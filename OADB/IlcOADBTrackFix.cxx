...
ClassImp(IlcOADBTrackFix);

//______________________________________________________________________________
IlcOADBTrackFix::IlcOADBTrackFix()
{
  // Default constructor
...
//______________________________________________________________________________
IlcOADBTrackFix::IlcOADBTrackFix(const char* name) : 
...
//______________________________________________________________________________
void IlcOADBTrackFix::SetPtInvCorr(int mode,int side, const TGraph* gr)
{
  if (!gr || gr->GetN()<1) {
    IlcInfo(Form("Correction for side %d in mode %d is empty",side,mode));
...
//______________________________________________________________________________
Double_t IlcOADBTrackFix::GetPtInvCorr(int mode, double sideAfrac, double phi) const
{
