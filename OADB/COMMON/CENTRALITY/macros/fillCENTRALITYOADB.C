...
void fill()
{
  ...
  IlcOADBContainer* con     = new IlcOADBContainer("Centrality");

  
  IlcOADBCentrality*  cent1  = new IlcOADBCentrality();
  ...
  list1->SetName("IlcCentralityBy1D_137161");
  list12->SetName("IlcCentralityByFunction_137161");
  initHists(137161, 2, list1, list12); 
  cent1->SetHistReferences(list1, list12);
  con->AppendObject(cent1,  136851,  137165);
  
  IlcOADBCentrality*  cent2  = new IlcOADBCentrality();
  ...
  list2->SetName("IlcCentralityBy1D_137366");
  list22->SetName("IlcCentralityByFunction_137366");
  initHists(137366, 2, list2, list22); 
  cent2->SetHistReferences(list2, list22);
  con->AppendObject(cent2,  137230,  137531);
  
  
  IlcOADBCentrality*  cent3  = new IlcOADBCentrality();
  ...
  list3->SetName("IlcCentralityBy1D_137722");
  list32->SetName("IlcCentralityByFunction_137722");
  initHists(137722, 2, list3, list32); 
  cent3->SetHistReferences(list3, list32);
  con->AppendObject(cent3, 137539, 137848);
  
  
  IlcOADBCentrality*  cent4  = new IlcOADBCentrality();
  ...
  list4->SetName("IlcCentralityBy1D_138150");
  list42->SetName("IlcCentralityByFunction_138150");
  initHists(138150, 2, list4, list42); 
  cent4->SetHistReferences(list4, list42);
  con->AppendObject(cent4,  138125, 138154);


  IlcOADBCentrality*  cent5  = new IlcOADBCentrality();
  ...
  list5->SetName("IlcCentralityBy1D_138200");
  list52->SetName("IlcCentralityByFunction_138200");
  initHists(138200, 2, list5, list52); 
  cent5->SetHistReferences(list5, list52);
  con->AppendObject(cent5,  138190, 138275);


  IlcOADBCentrality*  cent6  = new IlcOADBCentrality();
  ...
  list6->SetName("IlcCentralityBy1D_139172");
  list62->SetName("IlcCentralityByFunction_139172");
  initHists(139172, 2, list6, list62); 
  cent6->SetHistReferences(list6, list62);
  con->AppendObject(cent6,  138358,  139517);  
  

  IlcOADBCentrality*  defaultCent  = new IlcOADBCentrality("oadbDefault");
...
{
  TString fileName =(Form("%s/COMMON/CENTRALITY/data/pass%d/IlcCentralityBy1D_%d.root", IlcOADBContainer::GetOADBPath(), fPass, fRunNo));
  TString fileName2=(Form("%s/COMMON/CENTRALITY/data/pass%d/IlcCentralityByFunction_%d.root", IlcOADBContainer::GetOADBPath(), fPass, fRunNo));
  TDirectory *owd = gDirectory;
  // Check if the file is present
  TString path = gSystem->ExpandPathName(fileName.Data());
  if (gSystem->AccessPathName(path)) {
     IlcError(Form("File %s does not exist", path.Data()));
     return;
  }
