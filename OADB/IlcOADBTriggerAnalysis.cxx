...
ClassImp(IlcOADBTriggerAnalysis)

IlcOADBTriggerAnalysis::IlcOADBTriggerAnalysis() : TNamed("IlcOADBTriggerAnalysis", "OADB object storing trigger analysis settings"),   
...
IlcOADBTriggerAnalysis::IlcOADBTriggerAnalysis(char* name) : TNamed(name, "OADB object storing trigger analysis settings"), 
  fZDCCutRefSumCorr(-65.5),
  fZDCCutRefDeltaCorr(-2.1),
  fZDCCutSigmaSumCorr(6.0),
  fZDCCutSigmaDeltaCorr(1.2)
...
// void IlcOADBTriggerAnalysis::Init() {
//   // initialize pointers
...
IlcOADBTriggerAnalysis::~IlcOADBTriggerAnalysis(){
  // dtor

}
  
void IlcOADBTriggerAnalysis::Browse(TBrowser *b)
{
   // Browse this object.
...
void IlcOADBTriggerAnalysis::Print(Option_t* option) const {
