#ifndef ILCTARGETTRACKV1_H
#define ILCTARGETTRACKV1_H
//   TARGET Track Class
...
#include "../TPC/IlcTPCtrack.h"

class TObjArray;
class IlcTARGETRad;

class IlcTARGETTrackV1 : public TObject { 

public:

  IlcTARGETTrackV1();  // default constructor
  //IlcTARGETTrackV1(const char *opt);  // Standard constructor
  IlcTARGETTrackV1(Double_t fieldfactor);  // Standard constructor
  //IlcTARGETTrackV1(IlcTPCtrack &obj);  // Standard constructor
  IlcTARGETTrackV1(IlcTPCtrack &obj, Double_t fieldfactor);  // Standard constructor
  IlcTARGETTrackV1(const IlcTARGETTrackV1 &cobj);  // copy constructor
  IlcTARGETTrackV1 &operator=(IlcTARGETTrackV1 obj);  // operator =
  ~IlcTARGETTrackV1(); // default destructor
  ...
  IlcTPCtrack *GetTPCtrack() const { return fTPCtrack;}    // get hte TPC track
...
//////////////////////////////////////////////////////////////////////////////////////// 
 ...
 private:  
  ...
  IlcTPCtrack     *fTPCtrack;           // reference to TPC track
