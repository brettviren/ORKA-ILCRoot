//////////////////////////////////////////////////////////////////////////
// USER Class for PID in the TARGET                                          //
...
ClassImp(IlcTARGETPident)
  //_______________________________________________________________________
IlcTARGETPident::IlcTARGETPident(){
  // default constructor
  fMom=0;
  fdEdx=0;
  fInvPt=0;
...
IlcTARGETPident::IlcTARGETPident(const IlcTARGETPident &ob) :TObject(ob) {
  // Copy constructor
  // Copies are not allowed. The method is protected to avoid misuse.
  Error("IlcTARGETPident","Copy constructor not allowed\n");
}

//______________________________________________________________________
IlcTARGETPident& IlcTARGETPident::operator=(const IlcTARGETPident& /* ob */){
  // Assignment operator
...
//_______________________________________________________________________
IlcTARGETPident::IlcTARGETPident(Double_t mom,Double_t invPt,Double_t dEdx,IlcTARGETSteerPid *sp,Float_t *Qlay,Float_t priorip,Float_t priorik,Float_t prioripi,Float_t priorie){
...
//_______________________________________________________________________
IlcTARGETPident::IlcTARGETPident(IlcTARGETtrackV2 *trackTARGET,IlcTARGETSteerPid *sp,Float_t *Qlay,Float_t priorip,Float_t priorik,Float_t prioripi,Float_t priorie){
  //
  Double_t xr;
  Double_t par[5];
  trackTARGET->GetExternalParameters(xr,par);
  if (par[4]!=0) {
  ...
  fPBayesk=CookCombinedBayes(condFun,prior,1); 
  fPBayespi=CookCombinedBayes(condFun,prior,2); 
  fdEdx=trackTARGET->GetdEdx();

}
//_______________________________________________________________________
void IlcTARGETPident::PrintParameters() const{
 //print parameters
...
//_______________________________________________________________________
Double_t IlcTARGETPident::Langaufun(Double_t *x, Double_t *par) {
...
//_______________________________________________________________________
Double_t IlcTARGETPident::Langaufun2(Double_t *x, Double_t *par){
  //normilczed langaufun
  return 1/par[4]*Langaufun(x,par);
}
//_______________________________________________________________________
Double_t IlcTARGETPident::Langaufunnorm(Double_t *x, Double_t *par){
   //Fit parameters:
  //par[0]=Width (scale) parameter of Landau density
  //par[1]=Most Probable (MP, location) parameter of Landau density
...
//_______________________________________________________________________
Double_t IlcTARGETPident::Gaus2(Double_t *x, Double_t *par){
  //normilczed gaussian function
  return 1/(sqrt(2*TMath::Pi())*par[1])*TMath::Gaus(x[0],par[0],par[1]);
}
//_______________________________________________________________________
void IlcTARGETPident::CookFunItsLay(Int_t lay,Int_t opt,Double_t *par,Double_t dedx,Double_t mom,Double_t rangei,Double_t rangef,TString comment){
...
//_______________________________________________________________________
Float_t IlcTARGETPident::CookCombinedBayes(Double_t condfun[][3],Float_t *prior,Int_t part)const {
  //Bayesian combined PID in the TARGET
  Int_t test=0; 
  Float_t bayes;
...
//_______________________________________________________________________
Float_t IlcTARGETPident::CookProd(Double_t condfun[][3],Int_t part)const{
  //
  Float_t p=1;
...
//_______________________________________________________________________
Float_t IlcTARGETPident::CookSum(Double_t condfun[][3],Float_t *prior)const{
  //
  Float_t sum=0;
  Float_t pprior[4]={0,0,0,0};
  for(Int_t j=0;j<4;j++)pprior[j]=prior[j];
