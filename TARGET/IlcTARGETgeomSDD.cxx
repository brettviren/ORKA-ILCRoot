...
/* $Id: IlcTARGETgeomSDD.cxx,v 1.1.1.1 2008/03/11 14:52:51 vitomeg Exp $ */
...
ClassImp(IlcTARGETgeomSDD)
IlcTARGETgeomSDD::IlcTARGETgeomSDD(){
////////////////////////////////////////////////////////////////////////
//    default constructor
////////////////////////////////////////////////////////////////////////
...
//    cout << "IlcTARGETgeomSDD default creator called: start" << endl;
    fPeriod        = 0.0;
    fDvelocity     = 0.0;
    fNAnodesL      = 0;
    fNAnodesR      = 0;
    ...
    fAnodeLowEdgeR = 0;
    fShapeSDD      = 0;
//    cout << "IlcTARGETgeomSDD default creator called: end" << endl;
}
//________________________________________________________________________
IlcTARGETgeomSDD::IlcTARGETgeomSDD(const Float_t *box,Float_t per,Float_t vel,
...
//________________________________________________________________________
void IlcTARGETgeomSDD::ResetSDD(const Float_t *box,Float_t per,Float_t vel,
			     Float_t axL,Float_t axR,
			     Int_t nAL,Float_t *leL,
			     Int_t nAR,Float_t *leR){
////////////////////////////////////////////////////////////////////////
...
//________________________________________________________________________
IlcTARGETgeomSDD::IlcTARGETgeomSDD(IlcTARGETgeomSDD &source) : TObject(source){
    // Copy constructor
    Int_t i;
...
//________________________________________________________________________
IlcTARGETgeomSDD& IlcTARGETgeomSDD::operator=(IlcTARGETgeomSDD &source){
    // = operator
    Int_t i;
...
void IlcTARGETgeomSDD::Local2Det(Float_t xl,Float_t zl,Int_t &a,Int_t &t,Int_t &s){
...
//______________________________________________________________________
void IlcTARGETgeomSDD::Det2Local(Int_t a,Int_t t,Int_t s,Float_t &xl,Float_t &zl){
...
//______________________________________________________________________
void IlcTARGETgeomSDD::Print(ostream *os) const {
////////////////////////////////////////////////////////////////////////
...
//______________________________________________________________________
void IlcTARGETgeomSDD::Read(istream *is){
////////////////////////////////////////////////////////////////////////
...
//----------------------------------------------------------------------
ostream &operator<<(ostream &os,IlcTARGETgeomSDD &p){
////////////////////////////////////////////////////////////////////////
...
//----------------------------------------------------------------------
istream &operator>>(istream &is,IlcTARGETgeomSDD &r){
////////////////////////////////////////////////////////////////////////
...
ClassImp(IlcTARGETgeomSDD256)

IlcTARGETgeomSDD256::IlcTARGETgeomSDD256() : IlcTARGETgeomSDD(){
    // Default Constructor
}
//----------------------------------------------------------------------
IlcTARGETgeomSDD256::IlcTARGETgeomSDD256(Int_t npar,const Float_t *par) : 
    IlcTARGETgeomSDD(){
////////////////////////////////////////////////////////////////////////
//    constructor
/*
Pads for probe cards in ILC-D2       /05.03.2000/
...
//   const Float_t kDxyz[]   = {3.6250,0.01499,4.3794};//cm. (Geant 3.12 units)
    ...
    if(npar<3){
	Error("IlcTARGETgeomSDD256","npar=%d<3. array par must be [3] or greater",
	      npar);
	return;
    } // end if
//    cout << "IlcTARGETgeomSDD256 default creator called: start" << end;
   anodeLowEdges[0] = kAnodesZ;
    for(i=0;i<kNAnodes;i++)anodeLowEdges[i+1] = kAnodePitch+anodeLowEdges[i];
    IlcTARGETgeomSDD::ResetSDD(par,kPeriod,kVelocity,kAnodeXL,kAnodeXR,
			    kNAnodes+1,anodeLowEdges,
			    kNAnodes+1,anodeLowEdges);
//    cout << "IlcTARGETgeomSDD256 default creator called: end" << endl;
}
//________________________________________________________________________
ostream &operator<<(ostream &os,IlcTARGETgeomSDD256 &p){
////////////////////////////////////////////////////////////////////////
// Standard output streaming function.
////////////////////////////////////////////////////////////////////////
...
//----------------------------------------------------------------------
istream &operator>>(istream &is,IlcTARGETgeomSDD256 &r){
////////////////////////////////////////////////////////////////////////
// Standard input streaming function.
////////////////////////////////////////////////////////////////////////
...
ClassImp(IlcTARGETgeomSDD300)

IlcTARGETgeomSDD300::IlcTARGETgeomSDD300() : IlcTARGETgeomSDD(){
////////////////////////////////////////////////////////////////////////
//    default constructor
////////////////////////////////////////////////////////////////////////
...
//    cout << "IlcTARGETgeomSDD300 default creator called: start" << endl;
   anodeLowEdges[0] = kAnodesZ;
    for(i=0;i<kNAnodes;i++)anodeLowEdges[i+1] = kanode+anodeLowEdges[i];
    IlcTARGETgeomSDD::ResetSDD(kDxyz,kPeriod,kVelocity,kAnodeXL,kAnodeXR,
			    kNAnodes+1,anodeLowEdges,
			    kNAnodes+1,anodeLowEdges);
//    cout << "IlcTARGETgeomSDD300 default creator called: end" << endl;
}
//________________________________________________________________________
ostream &operator<<(ostream &os,IlcTARGETgeomSDD300 &p){
////////////////////////////////////////////////////////////////////////
// Standard output streaming function.
////////////////////////////////////////////////////////////////////////
...
//----------------------------------------------------------------------
istream &operator>>(istream &is,IlcTARGETgeomSDD300 &r){
////////////////////////////////////////////////////////////////////////
// Standard input streaming function.
////////////////////////////////////////////////////////////////////////
