///////////////////////////////////////////////////////////////
// IlcTARGETneuralPoint                                         //
//                                                           //
// A class which resumes the information of TARGET clusters     //
...
ClassImp(IlcTARGETNeuralPoint)
//
//------------------------------------------------------------------------------------------------------
//
IlcTARGETNeuralPoint::IlcTARGETNeuralPoint()
{
	// Default constructor.
...
//------------------------------------------------------------------------------------------------------
//
IlcTARGETNeuralPoint::IlcTARGETNeuralPoint(IlcTARGETNeuralPoint *p) :
...
//------------------------------------------------------------------------------------------------------
//
IlcTARGETNeuralPoint::IlcTARGETNeuralPoint(IlcTARGETRecPoint *rp, IlcTARGETgeomMatrix *gm)
{
	// Conversion constructor.
	// Accepts a IlcTARGETRecPoint and a IlcTARGETgeomMatrix,
	// and converts the local coord of the IlcTARGETRecPoint object into global
...
//
IlcTARGETNeuralPoint::IlcTARGETNeuralPoint
(IlcTARGETRecPoint *rp, IlcTARGETgeom *geom, Short_t module, Short_t index)
{
	// Conversion constructor.
	// Accepts a IlcTARGETRecPoint and an IlcTARGETgeom,
	// and converts the local coord of the IlcTARGETRecPoint object into global
...
//-------------------------------------------------------------------------------------------------
//
Double_t IlcTARGETNeuralPoint::GetPhi() const
{
...
//------------------------------------------------------------------------------------------------------
//
Double_t IlcTARGETNeuralPoint::GetError(Option_t *option)
{
...
//------------------------------------------------------------------------------------------------------
//
Bool_t IlcTARGETNeuralPoint::HasID(Int_t ID) const
{
...
//------------------------------------------------------------------------------------------------------
//
Int_t* IlcTARGETNeuralPoint::SharedID(IlcTARGETNeuralPoint *p) const
{
...
//
//
void IlcTARGETNeuralPoint::ConfMap(Double_t vx, Double_t vy)
{
