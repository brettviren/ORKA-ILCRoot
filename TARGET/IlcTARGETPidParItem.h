#ifndef IlcTARGETPIDPARITEM_H
#define IlcTARGETPIDPARITEM_H
//////////////////////////////////////////////////////////
//Class for PID in the TARGET                              //
//Origin: Elena Bruna bruna@to.infn.it                  //
//////////////////////////////////////////////////////////

class IlcTARGETPidParItem : public TObject{
  
 public:
  IlcTARGETPidParItem();  
  IlcTARGETPidParItem(Float_t center,Float_t width,Double_t *buff);  
  virtual ~IlcTARGETPidParItem(){;}
 ...
 private:
  ...
  ClassDef(IlcTARGETPidParItem,1);
};
#endif
