...
public:
 ...
 protected:
  ...
  //Double_t fXSPD[22][300];    //X-coordinates of pixel centers (not used)
  Double_t fYSPD[22][300];    //Y-coordinates of pixel centers
  Double_t fZSPD[22][300];    //Z-coordinates of pixel centers
  static IlcBin *fBins;
