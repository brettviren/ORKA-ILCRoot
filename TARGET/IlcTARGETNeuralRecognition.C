...
// the macro will save a file named, for example "gilc_<nsecs>.root"
// containing may IlcTARGETneuralTrack objects

void IlcTARGETNeuralRecognition
(Int_t nsecs = 20,
...
// =========================
	...
	IlcTARGETNeuralTracker *ANN = new IlcTARGETNeuralTracker();
