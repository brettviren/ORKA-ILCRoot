...
ClassImp(IlcTARGETstatistics)

//
IlcTARGETstatistics::IlcTARGETstatistics() : TObject(){
//
// default contructor
//
    fX = 0;
...
IlcTARGETstatistics::IlcTARGETstatistics(Int_t order) : TObject(){
//
...
IlcTARGETstatistics::~IlcTARGETstatistics(){
//
// default destructor
//
    if(fX!=0) delete[] fX;
...
IlcTARGETstatistics& IlcTARGETstatistics::operator=(IlcTARGETstatistics &source){
// operator =
...
//_______________________________________________________________
IlcTARGETstatistics::IlcTARGETstatistics(IlcTARGETstatistics &source) : TObject(source){
// Copy constructor
...
//_______________________________________________________________
void IlcTARGETstatistics::Reset(){
//
...
//_______________________________________________________________
void IlcTARGETstatistics::AddValue(Double_t x,Double_t w){
//
...
Double_t IlcTARGETstatistics::GetNth(Int_t order){
// This give the unbiased estimator for the RMS.
	...
	s = 0.0;
	printf("IlcTARGETstatistics: error in GetNth: fOrder=%d fN=%d fW[0]=%f\n",
	       fOrder,fN,fW[0]);
    } // end else
    return s;
}

Double_t IlcTARGETstatistics::GetRMS(){
// This give the unbiased estimator for the RMS.
...
Double_t IlcTARGETstatistics::GetErrorMean(){
...
Double_t IlcTARGETstatistics::GetErrorRMS(){
//This is the error in the mean or the square root of the variance of the mean.
