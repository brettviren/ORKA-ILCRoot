#ifndef ILCTARGETCLUSTERERV2_H
#define ILCTARGETCLUSTERERV2_H
//--------------------------------------------------------------
//                       TARGET clusterer V2
//
...
class IlcTARGETgeom;
class IlcTARGETclusterV2;
class IlcRawReader;
class IlcTARGETRawStream;

class IlcTARGETclustererV2 : public TObject {
public:
  IlcTARGETclustererV2(){ fEvent=0; fI=0;}
  IlcTARGETclustererV2(const IlcTARGETgeom *geom);

  void SetEvent(Int_t event) { fEvent=event; }
  Int_t Digits2Clusters(TTree *in, TTree *out);
  void Digits2Clusters(IlcRawReader* rawReader);
...
private:
  ...
  ClassDef(IlcTARGETclustererV2,1)  // TARGET cluster finder V2
};
