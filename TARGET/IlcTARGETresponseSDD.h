#ifndef ILCTARGETRESPONSESDD_H
#define ILCTARGETRESPONSESDD_H
...
/////////////////////////////////////////////////////////////
//  Base settings for the TARGET response classes.            //  
//  The data member of this class are static and set once  //
//  for all the modules.                                   //    
///////////////////////////////////////////////////////////// 

class IlcTARGETresponseSDD : public IlcTARGETresponse {
  public:

    IlcTARGETresponseSDD();
    virtual ~IlcTARGETresponseSDD();
	...
	// set Jitter error (20 um for ILC from beam test measurements 2001)
	fJitterError=jitter;}
 ...
 private:
   ...
   IlcTARGETresponseSDD(const IlcTARGETresponseSDD &ob); // copy constructor
   IlcTARGETresponseSDD& operator=(const IlcTARGETresponseSDD & /* source */); // ass. op.

    ClassDef(IlcTARGETresponseSDD,6) // Base response class 
