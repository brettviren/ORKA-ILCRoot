...
/* $Id: IlcTARGETRawStreamSDD.cxx,v 1.1.1.1 2008/03/11 14:52:50 vitomeg Exp $ */
...
ClassImp(IlcTARGETRawStreamSDD)

const Int_t IlcTARGETRawStreamSDD::fgkDDLModuleMap[kDDLsNumber][kModulesPerDDL] = {
...
const UInt_t IlcTARGETRawStreamSDD::fgkCodeLength[8] =  {8, 18, 2, 3, 4, 5, 6, 7};

IlcTARGETRawStreamSDD::IlcTARGETRawStreamSDD(IlcRawReader* rawReader) :
  IlcTARGETRawStream(rawReader)
{
// create an object to read TARGET SDD raw digits
...
UInt_t IlcTARGETRawStreamSDD::ReadBits()
{
...
Int_t IlcTARGETRawStreamSDD::DecompAmbra(Int_t value) const
{
// AMBRA decompression
...
Bool_t IlcTARGETRawStreamSDD::Next()
{
