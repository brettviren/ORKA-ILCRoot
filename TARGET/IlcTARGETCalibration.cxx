...
ClassImp(IlcTARGETCalibration)

//______________________________________________________________________
IlcTARGETCalibration::IlcTARGETCalibration(){
    // Default Constructor
...
//______________________________________________________________________
IlcTARGETCalibration::IlcTARGETCalibration(Double_t thickness){
    // Default Constructor
...
//______________________________________________________________________
IlcTARGETCalibration::IlcTARGETCalibration(const IlcTARGETCalibration &ob) : TObject(ob) {
  // Copy constructor
  // Copies are not allowed. The method is protected to avoid misuse.
  Error("IlcTARGETCalibration","Copy constructor not allowed\n");
}

//______________________________________________________________________
IlcTARGETCalibration& IlcTARGETCalibration::operator=(const IlcTARGETCalibration& /* ob */){
  // Assignment operator
...
//______________________________________________________________________
Double_t IlcTARGETCalibration::MobilityElectronSiEmp() const {
...
//______________________________________________________________________
Double_t IlcTARGETCalibration::MobilityHoleSiEmp() const {
...
//______________________________________________________________________
Double_t IlcTARGETCalibration::DiffusionCoefficientElectron() const {
...
//______________________________________________________________________
Double_t IlcTARGETCalibration::DiffusionCoefficientHole() const {
...
//______________________________________________________________________
Double_t IlcTARGETCalibration::SpeedElectron() const {
...
//______________________________________________________________________
Double_t IlcTARGETCalibration::SpeedHole() const {
...
//______________________________________________________________________
Double_t IlcTARGETCalibration::SigmaDiffusion3D(Double_t l) const {
...
//______________________________________________________________________
Double_t IlcTARGETCalibration::SigmaDiffusion2D(Double_t l) const {
...
//______________________________________________________________________
Double_t IlcTARGETCalibration::SigmaDiffusion1D(Double_t l) const {
...
//----------------------------------------------------------------------
Double_t IlcTARGETCalibration::DepletedRegionThicknessA(Double_t dopCons,
                                                 Double_t voltage,
                                                 Double_t elecCharge,
...
//----------------------------------------------------------------------
Double_t IlcTARGETCalibration::DepletedRegionThicknessB(Double_t resist,
                                                 Double_t voltage,
                                                 Double_t mobility,
...
//----------------------------------------------------------------------
Double_t IlcTARGETCalibration::ReverseBiasCurrent(Double_t temp,
...
//----------------------------------------------------------------------
void IlcTARGETCalibration::Print(ostream *os) const {
...
//----------------------------------------------------------------------
void IlcTARGETCalibration::Read(istream *is) {
...
ostream &operator<<(ostream &os,IlcTARGETCalibration &p){
...
//----------------------------------------------------------------------
istream &operator>>(istream &is,IlcTARGETCalibration &r){
