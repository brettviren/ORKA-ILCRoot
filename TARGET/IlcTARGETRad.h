#ifndef ILCTARGETRAD_H
#define ILCTARGETRAD_H
...
//                  TARGET Class to calculate the radiation lenght matrix
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
//


class IlcTARGETRad : public TObject { 

public:
    IlcTARGETRad(); // Default constructor.
    IlcTARGETRad(Int_t iimax, Int_t jjmax);         // class constructor
    virtual ~IlcTARGETRad();                        // class destructor
