#ifndef ILCTARGETRIEMANNFIT_H
#define ILCTARGETRIEMANNFIT_H
/* Copyright(c) 2005-2006, ILC Project Experiment, All rights reserved.   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcTARGETRiemannFit.h,v 1.1.1.1 2008/03/11 14:52:50 vitomeg Exp $ */
/////////////////////////////////////////////////////////////////////
...
class IlcTARGETRiemannFit : public TObject{
 public:
  IlcTARGETRiemannFit();
  IlcTARGETRiemannFit(Int_t size,Int_t ntracks);
  IlcTARGETRiemannFit(const IlcTARGETRiemannFit& rec);
  IlcTARGETRiemannFit& operator=(const IlcTARGETRiemannFit &source);
  ...
  class  IlcPointtl {
    ...
    private :
      ...
      IlcPointtl(const IlcPointtl& /*ap */) {}
    // assignment operator (NO assignment allowed)
      IlcPointtl& operator=(const IlcPointtl& /* ap */) {return *this;}
  ...
  IlcPointtl **GetPointRecs() const {return this->fPointRecs;}
 ...
 Int_t FitHelix(Int_t NPoints, TVector3** PointRecs,
		 TVector3** PointRecErrors,Float_t& f1,
 ...
 private:
  ...
  IlcPointtl **fPointRecs;    //rec points

  
  ClassDef(IlcTARGETRiemannFit,1)  // Fast fit of helices on TARGET RecPoints
    };
#endif
