#ifndef ILCTARGETRAWCLUSTERSDD_H
#define ILCTARGETRAWCLUSTERSDD_H
...
class IlcTARGETRawClusterSDD : public IlcTARGETRawCluster {
 public:
    IlcTARGETRawClusterSDD(); 
    IlcTARGETRawClusterSDD(Int_t wing,Float_t Anode,Float_t Time,Float_t Charge, 
    ...
    IlcTARGETRawClusterSDD( const IlcTARGETRawClusterSDD & source);
    virtual ~IlcTARGETRawClusterSDD() {// destructor
    }
    void Add(IlcTARGETRawClusterSDD* clJ); 
    Bool_t Brother(IlcTARGETRawClusterSDD* cluster,Float_t dz,Float_t dx);
 ...
 protected:
    ...
    ClassDef(IlcTARGETRawClusterSDD,1)  // IlcTARGETRawCluster class for SDD
};
#endif
