...
// points of the TARGET, with the goal of studying tracking and              *
...
ClassImp(IlcTARGETRiemannFit)


IlcTARGETRiemannFit::IlcTARGETRiemannFit() {
  ///////////////////////////////////////////////////////////
  // Default constructor.
...
IlcTARGETRiemannFit::IlcTARGETRiemannFit(const IlcTARGETRiemannFit &rf) : TObject(rf) {
  // Copy constructor
  // Copies are not allowed. The method is protected to avoid misuse.
  Error("IlcTARGETRiemannFit","Copy constructor not allowed\n");
}

//______________________________________________________________________
IlcTARGETRiemannFit& IlcTARGETRiemannFit::operator=(const IlcTARGETRiemannFit& /* rf */){
  // Assignment operator
...
IlcTARGETRiemannFit::IlcTARGETRiemannFit(Int_t size,Int_t ntracks) {
  ///////////////////////////////////////////////////////////
  // Constructor.
...
//    fspdi          = 0;
//    fspdo          = 0;
  IlcPointtl *first = new IlcPointtl[fSizeEvent];
  IlcPointtl **pointRecs = new IlcPointtl*[fSizeEvent];
  for(Int_t i=0;i<6;i++)fPLay[i] = 0;
...
// ---------------------------------------------------------------------
IlcTARGETRiemannFit::IlcPointtl::IlcPointtl(){
  // default constructor
  SetLay();
  SetLad();
  SetDet();
...
void FillPoints(IlcTARGETRiemannFit::IlcPointtl **Points,Int_t &index,Float_t *xpoint,
		Float_t *error,
		TLorentzVector pE,TLorentzVector oT,Int_t *id,
		Int_t track, Char_t *name,Int_t code,
		Float_t phiorigin){
  ///////////////////////////////////////////////////////////////////////
  // Fill the structure IlcPointtl with the proper data
  //
  //////////////////////////////////////////////////////////////////////
...
void IlcTARGETRiemannFit::InitPoints(Int_t ntracks,TTree *TR,Int_t nparticles){
  //////////////////////////////////////////////////////////////////////
  ...
  rl->CdGAFile();
  IlcTARGETgeom* gm = (IlcTARGETgeom*)gDirectory->Get("IlcTARGETgeom");
  ...
  IlcTARGETRiemannFit::IlcPointtl *global = new IlcPointtl[iMAX];
  fPointRecs = new IlcTARGETRiemannFit::IlcPointtl*[iMAX];
  //
  ...
  for (mod=0; mod<nmodules; mod++) {
    //itsModule=(IlcTARGETmodule*)iTSmodules->At(mod);
    //TARGET->ResetRecPoints();
    detTypeRec.ResetRecPoints();
    TR->GetEvent(mod);
    Int_t nrecp = iTSrec->GetEntries();
    if (!nrecp) continue;
...
///////////////////////////////////////////////////////////
Bool_t SortZ(const IlcTARGETRiemannFit::IlcPointtl *s1,const IlcTARGETRiemannFit::IlcPointtl *s2){
...
Bool_t SortTrack(const IlcTARGETRiemannFit::IlcPointtl *s1,const IlcTARGETRiemannFit::IlcPointtl *s2){
...
void hpsortTrack(IlcTARGETRiemannFit::IlcPointtl **ra,Int_t n){
   Int_t i,ir,j,l;
   IlcTARGETRiemannFit::IlcPointtl *rra;
...
void hpsortZ(IlcTARGETRiemannFit::IlcPointtl **ra,Int_t n){
   Int_t i,ir,j,l;
   IlcTARGETRiemannFit::IlcPointtl *rra;
...
void IlcTARGETRiemannFit::WritePoints(void) {
  /////////////////////////////////////////////////////////////////////
...
void IlcTARGETRiemannFit::ReadPoints(void) {
  //////////////////////////////////////////////////////////////////////
...
Int_t IlcTARGETRiemannFit::SolveCubic(Double_t a,Double_t b,Double_t c,
...
//-------------------------------------------------------------------
Int_t IlcTARGETRiemannFit::FitHelix(Int_t tracknumber,Double_t Px,Double_t Py,Double_t Pz,Double_t& fd0,
...
Int_t IlcTARGETRiemannFit::FitHelix(Int_t NPoints, TVector3** PointRecs,TVector3** PointRecErrors,Float_t& f1, Float_t& f2, Float_t& f3) {
  ...
  for (Int_t ip=0; ip<NPoints; ip++) {
    original[ip]->SetXYZ(0.1*PointRecs[ip]->X(),0.1*PointRecs[ip]->Y(),0.1*PointRecs[ip]->Z());
   
errors[ip]->SetXYZ(0.1*PointRecErrors[ip]->X(),0.1*PointRecErrors[ip]->Y(),0.1*PointRecErrors[ip]->Z());
...
Int_t IlcTARGETRiemannFit::LinearFit(Int_t npoints, TVector3 **input, 
...
Double_t IlcTARGETRiemannFit::Fitfunction(Double_t *x, Double_t* par){
