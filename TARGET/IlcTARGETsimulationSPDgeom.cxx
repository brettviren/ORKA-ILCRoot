...
/* $Id: IlcTARGETsimulationSPDgeom.cxx,v 1.1.1.1 2008/03/11 14:52:50 vitomeg Exp $ */
...
IlcTARGETsimulationSPD::IlcTARGETsimulationSPD() : IlcTARGETsimulation(),
fMapA2(0),
fHis(0){
    // Default constructor
    // Inputs: 
...
fHis(0){
    ...
    // Inputs: 
    //    IlcTARGETsegmentation *seg  Segmentation class to be used
    //    IlcTARGETresonse      *res  Response class to be used
    // Outputs:
    //    none.
    // Return:
    //    A standard constructed IlcTARGETsimulationSPD class.

    Init();
}
//______________________________________________________________________
void IlcTARGETsimulationSPD::Init() {
    // Initilizes the variables of IlcTARGETsimulation SPD.
    // Inputs:
    //    none.
    // Outputs:
    //    none.
    ...
    IlcTARGETsegmentationSPD* seg = (IlcTARGETsegmentationSPD*)GetSegmentationModel(0);
    fMapA2  = new IlcTARGETMapA2(seg);
    if(fpList) delete fpList;
    fpList  = new IlcTARGETpList(GetNPixelsZ()+1,GetNPixelsX()+1);
}
/*
//______________________________________________________________________
void IlcTARGETsimulationSPD::Init(IlcTARGETsegmentationSPD *seg,
                               IlcTARGETCalibrationSPD *resp) {
    // Initilizes the variables of IlcTARGETsimulation SPD.
    // Inputs:
    //    IlcTARGETsegmentationSPD   replacement segmentation class to be used
    //    ilcTARGETresponseSPD       replacement response class to be used
    // Outputs:
    //    none.
    // Return:
    //    none.
    ...
    if(fMapA2) delete fMapA2;
    fMapA2  = new IlcTARGETMapA2(GetSegmentationModel(0));
    if(fpList) delete fpList;
    fpList  = new IlcTARGETpList(GetNPixelsZ()+1,GetNPixelsX()+1);
}
*/
...
//______________________________________________________________________
IlcTARGETsimulationSPD::IlcTARGETsimulationSPD(const IlcTARGETsimulationSPD &source) :
    ...
    //    none.
    // Return:
    //    A new IlcTARGETsimulationSPD class with the same parameters as source.
...
//______________________________________________________________________
IlcTARGETsimulationSPD& IlcTARGETsimulationSPD::operator=(const IlcTARGETsimulationSPD 
						    &source) {
    //    Assignment operator
    // Inputs: 
    //    none.
...
//______________________________________________________________________
IlcTARGETsimulation& IlcTARGETsimulationSPD::operator=(const IlcTARGETsimulation 
						    &source) {
    //    Assignment operator
    // Inputs: 
    //    none.
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::SDigitiseModule(IlcTARGETmodule *mod, Int_t dummy0,
                                             Int_t dummy1) {
    // Sum digitize module
    // Inputs:
    //   IlcTARGETmodule  *mod    The module to be SDgitized
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::DigitiseModule(IlcTARGETmodule *mod, Int_t,Int_t) {
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::SDigitsToDigits(Int_t module,IlcTARGETpList *pList) {
    // sum digits to Digits.
    // Inputs:
    //   IlcTARGETmodule  *mod    The module to be SDgitized
    //   IlcTARGETpList   *pList  the array of SDigits
    // Outputs:
    //   IlcTARGETpList   *pList  the array of SDigits
    // Return:
    //   none.

    IlcDebug(1,Form("Entering IlcTARGETsimulatinSPD::SDigitsToDigits for module=%d",
		  module));
    fModule = module;
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::UpdateMapSignal(Int_t row,Int_t col,Int_t trk,
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::UpdateMapNoise(Int_t row,Int_t col,Int_t mod,
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::HitsToAnalogDigits(IlcTARGETmodule *mod,
    ...
    // Inputs:
    //   IlcTARGETmodule  *mod        module class
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::HitToDigit(IlcTARGETmodule *mod,Int_t hitpos,
				     Int_t *frowpixel,Int_t *fcolpixel,
				     Double_t *fenepixel,IlcTARGETpList *pList) {
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::ChargeSharing(Float_t x1l,Float_t z1l,Float_t x2l,
    ...
    //Begin_Html
    /*
      <img src="picts/TARGET/barimodel_2.gif">
      </pre>
      <br clear=left>
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::SetCoupling(Int_t row, Int_t col, Int_t ntrack,
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::SetCouplingOld(Int_t row, Int_t col, Int_t ntrack,
					 Int_t idhit,Int_t module,
					 IlcTARGETpList *pList) {
    //  Take into account the coupling between adiacent pixels.
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::CreateDigit(Int_t module,IlcTARGETpList *pList) {
    ...
    for (Int_t r=1;r<=GetNPixelsZ();r++) {
        for (Int_t c=1;c<=GetNPixelsX();c++) {
            ...
            if ( signal > GetThreshold()) {
                ...
                Float_t phys = 0;
                ilcTARGET->AddSimDigit(0,phys,digits,tracks,hits,charges);
                IlcDebug(1,Form("mod=%d r,c=%d,%d sig=%f noise=%f Msig=%d Thres=%f",
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::SetFluctuations(IlcTARGETpList *pList,Int_t module) {
    ...
    //Begin_Html
    /*
      <img src="picts/TARGET/barimodel_1.gif">
      </pre>
      <br clear=left>
      <font size=+2 color=red>
      <a href="mailto:Rocco.Caliandro@ba.infn.it"></a>.
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::SetMask(Int_t mod) {
    ...
    Int_t iz,ix,im;
    Float_t totMask;
    Float_t perc = ((IlcTARGETCalibrationSPD*)GetCalibrationModel(mod))->GetFractionDead();
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::CreateHistograms() {
    // Create Histograms
    // Inputs:
    //   none.
    // Outputs:
    ...
    //   none.
    Int_t i;
    printf("Sto creando gli histogrammi!"\n);
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::ResetHistograms() {
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::WriteSDigits(IlcTARGETpList *pList){
    ...
    for(i=0;i<ni;i++)for(j=0;j<nj;j++){
        if(pList->GetSignalOnly(i,j)>0.0){
            ilcTARGET->AddSumDigit(*(pList->GetpListItem(i,j)));
            if(IlcDebugLevel()>0){
                cout << "pListSPD: " << *(pList->GetpListItem(i,j)) << endl;
                IlcDebug(1,Form("mod=%d r,c=%d %d sig=%f noise=%f",
...
//______________________________________________________________________
void IlcTARGETsimulationSPD::FillMapFrompList(IlcTARGETpList *pList){
