void IlcTARGETNeuralExport(Int_t min_count_4_good = 5)
{
	TFile *f_in = new TFile("its_neural_new.root");
	TTree *t_in = (TTree*)f_in->Get("TreeT");
	
	IlcTARGETNeuralTrack *in_track = 0;
	...
	IlcTARGETIOTrack *out_track = 0;
	t_out->Branch("TARGETtracks", "IlcTARGETIOTrack", &out_track);
