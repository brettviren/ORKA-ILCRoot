#ifndef ILCTARGETRAWCLUSTERSPD_H
#define ILCTARGETRAWCLUSTERSPD_H
...
class IlcTARGETRawClusterSPD : public IlcTARGETRawCluster {
 public:
    IlcTARGETRawClusterSPD();
    IlcTARGETRawClusterSPD(Float_t clz,Float_t clx,Float_t Charge,
			Int_t ClusterSizeZ,Int_t ClusterSizeX,
			Int_t xstart,Int_t xstop,Float_t zstart,
			Float_t zstop,Int_t zend,Int_t module);
    virtual ~IlcTARGETRawClusterSPD() {// destructor
    }
    void Add(IlcTARGETRawClusterSPD* clJ); 
    Bool_t Brother(IlcTARGETRawClusterSPD* cluster,Float_t dz,Float_t dx) const;
 ...
 protected:
  ...
  ClassDef(IlcTARGETRawClusterSPD,2)  // IlcTARGETRawCluster class for SPD
};
