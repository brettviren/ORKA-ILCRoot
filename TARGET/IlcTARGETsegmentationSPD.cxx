...
//                                                  //
//////////////////////////////////////////////////////
ClassImp(IlcTARGETsegmentationSPD)

//_____________________________________________________________________________
  IlcTARGETsegmentationSPD::IlcTARGETsegmentationSPD(): IlcTARGETsegmentation(){
  // Default constructor
  fNpx = 0;
  fNpz = 0;
...
//_____________________________________________________________________________
Float_t IlcTARGETsegmentationSPD::ColFromZ300(Float_t z) const {
...
//_____________________________________________________________________________
Float_t IlcTARGETsegmentationSPD::ZFromCol300(Int_t col) const {
...
//_____________________________________________________________________________
Float_t IlcTARGETsegmentationSPD::ZpitchFromCol300(Int_t col) const {
...
//_____________________________________________________________________________
Float_t IlcTARGETsegmentationSPD::ColFromZ(Float_t z) const {
...
//_____________________________________________________________________________
Float_t IlcTARGETsegmentationSPD::ZFromCol(Int_t col) const {
    // same comments as above
    // Get z-coordinate for each colunm number
...
Float_t IlcTARGETsegmentationSPD::ZpitchFromCol(Int_t col) const {
...
//______________________________________________________________________
IlcTARGETsegmentationSPD::IlcTARGETsegmentationSPD(IlcTARGETgeom *gm){
  // Constructor
   fCorr=0;
   fNpx = 0;
   fNpz = 0;
...
//______________________________________________________________________
void IlcTARGETsegmentationSPD::Copy(TObject &obj) const {
  // protected method. copy this to obj
  IlcTARGETsegmentation::Copy(obj);
  ((IlcTARGETsegmentationSPD& ) obj).fNpx  = fNpx;
  ((IlcTARGETsegmentationSPD& ) obj).fNpz  = fNpz;
  Int_t i;
  for(i=0;i<256;i++) 
         ((IlcTARGETsegmentationSPD& ) obj).fCellSizeX[i] = fCellSizeX[i];
  for(i=0;i<280;i++) 
         ((IlcTARGETsegmentationSPD& ) obj).fCellSizeZ[i] = fCellSizeZ[i];
}

//______________________________________________________________________
IlcTARGETsegmentationSPD& IlcTARGETsegmentationSPD::operator=(const IlcTARGETsegmentationSPD &source){
   // = operator
...
IlcTARGETsegmentationSPD::IlcTARGETsegmentationSPD(const IlcTARGETsegmentationSPD &source) :
    IlcTARGETsegmentation(source){
  // copy constructor
  source.Copy(*this);
}
//----------------------------------------------------------------------
void IlcTARGETsegmentationSPD::SetBinSize(Float_t *x,Float_t *z){
...
//----------------------------------------------------------------------
void IlcTARGETsegmentationSPD::Init300(){
...
//------------------------------
void IlcTARGETsegmentationSPD::Init(){
...
//cout<<"Sto in INIT di IlcTARGETsegmentationSPD.cxx"<<endl;
...
//    for(i=fNpz;i<280;i++) fCellSizeZ[i] = 0.0; // zero out rest of array
    ...
    for(i=0;i<fNpz;i++) fDz += fCellSizeZ[i];
    fDy = 300.0; //microns  SPD sensitive layer thickness
    IlcDebug(1,Form(" IlcTARGETsegmentationSPD - Init: fNpx fNpz fDx fDz %d %d %f %f\n",fNpx, fNpz, fDx, fDz));

}
//------------------------------
void IlcTARGETsegmentationSPD::SetNPads(Int_t p1, Int_t p2){
...
//------------------------------
Float_t IlcTARGETsegmentationSPD::Dpx(Int_t i) const {
    //returs x pixel pitch for a give pixel
    if(i<0||i>=256) return 0.0;
    return fCellSizeX[i];
}
//------------------------------
Float_t IlcTARGETsegmentationSPD::Dpz(Int_t i) const {
    // returns z pixel pitch for a give pixel
    if(i<0||i>=280) return 0.0;
    return fCellSizeZ[i];
}
//------------------------------
void IlcTARGETsegmentationSPD::GetPadIxz(Float_t x,Float_t z,Int_t &ix,Int_t &iz) const {
...
//------------------------------
void IlcTARGETsegmentationSPD::GetPadTxz(Float_t &x,Float_t &z) const{
...
//------------------------------
void IlcTARGETsegmentationSPD::GetPadCxz(Int_t ix,Int_t iz,Float_t &x,Float_t&z) const {
...
//______________________________________________________________________
Bool_t IlcTARGETsegmentationSPD::LocalToDet(Float_t x,Float_t z,
...
//______________________________________________________________________
void IlcTARGETsegmentationSPD::DetToLocal(Int_t ix,Int_t iz,Float_t &x,Float_t &z) const
{
...
//______________________________________________________________________
void IlcTARGETsegmentationSPD::CellBoundries(Int_t ix,Int_t iz,
