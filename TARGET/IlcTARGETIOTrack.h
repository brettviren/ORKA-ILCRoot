#ifndef ILCTARGETIOTRACK_H
#define ILCTARGETIOTRACK_H 
...
class IlcTARGETIOTrack : public TObject {


 public:

  IlcTARGETIOTrack();                        // constructor
  virtual ~IlcTARGETIOTrack() {};            // distructor
...
//  Covariance matrix
  ...
  ClassDef(IlcTARGETIOTrack,1)  // IlcTARGETIOTrack class
};
