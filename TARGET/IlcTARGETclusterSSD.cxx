...
/* $Id: IlcTARGETclusterSSD.cxx,v 1.2 2008/03/17 18:20:42 vitomeg Exp $ */
////////////////////////////////////////////////////////////////////////////
...
ClassImp(IlcTARGETclusterSSD)

//______________________________________________________________________
IlcTARGETclusterSSD::IlcTARGETclusterSSD(){
    // default constructor
...
//______________________________________________________________________
IlcTARGETclusterSSD::IlcTARGETclusterSSD(Int_t ndigits, Int_t *DigitIndexes, 
...
//______________________________________________________________________
IlcTARGETclusterSSD::IlcTARGETclusterSSD(const IlcTARGETclusterSSD &OneSCluster) : 
    TObject(OneSCluster){
    // copy constructor
...
//______________________________________________________________________
IlcTARGETclusterSSD& IlcTARGETclusterSSD::operator=(const IlcTARGETclusterSSD 
					      &OneSCluster){
    // assignment operator
...
//______________________________________________________________________
Int_t IlcTARGETclusterSSD::SplitCluster(Int_t where, Int_t *outdigits){
    ...
    //This method generate params - see IlcTARGETmoduleSSD::SplitCluster;
    Int_t tmp = fNDigits;
    Int_t ind = 0;
...
//______________________________________________________________________
Int_t IlcTARGETclusterSSD::GetDigitStripNo(Int_t digit){
    // return strip no of a digit
    if (digit<0) return -1;
    return (digit>(fNDigits-1)) ? -1 :
        ((IlcTARGETdigitSSD*)(fDigits->UncheckedAt((*fDigitsIndex)[digit])))->GetStripNumber();
}
//______________________________________________________________________
Int_t IlcTARGETclusterSSD::GetDigitSignal(Int_t digit){
    // returns digit signal
    Int_t index,signal;
    if (digit<0||digit>=fNDigits) return -1;
    index  = (*fDigitsIndex)[digit];
    signal = ((IlcTARGETdigitSSD*)(fDigits->UncheckedAt(index)))->GetSignal();
    /*
...
//______________________________________________________________________
Float_t IlcTARGETclusterSSD::GetTotalSignal(){
    // return total signal
...
//______________________________________________________________________
Float_t  IlcTARGETclusterSSD::GetTotalSignalError(){
...
//______________________________________________________________________
void IlcTARGETclusterSSD::DelCross(Int_t index){
...
//______________________________________________________________________
Int_t  *IlcTARGETclusterSSD::GetTracks(Int_t &nt){
...
//______________________________________________________________________
Double_t IlcTARGETclusterSSD::GetPosition(){
...
//______________________________________________________________________
Double_t IlcTARGETclusterSSD::EtaAlgorithm(){
...
//______________________________________________________________________
Double_t  IlcTARGETclusterSSD::GetPositionError() const {
    // return the position error
    return (GetNumOfDigits()+1)/2;
}
//______________________________________________________________________
Bool_t IlcTARGETclusterSSD::IsCrossingWith(Int_t idx) const{
