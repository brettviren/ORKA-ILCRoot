//////////////////////////////////////////////////////////////////////////
//  Ilc TARGET class to help keep statistical information                //
//                                                                      //
// version: 0.0.0 Draft.                                                //
// Date: April 18 1999                                                  //
// By: Bjorn S. Nilsen                                                  //
...
ClassImp(IlcTARGETstatistics2)

//
IlcTARGETstatistics2::IlcTARGETstatistics2() : TObject(){
//
// default constructor
//
    fX  = 0;
...
IlcTARGETstatistics2::IlcTARGETstatistics2(Int_t order) : TObject(){
//
...
IlcTARGETstatistics2::~IlcTARGETstatistics2(){
//
// destructor
//
    if(fX!=0)  delete[] fX;
...
IlcTARGETstatistics2& IlcTARGETstatistics2::operator=(IlcTARGETstatistics2 &source){
// operator =
...
//_______________________________________________________________
IlcTARGETstatistics2::IlcTARGETstatistics2(IlcTARGETstatistics2 &source):
    TObject(source){
// Copy constructor
...
void IlcTARGETstatistics2::Reset(){
//
...
void IlcTARGETstatistics2::AddValue(Double_t y,Double_t x,Double_t w=1.0){
//
...
Double_t IlcTARGETstatistics2::GetXNth(Int_t order){
//
...
//
	...
	s = 0.0;
	printf("IlcTARGETstatistics2: error in GetNth: fOrder=%d fN=%d fW[0]=%f\n",
	       fOrder,fN,fW[0]);
    } // end else
    return s;
}
Double_t IlcTARGETstatistics2::GetYNth(Int_t order){
//
// This give the unbiased estimator for the RMS.
//
    Double_t s;
...
Double_t IlcTARGETstatistics2::GetYXNth(Int_t order){
// This give the unbiased estimator for the RMS.
    Double_t s;
...
Double_t IlcTARGETstatistics2::GetRMSX(){
// This give the unbiased estimator for the RMS.
...
Double_t IlcTARGETstatistics2::GetRMSY(){
// This give the unbiased estimator for the RMS.
    Double_t x,x2,w,ww,s;
...
Double_t IlcTARGETstatistics2::GetRMSYX(){
// This give the unbiased estimator for the RMS.
    Double_t x,x2,w,ww,s;
...
Double_t IlcTARGETstatistics2::GetErrorMeanY(){
...
Double_t IlcTARGETstatistics2::GetErrorMeanX(){
//This is the error in the mean or the square root of the variance of the mean.
    Double_t rms,w,ww,s;
...
Double_t IlcTARGETstatistics2::GetErrorMeanYX(){
//This is the error in the mean or the square root of the variance of the mean.
    Double_t rms,w,ww,s;
...
Double_t IlcTARGETstatistics2::GetErrorRMSY(){
//This is the error in the mean or the square root of the variance of the mean.
...
Double_t IlcTARGETstatistics2::GetErrorRMSX(){
//This is the error in the mean or the square root of the variance of the mean.
// at this moment this routine is only defined for weights=1.
    Double_t x,x2,x3,x4,w,ww,m2,m4,n,s;
...
Double_t IlcTARGETstatistics2::GetErrorRMSYX(){
//This is the error in the mean or the square root of the variance of the mean.
// at this moment this routine is only defined for weights=1.
    Double_t x,x2,x3,x4,w,ww,m2,m4,n,s;
...
Double_t IlcTARGETstatistics2::FitToLine(Double_t &a,Double_t &b){
// fit to y = a+bx returns Chi squared or -1.0 if an error
	...
	printf("IlcTARGETstatistics2: Error in FitToLine vertical line\n");
	return -1.0;
    } // end if h
