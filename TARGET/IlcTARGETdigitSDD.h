#ifndef ILCTARGETDIGTARGETDD_H
#define ILCTARGETDIGTARGETDD_H
...
class IlcTARGETdigitSDD: public IlcTARGETdigit {

 public:
    IlcTARGETdigitSDD(); //default creator
    //standard c.tor  with digits and "phys"
    IlcTARGETdigitSDD(Float_t phys,const Int_t *digits);
    //standard c.tor with digits, tracls, hits, "phys", and charge
    IlcTARGETdigitSDD( Float_t phys,const Int_t *digits,const Int_t *tracks,
    ...
    IlcTARGETdigitSDD( Float_t phys,const Int_t *digits,const Int_t *tracks,
		    const Int_t *hits,const Float_t *charges, 
                    IlcTARGETCalibrationSDD *resp);
    virtual ~IlcTARGETdigitSDD(){/* destructor*/}
 ...
 protected:
    ...
    ClassDef(IlcTARGETdigitSDD,3)   // Simulated digit object for SDD
