//------------------------------------------------------------//
// Class for identification of pions,kaons and protons in TARGET //
...
ClassImp(IlcTARGETPid)


IlcTARGETPid::IlcTARGETPid(const IlcTARGETPid &source) : TObject(source),
...
IlcTARGETPid& IlcTARGETPid::operator=(const IlcTARGETPid& source){
  // Assignment operator. This is a function which is not allowed to be
  this->~IlcTARGETPid();
  new(this) IlcTARGETPid(source);
  return *this;
}

//
  Float_t IlcTARGETPid::Qtrm(Int_t track) {
//
...
Float_t IlcTARGETPid::Qtrm(Float_t qarr[6],Int_t narr) const{
//
...
Int_t	IlcTARGETPid::Wpik(Float_t pm,Float_t q){
...
//-----------------------------------------------------------
Int_t	IlcTARGETPid::Wpikp(Float_t pm,Float_t q){
  //
...
//-----------------------------------------------------------
Int_t	IlcTARGETPid::GetPcode(TClonesArray* rps,Float_t pm)
{
...
//-----------------------------------------------------------
Int_t   IlcTARGETPid::GetPcode(IlcKalmanTrack *track)
{
...
//------------------------------------------------------------
Int_t   IlcTARGETPid::GetPcode(IlcTARGETIOTrack *track)
{
...
//    cout<<"TARGETV1 dedx,mom,pcode="<<dedx<<","<<mom<<","<<pcode<<endl;
return pcode?pcode:211;
}
//-----------------------------------------------------------
Int_t   IlcTARGETPid::GetPcode(IlcTARGETtrackV2 *track)
{
...
//    cout<<"lam,pt1,mom,dedx="<<lam<<","<<pt1<<","<<mom<<","<<dedx<<endl;
    Int_t pcode=GetPcode(dedx,mom);
//    cout<<"TARGET V2 dedx,mom,pcode="<<dedx<<","<<mom<<","<<pcode<<endl;
return pcode?pcode:211;
}
//-----------------------------------------------------------
Int_t	IlcTARGETPid::GetPcode(Float_t q,Float_t pm)
{
...
//-----------------------------------------------------------
void	IlcTARGETPid::SetCut(Int_t n,Float_t pm,Float_t pilo,Float_t pihi,
...
//------------------------------------------------------------
void IlcTARGETPid::SetVec(Int_t ntrack,const TVector& info) const
{
...
//-----------------------------------------------------------
TVector* IlcTARGETPid::GetVec(Int_t ntrack) const
{
...
//-----------------------------------------------------------
void IlcTARGETPid::SetEdep(Int_t track,Float_t Edep)
{
...
//-----------------------------------------------------------
void IlcTARGETPid::SetPmom(Int_t track,Float_t Pmom)
{
...
//-----------------------------------------------------------
void IlcTARGETPid::SetPcod(Int_t track,Int_t partcode)
{
...
//-----------------------------------------------------------
void IlcTARGETPid::Print(Int_t track)
{
  //Prints information for given track
cout<<fMxtrs<<" tracks in IlcTARGETPid obj."<<endl;
    if( ((TVector*)fTrs->At(track))->IsValid() )
...
//-----------------------------------------------------------
IlcTARGETPid::IlcTARGETPid(Int_t ntrack):
fMxtrs(0),
fTrs(0),
fWpi(0),
fWk(0),
...
fggka(0),
fggpr(0){
  //Constructor for IlcTARGETPid class
