#ifndef ILCTARGETNEURALPOINT_H
#define ILCTARGETNEURALPOINT_H
///////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////
class IlcTARGETgeom;
class IlcTARGETgeomMatrix;
class IlcTARGETRecPoint;
class IlcTARGETRecPoint;

class IlcTARGETNeuralPoint : public TObject {

public:

	IlcTARGETNeuralPoint();
	IlcTARGETNeuralPoint(IlcTARGETNeuralPoint *p);
	IlcTARGETNeuralPoint(IlcTARGETRecPoint *rp, IlcTARGETgeomMatrix *gm);
	IlcTARGETNeuralPoint(IlcTARGETRecPoint *rp, IlcTARGETgeom *geom, Short_t module, Short_t index);

	virtual ~IlcTARGETNeuralPoint() { }
	...
	Short_t   GetLayer()        const {return fLayer;}         // TARGET layer
	Short_t   GetModule()       const {return fModule;}        // TARGET module 
	...
	Int_t*    SharedID(IlcTARGETNeuralPoint *p) const;
...
protected:
	...
	Short_t   fModule;   // TARGET module containing the point (0 - 2197)
	Short_t   fIndex;    // index as TClonesArray entry in TreeR (usually not > 600)
	Short_t   fLayer;    // TARGET layer containing the point
	...
	ClassDef(IlcTARGETNeuralPoint, 1) // IlcTARGETNeuralPoints class
};
