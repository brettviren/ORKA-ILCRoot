...
#include <TGeoPgon.h>
#include "IlcTARGETBaseGeometry.h"


ClassImp(IlcTARGETMixture)

IlcTARGETMixture::IlcTARGETMixture(const char *name,Int_t N,Double_t *w,TObjArray *m,
    ...
    //   TObjArray *m The array of IlcTARGETMixture (TGeoMixture)s 
    //                to be mixed.
    // Output:
    //   none.
    // Return:
...
//======================================================================
ClassImp(IlcTARGETGeoCable)
;
IlcTARGETGeoCable::IlcTARGETGeoCable(){
    //
...
//----------------------------------------------------------------------
IlcTARGETGeoCable::IlcTARGETGeoCable(const char *name,const TObjArray *vect,
    ...
    //    none.
    // Return:
    //    A fully initilized and created IlcTARGETGeoCable class.
    Char_t nam[500];
    Int_t i,n;
    Double_t s,th,ph;
