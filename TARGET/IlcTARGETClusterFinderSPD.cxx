...
ClassImp(IlcTARGETClusterFinderSPD)

//______________________________________________________________________
IlcTARGETClusterFinderSPD::IlcTARGETClusterFinderSPD():IlcTARGETClusterFinder(),
fDz(0.0),
fDx(0.0),
fMinNCells(0){
    // constructor
...
//----------------------------------------------------------
IlcTARGETClusterFinderSPD::IlcTARGETClusterFinderSPD(IlcTARGETDetTypeRec* dettyp):
...
//______________________________________________________________________
IlcTARGETClusterFinderSPD::IlcTARGETClusterFinderSPD(const IlcTARGETClusterFinderSPD &source) : IlcTARGETClusterFinder(source) {
  // Copy constructor
  // Copies are not allowed. The method is protected to avoid misuse.
  Fatal("IlcTARGETClusterFinderSPD","Copy constructor not allowed\n");
}

//______________________________________________________________________
IlcTARGETClusterFinderSPD& IlcTARGETClusterFinderSPD::operator=(const IlcTARGETClusterFinderSPD& /* source */){
  // Assignment operator
...
//______________________________________________________________________
void IlcTARGETClusterFinderSPD::FindRawClusters(Int_t module){   
...
//----------------------------------------------------------------------
void IlcTARGETClusterFinderSPD::ClusterFinder(Int_t ndigits,Int_t digx[],
    ...
    for (i=0 ; i < nclus ; i++){
        ...
        // store the cluster information to the IlcTARGETRawCLusterSPD object
        ...
        IlcTARGETRawClusterSPD *clust = new IlcTARGETRawClusterSPD(zcenter[i], //f
                                                             xcenter[i], //f
                                                             ndig, //f
                                                             ndz,ndx, //ii
                                                             ndxmin,ndxmax,//ii
...
void IlcTARGETClusterFinderSPD::DigitToPoint(Int_t nclus,
					  Double_t *xcenter,Double_t *zcenter,
					  Double_t *errxcenter,
					  Double_t *errzcenter, 
					  Int_t *tr1clus, Int_t *tr2clus,
    ...
    // and their associated errors are stored in the file gilcSP.root.
    Double_t l[3],xg,zg;
