...
ClassImp(IlcTARGETdigitSPD)

//______________________________________________________________________
IlcTARGETdigitSPD::IlcTARGETdigitSPD():IlcTARGETdigit(){
...
//______________________________________________________________________
IlcTARGETdigitSPD::IlcTARGETdigitSPD(const Int_t *digits){
...
//______________________________________________________________________
IlcTARGETdigitSPD::IlcTARGETdigitSPD(const Int_t *digits,const Int_t *tracks,
			       const Int_t *hits){
...
//______________________________________________________________________
Int_t IlcTARGETdigitSPD::GetListOfTracks(TArrayI &t){
...
//______________________________________________________________________
void IlcTARGETdigitSPD::Print(ostream *os){
...
//______________________________________________________________________
void IlcTARGETdigitSPD::Read(istream *os){
