#ifndef ILCTARGETPID_H
#define ILCTARGETPID_H
/////////////////////////////////////////////////////////////////
...
class IlcTARGETtrackV2;
class TF1;


class  IlcTARGETPid : public TObject {

public:
		IlcTARGETPid(Int_t ntrs=1000);
		virtual ~IlcTARGETPid(){}
	...
	Int_t   GetPcode(IlcKalmanTrack* track);
        Int_t   GetPcode(IlcTARGETIOTrack* track); 
        Int_t   GetPcode(IlcTARGETtrackV2* track);
...
protected:
	...
	// since they are not allowed
        IlcTARGETPid(const IlcTARGETPid &source); // copy constructor. 
        IlcTARGETPid& operator=(const IlcTARGETPid&  source); // = operator.
	...
	TF1*    fggka;   // Kaons          --//--
	TF1*    fggpr;   // Protons        --//--
  ClassDef(IlcTARGETPid,2) // Class for TARGET PID
};
