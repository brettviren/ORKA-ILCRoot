...
ClassImp(IlcTARGETRawStreamSDDv2)


IlcTARGETRawStreamSDDv2::IlcTARGETRawStreamSDDv2(IlcRawReader* rawReader) :
...
Bool_t IlcTARGETRawStreamSDDv2::Next()
{
...
// returns kFALSE if there is no digit left
  ...
  while (fSkip < 8) {
    ...
    if (fSkip == 4) {
      if (fData != 0) {
	Error("Next", "data not vilcd: %8.8d", fData);
	return kFALSE;
      }
    }
    fSkip++;
