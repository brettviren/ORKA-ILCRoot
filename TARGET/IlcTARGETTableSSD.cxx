...
ClassImp(IlcTARGETTableSSD)
////////////////////////////////////////////////////////////////////////
// Version: 0
// Origin: Massimo Masera
// March 2002
//
// IlcTARGETTableSSD is used by IlcTARGETsimulationSSD class to fill the IlcTARGETpList
// object starting from the map with energy depositions

//----------------------------------------------------------------------
IlcTARGETTableSSD::IlcTARGETTableSSD() : TObject(){
  // Default Constructor
  fDim=0;
  fArray=0;
  for(Int_t i=0;i<2;i++){
...
//----------------------------------------------------------------------
IlcTARGETTableSSD::IlcTARGETTableSSD(const IlcTARGETTableSSD & source):TObject(source){
  // Copy constructor
...
//----------------------------------------------------------------------
IlcTARGETTableSSD& IlcTARGETTableSSD::operator=(const IlcTARGETTableSSD & source){
...
//----------------------------------------------------------------------
IlcTARGETTableSSD::IlcTARGETTableSSD(Int_t noelem) : TObject(){
...
//----------------------------------------------------------------------
IlcTARGETTableSSD::~IlcTARGETTableSSD(){
  // Destructor
  delete [] fArray;
  fArray=0;
}
//----------------------------------------------------------------------
void IlcTARGETTableSSD::Add(Int_t side,Int_t strip){
  // Add an element to the table
  if(strip>=fDim/2){
    cerr<<" Error in IlcTARGETTableSSD::Add. "<<strip<<" is out of range\n";
    return;
  }
  if((side!=0) && (side!=1)){
    cerr<<" Error in IlcTARGETTableSSD::Add. side="<<side<<endl;
    cerr<<" side must be 0 or 1\n";
    return;
  }
  if(fCurrFil[side]>(fDim/2-1)){
    cerr<<" Error in IlcTARGETTableSSD::Add. Trying to fill an element out of range\n";
...
//----------------------------------------------------------------------
void IlcTARGETTableSSD::DumpTable(){
  // Dumps the contents of the table
  cout<<"==============================================================\n";
  cout<<" IlcTARGETTableSSD::DumpTable \n";
...
//----------------------------------------------------------------------
Int_t IlcTARGETTableSSD::Use(Int_t side){
  ...
  Int_t elem=-1;
  if((side!=0) && (side!=1)){
    cerr<<" Error in IlcTARGETTableSSD::Use. side="<<side<<endl;
    cerr<<" side must be 0 or 1\n";
    return elem;
  }
  if(fCurrUse[side]>(fDim/2-1)){
    cerr<<" Error in IlcTARGETTableSSD::Use. Trying to use an element out of range\n";
