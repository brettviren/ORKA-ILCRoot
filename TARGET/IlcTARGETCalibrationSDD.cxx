...
const Double_t IlcTARGETCalibrationSDD::fgkTemperatureDefault = 296.;
const Double_t IlcTARGETCalibrationSDD::fgkNoiseDefault = 10.;
const Double_t IlcTARGETCalibrationSDD::fgkGainDefault = 1.;
const Double_t IlcTARGETCalibrationSDD::fgkBaselineDefault = 20.;
const Double_t IlcTARGETCalibrationSDD::fgkMinValDefault  = 4;
//______________________________________________________________________
ClassImp(IlcTARGETCalibrationSDD)

IlcTARGETCalibrationSDD::IlcTARGETCalibrationSDD(){
  // default constructor
...
//______________________________________________________________________
IlcTARGETCalibrationSDD::IlcTARGETCalibrationSDD(const char *dataType){
  // constructor
...
//______________________________________________________________________
IlcTARGETCalibrationSDD::IlcTARGETCalibrationSDD(const IlcTARGETCalibrationSDD &ob) : IlcTARGETCalibration(ob) {
  // Copy constructor
  // Copies are not allowed. The method is protected to avoid misuse.
  Error("IlcTARGETCalibrationSDD","Copy constructor not allowed\n");
}

//______________________________________________________________________
IlcTARGETCalibrationSDD& IlcTARGETCalibrationSDD::operator=(const IlcTARGETCalibrationSDD& /* ob */){
  // Assignment operator
...
//______________________________________________________________________
void IlcTARGETCalibrationSDD::GiveCompressParam(Int_t  cp[8],Int_t ian) const {
...
void IlcTARGETCalibrationSDD::SetBadChannel(Int_t i,Int_t anode){
  //Set bad anode (set gain=0 for these channels);

  if(anode<0 || anode >fgkChannels*fgkChips*fgkWings-1)IlcError("Wrong anode number");
  Int_t wing=0;
  Int_t chip,channel;
...
//_____________________________________________________________________
Bool_t IlcTARGETCalibrationSDD::IsBadChannel(Int_t anode){
...
/*
//______________________________________________________________________
void IlcTARGETCalibrationSDD::SetDeadChannels(Int_t nchip, Int_t nchan){
...
*/
//______________________________________________________________________
void IlcTARGETCalibrationSDD::PrintGains() const{
  //
...
//______________________________________________________________________
void IlcTARGETCalibrationSDD::Print(){
