...
/* $Id: IlcTARGETNeuralTrack.cxx,v 1.2 2009/12/11 11:36:18 vitomeg Exp $ */

// IlcTARGETNeuralTrack
//
// The format of output data from Neural Tracker
// It can export data in the format of IlcTARGETIOTrack
// (V1) tracking.
...
ClassImp(IlcTARGETNeuralTrack)
//
//
//
IlcTARGETNeuralTrack::IlcTARGETNeuralTrack() : fMatrix(5,5), fVertex()
{
	// Default constructor
...
//
//
IlcTARGETNeuralTrack::IlcTARGETNeuralTrack(IlcTARGETNeuralTrack &track) 
...
//
//
IlcTARGETNeuralTrack::~IlcTARGETNeuralTrack()
{
	Int_t l;
...
//
//
void IlcTARGETNeuralTrack::AssignLabel()
{	
...
//
//
void IlcTARGETNeuralTrack::CleanSlot(Int_t i, Bool_t del)
{
...
//
//
void IlcTARGETNeuralTrack::GetModuleData(Int_t layer, Int_t &mod, Int_t &pos)
{
// Returns the point coordinates according to the TreeR philosophy in gilc.root files
...
//
//
void IlcTARGETNeuralTrack::Insert(IlcTARGETNeuralPoint *point)
{
// A trivial method to insert a point in the tracks;
// the point is inserted to the slot corresponding to its TARGET layer.
...
//
//
Int_t IlcTARGETNeuralTrack::OccupationMask()
{
...
//
//
void IlcTARGETNeuralTrack::PrintLabels()
{
...
//
//
Bool_t IlcTARGETNeuralTrack::AddEL(Int_t layer, Double_t sign)
{
...
//
//
Bool_t IlcTARGETNeuralTrack::AddMS(Int_t layer)
{
...
//
//
Int_t IlcTARGETNeuralTrack::PropagateTo(Double_t rk)
{
	// Propagation method.
...
//
//
Bool_t IlcTARGETNeuralTrack::SeedCovariance()
{
...
//
//
Bool_t IlcTARGETNeuralTrack::Filter(IlcTARGETNeuralPoint *test)
{
...
//
//
Bool_t IlcTARGETNeuralTrack::KalmanFit()
{
...
//
//
Bool_t IlcTARGETNeuralTrack::RiemannFit()
{
	...
	IlcTARGETNeuralPoint *p = fPoint[0];
	phi1 = p->GetPhi();
	for (i = 1; i < 6; i++) {
		p = (IlcTARGETNeuralPoint*)fPoint[i];
		if (!p) break;
		phi2 = p->GetPhi();
		temp1 = phi1;
		temp2 = phi2;
...
//
//
void IlcTARGETNeuralTrack::PrintState(Bool_t matrix)
{
...
//
//
Double_t IlcTARGETNeuralTrack::GetDz() const
{
...
//
//
Double_t IlcTARGETNeuralTrack::GetGamma() const
{
// these two parameters are update according to the filtered values
...
//
//
Double_t IlcTARGETNeuralTrack::GetPhi(Double_t r) const
{
...
//
//
Double_t IlcTARGETNeuralTrack::GetZ(Double_t r) const
{
...
//
//
Double_t IlcTARGETNeuralTrack::GetdEdX()
{
...
//
//
void IlcTARGETNeuralTrack::SetVertex(Double_t *pos, Double_t *err)
{
	// Stores vertex data
...
//
//
IlcTARGETIOTrack* IlcTARGETNeuralTrack::ExportIOtrack(Int_t min)
{
// Exports an object in the standard format for reconstructed tracks

	Int_t layer = 0;
	IlcTARGETIOTrack *track = new IlcTARGETIOTrack;
...
//
//
Double_t IlcTARGETNeuralTrack::ArgPhi(Double_t r) const
{
...
//
//
Double_t IlcTARGETNeuralTrack::ArgZ(Double_t r) const
{
...
//
//
Double_t IlcTARGETNeuralTrack::ArgB(Double_t r) const 
{
// UTILITY FUNCTION 
...
//
//
Double_t IlcTARGETNeuralTrack::ArgC(Double_t r) const 
{
// UTILITY FUNCTION
