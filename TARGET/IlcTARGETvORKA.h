#ifndef ILCTARGETVORKA_H
#define ILCTARGETVORKA_H
/* Copyright(c) 2005-2006, ILC Project Experiment, All rights reserved.   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcTARGETvORKA.h,v 1.1 2008/07/08 10:11:06 rucco Exp $ */
...
class IlcTARGETvORKA : public IlcTARGET {

public:
    IlcTARGETvORKA();
    IlcTARGETvORKA(const char *name, const char *title, Int_t MinorVersion);
// // // //     IlcTARGETvORKA(const IlcTARGETvORKA &source); // copy constructor
    IlcTARGETvORKA& operator=(const IlcTARGETvORKA &source); // assignment operator
    virtual       ~IlcTARGETvORKA() ;
    virtual void   BuildGeometry();
    TList *   BuildGeometry2(void) ;             // creates the geometry for the ROOT display
    virtual void   CreateGeometry();
    virtual void   CreateGeometryV1();
    virtual void   CreateGeometryV2();
    ...
    virtual void   SetPixelDimension(Int_t lay,Float_t pixelx,Float_t pixely,Float_t pixelz) {
...
private:
    ...
    ClassDef(IlcTARGETvORKA,1)  //Hits manager for set:TARGET version 8
