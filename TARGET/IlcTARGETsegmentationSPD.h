#ifndef ILCTARGETSEGMENTATIONSPD_H
#define ILCTARGETSEGMENTATIONSPD_H
...
public IlcTARGETsegmentation {
 public:

    IlcTARGETsegmentationSPD();
    IlcTARGETsegmentationSPD(IlcTARGETgeom *gm);
    IlcTARGETsegmentationSPD(const IlcTARGETsegmentationSPD &source);
    virtual ~IlcTARGETsegmentationSPD(){}
    IlcTARGETsegmentationSPD& operator=(const IlcTARGETsegmentationSPD &source);
 ...
 private:
  ...
  ClassDef(IlcTARGETsegmentationSPD,2) //Segmentation class for SPD 
