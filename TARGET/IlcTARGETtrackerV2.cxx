...
//    It reads IlcTARGETRecPoint clusters and creates IlcTARGETtrackV2 tracks
...
ClassImp(IlcTARGETtrackerV2)

IlcTARGETtrackerV2::IlcTARGETlayer IlcTARGETtrackerV2::fgLayers[kMaxLayer]; // TARGET layers

IlcTARGETtrackerV2::IlcTARGETtrackerV2(): 
  IlcTracker(), 
  fI(kMaxLayer),
  fBestTrack(),
  fTrackToFollow(),
...
{
  //--------------------------------------------------------------------
  //This is the IlcTARGETtrackerV2 default constructor
  //--------------------------------------------------------------------

  for (Int_t i=1; i<kMaxLayer+1; i++) new(fgLayers+i-1) IlcTARGETlayer();
...
IlcTARGETtrackerV2::IlcTARGETtrackerV2(const IlcTARGETtrackerV2 &t): 
  IlcTracker(t), 
  fI(t.fI),
...
{
  //--------------------------------------------------------------------
  //This is the IlcTARGETtrackerV2 copy constructor
  //--------------------------------------------------------------------
...
IlcTARGETtrackerV2::IlcTARGETtrackerV2(const IlcTARGETgeom *geom) : 
  IlcTracker(), 
  fI(kMaxLayer),
  fBestTrack(),
  fTrackToFollow(),
...
{
  //--------------------------------------------------------------------
  //This is the IlcTARGETtrackerV2 constructor
  //--------------------------------------------------------------------
  ...
  for (i=1; i<kMaxLayer+1; i++) {
    ...
    new (fgLayers+i-1) IlcTARGETlayer(r,poff,zoff,nlad,ndet);
  ...
  for (i=0; i<kMaxLayer; i++) fLayersNotToSkip[i]=kLayersNotToSkip[i];

}

void IlcTARGETtrackerV2::SetLayersNotToSkip(Int_t *l) {
  //--------------------------------------------------------------------
...
Int_t IlcTARGETtrackerV2::LoadClusters(TTree *cTree) {
  //--------------------------------------------------------------------
...
void IlcTARGETtrackerV2::UnloadClusters() {
  //--------------------------------------------------------------------
...
static Int_t CorrectForDeadZoneMaterial(IlcTARGETtrackV2 *t) {
  //--------------------------------------------------------------------
  ...
  Double_t rs=50., ds=0.001; // something belonging to the TARGET (screen ?)

  if (t->GetX() > riw) {
     if (!t->PropagateTo(riw,diw,x0iw)) return 1;
     if (TMath::Abs(t->GetY())>yr) if(!t->CorrectForMaterial(dr)) return 1;
     if (TMath::Abs(t->GetZ())<zm) if(!t->CorrectForMaterial(dm)) return 1;
...
Int_t IlcTARGETtrackerV2::Clusters2Tracks(IlcESD *event) {
  //--------------------------------------------------------------------
  ...
  {/* Read ESD tracks */
    ...
    while (nentr--) {
      ...
      IlcTARGETtrackV2 *t=0;
      try {
        t=new IlcTARGETtrackV2(*esd);
  ...
  for (fPass=0; fPass<2; fPass++) {
     ...
     for (Int_t i=0; i<nentr; i++) {
       IlcTARGETtrackV2 *t=(IlcTARGETtrackV2*)itsTracks.UncheckedAt(i);
       ...
       fBestTrack.UpdateESDtrack(IlcESDtrack::kVXDin);
...
Int_t IlcTARGETtrackerV2::PropagateBack(IlcESD *event) {
  //--------------------------------------------------------------------
...
Int_t IlcTARGETtrackerV2::RefitInward(IlcESD *event) {
  //--------------------------------------------------------------------
...
IlcCluster *IlcTARGETtrackerV2::GetCluster(Int_t index) const {
  //--------------------------------------------------------------------
...
void IlcTARGETtrackerV2::FollowProlongation() {
  //--------------------------------------------------------------------
  ...
  while (fI>fLastLayerToTrackTo) {
    ...
    IlcTARGETtrackV2 &track=fTracks[i];
    ...
    track.~IlcTARGETtrackV2(); new(&track) IlcTARGETtrackV2(fTrackToFollow);
...
Int_t IlcTARGETtrackerV2::TakeNextProlongation() {
  //--------------------------------------------------------------------
  // This function takes another track prolongation 
  //
  //  dEdx analysis by: Boris Batyunya, JINR, Boris.Batiounia@cern.ch 
  //--------------------------------------------------------------------
  IlcTARGETlayer &layer=fgLayers[fI];
  ...
  const IlcTARGETRecPoint *cc=0; Int_t cci=-1;
  ...
  if (!fTrackToFollow.Update(cc,chi2,(fI<<kClusterLayerShift)+cci)) {
 ...
 if (!fTrackToFollow.CorrectForMaterial(d,x0)) return 0;;
  }
...
IlcTARGETtrackerV2::IlcTARGETlayer::IlcTARGETlayer():
  fR(0.),
  fPhiOffset(0.),
  fNladders(0),
  fZOffset(0.),
...
IlcTARGETtrackerV2::IlcTARGETlayer::
IlcTARGETlayer(Double_t r,Double_t p,Double_t z,Int_t nl,Int_t nd): 
  ...
  fZOffset(z),
  fNdetectors(nd),
  fDetectors(new IlcTARGETdetector[nl*nd]),
  fNsel(0),
  fRoad(2*r*TMath::Sqrt(3.14/1.)) //assuming that there's only one cluster
{
  //--------------------------------------------------------------------
  //main IlcTARGETlayer constructor
  //--------------------------------------------------------------------
...
void IlcTARGETtrackerV2::IlcTARGETlayer::ResetClusters() {
  //--------------------------------------------------------------------
...
void IlcTARGETtrackerV2::IlcTARGETlayer::ResetRoad() {
  //--------------------------------------------------------------------
...
Int_t IlcTARGETtrackerV2::IlcTARGETlayer::InsertCluster(IlcTARGETRecPoint *c) {
  //--------------------------------------------------------------------
  ...
  if (n==0) fClusters[sec*kMaxClusterPerSector]=c;
     ...
     memmove(fClusters+i+1 ,fClusters+i,k*sizeof(IlcTARGETRecPoint*));
     fClusters[i]=c;
  }
  n++;
  return 0;
...
Int_t 
IlcTARGETtrackerV2::IlcTARGETlayer::FindClusterIndex(Float_t z,Int_t s) const {
  //--------------------------------------------------------------------
...
Int_t IlcTARGETtrackerV2::IlcTARGETlayer::
SelectClusters(Float_t zmin,Float_t zmax,Float_t ymin, Float_t ymax) {
  ...
  //--------------------------------------------------------------------
    ...
    if (fN[i1]!=0) {
       ...
       for (; i<imax; i++) {
           IlcTARGETRecPoint *c=fClusters[i];
...
const IlcTARGETRecPoint *IlcTARGETtrackerV2::IlcTARGETlayer::GetNextCluster(Int_t &ci){
  //--------------------------------------------------------------------
  // This function returns clusters within the "window" 
  //--------------------------------------------------------------------
  IlcTARGETRecPoint *c=0;
  ci=-1;
  if (fNsel) {
     fNsel--;
     ci=fIndex[fNsel]; 
...
Int_t IlcTARGETtrackerV2::IlcTARGETlayer::GetNumberOfClusters() const {
  Int_t n=0;
...
Int_t 
IlcTARGETtrackerV2::IlcTARGETlayer::FindDetectorIndex(Double_t phi,Double_t z)const {
  //--------------------------------------------------------------------
...
Double_t 
IlcTARGETtrackerV2::IlcTARGETlayer::GetThickness(Double_t y,Double_t z,Double_t &x0)
const {
  //--------------------------------------------------------------------
...
Double_t IlcTARGETtrackerV2::GetEffectiveThickness(Double_t y,Double_t z) const
{
  //--------------------------------------------------------------------
...
Bool_t IlcTARGETtrackerV2::RefitAt(Double_t xx,IlcTARGETtrackV2 *t,
                                const IlcTARGETtrackV2 *c, Bool_t extra) {
  //--------------------------------------------------------------------
  ...
  for (Int_t i=from; i != to; i += step) {
     ...
     if (idx>0) {
        ...
        Double_t chi2=t->GetPredictedChi2(rp);
        if (chi2<maxchi2) { 
	  cl=rp; 
	  maxchi2=chi2; 
	} else {
     ...
     if (extra) { //search for extra clusters
        ...
        const IlcTARGETRecPoint *rp=0; Int_t ci=-1,cci=-1;
        maxchi2=1000.*kMaxChi2;
        Double_t tolerance=0.1;
        while ((rp=layer.GetNextCluster(ci))!=0) {
           if (idet == rp->GetDetectorIndex()) continue;

	   const IlcTARGETdetector &ddet=layer.GetDetector(rp->GetDetectorIndex());

           if (!tmp.Propagate(ddet.GetPhi(),ddet.GetR())) continue;
           
	   if (TMath::Abs(tmp.GetZ() - rp->GetZ()) > tolerance) continue;
           if (TMath::Abs(tmp.GetY() - rp->GetY()) > tolerance) continue;

           Double_t chi2=tmp.GetPredictedChi2(rp);
           if (chi2<maxchi2) { maxchi2=chi2; cci=ci; }
        }
        if (cci>=0) t->SetExtraCluster(i,(i<<kClusterLayerShift)+cci);
     }
...
void IlcTARGETtrackerV2::UseClusters(const IlcKalmanTrack *t, Int_t from) const {
  //--------------------------------------------------------------------
  ...
  IlcTARGETRecPoint *c= 0x0;

  if (clusterIndex>-1)
    c = (IlcTARGETRecPoint *)GetCluster(clusterIndex);
