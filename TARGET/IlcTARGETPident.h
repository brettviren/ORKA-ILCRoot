#ifndef ILCTARGETPIDENT_H
#define ILCTARGETPIDENT_H
...
class IlcTARGETPident : public TObject{

 public:
  IlcTARGETPident();
  IlcTARGETPident(Double_t mom,Double_t invPt,Double_t dEdx,IlcTARGETSteerPid *sp,Float_t *Qlay,Float_t priorip=0.066,Float_t priorik=0.103,Float_t prioripi=0.83,Float_t priorie=0.001);
  
  IlcTARGETPident(IlcTARGETtrackV2 *trackTARGET,IlcTARGETSteerPid *sp,Float_t *Qlay,Float_t priorip=0.066,Float_t priorik=0.103,Float_t prioripi=0.83,Float_t priorie=0.001);

  virtual ~IlcTARGETPident();
 ...
 private:
  ...
  IlcTARGETPident(const IlcTARGETPident &ob); // copy constructor
  IlcTARGETPident& operator=(const IlcTARGETPident & /* source */); // ass. op.
