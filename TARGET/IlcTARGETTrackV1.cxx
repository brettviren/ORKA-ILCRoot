...
ClassImp(IlcTARGETTrackV1)

IlcTARGETTrackV1::IlcTARGETTrackV1() {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it 
// default constructor   
...
IlcTARGETTrackV1::IlcTARGETTrackV1(Double_t fieldfactor) {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it 
// default constructor   
...
IlcTARGETTrackV1::IlcTARGETTrackV1(const IlcTARGETTrackV1 &cobj) : TObject(cobj) {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
// copy constructor    
...
IlcTARGETTrackV1::IlcTARGETTrackV1(IlcTPCtrack &obj, Double_t fieldfactor)
{ 
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it 
// special constructor to convert a TPC track into an TARGET track
...
//////////////////////////////////////// gets magnetic field factor ////////////////////////////////
  ...
  // fFieldFactor =(Double_t)fieldPointer-> SolenoidField()/10/.2;
    fFieldFactor = fieldfactor;
 // cout<< " field factor dentro ilctrack = "<<fFieldFactor<<"\n";/* getchar();*/
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ftgl2.ResizeTo(6); 
  fdtgl.ResizeTo(6); 
  IlcGenerator *gener = gIlc->Generator();
  Float_t vxg,vyg,vzg;
...
void IlcTARGETTrackV1::PutCElements(Double_t C00, Double_t C10, Double_t C11, Double_t C20, Double_t C21, 
...
void IlcTARGETTrackV1::GetCElements(Double_t &C00, Double_t &C10, Double_t &C11, Double_t &C20, Double_t &C21, 
Double_t &C22, Double_t &C30, Double_t &C31, Double_t &C32, Double_t &C33, Double_t &C40, 
...
void IlcTARGETTrackV1::GetXElements(Double_t &X0, Double_t &X1, Double_t &X2, Double_t &X3, Double_t &X4) const {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
// gets the elements of the state vector
  X0=fX0; X1=fX1; X2=fX2; X3=fX3; X4=fX4; 
}

void IlcTARGETTrackV1::PutXElements(Double_t X0, Double_t X1, Double_t X2, Double_t X3, Double_t X4){
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
// puts the elements of the state vector
  fX0=X0; fX1=X1; fX2=X2; fX3=X3; fX4=X4; 
}   

void IlcTARGETTrackV1::LmTPC() {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
// Transform the TPC state vector from TPC-local to master and build a new state vector TARGET-type
...
IlcTARGETTrackV1 &IlcTARGETTrackV1::operator=(IlcTARGETTrackV1 obj) {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it  
...
void IlcTARGETTrackV1::PutCluster(Int_t layerc, TVector vecclust) {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
...
void IlcTARGETTrackV1::GetClusters() {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
...
TVector IlcTARGETTrackV1::GetLabTrack(Int_t lay) {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
...
void IlcTARGETTrackV1::Search(TVector VecTotLabref, Long_t &labref, Int_t &freq){
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it  
// define label
...
void IlcTARGETTrackV1::Propagation(Double_t rk) {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it  
...
void IlcTARGETTrackV1::AddEL(Double_t signdE, Bool_t flagtot, Double_t mass) {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it  
//  add energy loss
// IlcTARGETRad *rl was passed as argument. Now rl has been commented out
...
void  IlcTARGETTrackV1::Correct(Double_t rk) {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it  
...
void IlcTARGETTrackV1::AddMS(Double_t mass) {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it       
...
void IlcTARGETTrackV1::PrimaryTrack() {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it  
...
Int_t IlcTARGETTrackV1::DoNotCross(Double_t rk) const{
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it  
...
Double_t IlcTARGETTrackV1::ArgA(Double_t rk) const {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
// quantity usefull in Propagation  
  ...
  //cout<<"class IlcTARGETTrack: ArgA out of range !\n";/* getchar();*/
...
// quantity usefull in Propagation 
  ...
  if (arg<0.) {/*cout<<"class IlcTARGETTrack: Arga out of range !\n";*/ arg=0.;} 
  return cy*TMath::Sqrt(arg);
}
   	
Double_t IlcTARGETTrackV1::ArgB(Double_t rk) const {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
// quantity usefull in Propagation 
  Double_t c=fX4;
  Double_t d=fX2;
...
Double_t IlcTARGETTrackV1::ArgC(Double_t rk) const {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
// quantity usefull in Propagation 
  Double_t c=fX4;
  Double_t d=fX2;
...
Double_t IlcTARGETTrackV1::GetPredChi2(Double_t m[2], Double_t sigma[2] ) const {
//Origin  A. Badala' and G.S. Pappalardo:  e-mail Angela.Badala@ct.infn.it, Giuseppe.S.Pappalardo@ct.infn.it
