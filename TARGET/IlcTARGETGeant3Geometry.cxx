...
/* $Id: IlcTARGETGeant3Geometry.cxx,v 1.1.1.1 2008/03/11 14:52:51 vitomeg Exp $ */
...
ClassImp(IlcTARGETGeant3Geometry)

IlcTARGETGeant3Geometry::IlcTARGETGeant3Geometry(){
// Constructor
...
//----------------------------------------------------------------------
Int_t IlcTARGETGeant3Geometry::NChildren(Int_t idvol){
//
...
//----------------------------------------------------------------------
Int_t IlcTARGETGeant3Geometry::GetShape(Int_t idvol,Int_t &npar,Int_t &natt,
...
//----------------------------------------------------------------------
Int_t IlcTARGETGeant3Geometry::Child(Int_t idvol, Int_t idc){
//
...
//----------------------------------------------------------------------
Int_t IlcTARGETGeant3Geometry::Medium(Int_t idvol){
//
...
//----------------------------------------------------------------------
Int_t IlcTARGETGeant3Geometry::Material(Int_t idvol){
...
//----------------------------------------------------------------------
void IlcTARGETGeant3Geometry::GetGeometry(Int_t nlevels,Int_t *lnam,Int_t *lnum,
...
//----------------------------------------------------------------------
Int_t IlcTARGETGeant3Geometry::StringToInt(char *name){
