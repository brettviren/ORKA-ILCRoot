#ifndef ILCTARGETVERTEXERZ_H
#define ILCTARGETVERTEXERZ_H
...
class IlcTARGETVertexerZ : public IlcTARGETVertexer {

 public:

  IlcTARGETVertexerZ();
  IlcTARGETVertexerZ(TString filename,Float_t x0=0., Float_t y0=0.);
  virtual ~IlcTARGETVertexerZ();
  // The number of contributors set in the IlcESDVertex object is the
 ...
 protected:
// // // //   IlcTARGETVertexerZ(const IlcTARGETVertexerZ& vtxr);
  IlcTARGETVertexerZ& operator=(const IlcTARGETVertexerZ& /* vtxr */);
