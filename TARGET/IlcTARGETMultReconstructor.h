#ifndef ILCTARGETMULTRECONSTRUCTOR_H
#define ILCTARGETMULTRECONSTRUCTOR_H
/* Copyright(c) 2005-2006, ILC Project Experiment, All rights reserved.   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcTARGETMultReconstructor.h,v 1.1.1.1 2008/03/11 14:52:51 vitomeg Exp $ */
...
class IlcTARGETMultReconstructor : public TObject 
{
public:
  IlcTARGETMultReconstructor();
  virtual ~IlcTARGETMultReconstructor();

  void SetGeometry(IlcTARGETgeom* geo) {fGeometry = geo;}
...
protected:
  ...
  IlcTARGETgeom*   fGeometry;            // TARGET geometry
  
  Float_t**     fClustersLay1;        // clusters in the 1st layer of TARGET 
  Float_t**     fClustersLay2;        // clusters in the 2nd layer of TARGET 
  ...
  ClassDef(IlcTARGETMultReconstructor,0)
};
