#ifndef ILCTARGETEVENTHEADER_H
#define ILCTARGETEVENTHEADER_H
...
class IlcTARGETEventHeader : public IlcDetectorEventHeader {
 
 public:


  IlcTARGETEventHeader(const char* name);
  IlcTARGETEventHeader();

  virtual ~IlcTARGETEventHeader() {}
 ...
 protected:
  ...
  ClassDef(IlcTARGETEventHeader,1)  // An Ilc TARGET event header 
