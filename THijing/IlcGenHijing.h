#ifndef ILCGENHIJING_H
#define ILCGENHIJING_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcGenHijing.h 51126 2011-08-17 13:37:49Z cvetan $ */
...
class IlcGenHijing : public IlcGenMC
{
    enum {kNoTrigger, kHardProcesses, kDirectPhotons};

 public:
    IlcGenHijing();
    IlcGenHijing(Int_t npart);
    virtual ~IlcGenHijing();
...
// ZDC proposal (by Chiara) to store num. of SPECTATORS protons and neutrons
    ...
    IlcGenHijingEventHeader     fHeader; // MC Header
    
 private:
    IlcGenHijing(const IlcGenHijing &Hijing);
    IlcGenHijing &  operator=(const IlcGenHijing & rhs);
    ...
    ClassDef(IlcGenHijing, 8) // IlcGenerator interface to Hijing
};
#endif
