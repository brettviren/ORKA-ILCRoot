...
/* $Id: IlcGenHijing.cxx 51126 2011-08-17 13:37:49Z cvetan $ */
...
ClassImp(IlcGenHijing)

IlcGenHijing::IlcGenHijing()
    :IlcGenMC(),
     fFrame("CMS"),
     fMinImpactParam(0.),
     fMaxImpactParam(5.),
     ...
     fHeader(IlcGenHijingEventHeader("Hijing"))
{
  // Constructor
  fEnergyCMS = 5500.;
  IlcHijingRndm::SetHijingRandom(GetRandom());
}

IlcGenHijing::IlcGenHijing(Int_t npart)
    :IlcGenMC(npart),
     fFrame("CMS"),
     fMinImpactParam(0.),
     fMaxImpactParam(5.),
...
void IlcGenHijing::KeepFullEvent()
{
    fKeep=1;
}

void IlcGenHijing::EvaluateCrossSections()
{
...
Bool_t IlcGenHijing::DaughtersSelection(const TParticle* iparticle)
{
//
...
Bool_t IlcGenHijing::SelectFlavor(Int_t pid)
{
...
Bool_t IlcGenHijing::Stable(const TParticle*  particle) const
{
...
Bool_t IlcGenHijing::CheckTrigger()
{
