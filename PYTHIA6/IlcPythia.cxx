...
/* $Id: IlcPythia.cxx 54863 2012-02-28 12:10:29Z hristov $ */
...
IlcPythia* IlcPythia::fgIlcPythia=NULL;
...
IlcPythia::IlcPythia(const IlcPythia& pythia):
    TPythia6(pythia), 
    IlcRndm(pythia),
    fProcess(kPyMb),
    fEcms(0.),
...
void IlcPythia::ProcInit(Process_t process, Float_t energy, StrucFunc_t strucfunc, Int_t itune)
{
...
//   
	...
	SetMSUB(95,1);	           // low pt production
        ...
        SetMSTP(51,IlcStructFuncType::PDFsetIndex(kCTEQ6ll));      // CTEQ6ll pdf
	SetMSTP(52,2);
	SetMSTP(68,1);
	SetMSTP(70,2);
...
Int_t IlcPythia::CheckedLuComp(Int_t kf)
{
...
void IlcPythia::SetNuclei(Int_t a1, Int_t a2, Int_t pdf)
{
...
IlcPythia* IlcPythia::Instance()
{ 
// Set random number generator 
    if (fgIlcPythia) {
	return fgIlcPythia;
    } else {
	fgIlcPythia = new IlcPythia();
	return fgIlcPythia;
    }
}

void IlcPythia::PrintParticles()
{ 
...
void  IlcPythia::ResetDecayTable()
{
...
void  IlcPythia::Pyclus(Int_t& njet)
{
...
void  IlcPythia::Pycell(Int_t& njet)
{
...
void  IlcPythia::Pyshow(Int_t ip1, Int_t ip2, Double_t qmax)
{
//  Call Pythia jet reconstruction algorithm
//
    pyshow(ip1, ip2, qmax);
...
void IlcPythia::Pyrobo(Int_t imi, Int_t ima, Double_t the, Double_t phi, Double_t bex, Double_t bey, Double_t bez)
{
    pyrobo(imi, ima, the, phi, bex, bey, bez);
}

void IlcPythia::Pytune(Int_t itune)
{
/*
C
...
void IlcPythia::Py2ent(Int_t idx, Int_t pdg1, Int_t pdg2, Double_t p){
  // Inset 2-parton system at line idx
  py2ent(idx, pdg1, pdg2, p);
}


void IlcPythia::InitQuenching(Float_t cMin, Float_t cMax, Float_t k, Int_t iECMethod, Float_t zmax, Int_t ngmax)
{
// Initializes 
...
void IlcPythia::Pyquen(Double_t a, Int_t ibf, Double_t b)
{
...
void IlcPythia::SetPyquenParameters(Double_t t0, Double_t tau0, Int_t nf, Int_t iengl, Int_t iangl)
{
...
void IlcPythia::Pyevnw()
{
    // New multiple interaction scenario
    pyevnw();
}

void  IlcPythia::Pyshowq(Int_t ip1, Int_t ip2, Double_t qmax)
{
    //  Call medium-modified Pythia jet reconstruction algorithm
    //
    pyshowq(ip1, ip2, qmax);
}
 void IlcPythia::Qpygin0()                                                                      
 {                                                                                              
     // New multiple interaction scenario                                                       
     qpygin0();                                                                                 
 }

void IlcPythia::GetQuenchingParameters(Double_t& xp, Double_t& yp, Double_t z[4])
{
...
void IlcPythia::ConfigHeavyFlavor()
{
    //
...
void IlcPythia::AtlasTuning()
{
    ...
    SetMSTP(51, IlcStructFuncType::PDFsetIndex(kCTEQ5L));      // CTEQ5L pdf
    SetMSTP(81,1);             // Multiple Interactions ON
    SetMSTP(82,4);             // Double Gaussian Model
...
void IlcPythia::AtlasTuningMC09()
{
    //
    // Configuration for the ATLAS tuning
    if (fItune > -1) return;
...
IlcPythia& IlcPythia::operator=(const  IlcPythia& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return *this;
 ...
 void IlcPythia::Copy(TObject&) const
{
    //
    // Copy 
    //
