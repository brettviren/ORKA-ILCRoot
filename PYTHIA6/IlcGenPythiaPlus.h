#ifndef ILCGENPYTHIAPLUS_H
#define ILCGENPYTHIAPLUS_H
...
class IlcGenPythiaPlus : public IlcGenMC
{
 public:
    ...
    IlcGenPythiaPlus();
    IlcGenPythiaPlus(IlcPythiaBase* pythia);
    virtual ~IlcGenPythiaPlus();
 ...
 private:
    IlcGenPythiaPlus(const IlcGenPythiaPlus &Pythia);
    IlcGenPythiaPlus & operator=(const IlcGenPythiaPlus & rhs);

    ClassDef(IlcGenPythiaPlus, 2) // IlcGenerator interface to Pythia
};
#endif
