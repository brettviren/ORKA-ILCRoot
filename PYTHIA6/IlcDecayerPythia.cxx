...
/* $Id: IlcDecayerPythia.cxx 58196 2012-08-15 14:35:40Z hristov $ */
...
Bool_t IlcDecayerPythia::fgInit = kFALSE;


IlcDecayerPythia::IlcDecayerPythia():
...
IlcDecayerPythia::IlcDecayerPythia(const IlcDecayerPythia &decayer):
    IlcDecayer(decayer),
    fPythia(0),
    fDecay(kAll),
    fHeavyFlavour(kTRUE),
...
void IlcDecayerPythia::Decay(Int_t idpart, TLorentzVector* p)
{
//  Decay a particle
// 
...
Int_t IlcDecayerPythia::ImportParticles(TClonesArray *particles)
{
...
void IlcDecayerPythia::ForceDecay()
{
...
void  IlcDecayerPythia::SwitchOffHeavyFlavour()
{
...
void  IlcDecayerPythia::ForceBeautyUpgrade()
{
 //
...
void  IlcDecayerPythia::Lu1Ent(Int_t flag, Int_t idpart, 
...
Int_t IlcDecayerPythia::CountProducts(Int_t channel, Int_t particle)
{
...
void IlcDecayerPythia::ForceHadronicD(Int_t optUse4Bodies)
{
//
  ...
  for (Int_t ihadron = 0; ihadron < kNHadrons; ihadron++)
    {
      ...
      if (norm < 1.-1.e-12 || norm > 1.+1.e-12) {
        ...
        IlcWarning(Form("Total branching ratio of %s (PDG code = %d) not equal to 1 (= %f)",pName,hadron[ihadron],norm));
      }
      fBraPart[kc] = norm;
      fPythia->SetMDCY(kc,1,1);	
...
void IlcDecayerPythia::ForceParticleDecay(Int_t particle, Int_t product, Int_t mult)
{
//
//  Force decay of particle into products with multiplicity mult
    ...
    if (norm < 1.-1.e-12 || norm > 1.+1.e-12) {
        ...
        IlcWarning(Form("Total branching ratio of %s (PDG code = %d) not equal to 1 (= %f)",pName,particle,norm));
    }
    fBraPart[kc] = norm;
//
...
void IlcDecayerPythia::ForceParticleDecay(Int_t particle, const Int_t* products, Int_t* mult, Int_t npart, Bool_t flag)
{
//
//  Force decay of particle into products with multiplicity mult
...
void IlcDecayerPythia::DefineParticles()
{
//
//
...
void  IlcDecayerPythia::ForceOmega()
{
...
void  IlcDecayerPythia::ForceLambda()
{
    // Force Lambda -> p pi-
...
void IlcDecayerPythia::SwitchOffBDecay()
{
// Switch off B-decays
...
Float_t  IlcDecayerPythia::GetPartialBranchingRatio(Int_t kf)
{
// Get branching ratio
...
Float_t  IlcDecayerPythia::GetLifetime(Int_t kf)
{
// Get branching ratio
    Int_t kc=fPythia->Pycomp(TMath::Abs(kf));
...
void IlcDecayerPythia::WriteDecayTable()
{
//
...
void IlcDecayerPythia::ReadDecayTable()
{
//
...
void IlcDecayerPythia::Copy(TObject &) const
{
  //
  // Copy *this onto IlcDecayerPythia -- not implemented
  //
