...
/* $Id: IlcHALLv3.cxx 53956 2012-01-17 13:19:32Z morsch $ */
...
IlcHALLv3::IlcHALLv3() : fNewShield24(0), fRefVolumeId(-1), fScoring(0)
{
  //
...
//_____________________________________________________________________________
IlcHALLv3::IlcHALLv3(const char *name, const char *title)
  : IlcHALL(name,title), fNewShield24(0), fRefVolumeId(-1), fScoring(0)
{
  //
...
void IlcHALLv3::StepManager()
{
//
// Stepmanager of IlcHALLv2
...
//
  ...
  //
  AddTrackReference(gIlc->GetMCApp()->GetCurrentTrackNumber(), IlcTrackReference::kHALL);
}
