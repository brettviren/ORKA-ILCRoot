...
/* $Id: IlcHALL.cxx 49869 2011-05-18 04:49:51Z hristov $ */
...
//Begin_Html
/*
<img src="picts/IlcHALLClass.gif">
</pre>
<br clear=left>
...
//_____________________________________________________________________________
IlcHALL::IlcHALL(const char *name, const char *title)
...
void IlcHALL::CreateGeometry()
{
  ...
  */
  ...
  //Begin_Html
  /*
    <img src="picts/IlcHALLSmall.gif">
  */
  //End_Html
  //
  ...
  //Begin_Html
  /*
    <img src="picts/IlcHALLLarge.gif">
  */
  //End_Html
  ...
  trdpar[2] = hullen;
  trdpar[3] = dh / 2.;
  IlcMatrix(idrotm[1900], 90., 0., 0., 0., 90., 90.);
  IlcMatrix(idrotm[1901], 270., 0., 90., 90., 0., 0.);
  gMC->Gsvolu("HUFL", "TRD1", idtmed[1956], trdpar, 4);
  r2 = hullen + 1900.;
  gMC->Gspos("HUFL", 1, "ILCM", 70.,-100-trdpar[3] , -r2, idrotm[1900], "ONLY");
  ...
  gMC->Gspos("HUWA", 1, "ILCM", 70., 40., -1900 - hullen , 0, "ONLY");
  ...
  gMC->Gspos("HHF1", 1, "ILCM", 0., -801., 1350., idrotm[1900], "ONLY");
  gMC->Gspos("HHF1", 2, "ILCM", 0., -801.,-1350., idrotm[1900], "ONLY");
  ...
  gMC->Gspos("HHW1", 1, "ILCM", dx, -896+trapar[3],  1350., 0, "ONLY");
  gMC->Gspos("HHW1", 2, "ILCM",-dx, -896+trapar[3],  1350., idrotm[1901], "ONLY");
  gMC->Gspos("HHW1", 3, "ILCM", dx, -896+trapar[3], -1350., 0, "ONLY");
  gMC->Gspos("HHW1", 4, "ILCM",-dx, -896+trapar[3], -1350., idrotm[1901], "ONLY");
  pbox[0] = 50.;
  pbox[1] = (500. - (trapar[3] * 2. - 896.)) / 2.;
  pbox[2] = 1900.;
  gMC->Gsvolu("HBW1", "BOX ", idtmed[1956], pbox, 3);
  gMC->Gspos("HBW1", 1, "ILCM",  1120., 500-pbox[1], 0., 0, "ONLY");
  gMC->Gspos("HBW1", 2, "ILCM", -1120., 500-pbox[1], 0., 0, "ONLY");
  ...
  r2 = cm - 896. + trapar[3];
  gMC->Gspos("HHW2", 1, "ILCM", dx, r2, 0., 0, "ONLY");
  gMC->Gspos("HHW2", 2, "ILCM",-dx, r2, 0., idrotm[1901], "ONLY");
  trapar[3]  = cm / 2.;
  trapar[4]  = w1 + cm / 2.;
  trapar[5]  = w1;
  ...
  r2 = trapar[3] - 896.;
  gMC->Gspos("HHW3", 1, "ILCM", dx, r2, 0., 0, "ONLY");
  gMC->Gspos("HHW3", 2, "ILCM",-dx, r2, 0., idrotm[1901], "ONLY");
  ...
  gMC->Gspos("HPIL", 1, "ILCM", 165.,-706+pbox[1] , -1350., 0, "ONLY");
  gMC->Gspos("HPIL", 2, "ILCM",-165.,-706+pbox[1] , -1350., 0, "ONLY");
  ...
  gMC->Gspos("HMBS", 1, "ILCM", 0., 70., 0., 0, "ONLY");
}

//_____________________________________________________________________________
void IlcHALL::CreateMaterials()
{
  //
...
// Steel  
  ...
  //     Stainless Steel 
  IlcMixture(10, "STAINLESS STEEL1", asteel, zsteel, 7.88, 4, wsteel);
  IlcMixture(30, "STAINLESS STEEL2", asteel, zsteel, 7.88, 4, wsteel);
  IlcMixture(50, "STAINLESS STEEL3", asteel, zsteel, 7.88, 4, wsteel);
  ...
  //  Stainless Steel
  IlcMedium(10, "STST_C0             ", 10, 0, isxfld, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  IlcMedium(30, "STST_C1             ", 30, 0, isxfld, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  IlcMedium(50, "STST_C2             ", 50, 0, isxfld, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
