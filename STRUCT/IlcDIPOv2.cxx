...
/* $Id: IlcDIPOv2.cxx 49869 2011-05-18 04:49:51Z hristov $ */
...
//Begin_Html
/*
<img src="picts/IlcDIPOv2Class.gif">
</pre>
<br clear=left>
...
//_____________________________________________________________________________
IlcDIPOv2::IlcDIPOv2(const char *name, const char *title)
  : IlcDIPO(name,title)
{
  //
...
//_____________________________________________________________________________
void IlcDIPOv2::CreateSpectrometerDipole()
{
  //
  // Creation of the geometry of the magnetic DIPOLE version 2
  //
...
//  dz =  37.65 - 243.55
  ...
  the3 = 90.;
  phi3 = 61.;
  IlcMatrix(idrotm[1800], the1, phi1, the2, phi2, the3, phi3);
  phi2 = 29.;  //90-61
  the3 = -90.;
  phi3 = -61.;
  IlcMatrix(idrotm[1801], the1, phi1, the2, phi2, the3, phi3);
  the1 = 0.;
  phi1 = 0.;
  the2 = 90.;
  phi2 = 151.;
  the3 = 90.;
  phi3 = 61.;
  IlcMatrix(idrotm[1802], the1, phi1, the2, phi2, the3, phi3);
  phi2 = 29.;
  the3 = -90.;
  phi3 = -61.;
  IlcMatrix(idrotm[1803], the1, phi1, the2, phi2, the3, phi3);
...
//*  coil high cuts
  ...
  the3 = 0.;
  phi3 = 0.;
  IlcMatrix(idrotm[1804], the1, phi1, the2, phi2, the3, phi3);
  the1 = 90.;
  phi1 = -61.;
  the2 = 90.;
  phi2 = -151.;
  IlcMatrix(idrotm[1805], the1, phi1, the2, phi2, the3, phi3);
  the1 = 90.;
  phi1 = 119.; //180 -61
  the2 = 90.;
  phi2 = 209.; //270-61
  IlcMatrix(idrotm[1806], the1, phi1, the2, phi2, the3, phi3);
  the1 = 90.;
  phi1 = -119.;
  the2 = 90.;
  phi2 = -209.;
  IlcMatrix(idrotm[1807], the1, phi1, the2, phi2, the3, phi3); 
...
// iron- low cuts
  ...
  the3 = 0.;
  phi3 = 0.;
  IlcMatrix(idrotm[1808], the1, phi1, the2, phi2, the3, phi3);
...
// iron - low cuts
  ...
  the3 = 90.;
  phi3 = 90.;
  IlcMatrix(idrotm[1809], the1, phi1, the2, phi2, the3, phi3);
  ...
  the3 = 90.;
  phi3 = 90.;
  IlcMatrix(idrotm[1810], the1, phi1, the2, phi2, the3, phi3);
  ...
  IlcMatrix(idrotm[1811], 270., 0., 90., 90., 180., 0.);
  gMC->Gspos("DDIP", 1, "ILCM", 0., 0., 0., idrotm[1811], "ONLY");
  gGeoManager->SetVolumeAttribute("DDIP", "SEEN", 0);
}


void IlcDIPOv2::CreateCompensatorDipole()
{
    //
...
// Assemble all
//
    IlcMatrix(idrotm[1811], -90., 0., 90., 90.,   0., 0.);
    IlcMatrix(idrotm[1812],   0., 0., 90., 90.,  90., 0.);  
    IlcMatrix(idrotm[1813], 180., 0., 90., 90.,  90., 0.);
    IlcMatrix(idrotm[1814],   0., 180., 90., 270.,  90., 0.);
    IlcMatrix(idrotm[1815], 180., 180., 90., 270.,  90., 0.);  
...
//  Clamps
    ...
    IlcMatrix(idrotm[1816], 270., 0., 90., 90.,  180., 0.);  
    gMC->Gspos("DCM0", 1, "ILCM",  0., -12.,  1075., idrotm[1816], "ONLY");
}


//_____________________________________________________________________________
void IlcDIPOv2::CreateMaterials()
{
  //
  ...
  //     Copper
  IlcMaterial(17, "COPPER0$   ", 63.55, 29., 8.96, 1.43, 15.1);
  IlcMaterial(37, "COPPER1$   ", 63.55, 29., 8.96, 1.43, 15.1);
  IlcMaterial(57, "COPPER2$   ", 63.55, 29., 8.96, 1.43, 15.1);
  //     Air 
  ...
  //     Coil 
  IlcMixture(14, "Al0$", acoil, zcoil, 2.122, 3, wcoil);
  IlcMixture(34, "Al1$", acoil, zcoil, 2.122, 3, wcoil);
  IlcMixture(54, "Al2$", acoil, zcoil, 2.122, 3, wcoil);

  //RESIN
  IlcMixture(13, "RESIN0$", aresi, zresi, 1.05, 3, wresi);
  IlcMixture(33, "RESIN1$", aresi, zresi, 1.05, 3, wresi);
  IlcMixture(53, "RESIN2$", aresi, zresi, 1.05, 3, wresi);  

  //G10
  IlcMixture(11, "G100$", aG10, zG10, 1.7, 5, wG10);
  IlcMixture(31, "G101$", aG10, zG10, 1.7, 5, wG10);
  IlcMixture(51, "G102$", aG10, zG10, 1.7, 5, wG10); 
  ...
  //    Coil 
  IlcMedium(14, "Coil_C1         ", 14, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  IlcMedium(34, "Coil_C2         ", 34, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  IlcMedium(54, "Coil_C3         ", 54, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);

  //    Resin 
  IlcMedium(13, "RESIN_C0        ", 13, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  IlcMedium(33, "RESIN_C1        ", 33, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  IlcMedium(53, "RESIN_C2        ", 53, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);

  //    G10 
  IlcMedium(11, "G10_C0          ", 11, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  IlcMedium(31, "G10_C1          ", 31, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  IlcMedium(51, "G10_C2          ", 51, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  //
  //    Copper
  IlcMedium(17, "Cu_C0           ", 17, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  IlcMedium(37, "Cu_C1           ", 37, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  IlcMedium(57, "Cu_C2           ", 57, 0, isxfld1, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
