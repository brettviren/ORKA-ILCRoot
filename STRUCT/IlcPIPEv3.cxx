...
/* $Id: IlcPIPEv3.cxx 56417 2012-05-11 08:46:54Z hristov $ */
...
IlcPIPEv3::IlcPIPEv3() : fBeamBackground(0)
{
// Constructor
}

//_____________________________________________________________________________
IlcPIPEv3::IlcPIPEv3(const char *name, const char *title)
  : IlcPIPE(name,title), fBeamBackground(0)
{
// Constructor
}
...
void IlcPIPEv3::CreateGeometry()
{
//
//  Method describing the beam pipe geometry
//
    IlcDebug(1,"Create PIPEv3 geometry");
    Float_t dz, z, zsh, z0;
//
// Rotation Matrices
//
...
//___________________________________________
void IlcPIPEv3::CreateMaterials()
{
  //
  // Define materials for beam pipe
  //

  IlcDebugClass(1,"Create PIPEv3 materials");
  ...
  IlcMixture(17, "VACUUMM$ ", aAir, zAir, dAir1, 4, wAir);
  //
  //     stainless Steel 
  ...
  IlcMedium(17, "VACUUMM", 17, 0, isxfld, sxmgmx, 0.1, stemax, deemax, epsil, stmin);
  //
  //    Steel 
...
TGeoPcon* IlcPIPEv3::MakeMotherFromTemplate(const TGeoPcon* shape, Int_t imin, Int_t imax, Float_t r0, Int_t nz)
{
//
...
TGeoPcon* IlcPIPEv3::MakeInsulationFromTemplate(TGeoPcon* shape)
{
//
...
TGeoVolume* IlcPIPEv3::MakeBellow(const char* ext, Int_t nc, Float_t rMin, Float_t rMax, Float_t dU, Float_t rPlie, Float_t dPlie)
{
...
void IlcPIPEv3::AddAlignableVolumes() const
{
  // 
  IlcInfo("Add PIPE alignable volume");

  if (!gGeoManager) {
    IlcFatal("TGeoManager doesn't exist !");
    return;
  }

  TString symname("CP1");
  TString volpath("/ILCM_1/CP_1/Cp1_1");
  if(!gGeoManager->SetAlignableEntry(symname.Data(),volpath.Data()))
    IlcFatal(Form("Alignable entry %s not created. Volume path %s not valid",
		  symname.Data(),volpath.Data()));

  TString symname2("CP3");
  TString volpath2("/ILCM_1/CP_1/Cp3_1");
