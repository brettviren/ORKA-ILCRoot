...
/* $Id: IlcPIPEv1.cxx 47909 2011-02-28 15:05:53Z fca $ */
...
//_____________________________________________________________________________
IlcPIPEv1::IlcPIPEv1(const char *name, const char *title)
       : IlcPIPE(name,title)
{
  //
...
void IlcPIPEv1::CreateGeometry()
{
  ...
  //Begin_Html
  /*
    <img src="picts/IlcPIPE.gif">
  */
  //End_Html
  //Begin_Html
  /*
    <img src="picts/IlcPIPETree.gif">
  */
  //End_Html
  ...
  gMC->Gspos("QQMO", 1, "ILCM", 0., 0., -dzmo, 0, "ONLY");
  ...
  gMC->Gspos("QN63", 1, "ILCM", 0., 0., zpos, 0, "ONLY");
  
  
  //     Replace Absorber or Shield by Beam-Pipe 
  //     in case they are not selected 
  
  if (gIlc->GetModule("ABSO") == 0) {
    
    gMC->Gspos("QN63", 2, "ILCM", 0., 0., kZFlange, 0, "ONLY");
    r2      = 2.9;
    dr      = .1;
    tpar[0] = 0.;
    tpar[1] = r2 + dr;
    ...
    gMC->Gspos("QDT8", 1, "ILCM", 0., 0., zpos, 0, "ONLY");
    dr      = .015;
    tpar[0] = 0.;
    tpar[1] = r2 + dr;
    ...
    zpos = tpar[2] + kZFlange;
    gMC->Gspos("QDTS", 1, "ILCM", 0., 0., zpos, 0, "ONLY");
  }
  if (gIlc->GetModule("SHIL") == 0) {
    r2      = 2.9;
    dr      = .015;
    tpar[0] = 0.;
    tpar[1] = r2 + dr;
    ...
    gMC->Gspos("QDT9", 1, "ILCM", 0., 0., zpos, 0, "ONLY");
  }
}

//_____________________________________________________________________________
void IlcPIPEv1::CreateMaterials()
{
  //
  ...
  IlcMaterial(16, "VACUUM$ ", 1e-16, 1e-16, 1e-16, 1e16, 1e16);
  IlcMaterial(15, "AIR$      ", 14.61, 7.3, .001205, 30423.24, 67500);
  ...
  IlcMedium(15, "AIR_L3_US", 15, 0, isxfld, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  
  //    Beryllium 
  
  IlcMedium(5, "BE_L3_US", 5, 0, isxfld, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  
  //    Vacuum 
  
  IlcMedium(16, "VA_L3_US", 16, 0, isxfld, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
  
  //    Steel 
  
  IlcMedium(19, "ST_L3_US", 19, 0, isxfld, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
}
