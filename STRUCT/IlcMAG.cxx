...
/* $Id: IlcMAG.cxx 47909 2011-02-28 15:05:53Z fca $ */
...
//_____________________________________________________________________________
IlcMAG::IlcMAG(const char *name, const char *title)
...
void IlcMAG::CreateGeometry()
{
  ...
  */
  ...
  /*
    ...
    <br> Dimensions taken from drawing: ILCL3___00010
  //End_Html
  */
// Octagon
...
void IlcMAG::CreateMaterials()
{
  ...
  //     Aluminum 
  IlcMaterial(9, "Al0$", 26.98, 13., 2.7, 8.9, 37.2);
  IlcMaterial(29, "Al1$", 26.98, 13., 2.7, 8.9, 37.2);
  ...
  //     Iron 
  IlcMaterial(10, "Fe0$", 55.85, 26., 7.87, 1.76, 17.1);
  IlcMaterial(30, "Fe1$", 55.85, 26., 7.87, 1.76, 17.1);
  
  //     Air 
  IlcMixture(15, "AIR0$      ", aAir, zAir, dAir, 4, wAir);
  IlcMixture(35, "AIR1$      ", aAir, zAir, dAir, 4, wAir);
  //     Water
  IlcMixture(16, "WATER", aWater, zWater, 1., 2, wWater);
  ...
  //    WATER
  IlcMedium(16, "WATER             ", 16, 0, isxfld, sxmgmx, tmaxfd, stemax, deemax, epsil, stmin);
}
