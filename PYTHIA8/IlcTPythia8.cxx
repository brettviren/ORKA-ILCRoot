...
ClassImp(IlcTPythia8)

IlcTPythia8*  IlcTPythia8::fgInstance = 0;

//___________________________________________________________________________
IlcTPythia8::IlcTPythia8():
    TGenerator("IlcTPythia8", "IlcTPythia8"),
    fPythia(0),
    fNumberOfParticles(0)
{
   // Constructor
   if (fgInstance) 
      Fatal("IlcTPythia8", "There's already an instance of IlcTPythia8");
...
//___________________________________________________________________________
IlcTPythia8::IlcTPythia8(const char *xmlDir):
    TGenerator("IlcTPythia8", "IlcTPythia8"),
    fPythia(0),
    fNumberOfParticles(0)
{
...
//___________________________________________________________________________
IlcTPythia8* IlcTPythia8::Instance()
{
   // Return an instance of IlcTPythia8
   return fgInstance ? fgInstance : (fgInstance = new IlcTPythia8()) ;
}

//___________________________________________________________________________
Bool_t IlcTPythia8::Initialize(Int_t idAin, Int_t idBin, Double_t ecms)
{
   // Initialization
...
//___________________________________________________________________________
void IlcTPythia8::GenerateEvent()
{
...
//___________________________________________________________________________
Int_t IlcTPythia8::ImportParticles(TClonesArray *particles, Option_t *option)
{
...
//___________________________________________________________________________
TObjArray* IlcTPythia8::ImportParticles(Option_t* /* option */)
{
   // Import particles from Pythia stack
   fParticles->Clear();
...
//___________________________________________________________________________
void IlcTPythia8::ReadString(const char* string) const
{
   // Configuration
...
//___________________________________________________________________________
void  IlcTPythia8::ReadConfigFile(const char* string) const
{
  // Configuration
...
//___________________________________________________________________________
void IlcTPythia8::PrintStatistics() const
{
...
//___________________________________________________________________________
void IlcTPythia8::EventListing() const
{
   // Event listing
   fPythia->event.list();
}
...
//___________________________________________________________________________
void IlcTPythia8::AddParticlesToPdgDataBase() const
{
