...
// Implementation of IlcDecayer using Pythia8
...
#include "IlcDecayerPythia8.h"
#include "ParticleData.h"

ClassImp(IlcDecayerPythia8)

Bool_t IlcDecayerPythia8::fgInit = kFALSE;

IlcDecayerPythia8::IlcDecayerPythia8():
  TVirtualMCDecayer(),
  fPythia8(IlcTPythia8::Instance()),
  fDebug(0),
  fDecay(kAll),
  fHeavyFlavour(kTRUE)
{
...
void IlcDecayerPythia8::Decay(Int_t pdg, TLorentzVector* p)
{
...
//___________________________________________________________________________
Int_t IlcDecayerPythia8::ImportParticles(TClonesArray *particles)
{
...
void IlcDecayerPythia8::ForceDecay()
{
// 
...
Float_t IlcDecayerPythia8::GetPartialBranchingRatio(Int_t ipart)
{
...
Float_t IlcDecayerPythia8::GetLifetime(Int_t kf)
{
...
void  IlcDecayerPythia8::SwitchOffHeavyFlavour()
{
...
void IlcDecayerPythia8::ForceHadronicD(Int_t optUse4Bodies)
{
//
...
//___________________________________________________________________________
void    IlcDecayerPythia8::ReadDecayTable()
{
...
//___________________________________________________________________________
void IlcDecayerPythia8::AppendParticle(Int_t pdg, TLorentzVector* p)
{
...
//___________________________________________________________________________
void IlcDecayerPythia8::ClearEvent()
{
