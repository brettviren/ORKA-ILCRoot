...
/* $Id: IlcGenReaderCwn.cxx 52788 2011-11-12 20:22:48Z morsch $ */

// Read the old ILC event format based on CW-ntuples
// http://consult.cern.ch/ilc/Internal_Notes/1995/32/abstract
...
ClassImp(IlcGenReaderCwn)

IlcGenReaderCwn::IlcGenReaderCwn():
    fNcurrent(0),
    fNparticle(0),
    fNparticleMax(0),
    fTreeNtuple(0),
...
IlcGenReaderCwn::IlcGenReaderCwn(const IlcGenReaderCwn &reader):
    IlcGenReader(reader),
    fNcurrent(0),
    fNparticle(0),
    fNparticleMax(0),
...
Int_t IlcGenReaderCwn::NextEvent() 
{
// Read the next event  
    Int_t nTracks;
    fNparticle = 0;
...
TParticle* IlcGenReaderCwn::NextParticle() 
{
// Read next particle
//  
    Float_t prwn;
...
IlcGenReaderCwn& IlcGenReaderCwn::operator=(const  IlcGenReaderCwn& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return *this;
...
void IlcGenReaderCwn::Copy(TObject&) const
{
    //
    // Copy 
    //
