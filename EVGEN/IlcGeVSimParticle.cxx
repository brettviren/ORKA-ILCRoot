...
/* $Id: IlcGeVSimParticle.cxx 46588 2011-01-23 19:30:14Z morsch $ */

//////////////////////////////////////////////////////////////////////////////
//
// IlcGeVSimParticle is a helper class for GeVSim (IlcGenGeVSim) event generator.
...
ClassImp(IlcGeVSimParticle)


////////////////////////////////////////////////////////////////////////////////////////////////////
IlcGeVSimParticle::IlcGeVSimParticle():
    fPDG(0),
    fModel(0),
    fN(0),
    fMultTotal(kTRUE),
...
IlcGeVSimParticle::IlcGeVSimParticle(Int_t pdg, Int_t model, Float_t multiplicity,
...
void  IlcGeVSimParticle::SetModel(Int_t model) {
  //
  // Set Model (1-7) 
  // For details about standard and custom models refer to ILC NOTE
  //
...
void  IlcGeVSimParticle::SetMultiplicity(Float_t mult) {
  //
...
void IlcGeVSimParticle::SetMultTotal(Bool_t isTotal) {
  //
  // Switch between total multiplicity (kTRUE) and 
  // multiplciity density (kFALSE)
  //
  // If this method is used its overrides mode in IlcGenGeVSim 
  //
...
void IlcGeVSimParticle::SetDirectedSimple(Float_t v1) {
  //
...
void IlcGeVSimParticle::SetEllipticSimple(Float_t v2) {
  //
...
Bool_t IlcGeVSimParticle::IsFlowSimple() const
{
  //
  // Function used by IlcGenGeVSim 
  //
...
void IlcGeVSimParticle::SetDirectedParam(Float_t v11, Float_t v12, Float_t v13, Float_t v14) {
  //
...
void IlcGeVSimParticle::SetEllipticParam(Float_t v21, Float_t pTmax, Float_t v22) {
  //
...
void IlcGeVSimParticle::SetEllipticOld(Float_t v21, Float_t v22, Float_t v23) {
  //
  // Set parameters for Elliptic Flow
  // Actual flow coefficient is calculated as follows
  //
...
Float_t IlcGeVSimParticle::GetDirectedFlow(Float_t pt, Float_t y) {
  //
...
Float_t IlcGeVSimParticle::GetEllipticFlow(Float_t pt, Float_t y) {
  //
