...
//-----------------------------------------------------------------------------
//
// Adaption for IlcRoot
//
// R. Averbeck
// A. Morsch
//
IlcOmegaDalitz::IlcOmegaDalitz():
	IlcDecayer(),
        fEPMass(0),
	fMPMass(0),
	fInit(0)
...
void IlcOmegaDalitz::Init()
{
  ...
  for ( idecay = 1; idecay<=2; idecay++ )
  {
    ...
    for ( ibin = 1; ibin <= nbins; ibin++ )
    {
      ...
      if ( q <= 4.0 * epsilon )
      {
	IlcFatal("Error in calculating Dalitz mass histogram binning!");
      }	
...
void IlcOmegaDalitz::Decay(Int_t idlepton, TLorentzVector* pparent)
{
//-----------------------------------------------------------------------------
//
...
Int_t IlcOmegaDalitz::ImportParticles(TClonesArray *particles)
{
...
void IlcOmegaDalitz::Decay(TClonesArray* array)
{
  //
...
IlcOmegaDalitz& IlcOmegaDalitz::operator=(const  IlcOmegaDalitz& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return *this;
...
void IlcOmegaDalitz::Copy(TObject&) const
{
    //
    // Copy 
    //
...
IlcOmegaDalitz::IlcOmegaDalitz(const IlcOmegaDalitz &dalitz)
  : IlcDecayer(),
    fEPMass(0),
    fMPMass(0),
    fInit(0)
