...
/* $Id: IlcGenDoubleScan.cxx 25922 2008-05-20 08:36:45Z morsch $ */
...
#include "IlcRun.h"
 ...
 ClassImp(IlcGenDoubleScan)
    
 IlcGenDoubleScan::IlcGenDoubleScan()
     :IlcGenScan(-1),
      fDistance(0.)
{
    // Default constructor
...
IlcGenDoubleScan::IlcGenDoubleScan(Int_t npart)
    :IlcGenScan(npart),
     fDistance(0.)
{
// Constructor
...
//____________________________________________________________
void IlcGenDoubleScan::Generate()
{
    //
