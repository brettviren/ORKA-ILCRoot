#ifndef IlcGenAfterBurnerFlow_h
#define IlcGenAfterBurnerFlow_h
...
class IlcGenAfterBurnerFlow : public IlcGenerator {

 public:

  IlcGenAfterBurnerFlow();
  IlcGenAfterBurnerFlow(Float_t reactionPlane);
  ~IlcGenAfterBurnerFlow();
 ...
 private:
  IlcGenAfterBurnerFlow(const IlcGenAfterBurnerFlow&);
  IlcGenAfterBurnerFlow& operator=(const IlcGenAfterBurnerFlow&);
  ...
  ClassDef(IlcGenAfterBurnerFlow,4)
};
#endif
