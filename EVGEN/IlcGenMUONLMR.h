#ifndef IlcGenMUONLMR_h
#define IlcGenMUONLMR_h
...
class IlcGenMUONLMR : public IlcGenMC { 
 public:
 ...
 private:
  IlcGenMUONLMR(const IlcGenMUONLMR &lmr);
  IlcGenMUONLMR & operator=(const IlcGenMUONLMR & rhs);
 ...
 private: 
  ...
  ClassDef(IlcGenMUONLMR, 1)  // example of analysis
}; 
