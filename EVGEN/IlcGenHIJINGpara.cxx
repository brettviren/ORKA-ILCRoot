...
/* $Id: IlcGenHIJINGpara.cxx 51126 2011-08-17 13:37:49Z cvetan $ */
...
//_____________________________________________________________________________
IlcGenHIJINGpara::IlcGenHIJINGpara()
    :IlcGenerator(),
	fNt(-1),
	fNpartProd(0),
	fPi0Decays(kFALSE),
...
//_____________________________________________________________________________
IlcGenHIJINGpara::IlcGenHIJINGpara(Int_t npart)
    :IlcGenerator(npart),
	fNt(-1),
	fNpartProd(npart),
	fPi0Decays(kFALSE),
...
//  Fraction of events corresponding to the selected phi-range    
    ...
    IlcInfo(Form("The number of particles in the selected kinematic region corresponds to %f percent of a full event", 
		 100./ fParentWeight));
...
// of the parametrization
	...
	IlcWarning("THE ALLOWED PSEUDORAPIDITY RANGE (-8. - 8.)");	    
	IlcWarning(Form("YOUR LIMITS: %f %f \n ", etaMin, etaMax));
    }
//
//
    if (fPi0Decays && gMC)
...
//_____________________________________________________________________________
void IlcGenHIJINGpara::Generate()
{
  //
...
// Header
    IlcGenEventHeader* header = new IlcGenEventHeader("HIJINGparam");
// Event Vertex
...
void IlcGenHIJINGpara::SetPtRange(Float_t ptmin, Float_t ptmax) {
    IlcGenerator::SetPtRange(ptmin, ptmax);
}

void IlcGenHIJINGpara::DecayPi0(Float_t* orig, Float_t * p, Float_t time) 
{
//
//    Decay the pi0
...
void IlcGenHIJINGpara::Draw( const char * /*opt*/)
{
    //
