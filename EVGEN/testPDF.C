...
//
    ...
    val[0]  = IlcStructFuncType::PDFsetIndex(pdf);
    IlcStructFuncType::PdfSet(parm, val);
...
Double_t pdf_gl(Double_t* x, Double_t* par)
{
    ...
    IlcStructFuncType::StructA(xx, q, a, upv, dnv, usea, 
...
Double_t mod_gl(Double_t* x, Double_t* par)
{
    ...
    IlcStructFuncType::StructA(xx, q, 1., upv, dnv, usea, 
				   dsea, str, chm, bot, top, gl);
