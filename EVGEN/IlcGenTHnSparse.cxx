...
/*
  Example for generation :
  	IlcGenTHnSparse *gener = new IlcGenTHnSparse();
...
ClassImp(IlcGenTHnSparse)

//_______________________________________________________________________
IlcGenTHnSparse::IlcGenTHnSparse():
  IlcGenerator(),
  fHn(0),
  fFile(0),
  fIpart(0),
...
//_______________________________________________________________________
IlcGenTHnSparse::IlcGenTHnSparse(const IlcGenTHnSparse& func):
  IlcGenerator(),
  fHn(func.fHn),
  fFile(func.fFile),
  fIpart(func.fIpart),
...
//_______________________________________________________________________
IlcGenTHnSparse & IlcGenTHnSparse::operator=(const IlcGenTHnSparse& func)
{
    // Assigment operator
...
//_______________________________________________________________________
void IlcGenTHnSparse::Init()
{
    
    // Initialisation, check consistency of selected file
    printf("************ IlcGenTHnSparse ****************\n");
    printf("*********************************************\n");
    if (!fHn){
	IlcFatal("THnSparse file not specified");
    }
...
//_______________________________________________________________________
void IlcGenTHnSparse::SetThnSparse(char *file_name, char *thn_name)
{
