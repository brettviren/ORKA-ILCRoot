...
/* $Id: IlcGenThetaSlice.cxx 51126 2011-08-17 13:37:49Z cvetan $ */
...
// Based on the IlcGenBox class written by andreas.morsch@cern.ch
//
...
ClassImp(IlcGenThetaSlice)

//_____________________________________________________________________________
IlcGenThetaSlice::IlcGenThetaSlice()
    :IlcGenerator(),
     fIpart(0)
{
  //
...
//_____________________________________________________________________________
IlcGenThetaSlice::IlcGenThetaSlice(Int_t npart)
    :IlcGenerator(npart),
     fIpart(kProton)
{
  //
...
void IlcGenThetaSlice::Generate()
{
  //
