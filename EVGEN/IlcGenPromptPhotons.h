#ifndef ILCGENPROMPTPHOTONS_H
#define ILCGENPROMPTPHOTONS_H
...
class IlcGenPromptPhotons : public IlcGenerator
{
 public:

  IlcGenPromptPhotons();
  IlcGenPromptPhotons(Int_t npart);
  virtual ~IlcGenPromptPhotons();
...
// Setters
 ...
 private:
  ...
  IlcGenPromptPhotons(const IlcGenPromptPhotons & PromptPhotons);
  IlcGenPromptPhotons& operator = (const IlcGenPromptPhotons & PromptPhotons) ;


  ClassDef(IlcGenPromptPhotons, 1) // prompt photon generator
};
#endif
