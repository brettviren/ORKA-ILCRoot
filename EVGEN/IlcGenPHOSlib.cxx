...
/* $Id: IlcGenPHOSlib.cxx 48518 2011-03-17 18:04:32Z morsch $ */
...
//  IlcGenParam  class:
//  IlcGenParam(npar, param,  IlcGenPHOSlib::GetPt(param),
//                            IlcGenPHOSlib::GetY(param),
//                            IlcGenPHOSlib::GetIp(param) )
...
//  with Pions, using the PtScal function taken from IlcGenMUONlib 
//  version ilcroot 3.01
//
...
//
 Double_t IlcGenPHOSlib::PtPion(const Double_t *px, const Double_t *)
{
//     Pion transverse momentum distribtuion taken 
//     from IlcGenMUONlib class, version 3.01 of ilcroot
...
//
 ...
 Double_t IlcGenPHOSlib::YPion( const Double_t *py, const Double_t *)
{
//
// pion y-distribution
//
...
Int_t IlcGenPHOSlib::IpPion(TRandom */*ran*/)
{
...
//
 ...
 Int_t IlcGenPHOSlib::IpChargedPion(TRandom *ran)
{
//                 particle composition pi+, pi0, pi-
//
...
Double_t IlcGenPHOSlib::PtPi0(const Double_t * px, const Double_t *)
{
...
Double_t IlcGenPHOSlib::PtPi0Flat(const Double_t */*px*/, const Double_t *)
{
...
Double_t IlcGenPHOSlib::YPi0Flat( const Double_t */*py*/, const Double_t *)
{
...
//
 ...
 Int_t IlcGenPHOSlib::IpPi0Flat(TRandom *)
{
...
//============================================================= 
//
 Double_t IlcGenPHOSlib::PtScal(Double_t pt, Int_t np)
{
// Mt-scaling
// Fonction for the calculation of the Pt distribution for a 
// given particle np, from the pion Pt distribution using the 
// mt scaling. This function was taken from IlcGenMUONlib 
// ilcroot version 3.01, and was extended for baryons
...
//============================================================================
//    K  A  O  N  S
 Double_t IlcGenPHOSlib::PtKaon( const Double_t *px, const Double_t *)
{
//                kaon
//                pt-distribution
//____________________________________________________________
 ...
 Double_t IlcGenPHOSlib::YKaon( const Double_t *py, const Double_t *)
{
// y-distribution
//____________________________________________________________
 ...
 Int_t IlcGenPHOSlib::IpKaon(TRandom *ran)
{
...
//
 ...
 Int_t IlcGenPHOSlib::IpChargedKaon(TRandom *ran)
{
//                 particle composition
//
...
Int_t IlcGenPHOSlib::IpKaon0L(TRandom *)
{
  //                 particle composition
  //
...
//============================================================================
//   E  T  A  S
 Double_t IlcGenPHOSlib::PtEta( const Double_t *px, const Double_t *)
{
//                etas
//                pt-distribution
//____________________________________________________________
 ...
 Double_t IlcGenPHOSlib::YEta( const Double_t *py, const Double_t *)
{
// y-distribution
//____________________________________________________________
 ...
 Int_t IlcGenPHOSlib::IpEta(TRandom *)
{
//                 particle composition
//
...
Double_t IlcGenPHOSlib::PtEtaFlat(const Double_t */*px*/, const Double_t *)
{
...
Double_t IlcGenPHOSlib::YEtaFlat( const Double_t */*py*/, const Double_t *)
{
//
// pion y-distribution
//
 ...
 Int_t IlcGenPHOSlib::IpEtaFlat(TRandom *)
{
//
...
//============================================================================
//    O  M  E  G  A  S
 Double_t IlcGenPHOSlib::PtOmega( const Double_t *px, const Double_t *)
{
// omegas
//                pt-distribution
//____________________________________________________________
 ...
 Double_t IlcGenPHOSlib::YOmega( const Double_t *py, const Double_t *)
{
// y-distribution
//____________________________________________________________
 ...
 Int_t IlcGenPHOSlib::IpOmega(TRandom *)
{
//                 particle composition
//
...
Double_t IlcGenPHOSlib::PtOmegaFlat(const Double_t */*px*/, const Double_t *)
{
...
Double_t IlcGenPHOSlib::YOmegaFlat( const Double_t */*py*/, const Double_t *)
{
...
//
 ...
 Int_t IlcGenPHOSlib::IpOmegaFlat(TRandom *)
{
...
//============================================================================
//    E  T  A  P  R  I  M  E
 Double_t IlcGenPHOSlib::PtEtaprime( const Double_t *px, const Double_t *)
{
// etaprime
//                pt-distribution
//____________________________________________________________
 ...
 Double_t IlcGenPHOSlib::YEtaprime( const Double_t *py, const Double_t *)
{
// y-distribution
//____________________________________________________________
 ...
 Int_t IlcGenPHOSlib::IpEtaprime(TRandom *)
{
//                 particle composition
//
...
//============================================================================
//    P  H  I   S
 Double_t IlcGenPHOSlib::PtPhi( const Double_t *px, const Double_t *)
{
// phi
//                pt-distribution
//____________________________________________________________
 ...
 Double_t IlcGenPHOSlib::YPhi( const Double_t *py, const Double_t *)
{
// y-distribution
//____________________________________________________________
 ...
 Int_t IlcGenPHOSlib::IpPhi(TRandom *)
{
//                 particle composition
//
...
//    B  A  R  Y  O  N  S  == protons, protonsbar, neutrons, and neutronsbars
 Double_t IlcGenPHOSlib::PtBaryon( const Double_t *px, const Double_t *)
{
// baryons
//                pt-distribution
//____________________________________________________________
 ...
 Double_t IlcGenPHOSlib::YBaryon( const Double_t *py, const Double_t *)
{
// y-distribution
//____________________________________________________________
 ...
 Int_t IlcGenPHOSlib::IpBaryon(TRandom *ran)
{
//                 particle composition
//
 ...
 Int_t IlcGenPHOSlib::IpProton(TRandom *)
{
//                 particle composition
//  
        return  2212;   //   p
 ...
 Int_t IlcGenPHOSlib::IpAProton(TRandom *)
{
//                 particle composition
//  
        return  -2212;   //   p bar
 ...
 Int_t IlcGenPHOSlib::IpNeutron(TRandom *)
{
//                 particle composition
//  
        return  2112;   //   n
 ...
 Int_t IlcGenPHOSlib::IpANeutron(TRandom *)
{
//                 particle composition
//  
        return  -2112;   //   n
...
GenFunc IlcGenPHOSlib::GetPt(Int_t param, const char* /*tname*/) const
{
// Return pinter to pT parameterisation
    ...
    switch (param)
      ...
      default:
        func=0;
        printf("<IlcGenPHOSlib::GetPt> unknown parametrisationn");
      }
    return func;
}

GenFunc IlcGenPHOSlib::GetY(Int_t param, const char* /*tname*/) const
{
  ...
  switch (param)
    ...
    default:
      func=0;
      printf("<IlcGenPHOSlib::GetY> unknown parametrisationn");
    }
  return func;
}
typedef Int_t (*GenFuncIp) (TRandom *);
GenFuncIp IlcGenPHOSlib::GetIp(Int_t param,  const char* /*tname*/) const
{
  ...
  switch (param)
    ...
    default:
      func=0;
      printf("<IlcGenPHOSlib::GetIp> unknown parametrisationn");
    }
  return func;
}
