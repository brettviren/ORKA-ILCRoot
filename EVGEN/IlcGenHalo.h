...
/* $Id: IlcGenHalo.h 38750 2010-02-09 08:59:16Z morsch $ */
...
public:
 ...
 protected:
    ...
    Float_t  fWS;                         // ! weight
 private:
    IlcGenHalo(const IlcGenHalo &Halo);
    IlcGenHalo & operator=(const IlcGenHalo & rhs);
    
    ClassDef(IlcGenHalo,1)        // LHC beam halo boundary source
};
#endif
