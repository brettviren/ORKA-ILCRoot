#ifndef ILCGENMUONCOCKTAIL_H
#define ILCGENMUONCOCKTAIL_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */


/* $Id: IlcGenMUONCocktail.h 16640 2007-01-31 09:18:26Z hristov $ */
//
...
class IlcGenMUONCocktail : public IlcGenCocktail
{
 public:
    IlcGenMUONCocktail();
     virtual ~IlcGenMUONCocktail();
    virtual void Init();
    ...
    void    SetInvMassRange(Float_t MassMin, Float_t MassMax) 
      { fInvMassMinCut=MassMin; 
        ...
        fInvMassCut = kTRUE; }
 private:
    IlcGenMUONCocktail(const IlcGenMUONCocktail &cocktail); 
    IlcGenMUONCocktail& operator=(const IlcGenMUONCocktail & rhs);

    //
 private:
    IlcFastGlauber *  fFastGlauber; //! Fast glauber calculations
    ...
    ClassDef(IlcGenMUONCocktail,1)  //  MUON cocktail for physics in the Ilc muon spectrometer
};
