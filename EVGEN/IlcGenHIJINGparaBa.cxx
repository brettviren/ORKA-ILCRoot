...
/* $Id: IlcGenHIJINGparaBa.cxx 51126 2011-08-17 13:37:49Z cvetan $ */
...
IlcGenHIJINGparaBa::IlcGenHIJINGparaBa()
    :IlcGenHIJINGpara(),
     fPtba(0),
     fETAba(0)
{
...
//_____________________________________________________________________________
IlcGenHIJINGparaBa::IlcGenHIJINGparaBa(Int_t npart)
  :IlcGenHIJINGpara(npart),
     fPtba(0),
     fETAba(0)
{
  // 
...
// of the parametrization
	...
	printf("\n \n WARNING FROM IlcGenHIJINGParaBa !");
...
//_____________________________________________________________________________
void IlcGenHIJINGparaBa::Generate()
{
  //
