...
/* $Id: IlcGenAfterBurnerFlow.cxx 48105 2011-03-05 22:04:00Z morsch $ */

///////////////////////////////////////////////////////////////////////////////
// 
// IlcGenAfterBurnerFlow is a After Burner event generator applying flow.
...
ClassImp(IlcGenAfterBurnerFlow)


IlcGenAfterBurnerFlow::IlcGenAfterBurnerFlow():IlcGenerator(),
  fReactionPlane(0),
  fHow(0),
  fCounter(0),
  fStack(0)
...
IlcGenAfterBurnerFlow::IlcGenAfterBurnerFlow(Float_t reactionPlane):IlcGenerator(),
  ...
  fStack(0)
{
  ...
  // but stored and applied in radiants (standard for TParticle & IlcCollisionGeometry) 
...
IlcGenAfterBurnerFlow::~IlcGenAfterBurnerFlow() 
{
  // def. dest.
}

void IlcGenAfterBurnerFlow::SetDirectedSimple(Int_t pdg, Float_t v1) 
{
  //
  // Set Directed Flow 
...
void IlcGenAfterBurnerFlow::SetDirectedParam(Int_t pdg, Float_t v11, Float_t v12, 
...
void IlcGenAfterBurnerFlow::SetEllipticSimple(Int_t pdg, Float_t v2) 
{
  //
  // Set Elliptic Flow
...
void IlcGenAfterBurnerFlow::SetEllipticParam(Int_t pdg, 
...
void IlcGenAfterBurnerFlow::SetEllipticParamPion(Int_t pdg, Float_t v21, 
...
void IlcGenAfterBurnerFlow::SetEllipticParamOld(Int_t pdg, Float_t v21, Float_t v22, Float_t v23) 
{
  //
  // Set Elliptic Flow
  //
...
void IlcGenAfterBurnerFlow::SetNpParams(Int_t order, Float_t p0, Float_t p1, Float_t p2, Float_t p3)
{
  //
...
void IlcGenAfterBurnerFlow::SetFlowParameters(Int_t pdg, Int_t order, Int_t type, 
                                              Float_t v1, Float_t v2,Float_t v3,Float_t v4) 
{
  ...
  if(TMath::Abs(pdg)>=fgkPDG){
    Error("IlcAfterBurnerFlow","Overflow");
    return;
  }
...
void IlcGenAfterBurnerFlow::Init() 
{
  // 
  // Standard IlcGenerator Initializer
  //

  if(fHow == 0)     { Info("IlcGenAfterBurnerFlow", "Using the Hijing R.P. Angle event by event "); }
  else if(fHow == 1){ Info("IlcGenAfterBurnerFlow", "Using a fixed R.P. Angle for every event ") ; }
  else { Info("IlcGenAfterBurnerFlow", 
              "Using a random R.P. Angle event by event ( ! not the same used by Hijing ! ) "); }
}

////////////////////////////////////////////////////////////////////////////////////////////////////

Float_t IlcGenAfterBurnerFlow::GetCoefficient(Int_t pdg, Int_t n, Float_t Pt, Float_t Y) const
{
  //
  // private function
...
Float_t IlcGenAfterBurnerFlow::GetNpNorm(Int_t npart) const
{
  //
...
Bool_t IlcGenAfterBurnerFlow::IsPrimary(Int_t pdg) const
{
...
void IlcGenAfterBurnerFlow::InitPrimaries()
{
...
void IlcGenAfterBurnerFlow::Generate() 
{
  // 
  // IlcGenerator generate function doing actual job.
  // Algorythm:
  //
  ...
  //  gen = (IlcGenCocktailAfterBurner *)gIlc->Generator();
  gen = (IlcGenCocktailAfterBurner *)gIlc->GetMCApp()->Generator();


  IlcGenerator* genHijing = 0 ;
  IlcCollisionGeometry* geom = 0 ;
...
void IlcGenAfterBurnerFlow::Rotate(Int_t i, Double_t phi, Bool_t IsPrim)
{
  // Rotation
