...
ClassImp(IlcGenPromptPhotons)

TF1*    IlcGenPromptPhotons::fgDataPt        = NULL;
TF1*    IlcGenPromptPhotons::fgWSzA          = NULL;
TF1*    IlcGenPromptPhotons::fgWSzB          = NULL;
TF1*    IlcGenPromptPhotons::fgTA            = NULL;
TF1*    IlcGenPromptPhotons::fgTB            = NULL;
TF1*    IlcGenPromptPhotons::fgTAxTB         = NULL;
TF1*    IlcGenPromptPhotons::fgTAB           = NULL;

//_____________________________________________________________________________
IlcGenPromptPhotons::IlcGenPromptPhotons()
    :IlcGenerator(-1),
        fAProjectile(0.),
        fATarget(0.),
        fEnergyCMS(0.),
...
//_____________________________________________________________________________
IlcGenPromptPhotons::IlcGenPromptPhotons(Int_t npart)
    :IlcGenerator(npart),
        fAProjectile(208),
        fATarget(208),
        fEnergyCMS(5500.),
...
//_____________________________________________________________________________
void IlcGenPromptPhotons::Generate()
{
  //
...
// Header
    IlcGenEventHeader* header = new IlcGenEventHeader("PromptPhotons");
// Event Vertex
...
void IlcGenPromptPhotons::SetPtRange(Float_t ptmin, Float_t ptmax) {
    IlcGenerator::SetPtRange(ptmin, ptmax);
}

void IlcGenPromptPhotons::SetYRange(Float_t ymin, Float_t ymax) {
    IlcGenerator::SetYRange(ymin, ymax);
}

//**********************************************************************************
Double_t IlcGenPromptPhotons::FitData(const Double_t* x, const Double_t* par) {
//---------------------------------------------------
// input:
// x[0] - p_t (GeV).
// par[0]=sqrt(s_NN) (GeV),
...
//**********************************************************************************
Double_t IlcGenPromptPhotons::WSforNorm(const Double_t* x, const Double_t* par) {
//---------------------------------------------------
// input:
// x[0] - r (fm)
// par[0] - R (fm), radius
...
//**********************************************************************************
Double_t IlcGenPromptPhotons::WSz(const Double_t* x, const Double_t* par) {
//---------------------------------------------------
// input:
// x[0] - z (fm)
// par[0] - R (fm), radius
...
//**********************************************************************************
Double_t IlcGenPromptPhotons::TA(const Double_t* x, const Double_t* par) {
//---------------------------------------------------
// input:
...
//**********************************************************************************
Double_t IlcGenPromptPhotons::TB(const Double_t* x, const Double_t* par) {
//---------------------------------------------------
// input:
// x[0] - phi (rad)
...
//**********************************************************************************
Double_t IlcGenPromptPhotons::TAxTB(const Double_t* x, const Double_t* par) {
//---------------------------------------------------
// input:
// x[0] - s (fm)
// par[0] - RBMAX (fm), max. value of target radius
...
// ---------------------------------------------------------------------------------
Double_t IlcGenPromptPhotons::TAB(const Double_t* x, const Double_t* par) {
//---------------------------------------------------
// input:
// x[0] - b (fm), impact parameter
// par[0] - RAMAX (fm), max. value of projectile radius
