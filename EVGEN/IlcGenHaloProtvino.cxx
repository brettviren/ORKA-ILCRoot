...
/* $Id: IlcGenHaloProtvino.cxx 54037 2012-01-21 07:39:10Z hristov $ */
...
ClassImp(IlcGenHaloProtvino)

IlcGenHaloProtvino::IlcGenHaloProtvino()
    :IlcGenerator(-1), 
     fFile(0),
     fFileName(0),
     fSide(1),
...
IlcGenHaloProtvino::IlcGenHaloProtvino(Int_t npart)
    :IlcGenerator(npart),
     fFile(0),
     fFileName(0),
     fSide(1),
...
//____________________________________________________________
void IlcGenHaloProtvino::Generate()
{
...
Float_t IlcGenHaloProtvino::GasPressureWeight(Float_t zPrimary)
{
//
...
void IlcGenHaloProtvino::Draw(Option_t *)
{
