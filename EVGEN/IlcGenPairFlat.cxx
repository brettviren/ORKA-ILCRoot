...
ClassImp(IlcGenPairFlat)

//_____________________________________________________________________________
IlcGenPairFlat::IlcGenPairFlat()
    :IlcGenerator(), 
     fPairNpart(10),
     fPairYMin(-10.),
     fPairYMax(10.),
...
void IlcGenPairFlat::Init()
{
	//
	// Init
	//

	printf("IlcGenPairFlat::Init() not implemented!!!\n");
...
Bool_t IlcGenPairFlat::Decay(TLorentzVector& mother, TLorentzVector &dau1, TLorentzVector &dau2, TF1* polfactor)
{
	//
	// decay procedure
	//
