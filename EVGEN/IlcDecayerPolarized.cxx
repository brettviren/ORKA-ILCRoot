...
ClassImp(IlcDecayerPolarized)



//____________________________________________________________
IlcDecayerPolarized::IlcDecayerPolarized():
    fAlpha(0),
    fSystRef(kHelicity),
    fDecProd(kMuon),
    fPol(0),
...
//____________________________________________________________
IlcDecayerPolarized::IlcDecayerPolarized(Double_t alpha, Polar_t systref, FinState_t decprod):
    fAlpha(alpha),
    fSystRef(systref),
    fDecProd(decprod),
...
// Another constructor
	...
	IlcFatal("Only polarized decay into muons or electrons is implemented!");
}

IlcDecayerPolarized::IlcDecayerPolarized(const IlcDecayerPolarized &decayer):
    IlcDecayer(decayer),
    fAlpha(0),
    fSystRef(kHelicity),
    fDecProd(kMuon),
...
//____________________________________________________________
void IlcDecayerPolarized::Decay(Int_t ipart, TLorentzVector *p)
{
// Polarized 2- body decay 
    ...
    if(ipart!= (pDataBase->GetParticle("J/psi")->PdgCode()) &&
       ...
       ipart!= (pDataBase->GetParticle("Upsilon'")->PdgCode()))  
       IlcFatal("Polarized decay only implemented for J/psi, psi', Upsilon and Upsilon' !");
...
//____________________________________________________________
Int_t IlcDecayerPolarized::ImportParticles(TClonesArray *part)
{
...
void  IlcDecayerPolarized::Copy(TObject &) const
{
    //
    // Copy *this onto IlcDecayerPolarized -- not implemented
    //
    Fatal("Copy","Not implemented!\n");
}

void IlcDecayerPolarized::SetForceDecay(Int_t)
{
    // This method is dummy
}

void IlcDecayerPolarized::ForceDecay()
{
    // This method is dummy
    IlcWarning("Method not implemented for this class !\n");
}

Float_t IlcDecayerPolarized::GetPartialBranchingRatio(Int_t)
{
    // This method is dummy
    return  1.;
}

Float_t IlcDecayerPolarized::GetLifetime(Int_t)
{
    // This method is dummy
    IlcWarning("Method not implemented for this class !\n");
    return -1.;
...
void IlcDecayerPolarized::ReadDecayTable()
{
    // This method is dummy
    IlcWarning("Method not implemented for this class !\n");
}
