#ifndef ILCGENPAIRFLAT_H
#define ILCGENPAIRFLAT_H
...
class IlcGenPairFlat : public IlcGenerator
{
 public:
  IlcGenPairFlat();
  virtual ~IlcGenPairFlat(){ }
...
protected:
  ...
  ClassDef(IlcGenPairFlat,1) // Flat random pair generator
};
