...
/* $Id: IlcGenParam.cxx 58196 2012-08-15 14:35:40Z hristov $ */
...
ClassImp(IlcGenParam)

//------------------------------------------------------------

  //Begin_Html
  /*
    <img src="picts/IlcGenParam.gif">
  */
  //End_Html

//____________________________________________________________
    IlcGenParam::IlcGenParam():
	fPtParaFunc(0),
	fYParaFunc(0),
	fIpParaFunc(0),
	fPtPara(0),
...
//____________________________________________________________
IlcGenParam::IlcGenParam(Int_t npart, const IlcGenLib * Library,  Int_t param, const char* tname)
    :IlcGenMC(npart),
...
//____________________________________________________________
IlcGenParam::IlcGenParam(Int_t npart, Int_t param, const char* tname, const char* name):
    IlcGenMC(npart),
    fPtParaFunc(0),
    fYParaFunc (0),
    fIpParaFunc(0),
...
//
    ...
    IlcGenLib* pLibrary = new IlcGenMUONlib();
...
IlcGenParam::IlcGenParam(Int_t npart, Int_t param,
...
//		  
  ...
  IlcGenEventHeader* header = new IlcGenEventHeader("PARAM");
...
Float_t IlcGenParam::GetRelativeArea(Float_t ptMin, Float_t ptMax, Float_t yMin, Float_t yMax, Float_t phiMin, Float_t phiMax)
{
//
...
void IlcGenParam::Draw( const char * /*opt*/)
{
    //
