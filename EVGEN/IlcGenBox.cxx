...
/* $Id: IlcGenBox.cxx 51126 2011-08-17 13:37:49Z cvetan $ */
...
//_____________________________________________________________________________
IlcGenBox::IlcGenBox(Int_t npart)
    :IlcGenerator(npart),
     fIpart(kProton),
     fEtaMin(0),
     fEtaMax(0)
...
void IlcGenBox::Generate()
{
  ...
  //
    ...
    IlcGenEventHeader* header = new IlcGenEventHeader("BOX");
