#ifndef ILCGENREADEREMD_H
#define ILCGENREADEREMD_H
...
// --------------------------------------------------------------------------
class IlcGenReaderEMD : public IlcGenReader
{
 public:
    ...
    IlcGenReaderEMD(const IlcGenReaderEMD &reader);
    virtual ~IlcGenReaderEMD();
    IlcGenReaderEMD & operator=(const IlcGenReaderEMD & rhs);
    // Initialise 
    virtual void Init();
    // Reader
 ...
 private:
    ...
    ClassDef(IlcGenReaderEMD, 2) // Class to read EMD data
};
#endif
