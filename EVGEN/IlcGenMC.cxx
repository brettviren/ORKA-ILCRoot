...
/* $Id: IlcGenMC.cxx 56668 2012-05-24 13:14:33Z hristov $ */

// Base class for generators using external MC generators.
// For example IlcGenPythia using Pythia.
...
Bool_t IlcGenMC::ParentSelected(Int_t ip) const
{
...
Bool_t IlcGenMC::ChildSelected(Int_t ip) const
{
...
Bool_t IlcGenMC::KinematicSelection(const TParticle *particle, Int_t flag) const
{
...
Bool_t IlcGenMC::CheckAcceptanceGeometry(Int_t np, TClonesArray* particles)
{
...
Int_t IlcGenMC::CheckPDGCode(Int_t pdgcode) const
{
//
...
void IlcGenMC::AddHeader(IlcGenEventHeader* header)
{
