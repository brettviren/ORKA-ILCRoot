...
ClassImp(IlcGenReaderSL)


IlcGenReaderSL& IlcGenReaderSL::operator=(const  IlcGenReaderSL& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return *this;
...
void IlcGenReaderSL::Copy(TObject&) const
{
    //
    // Copy 
    //
...
Int_t IlcGenReaderSL::NextEvent()
{
// Read the next event
...
TParticle* IlcGenReaderSL::NextParticle()
{
    // Read next particle
...
void IlcGenReaderSL::RewindEvent()
{
//    fFile->Rewind();
}
