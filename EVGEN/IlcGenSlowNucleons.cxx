...
ClassImp(IlcGenSlowNucleons)

    
IlcGenSlowNucleons::IlcGenSlowNucleons()
    :IlcGenerator(-1),
     fCMS(0.),
     fMomentum(0.),
     fBeta(0.),
...
IlcGenSlowNucleons::IlcGenSlowNucleons(Int_t npart)
    :IlcGenerator(npart),
     fCMS(14000.),
     fMomentum(0.),
     fBeta(0.),
     ...
     fCosThetaGrayHist(),
     fCosTheta(),
     fSlowNucleonModel(new IlcSlowNucleonModel())
{
// Constructor
    fName  = "SlowNucleons";
...
void IlcGenSlowNucleons::FinishRun()
{
// End of run action
...
void IlcGenSlowNucleons::Generate()
{
  //
  // Generate one event
  //
  ...
  // 
	...
	if (fDebug) {
	    ...
	    printf("IlcGenSlowNucleons: Impact parameter from Collision Geometry %f %d %d %d %d\n", 
		   b, nn, nwn, nnw, nwnw);
	}
    }     
...
void IlcGenSlowNucleons::GenerateSlow(Int_t charge, Double_t T, 
...
Double_t IlcGenSlowNucleons::Maxwell(Double_t m, Double_t p, Double_t T)
{
...
void IlcGenSlowNucleons::Lorentz(Double_t m, Double_t beta, Float_t* q)
{
