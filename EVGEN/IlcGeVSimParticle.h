#ifndef ILCGEVSIMPARTICLE_H
#define ILCGEVSIMPARTICLE_H

/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcGeVSimParticle.h 14845 2006-08-15 12:25:37Z morsch $ */
...
class IlcGeVSimParticle : public TObject {
 ...
 public:
  ...
  ////////////////////////////////////////////////////////////////////////////
    ...
    IlcGeVSimParticle();
    IlcGeVSimParticle(Int_t pdg, Int_t model, Float_t multiplicity); 
    IlcGeVSimParticle(Int_t pdg, Int_t model, Float_t multiplicity, 
 ...
 private:
  ...
  Bool_t  fIsSetMult;    // force multiplicity mode or use from IlcGenGeVSim
