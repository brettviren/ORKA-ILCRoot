...
// one should use it together with the IlcGenCocktail class
//
#include "IlcGenKrypton.h"
#include "TPDGCode.h"
//
ClassImp(IlcGenKrypton)

//________________________________________________________________________
IlcGenKrypton::IlcGenKrypton(){
  //
  // Default constructor
  //
}
//________________________________________________________________________
void IlcGenKrypton::Generate(){
...
//________________________________________________________________________
void IlcGenKrypton::KrDecay(Int_t &nelectron, Int_t &ngamma, Double_t *eelectron, Double_t *egamma)
{
