#ifndef ILCGENMUONCOCKTAILPP_H
#define ILCGENMUONCOCKTAILPP_H
...
class IlcGenMUONCocktailpp : public IlcGenCocktail
{
 public:

    IlcGenMUONCocktailpp();
 ...
 protected:
    ...
    //
 private:
    IlcGenMUONCocktailpp(const IlcGenMUONCocktailpp &cocktail); 
    IlcGenMUONCocktailpp & operator=(const IlcGenMUONCocktailpp &cocktail); 

    void AddReso2Generator(Char_t *nameReso, IlcGenParam* const genReso, Double_t sigmaReso, Double_t polReso);
...
//    Int_t fCMSEnergy; // CMS beam energy
    ...
    ClassDef(IlcGenMUONCocktailpp,5)  //  cocktail for physics in the Ilc
};
