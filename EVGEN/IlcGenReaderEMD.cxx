...
ClassImp(IlcGenReaderEMD)

IlcGenReaderEMD::IlcGenReaderEMD():
    fStartEvent(0),
    fNcurrent(0),  
    fNparticle(0), 
    fTreeNtuple(0),
...
// Std constructor
    ...
    if(fPcToTrack==kAll) printf("\n\t   *** IlcGenReaderEMD will track all produced particles \n\n");
    else if(fPcToTrack==kNotNucleons) printf("\n\t   *** IlcGenReaderEMD will track all produced particles except nucleons\n\n");
    else if(fPcToTrack==kOnlyNucleons) printf("\n\t   *** IlcGenReaderEMD will track only nucleons\n\n");
}


IlcGenReaderEMD::IlcGenReaderEMD(const IlcGenReaderEMD &reader):
    IlcGenReader(reader),
    fStartEvent(0),
    fNcurrent(0),  
    fNparticle(0), 
...
// -----------------------------------------------------------------------------------
IlcGenReaderEMD& IlcGenReaderEMD::operator=(const  IlcGenReaderEMD& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return *this;
...
// -----------------------------------------------------------------------------------
void IlcGenReaderEMD::Copy(TObject&) const
{
    //
    // Copy 
    //
...
// -----------------------------------------------------------------------------------
Int_t IlcGenReaderEMD::NextEvent() 
{
    // Read the next event  
    Int_t nTracks=0;
...
// -----------------------------------------------------------------------------------
TParticle* IlcGenReaderEMD::NextParticle() 
{
