...
/* $Id: IlcDimuCombinator.cxx 48105 2011-03-05 22:04:00Z morsch $ */
...
//
ClassImp(IlcDimuCombinator)

IlcDimuCombinator::IlcDimuCombinator():
    fNParticle((Int_t) (IlcRunLoader::Instance()->TreeK())->GetEntries()),
    fImuon1(0),
    fImuon2(0),
    fImin1(0),
    fImin2(0),
...
IlcDimuCombinator::IlcDimuCombinator(const IlcDimuCombinator & combinator)
    :TObject(combinator),
     fNParticle(0),
     fImuon1(0),
     fImuon2(0),
...
//                       Iterators
// 
TParticle* IlcDimuCombinator::Particle(Int_t i) const
{
//  Return next particle
//
    return gIlc->GetMCApp()->Particle(i);
}

TParticle* IlcDimuCombinator::FirstMuon()
{
...
TParticle* IlcDimuCombinator::FirstMuonSelected()
{
...
TParticle* IlcDimuCombinator::NextMuon()
{
...
TParticle* IlcDimuCombinator::NextMuonSelected()
{
...
void IlcDimuCombinator::FirstPartner()
{
...
void IlcDimuCombinator::FirstPartnerSelected()
{
...
void IlcDimuCombinator::NextPartner()
{
...
void IlcDimuCombinator::NextPartnerSelected()
{
...
TParticle*  IlcDimuCombinator::Partner() const
{
// Returns current partner for muon to form a dimuon
    return fMuon2;
}

void IlcDimuCombinator::FirstMuonPair(TParticle* & muon1, TParticle* & muon2)
{
...
void IlcDimuCombinator::NextMuonPair(TParticle* & muon1, TParticle* & muon2)
{
...
void IlcDimuCombinator::FirstMuonPairSelected(TParticle* & muon1, 
					      TParticle* & muon2)
{
...
void IlcDimuCombinator::NextMuonPairSelected(TParticle* & muon1, 
					     TParticle* & muon2)
{
...
void IlcDimuCombinator::ResetRange()
{
...
void IlcDimuCombinator::SetFirstRange(Int_t from, Int_t to)
{
...
void IlcDimuCombinator::SetSecondRange(Int_t from, Int_t to)
{
...
Bool_t IlcDimuCombinator::Selected(const TParticle* part) const
{
...
Bool_t IlcDimuCombinator::Selected(const TParticle* part1, const TParticle* part2) const
{
...
//                       Kinematics
//
Float_t IlcDimuCombinator::Mass(const TParticle* part1, const TParticle* part2) const
{
// Invariant mass
//
    Float_t px,py,pz,e;
...
Float_t IlcDimuCombinator::PT(const TParticle* part1, const TParticle* part2) const
{
...
Float_t IlcDimuCombinator::Pz(const TParticle* part1, const TParticle* part2) const
{
// Pz of dimuon system
//
...
Float_t IlcDimuCombinator::Y(const TParticle* part1, const TParticle* part2) const
{
...
//                  Response
//
void IlcDimuCombinator::SmearGauss(Float_t width, Float_t & value) const
{
...
Float_t IlcDimuCombinator::DecayProbability(const TParticle* part) const
{
...
//
// this part is still very ILC muon-arm specific
//
...
Float_t IlcDimuCombinator::Weight(const TParticle* part1, const TParticle* part2) const
{
// Dimuon weight
...
<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - the number of generated events --> fParentWeight=1./Float_t(fNpart) in IlcGenPythia.cxx . This
is a normalization to 1 of the number of generated particles.
<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - the kinematic bias coming
from the y and Pt cuts.&nbsp; Method&nbsp; IlcGenPythia::AdjustWeights() in IlcGenPythia.cxx
<BR>(in IlcGenParam.cxx this 2 things are taken into account in fParentWeight
...
Float_t IlcDimuCombinator::Weight(const TParticle* part) const
{
// Single muon weight
    return (part->GetWeight())*(Parent(part)->GetWeight())*fRate1;
}

Bool_t  IlcDimuCombinator::Correlated(const TParticle* part1, const TParticle* part2) const
{
...
TParticle* IlcDimuCombinator::Parent(const TParticle* part) const
{
...
Int_t IlcDimuCombinator::Origin(const TParticle* part) const
{
...
Int_t IlcDimuCombinator::Type(const TParticle *part)  const
{
// Return particle type for 
return part->GetPdgCode();
}

IlcDimuCombinator& IlcDimuCombinator::operator=(const  IlcDimuCombinator& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return *this;
...
void IlcDimuCombinator::Copy(TObject&) const
{
  //
  // Copy 
  //
