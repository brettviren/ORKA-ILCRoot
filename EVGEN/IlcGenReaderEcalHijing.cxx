...
/* $Id: IlcGenReaderEcalHijing.cxx 47231 2011-02-09 12:22:42Z morsch $ */
//
...
ClassImp(IlcGenReaderEcalHijing)

IlcGenReaderEcalHijing::IlcGenReaderEcalHijing():
    fNcurrent(0),
    fNparticle(0),
    fTreeNtuple(0),
    fNjatt(0),
...
IlcGenReaderEcalHijing::IlcGenReaderEcalHijing(const IlcGenReaderEcalHijing &reader):
    IlcGenReader(reader),
    fNcurrent(0),
    fNparticle(0),
    fTreeNtuple(0),
...
void IlcGenReaderEcalHijing::Init() 
{
//
...
Int_t IlcGenReaderEcalHijing::NextEvent() 
{
// Read the next event  
...
TParticle* IlcGenReaderEcalHijing::NextParticle() 
{
...
IlcGenReaderEcalHijing& IlcGenReaderEcalHijing::operator=(const  IlcGenReaderEcalHijing& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return (*this);
...
void IlcGenReaderEcalHijing::Copy(TObject&) const
{
    //
    // Copy 
    //
