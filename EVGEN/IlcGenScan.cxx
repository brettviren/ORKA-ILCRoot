...
/* $Id: IlcGenScan.cxx 14845 2006-08-15 12:25:37Z morsch $ */
...
// Momentum vectors are defined through the methods provided by IlcGenerator.
...
IlcGenScan::IlcGenScan(Int_t npart)
    :IlcGenerator(npart), 
      fXCmin(0),
      fXCmax(0),
      fNx(1),
...
void IlcGenScan::SetRange(Int_t nx, Float_t xmin, Float_t xmax,
