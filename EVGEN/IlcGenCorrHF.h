#ifndef ILCGENCORRHF_H
#define ILCGENCORRHF_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcGenCorrHF.h 52398 2011-10-28 07:03:57Z morsch $ */
...
//-------------------------------------------------------------
class IlcGenCorrHF : public IlcGenMC
{
 public:
    IlcGenCorrHF();
    IlcGenCorrHF(Int_t npart, Int_t idquark, Int_t energy);
    IlcGenCorrHF(char* tname, Int_t npart, Int_t idquark, Int_t energy);
     
    virtual ~IlcGenCorrHF();
 ...
 private:
    IlcGenCorrHF(const IlcGenCorrHF &CorrHF);
    IlcGenCorrHF & operator=(const IlcGenCorrHF & rhs);
    ...
    ClassDef(IlcGenCorrHF,1)  // Generator using parameterized QQbar & fragm. functions
};
#endif
