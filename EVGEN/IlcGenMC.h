...
/* $Id: IlcGenMC.h 48105 2011-03-05 22:04:00Z morsch $ */
...
class IlcGenMC : public IlcGenerator
{
 public:
    IlcGenMC();
    IlcGenMC(Int_t npart);
    virtual ~IlcGenMC();
    virtual void Init();
    ...
    virtual void SetGeometryAcceptance(IlcGeometry * GeometryAcceptance=0) {fGeometryAcceptance = GeometryAcceptance;}
 ...
 protected:
    ...
    IlcGeometry* fGeometryAcceptance; // Geometry to which particles must be simulated
 ...
 private:
    IlcGenMC(const IlcGenMC &MC);
    IlcGenMC & operator=(const IlcGenMC & rhs);
    
    ClassDef(IlcGenMC,7)       // IlcGenerator implementation for generators using MC methods
};
#endif
