#ifndef ILCGENTHERMALPHOTONS_H
#define ILCGENTHERMALPHOTONS_H
...
class IlcGenThermalPhotons : public IlcGenerator
{
 public:

  IlcGenThermalPhotons();
  IlcGenThermalPhotons(Int_t npart);
  virtual ~IlcGenThermalPhotons();
...
// Setters
 ...
 private:
  ...
  IlcGenThermalPhotons(const IlcGenThermalPhotons & ThermalPhotons);
  IlcGenThermalPhotons& operator = (const IlcGenThermalPhotons & ThermalPhotons) ;


  ClassDef(IlcGenThermalPhotons, 1) // Direct thermal photon generator
};
#endif
