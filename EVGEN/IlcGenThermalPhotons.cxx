...
IlcGenThermalPhotons::IlcGenThermalPhotons()
    :IlcGenerator(-1),
        fMinImpactParam(0.),
        fMaxImpactParam(0.),
        fTau0(0.),
...
//_____________________________________________________________________________
IlcGenThermalPhotons::IlcGenThermalPhotons(Int_t npart)
    :IlcGenerator(npart),
        fMinImpactParam(0.),
        fMaxImpactParam(0.),
        fTau0(0.1),
...
//_____________________________________________________________________________
void IlcGenThermalPhotons::Init()
{
    // Initialisation
...
//_____________________________________________________________________________
void IlcGenThermalPhotons::Generate()
{
  //
...
*/
    ...
    delete funcOL;
// Header
    IlcGenEventHeader* header = new IlcGenEventHeader("ThermalPhotons");
// Event Vertex
...
void IlcGenThermalPhotons::SetPtRange(Float_t ptmin, Float_t ptmax) {
    IlcGenerator::SetPtRange(ptmin, ptmax);
}

void IlcGenThermalPhotons::SetYRange(Float_t ymin, Float_t ymax) {
