...
/* $Id: IlcGenBeamGas.cxx 51126 2011-08-17 13:37:49Z cvetan $ */
...
ClassImp(IlcGenBeamGas)

IlcGenBeamGas::IlcGenBeamGas()
    :IlcGenExtFile(), 
     fInteractions(1)
{
//  Constructor
...
//      
      ...
      if (nTracks == 0) {
	  // printf("\n No more events !!! !\n");
	  Warning("IlcGenBeamGas::Generate",
