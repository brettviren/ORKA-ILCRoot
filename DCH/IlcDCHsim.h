...
/* $Id: IlcDCHsim.h,v 1.1.1.1 2008/03/11 14:53:01 vitomeg Exp $ */
...
class IlcDCHsim : public TObject {

 public:

  IlcDCHsim();
  IlcDCHsim(const IlcDCHsim &s);
  IlcDCHsim(IlcModule *mod, Int_t foil, Int_t gap);
  virtual ~IlcDCHsim();
  IlcDCHsim &operator=(const IlcDCHsim &s);
 ...
 protected:
  ...
  ClassDef(IlcDCHsim,2)            // Simulates TR photons
