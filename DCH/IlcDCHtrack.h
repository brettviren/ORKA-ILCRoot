...
/* $Id: IlcDCHtrack.h,v 1.6 2009/06/30 11:17:54 cgatto Exp $ */
...
public:
  ...
  void  SetClusterIndex(Int_t i, Int_t idx) {
    fIndex[i]=idx;
  ...
  Bool_t PropagateTo(Double_t xr, Double_t rho=0.43e-3, Double_t x0=26.64);
...
protected: 
  ...
  Int_t fIndex[kMaxLayer];       // indices of associated clusters 
