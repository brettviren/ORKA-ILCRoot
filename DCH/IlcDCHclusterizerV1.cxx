...
/* $Id: IlcDCHclusterizerV1.cxx,v 1.1.1.1 2008/03/11 14:53:01 vitomeg Exp $ */

///////////////////////////////////////////////////////////////////////////////
//                                                                           //
// DCH cluster finder for the slow simulator. 
//                                                                           //
///////////////////////////////////////////////////////////////////////////////
...
ClassImp(IlcDCHclusterizerV1)

//_____________________________________________________________________________
IlcDCHclusterizerV1::IlcDCHclusterizerV1():IlcDCHclusterizer()
{
  //
  // IlcDCHclusterizerV1 default constructor
  //
...
//_____________________________________________________________________________
IlcDCHclusterizerV1::IlcDCHclusterizerV1(const Text_t* name, const Text_t* title)
...
//_____________________________________________________________________________
IlcDCHclusterizerV1::IlcDCHclusterizerV1(const IlcDCHclusterizerV1 &c)
:IlcDCHclusterizer(c)
{
  //
  // IlcDCHclusterizerV1 copy constructor
  //

  ((IlcDCHclusterizerV1 &) c).Copy(*this);

}

//_____________________________________________________________________________
IlcDCHclusterizerV1::~IlcDCHclusterizerV1()
{
  //
  // IlcDCHclusterizerV1 destructor
  //
...
//_____________________________________________________________________________
IlcDCHclusterizerV1 &IlcDCHclusterizerV1::operator=(const IlcDCHclusterizerV1 &c)
{
  //
  // Assignment operator
  //

  if (this != &c) ((IlcDCHclusterizerV1 &) c).Copy(*this);
  return *this;

}

//_____________________________________________________________________________
void IlcDCHclusterizerV1::Copy(TObject &c) const
{
  //
  // Copy function
  //

  ((IlcDCHclusterizerV1 &) c).fDigitsManager = 0;
...
//_____________________________________________________________________________
Bool_t IlcDCHclusterizerV1::ReadDigits()
{
  //
  ...
  if (!fRunLoader) {
    printf("<IlcDCHclusterizerV1::ReadDigits> ");
...
//_____________________________________________________________________________
Bool_t IlcDCHclusterizerV1::ReadDigits(IlcRawReader* rawReader)
{
  //
...
//_____________________________________________________________________________
Bool_t IlcDCHclusterizerV1::MakeClusters()
{
  //
  ...
  /* 
  if (fDCH->IsVersion() != 1) {
    printf("<IlcDCHclusterizerV1::MakeCluster> ");
  ...
  // Get the geometry
  IlcDCHgeometry *geo = IlcDCHgeometry::GetGeometry(fRunLoader);  printf("OK GEOMETRY   ");
  ...
  {
    printf("<IlcDCHclusterizerV1::MakeCluster> ");
    printf("ERROR getting instance of IlcDCHSimParam");
    return kFALSE;  
  }
  ...
  if (!commonParam)
  {
    printf("<IlcDCHclusterizerV1::MakeDigits> ");
  ...
  IlcDCHdataArrayI *track0;
  IlcDCHdataArrayI *track1;
  IlcDCHdataArrayI *track2; 
  ...
  for (Int_t icham = chamBeg; icham < chamEnd; icham++) {
	...
	Int_t nColMax = commonParam->GetColMax(iplan);
        ...
        digitsIn->Expand();
        IlcDCHdataArrayF *digitsOut = new IlcDCHdataArrayF(digitsIn->GetNrow(), digitsIn->GetNcol(), digitsIn->GetNtime());
...
// 	      }
		...
		clusterPos[1] = padPlane->GetRowPos(row) - 0.5*rowSize; //MI change
                ...
                IlcDCHcluster * cluster = AddCluster(clusterPos
                          ,clusterTimeBin
                          ,idet
			  ,clusterCharge
			  ,clusterTracks
...
//_____________________________________________________________________________
Double_t IlcDCHclusterizerV1::GetCOG(Double_t signal[5])
{
  //
  // get COG position
...
//_____________________________________________________________________________
Double_t IlcDCHclusterizerV1::Unfold(Double_t eps, Int_t plane, Double_t* padSignal)
{
  //
...
//_____________________________________________________________________________
void IlcDCHclusterizerV1::Transform(IlcDCHdataArrayI* digitsIn,
				    ...
				    Float_t ADCthreshold)
{
  ...
  if (!recParam)
  {
    printf("<IlcDCHclusterizerV1::Transform> ");
    printf("ERROR getting instance of IlcDCHRecParam");
    return;
  }
  IlcDCHcalibDB* calibration = IlcDCHcalibDB::Instance();
...
//_____________________________________________________________________________
void IlcDCHclusterizerV1::DeConvExp(Double_t *source, Double_t *target,
				    Int_t n, Int_t nexp) 
{
  //
