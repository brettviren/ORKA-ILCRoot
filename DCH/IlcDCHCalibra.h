#ifndef ILCDCHCILCBRA_H 
#define ILCDCHCILCBRA_H 
/* Copyright(c) 2005-2006, ILC Project Experiment, All rights reserved.   *
 * See cxx source for full Copyright notice                               */ 
 
/* $Id: IlcDCHCalibra.h,v 1.2 2009/12/11 10:40:28 vitomeg Exp $ */ 
 
/////////////////////////////////////////////////////////////////////////////// 
//                                                                           // 
//  DCH calibration class for the HLT parameters                             // 
//                                                                           // 
/////////////////////////////////////////////////////////////////////////////// 
...
class IlcDCHCalibra : public TObject { 
 
 public:  
 
  // Instance 
  static IlcDCHCalibra *Instance(); 
  static void Terminate(); 
  static void Destroy(); 
 
  IlcDCHCalibra(const IlcDCHCalibra &c); 
  IlcDCHCalibra &operator=(const IlcDCHCalibra &) { return *this; } 
  ...
  // Functions for initialising the IlcDCHCalibra in the code 
          Bool_t   Init2Dhistos(); 
 
  // Functions for filling the histos in the code 
          Bool_t   ResetTrack(); 
          Bool_t   UpdateHistograms(IlcDCHcluster *cl, IlcDCHtrack *t); 
          Bool_t   UpdateHistogramcm(IlcDCHmcmTracklet *trk); 
  ...
  TObject         *CreatePadObjectTree(TTree *tree, Int_t i, IlcDCHCalDet *detobject); 
  IlcDCHCalDet    *CreateDetObjectTree(TTree *tree, Int_t i); 
 ...
 protected: 
  ...
  // Debug Mode 
          ...
          Int_t    fDet[3];                 // Detector  visuilcsed (plane,chamb,sect) si debugging == 3 or 4 
          Int_t    fFitVoir;                // Fit visuilcsed si debugging == 2 
  ...
  // Fill the 2D histos in the offline tracking 
          Bool_t   fDetectorIlcDCHtrack;    // Change of track 
          Int_t    fChamberIlcDCHtrack;     // Change of chamber 
  ...
  // Histograms to store the coef 
          ...
          TH2F    *fCoefChargeDB[3];        // Visuilcsation of the coef of the detecteur fDet for the gain 
          TH2F    *fCoefVdriftDB[2];        // Visuilcsation of the coef of the detecteur fDet for the drift velocity 
          TH2F    *fCoefT0DB[2];            // Visuilcsation of the coef of the detecteur fDet for time 0 
          TH2F    *fCoefPRFDB;              // Visuilcsation of the coef of the detecteur fDet for the pad response function 
  ...
  class IlcDCHPlace : public TObject { 
   ...
   public:  
    ...
    IlcDCHPlace() 
      :TObject() 
      ,fPlace(0x0)                                     { } 
    IlcDCHPlace(const IlcDCHPlace &i) 
      :TObject(i) 
      ,fPlace(0x0)                                     { } 
    IlcDCHPlace &operator=(const IlcDCHPlace&)         { return *this;            }  
    virtual ~IlcDCHPlace()                             { } 
  ...
  class IlcDCHCTInfo : public TObject { 
   ...
   public:  
    ...
    IlcDCHCTInfo() 
      :TObject() 
      ,fEntries(0x0)                                   { } 
    IlcDCHCTInfo(const IlcDCHCTInfo &i) 
      :TObject(i) 
      ,fEntries(0x0)                                   { } 
    IlcDCHCTInfo &operator=(const IlcDCHCTInfo&)       { return *this;            }  
    virtual ~IlcDCHCTInfo()                            { } 
  ...
  class IlcDCHFitCHInfo : public TObject { 
   ...
   public: 
    ...
    IlcDCHFitCHInfo() 
      ...
      ,fCoef(0x0) 
      ,fDetector(-1)                                   { }     
    IlcDCHFitCHInfo(const IlcDCHFitCHInfo &i)  
      :TObject(i) 
      ,fCoef(0x0) 
      ,fDetector(-1)                                   { } 
    IlcDCHFitCHInfo &operator=(const IlcDCHFitCHInfo&) { return *this;            } 
    virtual ~IlcDCHFitCHInfo()                         { } 
  ...
  class IlcDCHPInfo : public TObject { 
  public: 
    ...
    IlcDCHPInfo() 
      ...
      ,fSumSquare(0x0) 
      ,fEntries(0x0)                                   { } 
    IlcDCHPInfo(const IlcDCHPInfo &i) 
      :TObject(i) 
      ,fSum(0x0)  
      ,fSumSquare(0x0) 
      ,fEntries(0x0)                                   { }  
    IlcDCHPInfo &operator=(const IlcDCHPInfo&)         { return *this;            } 
    virtual ~IlcDCHPInfo()                             { } 
  ...
  TGraphErrors    *ConvertVectorPHisto(IlcDCHPInfo *pInfo, const Char_t *name) const; 
          TH1F    *ConvertVectorCTHisto(IlcDCHCTInfo *cTInfo, const Char_t *name) const; 
  ...
  static  IlcDCHCalibra *fgInstance;        // Instance 
  static  Bool_t   fgTerminated;            // If terminated 
     
  ClassDef(IlcDCHCalibra, 1)   // DCH Calibration class 
