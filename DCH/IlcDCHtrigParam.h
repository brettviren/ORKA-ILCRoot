#ifndef ILCDCHTRIGPARAM_H
#define ILCDCHTRIGPARAM_H
...
class IlcDCHtrigParam : public TNamed {

 public:

  IlcDCHtrigParam();
  IlcDCHtrigParam(const Text_t* name, const Text_t* title);
  IlcDCHtrigParam(const IlcDCHtrigParam &p);   
  virtual ~IlcDCHtrigParam();
  IlcDCHtrigParam &operator=(const IlcDCHtrigParam &p); 
 ...
 protected:
  ...
  ClassDef(IlcDCHtrigParam,2)              // DCH trigger parameter class
