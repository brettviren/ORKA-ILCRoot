#ifndef ILCDCHMCTRACK_H
#define ILCDCHMCTRACK_H  
...
class IlcDCHmcTrack : public TObject {

// Represents DCH related info about generated track

public:

  IlcDCHmcTrack();
  IlcDCHmcTrack(Int_t label, Int_t seedLabel, Bool_t primary, Float_t mass, 
...
protected:
   ...
   Int_t  fN;               // Number of DCH clusters associated with the track
   Int_t  fIndex[kMAX_TB][6][2]; // Indices of these clusters  
			   
   Double_t Pin[6][3];        // Px,Py,Pz at the entrance of each DCH plane   
   Double_t Pout[6][3];       // Px,Py,Pz at the exit of each DCH plane

   Double_t XYZin[6][3];        // x,y,z at the entrance of the DCH  
   Double_t XYZout[6][3];        // x,y,z at the exit of the DCH    

   ClassDef(IlcDCHmcTrack,1)  // DCH MC track
