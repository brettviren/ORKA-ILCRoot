...
/* $Id: IlcDCHcluster.h,v 1.4 2009/06/30 10:38:10 cgatto Exp $ */
...
//   IlcDCHcluster(Int_t *lab, Float_t *hit) :
//   IlcCluster(lab,hit) {
...
void SetLabelAll(Int_t *lab)		{SetLabel(lab[0],0); SetLabel(lab[1],1); SetLabel(lab[2],2);}
...
// // // //   virtual Float_t GetX()	const {return fX;}
  ...
  Float_t GetZLocal()		const {return (fZLocal<-1e-29?GetZ():fZLocal);}
