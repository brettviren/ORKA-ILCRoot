...
/* $Id: IlcDCHReconstructor.cxx,v 1.6 2009/12/11 10:40:28 vitomeg Exp $ */
...
IlcDCHReconstructor::IlcDCHReconstructor(): IlcReconstructor() {
  ...
  //
  if (!fgkRecoParam) {
    //IlcError("The Reconstruction parameters non initialized - Used default one");
...
//_____________________________________________________________________________
IlcTracker* IlcDCHReconstructor::CreateTracker() const
{
// create a DCH tracker

  IlcDCHParam* param = GetDCHParam();
  if (!param) {
    IlcWarning("Loading default DCH parameters !");
    param = new IlcDCHParam;
  }
...
//_____________________________________________________________________________
IlcDCHParam* IlcDCHReconstructor::GetDCHParam() const
{
// get the DCH parameters
