...
///////////////////////////////////////////////////////////////////////////////
//                                                                           //
//  Creates and handles digits from DCH hits                                 //
//                                                                           //
...
ClassImp(IlcDCHdigitizer)

//_____________________________________________________________________________
IlcDCHdigitizer::IlcDCHdigitizer()
{
  //
  // IlcDCHdigitizer default constructor
  //
...
//_____________________________________________________________________________
IlcDCHdigitizer::IlcDCHdigitizer(const Text_t *name, const Text_t *title)
                :IlcDigitizer(name,title)
{
  //
  // IlcDCHdigitizer constructor
  //
...
//_____________________________________________________________________________
IlcDCHdigitizer::IlcDCHdigitizer(IlcRunDigitizer *manager
                                , const Text_t *name, const Text_t *title)
                :IlcDigitizer(manager,name,title)
{
  //
  // IlcDCHdigitizer constructor
  //
...
//_____________________________________________________________________________
IlcDCHdigitizer::IlcDCHdigitizer(IlcRunDigitizer *manager)
                :IlcDigitizer(manager,"IlcDCHdigitizer","DCH digitizer")
{
  //
  // IlcDCHdigitizer constructor
  //
...
Bool_t IlcDCHdigitizer::Init()
{
  ...
  return IlcDigitizer::Init();

}

//_____________________________________________________________________________
IlcDCHdigitizer::IlcDCHdigitizer(const IlcDCHdigitizer &d):IlcDigitizer(d)
{
  //
  // IlcDCHdigitizer copy constructor
  //

  ((IlcDCHdigitizer &) d).Copy(*this);
...
//_____________________________________________________________________________
IlcDCHdigitizer &IlcDCHdigitizer::operator=(const IlcDCHdigitizer &d)
{
  //
  // Assignment operator
  //

  if (this != &d) ((IlcDCHdigitizer &) d).Copy(*this);
  return *this;

}

//_____________________________________________________________________________
void IlcDCHdigitizer::Copy(TObject &d) const
{
  //
  // Copy function
  //

  ((IlcDCHdigitizer &) d).fRunLoader          = 0;
  ((IlcDCHdigitizer &) d).fDigitsManager      = 0;
  ((IlcDCHdigitizer &) d).fSDigitsManager     = 0;
  ((IlcDCHdigitizer &) d).fSDigitsManagerList = 0;
  ((IlcDCHdigitizer &) d).fDCH                = 0;
  ((IlcDCHdigitizer &) d).fGeo                = 0;
  ((IlcDCHdigitizer &) d).fEvent              = 0;
  ((IlcDCHdigitizer &) d).fMasks              = 0;
  ((IlcDCHdigitizer &) d).fCompress           = fCompress;
  ((IlcDCHdigitizer &) d).fDebug              = fDebug  ;
  ((IlcDCHdigitizer &) d).fSDigits            = fSDigits;
  ((IlcDCHdigitizer &) d).fSDigitsScale       = fSDigitsScale;
  ((IlcDCHdigitizer &) d).fMergeSignalOnly    = fMergeSignalOnly;
  ((IlcDCHdigitizer &) d).fFixedGeometry      = fFixedGeometry;
                                       
  IlcDCHdigitizer& target = (IlcDCHdigitizer &) d;
  
  target.fDiffusionInfo = fDiffusionInfo;
  
  // Do not copy timestructs, just invilcdate lastvdrift.
...
//_____________________________________________________________________________
void IlcDCHdigitizer::Exec(Option_t* option)
{
  //
  ...
  if (optionString.Contains("deb")) {
    ...
    printf("<IlcDCHdigitizer::Exec> ");
    printf("Called with debug option %d\n",fDebug);
  }

  // The IlcRoot file is already connected by the manager
  IlcRunLoader* inrl;
  ...
  if (gIlc) 
   {
    if (fDebug > 0) {
      printf("<IlcDCHdigitizer::Exec> ");
      printf("IlcRun object found on file.\n");
    }
   }
  else {
    inrl = IlcRunLoader::GetRunLoader(fManager->GetInputFolderName(0));
    inrl->LoadgIlc();
    gIlc = inrl->GetIlcRun();
    if (!gIlc)
     {
  ...
  IlcRunLoader* orl = IlcRunLoader::GetRunLoader(fManager->GetOutputFolderName());
  if (InitDetector()) {
    IlcLoader* ogime = orl->GetLoader("DCHLoader");
  ...
  for (iInput = 0; iInput < nInput; iInput++) {
    ...
    inrl = IlcRunLoader::GetRunLoader(fManager->GetInputFolderName(iInput));
    IlcLoader* gime = inrl->GetLoader("DCHLoader");
    ...
    sdigitsManager = new IlcDCHdigitsManager();
    sdigitsManager->SetDebug(fDebug);
    sdigitsManager->SetSDigits(kTRUE);
    
    IlcRunLoader* rl = IlcRunLoader::GetRunLoader(fManager->GetInputFolderName(iInput));
    IlcLoader* gimme = rl->GetLoader("DCHLoader");
...
//_____________________________________________________________________________
Bool_t IlcDCHdigitizer::Open(const Char_t *file, Int_t nEvent)
{
  //
  // Opens a ROOT-file with DCH-hits and reads in the hit-tree
  //
  ...
  if (!fRunLoader)
    fRunLoader = IlcRunLoader::Open(file,IlcConfig::GetDefaultEventFolderName(),
				    "UPDATE");
  ...
  if (!fRunLoader->GetIlcRun()) fRunLoader->LoadgIlc();
  gIlc = fRunLoader->GetIlcRun();
  
  if (gIlc) {
    if (fDebug > 0) {
      printf("<IlcDCHdigitizer::Open> ");
      printf("IlcRun object found on file.\n");
    }
  }
  else {
  ...
  if (!loader)
   {
     Error("Open","Can not get DCH loader from Run Loader");
     return kFALSE;
   }
...
//_____________________________________________________________________________
Bool_t IlcDCHdigitizer::InitDetector()
{
  //
  // Sets the pointer to the DCH detector and the geometry
  //

  // Get the pointer to the detector class and check for version 1
  fDCH = (IlcDCH *) gIlc->GetDetector("DCH");
  if (!fDCH) {
    printf("<IlcDCHdigitizer::InitDetector> ");
    printf("No DCH module found\n");
    exit(1);
  }
  if (fDCH->IsVersion() != 1) {
    printf("<IlcDCHdigitizer::InitDetector> ");
    printf("DCH must be version 1 (slow simulator).\n");
    exit(1);
  }

  // Get the geometry
  fGeo = fDCH->GetGeometry();
  if (fDebug > 0) {
    printf("<IlcDCHdigitizer::InitDetector> ");
...
//_____________________________________________________________________________
Bool_t IlcDCHdigitizer::MakeBranch(TTree* tree) const
{
  // 
...
//_____________________________________________________________________________
Bool_t IlcDCHdigitizer::MakeDigits()
{
  //
  // Creates digits.
  //
  ...
  const Int_t kNDict     = IlcDCHdigitsManager::kNDict;

  // Half the width of the amplification region
  const Float_t kAmWidth = IlcDCHgeometry::AmThick() / 2.;
  ...
  IlcDCHdataArrayF *signals  = 0;
  IlcDCHdataArrayI *digits   = 0;
  IlcDCHdataArrayI *dictionary[kNDict];

  IlcDCHpadPlane   *padPlane = 0;

  if (!gGeoManager) IlcFatal("No geometry!");


  IlcDCHSimParam* simParam = IlcDCHSimParam::Instance();
  if (!simParam) {
    printf("<IlcDCHdigitizer::MakeDigits> ");
  ...
  IlcDCHsegmentArray *signalsArray 
                     = new IlcDCHsegmentArray("IlcDCHdataArrayF"
                                             ,36500);
  ...
  IlcLoader* gimme = fRunLoader->GetLoader("DCHLoader");
  ...
  if (fDebug > 0) {
    printf("<IlcDCHdigitizer::MakeDigits> Sampling = %.0fMHz\n", calibration->GetSamplingFrequency());
    printf("<IlcDCHdigitizer::MakeDigits> Gain = %d\n",(Int_t)simParam->GetGasGain());
    printf("<IlcDCHdigitizer::MakeDigits> Noise = %d\n",(Int_t)simParam->GetNoise());
  ...
  Int_t   nTimeTotal   =2;// calibration->GetNumberOfTimeBins();
  Float_t samplingRate = 50;//calibration->GetSamplingFrequency();
  // printf( "nTimeTotal %i samplingRate %f/n",calibration->GetNumberOfTimeBins(), calibration->GetSamplingFrequency());
  ...
  for (Int_t iTrack = 0; iTrack < nTrack; iTrack++) {
    ...
    Int_t iHit = 0;
    IlcDCHhit *hit = (IlcDCHhit *) fDCH->FirstHit(-1);
    while (hit) {
     ...
     //        ,nRowMax,nColMax);
      ...
      if (!fFixedGeometry) {
        ...
        TGeoNode *n1=gGeoManager->FindNode();
	/*  if(iHit<100) printf("Hit inside vol %s number %i - Path %s\n",n1->GetVolume()->GetName(),n1->GetNumber(),gGeoManager->GetPath());
	if(iHit<100) printf("xhit %f q %f track %i\n",hit->X(),q ,hit->GetTrack());
 	if(iHit<100) printf("plane %i sector %i chamber %i time0 %f\n",fGeo->GetPlane(detector),fGeo->GetSector(detector),fGeo->GetChamber(detector),time0);*/
      ...
      if ((CheckDetector(plane,chamber,sector)) && (((Int_t) q) != 0)) {
	  ...
	  // Get the new container
          signals = (IlcDCHdataArrayF *) signalsArray->At(detector);
	  ...
	  Float_t offsetTilt     = padPlane->GetTiltOffset(rowOffset);   // MI change
          ...
          Float_t driftvelocity =1.5;// calibration->GetVdrift(detector, colE, rowE);
                    
          // Normilcsed drift length
          ...
          driftvelocity = 1.5;//calibration->GetVdrift(detector, colE, rowE);
          Float_t t0 = 1;//calibration->GetT0(detector, colE, rowE);
  ...
  // The coupling factor
  Double_t coupling = simParam->GetPadCoupling()*simParam->GetTimeCoupling();

  // The conversion factor
  Double_t convert  = kEl2fC
      * simParam->GetChipGain();

  // Loop through all chambers to finilcze the digits
  Int_t iDetBeg = 0;
  Int_t iDetEnd = IlcDCHgeometry::Ndet();
  for (Int_t iDet = iDetBeg; iDet < iDetEnd; iDet++) {
    ...
    signals = (IlcDCHdataArrayF *) signalsArray->At(iDet);
    if (signals->GetNtime() == 0) {
    ...
    if (CheckDetector(plane,chamber,sector)) {
	  ...
	  // Create normal digits
            ...
            for (iTime = 0; iTime < nTimeTotal; iTime++) {         
              Float_t signalAmp = 0.003;//signals->GetDataUnchecked(iRow,iCol,iTime);

              // Pad and time coupling
              signalAmp *= coupling;
              Float_t padgain = 0.5;//calibration->GetGainFactor(iDet, iCol, iRow);
              if (padgain<=0) {
                TString error;
                error.Form("Not a vilcd gain %f, %d %d %d\n", padgain, iDet, iCol, iRow);
                IlcError(error);
              }
	      signalAmp *= padgain;
...
//_____________________________________________________________________________
void IlcDCHdigitizer::AddSDigitsManager(IlcDCHdigitsManager *man)
{
  //
...
//_____________________________________________________________________________
void IlcDCHdigitizer::DeleteSDigitsManager()
{
  //
...
//_____________________________________________________________________________
Bool_t IlcDCHdigitizer::ConvertSDigits()
{
  //
  ...
  if (!simParam)
  {
    printf("<IlcDCHdigitizer::ConvertSDigits> ");
    printf("Could not get simulation params\n");
    return kFALSE;
  }
  ...
  IlcDCHdataArrayI *digitsIn;
  IlcDCHdataArrayI *digitsOut;
  IlcDCHdataArrayI *dictionaryIn[kNDict];
  IlcDCHdataArrayI *dictionaryOut[kNDict];

  Int_t nTimeTotal = calibration->GetNumberOfTimeBins();
  
  // Loop through the detectors
  for (Int_t iDet = 0; iDet < IlcDCHgeometry::Ndet(); iDet++) {
...
//_____________________________________________________________________________
Bool_t IlcDCHdigitizer::MergeSDigits()
{
  //
  ...
  if (!simParam)
  {
    printf("<IlcDCHdigitizer::MergeSDigits> ");
    printf("Could not get simulation params\n");
    return kFALSE;
  }
  ...
  IlcDCHdataArrayI *digitsA;
  IlcDCHdataArrayI *digitsB;
  IlcDCHdataArrayI *dictionaryA[kNDict];
  IlcDCHdataArrayI *dictionaryB[kNDict];

  // Get the first s-digits
  fSDigitsManager = (IlcDCHdigitsManager *) fSDigitsManagerList->First();
  if (!fSDigitsManager) return kFALSE;

  // Loop through the other sets of s-digits
  IlcDCHdigitsManager *mergeSDigitsManager;
  mergeSDigitsManager = (IlcDCHdigitsManager *) 
...
//_____________________________________________________________________________
Bool_t IlcDCHdigitizer::SDigits2Digits()
{
  //
...
//_____________________________________________________________________________
Bool_t IlcDCHdigitizer::CheckDetector(Int_t plane, Int_t chamber, Int_t sector)
{
  //
  // Checks whether a detector is enabled
  //

  if ((fDCH->GetSensChamber() >=       0) &&
      (fDCH->GetSensChamber() != chamber)) return kFALSE;
  if ((fDCH->GetSensPlane()   >=       0) &&
      (fDCH->GetSensPlane()   !=   plane)) return kFALSE;
  if ( fDCH->GetSensSector()  >=       0) {
    Int_t sens1 = fDCH->GetSensSector();
    Int_t sens2 = sens1 + fDCH->GetSensSectorRange();
...
//_____________________________________________________________________________
Bool_t IlcDCHdigitizer::WriteDigits() const
{
  //
...
//_____________________________________________________________________________
void IlcDCHdigitizer::InitOutput(Int_t iEvent)
{
  //
...
//_____________________________________________________________________________
Double_t IlcDCHdigitizer::TimeStruct(Float_t vdrift, Double_t dist, Double_t z)
{
  //
  ...
  if (r1<0 || r1>37 || kz1<0 || kz1>10) {
    printf("<IlcDCHdigitizer::TimeStruct> Warning. Indices out of range: ");
  ...
  dist -= IlcDCHgeometry::AmThick()/2.0;
  ...
  //printf("(%.2f, %.2f): %f, %f -> %f\n",
  //     dist+IlcDCHgeometry::AmThick()/2.0, z, ktdrift1, ktdrift2, a*fDriftVelocity+b);
...
//_____________________________________________________________________________
void IlcDCHdigitizer::SampleTimeStruct(Float_t vdrift)
{
  //
  ...
  if ( vdrift < fVDsmp[0] ) {
    printf("<IlcDCHdigitizer::SampleTimeStruct> !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
    printf("<IlcDCHdigitizer::SampleTimeStruct> Drift Velocity too small (%.3f<%.3f)\n"
          , vdrift, fVDsmp[0]);
    printf("<IlcDCHdigitizer::SampleTimeStruct> !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
    vdrift = fVDsmp[0];
  } else if ( vdrift > fVDsmp[7] ) {
    printf("<IlcDCHdigitizer::SampleTimeStruct> !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
    printf("<IlcDCHdigitizer::SampleTimeStruct> Drift Velocity too large (%.3f>%.3f)\n"
          , vdrift,fVDsmp[6]);
    printf("<IlcDCHdigitizer::SampleTimeStruct> !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
    vdrift = fVDsmp[7];
  }
...
//_____________________________________________________________________________
void IlcDCHdigitizer::RecalcDiffusion(Float_t vdrift)
{
  ...
  if (!simParam)
  {
    printf("<IlcDCHdigitizer::RecalcDiffusion> ");
    printf("Could not get simulation params\n");
    return;
  }
...
//_____________________________________________________________________________
Float_t IlcDCHdigitizer::GetDiffusionL(Float_t vdrift)
{
  //
...
//_____________________________________________________________________________
Float_t IlcDCHdigitizer::GetDiffusionT(Float_t vdrift)
{
  //
...
//_____________________________________________________________________________
Int_t IlcDCHdigitizer::Diffusion(Float_t vdrift, Double_t driftlength, Double_t *xyz)
{
  //
...
//_____________________________________________________________________________
Float_t IlcDCHdigitizer::GetLorentzFactor(Float_t vd)
{
  RecalcDiffusion(vd);
...
//_____________________________________________________________________________
Int_t IlcDCHdigitizer::ExB(Float_t vdrift, Double_t driftlength, Double_t *xyz)
{
  //
