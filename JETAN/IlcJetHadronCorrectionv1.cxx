...
ClassImp(IlcJetHadronCorrectionv1)

Double_t IlcJetHadronCorrectionv1::fgParLookup[HCPARAMETERS][HCPARAMETERSETS] = 
{  
...
IlcJetHadronCorrectionv1* IlcJetHadronCorrectionv1::fgHadrCorr = 0;

IlcJetHadronCorrectionv1::IlcJetHadronCorrectionv1(const char *name,const char *title) 
...
IlcJetHadronCorrectionv1*
IlcJetHadronCorrectionv1::Instance()
{
  // return pointer to global instance. Instantiate if needed
  if (! fgHadrCorr) fgHadrCorr = new IlcJetHadronCorrectionv1();
  return fgHadrCorr;
}

void IlcJetHadronCorrectionv1::SetGeometry2(const IlcJetDummyGeo *geometry)
{
...
void IlcJetHadronCorrectionv1::SetGeometry(TString /*name*/,Double_t fs)
{
  // Initialise EMCAL geometry
...
// Double_t IlcJetHadronCorrectionv1::GetEnergy(Double_t pmom, Double_t eta, Int_t /*gid*/)
Double_t IlcJetHadronCorrectionv1::GetEnergy(Double_t pmom, Double_t eta, Int_t /*gid*/)
{
...
// void IlcJetHadronCorrectionv1::TrackPositionEMCal(const IlcAODTrack* track,Double_t &eta, Double_t &phi)
