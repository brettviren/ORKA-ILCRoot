...
class IlcJetGrid : public TNamed {

 public:
  
  IlcJetGrid();
  IlcJetGrid(Int_t nphi,Int_t neta,Double_t phiMin,Double_t etaMin,Double_t phiMax,Double_t etaMax);
  virtual ~IlcJetGrid();
 ...
 protected:
  IlcJetGrid(const IlcJetGrid& grid);
  IlcJetGrid& operator=(const IlcJetGrid& other);


  ClassDef(IlcJetGrid,1) 
};
