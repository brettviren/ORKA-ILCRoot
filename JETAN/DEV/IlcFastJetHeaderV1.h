#ifndef ILCFASTJETHEADERV1_H
#define ILCFASTJETHEADERV1_H
...
class IlcFastJetHeaderV1 : public IlcJetHeader
{
 public:
  IlcFastJetHeaderV1();
  virtual ~IlcFastJetHeaderV1() { }
  ...
  void                         SetComment(const char* com)                     {IlcJetHeader::SetComment(com);}
 ...
 protected:
  ...
  Bool_t                       fkBkgFastJetb;          // Toggle background estimation using IlcFastJetBkg::BkgFastJetb()
  Bool_t                       fktBkgFastJetWoHardest; // Toggle background estimation using IlcFastJetBkg::BkgFastJetWoHardest()  
 
  ClassDef(IlcFastJetHeaderV1,4)                       // Fastjet header class
};
