...
void IlcSISConeJetFinder::FindJets()
{
  ...
  for (size_t j = 0; j < jets.size(); j++) { // loop for jets
	...
	// Jet constituents (charged tracks) added to the IlcAODJet
	IlcJetCalTrkEvent* calEvt  = GetCalTrkEvent();
...
//____________________________________________________________________________
Bool_t IlcSISConeJetFinder::ProcessEvent()
{
  // Process one event
