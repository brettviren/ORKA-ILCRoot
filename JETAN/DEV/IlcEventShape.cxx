...
ClassImp(IlcEventShape)

//___________________________________________________________________
TArrayD * IlcEventShape::GetThrustParamMC(IlcMCEvent* mcEvent, Int_t  nstudymin, Double_t ptcutoff, Double_t etacutoff, Bool_t chom)
{
  /*
    This function returns an array of values of thrust. To get these values you have to do:
    TArrayD* eventshapes = 0;
    eventshapes = IlcShapeEvent::GetThrustParamMC(mcEvent, 3, 1, 1, kFALSE);
...
Double_t IlcEventShape::GetCircularityMC(IlcMCEvent* mcEvent, Int_t  nstudymin, Double_t ptcutoff, Double_t etacutoff, Bool_t chom)
{
  /*
