...
ClassImp(IlcUA1JetFinder)

////////////////////////////////////////////////////////////////////////

IlcUA1JetFinder::IlcUA1JetFinder():
  IlcJetFinder(),
  fLego(0),  
...
//-----------------------------------------------------------------------
void IlcUA1JetFinder::RunAlgoritm(Float_t etbgTotal, Double_t dEtTotal, Int_t& nJets,
...
//-----------------------------------------------------------------------
void IlcUA1JetFinder::WriteJHeaderToFile() const
{
  IlcUA1JetHeader* header = (IlcUA1JetHeader*) fHeader;
  header->Write();
