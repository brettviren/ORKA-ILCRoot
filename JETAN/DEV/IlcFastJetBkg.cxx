...
ClassImp(IlcFastJetBkg)

////////////////////////////////////////////////////////////////////////

IlcFastJetBkg::IlcFastJetBkg():
  TObject(),
  fHeader(0),
  fInputFJ(0)
{
...
IlcFastJetBkg::IlcFastJetBkg(const IlcFastJetBkg& input):
  TObject(input),
...
//______________________________________________________________________
IlcFastJetBkg& IlcFastJetBkg::operator=(const IlcFastJetBkg& source)
{
  // Assignment operator. 
  if(this!=&source){ 
...
void IlcFastJetBkg::BkgFastJetb(Double_t& rho,Double_t& sigma, 
				Double_t& meanarea)
{
  // Bkg estimation
  ...
  if(debug>0) cout<<"===============  IlcFastJetBkg::BkgFastJetb()  =========== "<<endl;
...
void IlcFastJetBkg::BkgFastJetWoHardest(Double_t& rho,Double_t& sigma, 
					Double_t& meanarea)
{
  ...
  IlcFastJetHeaderV1 *header = (IlcFastJetHeaderV1*)fHeader; 
  Int_t debug  = header->GetDebug();     // debug option
  if(debug) cout<<"===============  IlcFastJetBkg::BkgWoHardest()  =========== "<<endl;
  vector<fastjet::PseudoJet> inputParticles=fInputFJ->GetInputParticles();
...
void IlcFastJetBkg::CalcRhob(Double_t& median,Double_t& 
			     sigma,Double_t& 
...
//____________________________________________________________________
void IlcFastJetBkg::CalcRhoWoHardest(Double_t& median,Double_t& 
...
//___________________________________________________________________
Float_t IlcFastJetBkg::BkgFastJet()
{
  // Return background  
  ...
  if(debug>0) cout<<"===============  IlcFastJetBkg::BkgFastJet()  =========== "<<endl;
  vector<fastjet::PseudoJet> inputParticles=fInputFJ->GetInputParticles();
...
//___________________________________________________________________
Float_t IlcFastJetBkg::BkgChargedFastJet()
{
  ...
  if(debug>0) cout<<"===============  IlcFastJetBkg::BkgChargedFastJet()  =========== "<<endl;
...
Float_t IlcFastJetBkg::BkgStat()
{
  ...
  if(debug>0) cout<<"==============IlcFastJetBkg::BkgStat()============="<<endl;
  //TO BE IMPLEMENTED 
  Int_t nTracks= 0;
...
//___________________________________________________________________
Float_t IlcFastJetBkg::BkgFastJetCone(TClonesArray* fAODJets)
{
  ...
  if(debug>0) cout<<"==============IlcFastJetBkg::SubtractFastJetBackgCone()============="<<endl;

  Float_t rc= header->GetRparam();

  //Hard wired Calorimeter area (get it later from the IlcJetReaderHeader.h)
  Double_t accEMCal=2*0.7*110./180*TMath::Pi();//2.68 area of EMCal
  ...
  if(nJ==1) { 
    IlcAODJet *jettmp = (IlcAODJet*)(fAODJets->At(0));
    jeteta=jettmp->Eta();
    jetphi=jettmp->Phi();
  ...
  if(nJ>=2) { 
    IlcAODJet *jettmp = (IlcAODJet*)(fAODJets->At(0));
    IlcAODJet *jettmp1 = (IlcAODJet*)(fAODJets->At(1));
    jeteta=jettmp->Eta();
    jetphi=jettmp->Phi();
    jeteta1=jettmp1->Eta();
    jetphi1=jettmp1->Phi(); 
...
//___________________________________________________________________
Double_t IlcFastJetBkg::CalcRho(vector<fastjet::PseudoJet> inputParticles,Double_t rParamBkg,TString method)
{
  // calculate rho using the fastjet method
...
//___________________________________________________________________
Double_t  IlcFastJetBkg::BkgFunction(Double_t */*x*/,Double_t */*par*/)
{
...
//___________________________________________________________________
Bool_t IlcFastJetBkg::EmcalAcceptance(const Float_t eta, const Float_t phi, const Float_t radius) const
{
