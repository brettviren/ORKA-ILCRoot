#ifndef ILCSISCONEJETHEADER_H
#define ILCSISCONEJETHEADER_H
...
class IlcSISConeJetHeader : public IlcJetHeader
{
 public:
 
  IlcSISConeJetHeader();
  virtual ~IlcSISConeJetHeader() { }
 ...
 protected:
  ...
  ClassDef(IlcSISConeJetHeader,5)             // SISCONE header class
};
