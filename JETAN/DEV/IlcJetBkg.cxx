...
//----------------------------------------------------------------
Bool_t IlcJetBkg::PtCutPass(Int_t id, Int_t nTracks)
{
...
//----------------------------------------------------------------
Bool_t IlcJetBkg::SignalCutPass(Int_t id, Int_t nTracks)
{
  // Check if track or cell passes the cut flag
...
//----------------------------------------------------------------
Float_t IlcJetBkg::CalcJetAreaEtaCut(Float_t radius, const Float_t etaJet)
{
  // Calculate jet area taking into account an acceptance cut in eta
  IlcUA1JetHeader* header = (IlcUA1JetHeader*) fHeader;
...
//----------------------------------------------------------------
void IlcJetBkg::CalcJetAndBckgAreaEtaCut(Bool_t calcOutsideArea, Float_t radius, const Int_t nJets, const Float_t* etaJet, Float_t* &areaJet, Float_t &areaOut)
{
...
//----------------------------------------------------------------
void IlcJetBkg::SubtractBackg(const Int_t& nIn, const Int_t&nJ, Float_t&etbgTotalN, Float_t&sigmaN,
...
//----------------------------------------------------------------
void IlcJetBkg::SubtractBackgStat(const Int_t& nIn, const Int_t&nJ,Float_t&etbgTotalN, Float_t&sigmaN,
                                  const Float_t* ptT, const Float_t* etaT, const Float_t* phiT,
                                  Float_t* etJet, const Float_t* etaJet, const Float_t* phiJet,
                                  Float_t* etsigJet, Int_t* multJetT, Int_t* multJetC, Int_t* multJet,
                                  Int_t* injet, Float_t* &areaJet)
...
//----------------------------------------------------------------
void IlcJetBkg::SubtractBackgCone(const Int_t& nIn, const Int_t&nJ,Float_t& etbgTotalN, Float_t&sigmaN,
...
//----------------------------------------------------------------
void IlcJetBkg::SubtractBackgRatio(const Int_t& nIn, const Int_t&nJ,Float_t& etbgTotalN, Float_t&sigmaN,
                                   const Float_t* ptT,const Float_t* etaT, const Float_t* phiT,
                                   Float_t* etJet, const Float_t* etaJet, const Float_t* phiJet,
                                   Float_t* etsigJet, Int_t* multJetT, Int_t* multJetC, Int_t* multJet,
                                   Int_t* injet,  Float_t* &/*areaJet*/)
