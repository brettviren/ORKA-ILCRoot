#ifndef ILCJETREADERHEADER_H
#define ILCJETREADERHEADER_H
...
class IlcJetReaderHeader : public TNamed
{

 public:
  IlcJetReaderHeader(const char* name);
  IlcJetReaderHeader();
  IlcJetReaderHeader(Int_t det);
  virtual ~IlcJetReaderHeader();
 ...
 protected:
  ...
  ClassDef(IlcJetReaderHeader,4)   // jet reader header base class
