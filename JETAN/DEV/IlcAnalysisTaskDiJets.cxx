...
#include "IlcAnalysisTaskDiJets.h"
...
ClassImp(IlcAnalysisTaskDiJets)

////////////////////////////////////////////////////////////////////////

IlcAnalysisTaskDiJets::IlcAnalysisTaskDiJets():
    IlcAnalysisTaskSE(),
    fDiJets(0),
    fDiJetsIn(0),
    fUseAODInput(kFALSE),
...
//----------------------------------------------------------------------
IlcAnalysisTaskDiJets::IlcAnalysisTaskDiJets(const char* name):
...
//----------------------------------------------------------------------
void IlcAnalysisTaskDiJets::UserCreateOutputObjects()
{
// Create the output container
//
    if (fDebug) printf("AnalysisTaskDiJets::CreateOutPutData() \n");
    fDiJets = new TClonesArray("IlcAODDiJet", 0);
    if (fFillAOD){
...
//----------------------------------------------------------------------
void IlcAnalysisTaskDiJets::Init()
{
    // Initialization
...
//----------------------------------------------------------------------
void IlcAnalysisTaskDiJets::UserExec(Option_t */*option*/)
{
...
//
    ...
    if (fDiJetsIn) {
      ...
      if (fDiJetsIn->GetEntries() > 0) {
        testJ = (IlcAODDiJet*) (fDiJetsIn->At(0));
        jj1 = testJ->Jet(0);
        jj1->Print("");
        jj2 = testJ->Jet(1);
        jj2->Print("");
...
//----------------------------------------------------------------------
void IlcAnalysisTaskDiJets::Terminate(Option_t */*option*/)
{
// Terminate analysis
//
