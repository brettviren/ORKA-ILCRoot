#ifndef ILCUA1JETHEADER_H
#define ILCUA1JETHEADER_H
...
class IlcUA1JetHeader : public IlcJetHeader
{
 public:
  IlcUA1JetHeader();
  virtual ~IlcUA1JetHeader() { }
 ...
 protected:
  ...
  ClassDef(IlcUA1JetHeader,2) // UA1 jet finder header
