...
/* $Id: IlcJetGrid.cxx,v 1.0 07/09/2006 */
...
//
//  How to run it :
//  > IlcJetGrid *grid = new IlcJetGrid((NbinPhi-1),(NbinEta-1),PhiMin,PhiMax,EtaMin,EtaMax);
...
//__________________________________________________________
IlcJetGrid::IlcJetGrid(Int_t nphi,Int_t neta,Double_t phiMin,Double_t phiMax,Double_t etaMin,Double_t etaMax):
  fGrid(0),
  fNphi(nphi),        
  fNeta(neta),      
  fPhi(0),       
...
//__________________________________________________________
IlcJetGrid::IlcJetGrid(const IlcJetGrid& grid) : 
  TNamed(grid),
  fGrid(grid.fGrid),
  fNphi(grid.fNphi),        
  fNeta(grid.fNeta),      
...
IlcJetGrid& IlcJetGrid::operator=(const IlcJetGrid& other)
{
  // Assignment
    if (this != &other) {
	fGrid = other.fGrid;
...
//__________________________________________________________
void IlcJetGrid::InitParams(Double_t phiMinCal,Double_t phiMaxCal,Double_t etaMinCal,Double_t etaMaxCal) 
{ 
...
//__________________________________________________________
TArrayD* IlcJetGrid::GetArrayEta() 
{ 
...
//__________________________________________________________
TArrayD* IlcJetGrid::GetArrayPhi() 
{ 
...
//__________________________________________________________
TMatrixD* IlcJetGrid::GetIndexObject()
{ 
...
//__________________________________________________________
void IlcJetGrid::GetAccParam(Int_t &nphi, Int_t &neta, Float_t &minphi, Float_t &maxphi, 
...
//__________________________________________________________
void IlcJetGrid::GetBinParam(Int_t &phibintpc, Int_t &etabintpc, 
...
//__________________________________________________________
Int_t IlcJetGrid::GetIndexFromEtaPhi(Double_t phi,Double_t eta) const 
{ 
...
//__________________________________________________________
void IlcJetGrid::GetEtaPhiFromIndex(Int_t index, Float_t &eta, Float_t &phi)
{ 
...
//__________________________________________________________
Int_t IlcJetGrid::GetIndex(Double_t phi, Double_t eta) 
{ 
...
//__________________________________________________________
Int_t IlcJetGrid::GetIndexJFromEta(Double_t eta)
{ 
// Get eta id
// Eta discretized
...
//__________________________________________________________
Int_t IlcJetGrid::GetIndexIFromPhi(Double_t phi)
{ 
// Get phi id
// Phi discretized
...
//__________________________________________________________
void IlcJetGrid::SetMatrixIndex(Int_t i,Double_t par) 
{ 
...
//__________________________________________________________
void IlcJetGrid::SetMatrixIndexes() 
{ 
...
//__________________________________________________________
void IlcJetGrid::GetIJFromIndex(Int_t index, Int_t& i, Int_t& j) const
{ 
...
//__________________________________________________________
void IlcJetGrid::GetEtaPhiFromIndex2(Int_t index, Float_t &phi, Float_t &eta)
{ 
