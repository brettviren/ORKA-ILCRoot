...
ClassImp(IlcJetESDFillUnitArrayEMCalDigits)

//_____________________________________________________________________________
IlcJetESDFillUnitArrayEMCalDigits::IlcJetESDFillUnitArrayEMCalDigits()
  : IlcJetFillUnitArray(),
    fESD(0),
    fNIn(0),
    fOpt(0),
...
//_____________________________________________________________________________
IlcJetESDFillUnitArrayEMCalDigits::IlcJetESDFillUnitArrayEMCalDigits(IlcESDEvent *esd)
  : IlcJetFillUnitArray(),
    fESD(esd),
    fNIn(0),
    fOpt(0),
...
//_____________________________________________________________________________
IlcJetESDFillUnitArrayEMCalDigits::IlcJetESDFillUnitArrayEMCalDigits(const IlcJetESDFillUnitArrayEMCalDigits &det)
...
//_____________________________________________________________________________
IlcJetESDFillUnitArrayEMCalDigits& IlcJetESDFillUnitArrayEMCalDigits::operator=(const IlcJetESDFillUnitArrayEMCalDigits& other)
{
  // Assignment
...
//_____________________________________________________________________________
void IlcJetESDFillUnitArrayEMCalDigits::Exec(Option_t* const /*option*/)
{
  //
  // Main method.
...
//(not used ?)  Int_t nRefEnt = fRefArray->GetEntries();
  ...
  if(!fCluster) { // Keep all digit information
    ...
    //------------------------------------------------------------------
    IlcESDCaloCells &cells= *(fESD->GetEMCALCells());
...
//(not used ?)    Int_t type = cells.GetType();
    ...
    for(Int_t j = beg; j < nclus; j++) { // loop over clusters
      ...
      fClus = (IlcESDCaloCluster *) caloClusters->At(j) ;
...
void IlcJetESDFillUnitArrayEMCalDigits::GetCalibrationParameters()
{
...
//____________________________________________________________________________
Float_t  IlcJetESDFillUnitArrayEMCalDigits::Calibrate(Int_t amp, Int_t AbsId)
{
