...
////////////////////////////////////////////////////////////////////////
IlcPVBARGeometry *IlcJetReader::fGeom=0;
...
IlcJetReader::IlcJetReader():
  ...
  fSignalFlag(0),
  fCutFlag(0),
  fUnitArray(new TClonesArray("IlcJetUnitArray",60000)),
  fArrayInitialised(0),
...
if(myPath.Length()) {
 ...
 IlcOADBContainer EMCALgeoCont;
	...
	if(fDebug>19) cout<<"array definito"<<endl;
	 ...
	 EMCALgeoCont.InitFromFile((char*) OADBfile.Data(),"IlcEMCALgeo");
	...
	const char*  loc2master = ((IlcJetESDReaderHeader*) fReaderHeader)->GetEMCALmatrices2bLoad();
  ...
  // Define PVBAR geometry
 
  if(fDebug>10) cout<<"which PVBARgeometry is going to be uploaded?"<<geoType<<endl; 
  fGeom = IlcPVBARGeometry::GetInstance(geoType);
...
// }
//   
//   Info("\n SetPVBARGeometry:"," EMCal Geometry set ! \n");
