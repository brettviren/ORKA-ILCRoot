#ifndef ILCANALYSISTASKFASTEMBEDDING_H
#define ILCANALYSISTASKFASTEMBEDDING_H
...
class IlcAnalysisTaskFastEmbedding : public IlcAnalysisTaskSE {

public:
   
   IlcAnalysisTaskFastEmbedding();
   IlcAnalysisTaskFastEmbedding(const char *name);
   IlcAnalysisTaskFastEmbedding(const IlcAnalysisTaskFastEmbedding &copy);
   IlcAnalysisTaskFastEmbedding& operator=(const IlcAnalysisTaskFastEmbedding &o);
   virtual ~IlcAnalysisTaskFastEmbedding();
   ...
   virtual void     SetOfflineTrgMask(IlcVEvent::EOfflineTriggerTypes mask) { fOfflineTrgMask = mask; }
...
private:
   ...
   IlcAODEvent    *fAODout;     //! AOD out
   IlcAODEvent    *fAODevent;   //! AOD in
   TTree          *fAODtree;    //! AODin tree
   TFile          *fAODfile;    //! AODin file
   IlcAODMCHeader *mcHeader;    //! mc header
   ...
   IlcVEvent::EOfflineTriggerTypes fOfflineTrgMask; // mask of offline triggers to accept
   ...
   ClassDef(IlcAnalysisTaskFastEmbedding, 6);
};
