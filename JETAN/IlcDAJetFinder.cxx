...
//-----------------------------------------------------------------------------------
void IlcDAJetFinder::Annealing(Int_t nk,Double_t **xData,  TVectorD *vPx,  TVectorD *vPy,  TMatrixD *mPyx,  TMatrixD *mY)
{
...
//-----------------------------------------------------------------------------------
void IlcDAJetFinder::EndDetAnn(Int_t &nk,Double_t **xData,Int_t *xx,Double_t etx,TVectorD *vPx,TVectorD *vPy,TMatrixD *mPyx,TMatrixD *mY)
{
...
//-----------------------------------------------------------------------------------
void IlcDAJetFinder::StoreJets(Int_t nk, Double_t **xData, Int_t *xx, TMatrixD *mY)
{
//evaluate significant clusters properties
	const Double_t pi=TMath::Pi();
	IlcJetReaderHeader *rHeader=fReader->GetReaderHeader();
