...
// Base class used by IlcJetESDReader to fill a UnitArray from the information extracted 
...
ClassImp(IlcJetFillUnitArray)

//_____________________________________________________________________________
IlcJetFillUnitArray::IlcJetFillUnitArray()
  : TTask("IlcJetFillUnitArray","Fill Unit Array with tpc/its and emcal information"),
    fNTracks(0),
    fNTracksCut(0),
    fOpt(0),
    fDZ(0),
...
IlcJetFillUnitArray::IlcJetFillUnitArray(const IlcJetFillUnitArray& cpfrom)
  : TTask("IlcJetFillUnitArray","Fill Unit Array with tpc/its and emcal information"),
    fNTracks(0),
    fNTracksCut(0),
    fOpt(0),
...
IlcJetFillUnitArray& IlcJetFillUnitArray::operator=(const IlcJetFillUnitArray& rhs)
{
    //
    // Assignment operator
    //
...
//_____________________________________________________________________________
void IlcJetFillUnitArray::GetEtaPhiFromIndex(Int_t index, Float_t &eta, Float_t &phi)
{
...
//_____________________________________________________________________________
Float_t  IlcJetFillUnitArray::EtaToTheta(Float_t arg)
{
