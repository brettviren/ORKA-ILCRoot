#ifndef ILCJETDUMMYGEO_H
#define ILCJETDUMMYGEO_H
...
class TGeoMatrix;
class IlcJetDummyShishKebabTrd1Module;

class IlcJetDummyGeo : public TObject 
{
 public: 
  IlcJetDummyGeo();
  IlcJetDummyGeo(const IlcJetDummyGeo& geom);
  virtual ~IlcJetDummyGeo();
  static IlcJetDummyGeo* GetInstance() {return new IlcJetDummyGeo();}
  static IlcJetDummyGeo* GetInstance(const char* /*name*/, const char* /*title*/)
    {return new IlcJetDummyGeo();}
  ...
  IlcJetDummyShishKebabTrd1Module *GetShishKebabModule(Int_t neta);
 ...
 private:
  IlcJetDummyGeo &operator=(const IlcJetDummyGeo &det);
 ...
 protected:
  ...
  Float_t fEtaMaxOfTRD1;                // max eta in case of TRD1 geometry (see IlcEMCALShishKebabTrd1Module)
