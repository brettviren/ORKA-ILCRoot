...
/* $Id: IlcUA1JetFinderV1.cxx 48769 2011-03-27 12:18:59Z kleinb $ */
...
ClassImp(IlcUA1JetFinderV1)

/////////////////////////////////////////////////////////////////////

IlcUA1JetFinderV1::IlcUA1JetFinderV1() :
    IlcJetFinder(),
  fLego(0),
  fhEtBackg(0),
  fhAreaBackg(0)
...
void IlcUA1JetFinderV1::FindJets()
...
void IlcUA1JetFinderV1::RunAlgoritm(Float_t etbgTotal, Double_t dEtTotal, Int_t& nJets,
                                  ...
                                  Float_t* etallJet, Int_t* ncellsJet)
{
  ...
  if((nBinPhi*nBinEta)>nBinsMax){
    IlcError("Too many bins of the ETA-PHI histogram");
  }
  ...
  for(Int_t icell = 0; icell < nCell; icell++){
	 ...
	 if(nJets<kMaxJets){
	   ...
	   IlcError(Form("Too many jets (> %d) found by UA1JetFinder, adapt your cuts",kMaxJets));
	   break;
	 }
       }
  } // end of cells loop
...
void IlcUA1JetFinderV1::SubtractBackg(const Int_t& nIn, const Int_t&nJ, Float_t&etbgTotalN,
...
void IlcUA1JetFinderV1::SubtractBackgStat(const Int_t& nIn, const Int_t&nJ,Float_t&etbgTotalN,
					  const Float_t* ptT, const Float_t* etaT, const Float_t* phiT,
					  Float_t* etJet, const Float_t* etaJet, const Float_t* phiJet, Float_t* etsigJet,
					  Int_t* multJet, Int_t* injet)
{
...
void IlcUA1JetFinderV1::SubtractBackgCone(const Int_t& nIn, const Int_t&nJ,Float_t& etbgTotalN,
					  const Float_t* ptT, const Float_t* etaT, const Float_t* phiT,
					  Float_t* etJet, const Float_t* etaJet, const Float_t* phiJet, Float_t* etsigJet,
					  Int_t* multJet, Int_t* injet)
{
...
void IlcUA1JetFinderV1::SubtractBackgRatio(const Int_t& nIn, const Int_t&nJ, Float_t& etbgTotalN,
					   const Float_t* ptT, const Float_t* etaT, const Float_t* phiT,
					   Float_t* etJet, const Float_t* etaJet, const Float_t* phiJet, Float_t* etsigJet,
					   Int_t* multJet, Int_t* injet)
{
...
void IlcUA1JetFinderV1::WriteJHeaderToFile() const
{
  IlcUA1JetHeaderV1* header = (IlcUA1JetHeaderV1*) fHeader;
  header->Write();
}
