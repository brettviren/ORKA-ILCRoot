...
IlcJetBkg::IlcJetBkg(const IlcJetBkg& input):
  TObject(input),
...
//______________________________________________________________________
IlcJetBkg& IlcJetBkg::operator=(const IlcJetBkg& source){
    // Assignment operator. 
    this->~IlcJetBkg();
    new(this) IlcJetBkg(source);
    return *this;
...
//___________________________________________________________________
  void IlcJetBkg::BkgFastJetb(Double_t& rho,Double_t& sigma, 
Double_t& meanarea){

    IlcFastJetHeaderV1 *header = (IlcFastJetHeaderV1*)fHeader; 
    Bool_t debug  = header->GetDebug();     // debug option 
    if(debug)cout<<"===============  IlcJetBkg::BkgFastJetb()  =========== "<<endl;
...
//_________________________________________________________________
  ...
  void IlcJetBkg::BkgFastJetWoHardest(Double_t& rho,Double_t& sigma, 
Double_t& meanarea){
    IlcFastJetHeaderV1 *header = (IlcFastJetHeaderV1*)fHeader; 
    Bool_t debug  = header->GetDebug();     // debug option 
    if(debug)cout<<"===============  IlcJetBkg::BkgWoHardest()  =========== "<<endl;
  vector<fastjet::PseudoJet> inputParticles=fInputFJ->GetInputParticles();
...
//____________________________________________________________________
 ...
 void IlcJetBkg::CalcRhob(Double_t& median,Double_t& 
			  sigma,Double_t& 
...
//____________________________________________________________________
 ...
 void IlcJetBkg::CalcRhoWoHardest(Double_t& median,Double_t& 
sigma,Double_t& 
meanarea,vector<fastjet::PseudoJet> inputParticles,Double_t 
rParamBkg,TString method){
  //calculate rho using the fastjet method
...
//___________________________________________________________________
Float_t IlcJetBkg::BkgFastJet(){
// Return background  
  IlcFastJetHeaderV1 *header = (IlcFastJetHeaderV1*)fHeader;
  Bool_t debug  = header->GetDebug();     // debug option

  if(debug)cout<<"===============  IlcJetBkg::BkgFastJet()  =========== "<<endl;
  vector<fastjet::PseudoJet> inputParticles=fInputFJ->GetInputParticles();
...
//___________________________________________________________________
Float_t  IlcJetBkg::BkgChargedFastJet(){
// Background for charged jets
  IlcFastJetHeaderV1 *header = (IlcFastJetHeaderV1*)fHeader;
  Bool_t debug  = header->GetDebug();     // debug option

  if(debug)cout<<"===============  IlcJetBkg::BkgChargedFastJet()  =========== "<<endl;
...
Float_t IlcJetBkg::BkgStat()
{
  ...
  if(debug)cout<<"==============IlcJetBkg::BkgStat()============="<<endl;
  //TO BE IMPLEMENTED 
...
////////////////////////////////////////////////////////////////////////
Float_t IlcJetBkg::BkgFastJetCone(TClonesArray* fAODJets)
{
  ...
  if(debug)cout<<"==============IlcJetBkg::SubtractFastJetBackgCone()============="<<endl;
...
Double_t IlcJetBkg::CalcRho(vector<fastjet::PseudoJet> inputParticles,Double_t rParamBkg,TString method){
  //calculate rho using the fastjet method
...
Float_t  IlcJetBkg::EtaToTheta(Float_t arg)
{
...
Double_t  IlcJetBkg::BkgFunction(Double_t */*x*/,Double_t */*par*/){
  //to be implemented--- (pT + Energy in EMCal Acceptance vs Multiplicity)
  return 1;
}


Bool_t IlcJetBkg::EmcalAcceptance(const Float_t eta, const Float_t phi, const Float_t radius) const{
