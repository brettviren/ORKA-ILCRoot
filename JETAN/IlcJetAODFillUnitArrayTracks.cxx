...
ClassImp(IlcJetAODFillUnitArrayTracks)

//_____________________________________________________________________________
IlcJetAODFillUnitArrayTracks::IlcJetAODFillUnitArrayTracks()
  : IlcJetFillUnitArray(),
    fNumUnits(0),
    fHadCorr(0),
...
//_____________________________________________________________________________
IlcJetAODFillUnitArrayTracks::IlcJetAODFillUnitArrayTracks(IlcAODEvent* aod)
  : IlcJetFillUnitArray(),
    fNumUnits(0),
    fHadCorr(0),
    fApplyMIPCorrection(kTRUE),
...
//_____________________________________________________________________________
IlcJetAODFillUnitArrayTracks::IlcJetAODFillUnitArrayTracks(const IlcJetAODFillUnitArrayTracks &det)
...
//_____________________________________________________________________________
IlcJetAODFillUnitArrayTracks& IlcJetAODFillUnitArrayTracks::operator=(const IlcJetAODFillUnitArrayTracks& other)
{
  // Assignment
...
void IlcJetAODFillUnitArrayTracks::InitParameters()
{
...
//_____________________________________________________________________________
void IlcJetAODFillUnitArrayTracks::Exec(Option_t* const /*option*/)
//void IlcJetAODFillUnitArrayTracks::Exec(Option_t* option)
{
  //
  // Main method.
...
// 		  Double_t etaOut = 0.;
// 		  Double_t phiOut = 0.;
// 		  ((IlcJetHadronCorrectionv1*)fHadCorr)->TrackPositionEMCal(track,etaOut,phiOut);
// 
...
// 		  
// 		  IlcJetUnitArray *uArray = (IlcJetUnitArray*)fUnitArray->At(towerID2);
// 		  unitEnergy = uArray->GetUnitEnergy(); 
// 		  Bool_t ok = kFALSE;
// 		  Bool_t ref = kFALSE;
// 		  if(unitEnergy==0.){
...
// 		  // is positive. If not, put the value to zero in IlcJetAODUnitArrayEMCalDigit.
