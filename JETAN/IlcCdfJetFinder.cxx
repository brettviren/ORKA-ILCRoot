...
ClassImp(IlcCdfJetFinder)

//______________________________________________________________________________
IlcCdfJetFinder::IlcCdfJetFinder():
    IlcJetFinder(),
    fHistos(0),
    fFromAod(0),
    fAODwrite(0),
...
//______________________________________________________________________________
void IlcCdfJetFinder::CreateOutputObjects(TList * const histos)
{
...
IlcCdfJetHeader *header = (IlcCdfJetHeader*)fHeader;
...
if (fAODwrite)
  {
  fFromAod = !strcmp(fReader->ClassName(),"IlcJetAODReader");
...
//______________________________________________________________________________
void IlcCdfJetFinder::FindCones()
{
...
//______________________________________________________________________________
void IlcCdfJetFinder::ComputeConesWeight()
{
...
//______________________________________________________________________________
void IlcCdfJetFinder::WriteJets()  
{ 
...
//______________________________________________________________________________
void IlcCdfJetFinder::AnalizeJets()
{
...
//______________________________________________________________________________
void IlcCdfJetFinder::FinishRun()
{
// do i need this?
}
