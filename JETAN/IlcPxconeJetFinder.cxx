...
#include <TFile.h>
#include "IlcPxconeJetFinder.h"
#include "IlcPxconeJetHeader.h"
#include "IlcJetReader.h"

ClassImp(IlcPxconeJetFinder)

////////////////////////////////////////////////////////////////////////

IlcPxconeJetFinder::IlcPxconeJetFinder():
  fHeader(0)
{
  //
  // Constructor
...
void IlcPxconeJetFinder::FindJets()

{
  ...
  if (nIn > kNmaxVec) {
    cout << " IlcPxconeJetFinder::FindJets: Too many input vectors."
	 << endl;
...
void IlcPxconeJetFinder::WriteJHeaderToFile() const
{
