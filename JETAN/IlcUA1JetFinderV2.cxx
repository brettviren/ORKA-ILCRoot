...
/* $Id: IlcUA1JetFinderV2.cxx 48117 2011-03-06 14:24:54Z morsch $ */
...
ClassImp(IlcUA1JetFinderV2)


////////////////////////////////////////////////////////////////////////
IlcUA1JetFinderV2::IlcUA1JetFinderV2() :
  IlcJetFinder(),
  fLego(0),  
  fOpt(0)
{
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::FindJetsC()
{ 
  // 
  ...
  IlcUA1JetHeaderV1* header  = (IlcUA1JetHeaderV1*) fHeader;
  ...
  //add signal percentage and total signal  in IlcJets for analysis tool
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::FindJets()
{
  // 
  //  Used to find jets using charged particle momentum information 
  ...
  for(Int_t i=0; i<nIn; i++) 
	...
	for(Int_t jpart=0; jpart<nRef;jpart++)
	  trackRef->Add((IlcVTrack*)ref->At(jpart));
	...
	if(cFlagT[loop1] == 1 || cFlag2T[loop1] == 1) {
	  ...
	  if(detT[loop1]==0){ // TPC+ITS
	    ...
	    for(Int_t j=0; j<nRef;j++){
	      ...
	      x = ((IlcVTrack*)ref->At(j))->Px();
	      y = ((IlcVTrack*)ref->At(j))->Py();
	      z = ((IlcVTrack*)ref->At(j))->Pz();
  ...
  TRefArray *refs = 0;
  Bool_t fromAod = !strcmp(fReader->ClassName(),"IlcJetAODReader");
  ...
  for(Int_t kj=0; kj<nj; kj++)
	...
	for(Int_t jpart = 0; jpart < nTracks; jpart++) { // loop for all particles in array
	  Float_t deta = ((IlcAODTrack*)refs->At(jpart))->Eta() - etaJetOk[kj];
	  Float_t dphi = ((IlcAODTrack*)refs->At(jpart))->Phi() - phiJetOk[kj];
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::RunAlgoritm(Int_t nIn, Float_t* etCell, Float_t* const etaCell, Float_t* phiCell, 
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::RunAlgoritmC(Float_t etbgTotal, Double_t dEtTotal, Int_t& nJets,
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::SubtractBackg(const Int_t& nIn, const Int_t&nJ, Float_t& etbgTotalN, const Float_t* ptT, const Int_t* vectT, 
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::SubtractBackgC(const Int_t& nIn, const Int_t&nJ, Float_t&etbgTotalN,
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::SubtractBackgStat(const Int_t& nIn, const Int_t&nJ,Float_t&etbgTotalN,
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::SubtractBackgCone(const Int_t& nIn, const Int_t&nJ,Float_t& etbgTotalN,
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::SubtractBackgRatio(const Int_t& nIn, const Int_t&nJ,Float_t& etbgTotalN,
                      const Float_t* ptT, const Float_t* etaT, const Float_t* phiT, const Int_t* cFlagT, const Int_t* sFlagT,
                      Float_t* const etJet, const Float_t* etaJet, const Float_t* phiJet,
                      Float_t* const etsigJet, Int_t* const multJet, Int_t* const injet)
{
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::WriteJHeaderToFile() const
{
  IlcUA1JetHeaderV1* header = (IlcUA1JetHeaderV1*) fHeader;
  header->Write();
}
...
////////////////////////////////////////////////////////////////////////
void IlcUA1JetFinderV2::InitTask(TChain* tree)
{
