void JetAnalysisManagerLoc()
{
    ...
    // Jet analysis
    //
    // IlcAnalysisTaskJets *jetana = new IlcAnalysisTaskJetsV2("JetAnalysis");         // Charged only
    IlcAnalysisTaskJets *jetana = new IlcAnalysisTaskJets("JetAnalysis",chain); // Charged + neutral
