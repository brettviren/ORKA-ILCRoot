...
/* $Id: IlcPVECPIDv0.cxx 53738 2011-12-20 16:49:27Z kharlov $ */
...
//     - shower width.
//
// CPV or Preshower clusters should be closer in PVEC plane than fCpvEmcDistance (in cm).
...
//
// use case:
//  root [0] IlcPVECPIDv0 * p1 = new IlcPVECPIDv0("gilc.root")
//  Warning in <TDatabasePDG::TDatabasePDG>: object already instantiated
//  root [1] p1->SetIdentificationMethod("disp ellipse")
//  root [2] p1->ExecuteTask()
//  root [3] IlcPVECPIDv0 * p2 = new IlcPVECPIDv0("gilc1.root","ts1")
//  Warning in <TDatabasePDG::TDatabasePDG>: object already instantiated
...
//____________________________________________________________________________
IlcPVECPIDv0::IlcPVECPIDv0(IlcPVECGeometry *geom) : 
  IlcPVECPID(geom),
  fIDOptions("dis time"),
  fClusterizer(0),
  fTSMaker(0),
...
//____________________________________________________________________________
IlcPVECPIDv0::IlcPVECPIDv0(const IlcPVECPIDv0 & rhs) :
  IlcPVECPID(rhs),
...
//____________________________________________________________________________
IlcPVECPIDv0 & IlcPVECPIDv0::operator = (const IlcPVECPIDv0 & rhs)
{
  //Copy-assignment, emulates compiler generated, possibly wrong.
  IlcPVECPID::operator = (rhs);
  if (this != &rhs) {
    fIDOptions = rhs.fIDOptions;
    fClusterizer = rhs.fClusterizer;
    fTSMaker = rhs.fTSMaker;
...
//DP
////____________________________________________________________________________
//Float_t  IlcPVECPIDv0::GetDistance(IlcPVECEmcRecPoint * emc,IlcPVECRecPoint * cpv, Option_t *  Axis)const
//{
//  // Calculates the distance between the EMC RecPoint and the PPSD RecPoint
// 
//  const IlcPVECGeometry * geom = IlcPVECLoader::GetPVECGeometry() ; 
//  TVector3 vecEmc ;
//  TVector3 vecCpv ;
//  
//  emc->GetLocalPosition(vecEmc) ;
//  cpv->GetLocalPosition(vecCpv) ; 
//  if(emc->GetPVECMod() == cpv->GetPVECMod()){ 
//    
...
//____________________________________________________________________________
void  IlcPVECPIDv0::TrackSegments2RecParticles(Option_t * option) 
{
  //Steering method
...
//____________________________________________________________________________
void  IlcPVECPIDv0::MakeRecParticles()
{
  ...
  while ( (ts = (IlcPVECTrackSegment *)next()) ) {
    ...
    IlcPVECRecPoint    * cpv = 0 ;
    if(ts->GetCpvIndex()>=0)
      cpv = (IlcPVECRecPoint *)   fCPVRecPoints->At(ts->GetCpvIndex()) ;
...
//____________________________________________________________________________
void  IlcPVECPIDv0:: Print(const Option_t *) const
{
  // Print the parameters used for the particle type identification
  TString message ; 
  message  = "=============== IlcPVECPIDv0 ================\n" ;
  message += "Making PID\n" ;
...
//____________________________________________________________________________
void  IlcPVECPIDv0::SetShowerProfileCut(const char * formula)
{
...
//____________________________________________________________________________
void  IlcPVECPIDv0::PlotDispersionCuts()const
{
...
//____________________________________________________________________________
TVector3 IlcPVECPIDv0::GetMomentumDirection(IlcPVECEmcRecPoint * emc, IlcPVECRecPoint * )const 
{ 
...
//____________________________________________________________________________
void IlcPVECPIDv0::PrintRecParticles(Option_t * option)
{
  ...
  if(strstr(option,"all")) {  // printing found TS
    ...
    for (index = 0 ; index < fRecParticles->GetEntries() ; index++) {
      ...
      Text_t particle[100];
      switch(rp->GetType()) {
      case  IlcPVECFastRecParticle::kNEUTRALEMFAST:
	strncpy( particle, "NEUTRAL EM FAST",100);
	break;
      case  IlcPVECFastRecParticle::kNEUTRALHAFAST:
	strncpy(particle, "NEUTRAL HA FAST",100);
	break;
      case  IlcPVECFastRecParticle::kNEUTRALEMSLOW:
	strncpy(particle, "NEUTRAL EM SLOW",100);
	break ;
      case  IlcPVECFastRecParticle::kNEUTRALHASLOW: 
	strncpy(particle, "NEUTRAL HA SLOW",100);
	break ;
      case  IlcPVECFastRecParticle::kCHARGEDEMFAST:
	strncpy(particle, "CHARGED EM FAST",100);
	break ;
      case  IlcPVECFastRecParticle::kCHARGEDHAFAST:
	strncpy(particle, "CHARGED HA FAST",100);
	break ;	
      case  IlcPVECFastRecParticle::kCHARGEDEMSLOW:
	strncpy(particle, "CHARGEDEMSLOW",100);
	break ;
      case  IlcPVECFastRecParticle::kCHARGEDHASLOW:
