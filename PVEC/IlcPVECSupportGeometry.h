#ifndef ILCPVECSUPPORTGEOMETRY_H
#define ILCPVECSUPPORTGEOMETRY_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECSupportGeometry.h 14911 2006-08-28 10:01:56Z kharlov $ */
...
class IlcPVECSupportGeometry : public TObject {

public: 

  IlcPVECSupportGeometry();
  virtual ~IlcPVECSupportGeometry(void) {}
...
private:
  ...
  Float_t fCradleWallThickness ;    // PVEC cradle wall thickness
  Float_t fCradleWall[5] ;          // Size of the wall of the PVEC cradle (shape TUBS)
  Float_t fCradleWheel[3] ;         // "Wheels" by which the cradle rolls over the rails

  ClassDef(IlcPVECSupportGeometry,1) // PVEC support geometry class 

} ;

#endif // IlcPVECSUPPORTGEOMETRY_H
