#ifndef ILCPVECCPVDIGIT_H
#define ILCPVECCPVDIGIT_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECCPVDigit.h 15036 2006-09-13 07:31:01Z kharlov $ */
...
class IlcPVECCPVDigit : public TObject {
  
public:
  virtual ~IlcPVECCPVDigit() {}
           IlcPVECCPVDigit();
           IlcPVECCPVDigit(Int_t x, Int_t y, Float_t q);
...
private:
  ...
  ClassDef(IlcPVECCPVDigit,1)  // Digit object in one CPV pad
};
