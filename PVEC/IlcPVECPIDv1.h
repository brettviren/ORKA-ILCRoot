#ifndef ILCPVECPIDV1_H
#define ILCPVECPIDV1_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECPIDv1.h 44091 2010-10-05 09:46:25Z prsnko $ */
...
class IlcPVECTrackSegmentMakerv1 ;
#include "IlcPVECPID.h"
#include "IlcPID.h"

class  IlcPVECPIDv1 : public IlcPVECPID {
  
public:
  
  IlcPVECPIDv1() ;          // ctor   
  IlcPVECPIDv1(IlcPVECGeometry *geom);
  IlcPVECPIDv1(const IlcPVECPIDv1 & pid) ;          // cpy ctor            
  
  virtual ~IlcPVECPIDv1() ; // dtor
  ...
  IlcPVECPIDv1 & operator = (const IlcPVECPIDv1 & /*pid*/) { return *this ;} 
...
private:
 ...
 // Relative Distance CPV-EMC
  Int_t   GetCPVBit       (IlcPVECTrackSegment * ts, Int_t EffPur, Float_t e) const;
  Int_t   GetPrincipalBit (TString particle, const Double_t* P, Int_t EffPur, Float_t e)const ; //Principal cut
  Int_t   GetHardPhotonBit(IlcPVECEmcRecPoint * emc) const;
  Int_t   GetHardPi0Bit   (IlcPVECEmcRecPoint * emc) const;
  TVector3      GetMomentumDirection(IlcPVECEmcRecPoint * emc, IlcPVECCpvRecPoint * cpv)const ;
...
private:
  ...
  ClassDef( IlcPVECPIDv1,13)  // Particle identifier implementation version 1

};

#endif // IlcPVECPIDV1_H
