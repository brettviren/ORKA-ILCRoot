#ifndef ILCPVECTRACKSEGMENTMAKERV2_H
#define ILCPVECTRACKSEGMENTMAKERV2_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECTrackSegmentMakerv2.h 20497 2007-08-28 12:55:08Z policheh $ */
...
class  IlcPVECTrackSegmentMakerv2 : public IlcPVECTrackSegmentMaker {

public:

  IlcPVECTrackSegmentMakerv2() ;                     
  IlcPVECTrackSegmentMakerv2(IlcPVECGeometry *geom);
  IlcPVECTrackSegmentMakerv2(const IlcPVECTrackSegmentMakerv2 & tsm);

  virtual ~ IlcPVECTrackSegmentMakerv2() ; // dtor
 ...
 virtual const char * Version() const { return "tsm-v2" ; }  
  ...
  IlcPVECTrackSegmentMakerv2 & operator = (const IlcPVECTrackSegmentMakerv2 & )  {
...
private:
  ...
  void  GetDistanceInPVECPlane(IlcPVECEmcRecPoint * EmcClu , IlcESDtrack* track,
...
private:  
  ...
  std::vector<TrackInPVEC_t> fTPCtracks[5];  //!
  Int_t fNtpcTracks[5] ;  //!
  ...
  ClassDef( IlcPVECTrackSegmentMakerv2,2)  // Implementation version 1 of algorithm class to make PVEC track segments 

 };

#endif // IlcPVECTRACKSEGMENTMAKERV2_H
