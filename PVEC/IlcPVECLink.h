#ifndef ILCPVECLINK_H
#define ILCPVECLINK_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECLink.h 17222 2007-03-06 06:53:55Z kharlov $ */

//_________________________________________________________________________
//  Algorithm class used only by IlcPVECTrackSegmentMaker 
//  Links recpoints
// into tracksegments                
...
class IlcPVECLink : public  TObject{
  
public:
  
  IlcPVECLink() ;  // ctor            
  IlcPVECLink( Float_t x, Float_t z, Int_t emc, Int_t cpv, Int_t track) ;  // ctor            
  virtual ~IlcPVECLink(){
    // dtor
  }
...
private:
  ...
  ClassDef(IlcPVECLink,2)  // Auxilliary algorithm class used by IlcPVECTrackSegmentMaker
