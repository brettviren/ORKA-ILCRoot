...
ClassImp(IlcPVECCpvCalibData)

//________________________________________________________________
  IlcPVECCpvCalibData::IlcPVECCpvCalibData() : TNamed()
{
  // Default constructor
  Reset();
}
...
//________________________________________________________________
IlcPVECCpvCalibData::IlcPVECCpvCalibData(const char* name)
{
  // Constructor
...
//________________________________________________________________
IlcPVECCpvCalibData::IlcPVECCpvCalibData(const IlcPVECCpvCalibData& calibda) :
  TNamed(calibda)
{
  // copy constructor
...
//________________________________________________________________
IlcPVECCpvCalibData &IlcPVECCpvCalibData::operator =(const IlcPVECCpvCalibData& calibda)
{
  // assignment operator
  SetName(calibda.GetName());
  SetTitle(calibda.GetName());
...
//________________________________________________________________
IlcPVECCpvCalibData::~IlcPVECCpvCalibData()
{
  // Destructor
}

//________________________________________________________________
void IlcPVECCpvCalibData::Reset()
{
...
//________________________________________________________________
void  IlcPVECCpvCalibData::Print(Option_t *option) const
{
...
//________________________________________________________________
Float_t IlcPVECCpvCalibData::GetADCchannelCpv(Int_t module, Int_t column, Int_t row) const
{
...
//________________________________________________________________
Float_t IlcPVECCpvCalibData::GetADCpedestalCpv(Int_t module, Int_t column, Int_t row) const
{
  //Return CPV pedestal
  //module, column,raw should follow the internal PVEC convention:
  //module 1:5, column 1:56, row 1:128.
...
//________________________________________________________________
void IlcPVECCpvCalibData::SetADCchannelCpv(Int_t module, Int_t column, Int_t row, Float_t value)
{
...
//________________________________________________________________
void IlcPVECCpvCalibData::SetADCpedestalCpv(Int_t module, Int_t column, Int_t row, Float_t value)
{
  //Set CPV pedestal
  //module, column,raw should follow the internal PVEC convention:
  //module 1:5, column 1:56, row 1:128.
