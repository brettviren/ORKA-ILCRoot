#ifndef ILCPVECCLUSTERIZER_H
#define ILCPVECCLUSTERIZER_H
...
class IlcPVECClusterizer : public TObject {

public:

  IlcPVECClusterizer() ;        // default ctor
  IlcPVECClusterizer(IlcPVECGeometry *geom);
  virtual ~IlcPVECClusterizer() ; // dtor
...
private:
  IlcPVECClusterizer(const IlcPVECClusterizer & clusterizer);
  IlcPVECClusterizer & operator = (const IlcPVECClusterizer &clusterer);

  ClassDef(IlcPVECClusterizer,5)  // Clusterization algorithm class 

} ;

#endif // IlcPVECCLUSTERIZER_H
