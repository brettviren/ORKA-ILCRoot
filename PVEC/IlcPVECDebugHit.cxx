...
/* $Id: IlcPVECebugHit.cxx 3095 2001-03-12 15:24:10Z schutz $ */
...
//____________________________________________________________________________
IlcPVECHit::IlcPVECHit(Int_t shunt, Int_t primary, Int_t track, Int_t id, Float_t *hits, Int_t pid, TLorentzVector p, Float_t *xy): IlcHit(shunt, track)
{
  //
...
//____________________________________________________________________________
ostream& operator << (ostream& out, const IlcPVECHit& hit) 
{
  // Print out Id and energy 
  
  out << "IlcPVECHit = " << hit.GetId() << " " << hit.GetEnergy() << endl ;
  return out ;
}
