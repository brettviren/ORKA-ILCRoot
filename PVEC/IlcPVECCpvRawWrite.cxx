...
#include "IlcPVECCpvRawWrite.h"
#include "IlcPVECDigit.h"
#include "IlcPVECGeometry.h"

ClassImp(IlcPVECCpvRawWrite)

//____________________________________________________________________________
IlcPVECCpvRawWrite::IlcPVECCpvRawWrite() : 
  TObject(),
  fNDDL(5),
  fNRow(16),
  fNDilogic(10),
...
//____________________________________________________________________________
void IlcPVECCpvRawWrite::WriteRaw(const TObjArray *pDigAll)
{
...
// Returns: none
  ...
  for(Int_t iCh=0;iCh<fNDDL;iCh++){//chambers loop
    ...
    for(Int_t iDig=0;iDig<pDigCh->GetEntriesFast();iDig++){//digits loop
      IlcPVECDigit *pDig1=(IlcPVECDigit*)pDigCh->At(iDig);
	...
	cntLpad=0;
	  ...
	  if (isDigThere[iCh][row][dil][pad]!=-1) {
	    IlcPVECDigit *pDig=(IlcPVECDigit*)pDigCh->At(isDigThere[iCh][row][dil][pad]);             
...
//____________________________________________________________________________
void IlcPVECCpvRawWrite::HWaddress(const IlcPVECDigit *digit, 
				   UInt_t &w32, Int_t &ddl, Int_t &row, Int_t &dilogic, Int_t &address)
{
// Convert IlcPVECDigit to raw word format
...
//____________________________________________________________________________
void IlcPVECCpvRawWrite::WriteEoE(IlcFstream *ddl,UInt_t row,UInt_t dil,UInt_t wordCnt  )
{
...
//____________________________________________________________________________
void IlcPVECCpvRawWrite::WriteRowMarker(IlcFstream *ddl,UInt_t size)
{
...
//____________________________________________________________________________
void IlcPVECCpvRawWrite::WriteSegMarker(IlcFstream *ddl,UInt_t row, Int_t nwInSeg)
{
