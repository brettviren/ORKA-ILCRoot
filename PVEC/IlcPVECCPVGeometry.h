#ifndef ILCPVECCPVGEOMETRY_H
#define ILCPVECCPVGEOMETRY_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECCPVGeometry.h 7865 2003-07-13 09:26:14Z hristov $ */

//_________________________________________________________________________
// Geometry derived class for PVEC:CPV (Charged particle veto, IHEP version)
...
//#include "IlcPVECCPVBaseGeometry.h"
#include "TObject.h"

class IlcPVECCPVGeometry : public TObject {

public: 

           IlcPVECCPVGeometry();
  virtual ~IlcPVECCPVGeometry(void) {};
...
private:
  ...
  ClassDef(IlcPVECCPVGeometry,2)       // CPV geometry base class 

} ;

#endif // IlcPVECCPVGEOMETRY_H
