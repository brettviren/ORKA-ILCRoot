#ifndef ILCPVECCPVBASEGEOMETRY_H
#define ILCPVECCPVBASEGEOMETRY_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECCPVBaseGeometry.h 7867 2003-07-13 11:00:31Z hristov $ */

//_________________________________________________________________________
// Geometry base class for PVEC:CVS (Charged particle veto)
...
class IlcPVECCPVBaseGeometry : public TObject {

public: 

           IlcPVECCPVBaseGeometry()     {}
  virtual ~IlcPVECCPVBaseGeometry(void) {}
...
/*   virtual void    SetLeadConverterThickness(Float_t x) = 0 ; */
  ...
  ClassDef(IlcPVECCPVBaseGeometry,1)        // CPV base geometry class 

} ;

#endif // ILCPVECCPVBASEGEOMETRY_H
