...
/* $Id: IlcPVECPreprocessor.cxx 47523 2011-02-17 14:35:05Z policheh $ */

///////////////////////////////////////////////////////////////////////////////
// PVEC Preprocessor class. It runs by Shuttle at the end of the run,
...
IlcPVECPreprocessor::IlcPVECPreprocessor() :
...
//_______________________________________________________________________________________
IlcPVECPreprocessor::IlcPVECPreprocessor(IlcShuttleInterface* shuttle):
...
//_______________________________________________________________________________________
UInt_t IlcPVECPreprocessor::Process(TMap* /*valueSet*/)
{
...
Bool_t IlcPVECPreprocessor::ProcessLEDRun()
{
  //Process LED run, update High Gain/Low Gain ratios.

  IlcPVECEmcCalibData calibData;
...
Float_t IlcPVECPreprocessor::HG2LG(Int_t mod, Int_t X, Int_t Z, TFile* f)
{
  //Calculates High gain to Low gain ratio 
  //for crystal at the position (X,Z) in the PVEC module mod.
...
Bool_t IlcPVECPreprocessor::FindBadChannelsEmc()
{
  ...
  for (Int_t i=0; i<2; i++) {
    ...
    IlcPVECEmcBadChannelsMap badMap;
...
Bool_t IlcPVECPreprocessor::DoFindBadChannelsEmc(Int_t system, TList* list, IlcPVECEmcBadChannelsMap& badMap)
{
  //Creates the bad channels map for PVEC EMC.
...
Bool_t IlcPVECPreprocessor::CalibrateEmc()
{
  //Loop over two systems: DAQ and HLT.
  //For each system the same algorithm implemented in DoCalibrateEmc() invokes.

  IlcPVECEmcCalibData*   lastCalib=0;
  const IlcPVECEmcBadChannelsMap* badMap=0;
  ...
  for (Int_t i=0; i<2; i++) {
    ...
    if(!entryBCM)
      ...
      badMap = (IlcPVECEmcBadChannelsMap*)entryBCM->GetObject();
    ...
    if(!entryEmc) 
      ...
      lastCalib = (IlcPVECEmcCalibData*)entryEmc->GetObject();
...
Bool_t IlcPVECPreprocessor::StoreReferenceEmc(Int_t system, TList* list)
{
  ...
  Bool_t resultRef = StoreReferenceFile(fileName.Data(),"CalibRefPVEC.root");
  return resultRef;

}

Bool_t IlcPVECPreprocessor::StoreReferenceLED(TList* list)
{
  ...
  Bool_t resultRef = StoreReferenceFile(fileName.Data(),"LEDRefPVEC.root");
  return resultRef;
  
}


Bool_t IlcPVECPreprocessor::DoCalibrateEmc(Int_t system, TList* list, const IlcPVECEmcBadChannelsMap* badMap, IlcPVECEmcCalibData& calibData)
{
  // Return kTRUE if OK.
