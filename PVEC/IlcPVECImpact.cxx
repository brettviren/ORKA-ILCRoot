...
/* $Id: IlcPVECImpact.cxx 53186 2011-11-25 14:28:01Z kharlov $ */
...
ClassImp(IlcPVECImpact)

//____________________________________________________________________________
IlcPVECImpact::IlcPVECImpact() : 
  fPid(0),
  fPrimary(0),
  fMomentum()
{
...
//____________________________________________________________________________
IlcPVECImpact::IlcPVECImpact(const IlcPVECImpact & hit) : 
  IlcHit(hit),
  fPid(hit.fPid),
...
//____________________________________________________________________________
IlcPVECImpact::IlcPVECImpact(Int_t shunt, Int_t primary, Int_t track, Int_t pid, TLorentzVector p, Float_t *xyz): 
  IlcHit(shunt, track),
  fPid(pid),
  fPrimary(primary),
  fMomentum(p)
{
  //
  // Create a PVEC hit impact object
  //
...
//____________________________________________________________________________
IlcPVECImpact & IlcPVECImpact::operator = (const IlcPVECImpact &)
{
...
//____________________________________________________________________________
void IlcPVECImpact::Print(const Option_t *)const
{
