#ifndef ILCPVECMODULEMISILCGNMENT_H
#define ILCPVECMODULEMISILCGNMENT_H
...
// Utility class to calculate PVEC module's 
// misalignment from ideal geometry (defined by IlcPVECGeometry)
// and survey data. 5 modules expected.
// Number of modules is specified by enumerator kModules here,
// if this number changes in IlcPVECGeometry
...
//
// For example, in
//    "PVEC MODULE Position 2 (Production 2) 
...
//
// ...
// IlcPVECGeometry * PVECGeom = IlcPVECGeometry::GetInstance("ORKA", "");
// ...
...
// ...
// IlcPVECModuleMisalignment delta(*PVECGeom);
...
class IlcPVECModuleMisalignment {
  enum {
    kModules = 5
  };

public:
  IlcPVECModuleMisalignment(const IlcPVECGeometry & geom, Bool_t debug = kFALSE);
  //ClassDef macro will add virtual functions,
  //so, I have to define virtual dtor
  //to supress warnings.
  virtual ~IlcPVECModuleMisalignment();
...
private:
  ...
  ClassDef(IlcPVECModuleMisalignment, 1)//Utility class for module misalignment.
};
