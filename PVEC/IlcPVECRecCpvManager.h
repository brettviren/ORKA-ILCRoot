#ifndef IlcPVECRecCpvManager_H
#define IlcPVECRecCpvManager_H
...
class IlcPVECRecCpvManager : public IlcPVECRecManager {

 public: 

  IlcPVECRecCpvManager();
  ~IlcPVECRecCpvManager(void);
 ...
 private:
  ...
  ClassDef(IlcPVECRecCpvManager,1)        // CPV reconstruction management class 

} ;

#endif // IlcPVECRecCpvManager_H
