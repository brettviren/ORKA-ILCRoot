...
/* $Id: IlcPVECPulseGenerator.cxx 54863 2012-02-28 12:10:29Z hristov $ */

// The class which simulates the pulse shape from the PVEC FEE shaper,
// make sampled amplitudes, digitize them.
// Use case:
//   IlcPVECPulseGenerator *pulse = new IlcPVECPulseGenerator(energy,time);
...
ClassImp(IlcPVECPulseGenerator) 

Int_t    IlcPVECPulseGenerator::fgOrder       = 2 ;        // order of the Gamma function
Double_t IlcPVECPulseGenerator::fgTimePeak    = 2.1E-6 ;   // tau=2.1 micro seconds
Double_t IlcPVECPulseGenerator::fgTimeTrigger = 100E-9 ;   // one tick 100 ns

//-----------------------------------------------------------------------------
IlcPVECPulseGenerator::IlcPVECPulseGenerator(Double_t a, Double_t t0)
...
//-----------------------------------------------------------------------------
IlcPVECPulseGenerator::~IlcPVECPulseGenerator()
{
...
//-----------------------------------------------------------------------------
void IlcPVECPulseGenerator::Reset()
{
...
//-----------------------------------------------------------------------------
void IlcPVECPulseGenerator::AddBaseline(Double_t baselineLevel)
{
...
//-----------------------------------------------------------------------------
void IlcPVECPulseGenerator::AddNoise(Double_t sigma)
{
...
//-----------------------------------------------------------------------------
void IlcPVECPulseGenerator::AddNoise(Double_t * /* sigma */, Double_t /* cutoff */)
{
...
//-----------------------------------------------------------------------------
void IlcPVECPulseGenerator::AddPretriggerSamples(Int_t nPresamples)
{
...
//-----------------------------------------------------------------------------
void IlcPVECPulseGenerator::Digitize()
{
...
//-----------------------------------------------------------------------------
Double_t IlcPVECPulseGenerator::RawResponseFunction(Double_t *x, Double_t *par) 
{
...
Bool_t IlcPVECPulseGenerator::MakeSamples()
{
  // for a start time fTZero and an amplitude fAmplitude given by digit, 
  // calculates the raw sampled response IlcPVECPulseGenerator::RawResponseFunction
...
//__________________________________________________________________
void IlcPVECPulseGenerator::GetSamples(Int_t *adcHG, Int_t *adcLG) const
{
...
//__________________________________________________________________
void IlcPVECPulseGenerator::Print(Option_t*) const
{
...
//__________________________________________________________________
void IlcPVECPulseGenerator::Draw(Option_t* opt)
{
