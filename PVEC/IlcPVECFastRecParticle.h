#ifndef ILCPVECFASTRECPARTICLE_H
#define ILCPVECFASTRECPARTICLE_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECFastRecParticle.h 53186 2011-11-25 14:28:01Z kharlov $ */
...
class IlcPVECFastRecParticle : public TParticle {
  
 public:
  
  IlcPVECFastRecParticle() ;
  
  IlcPVECFastRecParticle(const IlcPVECFastRecParticle & rp) ;  // ctor
  IlcPVECFastRecParticle(const TParticle & p) ;  // ctor
  virtual ~IlcPVECFastRecParticle(){ } //dtor
  IlcPVECFastRecParticle & operator = (const IlcPVECFastRecParticle & /*rp*/);
 ...
 private:
  ...
  ClassDef(IlcPVECFastRecParticle,2)  // Reconstructed Particle produced by the fast simulation 

};

#endif // IlcPVECFASTRECPARTICLE_H
