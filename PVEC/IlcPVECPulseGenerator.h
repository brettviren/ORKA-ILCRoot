#ifndef ILCPVECPULSEGENERATOR_H
#define ILCPVECPULSEGENERATOR_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                          */

/* $Id: IlcPVECPulseGenerator.h 54863 2012-02-28 12:10:29Z hristov $ */
...
class IlcPVECPulseGenerator : public TObject
{
public:
  IlcPVECPulseGenerator(Double_t a=0, Double_t t0=0);
  virtual  ~IlcPVECPulseGenerator();
...
private:
  IlcPVECPulseGenerator(const IlcPVECPulseGenerator & pulse);
  IlcPVECPulseGenerator& operator = (const IlcPVECPulseGenerator &) {return *this;}
...
private:
  ...
  ClassDef(IlcPVECPulseGenerator,1)
