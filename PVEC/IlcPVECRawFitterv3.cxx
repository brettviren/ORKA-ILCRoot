...
ClassImp(IlcPVECRawFitterv3)

//-----------------------------------------------------------------------------
IlcPVECRawFitterv3::IlcPVECRawFitterv3():
  IlcPVECRawFitterv0()
{
  //Default constructor.
}
...
//-----------------------------------------------------------------------------
IlcPVECRawFitterv3::IlcPVECRawFitterv3(const IlcPVECRawFitterv3 &PVECFitter ):
...
//-----------------------------------------------------------------------------
IlcPVECRawFitterv3& IlcPVECRawFitterv3::operator = (const IlcPVECRawFitterv3 & /*PVECFitter*/)
{
  //Assignment operator.
  return *this;
}
...
//-----------------------------------------------------------------------------
Bool_t IlcPVECRawFitterv3::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
...
//      IlcWarning(Form("Can not read data from OCDB")) ;
  ...
  if(a==0.){
    if(b==0.){ //no roots
      fQuality = 2000. ;
      if(IlcLog::GetDebugLevel("PVEC","IlcPVECRawFitterv3")>3){
        printf(" a=%f, b=%f, c=%f \n",a,b,c) ;
        goto plot ;
      }
      return kTRUE ;
