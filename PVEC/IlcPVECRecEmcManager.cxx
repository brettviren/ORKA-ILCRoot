...
/* $Id: IlcPVECRecEmcManager.cxx 48717 2011-03-24 15:51:37Z kharlov $ */
...
ClassImp(IlcPVECRecEmcManager) 

//____________________________________________________________________________

IlcPVECRecEmcManager::IlcPVECRecEmcManager():
...
IlcPVECRecEmcManager::~IlcPVECRecEmcManager(void) {}

Float_t IlcPVECRecEmcManager::Dispersion(Float_t ei) const
{
...
Float_t IlcPVECRecEmcManager::OneGamChi2(Float_t ai, Float_t ei, Float_t, Float_t& gi) const
{
...
Float_t IlcPVECRecEmcManager::TwoGamChi2(Float_t ai, Float_t ei, Float_t, Float_t& gi) const
{
  // calculates chi^2
  Float_t da = ai - ei;
  Float_t d = ei; // we assume that sigma(E) = sqrt(E)
...
void IlcPVECRecEmcManager::AG(Float_t ei, Float_t xi, Float_t yi, Float_t& ai, Float_t& gxi, Float_t& gyi )
{
  ...
  // to the pad center.
  //Shape of the shower is from PVEC TDR.
