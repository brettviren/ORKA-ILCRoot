#ifndef ILCPVECTRACKSEGMENTMAKERV1_H
#define ILCPVECTRACKSEGMENTMAKERV1_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECTrackSegmentMakerv1.h 35594 2009-10-15 15:40:35Z prsnko $ */
...
class  IlcPVECTrackSegmentMakerv1 : public IlcPVECTrackSegmentMaker {

public:

  IlcPVECTrackSegmentMakerv1() ;                     
  IlcPVECTrackSegmentMakerv1(IlcPVECGeometry *geom);
  IlcPVECTrackSegmentMakerv1(const IlcPVECTrackSegmentMakerv1 & tsm);

  virtual ~ IlcPVECTrackSegmentMakerv1() ; // dtor
  
  virtual void   Clusters2TrackSegments(Option_t *option); // Does the job
          void   FillOneModule() ;       // Finds range in which RecPoints belonging current PVEC module are
  ...
  virtual void   SetMaxEmcCPVDistance(Float_t r){ fRcpv = r ;} //Maximal distance (in PVEC plane) 
  ...
  IlcPVECTrackSegmentMakerv1 & operator = (const IlcPVECTrackSegmentMakerv1 & )  {
...
private:
  ...
  void  GetDistanceInPVECPlane(IlcPVECEmcRecPoint * EmcClu , IlcPVECCpvRecPoint * Cpv, 
...
private:  
  ...
  Int_t fEmcFirst;     //! Index of first EMC RecPoint belonging to currect PVEC module
  Int_t fEmcLast ;     //!
  ...
  ClassDef( IlcPVECTrackSegmentMakerv1,4)  // Implementation version 1 of algorithm class to make PVEC track segments 

 };

#endif // IlcPVECTRACKSEGMENTMAKERV1_H
