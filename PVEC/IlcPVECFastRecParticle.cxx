...
/* $Id: IlcPVECFastRecParticle.cxx 53186 2011-11-25 14:28:01Z kharlov $ */
...
//  A  Particle modified by PVEC response and produced by IlcPVECvFast
//  To become a general class of IlcRoot ?    
//--
//  This is also a base class for IlcPVECRecParticle produced by IlcPVECPIDv1
//  The rec.particle type is to be defined by IlcPVECvFast or IlcPVECPIDv1
//--
...
ClassImp(IlcPVECFastRecParticle) 

//____________________________________________________________________________
IlcPVECFastRecParticle::IlcPVECFastRecParticle() :
  fIndexInList(0),
  fTof(0.f),
  fType(0)
{
...
//____________________________________________________________________________
 IlcPVECFastRecParticle::IlcPVECFastRecParticle(const IlcPVECFastRecParticle & rp)
   : TParticle(rp),
...
//____________________________________________________________________________
 IlcPVECFastRecParticle::IlcPVECFastRecParticle(const TParticle & pp) :
   fIndexInList(0),
   fTof(0.f),
   fType(0)
{
  ...
  IlcPVECFastRecParticle & p = (IlcPVECFastRecParticle &)(pnoconst) ;
  fPdgCode     = p.fPdgCode;
...
//____________________________________________________________________________
IlcPVECFastRecParticle & IlcPVECFastRecParticle::operator = (const IlcPVECFastRecParticle &)
{
...
//____________________________________________________________________________
Int_t IlcPVECFastRecParticle::DistancetoPrimitive(Int_t px, Int_t py)
{
  //  Compute distance from point px,py to a IlcPVECFastRecParticle considered as a Tmarker
...
//___________________________________________________________________________
 void IlcPVECFastRecParticle::Draw(Option_t *option)
 {
   // Draw this IlcPVECFastRecParticle with its current attributes
    
   AppendPad(option);
 }

//______________________________________________________________________________
void IlcPVECFastRecParticle::ExecuteEvent(Int_t event, Int_t , Int_t )
{
  //  Execute action corresponding to one event
  //  This member function is called when a IlcPVECFastRecParticle is clicked with the locator
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsPhoton(TString purity) const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsPi0(TString purity) const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsElectron(TString purity) const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsEleCon(TString purity) const
{
  // Rec.Particle is an electron if it has a photon-like shape, fast and charged
  // photon-like shape is defined with a purity "low", "medium" or "high"
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsHardPhoton() const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsHardPi0() const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsChargedHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsNeutralHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsFastChargedHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsSlowChargedHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsFastNeutralHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVECFastRecParticle::IsSlowNeutralHadron() const
{
  // Rec.Particle is a slow neutral hadron if it does not look like
  // a low-purity photon nor low-purity pi0, is high-purity neutral
  // and is not high-purity fast
...
//____________________________________________________________________________
TString IlcPVECFastRecParticle::Name() const
{
...
//______________________________________________________________________________
void IlcPVECFastRecParticle::SetType(Int_t type) { 
...
//______________________________________________________________________________
void IlcPVECFastRecParticle::Paint(Option_t *)
{
...
//____________________________________________________________________________
void IlcPVECFastRecParticle::Print(const Option_t *)const
{
