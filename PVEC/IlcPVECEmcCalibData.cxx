...
///////////////////////////////////////////////////////////////////////////////
//                                                                           //
// class for PVEC EmCal calibration                                          //
//                                                                           //
///////////////////////////////////////////////////////////////////////////////

#include "IlcPVECEmcCalibData.h"

ClassImp(IlcPVECEmcCalibData)

//________________________________________________________________
IlcPVECEmcCalibData::IlcPVECEmcCalibData():
  TNamed(),
  fSampleTimeStep(0)
{
  // Default constructor
...
//________________________________________________________________
IlcPVECEmcCalibData::IlcPVECEmcCalibData(const char* name):
  TNamed(),
  fSampleTimeStep(0)
{
  // Constructor
...
//________________________________________________________________
IlcPVECEmcCalibData::IlcPVECEmcCalibData(const IlcPVECEmcCalibData& calibda) :
  TNamed(calibda),
...
//________________________________________________________________
IlcPVECEmcCalibData &IlcPVECEmcCalibData::operator =(const IlcPVECEmcCalibData& calibda)
{
  // assignment operator
...
//________________________________________________________________
void IlcPVECEmcCalibData::Reset()
{
...
//________________________________________________________________
void  IlcPVECEmcCalibData::Print(Option_t *option) const
{
...
//________________________________________________________________
Float_t IlcPVECEmcCalibData::GetADCchannelEmc(Int_t module, Int_t column, Int_t row) const
{
...
//________________________________________________________________
Float_t IlcPVECEmcCalibData::GetADCpedestalEmc(Int_t module, Int_t column, Int_t row) const
{
  //Return EMC pedestal
  //module, column,raw should follow the internal PVEC convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
Float_t IlcPVECEmcCalibData::GetHighLowRatioEmc(Int_t module, Int_t column, Int_t row) const
{
  //Return EMC pedestal
  //module, column,raw should follow the internal PVEC convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
Float_t IlcPVECEmcCalibData::GetTimeShiftEmc(Int_t module, Int_t column, Int_t row) const
{
  //Return EMC pedestal
  //module, column,raw should follow the internal PVEC convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
Float_t IlcPVECEmcCalibData::GetSampleTimeStep()const
{
...
//________________________________________________________________
Int_t IlcPVECEmcCalibData::GetAltroOffsetEmc(Int_t module, Int_t column, Int_t row) const
{
...
//________________________________________________________________
void IlcPVECEmcCalibData::SetADCchannelEmc(Int_t module, Int_t column, Int_t row, Float_t value)
{
...
//________________________________________________________________
void IlcPVECEmcCalibData::SetADCpedestalEmc(Int_t module, Int_t column, Int_t row, Float_t value)
{
  //Set EMC pedestal
  //module, column,raw should follow the internal PVEC convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
void IlcPVECEmcCalibData::SetHighLowRatioEmc(Int_t module, Int_t column, Int_t row, Float_t value)
{
  //Set EMC pedestal
  //module, column,raw should follow the internal PVEC convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
void IlcPVECEmcCalibData::SetTimeShiftEmc(Int_t module, Int_t column, Int_t row, Float_t value)
{
  //Set EMC pedestal
  //module, column,raw should follow the internal PVEC convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
void IlcPVECEmcCalibData::SetAltroOffsetEmc(Int_t module, Int_t column, Int_t row, Int_t value)
{
  //Set EMC pedestal
  //module, column,raw should follow the internal PVEC convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
void IlcPVECEmcCalibData::SetSampleTimeStep(Float_t step)
{
...
//________________________________________________________________
Float_t IlcPVECEmcCalibData::GetADCchannelEmcDecalib(Int_t module, Int_t column, Int_t row) const
{
...
void IlcPVECEmcCalibData::SetADCchannelEmcDecalib(Int_t module, Int_t column, Int_t row, Float_t value)
{
