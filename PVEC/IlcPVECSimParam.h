#ifndef ILCPVECSIMPARAM_H
#define ILCPVECSIMPARAM_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                          */

/* $Id: IlcPVECSimParam.h 23530 2008-01-25 06:46:13Z prsnko $ */
                                              
// Base class for the PVEC simulation parameters.
// Do not use in the reconstruction; use derivative classes instead.

#include "TNamed.h"
#include "TMath.h"

class IlcPVECSimParam : public TNamed {

public:

  IlcPVECSimParam();
  IlcPVECSimParam(const IlcPVECSimParam& recoParam);
  IlcPVECSimParam& operator = (const IlcPVECSimParam& recoParam);
  virtual ~IlcPVECSimParam() {}

  static IlcPVECSimParam * GetInstance() ;

  //Parameters used in conversion of deposited energy to APD response [see IlcPVECv1 for details]
  ...
  //Parameters use in EMC noise calculation [see IlcPVECDigitizer for details]
  ...
  //Parameters for energy digitization [see IlcPVECDigitizer for details]
  ...
  //Parameters for EMC TOF resolution [see IlcPVECDigitizer::TimeResolution()]
  ...
  //Parameters for CPV noise and digitization  [see IlcPVECDigitizer for details] 
...
private:
  ...
  IlcPVECSimParam(Int_t i); //True constructor which should be called by GetInstance()

private:

  //Parameters used in conversion of deposited energy to APD response (IlcPVECv1)
  ...
  //Parameters used in electronic noise calculation and thresholds for EMC (IlcPVECDigitizer)
  ...
  Bool_t fCellNonLineaityOn ;  //Model scintillator non-linearity in IlcPVECDigitizer
  
  static IlcPVECSimParam * fgSimParam ; // pointer to the unique instance of the class

  ClassDef(IlcPVECSimParam,3)
};
