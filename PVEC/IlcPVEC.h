...
/* $Id: IlcPVEC.h 52261 2011-10-23 15:46:57Z hristov $ */
 ...
 * Follow IlcAlignObj framework and remove IlcPVECAlignData (Yu.Kharlov)
 *
 * Revision 1.66  2006/03/24 21:39:33  schutz
 * Modification needed to include PVEC in the global trigger framework
 *
...
class IlcPVEC : public IlcDetector {

public:

  IlcPVEC() ;
  IlcPVEC(const char* name, const char* title="") ;  
  virtual ~IlcPVEC() ; 
  ...
  virtual IlcPVECGeometry * GetGeometry() const
  {return IlcPVECGeometry::GetInstance(GetTitle(),"") ;  }
 ...
 private:                                        
  IlcPVEC(IlcPVEC & PVEC);
  IlcPVEC & operator = (const IlcPVEC & /*rvalue*/);

 protected:
  IlcPVECCalibData * fgCalibData ; //!  Pointer to Calibration DB

  ClassDef(IlcPVEC,6) // Photon Spectrometer Detector (base class)
} ;
