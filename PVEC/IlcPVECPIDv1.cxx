...
/* $Id: IlcPVECPIDv1.cxx 44091 2010-10-05 09:46:25Z prsnko $ */
...
// Implementation version v1 of the PVEC particle identifier 
...
//      file is $ILC_ROOT/PVEC/PCA8pa15_0.5-100.root. Analysis done for 
...
//      $ILC_ROOT/PVEC/Parameters.dat. Each time that IlcPVECPIDv1 is 
//      initialized, this parameters are copied to a Matrix (9,4), a 
//      TMatrixD object.  
//
// use case:
//  root [0] IlcPVECPIDv1 * p = new IlcPVECPIDv1("gilc1.root")
...
//                  
//  root [2] IlcPVECPIDv1 * p2 = new IlcPVECPIDv1("gilc1.root","v1",kTRUE)
//  Warning in <TDatabasePDG::TDatabasePDG>: object already instantiated
//                //Split mode.  
...
ClassImp( IlcPVECPIDv1) 

//____________________________________________________________________________
IlcPVECPIDv1::IlcPVECPIDv1() :
  IlcPVECPID(),
  fBayesian(kFALSE),
  fDefaultInit(kFALSE),
  fWrite(kFALSE),
...
//____________________________________________________________________________
IlcPVECPIDv1::IlcPVECPIDv1(const IlcPVECPIDv1 & pid ) : 
  IlcPVECPID(pid),
  fBayesian(kFALSE),
  fDefaultInit(kFALSE),
  fWrite(kFALSE),
...
//____________________________________________________________________________
IlcPVECPIDv1::IlcPVECPIDv1(IlcPVECGeometry *geom):
  IlcPVECPID(geom),
  fBayesian(kFALSE),
  fDefaultInit(kFALSE),
  fWrite(kFALSE),
...
//____________________________________________________________________________
void IlcPVECPIDv1::InitParameters()
{
...
void  IlcPVECPIDv1::TrackSegments2RecParticles(Option_t *option)
{
  ...
  if(strstr(option,"deb"))
      PrintRecParticles(option);
  if(strstr(option,"tim")){
    gBenchmark->Stop("PVECPID");
    IlcInfo(Form("took %f seconds for PID", 
		 gBenchmark->GetCpuTime("PVECPID")));  
  }
}

//________________________________________________________________________
Double_t  IlcPVECPIDv1::GausF(Double_t  x, Double_t  y, Double_t * par)
{
...
//________________________________________________________________________
Double_t  IlcPVECPIDv1::GausPol2(Double_t  x, Double_t y, Double_t * par)
{
  //Given the energy x and the parameter y (tof, shower dispersion or cpv-emc distance), 
  //this method returns a density probability of this parameter, given by a gaussian 
...
//____________________________________________________________________________
const TString IlcPVECPIDv1::GetFileNamePrincipal(TString particle) const
{
...
//____________________________________________________________________________
Float_t  IlcPVECPIDv1::GetParameterCalibration(Int_t i) const 
{
...
//____________________________________________________________________________
Float_t  IlcPVECPIDv1::GetParameterCpv2Emc(Int_t i, TString axis) const 
{
...
//____________________________________________________________________________
Float_t  IlcPVECPIDv1::GetCpv2EmcDistanceCut(TString axis, Float_t e) const
{
...
//____________________________________________________________________________
Float_t  IlcPVECPIDv1::GetEllipseParameter(TString particle, TString param, Float_t e) const 
{
...
Float_t  IlcPVECPIDv1::GetParameterPhotonBoundary (Int_t i) const
{ 
...
//____________________________________________________________________________
Float_t  IlcPVECPIDv1::GetParameterPi0Boundary (Int_t i) const
{ 
  // Get the parameter "i" to calculate the boundary on the moment M2x
  // for pi0 at high p_T
  Float_t param = 0;
...
//____________________________________________________________________________
Float_t  IlcPVECPIDv1::GetParameterTimeGate(Int_t i) const
{
...
//_____________________________________________________________________________
Float_t  IlcPVECPIDv1::GetParameterToCalculateEllipse(TString particle, TString param, Int_t i) const
{ 
...
//____________________________________________________________________________
Int_t  IlcPVECPIDv1::GetCPVBit(IlcPVECTrackSegment * ts, Int_t effPur, Float_t e) const
{
...
//____________________________________________________________________________
Int_t  IlcPVECPIDv1::GetPrincipalBit(TString particle, const Double_t* p, Int_t effPur, Float_t e)const
{
...
//____________________________________________________________________________
Int_t  IlcPVECPIDv1::GetHardPhotonBit(IlcPVECEmcRecPoint * emc) const
{
...
//____________________________________________________________________________
Int_t  IlcPVECPIDv1::GetHardPi0Bit(IlcPVECEmcRecPoint * emc) const
{
...
//____________________________________________________________________________
TVector3 IlcPVECPIDv1::GetMomentumDirection(IlcPVECEmcRecPoint * emc, IlcPVECCpvRecPoint * )const 
{ 
  ...
  Float_t x=local.X() ;
  Float_t z=local.Z() ;
  PVECgeom->GetIncidentVector(vtxOld,emc->GetPVECMod(),x,z,vInc) ;
  Float_t depthxOld = 0.;
  Float_t depthzOld = 0.;
  ...
  //Apply Real vertex
  PVECgeom->GetIncidentVector(fVtx,emc->GetPVECMod(),x,z,vInc) ;
  Float_t depthx = 0.;
  Float_t depthz = 0.;
  if (energy > 0 && vInc.Y()!=0.) {
  ...
  TVector3 dir(0,0,0) ; 
  PVECgeom->Local2Global(emc->GetPVECMod(),xd,zd,dir) ;
...
//________________________________________________________________________
Double_t  IlcPVECPIDv1::LandauF(Double_t  x, Double_t y, Double_t * par)
{
  //Given the energy x and the parameter y (tof, shower dispersion or cpv-emc distance), 
...
//________________________________________________________________________
Double_t  IlcPVECPIDv1::LandauPol2(Double_t  x, Double_t y, Double_t * par)
{
...
// //________________________________________________________________________
// Double_t  IlcPVECPIDv1::ChargedHadronDistProb(Double_t  x, Double_t y, Double_t * parg, Double_t * parl)
// {
//   Double_t cnt   = 0.0 ;
//   Double_t mean  = 0.0 ;
//   Double_t sigma = 0.0 ;
...
void  IlcPVECPIDv1::MakePID()
{
  ...
  while ( (ts = (IlcPVECTrackSegment *)next()) ) {
    
    //cout<<">>>>>> Bayesian Index "<<index<<endl;

    IlcPVECEmcRecPoint * emc = 0 ;
    if(ts->GetEmcIndex()>=0)
      emc = (IlcPVECEmcRecPoint *) fEMCRecPoints->At(ts->GetEmcIndex()) ;
    
//    IlcPVECCpvRecPoint * cpv = 0 ;
//    if(ts->GetCpvIndex()>=0)
//      cpv = (IlcPVECCpvRecPoint *) cpvRecPoints->At(ts->GetCpvIndex()) ;
//    
////     Int_t track = 0 ; 
...
//     }
  ...
  for(index = 0 ; index < nparticles ; index ++) {
    ...
    IlcPVECRecParticle * recpar = static_cast<IlcPVECRecParticle *>(fRecParticles->At(index));
...
//____________________________________________________________________________
void  IlcPVECPIDv1::MakeRecParticles()
{
  ...
  IlcPVECTrackSegment * ts ; 
  Int_t index = 0 ; 
  IlcPVECRecParticle * rp ; 
  while ( (ts = (IlcPVECTrackSegment *)next()) ) {
    //  cout<<">>>>>>>>>>>>>>>PCA Index "<<index<<endl;
    new( (*fRecParticles)[index] ) IlcPVECRecParticle() ;
    rp = (IlcPVECRecParticle *)fRecParticles->At(index) ; 
    ...
    IlcPVECCpvRecPoint * cpv = 0 ;
    if(ts->GetCpvIndex()>=0)
      cpv = (IlcPVECCpvRecPoint *) fCPVRecPoints->At(ts->GetCpvIndex()) ;
    ...
    IlcPVECTrackSegment * ts1  = static_cast<IlcPVECTrackSegment *>(fTrackSegments->At(rp->GetPVECTSIndex()));
    IlcPVECEmcRecPoint  * erp = static_cast<IlcPVECEmcRecPoint *>(fEMCRecPoints->At(ts1->GetEmcIndex()));
    TVector3 pos ; 
    fGeom->GetGlobalPVEC(erp, pos) ; 
    rp->SetPos(pos);
    index++ ; 
  }
}
...
//____________________________________________________________________________
void  IlcPVECPIDv1::Print(const Option_t *) const
{
  // Print the parameters used for the particle type identification

    IlcInfo("=============== IlcPVECPIDv1 ================") ;
    printf("Making PID\n") ;
...
//____________________________________________________________________________
void IlcPVECPIDv1::PrintRecParticles(Option_t * option)
{
  ...
  if(strstr(option,"all")) {  // printing found TS
    ...
    for (index = 0 ; index < fRecParticles->GetEntries() ; index++) {
      IlcPVECRecParticle * rp = (IlcPVECRecParticle * ) fRecParticles->At(index) ;       
      message += "\n" ;
...
//____________________________________________________________________________
void  IlcPVECPIDv1::SetParameters() 
{
  ...
  fFileNamePrincipalPhoton = "$ILC_ROOT/PVEC/PCA8pa15_0.5-100.root" ; 
  ...
  fFileNamePrincipalPi0    = "$ILC_ROOT/PVEC/PCA_pi0_40-120.root" ;
  ...
  fFileNameParameters = gSystem->ExpandPathName("$ILC_ROOT/PVEC/Parameters.dat");
...
//____________________________________________________________________________
void  IlcPVECPIDv1::SetParameterCalibration(Int_t i,Float_t param) 
{
...
//____________________________________________________________________________
void  IlcPVECPIDv1::SetParameterCpv2Emc(Int_t i, TString axis, Float_t cut) 
{
...
//____________________________________________________________________________
void  IlcPVECPIDv1::SetParameterPhotonBoundary(Int_t i,Float_t param) 
{
...
//____________________________________________________________________________
void  IlcPVECPIDv1::SetParameterPi0Boundary(Int_t i,Float_t param) 
{
...
//_____________________________________________________________________________
void  IlcPVECPIDv1::SetParameterTimeGate(Int_t i, Float_t gate) 
{
...
//_____________________________________________________________________________
void  IlcPVECPIDv1::SetParameterToCalculateEllipse(TString particle, TString param, Int_t i, Float_t par) 
{  
...
//____________________________________________________________________________
void IlcPVECPIDv1::GetVertex(void)
