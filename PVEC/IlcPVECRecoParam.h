#ifndef ILCPVECRECOPARAM_H
#define ILCPVECRECOPARAM_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                          */

/* $Id: IlcPVECRecoParam.h 53524 2011-12-11 21:34:35Z policheh $ */
...
class IlcPVECRecoParam : public IlcDetectorRecoParam {

public:

  IlcPVECRecoParam();
  IlcPVECRecoParam(const IlcPVECRecoParam& recoParam);
  IlcPVECRecoParam& operator = (const IlcPVECRecoParam& recoParam);
  virtual ~IlcPVECRecoParam() {}
  ...
  static IlcPVECRecoParam* GetDefaultParameters();
...
protected:
  ...
  Float_t fTimeGateLow ;           // EMC: Time difference between cells in PVEC cluster (bad time estimate)
  Float_t fTimeGateHigh ;          // EMC: Time difference between cells in PVEC cluster (good time estimate)
  ...
  TString fEMCFitterVersion ;      // EMC: IlcPVECRawFitter version
  ...
  static TObject* fgkTrigParams;   // PVEC trigger parameters

  ClassDef(IlcPVECRecoParam,12)
};
