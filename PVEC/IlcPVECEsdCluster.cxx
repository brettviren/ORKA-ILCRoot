...
//  IlcESDCaloCluster extension for PVEC to recalculate cluster 
...
#include "IlcPVECEsdCluster.h" 
#include "IlcPVECCalibData.h"
#include "IlcESDCaloCells.h"

ClassImp(IlcPVECEsdCluster)

//____________________________________________________________________________
IlcPVECEsdCluster::IlcPVECEsdCluster() : 
  IlcESDCaloCluster(),fRecalibrated(0)
{
  // ctor
}
//____________________________________________________________________________
IlcPVECEsdCluster::IlcPVECEsdCluster(const IlcESDCaloCluster & clu) : 
...
//____________________________________________________________________________
void IlcPVECEsdCluster::Recalibrate(IlcPVECCalibData * calibData,IlcESDCaloCells *phsCells){
  ...
  for(Int_t i=0; i<fNCells; i++){
    Int_t relId[4];
    PVECgeom->AbsToRelNumbering(fCellsAbsId[i],relId) ;
...
//____________________________________________________________________________
void  IlcPVECEsdCluster::EvalAll(Float_t logWeight, TVector3 &vtx){
...
//____________________________________________________________________________
void IlcPVECEsdCluster::EvalEnergy(){
...
//____________________________________________________________________________
void IlcPVECEsdCluster::EnergyCorrection(){
  //apply nonlinearity correction 
  fEnergy = IlcPVECReconstructor::CorrectNonlinearity(fEnergy) ;
}
//____________________________________________________________________________
void IlcPVECEsdCluster::EvalPID(IlcPVECPIDv1 * /*pid*/){           
...
//____________________________________________________________________________
void IlcPVECEsdCluster::EvalCoord(Float_t logWeight, TVector3 &vtx)
{
  ...
  for(Int_t iDigit=0; iDigit<fNCells; iDigit++) {
    Float_t xi ;
    Float_t zi ;
    PVECgeom->AbsToRelNumbering(fCellsAbsId[iDigit], relid) ;
