#ifndef ILCPVECTRIGGERPARAMETERS_H
#define ILCPVECTRIGGERPARAMETERS_H
...
/* $Id: IlcPVECTriggerParameters.h 55807 2012-04-17 20:40:19Z hristov $ */
 ...
 */
class IlcPVECTriggerParameters : public TNamed
{

public:
  IlcPVECTriggerParameters();
  IlcPVECTriggerParameters(const char* name);
  IlcPVECTriggerParameters(const IlcPVECTriggerParameters& );
  IlcPVECTriggerParameters& operator= (const IlcPVECTriggerParameters& );
  virtual ~IlcPVECTriggerParameters();
  ...
  // Constants
  static const Int_t kNMods     = 5; // Number of PVEC Modules
...
protected:
  ...
  ClassDef(IlcPVECTriggerParameters, 1) // PVEC Trigger Parameters
};
