...
/* $Id: IlcPVECEmcRecPoint.cxx 47523 2011-02-17 14:35:05Z policheh $ */
...
//  RecPoint implementation for PVEC-EMC 
...
ClassImp(IlcPVECEmcRecPoint)

//____________________________________________________________________________
IlcPVECEmcRecPoint::IlcPVECEmcRecPoint() : 
  IlcPVECRecPoint(),
...
//____________________________________________________________________________
IlcPVECEmcRecPoint::IlcPVECEmcRecPoint(const char * opt) : 
  IlcPVECRecPoint(opt),
  fCoreEnergy(0.), fDispersion(0.),
  fEnergyList(0), fTime(-1.), fNExMax(0),
  fM2x(0.), fM2z(0.), fM3x(0.), fM4z(0.),
...
//____________________________________________________________________________
IlcPVECEmcRecPoint::IlcPVECEmcRecPoint(const IlcPVECEmcRecPoint & rp) : 
  IlcPVECRecPoint(rp),
...
//____________________________________________________________________________
void IlcPVECEmcRecPoint::AddDigit(IlcPVECDigit & digit, Float_t Energy, Float_t time)
{
...
//____________________________________________________________________________
Bool_t IlcPVECEmcRecPoint::AreNeighbours(IlcPVECDigit * digit1, IlcPVECDigit * digit2 ) const
{
...
//____________________________________________________________________________
Int_t IlcPVECEmcRecPoint::Compare(const TObject * obj) const
{
  ...
  IlcPVECEmcRecPoint * clu = (IlcPVECEmcRecPoint *)obj ; 
...
void IlcPVECEmcRecPoint::ExecuteEvent(Int_t event, Int_t, Int_t) /*const*/
{
  ...
  IlcPVECLoader* PVECLoader = dynamic_cast<IlcPVECLoader*>(rn->GetLoader("PVECLoader"));
  if (PVECLoader == 0x0) 
    {
      IlcError(Form("Cannot find PVEC Loader from Run Loader"));
      return;
    }
  ...
  case kButton1Down: {
    ...
    const Int_t kMulDigit = IlcPVECEmcRecPoint::GetDigitsMultiplicity() ; 
...
//____________________________________________________________________________
void  IlcPVECEmcRecPoint::EvalDispersion(Float_t logWeight,TClonesArray * digits, TVector3 & /* vInc */)
{
...
//______________________________________________________________________________
void IlcPVECEmcRecPoint::EvalCoreEnergy(Float_t logWeight, Float_t coreRadius, TClonesArray * digits)
{
...
//____________________________________________________________________________
void  IlcPVECEmcRecPoint::EvalElipsAxis(Float_t logWeight,TClonesArray * digits, TVector3 & /* vInc */)
{
...
//   Double_t CosZ ;
//   IlcPVECGeometry * PVECgeom = IlcPVECGeometry::GetInstance() ;
//   Double_t DistanceToIP= (Double_t ) PVECgeom->GetIPtoCrystalSurface() ;
...
//____________________________________________________________________________
void  IlcPVECEmcRecPoint::EvalMoments(Float_t logWeight,TClonesArray * digits, TVector3 & /* vInc */)
{
  ...
  for(iDigit=0; iDigit<fMulDigit; iDigit++) {
    digit = (IlcPVECDigit *) digits->At(fDigitsList[iDigit])  ;
    PVECgeom->AbsToRelNumbering(digit->GetId(), relid) ;
    PVECgeom->RelPosInModule(relid, xiPVEC, ziPVEC);
    xi    = xiPVEC*cosPhi + ziPVEC*sinPhi;
    zi    = ziPVEC*cosPhi - xiPVEC*sinPhi;
    if (fAmp>0 && fEnergyList[iDigit]>0) {
      w     = TMath::Max(0.,logWeight+TMath::Log(fEnergyList[iDigit]/fAmp ) ) ;
      x    += w * xi ;
      z    += w * zi ; 
...
//______________________________________________________________________________
void  IlcPVECEmcRecPoint::EvalPrimaries(TClonesArray * digits)
{
  ...
  digit = static_cast<IlcPVECDigit *>(digits->At( fDigitsList[imaxDigit] )) ; 
  ...
  for (Int_t index = 0 ; index < GetDigitsMultiplicity() ; index++ ) { // all digits
    if(index==imaxDigit) //already in
      continue ; 
    digit = static_cast<IlcPVECDigit *>(digits->At( fDigitsList[index] )) ; 
...
//____________________________________________________________________________
void IlcPVECEmcRecPoint::EvalAll(TClonesArray * digits )
{
//   EvalCoreEnergy(logWeight, digits);
  EvalTime(digits) ;
  EvalPrimaries(digits) ;
  IlcPVECRecPoint::EvalAll(digits) ;
}
//____________________________________________________________________________
void IlcPVECEmcRecPoint::EvalAll(Float_t logWeight, TVector3 &vtx, TClonesArray * digits )
{
...
//____________________________________________________________________________
void IlcPVECEmcRecPoint::EvalLocalPosition(Float_t logWeight, TVector3 &vtx, TClonesArray * digits, TVector3 &vInc)
{
  // Calculates the center of gravity in the local PVEC-module coordinates 
  Float_t wtot = 0. ;
  ...
  PVECgeom->GetIncidentVector(vtx,GetPVECMod(),x,z,vInc) ;
...
//____________________________________________________________________________
Float_t IlcPVECEmcRecPoint::GetMaximalEnergy(void) const
{
...
//____________________________________________________________________________
Int_t IlcPVECEmcRecPoint::GetMultiplicityAtLevel(Float_t H) const
{
...
//____________________________________________________________________________
Int_t  IlcPVECEmcRecPoint::GetNumberOfLocalMax( IlcPVECDigit **  maxAt, Float_t * maxAtEnergy,
...
{ 
  ...
  for(iDigit = 0; iDigit < fMulDigit; iDigit++)
    maxAt[iDigit] = (IlcPVECDigit*) digits->At(fDigitsList[iDigit])  ;
  ...
  for(iDigit = 0 ; iDigit < fMulDigit; iDigit++) {   
	...
	digitN = (IlcPVECDigit *) digits->At(fDigitsList[iDigitN]) ; 
...
//____________________________________________________________________________
void IlcPVECEmcRecPoint::EvalTime(TClonesArray * /*digits*/)
{
...
/*
  ...
  fTime = ((IlcPVECDigit*) digits->At(fDigitsList[maxAt]))->GetTime() ;
*/  
}
//____________________________________________________________________________
void IlcPVECEmcRecPoint::Purify(Float_t threshold){
...
//____________________________________________________________________________
void IlcPVECEmcRecPoint::Print(Option_t *) const
{
  // Print the list of digits belonging to the cluster
  
  TString message ; 
  message  = "IlcPVECEmcRecPoint:\n" ;
