#ifndef ILCPVECCILCBDATA_H
#define ILCPVECCILCBDATA_H

/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECCalibData.h 50875 2011-08-01 09:01:23Z policheh $ */
...
class IlcPVECCpvCalibData;
class IlcPVECEmcBadChannelsMap;
class IlcCDBMetaData;

class IlcPVECCalibData: public TNamed {

 public:
  IlcPVECCalibData();
  IlcPVECCalibData(Int_t runNumber);
  IlcPVECCalibData(IlcPVECCalibData & PVECCDB);
  virtual ~IlcPVECCalibData();

  IlcPVECCalibData & operator = (const IlcPVECCalibData & rhs);

  void Reset();
  virtual void Print(Option_t *option = "") const; 

  IlcPVECEmcCalibData *GetCalibDataEmc() const {return fCalibDataEmc;}
  IlcPVECCpvCalibData *GetCalibDataCpv() const {return fCalibDataCpv;}
 ...
 private:
  ...
  IlcPVECEmcCalibData* fCalibDataEmc; // EMC calibration data
  IlcPVECCpvCalibData* fCalibDataCpv; // CPV calibration data
  IlcPVECEmcBadChannelsMap* fEmcBadChannelsMap; // EMC bad channels map
  ...
  ClassDef(IlcPVECCalibData,6)    // PVEC Calibration data
};
