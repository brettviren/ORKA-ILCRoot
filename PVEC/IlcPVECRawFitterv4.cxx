...
// If sample is not in saturation, a coarse algorithm is used (a-la IlcPVECRawFitterv0)
// If sample is in saturation, the unsaturated part of the sample is fit a-la IlcPVECRawFitterv1
// 
//     IlcPVECRawFitterv4 *fitterv4=new IlcPVECRawFitterv4();
...
ClassImp(IlcPVECRawFitterv4)

//-----------------------------------------------------------------------------
IlcPVECRawFitterv4::IlcPVECRawFitterv4():
  IlcPVECRawFitterv1(),
  fFitHighGain(0) 
{
  //Default constructor
...
Bool_t IlcPVECRawFitterv4::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
...
//===================================================
Bool_t IlcPVECRawFitterv4::EvalWithFitting(TArrayI*samples, TArrayI * times){
