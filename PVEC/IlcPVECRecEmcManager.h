#ifndef IlcPVECRecEmcManager_H
#define IlcPVECRecEmcManager_H
...
#include "IlcPVECRecManager.h"

class IlcPVECRecEmcManager : public IlcPVECRecManager {

 public: 

  IlcPVECRecEmcManager();
  ~IlcPVECRecEmcManager(void);
 ...
 private:
  ...
  ClassDef(IlcPVECRecEmcManager,1)        // Emc reconstruction management class 

} ;

#endif // IlcPVECRecEmcManager_H
