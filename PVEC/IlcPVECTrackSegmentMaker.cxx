 ...
 **************************************************************************/
/* $Id: IlcPVECTrackSegmentMaker.cxx 25703 2008-05-10 19:18:21Z kharlov $ */
...
ClassImp( IlcPVECTrackSegmentMaker) 


//____________________________________________________________________________
IlcPVECTrackSegmentMaker:: IlcPVECTrackSegmentMaker() : 
  TObject(),
  fESD(0), 
  fGeom(0),
  fEMCRecPoints(0),
...
//____________________________________________________________________________
IlcPVECTrackSegmentMaker::IlcPVECTrackSegmentMaker(IlcPVECGeometry *geom):
  TObject(),
  fESD(0), 
  fGeom(geom),
  fEMCRecPoints(0),
...
//____________________________________________________________________________
IlcPVECTrackSegmentMaker::IlcPVECTrackSegmentMaker(const IlcPVECTrackSegmentMaker & tsmaker) :
  TObject(tsmaker),
  fESD(tsmaker.GetESD()), 
  fGeom(tsmaker.fGeom),
...
//____________________________________________________________________________
void IlcPVECTrackSegmentMaker::SetInput(TTree *clustersTree)
{
