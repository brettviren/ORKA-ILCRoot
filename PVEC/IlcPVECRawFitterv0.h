#ifndef ILCPVECRAWFITTERV0_H
#define ILCPVECRAWFITTERV0_H
...
class IlcPVECRawFitterv0 : public TObject 
{

public:

  IlcPVECRawFitterv0();
  IlcPVECRawFitterv0(const IlcPVECRawFitterv0& rawFitterv0);
  IlcPVECRawFitterv0& operator = (const IlcPVECRawFitterv0& rawFitterv0);
  virtual ~IlcPVECRawFitterv0();
  ...
  void SetCalibData(IlcPVECCalibData * cdata){ fCalibData=cdata ;}

protected:   
  
  Int_t    fModule;         // PVEC module number
  ...
  IlcPVECCalibData * fCalibData ;   //! Calibration database if avalable

  ClassDef(IlcPVECRawFitterv0,2)
};
