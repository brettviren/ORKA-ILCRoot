...
/* $Id: IlcPVECRecCpvManager.cxx 36793 2009-11-16 05:02:28Z fca $ */
...
ClassImp(IlcPVECRecCpvManager) 

//____________________________________________________________________________
IlcPVECRecCpvManager::IlcPVECRecCpvManager() :
  fOneGamChisqCut(3.),
...
IlcPVECRecCpvManager::~IlcPVECRecCpvManager(void) 
{
  // Put a comment here
}

Float_t IlcPVECRecCpvManager::Dispersion(Float_t etot, Float_t ai) const
{
...
Float_t IlcPVECRecCpvManager::OneGamChi2(Float_t ai, Float_t ei, Float_t etot, Float_t& Gi) const
{
  //"Chi2" for one cell.
  // etot is the total "shower" energy, ai is the
  // calculated cell response,
...
Float_t IlcPVECRecCpvManager::TwoGamChi2(Float_t ai, Float_t ei, Float_t etot, Float_t& gi) const 
{
  // Put a comment here
...
void IlcPVECRecCpvManager::AG(Float_t ei, Float_t xi, Float_t yi, Float_t& ai, Float_t& gxi, Float_t& gyi )
{
...
Float_t IlcPVECRecCpvManager::Fcml(Float_t x, Float_t y)
{
  //Cumulative function
...
Float_t IlcPVECRecCpvManager::GradX(Float_t x, Float_t y)
{
  // Put a comment here
...
Float_t IlcPVECRecCpvManager::GradY(Float_t x, Float_t y)
{
  // Put a comment here
