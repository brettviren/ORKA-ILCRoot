...
ClassImp(IlcPVECSimParam)

IlcPVECSimParam  * IlcPVECSimParam::fgSimParam = 0 ;
//-----------------------------------------------------------------------------
IlcPVECSimParam::IlcPVECSimParam() :
  TNamed(),
...
//-----------------------------------------------------------------------------
IlcPVECSimParam::IlcPVECSimParam(Int_t) :
  TNamed(),
  fLightYieldMean(0.),fIntrinsicAPDEfficiency(0.),
  fLightFactor(0.),fAPDFactor(0.),         
  fAPDNoise(0.),fEMCDigitThreshold(0.),
  ...
  fDigitizeE(0),fCellNonLineaityOn(1)
{
  ...
  //Parameters describing energy deposition and light collection by APD, used in IlcPVECv1
...
//-----------------------------------------------------------------------------
IlcPVECSimParam::IlcPVECSimParam(const IlcPVECSimParam& ):
  TNamed(),
  fLightYieldMean(0.),fIntrinsicAPDEfficiency(0.),
  fLightFactor(0.),fAPDFactor(0.),         
  fAPDNoise(0.),fEMCDigitThreshold(0.),
...
//-----------------------------------------------------------------------------                                                            
IlcPVECSimParam * IlcPVECSimParam::GetInstance(){

  if(!fgSimParam)
    new IlcPVECSimParam(0) ;
  return fgSimParam ;
}
//-----------------------------------------------------------------------------
IlcPVECSimParam& IlcPVECSimParam::operator = (const IlcPVECSimParam& simParam)
{
  //Assignment operator.
