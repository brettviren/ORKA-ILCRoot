#ifndef ILCPVECGRIDFILE_H
#define ILCPVECGRIDFILE_H
...
class IlcPVECGridFile : public TObject {

 public:
  
  IlcPVECGridFile(TString grid="alien") ; 
  IlcPVECGridFile(const IlcPVECGridFile & lfn);
  
  virtual ~IlcPVECGridFile(void) ; 
  ...
  IlcPVECGridFile & operator = (const IlcPVECGridFile & /*rvalue*/)  {
...
private:
  ...
  ClassDef(IlcPVECGridFile,1)  
};

#endif // IlcPVECGRIDFILE_H
