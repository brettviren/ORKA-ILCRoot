#ifndef ILCPVECTrigger_H
#define ILCPVECTrigger_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECTrigger.h 32767 2009-06-05 15:59:59Z kharlov $ */
...
class IlcPVECTrigger : public IlcTriggerDetector {
  
 public: 
  
  IlcPVECTrigger() ; //  ctor
  IlcPVECTrigger(const IlcPVECTrigger & trig) ; // cpy ctor
  virtual ~IlcPVECTrigger();

  virtual void    CreateInputs(); //Define trigger inputs for Central Trigger Processor
  void            Print(const Option_t * opt ="") const ;  
  virtual void    Trigger() {}                   //Make PVEC trigger
  void            Trigger(TClonesArray *digits); //Make PVEC trigger
 ...
 private:
  ...
  IlcPVECTrigger & operator = (const IlcPVECTrigger & trig) ;//cpy assignment

  void FillTRU(const TClonesArray * digits, const IlcPVECGeometry * geom) const ;
 ...
 private: 
  ...
  ClassDef(IlcPVECTrigger,5)
} ;


#endif //ILCPVECTrigger_H
