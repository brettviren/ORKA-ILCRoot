#ifndef ILCPVECEMCRECPOINT_H
#define ILCPVECEMCRECPOINT_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECEmcRecPoint.h 54863 2012-02-28 12:10:29Z hristov $ */
...
class IlcPVECEmcRecPoint : public IlcPVECRecPoint  {

public:

  IlcPVECEmcRecPoint() ;
  IlcPVECEmcRecPoint(const char * opt) ;
  IlcPVECEmcRecPoint(const IlcPVECEmcRecPoint & rp) ; 
 
  virtual ~IlcPVECEmcRecPoint() ;  

  virtual void Clear(const Option_t* /*option*/ ="") { delete[] fEnergyList; fEnergyList=0; IlcPVECRecPoint::Clear(); }

  //This virtual function has signature different from IlcPVECRecPoint::AddDigit
  //it hides, not overrides. using - declaration should fix the problem, at least for
  //g++
//  using IlcPVECRecPoint::AddDigit;
  virtual void  AddDigit(IlcPVECDigit & digit, Float_t Energy, Float_t time=0.) ;          // add a digit to the digits list  
  ...
  virtual Int_t GetNumberOfLocalMax(IlcPVECDigit **  maxAt, Float_t * maxAtEnergy,
...
private:
  IlcPVECEmcRecPoint & operator = (const IlcPVECEmcRecPoint & /*rvalue*/) {return *this;}

protected:
  virtual void  EvalLocalPosition(Float_t logWeight, TVector3 &vtx, TClonesArray * digits, TVector3 &vInc) ;// computes the position in the PVEC module 
  ...
  virtual Bool_t AreNeighbours(IlcPVECDigit * digit1, IlcPVECDigit * digit2 ) const ;
  ...
  ClassDef(IlcPVECEmcRecPoint,3)  // EMC RecPoint (cluster)

};

#endif // IlcPVECEMCRECPOINT_H
