 ...
 **************************************************************************/
/* $Id: IlcPVECTrigger.cxx 47329 2011-02-11 19:44:15Z kharlov $ */
...
//  IlcPVECTrigger *tr = new IlcPVECTrigger();//Init Trigger
...
ClassImp(IlcPVECTrigger)

//______________________________________________________________________
IlcPVECTrigger::IlcPVECTrigger()
  : IlcTriggerDetector(),
...
IlcPVECTrigger::IlcPVECTrigger(const IlcPVECTrigger & trig) : 
...
//_________________________________________________________________________
IlcPVECTrigger & IlcPVECTrigger::operator = (const IlcPVECTrigger &)
{
  Fatal("operator =", "no implemented");
  return *this;
}

void IlcPVECTrigger::CreateInputs()
{
   // inputs 
   ...
   fInputs.AddLast( new IlcTriggerInput( "PVEC_JetHPt_L1",name, 1 ) );
   fInputs.AddLast( new IlcTriggerInput( "PVEC_JetMPt_L1",name, 1 ) );
   fInputs.AddLast( new IlcTriggerInput( "PVEC_JetLPt_L1",name, 1 ) );
 
}

//____________________________________________________________________________
void IlcPVECTrigger::FillTRU(const TClonesArray * /*digits*/, const IlcPVECGeometry * /*geom*/) const {
...
//     
//     dig    = static_cast<IlcPVECDigit *>(digits->At(idig)) ;
...
//______________________________________________________________________
void IlcPVECTrigger::GetCrystalPhiEtaIndexInModuleFromTRUIndex(Int_t itru, Int_t iphitru, Int_t ietatru,Int_t &iphiMod,Int_t &ietaMod) const 
{
...
//____________________________________________________________________________
Bool_t IlcPVECTrigger::IsPatchIsolated(Int_t iPatchType, const Int_t imod, const Int_t mtru, const Float_t maxamp, const Int_t maxphi, const Int_t maxeta) {
...
//____________________________________________________________________________
void IlcPVECTrigger::MakeSlidingCell(const Int_t imod, TMatrixD &ampmax2, TMatrixD &ampmaxn)
{
...
//____________________________________________________________________________
void IlcPVECTrigger::Print(const Option_t * opt) const 
{
  ...
  if(in->GetValue())
    printf( "             *** PVEC LO is set ***\n") ; 
  
  printf( "             Jet Low Pt Threshold for L1 %10.2f\n", fL1JetLowPtThreshold) ;
  in = (IlcTriggerInput*)fInputs.FindObject( "PVEC_JetLPt_L1" );
  if(in->GetValue())
    printf( "             *** PVEC Jet Low Pt for L1 is set ***\n") ;
  
  printf( "             Jet Medium Pt Threshold for L1 %10.2f\n", fL1JetMediumPtThreshold) ;
  in = (IlcTriggerInput*)fInputs.FindObject( "PVEC_JetMPt_L1" );
  if(in->GetValue())
    printf( "             *** PVEC Jet Medium Pt for L1 is set ***\n") ;
  
  printf( "             Jet High Pt Threshold for L1 %10.2f\n", fL1JetHighPtThreshold) ;  
  in = (IlcTriggerInput*) fInputs.FindObject( "PVEC_JetHPt_L1" );
  if(in->GetValue())
    printf( "              *** PVEC Jet High Pt for L1 is set ***\n") ;
  
}

//____________________________________________________________________________
void IlcPVECTrigger::SetTriggers(const Int_t iMod, const TMatrixD & ampmax2, const TMatrixD & ampmaxn)  
{
...
//____________________________________________________________________________
void IlcPVECTrigger::Trigger(TClonesArray *digits) 
{
