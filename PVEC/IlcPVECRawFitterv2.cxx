...
ClassImp(IlcPVECRawFitterv2)

//-----------------------------------------------------------------------------
IlcPVECRawFitterv2::IlcPVECRawFitterv2():
  IlcPVECRawFitterv0(),
...
//-----------------------------------------------------------------------------
IlcPVECRawFitterv2::IlcPVECRawFitterv2(const IlcPVECRawFitterv2 &PVECFitter ):
...
//-----------------------------------------------------------------------------
IlcPVECRawFitterv2& IlcPVECRawFitterv2::operator = (const IlcPVECRawFitterv2 & /*PVECFitter*/)
{
  //Assignment operator.
  return *this;
}
...
//-----------------------------------------------------------------------------
Bool_t IlcPVECRawFitterv2::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
  ...
  if(!FindAmpT(samples,times)){
    if(IlcLog::GetDebugLevel("PVEC","IlcPVECRawFitterv2")>3){
      goto plot ;
    }
    else{
      return kFALSE ;
...
//------------------------------------------------------------------
Bool_t IlcPVECRawFitterv2::FindAmpT(TArrayD samples, TArrayD times){
// makes fit
...
void IlcPVECRawFitterv2::FindMax(){
