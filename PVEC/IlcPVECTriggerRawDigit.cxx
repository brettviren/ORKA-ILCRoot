...
ClassImp(IlcPVECTriggerRawDigit)

IlcPVECTriggerRawDigit::IlcPVECTriggerRawDigit() : 
IlcDigitNew(),fMod(-1),fXIdx(-1),fZIdx(-1),fTRURow(-1),fBranch(-1)
{
  //Default constructor.
}

IlcPVECTriggerRawDigit::IlcPVECTriggerRawDigit(Int_t module, Int_t xIdx, Int_t zIdx, Int_t TRURow, Int_t branch, Int_t amp) :
  IlcDigitNew(),fMod(module),fXIdx(xIdx),fZIdx(zIdx),fTRURow(TRURow),fBranch(branch)
{
  fAmp = amp;
}

IlcPVECTriggerRawDigit::IlcPVECTriggerRawDigit(const IlcPVECTriggerRawDigit & tdigit) :
...
IlcPVECTriggerRawDigit& IlcPVECTriggerRawDigit::operator=(const IlcPVECTriggerRawDigit & tdigit)
{
  if (&tdigit != this) {
...
void IlcPVECTriggerRawDigit::GetModXZ(Int_t& mod, Int_t& modX, Int_t& modZ)
{
