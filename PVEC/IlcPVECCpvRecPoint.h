#ifndef ILCPVECCPVRECPOINT_H
#define ILCPVECCPVRECPOINT_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVECCpvRecPoint.h 25982 2008-05-20 20:27:07Z kharlov $ */
...
class IlcPVECCpvRecPoint : public IlcPVECEmcRecPoint  {

public:

  IlcPVECCpvRecPoint() ;
  IlcPVECCpvRecPoint(const char * opt) ;

  virtual ~IlcPVECCpvRecPoint() ;  
 ...
 protected:
  ...
  Bool_t AreNeighbours(IlcPVECDigit * digit1, IlcPVECDigit * digit2 ) const ;

  Int_t    fLengX ;          // cluster length along x
  Int_t    fLengZ ;          // cluster length along z
  
  ClassDef(IlcPVECCpvRecPoint,1)  // CPV RecPoint (cluster)

};

#endif // IlcPVECCPVRECPOINT_H
