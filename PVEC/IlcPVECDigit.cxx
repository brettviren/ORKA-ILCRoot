...
/* $Id: IlcPVECDigit.cxx 53186 2011-11-25 14:28:01Z kharlov $ */
...
ClassImp(IlcPVECDigit)

//____________________________________________________________________________
IlcPVECDigit::IlcPVECDigit() :
  IlcDigitNew(),
  fNprimary(0),  
  fPrimary(0x0),
  fEnergy(0.),
...
//____________________________________________________________________________
IlcPVECDigit::IlcPVECDigit(Int_t primary, Int_t id, Int_t digEnergy, Float_t time, Int_t index) :
  fNprimary(0),
  fPrimary(0),
  fEnergy(0.f),
  fTime(0.f),
...
{  
  ...
  else{  //If the contribution of this primary smaller than fDigitThreshold (IlcPVECv1)
    fNprimary = 0 ; 
    fPrimary  = 0 ;
  }
}
...
//____________________________________________________________________________
IlcPVECDigit::IlcPVECDigit(Int_t primary, Int_t id, Float_t energy, Float_t time, Int_t index) :
  fNprimary(0),
  fPrimary(0),
  fEnergy(0.f),
  fTime(0.f),
...
//____________________________________________________________________________
IlcPVECDigit::IlcPVECDigit(const IlcPVECDigit & digit) : 
  IlcDigitNew(digit),
...
//____________________________________________________________________________
IlcPVECDigit & IlcPVECDigit::operator = (const IlcPVECDigit &)
{
...
//____________________________________________________________________________
Int_t IlcPVECDigit::Compare(const TObject * obj) const
{
  ...
  IlcPVECDigit * digit = (IlcPVECDigit *)obj ; 
...
//____________________________________________________________________________
Int_t IlcPVECDigit::GetPrimary(Int_t index) const
{
...
//____________________________________________________________________________
void IlcPVECDigit::SetALTROSamplesHG(Int_t nSamplesHG, Int_t *samplesHG)
{
...
//____________________________________________________________________________
void IlcPVECDigit::SetALTROSamplesLG(Int_t nSamplesLG, Int_t *samplesLG)
{
...
//____________________________________________________________________________
void IlcPVECDigit::Print(const Option_t *) const
{
  // Print the digit together with list of primaries
  TString line = Form("PVEC digit: E=%.3f, Id=%d, Time=%.3e, TimeR=%.3e, NPrim=%d, nHG=%d, nLG=%d \n", fEnergy,fId,fTime,fTimeR,fNprimary,fNSamplesHG,fNSamplesLG);
...
//____________________________________________________________________________
void IlcPVECDigit::ShiftPrimary(Int_t shift)
{
...
//____________________________________________________________________________
Bool_t IlcPVECDigit::operator==(IlcPVECDigit const & digit) const 
{
...
//____________________________________________________________________________
IlcPVECDigit& IlcPVECDigit::operator+=(IlcPVECDigit const & digit) 
{
...
//____________________________________________________________________________
IlcPVECDigit& IlcPVECDigit::operator *= (Float_t factor) 
{
...
//____________________________________________________________________________
ostream& operator << ( ostream& out , const IlcPVECDigit & digit)
{
