#ifndef ILCPVECQADataMakerRec_H
#define ILCPVECQADataMakerRec_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */


/* $Id: IlcPVECQADataMakerRec.h 57196 2012-06-15 08:08:57Z hristov $ */
...
class IlcPVECQADataMakerRec: public IlcQADataMakerRec {
...
public:
  IlcPVECQADataMakerRec() ;          // ctor
  IlcPVECQADataMakerRec(const IlcPVECQADataMakerRec& qadm) ;   
  IlcPVECQADataMakerRec& operator = (const IlcPVECQADataMakerRec& qadm) ;
  virtual ~IlcPVECQADataMakerRec() {;} // dtor
  
private:
  const IlcPVECRecoParam* GetRecoParam() { return dynamic_cast<const IlcPVECRecoParam *>(fRecoParam); }
  ...
  ClassDef(IlcPVECQADataMakerRec,1)  // description 

};

#endif // IlcPVECQADataMakerRec_H
