...
ClassImp(IlcPVECModuleMisalignment)
...
//______________________________________________________________________________
IlcPVECModuleMisalignment::
IlcPVECModuleMisalignment(const IlcPVECGeometry & geom, Bool_t debug)
                            : fDebug(debug),
                              fAngles(),
                              fCenters(),
                              fModule(),
...
{
  //Ctor.
  //Extract ideal module transformations from IlcPVECGeometry.
  ...
  fModule[0][2] = -22.61;//This number is hardcoded, IlcPVECGeometry does not have it,
...
//______________________________________________________________________________
IlcPVECModuleMisalignment::~IlcPVECModuleMisalignment()
{
}

//______________________________________________________________________________
void IlcPVECModuleMisalignment::
                    ...
                    const TString & name2, TGeoHMatrix * delta)
{
  ...
  if (!pt0 || !pt1 || !pt2) {
    Warning("IlcPVECModuleData::DeltaTransformation",
...
//______________________________________________________________________________
void IlcPVECModuleMisalignment::FindIdealModule(UInt_t module)
{
...
//______________________________________________________________________________
void IlcPVECModuleMisalignment::FindRealModule(const IlcSurveyPoint * pt0, 
                                               const IlcSurveyPoint * pt1,
                                               const IlcSurveyPoint * pt2)
{
  //Real module - fV.
  //Survey is in millimeters.
  //IlcPVECGeometry is in centimeters.
...
//______________________________________________________________________________
void IlcPVECModuleMisalignment::FindDelta(TGeoHMatrix * delta)const
{
  ...
  */
  ...
  try {
    ...
    Error("IlcPVECModuleMisalignment::FindDelta", 
