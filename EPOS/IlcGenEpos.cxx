...
IlcGenEpos::IlcGenEpos() : IlcGenMC(),
		fBmin(0),
		fBmax(10000),
		fPhiMin(0),
		fPhiMax(TMath::TwoPi()),
...
IlcGenEpos::IlcGenEpos(Int_t npart) : IlcGenMC(npart),
		fBmin(0),
		fBmax(10000),
		fPhiMin(0),
		fPhiMax(TMath::TwoPi()),
...
void IlcGenEpos::Generate() {
  // Does actual generation and output conversion
	...
	// Builds the event header, to be called after each event
	  IlcGenEposEventHeader* header = new IlcGenEposEventHeader("EPOS");
    ...
    AddHeader(header);
    fCollisionGeometry = (IlcGenEposEventHeader*)  header;
    
    delete[] idsOnStack;
}

IlcGenEpos::~IlcGenEpos() {
}
