...
#include "IlcGenEposIsajetToPdgConverter.h"

ClassImp(IlcGenEposIsajetToPdgConverter)

IlcGenEposIsajetToPdgConverter::IlcGenEposIsajetToPdgConverter() {

}

IlcGenEposIsajetToPdgConverter::~IlcGenEposIsajetToPdgConverter() { }

Int_t IlcGenEposIsajetToPdgConverter::ConvertIsajetToPdg(Int_t isajet) const{
...
void IlcGenEposIsajetToPdgConverter::AddQuarkCluster(Int_t clusterCode) const {
...
Int_t IlcGenEposIsajetToPdgConverter::AddUnknownObject(Int_t code) const {
  // Add EPOS internal object to the PDG db
...
Int_t IlcGenEposIsajetToPdgConverter::ExtendedMapping(Int_t isajet) const {
...
Bool_t IlcGenEposIsajetToPdgConverter::fgParticlesAdded = kFALSE;

void IlcGenEposIsajetToPdgConverter::AddHigherResonances() {
