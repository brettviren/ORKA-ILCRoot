...
#include "IlcIonPDGCodes.h" 

ClassImp(IlcIonPDGCodes)
 
//______________________________________________________________________________
    IlcIonPDGCodes::IlcIonPDGCodes():
	TObject(),
	fNIon(200)
{ 
...
IlcIonPDGCodes::IlcIonPDGCodes(const IlcIonPDGCodes &/*PDGCodes*/)
    :TObject(),
     fNIon(200)
{
  for(Int_t i=0; i<fNIon; i++) fPDGCode[i]=0;
...
IlcIonPDGCodes&  IlcIonPDGCodes::operator=(const IlcIonPDGCodes &pdg)
{
  for(Int_t i=0; i<fNIon; i++) fPDGCode[i]=0;
  if (this != &pdg) {
...
//______________________________________________________________________________
void IlcIonPDGCodes::AddParticlesToPdgDataBase()
{
  ...
  printf("\n\n	IlcIonPDGCodes -> definition of PDG codes for ions\n\n");

}

//_____________________________________________________________________________
Int_t IlcIonPDGCodes::IdFromPDG(Int_t pdg) const 
{
  //
...
//_____________________________________________________________________________
Int_t IlcIonPDGCodes::PDGFromId(Int_t id) const 
{
  //
