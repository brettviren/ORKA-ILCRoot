...
ClassImp(IlcGenDPMjet)

//______________________________________________________________________________
IlcGenDPMjet::IlcGenDPMjet()
    :IlcGenMC(), 
     fBeamEn(2750.),
     fMinImpactParam(0.),
     fMaxImpactParam(5.),
...
// Constructor
    fEnergyCMS = 5500.;
    IlcDpmJetRndm::SetDpmJetRandom(GetRandom());
}


//______________________________________________________________________________
IlcGenDPMjet::IlcGenDPMjet(Int_t npart)
    :IlcGenMC(npart),
     fBeamEn(2750.),
     fMinImpactParam(0.),
     fMaxImpactParam(5.),
...
IlcGenDPMjet::IlcGenDPMjet(const IlcGenDPMjet &/*Dpmjet*/)
    :IlcGenMC(),
     fBeamEn(2750.),
     fMinImpactParam(0.),
     fMaxImpactParam(5.),
...
//______________________________________________________________________________
Bool_t IlcGenDPMjet::DaughtersSelection(TParticle* iparticle)
{
//
...
//______________________________________________________________________________
Bool_t IlcGenDPMjet::SelectFlavor(Int_t pid)
{
...
//______________________________________________________________________________
Bool_t IlcGenDPMjet::Stable(TParticle*  particle)
{
...
//______________________________________________________________________________
void IlcGenDPMjet::MakeHeader()
{
//  printf("MakeHeader %13.3f \n", fDPMjet->GetBImpac());
// Builds the event header, to be called after each event
    IlcGenEventHeader* header = new IlcGenDPMjetEventHeader("DPMJET");
    ((IlcGenDPMjetEventHeader*) header)->SetNProduced(fDPMjet->GetNumStablePc());
    ((IlcGenDPMjetEventHeader*) header)->SetImpactParameter(fDPMjet->GetBImpac());
    ((IlcGenDPMjetEventHeader*) header)->SetTotalEnergy(fDPMjet->GetTotEnergy());
    ((IlcGenDPMjetEventHeader*) header)->SetParticipants(fDPMjet->GetProjParticipants(), 
    							 fDPMjet->GetTargParticipants());

    if(fProcDiff>0){
    ((IlcGenDPMjetEventHeader*) header)->SetProcessType(fProcDiff);
    }
    else 
      ((IlcGenDPMjetEventHeader*) header)->SetProcessType(fDPMjet->GetProcessCode());

    // Bookkeeping for kinematic bias
    ((IlcGenDPMjetEventHeader*) header)->SetTrials(fTrials);
    // Event Vertex
...
void IlcGenDPMjet::AddHeader(IlcGenEventHeader* header)
{
...
//______________________________________________________________________________
IlcGenDPMjet& IlcGenDPMjet::operator=(const  IlcGenDPMjet& /*rhs*/)
{
// Assignment operator
    return *this;
}
...
Bool_t IlcGenDPMjet::CheckDiffraction()
{
  ...
  const Int_t pdgStable[20] = {
	...
	if (y > y2)
	{
	 ...
	 if(y1 > y2) 
	   ...
	   iPart = iPart1;
	   if((IlcDpmJetRndm::GetDpmJetRandom())->Uniform(0.,1.)>0.5) iPart = iPart2;
	 }
       }
     else if (pdg1 == 2212)
       iPart = iPart1;
 ...
 if(proc==1 && (IlcDpmJetRndm::GetDpmJetRandom())->Uniform(0.,1.) > wDD) return kFALSE;
 if(proc==2 && (IlcDpmJetRndm::GetDpmJetRandom())->Uniform(0.,1.) > wND) return kFALSE;
    ...
    if((IlcDpmJetRndm::GetDpmJetRandom())->Uniform(0.,1.)> wSD) return kFALSE;
...
Bool_t IlcGenDPMjet::GetWeightsDiffraction(Double_t M, Double_t &Mmin, Double_t &Mmax, 
