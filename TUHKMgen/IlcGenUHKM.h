...
// and IlcRoot (by inheriting from the IlcGenMC class).
...
class IlcGenUHKM : public IlcGenMC
{
   
 public:
  IlcGenUHKM();
  IlcGenUHKM(Int_t npart);
 ...
 private:
  ...
  IlcGenUHKM(const IlcGenUHKM&);
  IlcGenUHKM & operator = (const IlcGenUHKM &);

  ClassDef(IlcGenUHKM, 6) // IlcGenerator interface to UHKM
};
#endif
