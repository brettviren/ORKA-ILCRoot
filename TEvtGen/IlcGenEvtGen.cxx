...
#include "IlcStack.h"
#include "IlcGenEvtGen.h"
#include "IlcRun.h"
#include "IlcLog.h"
#include <TParticle.h>

ClassImp(IlcGenEvtGen)
///////////////////////////////////////////////////////////////////////////
IlcGenEvtGen::IlcGenEvtGen(): 
  fStack(0x0),    
  fDecayer(0x0),
  fForceDecay(kAll),
...
void IlcGenEvtGen::Init() 
  {
  //
  // Standard IlcGenerator Initializer - no input 
  ...
  if(fDecayer)
  {
  IlcWarning("IlcGenEvtGen already initialized!!!");
  return;
  }
  fDecayer = new IlcDecayerEvtGen();
...
void IlcGenEvtGen::Generate() 
  ...
  if(part->GetStatusCode() != 1 || part->GetNDaughters()>0) 
    {
    Info("IlcGenEvtGen","Attention: particle %d is already decayed by Pythia!",pdg); 
    continue;
    }
  ...
  for (int i = 1; i < np; i++) {
         ...
         IlcDebug(1,Form("FirstMother = %d e indicePart = %d e pdg = %d \n",jpa,i,kf));         
          
         PushTrack(trackIt[i], iparent, kf, pc, och, polar,tof, kPDecay, nt, 1., ksc); 
         if(trackIt[i]==1) IlcDebug(1,Form("Trackable particles: %d e pdg %d \n",i,kf));
         pParent[i] = nt;
         KeepTrack(nt);
         SetHighWaterMark(nt);
         }// Particle loop
  ...
  Info("Generate","IlcGenEvtGen DONE");  
  }

//////////////////////////////////////////////////////////////////////////////////////////
Int_t IlcGenEvtGen::GetFlavour(Int_t pdgCode)  
  { 
  //
...
/////////////////////////////////////////////////////////////////////////////////////////
Bool_t IlcGenEvtGen::SetUserDecayTable(Char_t *path)
  {
  //
