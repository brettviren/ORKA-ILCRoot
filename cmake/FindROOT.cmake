...
if(ROOT_CONFIG AND ROOTCINT)
  set(ROOT_FOUND TRUE)
  ILC_RootConfig(ROOT_VERSION --version)
  message(STATUS "ROOT ${ROOT_VERSION} found")
  ILC_RootConfig(ROOTLIBDIR --libdir)
  ILC_RootConfig(ROOTPLUGDIR --version)
  string(REGEX REPLACE "(^.*/)[^/]+" "${ROOTLIBDIR}/\\1" ROOTPLUGDIR ${ROOTPLUGDIR})
  ILC_RootConfig(ROOTINCDIR --incdir)
  ILC_RootConfig(ROOTCLIBS --glibs)
  ILC_RootConfig(ROOTHASALIEN --has-alien)
  ILC_RootConfig(ROOTHASXML --has-xml)
