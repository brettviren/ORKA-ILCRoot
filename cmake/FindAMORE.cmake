# IlcRoot Build System Module to find and configure AMORE
#
...
if(AMORE_CONFIG)
  ...
  set(AMOREDEFINITIONS "-DILC_AMORE")
  ...
  ILC_CleanOutput(_lddaflags "${_lddaflags}")
  set(AMOREFLAGS "-DILC_AMORE ${AMOREFLAGS}")
  if(DATE_FOUND)
