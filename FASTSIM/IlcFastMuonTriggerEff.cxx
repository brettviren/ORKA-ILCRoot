...
/* $Id: IlcFastMuonTriggerEff.cxx 53089 2011-11-22 22:19:31Z morsch $ */
...
ClassImp(IlcFastMuonTriggerEff)

IlcFastMuonTriggerEff::IlcFastMuonTriggerEff():
    IlcFastResponse("Efficiency", "Muon Trigger Efficiency"),
    fPtMin(0.),
    fPtMax(0.),
    fDpt(0.),
    fnptb(0),
...
IlcFastMuonTriggerEff::IlcFastMuonTriggerEff(const char* Name, const char* Title):
    IlcFastResponse(Name, Title),
    fPtMin(0.),
    fPtMax(0.),
    fDpt(0.),
    fnptb(0),
...
IlcFastMuonTriggerEff::IlcFastMuonTriggerEff(const IlcFastMuonTriggerEff& eff)
    :IlcFastResponse(eff),
    fPtMin(0.),
    fPtMax(0.),
    fDpt(0.),
...
void IlcFastMuonTriggerEff::SetCut(Int_t cut) 
{  
  //
  // Set the pt cut
  if(cut==kLow){
...
Int_t IlcFastMuonTriggerEff::SetBkgLevel(Float_t Bkg)
{
  //
...
Int_t IlcFastMuonTriggerEff::ForceBkgLevel(Float_t Bkg)
{
  //
...
Int_t IlcFastMuonTriggerEff::LoadTables(const Char_t *namet){
  //
...
void IlcFastMuonTriggerEff::Init()
{
//
//  Initialization
//
    fZones=0;
    Char_t file[100]="$(ILC_ROOT)/FASTSIM/data/MUONtriggerLUT_V2.4nvdn.root";
    printf("Initializing %s / %s\n", fName.Data(), fTitle.Data());
    printf("using data from file: %s\n",file);
    printf("IlcFastMuonTriggerEff: Initialization with background level: %f\n",fBkg);
...
//
    ...
    printf("***** This version of IlcFastMuonTriggerEff can use both *****\n");
    printf("***** new and old ILC reference frames depending on    *****\n");
...
void IlcFastMuonTriggerEff::Evaluate(Float_t charge, Float_t pt,Float_t theta,
              Float_t phi, Float_t& effLow, Float_t& effHigh, Float_t& effAny)
{
    ...
    effAny=0;
    if(fZones==0) {
        printf("Call to uninitialized object of class: IlcFastMuonTriggerEff\n");
	return;
    }
    if(pt<0) {
...
Float_t IlcFastMuonTriggerEff::Evaluate(Float_t charge, Float_t pt,
...
IlcFastMuonTriggerEff& IlcFastMuonTriggerEff::operator=(const  IlcFastMuonTriggerEff& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return *this;
