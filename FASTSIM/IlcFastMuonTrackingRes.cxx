...
ClassImp(IlcFastMuonTrackingRes)


IlcFastMuonTrackingRes::IlcFastMuonTrackingRes() :
    IlcFastResponse("Resolution", "Muon Tracking Resolution"),
    fBackground(0.),
    fCharge(1.),
    fFastTracking(0)
{
...
IlcFastMuonTrackingRes::IlcFastMuonTrackingRes(const IlcFastMuonTrackingRes & res)
    :IlcFastResponse(res),
    fBackground(0.),
    fCharge(1.),
    fFastTracking(0)
...
void IlcFastMuonTrackingRes::Init()
{
// Initialisation
...
void IlcFastMuonTrackingRes::Evaluate(Float_t   p,  Float_t  theta , Float_t   phi,
...
IlcFastMuonTrackingRes& IlcFastMuonTrackingRes::operator=(const  IlcFastMuonTrackingRes& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return *this;
