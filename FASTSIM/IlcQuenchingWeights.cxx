...
/* $Id: IlcQuenchingWeights.cxx 48085 2011-03-05 18:37:52Z morsch $ */
...
// (see the IlcFastGlauber class for definition of I0/I1)
//-----------------------------------------------------------------------------
...
ClassImp(IlcQuenchingWeights)

// conversion from fm to GeV^-1: 1 fm = fmGeV GeV^-1
const Double_t IlcQuenchingWeights::fgkConvFmToInvGeV = 1./0.197; 

// maximum value of R
const Double_t IlcQuenchingWeights::fgkRMax = 1.e6; 

// hist binning
const Int_t IlcQuenchingWeights::fgkBins = 1300; 
const Double_t IlcQuenchingWeights::fgkMaxBin = 1.3; 

// counter for histogram labels
Int_t IlcQuenchingWeights::fgCounter = 0; 


IlcQuenchingWeights::IlcQuenchingWeights() 
    : TObject(),
...
IlcQuenchingWeights::IlcQuenchingWeights(const IlcQuenchingWeights& a) 
    : TObject(),
      fInstanceNumber(fgCounter++),
      fMultSoft(kTRUE), 
      fECMethod(kDefault),
...
void IlcQuenchingWeights::Reset()
{
...
void IlcQuenchingWeights::SetECMethod(kECMethod type)
{
...
Int_t IlcQuenchingWeights::InitMult(const Char_t *contall,const Char_t *discall) 
{
...
Int_t IlcQuenchingWeights::CalcMult(Int_t ipart, Double_t rrrr,Double_t xxxx,
...
Int_t IlcQuenchingWeights::InitSingleHard(const Char_t *contall,const Char_t *discall) 
{
...
Int_t IlcQuenchingWeights::CalcSingleHard(Int_t ipart, Double_t rrrr,Double_t xxxx,
                                    Double_t &continuous,Double_t &discrete) const
{
...
Int_t IlcQuenchingWeights::CalcMult(Int_t ipart, 
...
Int_t IlcQuenchingWeights::CalcSingleHard(Int_t ipart, 
...
Double_t IlcQuenchingWeights::CalcR(Double_t wc, Double_t l) const 
{ 
...
Double_t IlcQuenchingWeights::CalcRk(Double_t k, Double_t I0, Double_t I1) const
{ 
  //calculate R value and 
  //check if it is less then maximum
...
Double_t IlcQuenchingWeights::GetELossRandom(Int_t ipart, Double_t length, Double_t e) const
{
...
Double_t IlcQuenchingWeights::CalcQuenchedEnergy(Int_t ipart, Double_t length, Double_t e) const
{
...
Double_t IlcQuenchingWeights::GetELossRandom(Int_t ipart, TH1F *hell, Double_t e) const
{
  // return DeltaE for MS or SH scattering
...
Double_t IlcQuenchingWeights::CalcQuenchedEnergy(Int_t ipart, TH1F *hell, Double_t e)  const
{
  //return quenched parton energy
  //for given parton type, length distribution and energy
...
Double_t IlcQuenchingWeights::GetELossRandomK(Int_t ipart, Double_t I0, Double_t I1, Double_t e)
{
...
Double_t IlcQuenchingWeights::CalcQuenchedEnergyK(Int_t ipart, Double_t I0, Double_t I1, Double_t e)
{
  //return quenched parton energy
  //for given parton type, I0 and I1 value and energy
...
Double_t IlcQuenchingWeights::GetELossRandomKFast(Int_t ipart, Double_t I0, Double_t I1, Double_t e)
{
  // return DeltaE for new dynamic version
  // for given parton type, I0 and I1 value and energy
  // Dependant on ECM (energy constraint method)
...
Double_t IlcQuenchingWeights::GetELossRandomKFastR(Int_t ipart, Double_t r, Double_t wc, Double_t e)
{
  // return DeltaE for new dynamic version
...
Double_t IlcQuenchingWeights::CalcQuenchedEnergyKFast(Int_t ipart, Double_t I0, Double_t I1, Double_t e)
{
...
Double_t IlcQuenchingWeights::GetDiscreteWeight(Int_t ipart, Double_t I0, Double_t I1)
{
...
Double_t IlcQuenchingWeights::GetDiscreteWeightR(Int_t ipart, Double_t r)
{
  // return discrete weight
...
void IlcQuenchingWeights::GetZeroLossProb(Double_t &p,Double_t &prw,Double_t &prwcont,
...
void IlcQuenchingWeights::GetZeroLossProbR(Double_t &p,Double_t &prw,Double_t &prwcont,
...
Int_t IlcQuenchingWeights::SampleEnergyLoss() 
{
...
Int_t IlcQuenchingWeights::SampleEnergyLoss(Int_t ipart, Double_t r)
{
...
const TH1F* IlcQuenchingWeights::GetHisto(Int_t ipart,Double_t length) const
{
...
TH1F* IlcQuenchingWeights::ComputeQWHisto(Int_t ipart,Double_t medval,Double_t length) const 
{
...
TH1F* IlcQuenchingWeights::ComputeQWHistoX(Int_t ipart,Double_t medval,Double_t length) const 
{
  // ipart = 1 for quark, 2 for gluon
  // medval a) qtransp = transport coefficient (GeV^2/fm)
  //        b) mu      = Debye mass (GeV)
...
TH1F* IlcQuenchingWeights::ComputeQWHistoX(Int_t ipart,Double_t r) const 
{
...
TH1F* IlcQuenchingWeights::ComputeELossHisto(Int_t ipart,Double_t medval,Double_t l,Double_t e) const
{
  // compute energy loss histogram for 
  // parton type, medium value, length and energy

  IlcQuenchingWeights *dummy=new IlcQuenchingWeights(*this);
  if(fMultSoft){
...
TH1F* IlcQuenchingWeights::ComputeELossHisto(Int_t ipart,Double_t medval,TH1F *hEll,Double_t e) const
{
  // compute energy loss histogram for 
...
TH1F* IlcQuenchingWeights::ComputeELossHisto(Int_t ipart,Double_t r) const 
{
  // compute energy loss histogram for 
...
Double_t IlcQuenchingWeights::GetMeanELoss(Int_t ipart,Double_t medval,Double_t l) const
{
...
Double_t IlcQuenchingWeights::GetMeanELoss(Int_t ipart,Double_t medval,TH1F *hEll) const
{
  // compute average energy loss for 
  // parton type, medium value, 
  // length distribution and energy
...
Double_t  IlcQuenchingWeights::GetMeanELoss(Int_t ipart,Double_t r) const 
{
...
void IlcQuenchingWeights::PlotDiscreteWeights(Double_t len,Double_t qm) const
{
...
void IlcQuenchingWeights::PlotContWeights(Int_t itype,Double_t ell) const
{
...
void IlcQuenchingWeights::PlotContWeightsVsL(Int_t itype,Double_t medval) const
{
  // plot continous weights for 
...
void IlcQuenchingWeights::PlotAvgELoss(Double_t len,Double_t qm,Double_t e) const
{
...
void IlcQuenchingWeights::PlotAvgELoss(TH1F *hEll,Double_t e) const
{
...
void IlcQuenchingWeights::PlotAvgELossVsL(Double_t e)  const
{
...
void IlcQuenchingWeights::PlotAvgELossVsPt(Double_t medval,Double_t len) const
{
...
void IlcQuenchingWeights::PlotAvgELossVsPt(Double_t medval,TH1F *hEll) const
{
  // plot relative energy loss for given
...
Int_t IlcQuenchingWeights::GetIndex(Double_t len) const
{
