#ifndef ILCFASTGLAUBER_H
#define ILCFASTGLAUBER_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcFastGlauber.h 52602 2011-11-07 10:13:42Z morsch $ */
...
class IlcFastGlauber : public TObject {
 public:
    static IlcFastGlauber* Instance();
    virtual ~IlcFastGlauber();
    ...
    void SetFileName(const char *fn="$(ILC_ROOT)/FASTSIM/data/glauberPbPb.root"){fName=fn;}
    ...
    // Copy
    IlcFastGlauber& operator=(const IlcFastGlauber & rhs);
 ...
 private:
    ...
    ClassDef(IlcFastGlauber,2) // Event geometry simulation in the Glauber Model
};
