...
/* $Id: IlcFastGlauber.cxx 52602 2011-11-07 10:13:42Z morsch $ */
//
...
ClassImp(IlcFastGlauber)

Float_t IlcFastGlauber::fgBMax           = 0.;
TF1*    IlcFastGlauber::fgWSb            = NULL;     
TF1*    IlcFastGlauber::fgRWSb           = NULL;     
TF2*    IlcFastGlauber::fgWSbz           = NULL;    
TF1*    IlcFastGlauber::fgWSz            = NULL;     
TF1*    IlcFastGlauber::fgWSta           = NULL;    
TF2*    IlcFastGlauber::fgWStarfi        = NULL; 
TF2*    IlcFastGlauber::fgWAlmond        = NULL; 
TF1*    IlcFastGlauber::fgWStaa          = NULL;   
TF1*    IlcFastGlauber::fgWSgeo          = NULL;   
TF1*    IlcFastGlauber::fgWSbinary       = NULL;   
TF1*    IlcFastGlauber::fgWSN            = NULL;   
TF1*    IlcFastGlauber::fgWPathLength0   = NULL;   
TF1*    IlcFastGlauber::fgWPathLength    = NULL;
TF1*    IlcFastGlauber::fgWEnergyDensity = NULL;   
TF1*    IlcFastGlauber::fgWIntRadius     = NULL;   
TF2*    IlcFastGlauber::fgWKParticipants = NULL; 
TF1*    IlcFastGlauber::fgWParticipants  = NULL; 
TF2*    IlcFastGlauber::fgWAlmondCurrent = NULL;    
TF2*    IlcFastGlauber::fgWAlmondFixedB[40]; 
const Int_t IlcFastGlauber::fgkMCInts = 100000;
IlcFastGlauber* IlcFastGlauber::fgGlauber = NULL;


IlcFastGlauber::IlcFastGlauber(): 
    fWSr0(0.),
    fWSd(0.), 
    fWSw(0.), 
    fWSn(0.), 
...
IlcFastGlauber::IlcFastGlauber(const IlcFastGlauber & gl)
    :TObject(gl),
     fWSr0(0.),
     fWSd(0.), 
     fWSw(0.), 
...
IlcFastGlauber* IlcFastGlauber::Instance()
{ 
// Set random number generator 
    if (fgGlauber) {
	return fgGlauber;
    } else {
	fgGlauber = new IlcFastGlauber();
	return fgGlauber;
    }
}
...
void IlcFastGlauber::SetAuAuRhic()
{
  ...
  SetNucleus(197);
  SetFileName("$(ILC_ROOT)/FASTSIM/data/glauberAuAu.root");
}

void IlcFastGlauber::SetPbPbLHC()
{
...
void IlcFastGlauber::Init(Int_t mode)
{
  // Initialisation
...
void IlcFastGlauber::Reset() const
{
  //
...
void IlcFastGlauber::DrawWSb() const
{
  //
...
void IlcFastGlauber::DrawOverlap() const
{
  //
...
void IlcFastGlauber::DrawParticipants() const
{
  //
...
void IlcFastGlauber::DrawThickness() const
{
  //
...
void IlcFastGlauber::DrawGeo() const
{
  //
...
void IlcFastGlauber::DrawBinary() const
{
  //
...
void IlcFastGlauber::DrawN() const
{
  //
...
void IlcFastGlauber::DrawKernel(Double_t b) const
{
  //
  //  Draw Kernel
  //
...
void IlcFastGlauber::DrawAlmond(Double_t b) const
{
  //
...
void IlcFastGlauber::DrawEnergyDensity() const
{
  //
  //  Draw energy density
  //
...
void IlcFastGlauber::DrawPathLength0(Double_t b, Int_t iopt) const
{
  //
  //  Draw Path Length
  //
...
void IlcFastGlauber::DrawPathLength(Double_t b , Int_t ni, Int_t iopt) const
{
  //
  //  Draw Path Length
  //
...
void IlcFastGlauber::DrawIntRadius(Double_t b) const
{
  //
...
Double_t IlcFastGlauber::WSb(const Double_t* x, const Double_t* par)
{
  //
...
Double_t IlcFastGlauber::RWSb(const Double_t* x, const Double_t* par)
{
  //
  //  Woods-Saxon Parameterisation
  //  as a function of radius (xx)
...
Double_t IlcFastGlauber::WSbz(const Double_t* x, const Double_t* par)
{
  //
...
Double_t IlcFastGlauber::WSz(const Double_t* x, const Double_t* par)
{
  //
  //  Wood Saxon Parameterisation
...
Double_t IlcFastGlauber::WSta(const Double_t* x, const Double_t* /*par*/)
{
  //
...
Double_t IlcFastGlauber::WStarfi(const Double_t* x, const Double_t* par)
{
  //
...
Double_t IlcFastGlauber::WStaa(const Double_t* x, const Double_t* par)
{
  //
  //  Overlap function 
...
Double_t IlcFastGlauber::WKParticipants(const Double_t* x, const Double_t* par)
{
  //
...
Double_t IlcFastGlauber::WParticipants(const Double_t* x, const Double_t* par)
{
  //
...
Double_t IlcFastGlauber::WSgeo(const Double_t* x, const Double_t* par)
{
  //
  //  Geometrical Cross-Section
  //  as a function of b
...
Double_t IlcFastGlauber::WSbinary(const Double_t* x, const Double_t* par)
{
  //
...
Double_t IlcFastGlauber::WSN(const Double_t* x, const Double_t* /*par*/)
{
  //
...
Double_t IlcFastGlauber::WEnergyDensity(const Double_t* x, const Double_t* par)
{
  //
...
Double_t IlcFastGlauber::WAlmond(const Double_t* x, const Double_t* par)
{
  //
  //  Almond shaped interaction region
...
Double_t IlcFastGlauber::WIntRadius(const Double_t* x, const Double_t* par)
{
  //
...
Double_t IlcFastGlauber::WPathLength0(const Double_t* x, const Double_t* par)
{
  //
  //  Path Length as a function of phi 
...
Double_t IlcFastGlauber::WPathLength(const Double_t* x, const Double_t* par)
{
  //
  //  Path Length as a function of phi 
...
Double_t IlcFastGlauber::CrossSection(Double_t b1, Double_t b2) const
{
  //
...
Double_t IlcFastGlauber::HardCrossSection(Double_t b1, Double_t b2) const
{
  //
...
Double_t IlcFastGlauber::FractionOfHardCrossSection(Double_t b1, Double_t b2) const
{
  //
...
Double_t IlcFastGlauber::NHard(const Double_t b1, const Double_t b2) const
{
  //
  //  Number of binary hard collisions 
...
Double_t IlcFastGlauber::Binaries(Double_t b) const
{
  //
...
Double_t IlcFastGlauber::MeanOverlap(Double_t b1, Double_t b2)
{
//
...
Double_t IlcFastGlauber::MeanNumberOfCollisionsPerEvent(Double_t b1, Double_t b2)
{
//
...
Double_t IlcFastGlauber::GetNumberOfBinaries(Double_t b) const
{
  //
...
Double_t IlcFastGlauber::Participants(Double_t  b) const
{
  //
...
Double_t IlcFastGlauber::GetNumberOfParticipants(Double_t  b) const
{
  //
...
Double_t IlcFastGlauber::GetNumberOfCollisions(Double_t  b) const
{
  //
...
Double_t IlcFastGlauber::GetNumberOfCollisionsPerEvent(Double_t  b) const
{
  //
...
void IlcFastGlauber::SimulateTrigger(Int_t n)
{
  //
  //  Simulates Trigger
  //
...
void IlcFastGlauber::GetRandom(Float_t& b, Float_t& p, Float_t& mult)
{
  //
...
void IlcFastGlauber::GetRandom(Int_t& bin, Bool_t& hard)
{
  //
...
Double_t  IlcFastGlauber::GetRandomImpactParameter(Double_t bmin, Double_t bmax)
{
  //
...
void IlcFastGlauber::StoreFunctions() const
{
  //
...
void IlcFastGlauber::StoreAlmonds() const
{
  //
  // Store in file 
...
void IlcFastGlauber::SetCentralityClass(Double_t xsecFrLow,Double_t xsecFrUp)
{
  //
...
void IlcFastGlauber::GetRandomBHard(Double_t& b)
{
  //
...
void IlcFastGlauber::GetRandomXY(Double_t& x,Double_t& y)
{
  //
...
void IlcFastGlauber::GetRandomPhi(Double_t& phi) 
{
  //
...
Double_t IlcFastGlauber::CalculateLength(Double_t b,Double_t x0,Double_t y0,Double_t phi0)
{
  // 
  // Calculate path length for a parton with production point (x0,y0)
  // and propagation direction (ux=cos(phi0),uy=sin(phi0)) 
...
void IlcFastGlauber::GetLengthAndPhi(Double_t& ell,Double_t& phi,Double_t b)
{
  //
...
void IlcFastGlauber::GetLength(Double_t& ell,Double_t b)
{
  //
  // Return length from random b, x0, y0, phi0 
  //
...
void IlcFastGlauber::GetLengthsBackToBackAndPhi(Double_t& ell1,Double_t& ell2,Double_t &phi,Double_t b)
{
  //
...
void IlcFastGlauber::GetLengthsBackToBack(Double_t& ell1,Double_t& ell2,
					  Double_t b)
{
  //
  // Return 2 lengths back to back from random b, x0, y0, phi0 
...
void IlcFastGlauber::GetLengthsForPythia(Int_t n,Double_t* const phi,Double_t* ell, Double_t b)
{
  //
...
void IlcFastGlauber::PlotBDistr(Int_t n)
{  
  // 
...
void IlcFastGlauber::PlotLengthDistr(Int_t n,Bool_t save,const char *fname)
{
  //
...
void IlcFastGlauber::PlotLengthB2BDistr(Int_t n,Bool_t save,const char *fname)
{
  //
...
void IlcFastGlauber::PlotAlmonds() const
{
  //
...
void IlcFastGlauber::CalculateI0I1(Double_t& integral0,Double_t& integral1,
...
void IlcFastGlauber::GetI0I1AndPhi(Double_t& integral0,Double_t& integral1,
				   Double_t& phi,
...
void IlcFastGlauber::GetI0I1(Double_t& integral0,Double_t& integral1,
			     Double_t ellCut,Double_t b)
{
  //
  // Return I0 and I1 from random b, x0, y0, phi0 
...
void IlcFastGlauber::GetI0I1BackToBackAndPhi(Double_t& integral01,Double_t& integral11,
...
void IlcFastGlauber::GetI0I1BackToBackAndPhiAndXY(Double_t& integral01,Double_t& integral11,
					          Double_t& integral02,Double_t& integral12,
...
void IlcFastGlauber::GetI0I1BackToBack(Double_t& integral01,Double_t& integral11,
				       Double_t& integral02,Double_t& integral12,
				       Double_t ellCut,Double_t b)
{
  //
...
void IlcFastGlauber::GetI0I1ForPythia(Int_t n,Double_t* phi,
...
void IlcFastGlauber::GetI0I1ForPythiaAndXY(Int_t n,Double_t* phi,
				      Double_t* integral0,Double_t* integral1,
...
void IlcFastGlauber::PlotI0I1Distr(Int_t n,Double_t ellCut,
...
void IlcFastGlauber::PlotI0I1B2BDistr(Int_t n,Double_t ellCut,
				      Bool_t save,const char *fname)
{
  //
...
IlcFastGlauber& IlcFastGlauber::operator=(const  IlcFastGlauber& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return *this;
...
void IlcFastGlauber::Copy(TObject&) const
{
    //
    // Copy 
    //
