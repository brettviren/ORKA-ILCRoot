...
/* $Id: IlcMUONFastTracking.cxx 48085 2011-03-05 18:37:52Z morsch $ */
...
//  Used by IlcFastMuonTrackingEff, IlcFastMuonTrackingAcc, 
...
ClassImp(IlcMUONFastTracking)


IlcMUONFastTracking* IlcMUONFastTracking::fgMUONFastTracking=NULL;
...
IlcMUONFastTracking::IlcMUONFastTracking(const IlcMUONFastTracking & ft):
    TObject(),
    fNbinp(10),
    fPmin(0.),
    fPmax(200.),
...
IlcMUONFastTracking* IlcMUONFastTracking::Instance()
{ 
// Set random number generator 
    if (fgMUONFastTracking) {
	return fgMUONFastTracking;
    } else {
	fgMUONFastTracking = new IlcMUONFastTracking();
	return fgMUONFastTracking;
    }
}

IlcMUONFastTracking::IlcMUONFastTracking():
    fNbinp(10),
    fPmin(0.),
    fPmax(200.),
    fDeltaP((fPmax-fPmin)/fNbinp),
...
void IlcMUONFastTracking::Init(Float_t bkg)
{
  //
  //  Initialization
  //
  for (Int_t ip=0; ip< fNbinp; ip++){
	...
	fCurrentEntry[ip][itheta][iphi] = new IlcMUONFastTrackingEntry;
	for (Int_t ibkg=0; ibkg<4; ibkg++){
	  fEntry[ip][itheta][iphi][ibkg] = new IlcMUONFastTrackingEntry;
	}
      }
    }
  }
  ...
  char filename [100]; 
  if (fClusterFinder==kOld) snprintf (filename, 100, "$(ILC_ROOT)/FASTSIM/data/MUONtrackLUT.root"); 
  else snprintf (filename, 100, "$(ILC_ROOT)/FASTSIM/data/MUONtrackLUT-AZ.root"); 
...
void IlcMUONFastTracking::ReadLUT(TFile* file)
{
  //
...
void IlcMUONFastTracking::GetBinning(Int_t &nbinp, Float_t &pmin, Float_t &pmax,
...
void IlcMUONFastTracking::GetIpIthetaIphi(Float_t p, Float_t theta, Float_t phi, 
...
void IlcMUONFastTracking::GetSplit(Int_t ip, Int_t itheta, 
...
Float_t IlcMUONFastTracking::Efficiency(Float_t p,   Float_t theta, 
...
Float_t IlcMUONFastTracking::Acceptance(Float_t p,   Float_t theta, 
					Float_t phi, Int_t charge){
  //
...
Float_t IlcMUONFastTracking::MeanP(Float_t p,   Float_t theta, 
...
Float_t IlcMUONFastTracking::SigmaP(Float_t p,   Float_t theta, 
				    Float_t phi, Int_t charge) const
{
  //
...
Float_t IlcMUONFastTracking::Sigma1P(Float_t p,   Float_t theta, 
			    Float_t phi, Int_t charge) const
{
  //
...
Float_t IlcMUONFastTracking::NormG2(Float_t p,   Float_t theta, 
				    Float_t phi, Int_t charge) const
{
  //
...
Float_t IlcMUONFastTracking::MeanG2(Float_t p,   Float_t theta, 
				    Float_t phi, Int_t charge) const
{
  //
...
Float_t IlcMUONFastTracking::SigmaG2(Float_t p,   Float_t theta, 
				     Float_t phi, Int_t charge) const
{
  //
...
Float_t IlcMUONFastTracking::MeanTheta(Float_t p,   Float_t theta, 
				       Float_t phi, Int_t charge) const
{
  //
...
Float_t IlcMUONFastTracking::SigmaTheta(Float_t p,   Float_t theta,  
			    Float_t phi, Int_t charge) const
{
  //
...
Float_t IlcMUONFastTracking::MeanPhi(Float_t p,   Float_t theta, 
			    Float_t phi, Int_t charge) const
{
  //
...
Float_t IlcMUONFastTracking::SigmaPhi(Float_t p,   Float_t theta, 
			    Float_t phi, Int_t charge){
  //
...
void IlcMUONFastTracking::SetSpline(){
  //
...
void IlcMUONFastTracking::SetBackground(Float_t bkg){
  //
...
TF1* IlcMUONFastTracking::GetFitP(Int_t ip,Int_t itheta,Int_t iphi) { 
...
IlcMUONFastTracking& IlcMUONFastTracking::operator=(const  IlcMUONFastTracking& rhs)
{
// Assignment operator
    rhs.Copy(*this);
    return *this;
...
void IlcMUONFastTracking::Copy(TObject&) const
{
    //
    // Copy 
    //
