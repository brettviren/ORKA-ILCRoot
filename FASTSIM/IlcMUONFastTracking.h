#ifndef ILCMUONFASTTRACKING_H
#define ILCMUONFASTTRACKING_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcMUONFastTracking.h 14855 2006-08-16 08:35:22Z morsch $ */
...
class TSpline3;
class TFile;
class IlcMUONFastTrackingEntry;
...
class IlcMUONFastTracking :  public TObject {
 public:
    static  IlcMUONFastTracking* Instance();
    ~IlcMUONFastTracking(){;}
 ...
 protected:
    ...
    IlcMUONFastTrackingEntry *fEntry[20][20][20][4]; // array of LUT parameters
    IlcMUONFastTrackingEntry *fCurrentEntry[20][20][20]; // array of LUT parameters
    ...
    static IlcMUONFastTracking*    fgMUONFastTracking; //!Pointer to single instance
    ClassDef(IlcMUONFastTracking,1)      // Fast MUON Tracking Data Handler
 private:
    IlcMUONFastTracking();
    IlcMUONFastTracking(Float_t /*bkg*/);
    IlcMUONFastTracking(const IlcMUONFastTracking &ft);
    void Copy(TObject &) const;
    IlcMUONFastTracking& operator=(const IlcMUONFastTracking & rhs);
};
