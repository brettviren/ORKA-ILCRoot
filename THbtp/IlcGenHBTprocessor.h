...
/* $Id: IlcGenHBTprocessor.h 16640 2007-01-31 09:18:26Z hristov $ */

#ifndef ILCGENHBTPROCESSOR_H
#define ILCGENHBTPROCESSOR_H
...
class IlcGenHBTprocessor : public IlcGenerator 
{ 
...
/************* S E T T E R S ******************/  
    ...
    void SetThetaRange(Float_t thetamin = 0, Float_t thetamax = 180); //Azimuthal angle, override IlcGenerator method
...
//                                       // projections onto single axis.
 ...
 private:
      IlcGenHBTprocessor(const IlcGenHBTprocessor& in);
      IlcGenHBTprocessor & operator=(const IlcGenHBTprocessor& in);

    ClassDef(IlcGenHBTprocessor,1) // Interface class for AliMevsim
