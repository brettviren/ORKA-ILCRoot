...
/* $Id: THBTprocessor.cxx 58244 2012-08-21 12:57:19Z hristov $ */
...
// For more information see IlcGenHBTprocessor class                         //
...
// User should use class IlcGenHBTprocessor and all their interface          //
...
THBTprocessor::THBTprocessor()// it is better not to intialize it:TGenerator("THBTprocessor","THBTprocessor")
 ...
 {
 //constructor
  PARAMETERS.ILC            = 1; //flag that we are working in IlcRoot (0==STAR stand alone mode)
