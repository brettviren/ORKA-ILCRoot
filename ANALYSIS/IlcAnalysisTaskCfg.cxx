...
//==============================================================================
//   IlcAnalisysTaskCfg - Class embedding the configuration needed to run
...
//  - The full path to the AddTask macro (starting with $ILC_ROOT if needed)
...
//    must be names of other IlcAnalysisTaskCfg objects, separated by commas.
...
#Module.MacroName    $ILC_ROOT/PWGPP/PilotTrain/AddTaskQAsym.C
#Module.MacroArgs    0, IlcVEvent::kAnyINT, IlcVEvent::kHighMult, IlcVEvent::kEMC7, IlcVEvent::kMUU7
#Module.OutputFile   
...
using std::ofstream;
using std::ifstream;
ClassImp(IlcAnalysisTaskCfg)

//______________________________________________________________________________
IlcAnalysisTaskCfg::IlcAnalysisTaskCfg()
                   :TNamed(),
                    fMacroName(),
                    fMacroArgs(),
                    fLibs(),
...
//______________________________________________________________________________
IlcAnalysisTaskCfg::IlcAnalysisTaskCfg(const char *name)
                   :TNamed(name,""),
                    fMacroName(),
                    fMacroArgs(),
                    fLibs(),
...
//______________________________________________________________________________
IlcAnalysisTaskCfg::IlcAnalysisTaskCfg(const IlcAnalysisTaskCfg &other)
                   :TNamed(other),
...
//______________________________________________________________________________
IlcAnalysisTaskCfg& IlcAnalysisTaskCfg::operator=(const IlcAnalysisTaskCfg &other)
{
// Assignment operator.
...
//______________________________________________________________________________
TMacro *IlcAnalysisTaskCfg::OpenMacro(const char *name)
{
...
//______________________________________________________________________________
void IlcAnalysisTaskCfg::SetMacro(TMacro *macro)
{
...
//______________________________________________________________________________
Long64_t IlcAnalysisTaskCfg::ExecuteMacro(const char *newargs)
{
...
// is set once the macro was successfully executed.
   ...
   if (retval >= ptrTask) {
      TObject::SetBit(IlcAnalysisTaskCfg::kLoaded, kTRUE);
...
//______________________________________________________________________________
Int_t IlcAnalysisTaskCfg::GetNlibs() const
{
...
//______________________________________________________________________________
const char *IlcAnalysisTaskCfg::GetLibrary(Int_t i) const
{
...
//______________________________________________________________________________
Bool_t IlcAnalysisTaskCfg::CheckLoadLibraries() const
{
...
//______________________________________________________________________________
Bool_t IlcAnalysisTaskCfg::NeedsLibrary(const char *lib) const
{
...
//______________________________________________________________________________
Int_t IlcAnalysisTaskCfg::GetNdeps() const
{
// Returns number of requested libraries.
...
//______________________________________________________________________________
const char *IlcAnalysisTaskCfg::GetDependency(Int_t i) const
{
// Returns library name for the i-th library.
...
//______________________________________________________________________________
Bool_t IlcAnalysisTaskCfg::NeedsDependency(const char *dep) const
{
// Check if a given library is needed by the module.
...
//______________________________________________________________________________
TMacro *IlcAnalysisTaskCfg::OpenConfigMacro(const char *name)
{
...
//______________________________________________________________________________
void IlcAnalysisTaskCfg::SetConfigMacro(TMacro *macro)
{
...
//______________________________________________________________________________
Long64_t IlcAnalysisTaskCfg::ExecuteConfigMacro()
{
...
//______________________________________________________________________________
void IlcAnalysisTaskCfg::SetDataTypes(const char *types)
{
...
//______________________________________________________________________________
Bool_t IlcAnalysisTaskCfg::SupportsData(const char *type) const
{
...
//______________________________________________________________________________
void IlcAnalysisTaskCfg::Print(Option_t * option) const
{
...
//______________________________________________________________________________
void IlcAnalysisTaskCfg::SaveAs(const char *filename, Option_t *option) const
{
...
//______________________________________________________________________________
const char *IlcAnalysisTaskCfg::DecodeValue(TString &line)
{
...
//______________________________________________________________________________
TObjArray *IlcAnalysisTaskCfg::ExtractModulesFrom(const char *filename)
{
...
// containing: #Module.Begin
   ...
   while (in.good()) {
      ...
      // New module found, save previous if any
         ...
         decode = IlcAnalysisTaskCfg::DecodeValue(line);
         cfg = new IlcAnalysisTaskCfg(decode);
         addMacro = 0;
         addConfig = 0;
