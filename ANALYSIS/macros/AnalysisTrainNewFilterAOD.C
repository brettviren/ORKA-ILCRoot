...
TString     ilcroot_version    = "v4-21-14-AN";  // *CHANGE ME IF MORE RECENT IN GRID*                                          
// Change production base directory here (test mode)
TString     alien_datadir      = "/ilc/data/2010/LHC10h";
...
TString     mergeExclude       = "IlcAOD.root IlcAOD.VertexingHF.root IlcAOD.Jets.root deltaAODPartCorr.root IlcAOD.Muons.root IlcAOD.Dimuons.root IlcAOD.Dielectron.root IlcAODCentrality.root";
...
Int_t       iMakeDimuonAOD     = 0;      // IlcAOD.Dimuons.root
...
//      tender->SetDebugLevel(2);
   ...
   if (iESDfilter && !iAODanalysis) {
      ...
      if (iMUONcopyAOD) {
        ...
        IlcAnalysisTaskESDfilter *taskesdfilter = AddTaskESDFilter(useKFILTER, kTRUE,(iMakeDimuonAOD==1), usePhysicsSelection, kFALSE, IlcESDpid::kTOF_T0, kTRUE);
      } else {
