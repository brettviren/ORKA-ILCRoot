...
//==============================================================================
TString     proof_cluster      = "ilccaf.cern.ch";
...
TString     ilcroot_version    = "v4-20-06-AN-1";  // *CHANGE ME IF MORE RECENT IN GRID*                                          
// Change production base directory here
TString     alien_datadir      = "/ilc/data/2010/LHC10d";
// AliEn output directory. If blank will become output_<train_name>
//TString     alien_outdir       = "/ilc/data/2010/LHC10b/AOD1";
...
TString     mergeExclude       = "IlcAOD.root IlcAOD.VertexingHF.root IlcAOD.Jets.root deltaAODPartCorr.root IlcAOD.Muons.root IlcAOD.Dimuons.root";
...
//         if (iPWG3vertexing) aodHandler->SetOutputFileName("IlcAOD.VertexingHF.root");
   ...
   if (mgr->InitAnalysis()) {                                                                                                              
      ...
      if (saveTrain && smode=="GRID") {                                                                                                    
         IlcAnalysisAlien *gridhandler = (IlcAnalysisAlien*)mgr->GetGridHandler();                                                         
         ...
         printf("=== Registering ConfigTrain.C in the work directory <%s> ===\n",                                                          
                alien_workdir.Data());                                                                                                     
         if (IlcAnalysisAlien::FileExists(Form("%s/%sConfig.C", alien_workdir.Data(), train_name.Data())))                                 
...
//      tender->SelectCollisionCandidates();
   ...
   if (iESDfilter && !iAODanalysis) {
      ...
      if (iMUONcopyAOD) {
         ...
         IlcAnalysisTaskESDfilter *taskesdfilter = AddTaskESDFilter(useKFILTER, kTRUE, kTRUE, usePhysicsSelection);
      } else {
         IlcAnalysisTaskESDfilter *taskesdfilter = AddTaskESDFilter(useKFILTER, kFALSE, kFALSE, usePhysicsSelection);
      }   
   }   
...
//   source /tmp/gclient_env_$UID in the current shell.
   if (!IlcAnalysisGrid::CreateToken()) return NULL;
...
//   plugin->SetPreferedSE("ILC::NIHAM::File");
...
//   plugin->AddDataFile("/ilc/data/2008/LHC08c/000057657/raw/Run57657.Merged.RAW.tag.root");
