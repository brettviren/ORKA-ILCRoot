...
//    IlcESDs_barrel.root IlcESDfriends_barrel.root ...  suffix = _barrel
//    IlcESDs_outer.root IlcESDfriends_outer.root ...    suffix = _outer
// HOW TO RUN (for run_no=158285):
// QA job: should call:
//    ln -fs IlcESDs_barrel.root IlcESDs.root
//    ln -fs IlcESDfriends_barrel.root IlcESDfriends.root
//    ... same for all specific reco files
//    ilcroot -b -q QAtrain_duo.C\(\"_barrel\"\,158285\) producing:
//      -> EventStat_temp_barrel.root QAresults_barrel.root 400_400_0_350.stat
//
//    ln -fs IlcESDs_outer.root IlcESDs.root
//    ln -fs IlcESDfriends_outer.root IlcESDfriends.root
//    ... same for all specific reco files
//    ilcroot QAtrain_duo.C\(\"_outer\"\,158285\) producing:
//      -> EventStat_temp_outer.root QAresults_outer.root 400_400_0_380.stat
//
// Each merging job:
// for stages i < 5
//    ilcroot -b -q QAtrain_duo.C\(\"_barrel\"\,158285\,\"wn.xml\"\,i\)
//    ilcroot -b -q QAtrain_duo.C\(\"_outer\"\,158285\,\"wn.xml\"\,i\)
//      -> same output files as the QA jobs (except .stat)
// for stage 5
//    ilcroot -b -q QAtrain_duo.C\(\"_barrel\"\,158285\,\"Stage_5.xml\"\,5\)
//      -> event_stat_barrel.root trending_barrel.root 145230_145230_0_120345.stat
//    ilcroot -b -q QAtrain_duo.C\(\"_outer\"\,158285\,\"Stage_5.xml\"\,5\)
             ...
             Int_t  stage          = 0) /*0 = QA train, 1...n - merging stage*/
{
  ...
  // Create manager
  IlcAnalysisManager *mgr  = new IlcAnalysisManager("PilotAnalysis", "Production train");
