...
//==============================================================================
//   IlcAnalysisGrid - Base grid utility class. Provides interface for creating
...
ClassImp(IlcAnalysisGrid)

//______________________________________________________________________________
IlcAnalysisGrid::IlcAnalysisGrid(const IlcAnalysisGrid& other)
...
//______________________________________________________________________________
IlcAnalysisGrid &IlcAnalysisGrid::operator=(const IlcAnalysisGrid& other)
{
// Assignment.
   if (this != &other) {
...
//______________________________________________________________________________
Bool_t IlcAnalysisGrid::CreateToken(const char *)
{
// Check if a valid token exists - if not create one
   ::Warning("IlcAnalysisGrid::CreateToken()", "**** !!!! Obsolete method. Please remove the line calling this in your plugin configuration !!!! ****\n");
   return kTRUE;
}

//______________________________________________________________________________
IlcAnalysisGrid::EPluginRunMode IlcAnalysisGrid::GetRunMode() const
{
// Get the current run mode.
   if (TObject::TestBit(kTest)) return IlcAnalysisGrid::kTest;
   if (TObject::TestBit(kOffline)) return IlcAnalysisGrid::kOffline;
   if (TObject::TestBit(kSubmit)) return IlcAnalysisGrid::kSubmit;
   if (TObject::TestBit(kMerge)) return IlcAnalysisGrid::kMerge;
   return IlcAnalysisGrid::kFull;
}
   
//______________________________________________________________________________
void IlcAnalysisGrid::SetRunMode(const char *mode)
{
