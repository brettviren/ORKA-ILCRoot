...
#ifndef ILCCOLLISIONNORMILCZATION_H
#define ILCCOLLISIONNORMILCZATION_H
...
class IlcCollisionNormalization : public TObject
...
public:
  ...
  IlcCollisionNormalization();
  IlcCollisionNormalization(Int_t nbinz, Float_t minz, Float_t maxz);
  IlcCollisionNormalization(const char * dataFile, const char * dataListName, 
  ...
  void FillVzMCGen(Float_t vz, Int_t ntrk, IlcMCEvent * mcEvt);      
  void FillVzMCRec(Float_t vz, Int_t ntrk, IlcMCEvent * mcEvt);      
  void FillVzMCTrg(Float_t vz, Int_t ntrk, IlcMCEvent * mcEvt);      
  ...
  Int_t GetProcessType(const IlcMCEvent * mcEvt) ;
...
protected:
  ...
  ClassDef(IlcCollisionNormalization, 4);
    
private:
  IlcCollisionNormalization(const IlcCollisionNormalization&);
  IlcCollisionNormalization& operator=(const IlcCollisionNormalization&);
};
