...
ClassImp(IlcESDv0KineCuts)

//____________________________________________________________________
IlcESDv0KineCuts::IlcESDv0KineCuts() :
  fEvent(0x0)
  , fPrimaryVertex(0x0)
  , fType(0)
  , fMode(0)
  ...
  , fDeleteVertex(kFALSE)
{
  ...
  fGcutChi2NDF = 10;           // Chi2NF cut value for the IlcKFparticle gamma
  ...
  // default K0 cuts
  fK0cutChi2NDF = 10;          // Chi2NF cut value for the IlcKFparticle K0
  ...
  fLcutChi2NDF = 10;           // Chi2NF cut value for the IlcKFparticle K0
...
//____________________________________________________________________
IlcESDv0KineCuts::IlcESDv0KineCuts(const IlcESDv0KineCuts &ref):
  TObject(ref)
  , fEvent(0x0)
  , fPrimaryVertex(0x0)
  , fType(0)
...
//____________________________________________________________________
IlcESDv0KineCuts &IlcESDv0KineCuts::operator=(const IlcESDv0KineCuts &ref){
  //
  // assignment operator
  //
  if(this != &ref)
...
//____________________________________________________________________
void IlcESDv0KineCuts::Copy(TObject &ref) const {
  //
  ...
  IlcESDv0KineCuts &target = dynamic_cast<IlcESDv0KineCuts &>(ref);
...
//____________________________________________________________________
Bool_t  IlcESDv0KineCuts::ProcessV0(IlcESDv0* const v0, Int_t &pdgV0, Int_t &pdgP, Int_t &pdgN) const 
{
  //
  // main user function
  //
  ...
  if(!v0) return kFALSE;
  if(!fEvent){
    IlcErrorClass("No valid Event pointer available, provide it first");
    return kFALSE;
  }
...
//____________________________________________________________________
Bool_t  IlcESDv0KineCuts::ProcessV0(IlcESDv0* const v0, Int_t &pdgP, Int_t &pdgN) const 
{
  //
...
//____________________________________________________________________
Int_t IlcESDv0KineCuts::PreselectV0(IlcESDv0* const v0) const 
{
  //
...
//____________________________________________________________________
Bool_t  IlcESDv0KineCuts::SingleTrackCuts(IlcESDv0 * const v0) const 
{
  //
  ...
  nIndex = v0->GetNindex();
  IlcESDtrack* d[2];
  d[0] = dynamic_cast<IlcESDtrack*>(fEvent->GetTrack(pIndex));
  d[1] = dynamic_cast<IlcESDtrack*>(fEvent->GetTrack(nIndex));
  ...
  for(Int_t i=0; i<2; ++i){
    ...
    // TPC refit
    if(!(status & IlcESDtrack::kTPCrefit)) return kFALSE;
...
//____________________________________________________________________
Bool_t IlcESDv0KineCuts::CaseGamma(IlcESDv0* const v0, Int_t &pdgV0, Int_t &pdgP, Int_t &pdgN) const 
{
  //
  ...
  daughter[0] = dynamic_cast<IlcVTrack *>(fEvent->GetTrack(pIndex));
  daughter[1] = dynamic_cast<IlcVTrack *>(fEvent->GetTrack(nIndex));
  if(!daughter[0] || !daughter[1]) return kFALSE;

  IlcKFParticle *kfMother = CreateMotherParticle(daughter[0], daughter[1], TMath::Abs(kElectron), TMath::Abs(kElectron));
...
//____________________________________________________________________
Bool_t  IlcESDv0KineCuts::CaseK0(IlcESDv0* const v0, Int_t &pdgV0, Int_t &pdgP, Int_t &pdgN) const {
  //
  ...
  IlcKFParticle *kfMother = CreateMotherParticle(daughter[0], daughter[1], TMath::Abs(kPiPlus), TMath::Abs(kPiPlus));
  if(!kfMother) return kFALSE;
...
//____________________________________________________________________
Bool_t  IlcESDv0KineCuts::CaseLambda(IlcESDv0* const v0, Int_t &pdgV0, Int_t &pdgP, Int_t &pdgN, Int_t id) const {
  //
  ...
  IlcKFParticle *kfMother[2] = {0x0, 0x0};
  // Lambda
...
//____________________________________________________________________
Bool_t  IlcESDv0KineCuts::V0CutsCommon(const IlcESDv0 * const v0) const 
{
  //
  ...
  dP = dynamic_cast<IlcESDtrack *>(fEvent->GetTrack(v0->GetPindex()));
  dN = dynamic_cast<IlcESDtrack *>(fEvent->GetTrack(v0->GetNindex())); 
...
//____________________________________________________________________
void IlcESDv0KineCuts::Armenteros(IlcESDv0* const v0, Float_t val[2]) const 
{
  //
...
//____________________________________________________________________
Bool_t IlcESDv0KineCuts::CheckSigns(IlcESDv0* const v0) const 
{
  //
...
Double_t IlcESDv0KineCuts::PsiPair(IlcESDv0* const v0) const 
{
  //
  ...
  IlcESDtrack* daughter[2];

  daughter[0] = dynamic_cast<IlcESDtrack *>(fEvent->GetTrack(pIndex));
  daughter[1] = dynamic_cast<IlcESDtrack *>(fEvent->GetTrack(nIndex));
  ...
  IlcExternalTrackParam pt(*daughter[0]), nt(*daughter[1]);
...
Bool_t  IlcESDv0KineCuts::GetConvPosXY(IlcESDtrack * const ptrack, IlcESDtrack * const ntrack, Double_t convpos[2]) const
{
  //
...
//___________________________________________________________________
Bool_t  IlcESDv0KineCuts::GetHelixCenter(IlcESDtrack * const track, Double_t b,Int_t charge, Double_t center[2]) const
{
  //
...
//___________________________________________________________________
IlcKFParticle *IlcESDv0KineCuts::CreateMotherParticle(const IlcVTrack* const pdaughter, const IlcVTrack* const ndaughter, Int_t pspec, Int_t nspec) const
{
  //
  // Creates a mother particle
  //
  IlcKFParticle pkfdaughter(*pdaughter, pspec);
  IlcKFParticle nkfdaughter(*ndaughter, nspec);
  
  
  // Create the mother particle 
  IlcKFParticle *m = new IlcKFParticle(pkfdaughter, nkfdaughter);
  ...
  if(TMath::Abs(kElectron) == pspec && TMath::Abs(kElectron) == nspec) m->SetMassConstraint(0, 0.001);
    ...
    IlcErrorClass("Wrong daughter ID - mass constraint can not be set");
  }

  IlcKFVertex improvedVertex = *fPrimaryVertex;
  improvedVertex += *m;
...
//____________________________________________________________________
void  IlcESDv0KineCuts::SetEvent(IlcESDEvent* const event){
  //
  // direct setter of ESD event
  //
  fEvent = event;
  if(!fEvent){
    IlcErrorClass("Invalid input event pointer");
    return;
  }
if (fUseExternalVertex) return;
	...
	fPrimaryVertex = new IlcKFVertex(*(fEvent->GetPrimaryVertex()));
	fDeleteVertex=kTRUE;
	}
...
//____________________________________________________________________
void  IlcESDv0KineCuts::SetEvent(IlcVEvent* const event){
  //
  // direct setter of ESD event
  //

  fEvent = dynamic_cast<IlcESDEvent*>(event);
  if(!fEvent){
    IlcErrorClass("Invalid input event pointer");
    return;
  }
...
//________________________________________________________________
void	 IlcESDv0KineCuts::UseExternalVertex(Bool_t use_external){
	//
...
//________________________________________________________________
void IlcESDv0KineCuts::SetPrimaryVertex(IlcKFVertex* const v){
  //
  ...
  if(!fPrimaryVertex){
    IlcErrorClass("Failed to initialize the primary vertex");
    return;
  }
}
//___________________________________________________________________
void IlcESDv0KineCuts::SetMode(Int_t mode, Int_t type){
  //
  ...
  case kEffGamma:
    ...
    break;
  default:
    IlcError("V0 selection mode not recognozed, setting 'kPurity'");
    fMode = kPurity;
  }
...
//___________________________________________________________________
void IlcESDv0KineCuts::SetMode(Int_t mode, const char* type){
  //
  ...
  if(!strcmp("pp", type)) t = kPP;
    ...
    IlcError("data type not recognized, setting 'pp'");
    t = kPP;    
  }
