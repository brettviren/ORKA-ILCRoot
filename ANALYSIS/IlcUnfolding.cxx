...
/* $Id: IlcUnfolding.cxx 31168 2009-02-23 15:18:45Z jgrosseo $ */
...
TMatrixD* IlcUnfolding::fgCorrelationMatrix = 0;
TMatrixD* IlcUnfolding::fgCorrelationMatrixSquared = 0;
TMatrixD* IlcUnfolding::fgCorrelationCovarianceMatrix = 0;
TVectorD* IlcUnfolding::fgCurrentESDVector = 0;
TVectorD* IlcUnfolding::fgEntropyAPriori = 0;
TVectorD* IlcUnfolding::fgEfficiency = 0;

TAxis* IlcUnfolding::fgUnfoldedAxis = 0;
TAxis* IlcUnfolding::fgMeasuredAxis = 0;

TF1* IlcUnfolding::fgFitFunction = 0;

IlcUnfolding::MethodType IlcUnfolding::fgMethodType = IlcUnfolding::kInvalid;
Int_t IlcUnfolding::fgMaxInput  = -1;  // bins in measured histogram
Int_t IlcUnfolding::fgMaxParams = -1;  // bins in unfolded histogram = number of fit params
Float_t IlcUnfolding::fgOverflowBinLimit = -1;

IlcUnfolding::RegularizationType IlcUnfolding::fgRegularizationType = IlcUnfolding::kPol1;
Float_t IlcUnfolding::fgRegularizationWeight = 10000;
Int_t IlcUnfolding::fgSkipBinsBegin = 0;
Float_t IlcUnfolding::fgMinuitStepSize = 0.1;                 // (usually not needed to be changed) step size in minimization
Float_t IlcUnfolding::fgMinuitPrecision = 1e-6;               // minuit precision
Int_t   IlcUnfolding::fgMinuitMaxIterations = 1e6;           // minuit maximum number of iterations
Bool_t IlcUnfolding::fgMinimumInitialValue = kFALSE;          // set all initial values at least to the smallest value among the initial values
Float_t IlcUnfolding::fgMinimumInitialValueFix = -1;
Bool_t IlcUnfolding::fgNormalizeInput = kFALSE;               // normalize input spectrum
Float_t IlcUnfolding::fgNotFoundEvents = 0;
Bool_t IlcUnfolding::fgSkipBin0InChi2 = kFALSE;

Float_t IlcUnfolding::fgBayesianSmoothing  = 1;           // smoothing parameter (0 = no smoothing)
Int_t   IlcUnfolding::fgBayesianIterations = 10;          // number of iterations in Bayesian method

Bool_t IlcUnfolding::fgDebug = kFALSE;

Int_t IlcUnfolding::fgCallCount = 0;

Int_t IlcUnfolding::fgPowern = 5;

Double_t IlcUnfolding::fChi2FromFit = 0.;
Double_t IlcUnfolding::fPenaltyVal  = 0.;
Double_t IlcUnfolding::fAvgResidual = 0.;

Int_t IlcUnfolding::fgPrintChi2Details = 0;

TCanvas *IlcUnfolding::fgCanvas = 0;
TH1 *IlcUnfolding::fghUnfolded = 0;     
TH2 *IlcUnfolding::fghCorrelation = 0;  
TH1 *IlcUnfolding::fghEfficiency = 0;   
TH1 *IlcUnfolding::fghMeasured = 0;     

ClassImp(IlcUnfolding)

//____________________________________________________________________
void IlcUnfolding::SetUnfoldingMethod(MethodType methodType)
{
  ...
  Printf("IlcUnfolding::SetUnfoldingMethod: %s enabled.", name);
}

//____________________________________________________________________
void IlcUnfolding::SetCreateOverflowBin(Float_t overflowBinLimit) 
{ 
  ...
  Printf("IlcUnfolding::SetCreateOverflowBin: overflow bin limit set to %f", overflowBinLimit);
}

//____________________________________________________________________
void IlcUnfolding::SetSkipBinsBegin(Int_t nBins)
{
  // set number of skipped bins in regularization
  
  fgSkipBinsBegin = nBins;
  
  Printf("IlcUnfolding::SetSkipBinsBegin: skipping %d bins at the beginning of the spectrum in the regularization.", fgSkipBinsBegin);
}

//____________________________________________________________________
void IlcUnfolding::SetNbins(Int_t nMeasured, Int_t nUnfolded) 
{ 
  ...
  Printf("IlcUnfolding::SetNbins: Set %d measured bins and %d unfolded bins", nMeasured, nUnfolded);
}

//____________________________________________________________________
void IlcUnfolding::SetChi2Regularization(RegularizationType type, Float_t weight)
{
  //
  ...
  Printf("IlcUnfolding::SetChi2Regularization --> Regularization set to %d with weight %f", (Int_t) type, weight);
}

//____________________________________________________________________
void IlcUnfolding::SetBayesianParameters(Float_t smoothing, Int_t nIterations)
{
  //
  ...
  Printf("IlcUnfolding::SetBayesianParameters --> Paramaters set to %d iterations with smoothing %f", fgBayesianIterations, fgBayesianSmoothing);
}

//____________________________________________________________________
void IlcUnfolding::SetFunction(TF1* function)
{
  // set function for unfolding with a fit function
  
  fgFitFunction = function;
  
  Printf("IlcUnfolding::SetFunction: Set fit function with %d parameters.", function->GetNpar());
}

//____________________________________________________________________
Int_t IlcUnfolding::Unfold(TH2* correlation, TH1* efficiency, TH1* measured, TH1* initialConditions, TH1* result, Bool_t check)
{
  ...
  if (fgMaxInput == -1)
  {
    Printf("IlcUnfolding::Unfold: WARNING. Number of measured bins not set with SetNbins. Using number of bins in measured distribution");
    fgMaxInput = measured->GetNbinsX();
  }
  if (fgMaxParams == -1)
  {
    Printf("IlcUnfolding::Unfold: WARNING. Number of unfolded bins not set with SetNbins. Using number of bins in measured distribution");
  ...
  switch (fgMethodType)
  {
    case kInvalid:
    {
      Printf("IlcUnfolding::Unfold: ERROR: Unfolding method not set. Use SetUnfoldingMethod. Exiting...");
      return -1;
    }
...
//____________________________________________________________________
void IlcUnfolding::SetStaticVariables(TH2* correlation, TH1* measured, TH1* efficiency)
{
...
//____________________________________________________________________
Int_t IlcUnfolding::UnfoldWithMinuit(TH2* correlation, TH1* efficiency, TH1* measured, TH1* initialConditions, TH1* result, Bool_t check)
{
  //
  ...
  */
  ...
  if (!initialConditions) {
    ...
    Printf("IlcUnfolding::UnfoldWithMinuit: Using different initial conditions...");
  ...
  printf("IlcUnfolding::UnfoldWithMinuit: Chi2 of initial parameters is = %f\n", chi2);
  ...
  Printf("IlcUnfolding::UnfoldWithMinuit: MINUIT status is %d", status);
  ...
  Printf("IlcUnfolding::UnfoldWithMinuit: iterations %d. Chi2 of final parameters is = %f", tmpCallCount, chi2);
...
//____________________________________________________________________
Int_t IlcUnfolding::UnfoldWithBayesian(TH2* correlation, TH1* aEfficiency, TH1* measured, TH1* initialConditions, TH1* aResult)
{
  //
  ...
  {
    Printf("IlcUnfolding::UnfoldWithBayesian: ERROR: The measured spectrum is empty");
    return -1;
  }
  ...
  {
    if (fgDebug)
      Printf("IlcUnfolding::UnfoldWithBayesian: iteration %i", i);
    ...
    */
    ...
    {
      Printf("IlcUnfolding::UnfoldWithBayesian: Stopped Bayesian unfolding after %d iterations at chi2(change since last iteration) of %e; chi2Measured of the last prior is %e", i, chi2LastIter, chi2Measured);
      break;
    }
  } // end of iterations
...
//____________________________________________________________________
Double_t IlcUnfolding::RegularizationPol0(TVectorD& params)
{
...
//____________________________________________________________________
Double_t IlcUnfolding::RegularizationPol1(TVectorD& params)
{
  // homogenity term for minuit fitting
  // pure function of the parameters
...
//____________________________________________________________________
Double_t IlcUnfolding::RegularizationLog(TVectorD& params)
{
  // homogenity term for minuit fitting
  // pure function of the parameters
...
//____________________________________________________________________
Double_t IlcUnfolding::RegularizationTotalCurvature(TVectorD& params)
{
  // homogenity term for minuit fitting
  // pure function of the parameters
...
//____________________________________________________________________
Double_t IlcUnfolding::RegularizationEntropy(TVectorD& params)
{
  // homogenity term for minuit fitting
  // pure function of the parameters
...
//____________________________________________________________________
Double_t IlcUnfolding::RegularizationRatio(TVectorD& params)
{
  // homogenity term for minuit fitting
  // pure function of the parameters
  //
...
//____________________________________________________________________
Double_t IlcUnfolding::RegularizationPowerLaw(TVectorD& params)
{
  // homogenity term for minuit fitting
  // pure function of the parameters
...
//____________________________________________________________________
Double_t IlcUnfolding::RegularizationLogLog(TVectorD& params)
{
  // homogenity term for minuit fitting
  // pure function of the parameters
...
//____________________________________________________________________
void IlcUnfolding::Chi2Function(Int_t&, Double_t*, Double_t& chi2, Double_t *params, Int_t)
{
  //
  ...
  if ((fgCallCount++ % 1000) == 0)
  {
    ...
    Printf("IlcUnfolding::Chi2Function: Iteration %d (ev %d %d +- %f) (%f) (%f): %f %f %f %f --> %f", fgCallCount-1, (Int_t) fgNotFoundEvents, (Int_t) currentNotFoundEvents, TMath::Sqrt(errorNotFoundEvents), params[fgMaxParams-1], avg, chi2FromFit, penaltyVal, notFoundEventsConstraint, chi2Avg, chi2);
...
//____________________________________________________________________
void IlcUnfolding::DrawResults(TH2* correlation, TH1* efficiency, TH1* measured, TH1* initialConditions, TCanvas *canv, Int_t reuseHists,TH1 *unfolded)
{
  // Draw histograms of
...
//____________________________________________________________________
void IlcUnfolding::RedrawInteractive() {
  // 
...
//____________________________________________________________________
void IlcUnfolding::InteractiveUnfold(TH2* correlation, TH1* efficiency, TH1* measured, TH1* initialConditions) 
{
  //
  ...
  fghUnfolded = new TH1F("IlcUnfoldingfghUnfolded","Unfolded result (Interactive unfolder",efficiency->GetNbinsX(),efficiency->GetXaxis()->GetXmin(),efficiency->GetXaxis()->GetXmax());
  ...
  TExec *execRedraw = new TExec("redraw","IlcUnfolding::RedrawInteractive()");
  fghUnfolded->GetListOfFunctions()->Add(execRedraw);
}
//____________________________________________________________________
void IlcUnfolding::DrawGuess(Double_t *params, TVirtualPad *pfolded, TVirtualPad *pres, TVirtualPad *ppen, Int_t reuseHists,TH1* unfolded)
{
  //
  ...
  if (!reuseHists || folded == 0) {
    if (fgMeasuredAxis->GetXbins()->GetArray()) // variable bins
      folded = new TH1F("__hfolded","Folded histo from IlcUnfolding",fgMeasuredAxis->GetNbins(),fgMeasuredAxis->GetXbins()->GetArray());
    else
      folded = new TH1F("__hfolded","Folded histo from IlcUnfolding",fgMeasuredAxis->GetNbins(),fgMeasuredAxis->GetXmin(),fgMeasuredAxis->GetXmax());
  }
...
//____________________________________________________________________
TH1* IlcUnfolding::GetResidualsPlot(TH1* corrected)
{
  //
...
//____________________________________________________________________
TH1* IlcUnfolding::GetResidualsPlot(Double_t* params)
{
  //
  // fill residuals histogram of solution suggested by params and effect of regularization
  //
...
//____________________________________________________________________
TH1* IlcUnfolding::GetPenaltyPlot(TH1* corrected)
{
...
//____________________________________________________________________
TH1* IlcUnfolding::GetPenaltyPlot(Double_t* params)
{
  // draws the penalty factors as function of multiplicity of the current selected regularization
...
//____________________________________________________________________
void IlcUnfolding::TF1Function(Int_t& unused1, Double_t* unused2, Double_t& chi2, Double_t *params, Int_t unused3)
{
  //
  // fit function for minuit
...
//____________________________________________________________________
Int_t IlcUnfolding::UnfoldWithFunction(TH2* correlation, TH1* efficiency, TH1* measured, TH1* /* initialConditions */, TH1* aResult)
{
  //
  ...
  if (!fgFitFunction)
  {
    Printf("IlcUnfolding::UnfoldWithFunction: ERROR fit function not set. Exiting.");
    return -1;
  }    
...
//____________________________________________________________________
void IlcUnfolding::CreateOverflowBin(TH2* correlation, TH1* measured)
{
  ...
  if (lastBin == 0)
  {
    Printf("IlcUnfolding::CreateOverflowBin: WARNING: First bin is already below limit of %f", fgOverflowBinLimit);
    return;
  }
  
  Printf("IlcUnfolding::CreateOverflowBin: Bin limit in measured spectrum determined to be %d", lastBin);
  ...
  Printf("IlcUnfolding::CreateOverflowBin: This bin has now %f +- %f entries", measured->GetBinContent(lastBin), measured->GetBinError(lastBin));
  ...
  Printf("IlcUnfolding::CreateOverflowBin: Adjusted correlation matrix!");
...
Int_t IlcUnfolding::UnfoldGetBias(TH2* correlation, TH1* efficiency, TH1* measured, TH1* initialConditions, TH1* result)
{
