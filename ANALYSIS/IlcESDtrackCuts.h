...
//  AcceptTrack which takes a single IlcESDtrack as argument and
//  returns kTRUE/kFALSE or GetAcceptedTracks which takes an IlcESDEvent
//  object and returns an TObjArray (of IlcESDtracks) with the tracks
...
#ifndef ILCESDTRACKCUTS_H
#define ILCESDTRACKCUTS_H
...
class IlcESDtrackCuts : public IlcAnalysisCuts
{
public:
  ...
  IlcESDtrackCuts(const Char_t* name = "IlcESDtrackCuts", const Char_t* title = "");
  virtual ~IlcESDtrackCuts();

  virtual Bool_t IsSelected(TObject* obj)
       {return AcceptTrack((IlcESDtrack*)obj);}
  virtual Bool_t IsSelected(TList* /*list*/) {return kTRUE;}

  Bool_t AcceptTrack(const IlcESDtrack* esdTrack);
  TObjArray* GetAcceptedTracks(const IlcESDEvent* esd, Bool_t bTPC = kFALSE);
  Int_t CountAcceptedTracks(const IlcESDEvent* const esd);
  
  static Int_t GetReferenceMultiplicity(const IlcESDEvent* esd, Bool_t tpcOnly);
  static Int_t GetReferenceMultiplicity(const IlcESDEvent* esd, MultEstTrackType trackType = kTrackletsITSTPC, Float_t etaRange = 0.5);
  static IlcESDtrackCuts* GetMultEstTrackCuts(MultEstTrackCuts cut);

  static IlcESDtrack* GetTPCOnlyTrack(const IlcESDEvent* esd, Int_t iTrack);
  
  // Standard cut definitions
  static IlcESDtrackCuts* GetStandardTPCOnlyTrackCuts();
  static IlcESDtrackCuts* GetStandardITSTPCTrackCuts2009(Bool_t selPrimaries=kTRUE);
  static IlcESDtrackCuts* GetStandardITSTPCTrackCuts2010(Bool_t selPrimaries=kTRUE, Int_t clusterCut=0);
  static IlcESDtrackCuts* GetStandardITSTPCTrackCuts2011(Bool_t selPrimaries=kTRUE, Int_t clusterCut=1);
  static IlcESDtrackCuts* GetStandardITSSATrackCuts2009(Bool_t selPrimaries=kTRUE, Bool_t useForPid=kTRUE);
  static IlcESDtrackCuts* GetStandardITSSATrackCuts2010(Bool_t selPrimaries=kTRUE, Bool_t useForPid=kTRUE);
  static IlcESDtrackCuts* GetStandardITSSATrackCutsPbPb2010(Bool_t selPrimaries=kTRUE, Bool_t useForPid=kTRUE);
  static IlcESDtrackCuts* GetStandardITSPureSATrackCuts2009(Bool_t selPrimaries=kTRUE, Bool_t useForPid=kTRUE);
  static IlcESDtrackCuts* GetStandardITSPureSATrackCuts2010(Bool_t selPrimaries=kTRUE, Bool_t useForPid=kTRUE);
  // Standard cuts for daughter tracks
  static IlcESDtrackCuts* GetStandardV0DaughterCuts();

  virtual Long64_t Merge(TCollection* list);
  virtual void Copy(TObject &c) const;
  IlcESDtrackCuts(const IlcESDtrackCuts& pd);  // Copy Constructor
  IlcESDtrackCuts &operator=(const IlcESDtrackCuts &c);
  ...
  static Float_t GetSigmaToVertex(const IlcESDtrack* const esdTrack);
...
protected:
  ...
  static IlcESDtrackCuts* fgMultEstTrackCuts[kNMultEstTrackCuts]; //! track cuts used for the multiplicity estimate
