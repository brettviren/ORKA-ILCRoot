/* $Id: IlcUnfolding.h 53846 2012-01-06 13:40:41Z jgrosseo $ */

#ifndef ILCUNFOLDING_H
#define ILCUNFOLDING_H
...
// PWG0/IlcUnfolding.h:21: previous declaration as `struct TVectorD'
...
class IlcUnfolding : public TObject
{
  public:
...
private:
    IlcUnfolding(const IlcUnfolding&);
    IlcUnfolding& operator=(const IlcUnfolding&);

  ClassDef(IlcUnfolding, 0);
};
