#ifndef ILCANALYSISTASK_H
#define ILCANALYSISTASK_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcAnalysisTask.h 47741 2011-02-23 14:00:34Z agheata $ */
...
class TClass;
class TFile;
class IlcAnalysisDataSlot;
class IlcAnalysisDataContainer;

class IlcAnalysisTask : public TTask {
 public:
...
public:  
  IlcAnalysisTask();
  IlcAnalysisTask(const char *name, const char *title);
  IlcAnalysisTask(const IlcAnalysisTask &task); 
  virtual ~IlcAnalysisTask();
  
  // Assignment
  IlcAnalysisTask& operator=(const IlcAnalysisTask &task);
  //=====================================================================
  ...
  // Conect inputs/outputs to data containers (by IlcAnalysisModule)
  Bool_t                    ConnectInput(Int_t islot, IlcAnalysisDataContainer *cont);
  Bool_t                    ConnectOutput(Int_t islot, IlcAnalysisDataContainer *cont);
  // Check connectivity
  ...
  IlcAnalysisDataSlot      *GetInputSlot(Int_t islot) const  {return (IlcAnalysisDataSlot*)fInputs->At(islot);}
  IlcAnalysisDataSlot      *GetOutputSlot(Int_t islot) const {return (IlcAnalysisDataSlot*)fOutputs->At(islot);}
  ...
  ClassDef(IlcAnalysisTask,2)  // Class describing an analysis task
};
#endif
