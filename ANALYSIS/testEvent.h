...
class TaskGenerate : public IlcAnalysisTask {

public:
   TaskGenerate(const char *name) : IlcAnalysisTask(name,"") {}
...
//______________________________________________________________________________
class TaskFilter : public IlcAnalysisTask {
private:
...
public:
   TaskFilter() : IlcAnalysisTask(), fEvent(0), fOutput(0), fList(0), fHist1(0), fHist2(0) {}
...
//______________________________________________________________________________
class TaskRecoPi0 : public IlcAnalysisTask {
private:
   AnaEvent      *fEvent;        // Current event
...
public:
   TaskRecoPi0() : IlcAnalysisTask(), fEvent(0), fGammas(0), fPions(0), fHist(0) {}
