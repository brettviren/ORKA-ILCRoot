...
ClassImp(IlcHEPDataParser)

IlcHEPDataParser::IlcHEPDataParser() : TObject(), fHistStat(0),  fHistSyst(0),  fGraphStat(0),  fGraphSyst(0),  fHEPDataFileLines(0), fValueName("")
{
  // default ctor

}

IlcHEPDataParser::IlcHEPDataParser(TH1 * hStat, TH1 * hSyst): TObject(), fHistStat(0),  fHistSyst(0),  fGraphStat(0),  fGraphSyst(0),  fHEPDataFileLines(0), fValueName("y")
{
  //ctor
  fHistStat = hStat;
  fHistSyst = hSyst;
...
IlcHEPDataParser::IlcHEPDataParser(TGraph * grStat, TGraph * grSyst): TObject(), fHistStat(0),  fHistSyst(0),  fGraphStat(0),  fGraphSyst(0),  fHEPDataFileLines(0), fValueName("")
{
  // ctor
  fGraphStat = grStat;
  fGraphSyst = grSyst;
...
IlcHEPDataParser::IlcHEPDataParser(const char * hepfileName): TObject(), fHistStat(0),  fHistSyst(0),  fGraphStat(0),  fGraphSyst(0),  fHEPDataFileLines(0), fValueName("y")
{
  //ctor
...
IlcHEPDataParser::~IlcHEPDataParser(){
  // dtor
...
void IlcHEPDataParser::SaveHEPDataFile(const char * hepfileName, Bool_t trueUseGraphFalesUseHisto) {
  ...
  if(trueUseGraphFalesUseHisto) {
    ...
    else     {IlcError("Unsupported graph type"); return;}
    Int_t npoint = fGraphStat->GetN();
    if(asym) IlcInfo("Assymmetric errors");
