// #####    TO RUN THIS MACRO:
// bash$ ilcroot         (due to IlcInfo, IlcError, ...)
// root[0] gSystem->Load("libANALYSIS");
// IN case you do not have the include path set to IlcRoot includes:
// root[1] gSystem->AddIncludePath("-I\"$ILC_ROOT/include\"");
...
// Simple event generation
   IlcAnalysisManager *mgr = new IlcAnalysisManager("generate");
...
// From gammas coming from the same vertex.
   ...
   IlcAnalysisManager *mgr = new IlcAnalysisManager("testEvent");
   ...
   IlcAnalysisDataContainer *cinput = mgr->CreateContainer("input0", 
                      TTree::Class(), IlcAnalysisManager::kInputContainer);
   IlcAnalysisDataContainer *coutput1 = mgr->CreateContainer("output0", 
                      TTree::Class(), IlcAnalysisManager::kOutputContainer);
   IlcAnalysisDataContainer *coutput2 = mgr->CreateContainer("output1", 
                      TList::Class(), IlcAnalysisManager::kOutputContainer);
   IlcAnalysisDataContainer *coutput = mgr->CreateContainer("output", 
                      TH1::Class(), IlcAnalysisManager::kOutputContainer, "output.root");
...
TaskFilter::TaskFilter(const char *name) 
           :IlcAnalysisTask(name,""), fEvent(0), fOutput(0), fList(0), fHist1(0), fHist2(0)
{
// Constructor
...
TaskRecoPi0::TaskRecoPi0(const char *name) 
           :IlcAnalysisTask(name,""), fEvent(0), fGammas(0), fPions(0), fHist(0)
{
// Constructor
   // Input slot #0 works with a tree of events
   DefineInput(0, TTree::Class());
