#ifndef ILCKINETRACKCUTS_H
#define ILCKINETRACKCUTS_H
...
class IlcKineTrackCuts : public IlcAnalysisCuts
{

public:
                      IlcKineTrackCuts(const Char_t* name = "IlcKineTrackCuts", const Char_t* title = "");
  virtual            ~IlcKineTrackCuts(){;}
