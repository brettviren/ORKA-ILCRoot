...
IlcAnalysisGoodies::IlcAnalysisGoodies() :
  TObject(),
  fTimer(), 
  ...
  fAmgr(0)
{
 ...
 // Make the analysis manager
  fAmgr = new IlcAnalysisManager("Goodies Manager", "Analysis manager created by IlcAnalysisGoodies") ;
}

//______________________________________________________________________________
IlcAnalysisGoodies::IlcAnalysisGoodies(const IlcAnalysisGoodies& ag) :
  TObject(),
  fTimer(), 
  fESDTreeName(""), 
  fAmgr(0x0)  
...
//______________________________________________________________________________
IlcAnalysisGoodies& IlcAnalysisGoodies::operator=(const IlcAnalysisGoodies& ag)
{
  // Assignment operator
  if(this!=&ag) {
  }
...
//______________________________________________________________________________
void IlcAnalysisGoodies::Help() const  
{
  IlcInfo("Analysis utilities:\n") ; 
  ...
  printf("                                                esdFile: can be a root file with the ESD Tree ( ex: esd?IlcESDs.root) \n") ;
  ...
  printf("                                               tagCuts: is the IlcEventTagCuts (needed only for tag? cases \n") ;
  ...
  printf("                                                lfndir : AliEn directory ( ex:  /ilc/data/2006/LHC06c/PHOS_TestBeam/\n") ;  
  printf("                                                pfndir : MSS directory   ( ex: /castor/cern.ch/ilc/testbeam/phos/2006 \n") ;
  printf("                                                file   : text file with a list of the file names to be registered\n ") ; 

}

//______________________________________________________________________
Bool_t IlcAnalysisGoodies::Alien2Local(const TString collectionNameIn, const TString localDir)
{
  ...
  IlcXMLCollection * collectionIn = IlcXMLCollection::Open(collectionNameIn) ;
  collectionIn->Reset() ; 

  IlcXMLCollection * collectionOu = new IlcXMLCollection() ; 
...
//______________________________________________________________________
IlcAnalysisDataContainer * IlcAnalysisGoodies::ConnectInput(IlcAnalysisTask * task, TClass * classin, UShort_t index) 
{
  ...
  if ( ! fAmgr->GetTask(task->GetName()) ) 
    ...
    IlcFatal(Form("Task %s already exists", task->GetName())) ; 

  IlcAnalysisDataContainer * taskInput = 0x0 ; 
  if ( fAmgr->GetInputs() ) 
    taskInput = dynamic_cast<IlcAnalysisDataContainer *>(fAmgr->GetInputs()->FindObject(Form("InputContainer_%s_%d", task->GetName(), index))) ; 
  if ( ! taskInput ) {
    taskInput  = fAmgr->CreateContainer(Form("InputContainer_%s_%d", task->GetName(), index), classin, IlcAnalysisManager::kInputContainer) ;
    fAmgr->ConnectInput (task, index, taskInput);
  }
  else 
    IlcFatal(Form("Input %s already exists", taskInput->GetName())) ; 

  return taskInput ; 
} 

//______________________________________________________________________
void IlcAnalysisGoodies::ConnectInput(IlcAnalysisTask * task, IlcAnalysisDataContainer * taskInput, UShort_t index) 
{
  // connect a task to the input
...
//______________________________________________________________________
IlcAnalysisDataContainer *  IlcAnalysisGoodies::ConnectOuput(IlcAnalysisTask * task, TClass * classou, UShort_t index, TString opt ) 
{
  ...
  char filename[20] ; 
    ...
    IlcAnalysisDataContainer * taskOuput = 0x0 ;
    if ( fAmgr->GetOutputs() ) 
      taskOuput = dynamic_cast<IlcAnalysisDataContainer *>(fAmgr->GetOutputs()->FindObject(Form("OutputContainer_%s_%d", task->GetName(), index))) ; 
    if ( ! taskOuput )
      taskOuput = fAmgr->CreateContainer(Form("OutputContainer_%s_%d", task->GetName(), index), classou, IlcAnalysisManager::kOutputContainer, filename) ;
...
//______________________________________________________________________
void IlcAnalysisGoodies::ConnectOuput(IlcAnalysisTask * task, IlcAnalysisDataContainer * taskOuput, UShort_t index) 
{
  // connect a task to the output
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::Make(IlcRunTagCuts *runCuts, IlcLHCTagCuts *lhcCuts, IlcDetectorTagCuts *detCuts, IlcEventTagCuts *evtCuts, const char * in, const char * out) const  
{
  ...
  if ( file.Contains(".root") ) 
    ...
    IlcError(Form("%s is not a valid file format", in)) ; 
    rv = kFALSE ; 
  }
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::MakeEsdCollectionFromTagFile(IlcRunTagCuts *runCuts, IlcLHCTagCuts *lhcCuts, IlcDetectorTagCuts *detCuts, IlcEventTagCuts *evtCuts, const char * in, const char * out) const 
{
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::MakeEsdCollectionFromTagCollection(IlcRunTagCuts *runCuts, IlcLHCTagCuts *lhcCuts, IlcDetectorTagCuts *detCuts, IlcEventTagCuts *evtCuts, const char * in, const char * out) const 
{
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::MakeEsdCollectionFromTagCollection(const char * runCuts, const char *lhcCuts, const char *detCuts, const char * evtCuts, const char * in, const char * out) const 
{
  // Makes an esd collection from a xml tag collection 
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::Merge(const char * collectionFile, const char * subFile, const char * outFile) 
{
  ...
  IlcInfo(Form("Files merged into %s\n", outFile)) ;
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::Process(TChain * chain) 
{
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::Process(const char * inFile) 
{ 
  // process the events with an Analysis Task 
  // usage Process(esdFile)
  //              esdFile: is of the form opt?file_lfn 
  Bool_t rv = kFALSE ; 
  IlcRunTagCuts      * runCuts = 0x0 ; 
  IlcLHCTagCuts      * lhcCuts = 0x0 ;
  IlcDetectorTagCuts * detCuts = 0x0 ; 
  IlcEventTagCuts    * evtCuts = 0x0 ;
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::Process(const char * inFile, IlcRunTagCuts *runCuts, IlcLHCTagCuts *lhcCuts, IlcDetectorTagCuts *detCuts, IlcEventTagCuts * evtCuts ) 
{
  // process the events with an Analysis Task 
  ...
  if ( file.Contains("esd?") && file.Contains(".root") ) {
    ...
    IlcError(Form("%s is not a valid file format", inFile)) ; 
    rv = kFALSE ;
  }
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::Process(const char * inFile, const char * runCuts, const char * lhcCuts, const char * detCuts, const char * evtCuts) 
{
  // process the events with an Analysis Task 
  // usage Process(esdFile, runtagCuts, evtTagCuts)
  //              esdFile: is of the form opt?file_lfn 
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::ProcessChain(TChain * chain) const
{
  // Procees a TChain. 
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::ProcessEsdFile(const char * esdFile) const   
{
  // process the events in a single ESD file with an Analysis Task 
  // usage ProcessLocalEsdFile(esdFile)
  //              esdFile: is the root file (local or in alien) with the ESD Tree ( ex: IlcESDs.root) 
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::ProcessTagFile(const char * tagFile, IlcRunTagCuts *runCuts, IlcLHCTagCuts *lhcCuts, IlcDetectorTagCuts *detCuts, IlcEventTagCuts *evtCuts) const   
{
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::ProcessTagFile(const char * tagFile, const char * runCuts, const char * lhcCuts, const char * detCuts, const char * evtCuts) const   
{
  // process the events in a single Tag file with an Analysis Task 
  // usage ProcessLocalEsdFile(tagFile)
  //              tagFile: is the root file (local or in alien) with the Tag Tree (ex: Run102.Event0_100.ESD.tag.root) 
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::ProcessEsdXmlCollection(const char * xmlFile) const   
{
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::ProcessTagXmlCollection(const char * xmlFile, IlcRunTagCuts *runCuts, IlcLHCTagCuts *lhcCuts, IlcDetectorTagCuts *detCuts, IlcEventTagCuts * evtCuts) const   
{
  // process the events in a xml ESD collection  with an Analysis Task 
  // usage ProcessLocalEsdFile(xmlFile)
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::ProcessTagXmlCollection(const char * xmlFile, const char * runCuts, const char * lhcCuts, const char * detCuts, const char * evtCuts) const   
{
  // process the events in a xml ESD collection  with an Analysis Task 
  // usage ProcessLocalEsdFile(xmlFile)
  //              xmlFile: is the local xml file with the tag collection ( ex: tagCollection.xml) 
...
//______________________________________________________________________
Bool_t IlcAnalysisGoodies::Register( const char * lfndir, const char * pfndir, const char * file) 
{
  // register files already stored in a MSS into the AliEn catalog
  // usage: Register(lfndir, pfndir, pfnFileName)
  //         lfndir : AliEn directory ( ex:  /ilc/data/2006/LHC06c/PHOS_TestBeam/ ) 
  //         pfndir : MSS directory   ( ex: /castor/cern.ch/ilc/testbeam/phos/2006 )
  ...
  while (1) {
    ...
    sprintf(pfn, "castor://Ilc::CERN::Castor2/%s/%s", pfndir, fileName) ;  
