...
/* $Id: IlcPVBARRawFitterv0.cxx 53738 2011-12-20 16:49:27Z kharlov $ */
...
// 
//     IlcPVBARRawFitterv0 *fitterv0=new IlcPVBARRawFitterv0();
...
ClassImp(IlcPVBARRawFitterv0)

//-----------------------------------------------------------------------------
IlcPVBARRawFitterv0::IlcPVBARRawFitterv0():
  TObject(),
  fModule(0),
  fCellX(0),
  fCellZ(0),
...
//-----------------------------------------------------------------------------
IlcPVBARRawFitterv0::IlcPVBARRawFitterv0(const IlcPVBARRawFitterv0 &PVBARFitter ):
  TObject(),
  fModule      (PVBARFitter.fModule),
  fCellX       (PVBARFitter.fCellX),
  fCellZ       (PVBARFitter.fCellZ),
  fCaloFlag    (PVBARFitter.fCaloFlag),
  fNBunches    (PVBARFitter.fNBunches),
  fPedSubtract (PVBARFitter.fPedSubtract),
  fEnergy      (PVBARFitter.fEnergy),
  fTime        (PVBARFitter.fTime),
  fQuality     (PVBARFitter.fQuality),
  fPedestalRMS (PVBARFitter.fPedestalRMS),
  fAmpOffset   (PVBARFitter.fAmpOffset),
  fAmpThreshold(PVBARFitter.fAmpThreshold),
  fOverflow    (PVBARFitter.fOverflow),
  fCalibData   (PVBARFitter.fCalibData)
{
  //Copy constructor
}

//-----------------------------------------------------------------------------
IlcPVBARRawFitterv0& IlcPVBARRawFitterv0::operator = (const IlcPVBARRawFitterv0 &PVBARFitter)
{
  //Assignment operator.
...
void IlcPVBARRawFitterv0::SetChannelGeo(const Int_t module, const Int_t cellX,
...
Bool_t IlcPVBARRawFitterv0::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
