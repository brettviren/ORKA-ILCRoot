/* $Id: IlcPVBARMakeRaw.C 17365 2007-03-12 10:28:57Z kharlov $ */
MakeRaw()
{
  ...
  for (Int_t iX=0; iX<64; iX++) {
	...
	if (buffer[iDDL] == 0) {
	  ...
	  mapping[iDDL] = new IlcCaloAltroMapping(path.Data());
	...
	IlcInfo("Signal is out of time range.\n");
...
PlotRawDDL()
{
  ...
  IlcRawReaderFile* rf = new IlcRawReaderFile(".");
  IlcCaloRawStream in(rf,"PVBAR");
