...
void TestPVBARTrigger(){

  //Loader  
  IlcRunLoader* rl=0x0;
  
//   cout<<"TestPVBARTrigger: Creating Run Loader ..."<<endl;
...
//   IlcPVBARLoader *emcalLoader = dynamic_cast<IlcPVBARLoader*>
//     (rl->GetDetectorLoader("PVBAR"));
...
//  maxevent=5;
  ...
  for(Int_t iEvent = 0; iEvent < maxevent ; iEvent++){
    ...
    IlcPVBARTrigger *tr = new IlcPVBARTrigger();
