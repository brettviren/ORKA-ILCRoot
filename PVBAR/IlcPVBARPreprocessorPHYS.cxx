...
#include "IlcPVBARPreprocessorPHYS.h"

ClassImp(IlcPVBARPreprocessorPHYS)

//_______________________________________________________________________________________
IlcPVBARPreprocessorPHYS::IlcPVBARPreprocessorPHYS() : IlcPreprocessor("PHS",0) {
  //default constructor
}
//_______________________________________________________________________________________
IlcPVBARPreprocessorPHYS::IlcPVBARPreprocessorPHYS(IlcShuttleInterface* shuttle): IlcPreprocessor("PHS",shuttle) {
  // Constructor
...
//_______________________________________________________________________________________
UInt_t IlcPVBARPreprocessorPHYS::Process(TMap* /*valueSet*/){
...
//_______________________________________________________________________________________
Bool_t IlcPVBARPreprocessorPHYS::CalibratePhys(){
  //process PHYSICS event retrieved by the Shuttle
  //
  
  TList* list = 0;
  list = GetFileSources(kDAQ,"PVBARDApi0mip");
  if(!list) {
  ...
  while ((source = dynamic_cast<TObjString *> (iter.Next()))) {
    ...
    TString fileName = GetFile(kDAQ, "PVBARDApi0mip", source->GetName());
