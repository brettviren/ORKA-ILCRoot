...
/* $Id: IlcPVBARPIDv0.cxx 53738 2011-12-20 16:49:27Z kharlov $ */
...
//     - shower width.
//
// CPV or Preshower clusters should be closer in PVBAR plane than fCpvEmcDistance (in cm).
...
//
// use case:
//  root [0] IlcPVBARPIDv0 * p1 = new IlcPVBARPIDv0("gilc.root")
//  Warning in <TDatabasePDG::TDatabasePDG>: object already instantiated
//  root [1] p1->SetIdentificationMethod("disp ellipse")
//  root [2] p1->ExecuteTask()
//  root [3] IlcPVBARPIDv0 * p2 = new IlcPVBARPIDv0("gilc1.root","ts1")
//  Warning in <TDatabasePDG::TDatabasePDG>: object already instantiated
...
ClassImp( IlcPVBARPIDv0) 

//____________________________________________________________________________
IlcPVBARPIDv0::IlcPVBARPIDv0():
  fIDOptions("dis time"),
  fClusterizer(0),
  fTSMaker(0),
  fFormula(0),
...
//____________________________________________________________________________
IlcPVBARPIDv0::IlcPVBARPIDv0(IlcPVBARGeometry *geom) : 
  IlcPVBARPID(geom),
  fIDOptions("dis time"),
  fClusterizer(0),
  fTSMaker(0),
...
//____________________________________________________________________________
IlcPVBARPIDv0::IlcPVBARPIDv0(const IlcPVBARPIDv0 & rhs) :
  IlcPVBARPID(rhs),
...
//____________________________________________________________________________
IlcPVBARPIDv0 & IlcPVBARPIDv0::operator = (const IlcPVBARPIDv0 & rhs)
{
  //Copy-assignment, emulates compiler generated, possibly wrong.
  IlcPVBARPID::operator = (rhs);
  if (this != &rhs) {
    fIDOptions = rhs.fIDOptions;
    fClusterizer = rhs.fClusterizer;
    fTSMaker = rhs.fTSMaker;
...
//DP
////____________________________________________________________________________
//Float_t  IlcPVBARPIDv0::GetDistance(IlcPVBAREmcRecPoint * emc,IlcPVBARRecPoint * cpv, Option_t *  Axis)const
//{
//  // Calculates the distance between the EMC RecPoint and the PPSD RecPoint
// 
//  const IlcPVBARGeometry * geom = IlcPVBARLoader::GetPVBARGeometry() ; 
//  TVector3 vecEmc ;
//  TVector3 vecCpv ;
//  
//  emc->GetLocalPosition(vecEmc) ;
//  cpv->GetLocalPosition(vecCpv) ; 
//  if(emc->GetPVBARMod() == cpv->GetPVBARMod()){ 
//    
...
//____________________________________________________________________________
void  IlcPVBARPIDv0::TrackSegments2RecParticles(Option_t * option) 
{
  //Steering method
...
//____________________________________________________________________________
void  IlcPVBARPIDv0::MakeRecParticles()
{
  ...
  while ( (ts = (IlcPVBARTrackSegment *)next()) ) {
    ...
    IlcPVBARRecPoint    * cpv = 0 ;
    if(ts->GetCpvIndex()>=0)
      cpv = (IlcPVBARRecPoint *)   fCPVRecPoints->At(ts->GetCpvIndex()) ;
...
//____________________________________________________________________________
void  IlcPVBARPIDv0:: Print(const Option_t *) const
{
  // Print the parameters used for the particle type identification
  TString message ; 
  message  = "=============== IlcPVBARPIDv0 ================\n" ;
  message += "Making PID\n" ;
...
//____________________________________________________________________________
void  IlcPVBARPIDv0::SetShowerProfileCut(const char * formula)
{
...
//____________________________________________________________________________
void  IlcPVBARPIDv0::PlotDispersionCuts()const
{
...
//____________________________________________________________________________
TVector3 IlcPVBARPIDv0::GetMomentumDirection(IlcPVBAREmcRecPoint * emc, IlcPVBARRecPoint * )const 
{ 
...
//____________________________________________________________________________
void IlcPVBARPIDv0::PrintRecParticles(Option_t * option)
{
  ...
  if(strstr(option,"all")) {  // printing found TS
    ...
    for (index = 0 ; index < fRecParticles->GetEntries() ; index++) {
      ...
      Text_t particle[100];
      switch(rp->GetType()) {
      case  IlcPVBARFastRecParticle::kNEUTRALEMFAST:
	strncpy( particle, "NEUTRAL EM FAST",100);
	break;
      case  IlcPVBARFastRecParticle::kNEUTRALHAFAST:
	strncpy(particle, "NEUTRAL HA FAST",100);
	break;
      case  IlcPVBARFastRecParticle::kNEUTRALEMSLOW:
	strncpy(particle, "NEUTRAL EM SLOW",100);
	break ;
      case  IlcPVBARFastRecParticle::kNEUTRALHASLOW: 
	strncpy(particle, "NEUTRAL HA SLOW",100);
	break ;
      case  IlcPVBARFastRecParticle::kCHARGEDEMFAST:
	strncpy(particle, "CHARGED EM FAST",100);
	break ;
      case  IlcPVBARFastRecParticle::kCHARGEDHAFAST:
	strncpy(particle, "CHARGED HA FAST",100);
	break ;	
      case  IlcPVBARFastRecParticle::kCHARGEDEMSLOW:
	strncpy(particle, "CHARGEDEMSLOW",100);
	break ;
      case  IlcPVBARFastRecParticle::kCHARGEDHASLOW:
