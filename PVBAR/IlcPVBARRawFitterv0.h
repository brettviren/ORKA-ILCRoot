#ifndef ILCPVBARRAWFITTERV0_H
#define ILCPVBARRAWFITTERV0_H
...
class IlcPVBARRawFitterv0 : public TObject 
{

public:

  IlcPVBARRawFitterv0();
  IlcPVBARRawFitterv0(const IlcPVBARRawFitterv0& rawFitterv0);
  IlcPVBARRawFitterv0& operator = (const IlcPVBARRawFitterv0& rawFitterv0);
  virtual ~IlcPVBARRawFitterv0();
  ...
  void SetCalibData(IlcPVBARCalibData * cdata){ fCalibData=cdata ;}

protected:   
  
  Int_t    fModule;         // PVBAR module number
  ...
  IlcPVBARCalibData * fCalibData ;   //! Calibration database if avalable

  ClassDef(IlcPVBARRawFitterv0,2)
};
