...
//-----------------------------------------------------------------------------                                                            
IlcPVBARSimParam * IlcPVBARSimParam::GetInstance(){

  if(!fgSimParam)
    new IlcPVBARSimParam(0) ;
  return fgSimParam ;
}
//-----------------------------------------------------------------------------
IlcPVBARSimParam& IlcPVBARSimParam::operator = (const IlcPVBARSimParam& simParam)
{
  //Assignment operator.
