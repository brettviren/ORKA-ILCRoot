#ifndef ILCPVBARTrigger_H
#define ILCPVBARTrigger_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVBARTrigger.h 32767 2009-06-05 15:59:59Z kharlov $ */
...
class IlcPVBARTrigger : public IlcTriggerDetector {
  
 public: 
  
  IlcPVBARTrigger() ; //  ctor
  IlcPVBARTrigger(const IlcPVBARTrigger & trig) ; // cpy ctor
  virtual ~IlcPVBARTrigger();

  virtual void    CreateInputs(); //Define trigger inputs for Central Trigger Processor
  void            Print(const Option_t * opt ="") const ;  
  virtual void    Trigger() {}                   //Make PVBAR trigger
  void            Trigger(TClonesArray *digits); //Make PVBAR trigger
 ...
 private:
  ...
  IlcPVBARTrigger & operator = (const IlcPVBARTrigger & trig) ;//cpy assignment

  void FillTRU(const TClonesArray * digits, const IlcPVBARGeometry * geom) const ;
 ...
 private: 
  ...
  ClassDef(IlcPVBARTrigger,5)
} ;


#endif //ILCPVBARTrigger_H
