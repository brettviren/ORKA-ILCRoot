#ifndef ILCPVBAREMCAGEOMETRY_H
#define ILCPVBAREMCAGEOMETRY_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVBAREMCAGeometry.h 31469 2009-03-13 11:16:29Z kharlov $ */

//_________________________________________________________________________
// Geometry class  for PVBAR : EMCA (Electromagnetic Calirometer)
...
class IlcPVBAREMCAGeometry : public TObject {

public: 

  IlcPVBAREMCAGeometry();
  //Compiler-generated copy ctor and copy-assignment operator _ARE_ OK.

  virtual ~IlcPVBAREMCAGeometry(void) {}
...
private:
  ...
  ClassDef(IlcPVBAREMCAGeometry,1)      // EMCA geometry class 

} ;

#endif // IlcPVBAREMCAGEOMETRY_H
