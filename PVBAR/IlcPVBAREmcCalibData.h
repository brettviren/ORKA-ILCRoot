#ifndef ILCPVBAREMCCILCBDATA_H
#define ILCPVBAREMCCILCBDATA_H
...
class IlcPVBAREmcCalibData: public TNamed {

 public:
  IlcPVBAREmcCalibData();
  IlcPVBAREmcCalibData(const char* name);
  IlcPVBAREmcCalibData(const IlcPVBAREmcCalibData &calibda);
  IlcPVBAREmcCalibData& operator= (const IlcPVBAREmcCalibData &calibda);
  virtual ~IlcPVBAREmcCalibData();
  void Reset();
...
protected:
  ...
  //
  ClassDef(IlcPVBAREmcCalibData,5)    // PVBAR EMC calibration data
};
