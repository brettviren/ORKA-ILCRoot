#ifndef ILCPVBARCPVBASEGEOMETRY_H
#define ILCPVBARCPVBASEGEOMETRY_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVBARCPVBaseGeometry.h 7867 2003-07-13 11:00:31Z hristov $ */

//_________________________________________________________________________
// Geometry base class for PVBAR:CVS (Charged particle veto)
...
class IlcPVBARCPVBaseGeometry : public TObject {

public: 

           IlcPVBARCPVBaseGeometry()     {}
  virtual ~IlcPVBARCPVBaseGeometry(void) {}
...
/*   virtual void    SetLeadConverterThickness(Float_t x) = 0 ; */
  ...
  ClassDef(IlcPVBARCPVBaseGeometry,1)        // CPV base geometry class 

} ;

#endif // ILCPVBARCPVBASEGEOMETRY_H
