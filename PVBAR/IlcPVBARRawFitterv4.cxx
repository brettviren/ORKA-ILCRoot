...
// If sample is not in saturation, a coarse algorithm is used (a-la IlcPVBARRawFitterv0)
// If sample is in saturation, the unsaturated part of the sample is fit a-la IlcPVBARRawFitterv1
// 
//     IlcPVBARRawFitterv4 *fitterv4=new IlcPVBARRawFitterv4();
...
ClassImp(IlcPVBARRawFitterv4)

//-----------------------------------------------------------------------------
IlcPVBARRawFitterv4::IlcPVBARRawFitterv4():
  IlcPVBARRawFitterv1(),
  fFitHighGain(0) 
{
  //Default constructor
...
Bool_t IlcPVBARRawFitterv4::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
...
//===================================================
Bool_t IlcPVBARRawFitterv4::EvalWithFitting(TArrayI*samples, TArrayI * times){
