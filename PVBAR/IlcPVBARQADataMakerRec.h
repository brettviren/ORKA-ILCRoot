#ifndef ILCPVBARQADataMakerRec_H
#define ILCPVBARQADataMakerRec_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */


/* $Id: IlcPVBARQADataMakerRec.h 57196 2012-06-15 08:08:57Z hristov $ */
...
class IlcPVBARQADataMakerRec: public IlcQADataMakerRec {
...
public:
  IlcPVBARQADataMakerRec() ;          // ctor
  IlcPVBARQADataMakerRec(const IlcPVBARQADataMakerRec& qadm) ;   
  IlcPVBARQADataMakerRec& operator = (const IlcPVBARQADataMakerRec& qadm) ;
  virtual ~IlcPVBARQADataMakerRec() {;} // dtor
  
private:
  const IlcPVBARRecoParam* GetRecoParam() { return dynamic_cast<const IlcPVBARRecoParam *>(fRecoParam); }
  ...
  ClassDef(IlcPVBARQADataMakerRec,1)  // description 

};

#endif // IlcPVBARQADataMakerRec_H
