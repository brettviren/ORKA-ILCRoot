#ifndef ILCPVBARCLUSTERIZER_H
#define ILCPVBARCLUSTERIZER_H
...
class IlcPVBARClusterizer : public TObject {

public:

  IlcPVBARClusterizer() ;        // default ctor
  IlcPVBARClusterizer(IlcPVBARGeometry *geom);
  virtual ~IlcPVBARClusterizer() ; // dtor
...
private:
  IlcPVBARClusterizer(const IlcPVBARClusterizer & clusterizer);
  IlcPVBARClusterizer & operator = (const IlcPVBARClusterizer &clusterer);

  ClassDef(IlcPVBARClusterizer,5)  // Clusterization algorithm class 

} ;

#endif // IlcPVBARCLUSTERIZER_H
