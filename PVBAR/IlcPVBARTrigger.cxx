 ...
 **************************************************************************/
/* $Id: IlcPVBARTrigger.cxx 47329 2011-02-11 19:44:15Z kharlov $ */
...
//  IlcPVBARTrigger *tr = new IlcPVBARTrigger();//Init Trigger
...
ClassImp(IlcPVBARTrigger)

//______________________________________________________________________
IlcPVBARTrigger::IlcPVBARTrigger()
  : IlcTriggerDetector(),
...
IlcPVBARTrigger::IlcPVBARTrigger(const IlcPVBARTrigger & trig) : 
...
//_________________________________________________________________________
IlcPVBARTrigger & IlcPVBARTrigger::operator = (const IlcPVBARTrigger &)
{
  Fatal("operator =", "no implemented");
  return *this;
}

void IlcPVBARTrigger::CreateInputs()
{
   // inputs 
   ...
   fInputs.AddLast( new IlcTriggerInput( "PVBAR_JetHPt_L1",name, 1 ) );
   fInputs.AddLast( new IlcTriggerInput( "PVBAR_JetMPt_L1",name, 1 ) );
   fInputs.AddLast( new IlcTriggerInput( "PVBAR_JetLPt_L1",name, 1 ) );
 
}

//____________________________________________________________________________
void IlcPVBARTrigger::FillTRU(const TClonesArray * digits, const IlcPVBARGeometry * geom) const {
  ...
  for(Int_t idig = 0 ; idig < digits->GetEntriesFast() ; idig++){
    ...
    dig    = static_cast<IlcPVBARDigit *>(digits->At(idig)) ;
...
//______________________________________________________________________
void IlcPVBARTrigger::GetCrystalPhiEtaIndexInModuleFromTRUIndex(Int_t itru, Int_t iphitru, Int_t ietatru,Int_t &iphiMod,Int_t &ietaMod) const 
{
...
//____________________________________________________________________________
Bool_t IlcPVBARTrigger::IsPatchIsolated(Int_t iPatchType, const Int_t imod, const Int_t mtru, const Float_t maxamp, const Int_t maxphi, const Int_t maxeta) {
...
//____________________________________________________________________________
void IlcPVBARTrigger::MakeSlidingCell(const Int_t imod, TMatrixD &ampmax2, TMatrixD &ampmaxn)
{
...
//____________________________________________________________________________
void IlcPVBARTrigger::Print(const Option_t * opt) const 
{
  ...
  if(in->GetValue())
    printf( "             *** PVBAR LO is set ***\n") ; 
  
  printf( "             Jet Low Pt Threshold for L1 %10.2f\n", fL1JetLowPtThreshold) ;
  in = (IlcTriggerInput*)fInputs.FindObject( "PVBAR_JetLPt_L1" );
  if(in->GetValue())
    printf( "             *** PVBAR Jet Low Pt for L1 is set ***\n") ;
  
  printf( "             Jet Medium Pt Threshold for L1 %10.2f\n", fL1JetMediumPtThreshold) ;
  in = (IlcTriggerInput*)fInputs.FindObject( "PVBAR_JetMPt_L1" );
  if(in->GetValue())
    printf( "             *** PVBAR Jet Medium Pt for L1 is set ***\n") ;
  
  printf( "             Jet High Pt Threshold for L1 %10.2f\n", fL1JetHighPtThreshold) ;  
  in = (IlcTriggerInput*) fInputs.FindObject( "PVBAR_JetHPt_L1" );
  if(in->GetValue())
    printf( "              *** PVBAR Jet High Pt for L1 is set ***\n") ;
  
}

//____________________________________________________________________________
void IlcPVBARTrigger::SetTriggers(const Int_t iMod, const TMatrixD & ampmax2, const TMatrixD & ampmaxn)  
{
...
//____________________________________________________________________________
void IlcPVBARTrigger::Trigger(TClonesArray *digits) 
{
...
void IlcPVBARTrigger::DoIt()
{
  ...
  if(fSimulation)
    fDigitsList = PVBARLoader->Digits() ;
