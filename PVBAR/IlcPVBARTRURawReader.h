#ifndef ILCPVBARTRURAWREADER_H
#define ILCPVBARTRURAWREADER_H
 ...
 */
class IlcPVBARTRURawReader : public TObject
{
 public:
  IlcPVBARTRURawReader();
  virtual ~IlcPVBARTRURawReader();
 ...
 private:
  IlcPVBARTRURawReader(const IlcPVBARTRURawReader &); // not implemented
  IlcPVBARTRURawReader& operator= (const IlcPVBARTRURawReader &); // not implemented
 ...
 private:  
  ...
  ClassDef(IlcPVBARTRURawReader, 1)
};

#endif // ILCPVBARTRURAWREADER_H
