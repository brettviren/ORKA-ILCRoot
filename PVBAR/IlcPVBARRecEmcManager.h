#ifndef IlcPVBARRecEmcManager_H
#define IlcPVBARRecEmcManager_H
...
class IlcPVBARRecEmcManager : public IlcPVBARRecManager {

 public: 

  IlcPVBARRecEmcManager();
  ~IlcPVBARRecEmcManager(void);
 ...
 private:
  ...
  ClassDef(IlcPVBARRecEmcManager,1)        // Emc reconstruction management class 

} ;

#endif // IlcPVBARRecEmcManager_H
