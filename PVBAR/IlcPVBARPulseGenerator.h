#ifndef ILCPVBARPULSEGENERATOR_H
#define ILCPVBARPULSEGENERATOR_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                          */

/* $Id: IlcPVBARPulseGenerator.h 54863 2012-02-28 12:10:29Z hristov $ */
...
class IlcPVBARPulseGenerator : public TObject
{
public:
  IlcPVBARPulseGenerator(Double_t a=0, Double_t t0=0);
  virtual  ~IlcPVBARPulseGenerator();
...
private:
  IlcPVBARPulseGenerator(const IlcPVBARPulseGenerator & pulse);
  IlcPVBARPulseGenerator& operator = (const IlcPVBARPulseGenerator &) {return *this;}
...
private:
  ...
  ClassDef(IlcPVBARPulseGenerator,1)
