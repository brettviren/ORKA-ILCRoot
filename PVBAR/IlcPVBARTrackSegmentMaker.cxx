 ...
 **************************************************************************/
/* $Id: IlcPVBARTrackSegmentMaker.cxx 25703 2008-05-10 19:18:21Z kharlov $ */
...
ClassImp( IlcPVBARTrackSegmentMaker) 


//____________________________________________________________________________
IlcPVBARTrackSegmentMaker:: IlcPVBARTrackSegmentMaker() : 
  TObject(),
  fESD(0), 
  fGeom(0),
  fEMCRecPoints(0),
...
//____________________________________________________________________________
IlcPVBARTrackSegmentMaker::IlcPVBARTrackSegmentMaker(IlcPVBARGeometry *geom):
  TObject(),
  fESD(0), 
  fGeom(geom),
  fEMCRecPoints(0),
...
//____________________________________________________________________________
IlcPVBARTrackSegmentMaker::IlcPVBARTrackSegmentMaker(const IlcPVBARTrackSegmentMaker & tsmaker) :
  TObject(tsmaker),
  fESD(tsmaker.GetESD()), 
  fGeom(tsmaker.fGeom),
...
//____________________________________________________________________________
void IlcPVBARTrackSegmentMaker::SetInput(TTree *clustersTree)
{
