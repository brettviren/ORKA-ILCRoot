#ifndef IlcPVBARRecManager_H
#define IlcPVBARRecManager_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

//_________________________________________________________________________
// Base class for the management by the PVBAR reconstruction.
...
class IlcPVBARRecManager : public TNamed {

 public:

  IlcPVBARRecManager();
  virtual ~IlcPVBARRecManager(void) {}
  ...
  ClassDef(IlcPVBARRecManager,1)

} ;

#endif // IlcPVBARRecManager_H
