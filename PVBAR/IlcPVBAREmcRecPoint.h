#ifndef ILCPVBAREMCRECPOINT_H
#define ILCPVBAREMCRECPOINT_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVBAREmcRecPoint.h 54863 2012-02-28 12:10:29Z hristov $ */
...
class IlcPVBAREmcRecPoint : public IlcPVBARRecPoint  {

public:

  IlcPVBAREmcRecPoint() ;
  IlcPVBAREmcRecPoint(const char * opt) ;
  IlcPVBAREmcRecPoint(const IlcPVBAREmcRecPoint & rp) ; 
 
  virtual ~IlcPVBAREmcRecPoint() ;  

  virtual void Clear(const Option_t* /*option*/ ="") { delete[] fEnergyList; fEnergyList=0; IlcPVBARRecPoint::Clear(); }

  //This virtual function has signature different from IlcPVBARRecPoint::AddDigit
  //it hides, not overrides. using - declaration should fix the problem, at least for
  //g++
//  using IlcPVBARRecPoint::AddDigit;
  virtual void  AddDigit(IlcPVBARDigit & digit, Float_t Energy, Float_t time=0.) ;          // add a digit to the digits list  
  ...
  virtual Int_t GetNumberOfLocalMax(IlcPVBARDigit **  maxAt, Float_t * maxAtEnergy,
...
private:
  IlcPVBAREmcRecPoint & operator = (const IlcPVBAREmcRecPoint & /*rvalue*/) {return *this;}

protected:
  virtual void  EvalLocalPosition(Float_t logWeight, TVector3 &vtx, TClonesArray * digits, TVector3 &vInc) ;// computes the position in the PVBAR module 
  ...
  virtual Bool_t AreNeighbours(IlcPVBARDigit * digit1, IlcPVBARDigit * digit2 ) const ;
  ...
  ClassDef(IlcPVBAREmcRecPoint,3)  // EMC RecPoint (cluster)

};

#endif // IlcPVBAREMCRECPOINT_H
