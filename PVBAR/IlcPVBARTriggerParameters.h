#ifndef ILCPVBARTRIGGERPARAMETERS_H
#define ILCPVBARTRIGGERPARAMETERS_H
...
/* $Id: IlcPVBARTriggerParameters.h 55807 2012-04-17 20:40:19Z hristov $ */
 ...
 */
class IlcPVBARTriggerParameters : public TNamed
{

public:
  IlcPVBARTriggerParameters();
  IlcPVBARTriggerParameters(const char* name);
  IlcPVBARTriggerParameters(const IlcPVBARTriggerParameters& );
  IlcPVBARTriggerParameters& operator= (const IlcPVBARTriggerParameters& );
  virtual ~IlcPVBARTriggerParameters();
  ...
  // Constants
  static const Int_t kNMods     = 5; // Number of PVBAR Modules
...
protected:
  ...
  ClassDef(IlcPVBARTriggerParameters, 1) // PVBAR Trigger Parameters
};
