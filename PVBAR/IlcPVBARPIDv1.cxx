...
/* $Id: IlcPVBARPIDv1.cxx 44091 2010-10-05 09:46:25Z prsnko $ */
...
// Implementation version v1 of the PVBAR particle identifier 
...
//      file is $ILC_ROOT/PVBAR/PCA8pa15_0.5-100.root. Analysis done for 
...
//      $ILC_ROOT/PVBAR/Parameters.dat. Each time that IlcPVBARPIDv1 is 
//      initialized, this parameters are copied to a Matrix (9,4), a 
//      TMatrixD object.  
//
// use case:
//  root [0] IlcPVBARPIDv1 * p = new IlcPVBARPIDv1("gilc1.root")
...
//                  
//  root [2] IlcPVBARPIDv1 * p2 = new IlcPVBARPIDv1("gilc1.root","v1",kTRUE)
//  Warning in <TDatabasePDG::TDatabasePDG>: object already instantiated
//                //Split mode.  
...
ClassImp( IlcPVBARPIDv1) 

//____________________________________________________________________________
IlcPVBARPIDv1::IlcPVBARPIDv1() :
  IlcPVBARPID(),
  fBayesian(kFALSE),
  fDefaultInit(kFALSE),
  fWrite(kFALSE),
...
//____________________________________________________________________________
IlcPVBARPIDv1::IlcPVBARPIDv1(const IlcPVBARPIDv1 & pid ) : 
  IlcPVBARPID(pid),
  fBayesian(kFALSE),
  fDefaultInit(kFALSE),
  fWrite(kFALSE),
...
//____________________________________________________________________________
IlcPVBARPIDv1::IlcPVBARPIDv1(IlcPVBARGeometry *geom):
  IlcPVBARPID(geom),
  fBayesian(kFALSE),
  fDefaultInit(kFALSE),
  fWrite(kFALSE),
...
//____________________________________________________________________________
void IlcPVBARPIDv1::InitParameters()
{
...
void  IlcPVBARPIDv1::TrackSegments2RecParticles(Option_t *option)
{
  ...
  if(strstr(option,"deb"))
      PrintRecParticles(option);
  if(strstr(option,"tim")){
    gBenchmark->Stop("PVBARPID");
    IlcInfo(Form("took %f seconds for PID", 
		 gBenchmark->GetCpuTime("PVBARPID")));  
  }
}

//________________________________________________________________________
Double_t  IlcPVBARPIDv1::GausF(Double_t  x, Double_t  y, Double_t * par)
{
...
//________________________________________________________________________
Double_t  IlcPVBARPIDv1::GausPol2(Double_t  x, Double_t y, Double_t * par)
{
  //Given the energy x and the parameter y (tof, shower dispersion or cpv-emc distance), 
  //this method returns a density probability of this parameter, given by a gaussian 
...
//____________________________________________________________________________
const TString IlcPVBARPIDv1::GetFileNamePrincipal(TString particle) const
{
...
//____________________________________________________________________________
Float_t  IlcPVBARPIDv1::GetParameterCalibration(Int_t i) const 
{
...
//____________________________________________________________________________
Float_t  IlcPVBARPIDv1::GetParameterCpv2Emc(Int_t i, TString axis) const 
{
...
//____________________________________________________________________________
Float_t  IlcPVBARPIDv1::GetCpv2EmcDistanceCut(TString axis, Float_t e) const
{
...
//____________________________________________________________________________
Float_t  IlcPVBARPIDv1::GetEllipseParameter(TString particle, TString param, Float_t e) const 
{
...
Float_t  IlcPVBARPIDv1::GetParameterPhotonBoundary (Int_t i) const
{ 
...
//____________________________________________________________________________
Float_t  IlcPVBARPIDv1::GetParameterPi0Boundary (Int_t i) const
{ 
  // Get the parameter "i" to calculate the boundary on the moment M2x
  // for pi0 at high p_T
  Float_t param = 0;
...
//____________________________________________________________________________
Float_t  IlcPVBARPIDv1::GetParameterTimeGate(Int_t i) const
{
...
//_____________________________________________________________________________
Float_t  IlcPVBARPIDv1::GetParameterToCalculateEllipse(TString particle, TString param, Int_t i) const
{ 
...
//____________________________________________________________________________
Int_t  IlcPVBARPIDv1::GetCPVBit(IlcPVBARTrackSegment * ts, Int_t effPur, Float_t e) const
{
...
//____________________________________________________________________________
Int_t  IlcPVBARPIDv1::GetPrincipalBit(TString particle, const Double_t* p, Int_t effPur, Float_t e)const
{
...
//____________________________________________________________________________
Int_t  IlcPVBARPIDv1::GetHardPhotonBit(IlcPVBAREmcRecPoint * emc) const
{
...
//____________________________________________________________________________
Int_t  IlcPVBARPIDv1::GetHardPi0Bit(IlcPVBAREmcRecPoint * emc) const
{
...
//____________________________________________________________________________
TVector3 IlcPVBARPIDv1::GetMomentumDirection(IlcPVBAREmcRecPoint * emc, IlcPVBARCpvRecPoint * )const 
{ 
  ...
  Float_t x=local.X() ;
  Float_t z=local.Z() ;
  PVBARgeom->GetIncidentVector(vtxOld,emc->GetPVBARMod(),x,z,vInc) ;
  Float_t depthxOld = 0.;
  Float_t depthzOld = 0.;
  ...
  //Apply Real vertex
  PVBARgeom->GetIncidentVector(fVtx,emc->GetPVBARMod(),x,z,vInc) ;
  Float_t depthx = 0.;
  Float_t depthz = 0.;
  if (energy > 0 && vInc.Y()!=0.) {
  ...
  TVector3 dir(0,0,0) ; 
  PVBARgeom->Local2Global(emc->GetPVBARMod(),xd,zd,dir) ;
...
//________________________________________________________________________
Double_t  IlcPVBARPIDv1::LandauF(Double_t  x, Double_t y, Double_t * par)
{
  //Given the energy x and the parameter y (tof, shower dispersion or cpv-emc distance), 
...
//________________________________________________________________________
Double_t  IlcPVBARPIDv1::LandauPol2(Double_t  x, Double_t y, Double_t * par)
{
...
// //________________________________________________________________________
// Double_t  IlcPVBARPIDv1::ChargedHadronDistProb(Double_t  x, Double_t y, Double_t * parg, Double_t * parl)
// {
//   Double_t cnt   = 0.0 ;
//   Double_t mean  = 0.0 ;
//   Double_t sigma = 0.0 ;
...
void  IlcPVBARPIDv1::MakePID()
{
  ...
  while ( (ts = (IlcPVBARTrackSegment *)next()) ) {
    
    //cout<<">>>>>> Bayesian Index "<<index<<endl;

    IlcPVBAREmcRecPoint * emc = 0 ;
    if(ts->GetEmcIndex()>=0)
      emc = (IlcPVBAREmcRecPoint *) fEMCRecPoints->At(ts->GetEmcIndex()) ;
    
//    IlcPVBARCpvRecPoint * cpv = 0 ;
//    if(ts->GetCpvIndex()>=0)
//      cpv = (IlcPVBARCpvRecPoint *) cpvRecPoints->At(ts->GetCpvIndex()) ;
//    
////     Int_t track = 0 ; 
...
//     }
  ...
  for(index = 0 ; index < nparticles ; index ++) {
    ...
    IlcPVBARRecParticle * recpar = static_cast<IlcPVBARRecParticle *>(fRecParticles->At(index));
...
//____________________________________________________________________________
void  IlcPVBARPIDv1::MakeRecParticles()
{
  ...
  IlcPVBARTrackSegment * ts ; 
  Int_t index = 0 ; 
  IlcPVBARRecParticle * rp ; 
  while ( (ts = (IlcPVBARTrackSegment *)next()) ) {
    //  cout<<">>>>>>>>>>>>>>>PCA Index "<<index<<endl;
    new( (*fRecParticles)[index] ) IlcPVBARRecParticle() ;
    rp = (IlcPVBARRecParticle *)fRecParticles->At(index) ; 
    ...
    IlcPVBARCpvRecPoint * cpv = 0 ;
    if(ts->GetCpvIndex()>=0)
      cpv = (IlcPVBARCpvRecPoint *) fCPVRecPoints->At(ts->GetCpvIndex()) ;
    ...
    IlcPVBARTrackSegment * ts1  = static_cast<IlcPVBARTrackSegment *>(fTrackSegments->At(rp->GetPVBARTSIndex()));
    IlcPVBAREmcRecPoint  * erp = static_cast<IlcPVBAREmcRecPoint *>(fEMCRecPoints->At(ts1->GetEmcIndex()));
    TVector3 pos ; 
    fGeom->GetGlobalPVBAR(erp, pos) ; 
    rp->SetPos(pos);
    index++ ; 
  }
}
...
//____________________________________________________________________________
void  IlcPVBARPIDv1::Print(const Option_t *) const
{
  // Print the parameters used for the particle type identification

    IlcInfo("=============== IlcPVBARPIDv1 ================") ;
    printf("Making PID\n") ;
...
//____________________________________________________________________________
void IlcPVBARPIDv1::PrintRecParticles(Option_t * option)
{
  ...
  if(strstr(option,"all")) {  // printing found TS
    ...
    for (index = 0 ; index < fRecParticles->GetEntries() ; index++) {
      IlcPVBARRecParticle * rp = (IlcPVBARRecParticle * ) fRecParticles->At(index) ;       
      message += "\n" ;
...
//____________________________________________________________________________
void  IlcPVBARPIDv1::SetParameters() 
{
  ...
  fFileNamePrincipalPhoton = "$ILC_ROOT/PVBAR/PCA8pa15_0.5-100.root" ; 
  ...
  fFileNamePrincipalPi0    = "$ILC_ROOT/PVBAR/PCA_pi0_40-120.root" ;
  ...
  fFileNameParameters = gSystem->ExpandPathName("$ILC_ROOT/PVBAR/Parameters.dat");
...
//____________________________________________________________________________
void  IlcPVBARPIDv1::SetParameterCalibration(Int_t i,Float_t param) 
{
...
//____________________________________________________________________________
void  IlcPVBARPIDv1::SetParameterCpv2Emc(Int_t i, TString axis, Float_t cut) 
{
...
//____________________________________________________________________________
void  IlcPVBARPIDv1::SetParameterPhotonBoundary(Int_t i,Float_t param) 
{
...
//____________________________________________________________________________
void  IlcPVBARPIDv1::SetParameterPi0Boundary(Int_t i,Float_t param) 
{
...
//_____________________________________________________________________________
void  IlcPVBARPIDv1::SetParameterTimeGate(Int_t i, Float_t gate) 
{
...
//_____________________________________________________________________________
void  IlcPVBARPIDv1::SetParameterToCalculateEllipse(TString particle, TString param, Int_t i, Float_t par) 
{  
...
//____________________________________________________________________________
void IlcPVBARPIDv1::GetVertex(void)
