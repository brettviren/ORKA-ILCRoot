#ifndef ILCPVBARRECOPARAM_H
#define ILCPVBARRECOPARAM_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                          */

/* $Id: IlcPVBARRecoParam.h 53524 2011-12-11 21:34:35Z policheh $ */
...
class IlcPVBARRecoParam : public IlcDetectorRecoParam {

public:

  IlcPVBARRecoParam();
  IlcPVBARRecoParam(const IlcPVBARRecoParam& recoParam);
  IlcPVBARRecoParam& operator = (const IlcPVBARRecoParam& recoParam);
  virtual ~IlcPVBARRecoParam() {}
  ...
  static IlcPVBARRecoParam* GetDefaultParameters();
...
protected:
  ...
  Float_t fTimeGateLow ;           // EMC: Time difference between cells in PVBAR cluster (bad time estimate)
  Float_t fTimeGateHigh ;          // EMC: Time difference between cells in PVBAR cluster (good time estimate)
  ...
  TString fEMCFitterVersion ;      // EMC: IlcPVBARRawFitter version
  ...
  static TObject* fgkTrigParams;   // PVBAR trigger parameters

  ClassDef(IlcPVBARRecoParam,12)
};
