#ifndef IlcPVBARRecCpvManager_H
#define IlcPVBARRecCpvManager_H
...
class IlcPVBARRecCpvManager : public IlcPVBARRecManager {

 public: 

  IlcPVBARRecCpvManager();
  ~IlcPVBARRecCpvManager(void);
 ...
 private:
  ...
  ClassDef(IlcPVBARRecCpvManager,1)        // CPV reconstruction management class 

} ;

#endif // IlcPVBARRecCpvManager_H
