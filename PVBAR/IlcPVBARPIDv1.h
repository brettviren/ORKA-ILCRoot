#ifndef ILCPVBARPIDV1_H
#define ILCPVBARPIDV1_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVBARPIDv1.h 44091 2010-10-05 09:46:25Z prsnko $ */
...
class IlcPVBARTrackSegmentMakerv1 ;
#include "IlcPVBARPID.h"
#include "IlcPID.h"

class  IlcPVBARPIDv1 : public IlcPVBARPID {
  
public:
  
  IlcPVBARPIDv1() ;          // ctor   
  IlcPVBARPIDv1(IlcPVBARGeometry *geom);
  IlcPVBARPIDv1(const IlcPVBARPIDv1 & pid) ;          // cpy ctor            
  
  virtual ~IlcPVBARPIDv1() ; // dtor
  ...
  IlcPVBARPIDv1 & operator = (const IlcPVBARPIDv1 & /*pid*/) { return *this ;} 
...
private:
 ...
 // Relative Distance CPV-EMC
  Int_t   GetCPVBit       (IlcPVBARTrackSegment * ts, Int_t EffPur, Float_t e) const;
  Int_t   GetPrincipalBit (TString particle, const Double_t* P, Int_t EffPur, Float_t e)const ; //Principal cut
  Int_t   GetHardPhotonBit(IlcPVBAREmcRecPoint * emc) const;
  Int_t   GetHardPi0Bit   (IlcPVBAREmcRecPoint * emc) const;
  TVector3      GetMomentumDirection(IlcPVBAREmcRecPoint * emc, IlcPVBARCpvRecPoint * cpv)const ;
...
private:
  ...
  ClassDef( IlcPVBARPIDv1,13)  // Particle identifier implementation version 1

};

#endif // IlcPVBARPIDV1_H
