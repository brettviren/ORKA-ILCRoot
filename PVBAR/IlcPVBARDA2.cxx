#include "IlcPVBARDA2.h"
#include "TString.h"

ClassImp(IlcPVBARDA2)

//----------------------------------------------------------------
IlcPVBARDA2::IlcPVBARDA2(int module) : TNamed(),
 fHistoFile(0),fFiredCells(0),fMod(module)

{
  // Create IlcPVBARDA2 ("Bad channels finder") object.
  // module is the PVBAR module number (0..4).
  // Quality histogram names: module_iX_iZ_gain.
  // Root file name: PVBAR_ModuleX_BCM.root, where X - module number.
  
  char name[128];
  TString sname="PVBAR_Module%d_BCM";
  snprintf(name,sname.Length(),sname.Data(),fMod);
  SetName(name);

  SetTitle("Detector Algorithm to check for PVBAR channels quality");
...
//----------------------------------------------------------------
IlcPVBARDA2::IlcPVBARDA2(Int_t module, TObjArray* oldHistos) : TNamed(),
 fHistoFile(0),fFiredCells(0),fMod(module)
...
//-------------------------------------------------------------------
IlcPVBARDA2::IlcPVBARDA2(const IlcPVBARDA2& da) : TNamed(da),
...
//-------------------------------------------------------------------
IlcPVBARDA2& IlcPVBARDA2::operator= (const IlcPVBARDA2& da)
{
  //Assignment operator.
...
//-------------------------------------------------------------------
void IlcPVBARDA2::FillQualityHistograms(Float_t quality[64][56][2]) 
{
...
//-------------------------------------------------------------------
void  IlcPVBARDA2::FillFiredCellsHistogram(Int_t nCells)
{
  fFiredCells->Fill(nCells);
}

//-------------------------------------------------------------------
void IlcPVBARDA2::UpdateHistoFile()
{
