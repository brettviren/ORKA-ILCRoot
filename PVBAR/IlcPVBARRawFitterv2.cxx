...
ClassImp(IlcPVBARRawFitterv2)

//-----------------------------------------------------------------------------
IlcPVBARRawFitterv2::IlcPVBARRawFitterv2():
  IlcPVBARRawFitterv0(),
...
//-----------------------------------------------------------------------------
IlcPVBARRawFitterv2::IlcPVBARRawFitterv2(const IlcPVBARRawFitterv2 &PVBARFitter ):
...
//-----------------------------------------------------------------------------
IlcPVBARRawFitterv2& IlcPVBARRawFitterv2::operator = (const IlcPVBARRawFitterv2 & /*PVBARFitter*/)
{
  //Assignment operator.
  return *this;
}
...
//-----------------------------------------------------------------------------
Bool_t IlcPVBARRawFitterv2::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
  ...
  if(!FindAmpT(samples,times)){
    if(IlcLog::GetDebugLevel("PVBAR","IlcPVBARRawFitterv2")>3){
      goto plot ;
    }
    else{
      return kFALSE ;
...
//------------------------------------------------------------------
Bool_t IlcPVBARRawFitterv2::FindAmpT(TArrayD samples, TArrayD times){
// makes fit
...
void IlcPVBARRawFitterv2::FindMax(){
