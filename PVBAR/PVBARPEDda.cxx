...
reference run: /ilc/data/2010/LHC10a_PVBAR/000112189/raw/10000112189003.10.root
run type: PEDESTAL
DA type: MON 
...
int main(int argc, char **argv) 
{
  ...
  IlcRawReader * reader = NULL;
  IlcCaloRawStreamV3* stream = NULL;
  ...
  for(;;) {
    ...
    if (eventT==PHYSICS_EVENT) {
      ...
      reader = new IlcRawReaderDate((void*)event);
      stream =  new IlcCaloRawStreamV3(reader,"PVBAR",mapping);
  ...
  TString fileName = "PVBAR_PED.root";
