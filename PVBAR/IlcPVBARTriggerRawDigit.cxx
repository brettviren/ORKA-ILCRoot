...
ClassImp(IlcPVBARTriggerRawDigit)

IlcPVBARTriggerRawDigit::IlcPVBARTriggerRawDigit() : 
IlcDigitNew(),fMod(-1),fXIdx(-1),fZIdx(-1),fTRURow(-1),fBranch(-1)
{
  //Default constructor.
}

IlcPVBARTriggerRawDigit::IlcPVBARTriggerRawDigit(Int_t module, Int_t xIdx, Int_t zIdx, Int_t TRURow, Int_t branch, Int_t amp) :
  IlcDigitNew(),fMod(module),fXIdx(xIdx),fZIdx(zIdx),fTRURow(TRURow),fBranch(branch)
{
  fAmp = amp;
}

IlcPVBARTriggerRawDigit::IlcPVBARTriggerRawDigit(const IlcPVBARTriggerRawDigit & tdigit) :
...
IlcPVBARTriggerRawDigit& IlcPVBARTriggerRawDigit::operator=(const IlcPVBARTriggerRawDigit & tdigit)
{
  if (&tdigit != this) {
...
void IlcPVBARTriggerRawDigit::GetModXZ(Int_t& mod, Int_t& modX, Int_t& modZ)
{
