#ifndef ILCPVBARCLUSTERIZERV1_H
#define ILCPVBARCLUSTERIZERV1_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVBARClusterizerv1.h 43634 2010-09-17 09:17:08Z prsnko $ */

/* History of cvs commits:
 *
 * $Log: IlcPVBARClusterizerv1.h,v $
...
//  PVBARCpvRP (CPV RecPoints) and IlcPVBARClusterizer
//
...
class IlcPVBARClusterizerv1 : public IlcPVBARClusterizer {
  
public:
  
  IlcPVBARClusterizerv1() ;
  IlcPVBARClusterizerv1(IlcPVBARGeometry *geom);
  virtual ~IlcPVBARClusterizerv1()  ;

  void    InitParameters() ;
  
  virtual Int_t   AreNeighbours(IlcPVBARDigit * d1, IlcPVBARDigit * d2)const ; 
...
protected:
  ...
  virtual Bool_t IsInEmc (IlcPVBARDigit * digit)const ;     // Tells if id digit is in EMC
  virtual Bool_t IsInCpv (IlcPVBARDigit * digit)const ;     // Tells if id digit is in CPV
...
private:
  IlcPVBARClusterizerv1(const IlcPVBARClusterizerv1 & clu) ;
  IlcPVBARClusterizerv1 & operator = (const IlcPVBARClusterizerv1 & obj);

  Bool_t  FindFit(IlcPVBAREmcRecPoint * emcRP, IlcPVBARDigit ** MaxAt, Float_t * maxAtEnergy, 
		  Int_t NPar, Float_t * FitParametres) const; //Used in UnfoldClusters, calls TMinuit
  void    Init() ;

  virtual void   MakeUnfolding() ;
  void           UnfoldCluster(IlcPVBAREmcRecPoint * iniEmc,Int_t Nmax, 
		       IlcPVBARDigit ** maxAt,Float_t * maxAtEnergy ) ; //Unfolds cluster using TMinuit package
  void           PrintRecPoints(Option_t * option) ;

private:

  Bool_t  fDefaultInit;              //! Says if the task was created by defaut ctor (only parameters are initialized)
  Int_t   fEmcCrystals ;             // number of EMC cristals in PVBAR
  ...
  ClassDef(IlcPVBARClusterizerv1,8)   // Clusterizer implementation version 1

};

#endif // IlcPVBARCLUSTERIZERV1_H
