...
/* $Id: IlcPVBARRecEmcManager.cxx 48717 2011-03-24 15:51:37Z kharlov $ */
...
ClassImp(IlcPVBARRecEmcManager) 

//____________________________________________________________________________

IlcPVBARRecEmcManager::IlcPVBARRecEmcManager():
...
IlcPVBARRecEmcManager::~IlcPVBARRecEmcManager(void) {}

Float_t IlcPVBARRecEmcManager::Dispersion(Float_t ei) const
{
...
Float_t IlcPVBARRecEmcManager::OneGamChi2(Float_t ai, Float_t ei, Float_t, Float_t& gi) const
{
...
Float_t IlcPVBARRecEmcManager::TwoGamChi2(Float_t ai, Float_t ei, Float_t, Float_t& gi) const
{
  // calculates chi^2
  Float_t da = ai - ei;
  Float_t d = ei; // we assume that sigma(E) = sqrt(E)
...
void IlcPVBARRecEmcManager::AG(Float_t ei, Float_t xi, Float_t yi, Float_t& ai, Float_t& gxi, Float_t& gyi )
{
  ...
  // to the pad center.
  //Shape of the shower is from PVBAR TDR.
