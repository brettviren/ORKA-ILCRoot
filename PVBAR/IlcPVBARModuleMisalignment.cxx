...
ClassImp(IlcPVBARModuleMisalignment)
...
//______________________________________________________________________________
IlcPVBARModuleMisalignment::
IlcPVBARModuleMisalignment(const IlcPVBARGeometry & geom, Bool_t debug)
                            : fDebug(debug),
                              fAngles(),
                              fCenters(),
                              fModule(),
...
{
  //Ctor.
  //Extract ideal module transformations from IlcPVBARGeometry.
  ...
  fModule[0][2] = -22.61;//This number is hardcoded, IlcPVBARGeometry does not have it,
...
//______________________________________________________________________________
IlcPVBARModuleMisalignment::~IlcPVBARModuleMisalignment()
{
}

//______________________________________________________________________________
void IlcPVBARModuleMisalignment::
                    ...
                    const TString & name2, TGeoHMatrix * delta)
{
  ...
  if (!pt0 || !pt1 || !pt2) {
    Warning("IlcPVBARModuleData::DeltaTransformation",
...
//______________________________________________________________________________
void IlcPVBARModuleMisalignment::FindIdealModule(UInt_t module)
{
...
//______________________________________________________________________________
void IlcPVBARModuleMisalignment::FindRealModule(const IlcSurveyPoint * pt0, 
                                               const IlcSurveyPoint * pt1,
                                               const IlcSurveyPoint * pt2)
{
  //Real module - fV.
  //Survey is in millimeters.
  //IlcPVBARGeometry is in centimeters.
...
//______________________________________________________________________________
void IlcPVBARModuleMisalignment::FindDelta(TGeoHMatrix * delta)const
{
  ...
  */
  ...
  try {
    ...
    Error("IlcPVBARModuleMisalignment::FindDelta", 
