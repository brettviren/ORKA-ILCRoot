...
/* $Id: IlcPVBARPulseGenerator.cxx 54863 2012-02-28 12:10:29Z hristov $ */

// The class which simulates the pulse shape from the PVBAR FEE shaper,
// make sampled amplitudes, digitize them.
// Use case:
//   IlcPVBARPulseGenerator *pulse = new IlcPVBARPulseGenerator(energy,time);
...
ClassImp(IlcPVBARPulseGenerator) 

Int_t    IlcPVBARPulseGenerator::fgOrder       = 2 ;        // order of the Gamma function
Double_t IlcPVBARPulseGenerator::fgTimePeak    = 2.1E-6 ;   // tau=2.1 micro seconds
Double_t IlcPVBARPulseGenerator::fgTimeTrigger = 100E-9 ;   // one tick 100 ns

//-----------------------------------------------------------------------------
IlcPVBARPulseGenerator::IlcPVBARPulseGenerator(Double_t a, Double_t t0)
...
//-----------------------------------------------------------------------------
IlcPVBARPulseGenerator::~IlcPVBARPulseGenerator()
{
...
//-----------------------------------------------------------------------------
void IlcPVBARPulseGenerator::Reset()
{
...
//-----------------------------------------------------------------------------
void IlcPVBARPulseGenerator::AddBaseline(Double_t baselineLevel)
{
...
//-----------------------------------------------------------------------------
void IlcPVBARPulseGenerator::AddNoise(Double_t sigma)
{
...
//-----------------------------------------------------------------------------
void IlcPVBARPulseGenerator::AddNoise(Double_t * /* sigma */, Double_t /* cutoff */)
{
...
//-----------------------------------------------------------------------------
void IlcPVBARPulseGenerator::AddPretriggerSamples(Int_t nPresamples)
{
...
//-----------------------------------------------------------------------------
void IlcPVBARPulseGenerator::Digitize()
{
...
//-----------------------------------------------------------------------------
Double_t IlcPVBARPulseGenerator::RawResponseFunction(Double_t *x, Double_t *par) 
{
...
Bool_t IlcPVBARPulseGenerator::MakeSamples()
{
  // for a start time fTZero and an amplitude fAmplitude given by digit, 
  // calculates the raw sampled response IlcPVBARPulseGenerator::RawResponseFunction
...
//__________________________________________________________________
void IlcPVBARPulseGenerator::GetSamples(Int_t *adcHG, Int_t *adcLG) const
{
...
//__________________________________________________________________
void IlcPVBARPulseGenerator::Print(Option_t*) const
{
...
//__________________________________________________________________
void IlcPVBARPulseGenerator::Draw(Option_t* opt)
{
