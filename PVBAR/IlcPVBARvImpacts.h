#ifndef ILCPVBARVIMPACTS_H
#define ILCPVBARVIMPACTS_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVBARvImpacts.h 15830 2006-11-14 17:11:17Z hristov $ */
...
class IlcPVBARvImpacts : public IlcPVBARv1 {

public:

  IlcPVBARvImpacts(void) ;
  IlcPVBARvImpacts(const char *name, const char *title="") ;
  virtual ~IlcPVBARvImpacts(void) ;
...
protected:
 ...
 private:
  IlcPVBARvImpacts(IlcPVBARvImpacts & PVBAR);
  IlcPVBARvImpacts & operator = (const IlcPVBARvImpacts & /*rvalue*/);

  ClassDef(IlcPVBARvImpacts,1)  // Implementation of PVBAR manager class for layout EMC+PPSD

};

#endif // IlcPVBARVIMPACTS_H
