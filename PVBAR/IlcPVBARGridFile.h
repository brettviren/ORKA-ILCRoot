#ifndef ILCPVBARGRIDFILE_H
#define ILCPVBARGRIDFILE_H
...
class IlcPVBARGridFile : public TObject {

 public:
  
  IlcPVBARGridFile(TString grid="alien") ; 
  IlcPVBARGridFile(const IlcPVBARGridFile & lfn);
  
  virtual ~IlcPVBARGridFile(void) ; 
  ...
  IlcPVBARGridFile & operator = (const IlcPVBARGridFile & /*rvalue*/)  {
...
private:
  ...
  ClassDef(IlcPVBARGridFile,1)  
};

#endif // IlcPVBARGRIDFILE_H
