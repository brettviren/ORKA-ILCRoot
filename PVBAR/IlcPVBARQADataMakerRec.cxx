...
/* $Id: IlcPVBARQADataMakerRec.cxx 57196 2012-06-15 08:08:57Z hristov $ */
...
ClassImp(IlcPVBARQADataMakerRec)
           
//____________________________________________________________________________ 
  IlcPVBARQADataMakerRec::IlcPVBARQADataMakerRec() : 
  IlcQADataMakerRec(IlcQAv1::GetDetName(IlcQAv1::kPVBAR), "PVBAR Quality Assurance Data Maker")
{
  // ctor
}

//____________________________________________________________________________ 
IlcPVBARQADataMakerRec::IlcPVBARQADataMakerRec(const IlcPVBARQADataMakerRec& qadm) :
  IlcQADataMakerRec()
{
  //copy ctor 
...
IlcPVBARQADataMakerRec& IlcPVBARQADataMakerRec::operator = (const IlcPVBARQADataMakerRec& qadm )
{
  // Equal operator.
  this->~IlcPVBARQADataMakerRec();
  new(this) IlcPVBARQADataMakerRec(qadm);
  return *this;
}
 
//____________________________________________________________________________ 
void IlcPVBARQADataMakerRec::EndOfDetectorCycle(IlcQAv1::TASKINDEX_t task, TObjArray ** list)
{
...
//____________________________________________________________________________ 
void IlcPVBARQADataMakerRec::InitESDs()
{
  ...
  TH1F * h1 = new TH1F("hESDPVBARSpectrum",  "ESDs spectrum in PVBAR; Energy [MeV];Counts"                ,  200, 0.,   20.) ;
  h1->Sumw2() ;
  Add2ESDsList(h1, kESDSpec, !expert, image)  ;

  TH1I * h2 = new TH1I("hESDPVBARMul",       "ESDs multiplicity distribution in PVBAR; # of clusters;Counts", 100, 0,   100 ) ; 
  h2->Sumw2() ;
  Add2ESDsList(h2, kESDNtot, !expert, image) ;
 
  TH1F * h3 = new TH1F("hESDPVBAREtot",      "ESDs total energy;Energy [MeV];Counts"                     , 2000, 0,  200.) ; 
  h3->Sumw2() ;
  Add2ESDsList(h3, kESDEtot, !expert, image) ;  //Expert histo
 
  TH1F * h4 = new TH1F("hESDpid",           "ESDs PID distribution in PVBAR;Particle Id;Counts"         , 100, 0.,    1.) ;
  h4->Sumw2() ;
...
//____________________________________________________________________________ 
void IlcPVBARQADataMakerRec::InitDigits()
{
...
//____________________________________________________________________________ 
void IlcPVBARQADataMakerRec::InitRecPoints()
{
  // create Reconstructed Points histograms in RecPoints subdir
  const Bool_t expert   = kTRUE ; 
  const Bool_t image    = kTRUE ; 
  
  TH2I * h0 = new TH2I("hRpPVBARxyMod1","RecPoints Rows x Columns for PVBAR module 1;Row #;Column #", 64, -72., 72., 56, -63., 63.) ;                             
  Add2RecPointsList(h0,kRPmod1, expert, !image) ;
  TH2I * h1 = new TH2I("hRpPVBARxyMod2","RecPoints Rows x Columns for PVBAR module 2;Row #;Column #", 64, -72., 72., 56, -63., 63.) ;                             
  Add2RecPointsList(h1,kRPmod2, expert, !image) ;
  TH2I * h2 = new TH2I("hRpPVBARxyMod3","RecPoints Rows x Columns for PVBAR module 3;Row #;Column #", 64, -72., 72., 56, -63., 63.) ;                             
  Add2RecPointsList(h2,kRPmod3, expert, !image) ;
  TH2I * h3 = new TH2I("hRpPVBARxyMod4","RecPoints Rows x Columns for PVBAR module 4;Row #;Column #", 64, -72., 72., 56, -63., 63.) ;                             
  Add2RecPointsList(h3,kRPmod4, expert, !image) ;
  TH2I * h4 = new TH2I("hRpPVBARxyMod5","RecPoints Rows x Columns for PVBAR module 5;Row #;Column #", 64, -72., 72., 56, -63., 63.) ;                             
  Add2RecPointsList(h4,kRPmod5, expert, !image) ;
 
  TH1F * h5 = new TH1F("hEmcPVBARRecPointsSpectrum",  "EMC RecPoints spectrum in PVBAR;Energy [MeV];Counts",   2000, 0., 20.) ; 
  h5->Sumw2() ;
  Add2RecPointsList(h5, kRPSpec, !expert, image)  ;

  TH1I * h6 = new TH1I("hEmcPVBARRecPointsMul", "EMC RecPoints multiplicity distribution in PVBAR;# of EMC Clusters;Entries", 100, 0,  100) ; 
  h6->Sumw2() ;
  Add2RecPointsList(h6, kRPNtot, !expert, image) ;

  TH1I * h7 = new TH1I("hEmcPVBARRecPointsEtot", "EMC RecPoints Etot;Energy [MeV];Counts", 200, 0,  200.) ; 
  h7->Sumw2() ;
  Add2RecPointsList(h7, kRPEtot, !expert, image) ;

  TH1I * h8 = new TH1I("hCpvPVBARRecPointsMul", "CPV RecPoints multiplicity distribution in PVBAR;# of CPV clusters;Counts", 100, 0,  100) ; 
  h8->Sumw2() ;
...
//____________________________________________________________________________ 
void IlcPVBARQADataMakerRec::InitRaws()
{
  ...
  TH2I * h0 = new TH2I("hHighPVBARxyMod0","High Gain in PVBAR module 0", 64, 0, 64, 56, 0, 56) ;
  h0->SetXTitle("x, cells"); h0->SetYTitle("z, cells");
  Add2RawsList(h0,kHGmod0, expert, !image, !saveCorr) ;
  TH2I * h1 = new TH2I("hHighPVBARxyMod1","High Gain in PVBAR module 1", 64, 0, 64, 56, 0, 56) ;
  h1->SetXTitle("x, cells"); h1->SetYTitle("z, cells");
  Add2RawsList(h1,kHGmod1, expert, !image, !saveCorr) ;
  TH2I * h2 = new TH2I("hHighPVBARxyMod2","High Gain in PVBAR module 2", 64, 0, 64, 56, 0, 56) ;
  h2->SetXTitle("x, cells"); h2->SetYTitle("z, cells");
  Add2RawsList(h2,kHGmod2, expert, !image, !saveCorr) ;
  TH2I * h3 = new TH2I("hHighPVBARxyMod3","High Gain in PVBAR module 3", 64, 0, 64, 56, 0, 56) ;
  h3->SetXTitle("x, cells"); h3->SetYTitle("z, cells");
  Add2RawsList(h3,kHGmod3, expert, !image, !saveCorr) ;
  TH2I * h4 = new TH2I("hHighPVBARxyMod4","High Gain in PVBAR module 4", 64, 0, 64, 56, 0, 56) ;
  h4->SetXTitle("x, cells"); h4->SetYTitle("z, cells");
  Add2RawsList(h4,kHGmod4, expert, !image, !saveCorr) ;

  TH2I * h5 = new TH2I("hLowPVBARxyMod0","Low Gain in PVBAR module 0", 64, 0, 64, 56, 0, 56) ;
  h5->SetXTitle("x, cells"); h5->SetYTitle("z, cells");
  Add2RawsList(h5,kLGmod0, expert, !image, !saveCorr) ;
  TH2I * h6 = new TH2I("hLowPVBARxyMod1","Low Gain in PVBAR module 1", 64, 0, 64, 56, 0, 56) ;
  h6->SetXTitle("x, cells"); h6->SetYTitle("z, cells");
  Add2RawsList(h6,kLGmod1, expert, !image, !saveCorr) ;
  TH2I * h7 = new TH2I("hLowPVBARxyMod2","Low Gain in PVBAR module 2", 64, 0, 64, 56, 0, 56) ;
  h7->SetXTitle("x, cells"); h7->SetYTitle("z, cells");
  Add2RawsList(h7,kLGmod2, expert, !image, !saveCorr) ;
  TH2I * h8 = new TH2I("hLowPVBARxyMod3","Low Gain in PVBAR module 3", 64, 0, 64, 56, 0, 56) ;
  h8->SetXTitle("x, cells"); h8->SetYTitle("z, cells");
  Add2RawsList(h8,kLGmod3, expert, !image, !saveCorr) ;
  TH2I * h9 = new TH2I("hLowPVBARxyMod4","Low Gain in PVBAR module 4", 64, 0, 64, 56, 0, 56) ;
  h9->SetXTitle("x, cells"); h9->SetYTitle("z, cells");
  Add2RawsList(h9,kLGmod4, expert, !image, !saveCorr) ;

  TH1I * h10 = new TH1I("hLowPVBARModules",    "Low Gain Hits in EMCA PVBAR modules", 5, 0, 5) ;
  h10->SetXTitle("Module number");
  Add2RawsList(h10, kNmodLG, !expert, image, !saveCorr) ;
  TH1I * h11 = new TH1I("hHighPVBARModules",   "High Gain Hits in EMCA PVBAR modules",5, 0, 5) ;
  h11->SetXTitle("Module number");
  Add2RawsList(h11, kNmodHG, !expert, image, !saveCorr) ;

  TH1I * h11_RCU = new TH1I("hHighPVBARRCU",   "PVBAR RCU occupancy with HG channels",12, 0, 12) ;
  h11_RCU->SetXTitle("RCU number");
  Add2RawsList(h11_RCU, kNRCUHG, expert, image, !saveCorr) ;
  TH1F * h11_RCUnorm = new TH1F("hHighPVBARRCUnorm",   "PVBAR RCU normalized occupancy with HG channels",12, 0, 12) ;
  ...
  TH1F * h12 = new TH1F("hLowPVBARRawtime" , "Low Gain Time of raw hits in PVBAR" , 500, -50., 200.) ;
  h12->SetXTitle("Time [samples]");
  h12->Sumw2() ;
  Add2RawsList(h12, kLGtime, expert, !image, !saveCorr) ;
  TH1F * h13 = new TH1F("hHighPVBARRawtime", "High Gain Time of raw hits in PVBAR", 500, -50., 200.) ;
  h13->SetXTitle("Time [samples]");
  h13->Sumw2() ;
  Add2RawsList(h13, kHGtime, expert, !image, !saveCorr) ;

  TH1F * h14 = new TH1F("hLowPVBARRawEnergy" , "Low Gain Energy of raw hits in PVBAR" , 512, 0., 1024.) ;
  h14->SetXTitle("Energy [ADC counts]");
  h14->Sumw2() ;
  Add2RawsList(h14, kSpecLG, !expert, image, !saveCorr) ;
  TH1F * h15 = new TH1F("hHighPVBARRawEnergy", "High Gain Energy of raw hits in PVBAR", 512, 0., 1024.) ;
  h15->SetXTitle("Energy [ADC counts]");
  h15->Sumw2() ;
  Add2RawsList(h15, kSpecHG, !expert, image, !saveCorr) ;

  TH1F * h16 = new TH1F("hLowNtot" , "Low Gain Total Number of raw hits in PVBAR" , 500, 0., 5000.) ;
  h16->SetXTitle("Number of hits");
  h16->Sumw2() ;
  Add2RawsList(h16, kNtotLG, !expert, image, saveCorr) ;
  TH1F * h17 = new TH1F("hHighNtot", "High Gain Total Number of raw hits in PVBAR", 500, 0., 5000.) ;
  ...
  TH1F * h18 = new TH1F("hLowEtot" , "Low Gain Total Energy of raw hits in PVBAR" , 500, 0., 100000.) ;
  h18->SetXTitle("Energy [ADC counts]");
  h18->Sumw2() ;
  Add2RawsList(h18, kEtotLG, !expert, image, saveCorr) ;
  TH1F * h19 = new TH1F("hHighEtot", "High Gain Total Energy of raw hits in PVBAR", 500, 0., 100000.) ;
...
//____________________________________________________________________________
void IlcPVBARQADataMakerRec::MakeESDs(IlcESDEvent * esd)
{
...
//____________________________________________________________________________
void IlcPVBARQADataMakerRec::MakeRaws(IlcRawReader* rawReader)
{
  ...
  IlcCaloRawStreamV3 fRawStream(rawReader,"PVBAR",mapping);
...
//____________________________________________________________________________
void IlcPVBARQADataMakerRec::MakeDigits()
{
...
//____________________________________________________________________________
void IlcPVBARQADataMakerRec::MakeDigits(TTree * digitTree)
{
...
//____________________________________________________________________________
void IlcPVBARQADataMakerRec::MakeRecPoints(TTree * clustersTree)
{
  {
    ...
    Double_t eTot = 0. ; 
    while ( (rp = static_cast<IlcPVBAREmcRecPoint *>(next())) ) {
      FillRecPointsData(kRPSpec, rp->GetEnergy()) ;
      Int_t mod = rp->GetPVBARMod() ;
      TVector3 pos ;
...
//____________________________________________________________________________ 
void IlcPVBARQADataMakerRec::StartOfDetectorCycle()
{
