 ...
 **************************************************************************/
/* $Id: IlcPVBARGridFile.cxx 47780 2011-02-24 15:37:59Z kharlov $ */
...
ClassImp(IlcPVBARGridFile)

//____________________________________________________________________________
IlcPVBARGridFile::IlcPVBARGridFile(TString grid):
  fGrid(0),
  ...
  fPath("")
{
  ...
  if (grid == "alien")
    ...
    Error("IlcPVBARGridFile", " %s is an unknown grid system", grid.Data()) ;
  if ( !fGrid )
...
#else
  Error("IlcPVBARGridFile", "needs to be ported to new TGrid");
#endif
...
//____________________________________________________________________________
IlcPVBARGridFile::IlcPVBARGridFile(const IlcPVBARGridFile &rhs) :
  TObject(rhs),
  fGrid(0),
  fRoot(""),
  fYear(""),
...
//____________________________________________________________________________
IlcPVBARGridFile::~IlcPVBARGridFile()
{
}

//____________________________________________________________________________
TString IlcPVBARGridFile::GetLFN() const
{
...
//____________________________________________________________________________
void IlcPVBARGridFile::Copy(TObject & obj)const
{
  //Copy method used by the Copy ctor
  IlcPVBARGridFile &lfn = static_cast<IlcPVBARGridFile &>(obj);
...
//____________________________________________________________________________
void IlcPVBARGridFile::ListEvents() const
{
...
//____________________________________________________________________________
void IlcPVBARGridFile::ListRuns() const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARGridFile::SetYearProd(TString year, TString prod)
{
...
//____________________________________________________________________________
Bool_t IlcPVBARGridFile::SetVers(TString vers)
{
  // set the year and verifies if the directory exists
  Bool_t rv = kFALSE ;
  char tempo[80] ;
...
//____________________________________________________________________________
Bool_t IlcPVBARGridFile::SetType(TString type)
{
  // set the year and verifies if the directory exists
  Bool_t rv = kFALSE ;
  char tempo[80] ;
...
//____________________________________________________________________________
Bool_t IlcPVBARGridFile::SetPath(TString year, TString prod, TString vers, TString type)
{
  // set the year and verifies if the directory exists
  Bool_t rv = kFALSE ;
  char tempo[80] ;
...
//____________________________________________________________________________
Bool_t IlcPVBARGridFile::SetRun(Int_t run)
{
  // set the year and verifies if the directory exists
  Bool_t rv = kFALSE ;
...
//____________________________________________________________________________
Bool_t IlcPVBARGridFile::SetEvt(Int_t evt)
{
  // set the year and verifies if the directory exists
  Bool_t rv = kFALSE ;
