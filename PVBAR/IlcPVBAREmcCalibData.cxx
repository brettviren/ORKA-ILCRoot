...
///////////////////////////////////////////////////////////////////////////////
//                                                                           //
// class for PVBAR EmCal calibration                                          //
//                                                                           //
///////////////////////////////////////////////////////////////////////////////

#include "IlcPVBAREmcCalibData.h"

ClassImp(IlcPVBAREmcCalibData)

//________________________________________________________________
IlcPVBAREmcCalibData::IlcPVBAREmcCalibData():
  TNamed(),
  fSampleTimeStep(0)
{
  // Default constructor
...
//________________________________________________________________
IlcPVBAREmcCalibData::IlcPVBAREmcCalibData(const char* name):
  TNamed(),
  fSampleTimeStep(0)
{
  // Constructor
...
//________________________________________________________________
IlcPVBAREmcCalibData::IlcPVBAREmcCalibData(const IlcPVBAREmcCalibData& calibda) :
  TNamed(calibda),
...
//________________________________________________________________
IlcPVBAREmcCalibData &IlcPVBAREmcCalibData::operator =(const IlcPVBAREmcCalibData& calibda)
{
  // assignment operator
...
//________________________________________________________________
void IlcPVBAREmcCalibData::Reset()
{
...
//________________________________________________________________
void  IlcPVBAREmcCalibData::Print(Option_t *option) const
{
...
//________________________________________________________________
Float_t IlcPVBAREmcCalibData::GetADCchannelEmc(Int_t module, Int_t column, Int_t row) const
{
...
//________________________________________________________________
Float_t IlcPVBAREmcCalibData::GetADCpedestalEmc(Int_t module, Int_t column, Int_t row) const
{
  //Return EMC pedestal
  //module, column,raw should follow the internal PVBAR convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
Float_t IlcPVBAREmcCalibData::GetHighLowRatioEmc(Int_t module, Int_t column, Int_t row) const
{
  //Return EMC pedestal
  //module, column,raw should follow the internal PVBAR convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
Float_t IlcPVBAREmcCalibData::GetTimeShiftEmc(Int_t module, Int_t column, Int_t row) const
{
  //Return EMC pedestal
  //module, column,raw should follow the internal PVBAR convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
Float_t IlcPVBAREmcCalibData::GetSampleTimeStep()const
{
...
//________________________________________________________________
Int_t IlcPVBAREmcCalibData::GetAltroOffsetEmc(Int_t module, Int_t column, Int_t row) const
{
...
//________________________________________________________________
void IlcPVBAREmcCalibData::SetADCchannelEmc(Int_t module, Int_t column, Int_t row, Float_t value)
{
...
//________________________________________________________________
void IlcPVBAREmcCalibData::SetADCpedestalEmc(Int_t module, Int_t column, Int_t row, Float_t value)
{
  //Set EMC pedestal
  //module, column,raw should follow the internal PVBAR convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
void IlcPVBAREmcCalibData::SetHighLowRatioEmc(Int_t module, Int_t column, Int_t row, Float_t value)
{
  //Set EMC pedestal
  //module, column,raw should follow the internal PVBAR convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
void IlcPVBAREmcCalibData::SetTimeShiftEmc(Int_t module, Int_t column, Int_t row, Float_t value)
{
  //Set EMC pedestal
  //module, column,raw should follow the internal PVBAR convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
void IlcPVBAREmcCalibData::SetAltroOffsetEmc(Int_t module, Int_t column, Int_t row, Int_t value)
{
  //Set EMC pedestal
  //module, column,raw should follow the internal PVBAR convention:
  //module 1:5, column 1:56, row 1:64
...
//________________________________________________________________
void IlcPVBAREmcCalibData::SetSampleTimeStep(Float_t step)
{
...
//________________________________________________________________
Float_t IlcPVBAREmcCalibData::GetADCchannelEmcDecalib(Int_t module, Int_t column, Int_t row) const
{
...
void IlcPVBAREmcCalibData::SetADCchannelEmcDecalib(Int_t module, Int_t column, Int_t row, Float_t value)
{
