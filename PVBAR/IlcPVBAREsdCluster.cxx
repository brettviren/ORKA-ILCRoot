...
//  IlcESDCaloCluster extension for PVBAR to recalculate cluster 
...
ClassImp(IlcPVBAREsdCluster)

//____________________________________________________________________________
IlcPVBAREsdCluster::IlcPVBAREsdCluster() : 
  IlcESDCaloCluster(),fRecalibrated(0)
{
  // ctor
}
//____________________________________________________________________________
IlcPVBAREsdCluster::IlcPVBAREsdCluster(const IlcESDCaloCluster & clu) : 
...
//____________________________________________________________________________
void IlcPVBAREsdCluster::Recalibrate(IlcPVBARCalibData * calibData,IlcESDCaloCells *phsCells){
  ...
  for(Int_t i=0; i<fNCells; i++){
    Int_t relId[4];
    PVBARgeom->AbsToRelNumbering(fCellsAbsId[i],relId) ;
...
//____________________________________________________________________________
void  IlcPVBAREsdCluster::EvalAll(Float_t logWeight, TVector3 &vtx){
...
//____________________________________________________________________________
void IlcPVBAREsdCluster::EvalEnergy(){
...
//____________________________________________________________________________
void IlcPVBAREsdCluster::EnergyCorrection(){
  //apply nonlinearity correction 
  fEnergy = IlcPVBARReconstructor::CorrectNonlinearity(fEnergy) ;
}
//____________________________________________________________________________
void IlcPVBAREsdCluster::EvalPID(IlcPVBARPIDv1 * /*pid*/){           
...
//____________________________________________________________________________
void IlcPVBAREsdCluster::EvalCoord(Float_t logWeight, TVector3 &vtx)
{
  ...
  for(Int_t iDigit=0; iDigit<fNCells; iDigit++) {
    Float_t xi ;
    Float_t zi ;
    PVBARgeom->AbsToRelNumbering(fCellsAbsId[iDigit], relid) ;
