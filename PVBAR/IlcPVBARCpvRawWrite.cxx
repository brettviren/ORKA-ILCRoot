...
#include "IlcPVBARCpvRawWrite.h"
#include "IlcPVBARDigit.h"
#include "IlcPVBARGeometry.h"

ClassImp(IlcPVBARCpvRawWrite)

//____________________________________________________________________________
IlcPVBARCpvRawWrite::IlcPVBARCpvRawWrite() : 
  TObject(),
  fNDDL(5),
  fNRow(16),
  fNDilogic(10),
...
//____________________________________________________________________________
void IlcPVBARCpvRawWrite::WriteRaw(const TObjArray *pDigAll)
{
...
// Returns: none
  ...
  if (!(geom = IlcPVBARGeometry::GetInstance())) 
        geom = IlcPVBARGeometry::GetInstance("IHEP","");
  ...
  for(Int_t iCh=0;iCh<fNDDL;iCh++){//chambers loop
    ...
    for(Int_t iDig=0;iDig<pDigCh->GetEntriesFast();iDig++){//digits loop
      IlcPVBARDigit *pDig1=(IlcPVBARDigit*)pDigCh->At(iDig);
	...
	cntLpad=0;
	  ...
	  if (isDigThere[iCh][row][dil][pad]!=-1) {
	    IlcPVBARDigit *pDig=(IlcPVBARDigit*)pDigCh->At(isDigThere[iCh][row][dil][pad]);             
...
//____________________________________________________________________________
void IlcPVBARCpvRawWrite::HWaddress(const IlcPVBARDigit *digit, 
				   UInt_t &w32, Int_t &ddl, Int_t &row, Int_t &dilogic, Int_t &address)
{
// Convert IlcPVBARDigit to raw word format
...
//____________________________________________________________________________
void IlcPVBARCpvRawWrite::WriteEoE(IlcFstream *ddl,UInt_t row,UInt_t dil,UInt_t wordCnt  )
{
...
//____________________________________________________________________________
void IlcPVBARCpvRawWrite::WriteRowMarker(IlcFstream *ddl,UInt_t size)
{
...
//____________________________________________________________________________
void IlcPVBARCpvRawWrite::WriteSegMarker(IlcFstream *ddl,UInt_t row, Int_t nwInSeg)
{
