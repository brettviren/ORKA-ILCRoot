...
/* $Id: IlcPVBARFastRecParticle.cxx 53186 2011-11-25 14:28:01Z kharlov $ */
...
//  A  Particle modified by PVBAR response and produced by IlcPVBARvFast
//  To become a general class of IlcRoot ?    
//--
//  This is also a base class for IlcPVBARRecParticle produced by IlcPVBARPIDv1
//  The rec.particle type is to be defined by IlcPVBARvFast or IlcPVBARPIDv1
//--
...
ClassImp(IlcPVBARFastRecParticle) 

//____________________________________________________________________________
IlcPVBARFastRecParticle::IlcPVBARFastRecParticle() :
  fIndexInList(0),
  fTof(0.f),
  fType(0)
{
...
//____________________________________________________________________________
 IlcPVBARFastRecParticle::IlcPVBARFastRecParticle(const IlcPVBARFastRecParticle & rp)
   : TParticle(rp),
...
//____________________________________________________________________________
 IlcPVBARFastRecParticle::IlcPVBARFastRecParticle(const TParticle & pp) :
   fIndexInList(0),
   fTof(0.f),
   fType(0)
{
  ...
  IlcPVBARFastRecParticle & p = (IlcPVBARFastRecParticle &)(pnoconst) ;
  fPdgCode     = p.fPdgCode;
...
//____________________________________________________________________________
IlcPVBARFastRecParticle & IlcPVBARFastRecParticle::operator = (const IlcPVBARFastRecParticle &)
{
...
//____________________________________________________________________________
Int_t IlcPVBARFastRecParticle::DistancetoPrimitive(Int_t px, Int_t py)
{
  //  Compute distance from point px,py to a IlcPVBARFastRecParticle considered as a Tmarker
...
//___________________________________________________________________________
 void IlcPVBARFastRecParticle::Draw(Option_t *option)
 {
   // Draw this IlcPVBARFastRecParticle with its current attributes
    
   AppendPad(option);
 }

//______________________________________________________________________________
void IlcPVBARFastRecParticle::ExecuteEvent(Int_t event, Int_t , Int_t )
{
  //  Execute action corresponding to one event
  //  This member function is called when a IlcPVBARFastRecParticle is clicked with the locator
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsPhoton(TString purity) const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsPi0(TString purity) const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsElectron(TString purity) const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsEleCon(TString purity) const
{
  // Rec.Particle is an electron if it has a photon-like shape, fast and charged
  // photon-like shape is defined with a purity "low", "medium" or "high"
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsHardPhoton() const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsHardPi0() const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsChargedHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsNeutralHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsFastChargedHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsSlowChargedHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsFastNeutralHadron() const
{
...
//____________________________________________________________________________
Bool_t IlcPVBARFastRecParticle::IsSlowNeutralHadron() const
{
  // Rec.Particle is a slow neutral hadron if it does not look like
  // a low-purity photon nor low-purity pi0, is high-purity neutral
  // and is not high-purity fast
...
//____________________________________________________________________________
TString IlcPVBARFastRecParticle::Name() const
{
...
//______________________________________________________________________________
void IlcPVBARFastRecParticle::SetType(Int_t type) { 
...
//______________________________________________________________________________
void IlcPVBARFastRecParticle::Paint(Option_t *)
{
...
//____________________________________________________________________________
void IlcPVBARFastRecParticle::Print(const Option_t *)const
{
