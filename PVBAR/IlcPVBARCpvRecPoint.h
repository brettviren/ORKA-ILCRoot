#ifndef ILCPVBARCPVRECPOINT_H
#define ILCPVBARCPVRECPOINT_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVBARCpvRecPoint.h 25982 2008-05-20 20:27:07Z kharlov $ */
...
class IlcPVBARCpvRecPoint : public IlcPVBAREmcRecPoint  {

public:

  IlcPVBARCpvRecPoint() ;
  IlcPVBARCpvRecPoint(const char * opt) ;

  virtual ~IlcPVBARCpvRecPoint() ;  
 ...
 protected:
  ...
  Bool_t AreNeighbours(IlcPVBARDigit * digit1, IlcPVBARDigit * digit2 ) const ;

  Int_t    fLengX ;          // cluster length along x
  Int_t    fLengZ ;          // cluster length along z
  
  ClassDef(IlcPVBARCpvRecPoint,1)  // CPV RecPoint (cluster)

};

#endif // IlcPVBARCPVRECPOINT_H
