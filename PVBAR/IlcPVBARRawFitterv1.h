#ifndef ILCPVBARRAWFITTERV1_H
#define ILCPVBARRAWFITTERV1_H
...
class IlcPVBARRawFitterv1 : public IlcPVBARRawFitterv0 {

public:

  IlcPVBARRawFitterv1();
  IlcPVBARRawFitterv1(const IlcPVBARRawFitterv1& rawFitter);
  IlcPVBARRawFitterv1& operator = (const IlcPVBARRawFitterv1& rawFitter);
  virtual ~IlcPVBARRawFitterv1();
...
private:
  ClassDef(IlcPVBARRawFitterv1,1)
};
