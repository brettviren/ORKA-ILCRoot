#ifndef ILCPVBARFASTRECPARTICLE_H
#define ILCPVBARFASTRECPARTICLE_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcPVBARFastRecParticle.h 53186 2011-11-25 14:28:01Z kharlov $ */
...
class IlcPVBARFastRecParticle : public TParticle {
  
 public:
  
  IlcPVBARFastRecParticle() ;
  
  IlcPVBARFastRecParticle(const IlcPVBARFastRecParticle & rp) ;  // ctor
  IlcPVBARFastRecParticle(const TParticle & p) ;  // ctor
  virtual ~IlcPVBARFastRecParticle(){ } //dtor
  IlcPVBARFastRecParticle & operator = (const IlcPVBARFastRecParticle & /*rp*/);
 ...
 private:
  ...
  ClassDef(IlcPVBARFastRecParticle,2)  // Reconstructed Particle produced by the fast simulation 

};

#endif // IlcPVBARFASTRECPARTICLE_H
