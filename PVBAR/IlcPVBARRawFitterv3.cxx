...
ClassImp(IlcPVBARRawFitterv3)

//-----------------------------------------------------------------------------
IlcPVBARRawFitterv3::IlcPVBARRawFitterv3():
  IlcPVBARRawFitterv0()
{
  //Default constructor.
}
...
//-----------------------------------------------------------------------------
IlcPVBARRawFitterv3::IlcPVBARRawFitterv3(const IlcPVBARRawFitterv3 &PVBARFitter ):
...
//-----------------------------------------------------------------------------
IlcPVBARRawFitterv3& IlcPVBARRawFitterv3::operator = (const IlcPVBARRawFitterv3 & /*PVBARFitter*/)
{
  //Assignment operator.
  return *this;
}
...
//-----------------------------------------------------------------------------
Bool_t IlcPVBARRawFitterv3::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
...
//      IlcWarning(Form("Can not read data from OCDB")) ;
  ...
  if(a==0.){
    if(b==0.){ //no roots
      fQuality = 2000. ;
      if(IlcLog::GetDebugLevel("PVBAR","IlcPVBARRawFitterv3")>3){
        printf(" a=%f, b=%f, c=%f \n",a,b,c) ;
        goto plot ;
      }
      return kTRUE ;
