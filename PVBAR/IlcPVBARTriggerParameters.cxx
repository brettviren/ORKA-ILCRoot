...
/* $Id: IlcPVBARTriggerParameters.cxx 52412 2011-10-28 19:54:58Z kharlov $ */

///////////////////////////////////////////////////////////////////////////////
//.                                                                          //
// class for PVBAR Trigger Parameters                                         //
//.                                                                          //
///////////////////////////////////////////////////////////////////////////////
...
ClassImp(IlcPVBARTriggerParameters)

//________________________________________________________________
IlcPVBARTriggerParameters::IlcPVBARTriggerParameters()
  : TNamed()
{
...
//________________________________________________________________
IlcPVBARTriggerParameters::IlcPVBARTriggerParameters(const char* name)
  : TNamed(name, name)
{
...
//________________________________________________________________
IlcPVBARTriggerParameters::IlcPVBARTriggerParameters(const IlcPVBARTriggerParameters& other)
  : TNamed(other)
{
  // copy constructor
...
//________________________________________________________________
IlcPVBARTriggerParameters& IlcPVBARTriggerParameters::operator= (const IlcPVBARTriggerParameters& other)
{
  // assignement
...
//________________________________________________________________
UShort_t IlcPVBARTriggerParameters::GetTRUPedestal(Int_t mod, Int_t TRURow, Int_t branch, Int_t xIdx, Int_t zIdx) const
{
  ...
  // TRURow: [0,3], TRU Row, indexed in rising number in PVBAR x direction
  // branch: [0,1], branch, indexed in rising number in z direction
  // xIdx: [0,7], TRU 2x2 cell x index, indexed in rising number in PVBAR x direction
  // zIdx: [0,13], TRU 2x2 cell z index, indexed in rising number in PVBAR z direction
  
  return fTRUPedestals[mod][TRURow][branch][xIdx][zIdx];
}
//________________________________________________________________
Bool_t IlcPVBARTriggerParameters::GetTRUReadoutOn(Int_t mod, Int_t TRURow, Int_t branch) const
{
...
//________________________________________________________________
Bool_t IlcPVBARTriggerParameters::GetTRUSignalReadoutOn(Int_t mod, Int_t TRURow, Int_t branch) const
{
  // Returns the TRU specific flag that specifies for the TRU whether 
...
//________________________________________________________________
UShort_t IlcPVBARTriggerParameters::GetTRUSignalTimeBinFrom(Int_t mod, Int_t TRURow, Int_t branch) const
{
...
//________________________________________________________________
UShort_t IlcPVBARTriggerParameters::GetTRUSignalTimeBinTo(Int_t mod, Int_t TRURow, Int_t branch) const
{
...
//________________________________________________________________
UShort_t IlcPVBARTriggerParameters::GetTRUThreshold(Int_t mod, Int_t TRURow, Int_t branch) const
{
...
//________________________________________________________________
UShort_t IlcPVBARTriggerParameters::GetTRUMaskChannel(Int_t mod, Int_t TRURow, Int_t branch) const
{
  // TODO: description
  //
  // mod: [0,4], module index, clockwise, as of 2011 only 2:4 exists
...
//________________________________________________________________
const UShort_t* IlcPVBARTriggerParameters::GetTORMaskArray(Int_t mod, Int_t tor) const
{
  // TODO: description
  //
  // mod: [0,4], module index, clockwise, as of 2011 only 2:4 exists
  // tor: [0,1], TOR index, rising in PVBAR x direction
  //
...
//________________________________________________________________
const UShort_t* IlcPVBARTriggerParameters::GetTORReadoutMask(Int_t mod, Int_t tor) const
{
  // TODO: description
  //
  // mod: [0,4], module index, clockwise, as of 2011 only 2:4 exists
...
//________________________________________________________________
void IlcPVBARTriggerParameters::SetTRUPedestal(UShort_t pedestal, Int_t mod, Int_t TRURow, Int_t branch, Int_t xIdx, Int_t zIdx)
{
  ...
  // branch: [0,1], branch, indexed in rising number in z direction
  // xIdx: [0,7], TRU 2x2 cell x index, indexed in rising number in PVBAR x direction
  // zIdx: [0,7], TRU 2x2 cell z index, indexed in rising number in PVBAR z direction
  
  fTRUPedestals[mod][TRURow][branch][xIdx][zIdx] = pedestal;
}
//________________________________________________________________
void IlcPVBARTriggerParameters::SetTRUReadoutOn(Bool_t isOn, Int_t mod, Int_t TRURow, Int_t branch)
{
...
//________________________________________________________________
void IlcPVBARTriggerParameters::SetTRUSignalReadoutOn(Bool_t isOn, Int_t mod, Int_t TRURow, Int_t branch)
{
...
//________________________________________________________________
void IlcPVBARTriggerParameters::SetTRUSignalTimeBinFrom(UShort_t fromBin, Int_t mod, Int_t TRURow, Int_t branch)
{
  // Returns the TRU specific value that specifies from (including), 
  // which timebin TRU should read out.
  //
...
//________________________________________________________________
void IlcPVBARTriggerParameters::SetTRUSignalTimeBinTo(UShort_t toBin, Int_t mod, Int_t TRURow, Int_t branch)
{
  // Returns the TRU specific value that specifies to (including), 
  // which timebin TRU should read out.
  //
...
//________________________________________________________________
void IlcPVBARTriggerParameters::SetTRUThreshold(UShort_t threshold, Int_t mod, Int_t TRURow, Int_t branch)
{
  // Returns the TRU specific value that specifies the trigger threshold, 
...
//________________________________________________________________
void IlcPVBARTriggerParameters::SetTRUMaskChannel(UShort_t mask, Int_t mod, Int_t TRURow, Int_t branch)
{
  // TODO: description
  //
  // mod: [0,4], module index, clockwise, as of 2011 only 2:4 exists
...
//________________________________________________________________
void IlcPVBARTriggerParameters::SetTORMaskArray(const UShort_t ma[3], Int_t mod, Int_t tor)
{
  // TODO: description
  //
  // mod: [0,4], module index, clockwise, as of 2011 only 2:4 exists
...
//________________________________________________________________
void IlcPVBARTriggerParameters::SetTORReadoutMask(const UShort_t rm[2], Int_t mod, Int_t tor)
{
  // TODO: description
  //
  // mod: [0,4], module index, clockwise, as of 2011 only 2:4 exists
...
//________________________________________________________________
void IlcPVBARTriggerParameters::Print(Option_t *option) const
{
  // Will Write uppon request (Henrik Qvigstad <henrik.qvigstad@cern.ch>)
  if(option)
    Printf("IlcPVBARTriggerParameters::Print is not implemented.");
}

//________________________________________________________________
void IlcPVBARTriggerParameters::Reset()
{
