...
/* $Id: IlcCFFrame.h 37130 2009-11-23 11:08:08Z rvernet $ */

//--------------------------------------------------------------------//
//                                                                    //
// IlcCFFrame.cxx Class                                               //
...
class IlcCFFrame : public TNamed
{
 public:
  IlcCFFrame();
  IlcCFFrame(const Char_t* name,const Char_t* title);
  virtual ~IlcCFFrame() {} ;
