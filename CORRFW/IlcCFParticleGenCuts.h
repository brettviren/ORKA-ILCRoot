...
//////////////////////////////////////////////////////////////////////
// IlcCFParticleGenCut implementation
...
#ifndef ILCCFPARTICLEGENCUTS_H
#define ILCCFPARTICLEGENCUTS_H
...
class IlcCFParticleGenCuts : public IlcCFCutBase
{
 public :
  IlcCFParticleGenCuts() ;
  IlcCFParticleGenCuts           (const Char_t* name, const Char_t* title) ;
  IlcCFParticleGenCuts           (const IlcCFParticleGenCuts& c) ;
  IlcCFParticleGenCuts& operator=(const IlcCFParticleGenCuts& c) ;
  virtual ~IlcCFParticleGenCuts() { };
  virtual Bool_t IsSelected(TObject* obj) ;
  Bool_t IsSelected(TList* /*list*/) {return kTRUE;}
  virtual void   SetMCEventInfo(const TObject* mcEvent) ;
  void    SetAODMC(Bool_t flag) {fIsAODMC=flag;}

  Bool_t IsPrimaryCharged(IlcVParticle *mcPart);
  Bool_t IsPrimary(IlcMCParticle    *mcPart) ;
  Bool_t IsPrimary(IlcAODMCParticle *mcPart) ;
  //static checkers
  static Bool_t IsCharged(IlcVParticle *mcPart);
  static Bool_t IsA(IlcMCParticle    *mcPart, Int_t pdg, Bool_t abs=kFALSE);
  static Bool_t IsA(IlcAODMCParticle *mcPart, Int_t pdg, Bool_t abs=kFALSE);
 ...
 private:
  ...
  IlcVEvent* fMCInfo ;    // pointer to the MC event information
  ...
  void SelectionBitMap(IlcMCParticle*    obj); // for MC got from Kinematics
  void SelectionBitMap(IlcAODMCParticle* obj); // for MC got from AOD
  void FillHistograms(TObject* obj, Bool_t afterCuts);
  void AddQAHistograms(TList *qaList) ;
  void DefineHistograms();

  ClassDef(IlcCFParticleGenCuts,2);
};
