...
#ifndef ILCCFTRACKQUILCTYCUTS_H
#define ILCCFTRACKQUILCTYCUTS_H
...
class IlcCFTrackQualityCuts : public IlcCFCutBase
{
 public :
  IlcCFTrackQualityCuts() ;
  IlcCFTrackQualityCuts(Char_t* name, Char_t* title) ;
  IlcCFTrackQualityCuts(const IlcCFTrackQualityCuts& c) ;
  IlcCFTrackQualityCuts& operator=(const IlcCFTrackQualityCuts& c) ;
  ~IlcCFTrackQualityCuts();
...
{fCovariance11Max=c1;fCovariance22Max=c2;fCovariance33Max=c3;fCovariance44Max=c4;fCovariance55Max=c5;}
 ...
 private:
  ...
  IlcESDtrackCuts *fTrackCuts;		// use some functionality from this class
  ...
  ClassDef(IlcCFTrackQualityCuts,4);
};
