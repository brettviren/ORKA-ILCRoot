...
#ifndef ILCCFTRACKKINECUTS_H
#define ILCCFTRACKKINECUTS_H
...
class IlcCFTrackKineCuts : public IlcCFCutBase
{
 public :
  IlcCFTrackKineCuts() ;
  IlcCFTrackKineCuts(Char_t* name, Char_t* title) ;
  IlcCFTrackKineCuts(const IlcCFTrackKineCuts& c) ;
  IlcCFTrackKineCuts& operator=(const IlcCFTrackKineCuts& c) ;
  ~IlcCFTrackKineCuts();
