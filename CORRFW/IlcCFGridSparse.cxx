...
#include "TH3D.h"
#include "TAxis.h"
#include "IlcCFUnfolding.h"

//____________________________________________________________________
ClassImp(IlcCFGridSparse)

//____________________________________________________________________
IlcCFGridSparse::IlcCFGridSparse() : 
  IlcCFFrame(),
  fSumW2(kFALSE),
  fData(0x0)
{
...
//____________________________________________________________________
IlcCFGridSparse::IlcCFGridSparse(const Char_t* name, const Char_t* title) : 
  IlcCFFrame(name,title),
  fSumW2(kFALSE),
  fData(0x0)
{
  // default constructor
...
//____________________________________________________________________
IlcCFGridSparse::IlcCFGridSparse(const Char_t* name, const Char_t* title, Int_t nVarIn, const Int_t * nBinIn) :  
  IlcCFFrame(name,title),
  fSumW2(kFALSE),
  fData(0x0)
{
...
//____________________________________________________________________
IlcCFGridSparse::IlcCFGridSparse(const IlcCFGridSparse& c) :
  IlcCFFrame(c),
  fSumW2(kFALSE),
  fData(0x0)
{
  ...
  // copy constructor
  //
  ((IlcCFGridSparse &)c).Copy(*this);
}

//____________________________________________________________________
IlcCFGridSparse& IlcCFGridSparse::operator=(const IlcCFGridSparse &c)
{
  //
  // assigment operator
  //
...
//____________________________________________________________________
void IlcCFGridSparse::SetBinLimits(Int_t ivar, Double_t min, Double_t max)
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::SetBinLimits(Int_t ivar, const Double_t *array)
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::Fill(const Double_t *var, Double_t weight)
{
  //
  // Fill the grid,
...
IlcCFGridSparse* IlcCFGridSparse::MakeSlice(Int_t nVars, const Int_t* vars, const Double_t* varMin, const Double_t* varMax, Bool_t useBins) const
{
  //
  ...
  IlcCFGridSparse* out = new IlcCFGridSparse(fName,fTitle,nVars,bins);
  ...
  else IlcInfo("Keeping same axis ranges");
...
//____________________________________________________________________
Float_t IlcCFGridSparse::GetBinCenter(Int_t ivar, Int_t ibin) const
{
  //
...
//____________________________________________________________________
Float_t IlcCFGridSparse::GetBinSize(Int_t ivar, Int_t ibin) const
{
  //
...
//____________________________________________________________________
Float_t IlcCFGridSparse::GetEntries() const
{
  //
...
//____________________________________________________________________
Float_t IlcCFGridSparse::GetElement(Long_t index) const
{
  //
...
//____________________________________________________________________
Float_t IlcCFGridSparse::GetElement(const Int_t *bin) const
{
  //
...
//____________________________________________________________________
Float_t IlcCFGridSparse::GetElement(const Double_t *var) const
{
  //
...
//____________________________________________________________________
Float_t IlcCFGridSparse::GetElementError(Long_t index) const
{
  //
...
//____________________________________________________________________
Float_t IlcCFGridSparse::GetElementError(const Int_t *bin) const
{
 //
...
//____________________________________________________________________
Float_t IlcCFGridSparse::GetElementError(const Double_t *var) const
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::SetElement(Long_t index, Float_t val)
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::SetElement(const Int_t *bin, Float_t val)
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::SetElement(const Double_t *var, Float_t val) 
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::SetElementError(Long_t index, Float_t val)
{
  //
  // Sets grid element iel error to val (linear indexing) in IlcCFFrame
  //
  Int_t *bin = new Int_t[GetNVar()];
...
//____________________________________________________________________
void IlcCFGridSparse::SetElementError(const Int_t *bin, Float_t val)
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::SetElementError(const Double_t *var, Float_t val) 
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::Add(const IlcCFGridSparse* aGrid, Double_t c)
{
  //
  ...
  if (aGrid->GetNVar() != GetNVar()){
    IlcError("Different number of variables, cannot add the grids");
    return;
  } 
...
//____________________________________________________________________
void IlcCFGridSparse::Add(const IlcCFGridSparse* aGrid1, const IlcCFGridSparse* aGrid2, Double_t c1,Double_t c2)
{
  //
  ...
  if (GetNVar() != aGrid1->GetNVar() || GetNVar() != aGrid2->GetNVar()) {
    IlcInfo("Different number of variables, cannot add the grids");
    return;
  } 
...
//____________________________________________________________________
void IlcCFGridSparse::Multiply(const IlcCFGridSparse* aGrid, Double_t c)
{
  //
  ...
  if (aGrid->GetNVar() != GetNVar()) {
    IlcError("Different number of variables, cannot multiply the grids");
    return;
  } 
...
//____________________________________________________________________
void IlcCFGridSparse::Multiply(const IlcCFGridSparse* aGrid1, const IlcCFGridSparse* aGrid2, Double_t c1,Double_t c2)
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::Divide(const IlcCFGridSparse* aGrid, Double_t c)
{
  //
  ...
  if (aGrid->GetNVar() != GetNVar()) {
    IlcError("Different number of variables, cannot divide the grids");
    return;
  } 
...
//____________________________________________________________________
void IlcCFGridSparse::Divide(const IlcCFGridSparse* aGrid1, const IlcCFGridSparse* aGrid2, Double_t c1,Double_t c2, Option_t *option)
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::Rebin(const Int_t* group)
{
  //
  ...
  for(Int_t i=0;i<GetNVar();i++){
    if (group[i]!=1) IlcInfo(Form(" merging bins along dimension %i in groups of %i bins", i,group[i]));
  }
...
//____________________________________________________________________
void IlcCFGridSparse::Scale(Long_t index, const Double_t *fact)
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::Scale(const Int_t *bin, const Double_t *fact)
{
  //
  //scale content of a certain cell by (positive) fact (with error)
  //
...
//____________________________________________________________________
void IlcCFGridSparse::Scale(const Double_t *var, const Double_t *fact) 
{
  //
  //scale content of a certain cell by (positive) fact (with error)
  //
...
//____________________________________________________________________
void IlcCFGridSparse::Scale(const Double_t* fact)
{
  //
...
//____________________________________________________________________
Long_t IlcCFGridSparse::GetEmptyBins() const {
  //
  // Get empty bins 
  //
...
//____________________________________________________________________
Int_t IlcCFGridSparse::CheckStats(Double_t thr) const
{
  //
...
Double_t IlcCFGridSparse::GetIntegral() const 
{
  //
  // Get full Integral
  //
...
//____________________________________________________________________
Long64_t IlcCFGridSparse::Merge(TCollection* list)
{
  //
  // Merge a list of IlcCFGridSparse with this (needed for PROOF). 
  ...
  Int_t count = 0;
  while ((obj = iter->Next())) {
    IlcCFGridSparse* entry = dynamic_cast<IlcCFGridSparse*> (obj);
    if (entry == 0) 
      continue;
    this->Add(entry);
    count++;
...
//____________________________________________________________________
void IlcCFGridSparse::GetScaledValues(const Double_t *fact, const Double_t *in, Double_t *out) const{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::Copy(TObject& c) const
{
  //
  // copy function
  //
  IlcCFFrame::Copy(c);
  IlcCFGridSparse& target = (IlcCFGridSparse &) c;
...
//____________________________________________________________________
TH1* IlcCFGridSparse::Slice(Int_t iVar1, Int_t iVar2, Int_t iVar3, const Double_t *varMin, const Double_t *varMax, Bool_t useBins) const
{
  //
  ...
  if (iVar3<0) {
	...
	IlcError("Non-existent variable, return NULL");
	return 0x0;
      }
...
//____________________________________________________________________
void IlcCFGridSparse::SetAxisRange(TAxis* axis, Double_t min, Double_t max, Bool_t useBins) const {
  //
...
//____________________________________________________________________
void IlcCFGridSparse::SetRangeUser(Int_t iVar, Double_t varMin, Double_t varMax, Bool_t useBins) const {
  //
  // set range of axis iVar. 
  //
  SetAxisRange(fData->GetAxis(iVar),varMin,varMax,useBins);
	//IlcInfo(Form("IlcCFGridSparse axis %d range has been modified",iVar));
  ...
  IlcWarning(outString.Data());

}

//____________________________________________________________________
void IlcCFGridSparse::SetRangeUser(const Double_t *varMin, const Double_t *varMax, Bool_t useBins) const {
  //
  ...
  IlcInfo("IlcCFGridSparse axes ranges have been modified");
}

//____________________________________________________________________
Float_t IlcCFGridSparse::GetOverFlows(Int_t ivar, Bool_t exclusive) const
{
  //
...
//____________________________________________________________________
Float_t IlcCFGridSparse::GetUnderFlows(Int_t ivar, Bool_t exclusive) const
{
  //
...
//____________________________________________________________________
void IlcCFGridSparse::Smooth() {
  //
  // smoothing function: TO USE WITH CARE
  //

  IlcInfo("Your GridSparse is going to be smoothed");
  IlcInfo(Form("N TOTAL  BINS : %li",GetNBinsTotal()));
  IlcInfo(Form("N FILLED BINS : %li",GetNFilledBins()));
  IlcCFUnfolding::SmoothUsingNeighbours(fData);
}
