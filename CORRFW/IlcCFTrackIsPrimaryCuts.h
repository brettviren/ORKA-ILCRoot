...
#ifndef ILCCFTRACKISPRIMARYCUTS_H
#define ILCCFTRACKISPRIMARYCUTS_H
...
class IlcCFTrackIsPrimaryCuts : public IlcCFCutBase
{
 public :
  IlcCFTrackIsPrimaryCuts() ;
  IlcCFTrackIsPrimaryCuts(Char_t* name, Char_t* title) ;
  IlcCFTrackIsPrimaryCuts(const IlcCFTrackIsPrimaryCuts& c) ;
  IlcCFTrackIsPrimaryCuts& operator=(const IlcCFTrackIsPrimaryCuts& c) ;
  ~IlcCFTrackIsPrimaryCuts();
  ...
  void SetAODType(Char_t type=IlcAODTrack::kUndef)      {fAODType = type;}
  ...
  enum { 
    ...
    kCutAODType,                // cut on IlcAODTrack::fType
 ...
 private:
  ...
  void GetDCA(IlcESDtrack* esdTrack);
  void GetDCA(IlcAODTrack* aodTrack);
  ...
  IlcVEvent*  fEvt;			// pointer to event, needed for SPD vertex and DCA in AODs
  ...
  ClassDef(IlcCFTrackIsPrimaryCuts,3);
};
