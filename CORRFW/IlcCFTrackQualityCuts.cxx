...
// The class IlcCFTrackQualityCuts is designed to select reconstructed tracks
...
ClassImp(IlcCFTrackQualityCuts)

//__________________________________________________________________________________
IlcCFTrackQualityCuts::IlcCFTrackQualityCuts() :
  IlcCFCutBase(),
  fMinNClusterTPC(0),
  fMinNClusterITS(0),
  fMinNClusterTRD(0),
...
//__________________________________________________________________________________
IlcCFTrackQualityCuts::IlcCFTrackQualityCuts(Char_t* name, Char_t* title) :
...
//__________________________________________________________________________________
IlcCFTrackQualityCuts::IlcCFTrackQualityCuts(const IlcCFTrackQualityCuts& c) :
  IlcCFCutBase(c),
  ...
  fhBinLimCovariance55(c.fhBinLimCovariance55)
{
  ...
  // copy constructor
  //
  ((IlcCFTrackQualityCuts &) c).Copy(*this);
}
//__________________________________________________________________________________
IlcCFTrackQualityCuts& IlcCFTrackQualityCuts::operator=(const IlcCFTrackQualityCuts& c)
{
  //
  // Assignment operator
  //
...
//__________________________________________________________________________________
void IlcCFTrackQualityCuts::Initialise()
{
  //
  ...
  fhCutCorrelation = 0;
  fBitmap=new TBits(0);
  fTrackCuts=new IlcESDtrackCuts("aliESDtrackCuts","aliESDtrackCuts");
...
//__________________________________________________________________________________
void IlcCFTrackQualityCuts::Copy(TObject &c) const
{
  //
  // Copy function
  //
  IlcCFTrackQualityCuts& target = (IlcCFTrackQualityCuts &) c;
...
//__________________________________________________________________________________
void IlcCFTrackQualityCuts::SelectionBitMap(TObject* obj)
{
  //
...
// // // remove following 5 lines when IlcESDtrackCuts is updated
...
// // // include following line when IlcESDtrackCuts is updated
//     if (esdTrack->GetTPCNclsF() != 0) fractionFoundClustersTPC = fTrackCuts->GetCutVariable(2) / float(esdTrack->GetTPCNclsF());

// // // remove following 6 lines when IlcESDtrackCuts is updated
...
// // // include following lines when IlcESDtrackCuts is updated
...
// // // remove following lines when IlcESDtrackCuts is updated
...
//__________________________________________________________________________________
Bool_t IlcCFTrackQualityCuts::IsSelected(TObject* obj) {
  //
...
//__________________________________________________________________________________
void IlcCFTrackQualityCuts::SetHistogramBins(Int_t index, Int_t nbins, Double_t *bins)
{
  //
  // variable bin size
  //
...
//__________________________________________________________________________________
void IlcCFTrackQualityCuts::SetHistogramBins(Int_t index, Int_t nbins, Double_t xmin, Double_t xmax)
{
  //
  // fixed bin size
  //
...
//__________________________________________________________________________________
 void IlcCFTrackQualityCuts::DefineHistograms() {
  //
...
//__________________________________________________________________________________
void IlcCFTrackQualityCuts::FillHistograms(TObject* obj, Bool_t b)
{
  //
...
// // // remove following 4 lines when IlcESDtrackCuts is updated
...
//__________________________________________________________________________________
void IlcCFTrackQualityCuts::SaveHistograms(const Char_t* dir) {
  //
...
//__________________________________________________________________________________
void IlcCFTrackQualityCuts::DrawHistograms(Bool_t drawLogScale)
{
  //
...
//__________________________________________________________________________________
void IlcCFTrackQualityCuts::AddQAHistograms(TList *qaList) {
  //
