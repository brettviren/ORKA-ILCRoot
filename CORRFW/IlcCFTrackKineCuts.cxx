...
// The class IlcCFTrackKineCuts is designed to select both generated 
...
#include <IlcLog.h>
#include "IlcCFTrackKineCuts.h"

ClassImp(IlcCFTrackKineCuts)

//__________________________________________________________________________________
IlcCFTrackKineCuts::IlcCFTrackKineCuts() :
  IlcCFCutBase(),
  fMomentumMin(0),
  fMomentumMax(0),
  fPtMin(0),
...
//__________________________________________________________________________________
IlcCFTrackKineCuts::IlcCFTrackKineCuts(Char_t* name, Char_t* title) :
...
//__________________________________________________________________________________
IlcCFTrackKineCuts::IlcCFTrackKineCuts(const IlcCFTrackKineCuts& c) :
  IlcCFCutBase(c),
  ...
  fhBinLimCharge(c.fhBinLimCharge)
{
  ...
  // copy constructor
  //
  ((IlcCFTrackKineCuts &) c).Copy(*this);
}
//__________________________________________________________________________________
IlcCFTrackKineCuts& IlcCFTrackKineCuts::operator=(const IlcCFTrackKineCuts& c)
{
  //
  // Assignment operator
  //
...
//__________________________________________________________________________________
void IlcCFTrackKineCuts::Initialise()
{
  //
...
//__________________________________________________________________________________
void IlcCFTrackKineCuts::Copy(TObject &c) const
{
  //
  // Copy function
  //
  IlcCFTrackKineCuts& target = (IlcCFTrackKineCuts &) c;
...
//__________________________________________________________________________________
void IlcCFTrackKineCuts::SelectionBitMap(TObject* obj) {
  //
  ...
  if (!obj) return  ;
  if (!obj->InheritsFrom("IlcVParticle")) IlcError("object must derived from IlcVParticle !");
  IlcVParticle* particle = dynamic_cast<IlcVParticle *>(obj);
  if ( !particle ) return;
...
//__________________________________________________________________________________
Bool_t IlcCFTrackKineCuts::IsSelected(TObject* obj) {
  //
...
//__________________________________________________________________________________
void IlcCFTrackKineCuts::SetHistogramBins(Int_t index, Int_t nbins, Double_t *bins)
{
  //
  // variable bin size
  //
...
//__________________________________________________________________________________
void IlcCFTrackKineCuts::SetHistogramBins(Int_t index, Int_t nbins, Double_t xmin, Double_t xmax)
{
  //
  // fixed bin size
  //
...
//__________________________________________________________________________________
 void IlcCFTrackKineCuts::DefineHistograms() {
  //
...
//__________________________________________________________________________________
void IlcCFTrackKineCuts::FillHistograms(TObject* obj, Bool_t b)
{
  //
...
//__________________________________________________________________________________
void IlcCFTrackKineCuts::SaveHistograms(const Char_t* dir) {
  //
...
//__________________________________________________________________________________
void IlcCFTrackKineCuts::DrawHistograms(Bool_t drawLogScale)
{
  //
...
//__________________________________________________________________________________
void IlcCFTrackKineCuts::AddQAHistograms(TList *qaList) {
  //
