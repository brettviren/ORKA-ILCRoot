...
#ifndef ILCCFUNFOLDING_H
#define ILCCFUNFOLDING_H
...
class IlcCFUnfolding : public TNamed {

 public :

  IlcCFUnfolding();
  IlcCFUnfolding(const Char_t* name, const Char_t* title, const Int_t nVar, 
  ...
  ~IlcCFUnfolding();
  void UnsetCorrelatedErrors()  {IlcError("===================> DEPRECATED <=====================");}
  void SetUseCorrelatedErrors() {IlcError("===================> DEPRECATED <=====================");}
  void SetMaxNumberOfIterations(Int_t n = 10)  {
    IlcError("===================> DEPRECATED : should be set in constructor <=====================");
    IlcError("===================> DEPRECATED : will be removed soon         <=====================");
    fMaxNumIterations = n;
  }
 ...
 private :
  IlcCFUnfolding(const IlcCFUnfolding& c);
  IlcCFUnfolding& operator= (const IlcCFUnfolding& c);
