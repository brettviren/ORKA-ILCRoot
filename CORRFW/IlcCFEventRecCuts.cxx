...
#include "IlcCFEventRecCuts.h"
ClassImp(IlcCFEventRecCuts) 
//____________________________________________________________________
IlcCFEventRecCuts::IlcCFEventRecCuts() : 
  IlcCFCutBase(),
  fNTracksMin(-1),
  fNTracksMax(1000000),
...
//____________________________________________________________________
IlcCFEventRecCuts::IlcCFEventRecCuts(Char_t* name, Char_t* title) : 
...
//____________________________________________________________________
IlcCFEventRecCuts::IlcCFEventRecCuts(const IlcCFEventRecCuts& c) : 
  IlcCFCutBase(c),
...
void IlcCFEventRecCuts::Initialise()
{
...
//____________________________________________________________________
IlcCFEventRecCuts& IlcCFEventRecCuts::operator=(const IlcCFEventRecCuts& c)
{
  //
  // Assignment operator
  //
...
//____________________________________________________________________
Bool_t IlcCFEventRecCuts::IsSelected(TObject* obj) {
  //
...
void IlcCFEventRecCuts::SelectionBitMap(TObject* obj) {
  ...
  if(fRequireVtxCuts){
    ...
    if(!vtxESD){
      ...
      IlcWarning("Cannot get vertex, skipping event");
      return;
    }
    // Require the vertex to have been reconstructed successfully
    if (strcmp(vtxESD->GetName(), "default")==0){
      IlcWarning(Form(" No reconstructed vertex found, skipping event"));    
      for(Int_t j=1;j<kNCuts;j++)fBitMap->SetBitNumber(j,kFALSE); 
      return;
    }    
...
//_____________________________________________________________________________
void IlcCFEventRecCuts::FillHistograms(TObject* obj, Bool_t b)
{
  //
...
//____________________________________________________________________
void IlcCFEventRecCuts::SetHistogramBins(Int_t index, Int_t nbins, Double_t *bins)
{
  //
...
//____________________________________________________________________
void IlcCFEventRecCuts::SetHistogramBins(Int_t index, Int_t nbins, Double_t xmin, Double_t xmax)
{
  //
...
//_____________________________________________________________________________
 void IlcCFEventRecCuts::DefineHistograms() {
  //
...
//_____________________________________________________________________________
void IlcCFEventRecCuts::AddQAHistograms(TList *qaList) {
  //
