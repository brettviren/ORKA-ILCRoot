#ifndef ILCCFEVENTCLASSCUTS_H
#define ILCCFEVENTCLASSCUTS_H
/**************************************************************************
...
// an IlcVEvent, although conditions are meaningful only for IlcESD(AOD)Event 
// type objects.
...
class IlcCFEventClassCuts: public IlcCFCutBase 
{
 public :
  IlcCFEventClassCuts() ;
  IlcCFEventClassCuts(Char_t* name, Char_t* title) ;
  IlcCFEventClassCuts(const IlcCFEventClassCuts& c) ;
  IlcCFEventClassCuts& operator=(const IlcCFEventClassCuts& c) ;
  ~IlcCFEventClassCuts();
  ...
  static Bool_t IsTriggered(IlcVEvent *ev, TriggerType trigger=kMB1); 
 ...
 protected:
  ...
  static void TriggerBitMap(IlcVEvent* ev,TBits *bitmapT);
  ...
  ClassDef(IlcCFEventClassCuts,2);
};
#endif
