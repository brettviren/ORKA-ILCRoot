...
ClassImp(IlcRSTACKCpvCalibData)

//________________________________________________________________
  IlcRSTACKCpvCalibData::IlcRSTACKCpvCalibData() : TNamed()
{
  // Default constructor
  Reset();
}
...
//________________________________________________________________
IlcRSTACKCpvCalibData::IlcRSTACKCpvCalibData(const char* name)
{
  // Constructor
...
//________________________________________________________________
IlcRSTACKCpvCalibData::IlcRSTACKCpvCalibData(const IlcRSTACKCpvCalibData& calibda) :
  TNamed(calibda)
{
  // copy constructor
...
//________________________________________________________________
IlcRSTACKCpvCalibData &IlcRSTACKCpvCalibData::operator =(const IlcRSTACKCpvCalibData& calibda)
{
  // assignment operator
  SetName(calibda.GetName());
  SetTitle(calibda.GetName());
...
//________________________________________________________________
IlcRSTACKCpvCalibData::~IlcRSTACKCpvCalibData()
{
  // Destructor
}

//________________________________________________________________
void IlcRSTACKCpvCalibData::Reset()
{
...
//________________________________________________________________
void  IlcRSTACKCpvCalibData::Print(Option_t *option) const
{
...
//________________________________________________________________
Float_t IlcRSTACKCpvCalibData::GetADCchannelCpv(Int_t module, Int_t column, Int_t row) const
{
...
//________________________________________________________________
Float_t IlcRSTACKCpvCalibData::GetADCpedestalCpv(Int_t module, Int_t column, Int_t row) const
{
  //Return CPV pedestal
  //module, column,raw should follow the internal RSTACK convention:
  //module 1:5, column 1:56, row 1:128.
...
//________________________________________________________________
void IlcRSTACKCpvCalibData::SetADCchannelCpv(Int_t module, Int_t column, Int_t row, Float_t value)
{
...
//________________________________________________________________
void IlcRSTACKCpvCalibData::SetADCpedestalCpv(Int_t module, Int_t column, Int_t row, Float_t value)
{
  //Set CPV pedestal
  //module, column,raw should follow the internal RSTACK convention:
  //module 1:5, column 1:56, row 1:128.
