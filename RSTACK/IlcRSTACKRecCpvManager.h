#ifndef IlcRSTACKRecCpvManager_H
#define IlcRSTACKRecCpvManager_H
...
#include "IlcRSTACKRecManager.h"
//class IlcRSTACKGeometry ; 

class IlcRSTACKRecCpvManager : public IlcRSTACKRecManager {

 public: 

  IlcRSTACKRecCpvManager();
  ~IlcRSTACKRecCpvManager(void);
 ...
 private:
  ...
  ClassDef(IlcRSTACKRecCpvManager,1)        // CPV reconstruction management class 

} ;

#endif // IlcRSTACKRecCpvManager_H
