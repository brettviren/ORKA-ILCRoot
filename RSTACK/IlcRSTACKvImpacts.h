#ifndef ILCRSTACKVIMPACTS_H
#define ILCRSTACKVIMPACTS_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcRSTACKvImpacts.h 15830 2006-11-14 17:11:17Z hristov $ */
...
class IlcRSTACKvImpacts : public IlcRSTACKv1 {

public:

  IlcRSTACKvImpacts(void) ;
  IlcRSTACKvImpacts(const char *name, const char *title="") ;
  virtual ~IlcRSTACKvImpacts(void) ;
...
protected:
 ...
 private:
  IlcRSTACKvImpacts(IlcRSTACKvImpacts & RSTACK);
  IlcRSTACKvImpacts & operator = (const IlcRSTACKvImpacts & /*rvalue*/);

  ClassDef(IlcRSTACKvImpacts,1)  // Implementation of RSTACK manager class for layout EMC+PPSD

};

#endif // IlcRSTACKVIMPACTS_H
