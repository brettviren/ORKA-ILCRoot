#ifndef ILCRSTACKPULSEGENERATOR_H
#define ILCRSTACKPULSEGENERATOR_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                          */

/* $Id: IlcRSTACKPulseGenerator.h 54863 2012-02-28 12:10:29Z hristov $ */
...
class IlcRSTACKPulseGenerator : public TObject
{
public:
  IlcRSTACKPulseGenerator(Double_t a=0, Double_t t0=0);
  virtual  ~IlcRSTACKPulseGenerator();
...
private:
  IlcRSTACKPulseGenerator(const IlcRSTACKPulseGenerator & pulse);
  IlcRSTACKPulseGenerator& operator = (const IlcRSTACKPulseGenerator &) {return *this;}
...
private:
  ...
  ClassDef(IlcRSTACKPulseGenerator,1)
