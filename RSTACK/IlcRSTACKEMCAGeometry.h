#ifndef ILCRSTACKEMCAGEOMETRY_H
#define ILCRSTACKEMCAGEOMETRY_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcRSTACKEMCAGeometry.h 31469 2009-03-13 11:16:29Z kharlov $ */

//_________________________________________________________________________
// Geometry class  for RSTACK : EMCA (Electromagnetic Calirometer)
...
class IlcRSTACKEMCAGeometry : public TObject {

public: 

  IlcRSTACKEMCAGeometry();
  //Compiler-generated copy ctor and copy-assignment operator _ARE_ OK.

  virtual ~IlcRSTACKEMCAGeometry(void) {}
...
private:
  ...
  ClassDef(IlcRSTACKEMCAGeometry,1)      // EMCA geometry class 

} ;

#endif // IlcRSTACKEMCAGEOMETRY_H
