...
ClassImp(IlcRSTACKRawFitterv3)

//-----------------------------------------------------------------------------
IlcRSTACKRawFitterv3::IlcRSTACKRawFitterv3():
...
//-----------------------------------------------------------------------------
IlcRSTACKRawFitterv3::IlcRSTACKRawFitterv3(const IlcRSTACKRawFitterv3 &RSTACKFitter ):
...
//-----------------------------------------------------------------------------
IlcRSTACKRawFitterv3& IlcRSTACKRawFitterv3::operator = (const IlcRSTACKRawFitterv3 & /*RSTACKFitter*/)
{
  //Assignment operator.
  return *this;
}
...
//-----------------------------------------------------------------------------
Bool_t IlcRSTACKRawFitterv3::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
...
//      IlcWarning(Form("Can not read data from OCDB")) ;
  ...
  if(a==0.){
    if(b==0.){ //no roots
      fQuality = 2000. ;
      if(IlcLog::GetDebugLevel("RSTACK","IlcRSTACKRawFitterv3")>3){
        printf(" a=%f, b=%f, c=%f \n",a,b,c) ;
        goto plot ;
      }
      return kTRUE ;
