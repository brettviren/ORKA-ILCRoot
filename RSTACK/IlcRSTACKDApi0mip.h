#ifndef IlcRSTACKDApi0mip_H
#define IlcRSTACKDApi0mip_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcRSTACKDApi0mip.h 52964 2011-11-17 12:12:19Z policheh $ */
...
class IlcRSTACKDApi0mip : public TNamed {
 public:
  IlcRSTACKDApi0mip(int module,int iterid=0,const char* fopt="RECREATE");
  IlcRSTACKDApi0mip(const IlcRSTACKDApi0mip& da);
  IlcRSTACKDApi0mip& operator= (const IlcRSTACKDApi0mip&);
  ~IlcRSTACKDApi0mip();
  ...
  void FillTree(IlcRSTACKDATreeEvent* event=0);
  void FillHist(IlcRSTACKDATreeEvent* event=0);
 ...
 private:
  ...
  IlcRSTACKDATreeEvent* fEvent;   //! Contents of TTree
