#ifndef ILCRSTACKTRIGGERPARAMETERS_H
#define ILCRSTACKTRIGGERPARAMETERS_H
...
/* $Id: IlcRSTACKTriggerParameters.h 55807 2012-04-17 20:40:19Z hristov $ */
 ...
 */
class IlcRSTACKTriggerParameters : public TNamed
{

public:
  IlcRSTACKTriggerParameters();
  IlcRSTACKTriggerParameters(const char* name);
  IlcRSTACKTriggerParameters(const IlcRSTACKTriggerParameters& );
  IlcRSTACKTriggerParameters& operator= (const IlcRSTACKTriggerParameters& );
  virtual ~IlcRSTACKTriggerParameters();
  ...
  // Constants
  static const Int_t kNMods     = 5; // Number of RSTACK Modules
...
protected:
  ...
  ClassDef(IlcRSTACKTriggerParameters, 1) // RSTACK Trigger Parameters
};
