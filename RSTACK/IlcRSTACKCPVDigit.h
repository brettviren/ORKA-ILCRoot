#ifndef ILCRSTACKCPVDIGIT_H
#define ILCRSTACKCPVDIGIT_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcRSTACKCPVDigit.h 15036 2006-09-13 07:31:01Z kharlov $ */
...
class IlcRSTACKCPVDigit : public TObject {
  
public:
  virtual ~IlcRSTACKCPVDigit() {}
           IlcRSTACKCPVDigit();
           IlcRSTACKCPVDigit(Int_t x, Int_t y, Float_t q);
...
private:
  ...
  ClassDef(IlcRSTACKCPVDigit,1)  // Digit object in one CPV pad
};
