...
// Author: Dmitri Peressounko (after A.Pavlinov - see RAW/IlcCaloFastAltroFitv0.cxx)
...
ClassImp(IlcRSTACKRawFitterv2)

//-----------------------------------------------------------------------------
IlcRSTACKRawFitterv2::IlcRSTACKRawFitterv2():
...
//-----------------------------------------------------------------------------
IlcRSTACKRawFitterv2::IlcRSTACKRawFitterv2(const IlcRSTACKRawFitterv2 &RSTACKFitter ):
...
//-----------------------------------------------------------------------------
IlcRSTACKRawFitterv2& IlcRSTACKRawFitterv2::operator = (const IlcRSTACKRawFitterv2 & /*RSTACKFitter*/)
{
  //Assignment operator.
  return *this;
}
...
//-----------------------------------------------------------------------------
Bool_t IlcRSTACKRawFitterv2::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
  ...
  if(!FindAmpT(samples,times)){
    if(IlcLog::GetDebugLevel("RSTACK","IlcRSTACKRawFitterv2")>3){
      goto plot ;
    }
    else{
      return kFALSE ;
...
//------------------------------------------------------------------
Bool_t IlcRSTACKRawFitterv2::FindAmpT(TArrayD samples, TArrayD times){
// makes fit
...
void IlcRSTACKRawFitterv2::FindMax(){
