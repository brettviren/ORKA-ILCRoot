...
/* $Id: IlcRSTACKEMCAGeometry.cxx 27023 2008-07-01 19:20:43Z kharlov $ */
...
ClassImp(IlcRSTACKEMCAGeometry)

//____________________________________________________________________________
IlcRSTACKEMCAGeometry::IlcRSTACKEMCAGeometry():
                     fAirGapLed(0.f),
...
//			       fNCellsZInStrip * (2*fTyvecThickness + 2*fCrystalHalfSize[2]) )/2;
  ...
  fOuterThermoWidthXUp  = 156.0 - fAlCoverThickness ; 
                                  //width of the upper surface of the RSTACK module accross the beam 
