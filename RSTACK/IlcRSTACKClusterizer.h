#ifndef ILCRSTACKCLUSTERIZER_H
#define ILCRSTACKCLUSTERIZER_H
 ...
 * IlcRawReader is not persistent
 *
...
class IlcRSTACKClusterizer : public TObject {

public:

  IlcRSTACKClusterizer() ;        // default ctor
  IlcRSTACKClusterizer(IlcRSTACKGeometry *geom);
  virtual ~IlcRSTACKClusterizer() ; // dtor
...
protected:
  ...
  IlcRSTACKGeometry *fGeom; // Pointer to RSTACK geometry
...
private:
  IlcRSTACKClusterizer(const IlcRSTACKClusterizer & clusterizer);
  IlcRSTACKClusterizer & operator = (const IlcRSTACKClusterizer &clusterer);

  ClassDef(IlcRSTACKClusterizer,5)  // Clusterization algorithm class 

} ;

#endif // IlcRSTACKCLUSTERIZER_H
