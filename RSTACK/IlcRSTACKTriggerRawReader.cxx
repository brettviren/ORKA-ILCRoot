 ...
 *   please read documentation for IlcRSTACKTriggerRawReader::ReadFromStream .
 */
...
ClassImp(IlcRSTACKTriggerRawReader)


//________________________________________________________________
IlcRSTACKTriggerRawReader::IlcRSTACKTriggerRawReader()
  : TObject(),
    fTRUs()
{
  // default constructor.
...
//________________________________________________________________
IlcRSTACKTRURawReader* IlcRSTACKTriggerRawReader::GetTRU(Int_t mod, Int_t truRow, Int_t branch)
{
  // Get TRU Raw Reader.
  ...
  if( ! fTRUs[mod][truRow][branch] )
    fTRUs[mod][truRow][branch] = new IlcRSTACKTRURawReader();
  return fTRUs[mod][truRow][branch];
}
 

//________________________________________________________________
void IlcRSTACKTriggerRawReader::ReadFromStream(IlcCaloRawStreamV3* rawStream)
{
  // Give a IlcCaloRawStreamV3* to an instance of this class.
  // It will read from the stream. The stream is passed to 'IlcRSTACKTRURawReader's
  // which are accesible through 'IlcRSTACKTriggerRawReader::GetTRU'.
  ...
  while (rawStream->NextBunch()) {
    ...
    IlcRSTACKTRURawReader* reader = GetTRU(module, rcuRow, branch);
    if (reader) reader->ReadFromStream(rawStream);
  } // end while 
}

//________________________________________________________________
void IlcRSTACKTriggerRawReader::Reset()
{
  // Reset
