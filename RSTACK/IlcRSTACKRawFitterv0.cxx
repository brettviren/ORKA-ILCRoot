...
/* $Id: IlcRSTACKRawFitterv0.cxx 53738 2011-12-20 16:49:27Z kharlov $ */
...
// 
//     IlcRSTACKRawFitterv0 *fitterv0=new IlcRSTACKRawFitterv0();
...
ClassImp(IlcRSTACKRawFitterv0)

//-----------------------------------------------------------------------------
IlcRSTACKRawFitterv0::IlcRSTACKRawFitterv0():
  TObject(),
  fModule(0),
  fCellX(0),
  fCellZ(0),
...
//-----------------------------------------------------------------------------
IlcRSTACKRawFitterv0::IlcRSTACKRawFitterv0(const IlcRSTACKRawFitterv0 &RSTACKFitter ):
  TObject(),
  fModule      (RSTACKFitter.fModule),
  fCellX       (RSTACKFitter.fCellX),
  fCellZ       (RSTACKFitter.fCellZ),
  fCaloFlag    (RSTACKFitter.fCaloFlag),
  fNBunches    (RSTACKFitter.fNBunches),
  fPedSubtract (RSTACKFitter.fPedSubtract),
  fEnergy      (RSTACKFitter.fEnergy),
  fTime        (RSTACKFitter.fTime),
  fQuality     (RSTACKFitter.fQuality),
  fPedestalRMS (RSTACKFitter.fPedestalRMS),
  fAmpOffset   (RSTACKFitter.fAmpOffset),
  fAmpThreshold(RSTACKFitter.fAmpThreshold),
  fOverflow    (RSTACKFitter.fOverflow),
  fCalibData   (RSTACKFitter.fCalibData)
{
  //Copy constructor
}

//-----------------------------------------------------------------------------
IlcRSTACKRawFitterv0& IlcRSTACKRawFitterv0::operator = (const IlcRSTACKRawFitterv0 &RSTACKFitter)
{
  //Assignment operator.
...
void IlcRSTACKRawFitterv0::SetChannelGeo(const Int_t module, const Int_t cellX,
...
Bool_t IlcRSTACKRawFitterv0::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
