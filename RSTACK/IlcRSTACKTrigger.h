#ifndef ILCRSTACKTrigger_H
#define ILCRSTACKTrigger_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcRSTACKTrigger.h 32767 2009-06-05 15:59:59Z kharlov $ */
...
//  IlcEMCALTrigger *tr = new IlcEMCALTrigger();//Init Trigger
...
class IlcRSTACKTrigger : public IlcTriggerDetector {
  
 public: 
  
  IlcRSTACKTrigger() ; //  ctor
  IlcRSTACKTrigger(const IlcRSTACKTrigger & trig) ; // cpy ctor
  virtual ~IlcRSTACKTrigger();

  virtual void    CreateInputs(); //Define trigger inputs for Central Trigger Processor
  void            Print(const Option_t * opt ="") const ;  
  virtual void    Trigger() {}                   //Make RSTACK trigger
  void            Trigger(TClonesArray *digits); //Make RSTACK trigger
 ...
 private:
  ...
  IlcRSTACKTrigger & operator = (const IlcRSTACKTrigger & trig) ;//cpy assignment

  void FillTRU(const TClonesArray * digits, const IlcRSTACKGeometry * geom) const ;
 ...
 private: 
  ...
  ClassDef(IlcRSTACKTrigger,5)
} ;


#endif //ILCRSTACKTrigger_H
