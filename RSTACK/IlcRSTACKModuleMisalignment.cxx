...
ClassImp(IlcRSTACKModuleMisalignment)
...
//______________________________________________________________________________
IlcRSTACKModuleMisalignment::
IlcRSTACKModuleMisalignment(const IlcRSTACKGeometry & geom, Bool_t debug)
                            : fDebug(debug),
                              fAngles(),
                              fCenters(),
                              fModule(),
...
{
  //Ctor.
  //Extract ideal module transformations from IlcRSTACKGeometry.
  ...
  fModule[0][2] = -22.61;//This number is hardcoded, IlcRSTACKGeometry does not have it,
...
//______________________________________________________________________________
IlcRSTACKModuleMisalignment::~IlcRSTACKModuleMisalignment()
{
}

//______________________________________________________________________________
void IlcRSTACKModuleMisalignment::
                    ...
                    const TString & name2, TGeoHMatrix * delta)
{
  ...
  const IlcSurveyPoint * pt0 = static_cast<IlcSurveyPoint *>(points->FindObject(name0));
  const IlcSurveyPoint * pt1 = static_cast<IlcSurveyPoint *>(points->FindObject(name1));
  const IlcSurveyPoint * pt2 = static_cast<IlcSurveyPoint *>(points->FindObject(name2));

  if (!pt0 || !pt1 || !pt2) {
    Warning("IlcRSTACKModuleData::DeltaTransformation",
...
//______________________________________________________________________________
void IlcRSTACKModuleMisalignment::FindIdealModule(UInt_t module)
{
...
//______________________________________________________________________________
void IlcRSTACKModuleMisalignment::FindRealModule(const IlcSurveyPoint * pt0, 
                                               const IlcSurveyPoint * pt1,
                                               const IlcSurveyPoint * pt2)
{
  //Real module - fV.
  //Survey is in millimeters.
  //IlcRSTACKGeometry is in centimeters.
...
//______________________________________________________________________________
void IlcRSTACKModuleMisalignment::FindDelta(TGeoHMatrix * delta)const
{
  ...
  */
  ...
  try {
    ...
    Error("IlcRSTACKModuleMisalignment::FindDelta", 
