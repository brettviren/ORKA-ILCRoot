#ifndef ILCRSTACKTRACKSEGMENTMAKERV1_H
#define ILCRSTACKTRACKSEGMENTMAKERV1_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcRSTACKTrackSegmentMakerv1.h 35594 2009-10-15 15:40:35Z prsnko $ */
...
class  IlcRSTACKTrackSegmentMakerv1 : public IlcRSTACKTrackSegmentMaker {

public:

  IlcRSTACKTrackSegmentMakerv1() ;                     
  IlcRSTACKTrackSegmentMakerv1(IlcRSTACKGeometry *geom);
  IlcRSTACKTrackSegmentMakerv1(const IlcRSTACKTrackSegmentMakerv1 & tsm);

  virtual ~ IlcRSTACKTrackSegmentMakerv1() ; // dtor
  ...
  virtual void   SetMaxEmcCPVDistance(Float_t r){ fRcpv = r ;} //Maximal distance (in RSTACK plane) 
  ...
  IlcRSTACKTrackSegmentMakerv1 & operator = (const IlcRSTACKTrackSegmentMakerv1 & )  {
...
private:
  ...
  void  GetDistanceInRSTACKPlane(IlcRSTACKEmcRecPoint * EmcClu , IlcRSTACKCpvRecPoint * Cpv, 
...
private:  
  ...
  ClassDef( IlcRSTACKTrackSegmentMakerv1,4)  // Implementation version 1 of algorithm class to make RSTACK track segments 

 };

#endif // IlcRSTACKTRACKSEGMENTMAKERV1_H
