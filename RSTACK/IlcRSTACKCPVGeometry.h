#ifndef ILCRSTACKCPVGEOMETRY_H
#define ILCRSTACKCPVGEOMETRY_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcRSTACKCPVGeometry.h 7865 2003-07-13 09:26:14Z hristov $ */

//_________________________________________________________________________
// Geometry derived class for RSTACK
...
//#include "IlcRSTACKCPVBaseGeometry.h"
#include "TObject.h"

class IlcRSTACKCPVGeometry : public TObject {

public: 

           IlcRSTACKCPVGeometry();
  virtual ~IlcRSTACKCPVGeometry(void) {};
...
private:
  ...
  ClassDef(IlcRSTACKCPVGeometry,2)       // CPV geometry base class 

} ;

#endif // IlcRSTACKCPVGEOMETRY_H
