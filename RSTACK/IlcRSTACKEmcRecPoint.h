#ifndef ILCRSTACKEMCRECPOINT_H
#define ILCRSTACKEMCRECPOINT_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcRSTACKEmcRecPoint.h 54863 2012-02-28 12:10:29Z hristov $ */
...
class IlcRSTACKEmcRecPoint : public IlcRSTACKRecPoint  {

public:

  IlcRSTACKEmcRecPoint() ;
  IlcRSTACKEmcRecPoint(const char * opt) ;
  IlcRSTACKEmcRecPoint(const IlcRSTACKEmcRecPoint & rp) ; 
 
  virtual ~IlcRSTACKEmcRecPoint() ;  

  virtual void Clear(const Option_t* /*option*/ ="") { delete[] fEnergyList; fEnergyList=0; IlcRSTACKRecPoint::Clear(); }

  //This virtual function has signature different from IlcRSTACKRecPoint::AddDigit
  //it hides, not overrides. using - declaration should fix the problem, at least for
  //g++
//  using IlcRSTACKRecPoint::AddDigit;
  virtual void  AddDigit(IlcRSTACKDigit & digit, Float_t Energy, Float_t time=0.) ;          // add a digit to the digits list  
  ...
  virtual Int_t GetNumberOfLocalMax(IlcRSTACKDigit **  maxAt, Float_t * maxAtEnergy,
...
private:
  IlcRSTACKEmcRecPoint & operator = (const IlcRSTACKEmcRecPoint & /*rvalue*/) {return *this;}

protected:
  virtual void  EvalLocalPosition(Float_t logWeight, TVector3 &vtx, TClonesArray * digits, TVector3 &vInc) ;// computes the position in the RSTACK module 
  ...
  virtual Bool_t AreNeighbours(IlcRSTACKDigit * digit1, IlcRSTACKDigit * digit2 ) const ;
  ...
  ClassDef(IlcRSTACKEmcRecPoint,3)  // EMC RecPoint (cluster)

};

#endif // IlcRSTACKEMCRECPOINT_H
