...
/* $Id: IlcRSTACKPID.cxx 44091 2010-10-05 09:46:25Z prsnko $ */
...
ClassImp(IlcRSTACKPID)

//____________________________________________________________________________
IlcRSTACKPID::IlcRSTACKPID():
  TObject(),
  fGeom(NULL),
  fESD(0x0),
  fEMCRecPoints(NULL),
...
//____________________________________________________________________________
IlcRSTACKPID::IlcRSTACKPID(IlcRSTACKGeometry *geom):
  TObject(),
  fGeom(geom),
  fESD(0x0),
  fEMCRecPoints(NULL),
  ...
  fRecParticles(NULL)
{
  ...
  fRecParticles = new TClonesArray("IlcRSTACKRecParticle",100) ;
  fRecParticles->SetName("RECPARTICLES");

}

//____________________________________________________________________________
IlcRSTACKPID::IlcRSTACKPID(const IlcRSTACKPID & pid) :
  TObject(pid),
  fGeom(pid.fGeom),
  fESD(pid.fESD), 
...
//____________________________________________________________________________
void IlcRSTACKPID::SetInput(TTree *clustersTree, TClonesArray *trackSegments)
{
