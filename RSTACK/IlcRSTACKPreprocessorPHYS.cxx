...
#include "IlcRSTACKPreprocessorPHYS.h"

ClassImp(IlcRSTACKPreprocessorPHYS)

//_______________________________________________________________________________________
IlcRSTACKPreprocessorPHYS::IlcRSTACKPreprocessorPHYS() : IlcPreprocessor("PHS",0) {
  //default constructor
}
//_______________________________________________________________________________________
IlcRSTACKPreprocessorPHYS::IlcRSTACKPreprocessorPHYS(IlcShuttleInterface* shuttle): IlcPreprocessor("PHS",shuttle) {
  // Constructor
...
//_______________________________________________________________________________________
UInt_t IlcRSTACKPreprocessorPHYS::Process(TMap* /*valueSet*/){
...
//_______________________________________________________________________________________
Bool_t IlcRSTACKPreprocessorPHYS::CalibratePhys(){
  //process PHYSICS event retrieved by the Shuttle
  //
  
  TList* list = 0;
  list = GetFileSources(kDAQ,"RSTACKDApi0mip");
  if(!list) {
  ...
  while ((source = dynamic_cast<TObjString *> (iter.Next()))) {
    ...
    TString fileName = GetFile(kDAQ, "RSTACKDApi0mip", source->GetName());
