#ifndef ILCRSTACKTRURAWREADER_H
#define ILCRSTACKTRURAWREADER_H
 ...
 */
class IlcRSTACKTRURawReader : public TObject
{
 public:
  IlcRSTACKTRURawReader();
  virtual ~IlcRSTACKTRURawReader();
 ...
 private:
  IlcRSTACKTRURawReader(const IlcRSTACKTRURawReader &); // not implemented
  IlcRSTACKTRURawReader& operator= (const IlcRSTACKTRURawReader &); // not implemented
 ...
 private:  
  ...
  ClassDef(IlcRSTACKTRURawReader, 1)
};

#endif // ILCRSTACKTRURAWREADER_H
