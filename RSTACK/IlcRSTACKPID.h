#ifndef ILCRSTACKPID_H
#define ILCRSTACKPID_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */
                            
/* $Id: IlcRSTACKPID.h 44091 2010-10-05 09:46:25Z prsnko $ */
...
//  Algorithm class for the identification of particles detected in RSTACK        
//  base  class                             
...
class IlcRSTACKPID : public TObject {

 public:

  IlcRSTACKPID() ;          // ctor            
  IlcRSTACKPID (IlcRSTACKGeometry *geom);
  IlcRSTACKPID(const IlcRSTACKPID & pid) ;
  virtual ~IlcRSTACKPID() ; // dtor
  IlcRSTACKPID & operator = (const IlcRSTACKPID & /*rvalue*/)  {
...
private: 
  ...
  ClassDef(IlcRSTACKPID,8)  // Particle Identifier algorithm (base class)

} ;

#endif // ILCRSTACKPID_H
