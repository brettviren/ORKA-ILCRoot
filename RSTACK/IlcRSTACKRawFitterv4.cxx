...
// If sample is not in saturation, a coarse algorithm is used (a-la IlcRSTACKRawFitterv0)
// If sample is in saturation, the unsaturated part of the sample is fit a-la IlcRSTACKRawFitterv1
// 
//     IlcRSTACKRawFitterv4 *fitterv4=new IlcRSTACKRawFitterv4();
...
ClassImp(IlcRSTACKRawFitterv4)

//-----------------------------------------------------------------------------
IlcRSTACKRawFitterv4::IlcRSTACKRawFitterv4():
...
Bool_t IlcRSTACKRawFitterv4::Eval(const UShort_t *signal, Int_t sigStart, Int_t sigLength)
{
...
//===================================================
Bool_t IlcRSTACKRawFitterv4::EvalWithFitting(TArrayI*samples, TArrayI * times){
