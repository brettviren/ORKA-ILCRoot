#ifndef ILCRSTACKSUPPORTGEOMETRY_H
#define ILCRSTACKSUPPORTGEOMETRY_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcRSTACKSupportGeometry.h 14911 2006-08-28 10:01:56Z kharlov $ */

//_________________________________________________________________________
// Geometry class  for RSTACK : Support which holds all RSTACK modules.
// Its data members provide geometry parametrization of
// the RSTACK support which can be changed in the constructor only.
...
class IlcRSTACKSupportGeometry : public TObject {

public: 

  IlcRSTACKSupportGeometry();
  virtual ~IlcRSTACKSupportGeometry(void) {}
...
private:
  ...
  Float_t fCradleWallThickness ;    // RSTACK cradle wall thickness
  Float_t fCradleWall[5] ;          // Size of the wall of the RSTACK cradle (shape TUBS)
  Float_t fCradleWheel[3] ;         // "Wheels" by which the cradle rolls over the rails

  ClassDef(IlcRSTACKSupportGeometry,1) // RSTACK support geometry class 

} ;

#endif // IlcRSTACKSUPPORTGEOMETRY_H
