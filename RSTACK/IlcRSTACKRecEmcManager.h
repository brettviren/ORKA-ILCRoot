#ifndef IlcRSTACKRecEmcManager_H
#define IlcRSTACKRecEmcManager_H
...
class IlcRSTACKRecEmcManager : public IlcRSTACKRecManager {

 public: 

  IlcRSTACKRecEmcManager();
  ~IlcRSTACKRecEmcManager(void);
 ...
 private:
  ...
  ClassDef(IlcRSTACKRecEmcManager,1)        // Emc reconstruction management class 

} ;

#endif // IlcRSTACKRecEmcManager_H
