#ifndef ILCRSTACKEMCCILCBDATA_H
#define ILCRSTACKEMCCILCBDATA_H
...
class IlcRSTACKEmcCalibData: public TNamed {

 public:
  IlcRSTACKEmcCalibData();
  IlcRSTACKEmcCalibData(const char* name);
  IlcRSTACKEmcCalibData(const IlcRSTACKEmcCalibData &calibda);
  IlcRSTACKEmcCalibData& operator= (const IlcRSTACKEmcCalibData &calibda);
  virtual ~IlcRSTACKEmcCalibData();
  void Reset();
...
protected:
  ...
  //
  ClassDef(IlcRSTACKEmcCalibData,5)    // RSTACK EMC calibration data
};
