#ifndef ILCRSTACKRECOPARAM_H
#define ILCRSTACKRECOPARAM_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                          */

/* $Id: IlcRSTACKRecoParam.h 53524 2011-12-11 21:34:35Z policheh $ */
...
class IlcRSTACKRecoParam : public IlcDetectorRecoParam {

public:

  IlcRSTACKRecoParam();
  IlcRSTACKRecoParam(const IlcRSTACKRecoParam& recoParam);
  IlcRSTACKRecoParam& operator = (const IlcRSTACKRecoParam& recoParam);
  virtual ~IlcRSTACKRecoParam() {}
  ...
  static IlcRSTACKRecoParam* GetDefaultParameters();
...
protected:
  ...
  Float_t fTimeGateLow ;           // EMC: Time difference between cells in RSTACK cluster (bad time estimate)
  Float_t fTimeGateHigh ;          // EMC: Time difference between cells in RSTACK cluster (good time estimate)
  ...
  TString fEMCFitterVersion ;      // EMC: IlcRSTACKRawFitter version
  ...
  static TObject* fgkTrigParams;   // RSTACK trigger parameters

  ClassDef(IlcRSTACKRecoParam,12)
};
