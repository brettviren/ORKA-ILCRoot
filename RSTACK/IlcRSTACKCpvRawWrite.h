#ifndef ILCRSTACKCPVRAWWRITE_H
#define ILCRSTACKCPVRAWWRITE_H
...
class IlcRSTACKCpvRawWrite : public TObject
{
public:

  IlcRSTACKCpvRawWrite() ;
  virtual ~IlcRSTACKCpvRawWrite() ;  
  void WriteRaw(const TObjArray *digits);
  void HWaddress(const IlcRSTACKDigit *digit, UInt_t &w32, Int_t &ddl, Int_t &row, Int_t &dilogic, Int_t &address);
 ...
 protected:
  ...
  ClassDef(IlcRSTACKCpvRawWrite,1)  // CPV raw data writer

};

#endif // IlcRSTACKCPVRAWWRITE_H
