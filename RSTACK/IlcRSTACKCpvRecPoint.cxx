...
/* $Id: IlcRSTACKCpvRecPoint.cxx 44661 2010-10-27 09:18:21Z hristov $ */
...
ClassImp(IlcRSTACKCpvRecPoint)

//____________________________________________________________________________
IlcRSTACKCpvRecPoint::IlcRSTACKCpvRecPoint() : 
  IlcRSTACKEmcRecPoint(),
  fLengX(-1),
  fLengZ(-1)
{
  // ctor
...
//____________________________________________________________________________
IlcRSTACKCpvRecPoint::IlcRSTACKCpvRecPoint(const char * opt) : 
  IlcRSTACKEmcRecPoint(opt),
  fLengX(-1),
  fLengZ(-1)
{
   // ctor
...
//____________________________________________________________________________
Bool_t IlcRSTACKCpvRecPoint::AreNeighbours(IlcRSTACKDigit * digit1, IlcRSTACKDigit * digit2 ) const
{
...
//____________________________________________________________________________
Int_t IlcRSTACKCpvRecPoint::Compare(const TObject * obj) const
{
  ...
  IlcRSTACKCpvRecPoint * clu  = (IlcRSTACKCpvRecPoint *) obj ; 
...
void IlcRSTACKCpvRecPoint::ExecuteEvent(Int_t, Int_t, Int_t ) /*const*/
{
...
//   IlcRSTACKLoader * gime =  IlcRSTACKLoader::GetInstance() ; 
...
//     IlcRSTACKGeometry * RSTACKgeom =  (IlcRSTACKGeometry *) fGeom ;
//     Int_t iDigit;
//     Int_t relid[4] ;
    
//     const Int_t kMulDigit = IlcRSTACKCpvRecPoint::GetDigitsMultiplicity() ; 
...
//       digit = (IlcRSTACKDigit *) ( gime->Digit(fDigitsList[iDigit]) ) ;
...
//____________________________________________________________________________
void IlcRSTACKCpvRecPoint::EvalAll(TClonesArray * digits)
{
  // Evaluate local coordinate assuming the vertex in (000) and no inclination
  IlcRSTACKEmcRecPoint::EvalAll(digits) ;
}
//____________________________________________________________________________
void IlcRSTACKCpvRecPoint::EvalAll(Float_t logWeight, TVector3 &vtx, TClonesArray * digits)
{
  // wraps other methods
  TVector3 vInc(0,1,0);
  IlcRSTACKEmcRecPoint::EvalAll(logWeight,vtx,digits) ;
  EvalLocalPosition(logWeight, vtx, digits,vInc) ;
  EvalClusterLengths(digits) ;
}
//____________________________________________________________________________
void IlcRSTACKCpvRecPoint::EvalLocalPosition(Float_t logWeight, TVector3 & /*vtx */, TClonesArray * digits, TVector3 &/* vInc */)
{
...
//____________________________________________________________________________
void IlcRSTACKCpvRecPoint::EvalClusterLengths(TClonesArray * digits)
{
  ...
  for(Int_t iDigit=0; iDigit<fMulDigit; iDigit++) {
    ...
    RSTACKgeom->AbsToRelNumbering(absId, relid) ;
...
//____________________________________________________________________________
void IlcRSTACKCpvRecPoint::Print(const Option_t *) const
{
  // Print the list of digits belonging to the cluster
  
  TString message ; 
  message  =  "IlcRSTACKCpvRecPoint: " ;
  message +=  "Digits #   " ;
