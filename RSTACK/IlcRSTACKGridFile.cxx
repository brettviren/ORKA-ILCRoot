 ...
 **************************************************************************/
/* $Id: IlcRSTACKGridFile.cxx 47780 2011-02-24 15:37:59Z kharlov $ */
...
#include "IlcLog.h"
#include "IlcRSTACKGridFile.h"

ClassImp(IlcRSTACKGridFile)

//____________________________________________________________________________
IlcRSTACKGridFile::IlcRSTACKGridFile(TString grid):
  fGrid(0),
  ...
  fPath("")
{
  ...
  if (grid == "alien")
    ...
    Error("IlcRSTACKGridFile", " %s is an unknown grid system", grid.Data()) ;
  if ( !fGrid )
...
#else
  Error("IlcRSTACKGridFile", "needs to be ported to new TGrid");
#endif
...
//____________________________________________________________________________
IlcRSTACKGridFile::IlcRSTACKGridFile(const IlcRSTACKGridFile &rhs) :
  TObject(rhs),
  fGrid(0),
  fRoot(""),
  fYear(""),
...
//____________________________________________________________________________
IlcRSTACKGridFile::~IlcRSTACKGridFile()
{
}

//____________________________________________________________________________
TString IlcRSTACKGridFile::GetLFN() const
{
...
//____________________________________________________________________________
void IlcRSTACKGridFile::Copy(TObject & obj)const
{
  //Copy method used by the Copy ctor
  IlcRSTACKGridFile &lfn = static_cast<IlcRSTACKGridFile &>(obj);
...
//____________________________________________________________________________
void IlcRSTACKGridFile::ListEvents() const
{
...
//____________________________________________________________________________
void IlcRSTACKGridFile::ListRuns() const
{
...
//____________________________________________________________________________
Bool_t IlcRSTACKGridFile::SetYearProd(TString year, TString prod)
{
...
//____________________________________________________________________________
Bool_t IlcRSTACKGridFile::SetVers(TString vers)
{
  // set the year and verifies if the directory exists
  Bool_t rv = kFALSE ;
  char tempo[80] ;
...
//____________________________________________________________________________
Bool_t IlcRSTACKGridFile::SetType(TString type)
{
  // set the year and verifies if the directory exists
  Bool_t rv = kFALSE ;
  char tempo[80] ;
...
//____________________________________________________________________________
Bool_t IlcRSTACKGridFile::SetPath(TString year, TString prod, TString vers, TString type)
{
  // set the year and verifies if the directory exists
  Bool_t rv = kFALSE ;
  char tempo[80] ;
...
//____________________________________________________________________________
Bool_t IlcRSTACKGridFile::SetRun(Int_t run)
{
  // set the year and verifies if the directory exists
  Bool_t rv = kFALSE ;
...
//____________________________________________________________________________
Bool_t IlcRSTACKGridFile::SetEvt(Int_t evt)
{
  // set the year and verifies if the directory exists
  Bool_t rv = kFALSE ;
