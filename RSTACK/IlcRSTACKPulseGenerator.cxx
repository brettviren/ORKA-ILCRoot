...
/* $Id: IlcRSTACKPulseGenerator.cxx 54863 2012-02-28 12:10:29Z hristov $ */

// The class which simulates the pulse shape from the RSTACK FEE shaper,
// make sampled amplitudes, digitize them.
// Use case:
//   IlcRSTACKPulseGenerator *pulse = new IlcRSTACKPulseGenerator(energy,time);
...
ClassImp(IlcRSTACKPulseGenerator) 

Int_t    IlcRSTACKPulseGenerator::fgOrder       = 2 ;        // order of the Gamma function
Double_t IlcRSTACKPulseGenerator::fgTimePeak    = 2.1E-6 ;   // tau=2.1 micro seconds
Double_t IlcRSTACKPulseGenerator::fgTimeTrigger = 100E-9 ;   // one tick 100 ns

//-----------------------------------------------------------------------------
IlcRSTACKPulseGenerator::IlcRSTACKPulseGenerator(Double_t a, Double_t t0)
...
//-----------------------------------------------------------------------------
IlcRSTACKPulseGenerator::~IlcRSTACKPulseGenerator()
{
...
//-----------------------------------------------------------------------------
void IlcRSTACKPulseGenerator::Reset()
{
...
//-----------------------------------------------------------------------------
void IlcRSTACKPulseGenerator::AddBaseline(Double_t baselineLevel)
{
...
//-----------------------------------------------------------------------------
void IlcRSTACKPulseGenerator::AddNoise(Double_t sigma)
{
...
//-----------------------------------------------------------------------------
void IlcRSTACKPulseGenerator::AddNoise(Double_t * /* sigma */, Double_t /* cutoff */)
{
  ...
  IlcError("not implemented yet");
}

//-----------------------------------------------------------------------------
void IlcRSTACKPulseGenerator::AddPretriggerSamples(Int_t nPresamples)
{
...
//-----------------------------------------------------------------------------
void IlcRSTACKPulseGenerator::Digitize()
{
...
//-----------------------------------------------------------------------------
Double_t IlcRSTACKPulseGenerator::RawResponseFunction(Double_t *x, Double_t *par) 
{
...
Bool_t IlcRSTACKPulseGenerator::MakeSamples()
{
  // for a start time fTZero and an amplitude fAmplitude given by digit, 
  // calculates the raw sampled response IlcRSTACKPulseGenerator::RawResponseFunction
...
//__________________________________________________________________
void IlcRSTACKPulseGenerator::GetSamples(Int_t *adcHG, Int_t *adcLG) const
{
...
//__________________________________________________________________
void IlcRSTACKPulseGenerator::Print(Option_t*) const
{
...
//__________________________________________________________________
void IlcRSTACKPulseGenerator::Draw(Option_t* opt)
{
