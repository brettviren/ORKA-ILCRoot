#ifndef ILCRSTACKSIMPARAM_H
#define ILCRSTACKSIMPARAM_H
...
class IlcRSTACKSimParam : public TNamed {

public:

  IlcRSTACKSimParam();
  IlcRSTACKSimParam(const IlcRSTACKSimParam& recoParam);
  IlcRSTACKSimParam& operator = (const IlcRSTACKSimParam& recoParam);
  virtual ~IlcRSTACKSimParam() {}

  static IlcRSTACKSimParam * GetInstance() ;

  //Parameters used in conversion of deposited energy to photons [see IlcRSTACKv1 for details]
  ...
  //Parameters used to convert photons in electronic signal [see IlcRSTACKDigitizer for details]
  ...
  //Parameters for energy digitization [see IlcRSTACKDigitizer for details]
  ...
  //Parameters for EMC TOF resolution [see IlcRSTACKDigitizer::TimeResolution()]
...
private:
  ...
  IlcRSTACKSimParam(Int_t i); //True constructor which should be called by GetInstance()

private:

  //Parameters used in conversion of deposited energy to photons (IlcRSTACKv1)
  Float_t  fLightYieldMean ;        //Average number of photoelectrons per GeV
  Float_t  fBirks ;                //Birk's constant
  Float_t  fAttenuationLength ;

  
  //Parameters used in electronic noise calculation and thresholds (IlcRSTACKDigitizer)
  ...
  Bool_t fCellNonLinearityOn ;  //Model scintillator non-linearity in IlcRSTACKDigitizer
  
  static IlcRSTACKSimParam * fgSimParam ; // pointer to the unique instance of the class

  ClassDef(IlcRSTACKSimParam,3)
};
