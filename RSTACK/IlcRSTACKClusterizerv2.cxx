...
/* $Id: IlcRSTACKClusterizerv2.cxx 20956 2007-09-26 14:22:18Z cvetan $ */
...
#include "IlcLog.h"
#include "IlcRSTACKClusterizerv2.h"
...
ClassImp(IlcRSTACKClusterizerv2)

//____________________________________________________________________________
IlcRSTACKClusterizerv2::IlcRSTACKClusterizerv2() : IlcRSTACKClusterizerv1() 
{}

//____________________________________________________________________________
IlcRSTACKClusterizerv2::IlcRSTACKClusterizerv2(IlcRSTACKGeometry *geom):
IlcRSTACKClusterizerv1(geom)
{}

//____________________________________________________________________________
void IlcRSTACKClusterizerv2::GetNumberOfClustersFound(int* numb) const
{
...
//____________________________________________________________________________
void IlcRSTACKClusterizerv2::Digits2Clusters(Option_t* option)
{
  // Steering method
...
//   IlcRSTACKGetter * gime = IlcRSTACKGetter::Instance() ; 

//   TFolder* wPoolF =  gime->RSTACKLoader()->GetDetectorDataFolder();
...
//     IlcRSTACKEvalRecPoint* rp=0;

//     // CPV reconstruction

//     IlcRSTACKRecCpvManager* recCpv = new IlcRSTACKRecCpvManager();
//     wPoolF->Add(recCpv);

//     Int_t iPoint; //loop variable

//     for(iPoint=0; iPoint<gime->CpvRecPoints()->GetEntriesFast(); iPoint++) {
//       rp = new IlcRSTACKEvalRecPoint(iPoint, kTRUE);
//       rp->MakeJob();
//     }

//     IlcRSTACKEvalRecPoint pt;
...
//     IlcRSTACKRecEmcManager* recEmc = new IlcRSTACKRecEmcManager();
//     wPoolF->Add(recEmc);

//     for(iPoint=0; iPoint<gime->EmcRecPoints()->GetEntriesFast(); iPoint++) {
//       rp = new IlcRSTACKEvalRecPoint(iPoint, kFALSE);
//       rp->MakeJob();
//     }
...
//     IlcInfo(Form("took %f seconds for Clusterizing", gBenchmark->GetCpuTime("RSTACKClusterizer") )) ;
//   }
// }

//____________________________________________________________________________
Int_t IlcRSTACKClusterizerv2::AreNeighbours(IlcRSTACKDigit* d1, IlcRSTACKDigit* d2) const
{
  ...
  if ( (relid1[0] == relid2[0]) && (relid1[1]==relid2[1]) ) { // inside the same RSTACK module and the same PPSD Module 
