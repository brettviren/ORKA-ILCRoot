...
// @(#) $Id: IlcRawEquipmentHeader.cxx 23623 2008-01-29 15:55:43Z cvetan $
...
ClassImp(IlcRawEquipmentHeader)

//______________________________________________________________________________
IlcRawEquipmentHeader::IlcRawEquipmentHeader():
  fSize(0),
  fEquipmentType(0),
...
//______________________________________________________________________________
UInt_t IlcRawEquipmentHeader::SwapWord(UInt_t x) const
{
...
//______________________________________________________________________________
void IlcRawEquipmentHeader::Swap()
{
...
//______________________________________________________________________________
void IlcRawEquipmentHeader::Reset()
{
...
void IlcRawEquipmentHeader::Print( const Option_t* opt ) const
{
  ...
  Int_t ddlIndex;
  cout << opt << "  Equipment ID: " << fEquipmentID << " ( " << IlcDAQ::DetectorNameFromDdlID(fEquipmentID,ddlIndex) << " )" << endl;
