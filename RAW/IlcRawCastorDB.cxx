// @(#) $Id: IlcRawCastorDB.cxx 32401 2009-05-15 14:01:03Z cvetan $
...
ClassImp(IlcRawCastorDB)


//______________________________________________________________________________
IlcRawCastorDB::IlcRawCastorDB(IlcRawEventV2 *event,
			       IlcESDEvent *esd,
			       Int_t compress,
   ...
   : IlcRawDB(event, esd, compress, fileName, basketsize)
{
   ...
   if (!init) {
      ...
      if (!gSystem->Getenv("RH_HOST"))
         Error("IlcRawRFIODB", "RH_HOST not set");
      if (!gSystem->Getenv("SVCCLASS"))
         Error("IlcRawRFIODB", "SVCCLASS not set");
      init = 1;
   }
...
//______________________________________________________________________________
const char *IlcRawCastorDB::GetFileName() const
{
