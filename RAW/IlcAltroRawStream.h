#ifndef ILCALTRORAWSTREAM_H
#define ILCALTRORAWSTREAM_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcAltroRawStream.h 35667 2009-10-18 21:18:59Z cvetan $ */
...
class IlcAltroRawStream: public TObject {
  public :
    IlcAltroRawStream(IlcRawReader* rawReader);
    virtual ~IlcAltroRawStream();
    ...
    IlcAltroRawStream& operator = (const IlcAltroRawStream& stream);
    IlcAltroRawStream(const IlcAltroRawStream& stream);
  ...
  private :
    ...
    ClassDef(IlcAltroRawStream, 0)  // base class for reading Altro raw digits
};
