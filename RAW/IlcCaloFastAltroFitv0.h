...
#ifndef ILCCALOFASTALTROFITV0_H
#define ILCCALOFASTALTROFITV0_H
...
class IlcCaloFastAltroFitv0 : public TNamed {

public:

  IlcCaloFastAltroFitv0();
  IlcCaloFastAltroFitv0(const char* name, const char* title,
  const Double_t sig=1.3, const Double_t tau=2.35, const Double_t n=2.);
  virtual ~IlcCaloFastAltroFitv0(); 
...
private:
  IlcCaloFastAltroFitv0(const IlcCaloFastAltroFitv0 &obj);
  IlcCaloFastAltroFitv0& operator= (const IlcCaloFastAltroFitv0 &obj);

  ClassDef(IlcCaloFastAltroFitv0,1) // Class for fast altro fitting
};

#endif // ILCCALOFASTALTROFITV0_H
