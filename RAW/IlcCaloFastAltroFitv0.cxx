...
// Feb 17, 2009
// Implementation of fit procedure from ILC-INT-2008-026:
...
#include "IlcCaloFastAltroFitv0.h"
...
ClassImp(IlcCaloFastAltroFitv0)

//____________________________________________________________________________
  IlcCaloFastAltroFitv0::IlcCaloFastAltroFitv0() 
: TNamed(), 
...
//____________________________________________________________________________
IlcCaloFastAltroFitv0::IlcCaloFastAltroFitv0(const char* name, const char* title, 
...
//____________________________________________________________________________
IlcCaloFastAltroFitv0::IlcCaloFastAltroFitv0(const IlcCaloFastAltroFitv0 &obj)
  : TNamed(obj), 
...
//____________________________________________________________________________
IlcCaloFastAltroFitv0& IlcCaloFastAltroFitv0::operator= (const IlcCaloFastAltroFitv0 &/*obj*/)
{
  // Not implemented yet
  return (*this);
}

void IlcCaloFastAltroFitv0::FastFit(Int_t* t, Int_t* y, Int_t nPoints, Double_t sig, Double_t tau, 
...
//____________________________________________________________________________
void IlcCaloFastAltroFitv0::FastFit(TH1F* h, Double_t sig, Double_t tau, Double_t n,
...
void IlcCaloFastAltroFitv0::Reset()
{
  // Reset variables
  fSig  = fTau = 0.0;
...
void IlcCaloFastAltroFitv0::GetFitResult(Double_t &amp,Double_t &eamp,Double_t &t0,Double_t &et0, 
...
void IlcCaloFastAltroFitv0::GetFittedPoints(Int_t &nfit, Double_t* ar[2]) const
{
  nfit  = fNfit;
  ar[0] = fTfit;
  ar[1] = fAmpfit;
...
// static functions
// 
void  IlcCaloFastAltroFitv0::CutRightPart(Int_t *t,Int_t *y,Int_t nPoints,Double_t tMax, Int_t &ii)
{
...
void IlcCaloFastAltroFitv0::DeductPedestal(Int_t* t, Int_t* y, Int_t nPoints, Double_t tau, Double_t ped, 
...
void IlcCaloFastAltroFitv0::FastFit(const Double_t* t, const Double_t* y, const Int_t nPoints, 
                                    ...
                                    Double_t &amp, Double_t &eamp, Double_t &t0, Double_t &et0, Double_t &chi2)
{
  ...
  if(nPoints<2) {
    printf(" IlcCaloFastAltroFitv0::FastFit : nPoints<=%i \n", nPoints); 
    return;
  }
...
Bool_t IlcCaloFastAltroFitv0::QuadraticRoots(const Double_t a, const Double_t b, const Double_t c, 
...
void IlcCaloFastAltroFitv0::Amplitude(const Double_t* t,const Double_t* y,const Int_t nPoints, 
...
void IlcCaloFastAltroFitv0::CalculateParsErrors(const Double_t* t, const Double_t* /*y*/, const Int_t nPoints, 
                                                const Double_t sig, const Double_t tau, 
...
// Drawing
//
TCanvas* IlcCaloFastAltroFitv0::DrawFastFunction()
{
  // QA of fitting
...
Double_t IlcCaloFastAltroFitv0::StdResponseFunction(const Double_t *x, const Double_t *par)
{
  // Static Standard Response Function : 
  // look to Double_t IlcEMCALRawUtils::RawResponseFunction(Double_t *x, Double_t *par)
