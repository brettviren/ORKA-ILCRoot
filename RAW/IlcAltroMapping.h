#ifndef IlcALTROMAPPING_H
#define IlcALTROMAPPING_H
...
class IlcAltroMapping: public TObject {
 public:
  IlcAltroMapping();
  IlcAltroMapping(const char *mappingFile);
  virtual ~IlcAltroMapping();
 ...
 private:
  ...
  IlcAltroMapping(const IlcAltroMapping& mapping);
  IlcAltroMapping& operator = (const IlcAltroMapping& mapping);

  ClassDef(IlcAltroMapping,4)  // Altro mapping handler class
};
