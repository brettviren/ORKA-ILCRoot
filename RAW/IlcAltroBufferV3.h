...
#ifndef IlcALTROBUFFERV3_H
#define IlcALTROBUFFERV3_H

#include "IlcAltroBuffer.h"

class IlcAltroBufferV3: public IlcAltroBuffer {
 public:
  IlcAltroBufferV3(const char* fileName, IlcAltroMapping *mapping = NULL);
  virtual ~IlcAltroBufferV3();
 ...
 protected:
  ...
  IlcAltroBufferV3(const IlcAltroBufferV3& source);
  IlcAltroBufferV3& operator = (const IlcAltroBufferV3& source);
  ...
  ClassDef(IlcAltroBufferV3,0)  // Interface to the Altro format
};
