/*
  ...
  gSystem->AddIncludePath("-I$ILC_ROOT/STAT")
  gSystem->Load("$ILC_ROOT/lib/tgt_linux/libSTAT.so");
  .L $ILC_ROOT/STAT/Macros/kDTreeTest.C+ 
  ...
  TestSizeIF();      // test the size of kdtree - search application - Ilc TPC tracker situation
  //
*/
