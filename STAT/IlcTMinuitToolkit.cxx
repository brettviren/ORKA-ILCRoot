...
/* $Id: IlcTMinuitToolkit.cxx 51523 2011-09-09 14:46:37Z fca $ */
...
#include "IlcTMinuitToolkit.h"

//--------------------------------------------------------------------------------------
//
// The IlcTMinuitToolkit serves as an easy to use interface for the TMinuit 
// package: 
// 
...
//
// A small example illustrating the usage of IlcTMinuitToolkit is given in the function 
// "IlcTMinuitToolkit::Test()".
// 
// 
...
// 5. examples:
//
//  A small example illustrating the working principles of IlcTMinuitToolkit is given
//  in the function "IlcTMinuitToolkit::Test()".
//
//
//
...
ClassImp(IlcTMinuitToolkit)

IlcTMinuitToolkit::IlcTMinuitToolkit() : 
   TNamed(),
   fFormula(0),
   fWeightFunction(0),
   fFitAlgorithm(""),
...
IlcTMinuitToolkit::IlcTMinuitToolkit(const IlcTMinuitToolkit&) :
   TNamed(),
   fFormula(0),
   fWeightFunction(0),
   fFitAlgorithm(""),
...
IlcTMinuitToolkit& IlcTMinuitToolkit::operator=(const IlcTMinuitToolkit&) {
...
void IlcTMinuitToolkit::FitHistogram(TH1F *const his) {
 //
...
void IlcTMinuitToolkit::FitHistogram(TH2F *const his) {
 //
...
void IlcTMinuitToolkit::SetWeightFunction(const Char_t *name, Float_t param1, Float_t param2) {
 //
...
void IlcTMinuitToolkit::FitterFCN(int &/*npar*/, double */*dummy*/, double &fchisq, double *gin, int /*iflag*/){
  //
  // internal function which gives the specified function to the TMinuit function
  //  

  //
  IlcTMinuitToolkit * fitter = (IlcTMinuitToolkit*)TVirtualFitter::GetFitter()->GetObjectFit();
  fchisq = 0;
...
void IlcTMinuitToolkit::Fit() {
  ...
  minuit->SetFCN(IlcTMinuitToolkit::FitterFCN);
...
void IlcTMinuitToolkit::Test() {
 ...
 IlcTMinuitToolkit * tool = new IlcTMinuitToolkit();
