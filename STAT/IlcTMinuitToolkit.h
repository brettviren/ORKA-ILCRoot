#ifndef ILCTMINUITTOOLKIT_H
#define ILCTMINUITTOOLKIT_H
...
class IlcTMinuitToolkit: public TNamed{
public:
  //
  //
  //
  IlcTMinuitToolkit();
  virtual ~IlcTMinuitToolkit();
...
private:
  //
  IlcTMinuitToolkit(const IlcTMinuitToolkit&); // fake copy constr. -- suppress warnings
  IlcTMinuitToolkit& operator=(const IlcTMinuitToolkit&); // fake -- suppress warnings
  //
