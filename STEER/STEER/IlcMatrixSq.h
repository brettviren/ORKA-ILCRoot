#ifndef ILCMATRIXSQ_H
#define ILCMATRIXSQ_H
...
class IlcMatrixSq : public TMatrixDBase {
  //
 public:
  IlcMatrixSq(): fSymmetric(kFALSE) {}
  IlcMatrixSq(const IlcMatrixSq &src) : TMatrixDBase(src), fSymmetric(src.fSymmetric) {}
  virtual ~IlcMatrixSq() {}
  IlcMatrixSq& operator=(const IlcMatrixSq &src);
 ...
 protected:
  ...
  //
  ClassDef(IlcMatrixSq,1) //Square Matrix Class
};


//___________________________________________________________
inline void IlcMatrixSq::MultiplyByVec(const TVectorD &vecIn, TVectorD &vecOut) const
{
