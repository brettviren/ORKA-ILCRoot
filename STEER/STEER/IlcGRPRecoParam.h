#ifndef ILCGRPRECOPARAM_H
#define ILCGRPRECOPARAM_H
...
// (initially, parameters for IlcVertexerTracks)                             //
...
class IlcGRPRecoParam : public IlcDetectorRecoParam
{
 public: 
  IlcGRPRecoParam();
  virtual ~IlcGRPRecoParam();

  static IlcGRPRecoParam *GetLowFluxParam();// make reco parameters for low flux env.
  static IlcGRPRecoParam *GetHighFluxParam();// make reco parameters for high flux env. 
  static IlcGRPRecoParam *GetCosmicTestParam();// make reco parameters for cosmics env. 
  ...
  IlcGRPRecoParam(const IlcGRPRecoParam&);
  IlcGRPRecoParam& operator=(const IlcGRPRecoParam&);

 protected:
  //

  Double_t fMostProbablePt; // to be used for B=0 tracking
  Bool_t   fVertexerTracksConstraintITS; // diamond constr for IlcVertexerTracks
  Bool_t   fVertexerTracksConstraintTPC; // diamond constr for IlcVertexerTracks
  Int_t    fVertexerTracksNCuts;  // number of cuts for IlcVertexerTracks

  // cuts for IlcVertexerTracks: ITS mode
  ...
  // cuts for IlcVertexerTracks: TPC-only mode
  ...
  //
  Int_t    fVertexerV0NCuts;      // number of cuts for IlcV0vertexer

  // cuts for IlcV0vertexer:
  ...
  Int_t    fVertexerCascadeNCuts; // number of cuts for IlcCascadeVertexer

  // cuts for IlcCascadeVertexer:
  ...
  ClassDef(IlcGRPRecoParam,7) // global reco parameters
};

inline void  IlcGRPRecoParam::SetVertexerTracksTPCClusterization(Bool_t use, Double_t dzcut, Double_t nsigmazcut)
{
...
inline  void  IlcGRPRecoParam::SetVertexerTracksITSClusterization(Bool_t use, Double_t dzcut, Double_t nsigmazcut)
{
