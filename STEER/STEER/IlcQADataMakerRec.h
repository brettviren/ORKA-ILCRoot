#ifndef ILCQADATAMAKERREC_H
#define ILCQADATAMAKERREC_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */


/* $Id: IlcQADataMakerRec.h 50615 2011-07-16 23:19:19Z hristov $ */
//
//  Base Class:
...
class IlcQADataMakerRec: public IlcQADataMaker {
  
public:
	
	IlcQADataMakerRec(const char * name="", const char * title="") ;          // ctor
	IlcQADataMakerRec(const IlcQADataMakerRec& qadm) ;   
	IlcQADataMakerRec& operator = (const IlcQADataMakerRec& qadm) ;
	virtual ~IlcQADataMakerRec() ; // dtor
  ...
  virtual const IlcDetectorRecoParam * GetRecoParam() { return fRecoParam ; }
  ...
  virtual void        InitRaws()                          {IlcInfo("To be implemented by detectors");}
  virtual void        InitRecPoints()                     {IlcInfo("To be implemented by detectors");}
  virtual void        InitDigits()                        {IlcInfo("To be implemented by detectors");}
  virtual void        InitESDs()                          {IlcInfo("To be implemented by detectors");}
  ...
  virtual void        SetRecoParam(const IlcDetectorRecoParam *param) { fRecoParam = param; }
  //
...
protected: 
  ...
  virtual void   InitHits()                          {IlcWarning("Call not valid") ; }
  //virtual void   InitRecParticles()                {IlcInfo("To be implemented by detectors");}
  virtual void   InitSDigits()                       {IlcWarning("Call not valid") ; }
  //virtual void   InitTrackSegments()               {IlcInfo("To ne implemented by detectors");}
  virtual void   MakeESDs(IlcESDEvent * )            {IlcInfo("To be implemented by detectors");} 
  virtual void   MakeHits()                          {IlcWarning("Call not valid") ; }
  virtual void   MakeHits(TTree * )                  {IlcWarning("Call not valid") ; }  
  ...
  //virtual void   MakeRecParticles()                {IlcInfo("To be implemented by detectors");} 
  virtual void   MakeRaws(IlcRawReader *)            {IlcInfo("To be implemented by detectors");} 
  virtual void   MakeRecPoints(TTree * )             {IlcInfo("To be implemented by detectors");} 
  virtual void   MakeSDigits()                       {IlcWarning("Call not valid") ; }     
  virtual void   MakeSDigits(TTree * )               {IlcWarning("Call not valid") ; }    
  ...
  const IlcDetectorRecoParam *fRecoParam;         //! const pointer to the reco parameters to be used in the reco QA
  TClonesArray *              fRecPointsArray;    //! Array that contains the RecPoints    
  
 ClassDef(IlcQADataMakerRec,4)  // description 

};

#endif // ILCQADATAMAKERREC_H
