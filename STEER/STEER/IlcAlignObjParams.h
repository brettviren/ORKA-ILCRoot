#ifndef ILCILCGNOBJANGLES_H
#define ILCILCGNOBJANGLES_H

/*****************************************************************************
 * IlcAlignObjParams: derived alignment class storing alignment information  *
...
class IlcAlignObjParams : public IlcAlignObj{
 public:
  IlcAlignObjParams();
  IlcAlignObjParams(const char* symname, UShort_t volUId, Double_t x, Double_t y, Double_t z, Double_t psi, Double_t theta, Double_t phi, Bool_t global) throw (const Char_t *);
  IlcAlignObjParams(const char* symname, UShort_t volUId, TGeoMatrix& m, Bool_t global) throw (const Char_t *);
  IlcAlignObjParams(const IlcAlignObj& theAlignObj);
  IlcAlignObjParams& operator= (const IlcAlignObj& theAlignObj);
  virtual ~IlcAlignObjParams();
