...
//______________________________________________________________________________
IlcFstream::IlcFstream(const char *fileName):
  fFile(0x0),
  fBuffer(0x0),
  fBufferSize(0)
{
...
//______________________________________________________________________________
void IlcFstream::Seekp(UInt_t position)
{
...
//______________________________________________________________________________
UInt_t IlcFstream::Swap(UInt_t x)
{
...
//______________________________________________________________________________
void IlcFstream::WriteBuffer(const char *buffer, UInt_t size, Bool_t force)
{
  ...
  if ((size % sizeof(UInt_t)) != 0)
    IlcFatal(Form("Size of the buffer is not multiple of 4 (size = %d) !",size));
