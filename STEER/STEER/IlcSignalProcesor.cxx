...
/* $Id: IlcSignalProcesor.cxx 50615 2011-07-16 23:19:19Z hristov $ */
...
Double_t asymgauss(Double_t* x, Double_t* par)
{
  ...
  Double_t  exp1    = par3save*TMath::Exp(-par3save*(dx-0.5*par3save*sigma2))
    *(1-IlcMathBase::ErfFast((par3save*sigma2-dx)/(sqrt2*par2save)));

  Double_t  exp2    = par5save*TMath::Exp(-par5save*(dx-0.5*par5save*sigma2))
    *(1-IlcMathBase::ErfFast((par5save*sigma2-dx)/(sqrt2*par2save)));
...
Double_t asymgaussN(Double_t* x, Double_t* par)
{
  ...
  Double_t  exp1    = par3save*TMath::Exp(-par3save*(dx-0.5*par3save*sigma2))
    *0.5*(1-IlcMathBase::ErfFast((par3save*sigma2-dx)/(sqrt2*par2save)));

  Double_t  exp2    = par5save*TMath::Exp(-par5save*(dx-0.5*par5save*sigma2))
    *0.5*(1-IlcMathBase::ErfFast((par5save*sigma2-dx)/(sqrt2*par2save)));
...
TF1 * IlcSignalProcesor::GetAsymGauss()
{
...
void IlcSignalProcesor::SplineSmoother(const Double_t *ampin, Double_t *ampout, Int_t n) const
{  
  //
  //
  Float_t in[10000];
...
void IlcSignalProcesor::TailCancelationALTRO(const Double_t *ampin, Double_t *ampout, Float_t k, Float_t l, Int_t n) const
{
  //
  // ALTRO
  Float_t temp;
...
//
//
void IlcSignalProcesor::TailCancelationTRD(const Double_t *ampin, Double_t *ampout, Float_t r, Float_t c, 
		      Int_t n) const
{
  //TRD
  //
...
void IlcSignalProcesor::TailMaker(const Double_t *ampin, Double_t *ampout, Float_t lambda, 
		      Int_t n) const
{
...
void IlcSignalProcesor::TailCancelationALTRO1(Double_t *ampin, Double_t *ampout, Float_t norm, 
...
void IlcSignalProcesor::TailCancelationTRD1(Double_t *ampin, Double_t *ampout, Float_t norm, 
					  Float_t lambda, Int_t n)
{
  //
  //
...
void IlcSignalProcesor::TailCancelationMI(const Double_t *ampin, Double_t *ampout, Float_t norm, 
...
void IlcSignalProcesor::TailMakerSpline(const Double_t *ampin, Double_t *ampout, Float_t lambda, 
		      Int_t n) const
{
