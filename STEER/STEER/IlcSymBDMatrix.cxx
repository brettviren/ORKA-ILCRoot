...
ClassImp(IlcSymBDMatrix)


//___________________________________________________________
IlcSymBDMatrix::IlcSymBDMatrix() 
: fElems(0)
{
  // def. c-tor
  fSymmetric = kTRUE;
...
//___________________________________________________________
IlcSymBDMatrix::IlcSymBDMatrix(Int_t size, Int_t w)
  : IlcMatrixSq(),fElems(0)
{
...
//___________________________________________________________
IlcSymBDMatrix::IlcSymBDMatrix(const IlcSymBDMatrix &src) 
  : IlcMatrixSq(src),fElems(0)
{
  // copy c-tor
...
//___________________________________________________________
IlcSymBDMatrix&  IlcSymBDMatrix::operator=(const IlcSymBDMatrix& src)
{
  // assignment
  //
  if (this != &src) {
...
//___________________________________________________________
void IlcSymBDMatrix::Clear(Option_t*)
{
  // clear dynamic part
...
//___________________________________________________________
Float_t IlcSymBDMatrix::GetDensity() const
{
...
//___________________________________________________________
void IlcSymBDMatrix::Print(Option_t* option) const
{
  // print data
...
//___________________________________________________________
void IlcSymBDMatrix::MultiplyByVec(const Double_t *vecIn,Double_t *vecOut) const
{
...
//___________________________________________________________
void IlcSymBDMatrix::AddToRow(Int_t r, Double_t *valc,Int_t *indc,Int_t n)
{
...
//___________________________________________________________
void IlcSymBDMatrix::DecomposeLDLT()
{
...
//___________________________________________________________
void IlcSymBDMatrix::Solve(Double_t *rhs)
{
...
//___________________________________________________________
void IlcSymBDMatrix::Solve(const Double_t *rhs,Double_t *sol)
{
  // solve matrix equation
