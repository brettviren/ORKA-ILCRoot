#ifndef ILCMILLEPEDERECORD_H
#define ILCMILLEPEDERECORD_H
...
class IlcMillePedeRecord : public TObject
{
 public:
  IlcMillePedeRecord();
  IlcMillePedeRecord(const IlcMillePedeRecord& src);
  IlcMillePedeRecord& operator=(const IlcMillePedeRecord& rhs);
  //
  virtual    ~IlcMillePedeRecord();
  void       Reset();
 ...
 protected:
  ...
  //
  ClassDef(IlcMillePedeRecord,3)                // Record of track residuals and local/global deriavtives
};

//_____________________________________________________________________________________________
inline void  IlcMillePedeRecord::AddIndexValue(Int_t ind, Double_t val) 
{
...
//_____________________________________________________________________________________________
inline Bool_t IlcMillePedeRecord::IsGroupPresent(Int_t id) const
{
