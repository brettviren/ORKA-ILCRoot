...
/* $Id: IlcGausCorr.cxx 50615 2011-07-16 23:19:19Z hristov $ */
...
ClassImp(IlcGausCorr)

//_______________________________________________________________________
IlcGausCorr::IlcGausCorr():
  fSize(0),
  fCv(0)
{
  //
...
//_______________________________________________________________________
IlcGausCorr::IlcGausCorr(const TMatrixD & vec, Int_t size):
  fSize(size),
...
//_______________________________________________________________________
IlcGausCorr::IlcGausCorr(const IlcGausCorr & tgcorr):
  TObject(tgcorr),
  fSize(tgcorr.fSize),
  fCv(new TMatrixD(fSize,fSize))
{
...
//_______________________________________________________________________
void IlcGausCorr::GetGaussN(TArrayD &vec) const
{
...
//_______________________________________________________________________
void IlcGausCorr::PrintCv() const
{
  // Printout of the "square root" cov. matrix 
  printf("\n IlcGausCorr - triangular matrix \n");
  for(Int_t i=0; i<fSize;i++){
...
//_______________________________________________________________________
IlcGausCorr & IlcGausCorr::operator=(const IlcGausCorr & tgcorr)
{
  // Assignment operator
