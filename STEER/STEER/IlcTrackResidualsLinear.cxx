...
/* $Id: IlcTrackResidualsLinear.cxx 50615 2011-07-16 23:19:19Z hristov $ */
...
ClassImp(IlcTrackResidualsLinear)

//______________________________________________________________________________
IlcTrackResidualsLinear::IlcTrackResidualsLinear():
  IlcTrackResiduals(),
  fFitter(0),
  fFraction(-1),
  fChi2Orig(0)
...
//______________________________________________________________________________
IlcTrackResidualsLinear::IlcTrackResidualsLinear(Int_t ntracks):
...
//______________________________________________________________________________
IlcTrackResidualsLinear::IlcTrackResidualsLinear(const IlcTrackResidualsLinear &res):
...
//______________________________________________________________________________
IlcTrackResidualsLinear &IlcTrackResidualsLinear::operator= (const IlcTrackResidualsLinear& res)
{
  // Assignment operator
 ((IlcTrackResiduals *)this)->operator=(res);
 return *this;
}
//______________________________________________________________________________
IlcTrackResidualsLinear::~IlcTrackResidualsLinear()
...
//______________________________________________________________________________
Bool_t IlcTrackResidualsLinear::Minimize()
{
...
//______________________________________________________________________________
void IlcTrackResidualsLinear::AddPoints(IlcTrackPoint &p, IlcTrackPoint &pprime)
{
  //
  ...
  if (IlcLog::GetDebugLevel("","IlcTrackResidualsLinear")>2){    
    //
    // debug part
    //
  ...
  for (Int_t idim = 1; idim<3; idim++){
    ...
    if (covDiagonal[idim]>0.){
      ...
      if (chi2>100 && IlcLog::GetDebugLevel("","IlcTrackResidualsLinear")>1){
  ...
  if (IlcLog::GetDebugLevel("","IlcTrackResidualsLinear")>1){
...
//______________________________________________________________________________
Bool_t IlcTrackResidualsLinear::Update()
{
  ...
  fIlcgnObj->SetPars(fParams[0], fParams[1], fParams[2],
