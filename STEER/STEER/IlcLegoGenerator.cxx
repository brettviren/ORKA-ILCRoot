...
/* $Id: IlcLegoGenerator.cxx 50615 2011-07-16 23:19:19Z hristov $ */
...
ClassImp(IlcLegoGenerator)

//_______________________________________________________________________
IlcLegoGenerator::IlcLegoGenerator():
  fRadMin(0),
  fRadMax(0),
  fZMax(0),
  fNCoor1(0),
...
//_______________________________________________________________________
IlcLegoGenerator::IlcLegoGenerator(Int_t nc1, Float_t c1min,
...
//_______________________________________________________________________
void IlcLegoGenerator::Generate()
{
  ...
  // Rootinos are 0
   ...
   if(fCoor1Bin>=fNCoor1-1)
     if(fCoor2Bin>=fNCoor2-1) {
       ...
       fCoor2Bin++;
       IlcDebug(1, Form("Generating rays in phi bin:%d",fCoor2Bin));
       fCoor1Bin=0;
     } else fCoor1Bin++;
   ...
   Float_t dilcmz = 3000;
   if (fRadMin > 0) {
       t = PropagateCylinder(orig,pmom,fRadMin,dilcmz);
       orig[0] = pmom[0]*t;
       orig[1] = pmom[1]*t;
       orig[2] = pmom[2]*t;
...
//_______________________________________________________________________
Float_t IlcLegoGenerator::PropagateCylinder(Float_t *x, Float_t *v, Float_t r, 
                                            Float_t z)
{
  //
