#ifndef ILC_MILLEPEDE_H 
#define ILC_MILLEPEDE_H

/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcMillepede.h 50615 2011-07-16 23:19:19Z hristov $ */
...
class IlcMillepede : public TObject {

public: 
  /// Standard constructor
  IlcMillepede();

  virtual ~IlcMillepede( ); /// Destructor
...
// Vectors and useful variables
  ...
  ClassDef(IlcMillepede, 1)  // Millepede Class
};
