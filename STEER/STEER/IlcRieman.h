...
/* $Id: IlcRieman.h 50615 2011-07-16 23:19:19Z hristov $ */
...
class IlcRieman : public TObject{
 public:
  IlcRieman();
  IlcRieman(Int_t capacity);
  IlcRieman(const IlcRieman &rieman);
  ~IlcRieman();
  void Reset();
 ...
 protected:  
 private:
  IlcRieman& operator=(const IlcRieman &rieman);
  ClassDef(IlcRieman,2)  // Fast fit of helices on ITS RecPoints
};
