...
/* $Id: IlcRun.cxx 30859 2009-02-02 16:24:37Z fca $ */
...
ClassImp(IlcVectorSparse)

//___________________________________________________________
IlcVectorSparse::IlcVectorSparse()
  : fNElems(0),fIndex(0),fElems(0) {}

//___________________________________________________________
IlcVectorSparse::IlcVectorSparse(const IlcVectorSparse& src)
...
//___________________________________________________________
void IlcVectorSparse::Clear(Option_t*)
{
  // clear all
...
//___________________________________________________________
IlcVectorSparse& IlcVectorSparse::operator=(const IlcVectorSparse& src)
{
  // assignment op-tor
...
//___________________________________________________________
Double_t IlcVectorSparse::FindIndex(Int_t ind) const
{
...
//___________________________________________________________
void IlcVectorSparse::SetToZero(Int_t ind)
{
...
//___________________________________________________________
Double_t& IlcVectorSparse::FindIndexAdd(Int_t ind)
{
...
void IlcVectorSparse::ReSize(Int_t sz,Bool_t copy)
{
  // change the size
...
//__________________________________________________________
void IlcVectorSparse::SortIndices(Bool_t valuesToo)
{
...
//__________________________________________________________
void IlcVectorSparse::Print(Option_t* opt)  const
{
  // print itself
...
//___________________________________________________________
void IlcVectorSparse::Add(Double_t *valc,Int_t *indc,Int_t n)
{
