#ifndef ILCSYMBDMATRIX_H
#define ILCSYMBDMATRIX_H
...
class IlcSymBDMatrix : public IlcMatrixSq {
  //
 public:
  enum {kDecomposedBit = 0x1};
  //
  IlcSymBDMatrix();
  IlcSymBDMatrix(Int_t size, Int_t w = 0);
  IlcSymBDMatrix(const IlcSymBDMatrix &mat);
  virtual ~IlcSymBDMatrix();
  //
  ...
  IlcSymBDMatrix& operator=(const IlcSymBDMatrix& src);
  ...
  //
  Double_t      DiagElem(Int_t r)                                const {return (*(const IlcSymBDMatrix*)this)(r,r);}
 ...
 protected:
  ...
  //
  ClassDef(IlcSymBDMatrix,0) //Symmetric Matrix Class
};


//___________________________________________________________
inline Int_t IlcSymBDMatrix::GetIndex(Int_t row,Int_t col) const
{
...
//___________________________________________________________
inline Int_t IlcSymBDMatrix::GetIndex(Int_t diagID) const
{
...
//___________________________________________________________
inline Double_t IlcSymBDMatrix::operator()(Int_t row, Int_t col) const
{
  // query element
...
//___________________________________________________________
inline Double_t& IlcSymBDMatrix::operator()(Int_t row, Int_t col)
{
...
//___________________________________________________________
inline Double_t IlcSymBDMatrix::operator()(Int_t row) const
{
  // query diagonal 
...
//___________________________________________________________
inline Double_t& IlcSymBDMatrix::operator()(Int_t row)
{
...
//___________________________________________________________
inline void IlcSymBDMatrix::MultiplyByVec(const TVectorD &vecIn, TVectorD &vecOut) const
{
