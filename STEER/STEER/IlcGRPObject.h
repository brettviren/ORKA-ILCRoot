#ifndef ILCGRPOBJECT_H
#define ILCGRPOBJECT_H
...
class IlcGRPObject : public TObject {
 public:
	...
	IlcGRPObject();
	IlcGRPObject(const IlcGRPObject & obj);
	IlcGRPObject& operator=(const IlcGRPObject & obj);
	~IlcGRPObject();
	...
	IlcDCSSensor*   GetCavernAtmosPressure() const {return fCavernAtmosPressure;}
	IlcDCSSensor*   GetCavernAtmosPressure2() const {return fCavernAtmosPressure2;}
	IlcDCSSensor*   GetSurfaceAtmosPressure() const {return fSurfaceAtmosPressure;}
	IlcDCSSensor*   GetBestCavernAtmosPressure() const ;
	IlcDCSSensor*   GetBestCavernAtmosPressure(const TTimeStamp& time) const;
	static IlcDCSSensor* GetBestCavernAtmosPressure(IlcDCSSensor* cavern1, 
	...
	void SetCavernAtmosPressure(IlcDCSSensor* const cavernAtmosPressure)  {fCavernAtmosPressure = cavernAtmosPressure;}
	void SetCavernAtmosPressure2(IlcDCSSensor* const cavernAtmosPressure)  {fCavernAtmosPressure2 = cavernAtmosPressure;}
	void SetSurfaceAtmosPressure(IlcDCSSensor* const surfacePressure)  {fSurfaceAtmosPressure = surfacePressure;}
	...
	static Double_t EvalCavernPressure(IlcDCSSensor* cavern1, 
	...
	void SetMagField(IlcMagF* MagField) {fMagField = MagField;}
	IlcMagF* GetMagField() const {return fMagField;}
 ...
 private:
	...
	IlcDCSSensor*  fCavernAtmosPressure;    // CavernAtmosPressure entry from DCS DB
	IlcDCSSensor*  fCavernAtmosPressure2;    // CavernAtmosPressure2 entry from DCS DB
	IlcDCSSensor*  fSurfaceAtmosPressure;   // SurfaceAtmosPressure entry from DCS DB
