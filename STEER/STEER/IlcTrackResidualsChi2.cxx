...
ClassImp(IlcTrackResidualsChi2)
...
void TrackResidualsChi2Fcn(Int_t &npar, Double_t *gin, Double_t &f, Double_t *par, Int_t iflag)
{
  ...
  IlcTrackResidualsChi2* dummy = (IlcTrackResidualsChi2 *)TVirtualFitter::GetFitter()->GetObjectFit();
  dummy->Chi2(npar, gin, f, par, iflag);
}

//______________________________________________________________________________
Bool_t IlcTrackResidualsChi2::Minimize()
{
...
//______________________________________________________________________________
void IlcTrackResidualsChi2::Chi2(Int_t & /* npar */, Double_t * /* gin */, Double_t &f, Double_t *par, Int_t /* iflag */)
{
  // Chi2 function to be minimized
  // Sums all the track residuals
  Double_t chi2 = 0;

  fIlcgnObj->SetPars(par[0],par[1],par[2],par[3],par[4],par[5]);
