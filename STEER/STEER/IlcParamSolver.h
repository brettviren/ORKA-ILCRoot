#ifndef ILCPARAMSOLVER_H
#define ILCPARAMSOLVER_H
...
class IlcParamSolver: public TObject
{
 public:
  ...
  IlcParamSolver();
  IlcParamSolver(Int_t maxglo,Int_t locsize=16);
  IlcParamSolver(const IlcParamSolver& src);
  IlcParamSolver& operator=(const IlcParamSolver& src);
  ~IlcParamSolver();
  //
 ...
 protected:
  IlcSymMatrix*    fMatrix;            // final matrix for global parameters (C in MP)
