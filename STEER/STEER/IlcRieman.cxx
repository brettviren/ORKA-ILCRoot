...
/* $Id: IlcRieman.cxx 50615 2011-07-16 23:19:19Z hristov $ */
...
IlcRieman::IlcRieman(Int_t capacity) :
  TObject(),
  fCapacity(capacity),
  fN(0),
...
IlcRieman::IlcRieman(const IlcRieman &rieman):
  TObject(rieman),
  fCapacity(rieman.fN),
  fN(rieman.fN),
  fX(new Double_t[fN]),
...
void IlcRieman::AddPoint(Double_t x, Double_t y, Double_t z, Double_t sy, Double_t sz)
{
  //
  //  Rieman update
  //
...
void IlcRieman::UpdateCovariancePol(){
  //
...
Double_t  IlcRieman::GetErrY(Double_t x) const{
  //
  //    P0'  = P0 + P1 * x +  P2 * x^2 
  //    P1'  =      P1     +  P2 * x
  //    P2'  =             +  P2
...
Double_t  IlcRieman::GetErrZ(Double_t x) const{
  //
...
Bool_t IlcRieman::GetExternalParameters(Double_t xref, Double_t *params, Double_t * covar){
  //
...
Double_t IlcRieman::GetYat(Double_t x) const {
  //
...
Double_t IlcRieman::GetDYat(Double_t x) const {
  //
...
Double_t IlcRieman::GetZat(Double_t x) const {
  //
...
Double_t IlcRieman::GetDZat(Double_t x) const {
  //
...
Bool_t IlcRieman::GetXYZat(Double_t r, Double_t alpha, Float_t *xyz) const
{
  //
...
Double_t IlcRieman::CalcChi2Y() const{ 
  //
...
Double_t IlcRieman::CalcChi2Z() const{
  //
...
Double_t IlcRieman::CalcChi2() const{
  //
...
IlcRieman * IlcRieman::MakeResiduals() const{
  //
  // create residual structure - ONLY for debug purposes
  //
  IlcRieman *rieman = new IlcRieman(fN);  
  for (Int_t i=0;i<fN;i++){
