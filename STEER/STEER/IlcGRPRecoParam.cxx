...
ClassImp(IlcGRPRecoParam)

//_____________________________________________________________________________
IlcGRPRecoParam::IlcGRPRecoParam() : IlcDetectorRecoParam(),
...
//_____________________________________________________________________________
IlcGRPRecoParam::~IlcGRPRecoParam() 
{
  //
  // destructor
  //  
...
IlcGRPRecoParam::IlcGRPRecoParam(const IlcGRPRecoParam& par) :
  IlcDetectorRecoParam(par),
...
//_____________________________________________________________________________
IlcGRPRecoParam& IlcGRPRecoParam::operator = (const IlcGRPRecoParam& par)
{
  // assignment operator

  if(&par == this) return *this;

  this->~IlcGRPRecoParam();
  new(this) IlcGRPRecoParam(par);
  return *this;
}

//_____________________________________________________________________________
IlcGRPRecoParam *IlcGRPRecoParam::GetHighFluxParam() 
{
  //
  // make default reconstruction  parameters for high flux env.
  //
  IlcGRPRecoParam *param = new IlcGRPRecoParam();
...
//_____________________________________________________________________________
IlcGRPRecoParam *IlcGRPRecoParam::GetLowFluxParam() 
{
  //
...
//_____________________________________________________________________________
IlcGRPRecoParam *IlcGRPRecoParam::GetCosmicTestParam() 
{
  //
...
//_____________________________________________________________________________
void IlcGRPRecoParam::GetVertexerTracksCuts(Int_t mode,Double_t *cuts, int n) const {
  //
...
//_____________________________________________________________________________
void IlcGRPRecoParam::SetVertexerTracksCuts(Int_t mode,Int_t ncuts,Double_t* cuts) {
  //
  // set cuts for ITS (0) or TPC (1) mode
  //
  if(ncuts!=fVertexerTracksNCuts) {
    printf("IlcGRPRecoParam: Number of IlcVertexerTracks cuts is %d\n",fVertexerTracksNCuts);
    return;
  }
...
//_____________________________________________________________________________
void IlcGRPRecoParam::GetVertexerV0Cuts(Double_t *cuts) const {
  //
  // get cuts for IlcV0vertexer
  //
...
//_____________________________________________________________________________
void IlcGRPRecoParam::SetVertexerV0Cuts(Int_t ncuts,Double_t cuts[7]) {
  //
  // set cuts for IlcV0vertexer
  //
  if(ncuts!=fVertexerV0NCuts) {
    printf("IlcGRPRecoParam: Number of IlcV0vertexer cuts is %d\n",fVertexerV0NCuts);
    return;
  }
...
//_____________________________________________________________________________
void IlcGRPRecoParam::GetVertexerCascadeCuts(Double_t *cuts) const {
  //
  // get cuts for IlcCascadevertexer
  //
...
//_____________________________________________________________________________
void IlcGRPRecoParam::SetVertexerCascadeCuts(Int_t ncuts,Double_t cuts[8]) {
  //
  // set cuts for IlcCascadeVertexer
  //
  if(ncuts!=fVertexerCascadeNCuts) {
    printf("IlcGRPRecoParam: Number of IlcCascadeVertexer cuts is %d\n",fVertexerCascadeNCuts);
    return;
  }
