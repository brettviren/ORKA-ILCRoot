#ifndef ILCMILLEPEDE2_H
#define ILCMILLEPEDE2_H
...
class IlcMillePede2: public TObject
{
 public:
  //
  ...
  //
  IlcMillePede2();
  IlcMillePede2(const IlcMillePede2& src);
  virtual ~IlcMillePede2();
  IlcMillePede2& operator=(const IlcMillePede2& )             {printf("Dummy\n"); return *this;}
  //
  ...
  //
  IlcMatrixSq*         GetGlobalMatrix()                const {return fMatCGlo;}
  IlcSymMatrix*        GetLocalMatrix()                 const {return fMatCLoc;}
  ...
  static void          SetIterSolverType(Int_t val=IlcMinResSolve::kSolMinRes) {fgIterSol = val;}
  ...
  //
  void   SetRecDataTreeName(const char* name=0)     {fRecDataTreeName = name;   if (fRecDataTreeName.IsNull()) fRecDataTreeName = "IlcMillePedeRecords_Data";}
  void   SetRecConsTreeName(const char* name=0)     {fRecConsTreeName = name;   if (fRecConsTreeName.IsNull()) fRecConsTreeName = "IlcMillePedeRecords_Consaints";}
  ...
  IlcMillePedeRecord*  GetRecord()                      const {return fRecord;}
 ...
 protected:
  ...
  //
  // Matrices
  IlcSymMatrix         *fMatCLoc;                        // Matrix C local
  IlcMatrixSq          *fMatCGlo;                        // Matrix C global
  IlcRectMatrix        *fMatCGloLoc;                     // Rectangular matrix C g*l 
  ...
  IlcMillePedeRecord   *fRecord;                         // Buffer of measurements records
  ...
  //
  ClassDef(IlcMillePede2,0)
};

//_____________________________________________________________________________________________
inline void IlcMillePede2::ReadRecordData(Long_t recID)       {fTreeData->GetEntry(recID); fCurrRecDataID=recID;}

//_____________________________________________________________________________________________
inline void IlcMillePede2::ReadRecordConstraint(Long_t recID) {fTreeConstr->GetEntry(recID); fCurrRecConstrID=recID;}

//_____________________________________________________________________________________________
inline void IlcMillePede2::SaveRecordData()                   {fTreeData->Fill(); fRecord->Reset(); fCurrRecDataID++;}

//_____________________________________________________________________________________________
inline void IlcMillePede2::SaveRecordConstraint()             {fTreeConstr->Fill(); fRecord->Reset();fCurrRecConstrID++;}
