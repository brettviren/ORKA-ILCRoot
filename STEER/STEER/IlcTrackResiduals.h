#ifndef ILCTRACKRESIDUALS_H
#define ILCTRACKRESIDUALS_H

//************************************************************************
// IlcTrackResiduals: base class for collecting the track space point    *
// residuals produced by the fast track fitters (IlcTrackFitter class).  *
...
// IlcAlignObj for the given detector volume.                            *
//************************************************************************
...
class IlcTrackResiduals : public TObject {

 public:

  IlcTrackResiduals();
  IlcTrackResiduals(Int_t ntracks);
  IlcTrackResiduals(const IlcTrackResiduals &res);
  IlcTrackResiduals& operator= (const IlcTrackResiduals& res);
  virtual ~IlcTrackResiduals();

  void   SetNTracks(Int_t ntracks);
  Bool_t AddTrackPointArrays(IlcTrackPointArray *volarray, IlcTrackPointArray *trackarray);
  void   InitAlignObj();
  ...
  Bool_t GetTrackPointArrays(Int_t i, IlcTrackPointArray* &volarray, IlcTrackPointArray* &trackarray) const;
  IlcAlignObj *GetAlignObj() const { return fIlcgnObj; }
 ...
 protected:
  ...
  IlcAlignObj        *fIlcgnObj;    // Pointer to the volume alignment object to be fitted
  IlcTrackPointArray **fVolArray;   //! Pointers to the arrays containing space points
  IlcTrackPointArray **fTrackArray; //! Pointers to the arrays containing track extrapolation points
