...
/////////////////////////////////////////////////////////////////////////////////
//                                                                             //
//  IlcLHCDipValT: templated class to store the array from processed           //
...
template<class Element> class IlcLHCDipValT : public TObject
{
 public:
  //
  enum {
  ...
  //
  IlcLHCDipValT(Int_t size=0, Double_t t=0);
  IlcLHCDipValT(const IlcLHCDipValT<Element> &src);
  virtual ~IlcLHCDipValT() {delete[] fArray;}
  IlcLHCDipValT& operator=(const IlcLHCDipValT<Element> &src);
 ...
 protected:
  ...
  //
  ClassDef(IlcLHCDipValT,1)
};


//__________________________________________________________________________
template<class Element>
IlcLHCDipValT<Element>::IlcLHCDipValT(Int_t size,Double_t t) 
...
//__________________________________________________________________________
template<class Element>
IlcLHCDipValT<Element>::IlcLHCDipValT(const IlcLHCDipValT<Element> &src)
...
//__________________________________________________________________________
template<class Element>
IlcLHCDipValT<Element>& IlcLHCDipValT<Element>::operator=(const IlcLHCDipValT<Element> &src)
{
  //assingment
  if (this != &src) {
...
//__________________________________________________________________________
template<class Element>
Char_t* IlcLHCDipValT<Element>::TimeAsString(double t, Bool_t utc)
{
...
//__________________________________________________________________________
template<class Element>
void IlcLHCDipValT<Element>::SetValue(Int_t i,Element v)
{
  //assign value
  if (i>=GetSizeTotal() || i<0) {
    IlcError(Form("Index %d is out of range 0:%d",i,GetSizeTotal()-1));
    return;
  }
  fArray[i] = v;
}
...
//__________________________________________________________________________
template<class Element>
void IlcLHCDipValT<Element>::SetValues(const Element* v, Int_t n)
{
  //assign value
...
//__________________________________________________________________________
template<class Element>
Element& IlcLHCDipValT<Element>::operator[](Int_t i)
{
...
//__________________________________________________________________________
template<class Element>
Element IlcLHCDipValT<Element>::operator[](Int_t i) const
{
  //obtain value
  if (i>=GetSizeTotal() || i<0) {
    IlcError(Form("Index %d is out of range 0:%d",i,GetSizeTotal()-1));
...
//__________________________________________________________________________
template<class Element>
Element IlcLHCDipValT<Element>::GetValue(Int_t i) const
{
  //obtain value
  if (i>=GetSizeTotal() || i<0) {
    IlcError(Form("Index %d is out of range 0:%d",i,GetSizeTotal()-1));
...
//__________________________________________________________________________
template<class Element>
void IlcLHCDipValT<Element>::SetSize(Int_t sz)
{
  //resize
  Element* arr = 0;
  if (sz>0) {
...
//__________________________________________________________________________
template<class Element>
void IlcLHCDipValT<Element>::Print(const Option_t *opt) const
{
...
//__________________________________________________________________________
template<class Element>
void IlcLHCDipValT<Element>::Clear(const Option_t *)
{
...
typedef IlcLHCDipValT<Double_t> IlcLHCDipValD;
typedef IlcLHCDipValT<Float_t>  IlcLHCDipValF;
typedef IlcLHCDipValT<Int_t>    IlcLHCDipValI;
typedef IlcLHCDipValT<Char_t>   IlcLHCDipValC;
