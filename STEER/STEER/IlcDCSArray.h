#ifndef ILC_DCS_ARRAY_H
#define ILC_DCS_ARRAY_H
...
class IlcDCSArray : public TObject {
 public:
	enum Type {
		kInvalid = 0,
		kBool = 1,
	...
	IlcDCSArray(Int_t nentries, Bool_t* value, Double_t timeStamp);
	IlcDCSArray(Int_t nentries, Char_t* value, Double_t timeStamp);
	IlcDCSArray(Int_t nentries, Int_t* value, Double_t timeStamp);
	IlcDCSArray(Int_t nentries, UInt_t* value, Double_t timeStamp);
	IlcDCSArray(Int_t nentries, Float_t* value, Double_t timeStamp);
	IlcDCSArray(Int_t nentries, Double_t* value, Double_t timeStamp);
	IlcDCSArray(Int_t nentries, TObjArray* value, Double_t timeStamp);
 ...
 private:
	IlcDCSArray(const IlcDCSArray& c);
	IlcDCSArray& operator=(const IlcDCSArray& c);
	
	ClassDef(IlcDCSArray, 2);
};
