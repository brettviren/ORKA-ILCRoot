#ifndef ILC_SURVEY_POINT_H
#define ILC_SURVEY_POINT_H
...
class IlcSurveyPoint: public TObject {

 public:
  IlcSurveyPoint();
  IlcSurveyPoint(TString name, Float_t x, Float_t y, Float_t z,
		 Float_t precX, Float_t precY, Float_t precZ, 
                 Char_t type, Bool_t Target);
  virtual ~IlcSurveyPoint();
