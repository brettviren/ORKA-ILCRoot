...
ClassImp(IlcMatrixSq)

IlcMatrixSq & IlcMatrixSq::operator=(const IlcMatrixSq &src)
{
  // = operator
...
void IlcMatrixSq::MultiplyByVec(const Double_t *vecIn,Double_t *vecOut) const
{
...
//___________________________________________________________
void IlcMatrixSq::PrintCOO() const
{
