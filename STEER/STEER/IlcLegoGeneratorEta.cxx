...
/* $Id: IlcLegoGeneratorEta.cxx 50615 2011-07-16 23:19:19Z hristov $ */
...
ClassImp(IlcLegoGeneratorEta)


//___________________________________________
void IlcLegoGeneratorEta::Generate()
{
  ...
  // Rootinos are 0
   ...
   if(fCoor1Bin>=fNCoor1-1)
     if(fCoor2Bin>=fNCoor2-1) {
       ...
       fCoor2Bin++;
       IlcDebug(1, Form("Generating rays in eta bin:%d",fCoor2Bin));
       fCoor1Bin=0;
     } else fCoor1Bin++;
