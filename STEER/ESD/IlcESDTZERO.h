...
// -*- mode: C++ -*- 
#ifndef ILCESDTZERO_H
#define ILCESDTZERO_H
...
class IlcESDTZERO: public TObject {
public:
  IlcESDTZERO();
  IlcESDTZERO(const IlcESDTZERO& tzero);
  IlcESDTZERO& operator=(const IlcESDTZERO& tzero);
