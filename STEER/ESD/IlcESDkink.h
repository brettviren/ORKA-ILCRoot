...
/* $Id: IlcESDkink.h 50615 2011-07-16 23:19:19Z hristov $ */
...
class IlcESDkink : public TObject {
public:
  IlcESDkink();             //constructor
  IlcESDkink(const IlcESDkink &source);             //constructor
  IlcESDkink& operator=(const IlcESDkink &source);
  virtual void Copy(TObject &obj) const;
  //
  void SetID(Short_t id){fID=id;}
  Short_t GetID(){return fID;}
  void SetMother(const IlcExternalTrackParam & pmother); 
  void SetDaughter(const IlcExternalTrackParam & pdaughter);
  ...
  //  
  const IlcExternalTrackParam& RefParamDaughter() {return fParamDaughter;}
  const IlcExternalTrackParam& RefParamMother()   {return fParamMother;}
 protected:

  IlcExternalTrackParam fParamDaughter;
  IlcExternalTrackParam fParamMother;
  ...
  ClassDef(IlcESDkink,4)      // ESD V0 vertex
};
