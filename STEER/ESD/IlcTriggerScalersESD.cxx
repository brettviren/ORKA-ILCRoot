...
ClassImp( IlcTriggerScalersESD )

//_____________________________________________________________________________
IlcTriggerScalersESD::IlcTriggerScalersESD(): 
  TObject(),
  fClassIndex(0),
  fLOCB(0),     
  fLOCA(0),     
...
//_____________________________________________________________________________
IlcTriggerScalersESD::IlcTriggerScalersESD( UChar_t classIndex, ULong64_t LOCB, ULong64_t LOCA,        
...
//_____________________________________________________________________________
IlcTriggerScalersESD::IlcTriggerScalersESD(UChar_t classIndex,ULong64_t* s64):
TObject(),
fClassIndex( classIndex ),
fLOCB(s64[0]),     
fLOCA(s64[1]),     
...
//_____________________________________________________________________________
IlcTriggerScalersESD::IlcTriggerScalersESD(const IlcTriggerScalersESD& scal ):   
  TObject(scal),
...
//_____________________________________________________________________________
IlcTriggerScalersESD& IlcTriggerScalersESD::operator=(const IlcTriggerScalersESD& scal)
{
...
void IlcTriggerScalersESD::GetAllScalers(ULong64_t *scalers) const
{
 scalers[0]=fLOCB;
 scalers[1]=fLOCA;
 scalers[2]=fL1CB;
...
//_____________________________________________________________________________
void IlcTriggerScalersESD::Print( const Option_t* ) const
{
   // Print
