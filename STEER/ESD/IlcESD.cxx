...
/* $Id: IlcESD.cxx 54863 2012-02-28 12:10:29Z hristov $ */
...
IlcESD::IlcESD():
  ...
  fT0timeStart(0),
  fT0trig(0),
  fTracks("IlcESDtrack",15000),
  fHLTConfMapTracks("IlcESDHLTtrack",25000),
  fHLTHoughTracks("IlcESDHLTtrack",15000),
  fMuonTracks("IlcESDMuonTrack",30),
  fPmdTracks("IlcESDPmdTrack",3000),
  fTrdTracks("IlcESDTrdTrack",300),
  fV0s("IlcESDv0",200),  
  fCascades("IlcESDcascade",20),
  fKinks("IlcESDkink",4000),
  fCaloClusters("IlcESDCaloCluster",10000),
  fEMCALClusters(0), 
  ...
  fESDVZERO(0x0),
  fESDACORDE(0x0),
  fErrorLogs("IlcRawDataErrorLog",5)
  #ifdef MFT_UPGRADE
 // ,fESDMFT(0x0)
  #endif
{
...
//______________________________________________________________________________
IlcESD::IlcESD(const IlcESD& esd):
  TObject(esd),
...
Bool_t  IlcESD::RemoveKink(Int_t rm) {
  // ---------------------------------------------------------
...
Bool_t  IlcESD::RemoveV0(Int_t rm) {
  // ---------------------------------------------------------
...
Bool_t  IlcESD::RemoveTrack(Int_t rm) {
  // ---------------------------------------------------------
...
Bool_t IlcESD::Clean(Float_t *cleanPars) {
  //
  ...
  const IlcESDVertex *vertex=GetVertex();
...
Int_t IlcESD::AddV0(const IlcESDv0 *v) {
  //
  // Add V0
  //
    Int_t idx=fV0s.GetEntriesFast();
    new(fV0s[idx]) IlcESDv0(*v);
    return idx;
}  

//______________________________________________________________________________
void IlcESD::Print(Option_t *) const 
{
  //
...
void IlcESD::SetESDfriend(const IlcESDfriend *ev) {
  //
...
void IlcESD::GetESDfriend(IlcESDfriend *ev) const {
  //
...
void IlcESD::SetDiamond(const IlcESDVertex *vertex)
{
  //
