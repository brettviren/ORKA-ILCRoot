#ifndef ILCMULTIPLICITY_H
#define ILCMULTIPLICITY_H
...
class IlcMultiplicity : public TObject {
 ...
 public:
  ...
  IlcMultiplicity();               // default constructor
  // standard constructor
  IlcMultiplicity(Int_t ntr,Float_t *th, Float_t *ph, Float_t *dth, Float_t *dph, Int_t *labels,
         Int_t* labelsL2, Int_t ns, Float_t *ts, Float_t *ps, Int_t *labelss, Short_t nfcL1, Short_t nfcL2, const TBits & fFastOrFiredChips);
  IlcMultiplicity(Int_t ntr, Int_t ns, Short_t nfcL1, Short_t nfcL2, const TBits & fFastOr);
  IlcMultiplicity(const IlcMultiplicity& m);
  IlcMultiplicity& operator=(const IlcMultiplicity& m);
  virtual void Copy(TObject &obj) const;
  virtual void Clear(Option_t* opt="");
  virtual ~IlcMultiplicity();
...
// methods to access single cluster information
  ...
  void AttachTracklet2TrackRefs(IlcRefArray* l1t1,IlcRefArray* l1t2,IlcRefArray* l2t1,IlcRefArray* l2t2) {
    fTCl2Tracks[0][0] = l1t1; fTCl2Tracks[0][1] = l1t2; fTCl2Tracks[1][0] = l2t1; fTCl2Tracks[1][1] = l2t2; 
  }
  void AttachCluster2TrackRefs(IlcRefArray* l1t1,IlcRefArray* l1t2) {
  ...
  protected:
  void Duplicate(const IlcMultiplicity &m);  // used by copy ctr.
  ...
  IlcRefArray *fTCl2Tracks[2][2]; // container with multiple tracklet_cluster->track references
  IlcRefArray *fSCl2Tracks[2];    // container with multiple single_cluster->track references
  ...
  ClassDef(IlcMultiplicity,19);
};

inline Int_t IlcMultiplicity::GetLabel(Int_t i, Int_t layer) const
{
    if(i>=0 && i<fNtracks) {
	if (layer == 0) {
	    return fLabels[i];
...
inline Int_t IlcMultiplicity::GetLabelSingle(Int_t i) const 
{
    if(i>=0 && i<fNsingle) {
...
inline Double_t IlcMultiplicity::CalcDist(Int_t i) const
{
...
inline Int_t IlcMultiplicity::GetNumberOfSingleClustersLr(Int_t lr) const
{
