#ifndef ILCESDCALOTRIGGER_H
#define ILCESDCALOTRIGGER_H
...
class IlcESDCaloTrigger : public TNamed 
{
public:
	         IlcESDCaloTrigger();
	         IlcESDCaloTrigger(const IlcESDCaloTrigger& ctrig);
	virtual ~IlcESDCaloTrigger();
	
	IlcESDCaloTrigger& operator=(const IlcESDCaloTrigger& ctrig);
