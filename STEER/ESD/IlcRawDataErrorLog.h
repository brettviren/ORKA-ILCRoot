#ifndef ILCRAWDATAERRORLOG_H
#define ILCRAWDATAERRORLOG_H
...
class IlcRawDataErrorLog: public TNamed {
 ...
 public:
  ...
  IlcRawDataErrorLog();
  IlcRawDataErrorLog(Int_t eventNumber, Int_t ddlId,
		     ERawDataErrorLevel errorLevel,
		     Int_t errorCode,
		     const char *message = NULL);
  IlcRawDataErrorLog(const IlcRawDataErrorLog & source);
  IlcRawDataErrorLog & operator=(const IlcRawDataErrorLog & source);
  virtual ~IlcRawDataErrorLog() {};
