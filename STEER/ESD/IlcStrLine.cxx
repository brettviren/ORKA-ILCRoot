...
/* $Id: IlcStrLine.cxx 53924 2012-01-16 09:30:34Z fca $ */
...
//________________________________________________________
IlcStrLine::IlcStrLine(const Double_t *const point, const Double_t *const cd, Bool_t twopoints, UShort_t id1, UShort_t id2) :
  TObject(),
  fWMatrix(0),
  fTpar(0)
{
...
//________________________________________________________
IlcStrLine::IlcStrLine(const Double_t *const point, const Double_t *const sig2point, const Double_t *const cd, Bool_t twopoints, UShort_t id1, UShort_t id2) :
  TObject(),
  fWMatrix(0),
  fTpar(0)
{
...
//________________________________________________________
IlcStrLine::IlcStrLine(const Double_t *const point, const Double_t *const sig2point, const Double_t *const wmat, const Double_t *const cd, Bool_t twopoints, UShort_t id1, UShort_t id2) :
  TObject(),
  fWMatrix(0),
  fTpar(0)
{
...
//________________________________________________________
IlcStrLine::IlcStrLine(const IlcStrLine &source):
  TObject(source),
  fWMatrix(0),
  fTpar(source.fTpar)
{
...
//________________________________________________________
IlcStrLine& IlcStrLine::operator=(const IlcStrLine& source)
{
  // Assignment operator
  if(this !=&source){
...
//________________________________________________________
void IlcStrLine::GetWMatrix(Double_t *wmat)const {
...
//________________________________________________________
void IlcStrLine::SetWMatrix(const Double_t *wmat) {
...
//________________________________________________________
void IlcStrLine::InitDirection(const Double_t *const point, const Double_t *const cd)
{
  ...
  else IlcFatal("Null direction cosines!!!");
}

//________________________________________________________
void IlcStrLine::InitTwoPoints(const Double_t *const pA, const Double_t *const pB)
{
...
//________________________________________________________
void IlcStrLine::PrintStatus() const {
...
//________________________________________________________
Int_t IlcStrLine::IsParallelTo(const IlcStrLine *line) const {
...
//________________________________________________________
Int_t IlcStrLine::Crossrphi(const IlcStrLine *line)
{
...
//________________________________________________________
Int_t IlcStrLine::CrossPoints(IlcStrLine *line, Double_t *point1, Double_t *point2){
...
Int_t IlcStrLine::Cross(IlcStrLine *line, Double_t *point)
{
...
Double_t IlcStrLine::GetDCA(const IlcStrLine *line) const
{
...
//________________________________________________________
void IlcStrLine::GetCurrentPoint(Double_t *point) const {
  // Fills the array point with the current value on the line
  for(Int_t i=0;i<3;i++)point[i]=fP0[i]+fCd[i]*fTpar;
}

//________________________________________________________
Double_t IlcStrLine::GetDistFromPoint(const Double_t *point) const 
{
  // computes distance from point 
  IlcStrLine tmpline(point, fCd, kFALSE);
  return GetDCA(&tmpline);
}

//________________________________________________________
Bool_t IlcStrLine::GetParamAtRadius(Double_t r,Double_t &t1,Double_t &t2) const
{
