#ifndef ILCESDV0PARAMS_H
#define ILCESDV0PARAMS_H
...
class IlcESDV0Params : public TObject{
  friend class IlcESDv0;              // ESD V0
 public:
  IlcESDV0Params();
 ...
 private:
  ...
  ClassDef(IlcESDV0Params,4)      // ESD V0 vertex - error and likelihood parameterization constant
};
