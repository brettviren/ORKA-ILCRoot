#ifndef ILCESDCASCADE_H
#define ILCESDCASCADE_H

/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcESDcascade.h 50615 2011-07-16 23:19:19Z hristov $ */
...
class IlcESDcascade : public IlcESDv0 {

public:
  IlcESDcascade();
  IlcESDcascade(const IlcESDcascade& cas);
  IlcESDcascade(const IlcESDv0 &v0,
                const IlcExternalTrackParam &t, Int_t i);
  ~IlcESDcascade();
  IlcESDcascade& operator=(const IlcESDcascade& cas);
...
private:
  ...
  ClassDef(IlcESDcascade,5) // reconstructed cascade vertex
};

inline
void IlcESDcascade::SetDcaXiDaughters(Double_t rDcaXiDaughters){
