...
/** @class IlcFMDMap
    ...
    class.  */
class IlcFMDMap : public TObject 
{
public:
  enum { 
   ...
   */  
  IlcFMDMap(const IlcFMDMap& other);
  /** Destructor */
  virtual ~IlcFMDMap() {}
   ...
   */
  IlcFMDMap& operator*=(const IlcFMDMap& o);
  /** 
   ...
   * 
   * @see Float_t IlcFMDMap::AtAsFloat(Int_t) const
   *
   * @param idx Index number
   * 
   ...
   * Virtal function to get the value at index @a idx as an integer
   * 
   * @see Float_t& IlcFMDMap::AtAsFloat(Int_t)
   *
   * @param idx Index number
   * 
   * @return Value at index as an integer
...
protected:
  ...
  ClassDef(IlcFMDMap, 4) // Cache of per strip information
};

inline Float_t
IlcFMDMap::AtAsFloat(Int_t) const
{
  return 0;
}
inline Float_t&
IlcFMDMap::AtAsFloat(Int_t)
{
  static Float_t d;
  return d;
}
inline Int_t
IlcFMDMap::AtAsInt(Int_t) const
{
  return 0;
}
inline Int_t&
IlcFMDMap::AtAsInt(Int_t)
{
  static Int_t d;
  return d;
}
inline UShort_t
IlcFMDMap::AtAsUShort(Int_t) const
{
  return 0;
}
inline UShort_t&
IlcFMDMap::AtAsUShort(Int_t)
{
  static UShort_t d;
  return d;
}
inline Bool_t
IlcFMDMap::AtAsBool(Int_t) const
{
  return kFALSE;
}
inline Bool_t&
IlcFMDMap::AtAsBool(Int_t)
{
  static Bool_t d;
  return d;
}
inline Bool_t
IlcFMDMap::ForOne::operator()(UShort_t, Char_t, UShort_t, UShort_t, Float_t)
{
  return kTRUE;
}
inline Bool_t
IlcFMDMap::ForOne::operator()(UShort_t, Char_t, UShort_t, UShort_t, Int_t)
{
  return kTRUE;
}
inline Bool_t
IlcFMDMap::ForOne::operator()(UShort_t, Char_t, UShort_t, UShort_t, UShort_t)
{
  return kTRUE;
}
inline Bool_t
IlcFMDMap::ForOne::operator()(UShort_t, Char_t, UShort_t, UShort_t, Bool_t)
{
  return kTRUE;
}
