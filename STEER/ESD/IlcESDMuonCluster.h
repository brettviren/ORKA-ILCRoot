#ifndef ILCESDMUONCLUSTER_H
#define ILCESDMUONCLUSTER_H

/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
* See cxx source for full Copyright notice                               */

// $Id: IlcESDMuonCluster.h 55446 2012-03-30 16:00:07Z hristov $
...
class IlcESDMuonCluster : public TObject {
public:
  IlcESDMuonCluster(); // Constructor
  virtual ~IlcESDMuonCluster(); //< Destructor
  IlcESDMuonCluster(const IlcESDMuonCluster& cluster);
  IlcESDMuonCluster& operator=(const IlcESDMuonCluster& cluster);
  ...
  void     MovePadsToESD(IlcESDEvent &esd);
...
protected:
  ...
  ClassDef(IlcESDMuonCluster, 4) // MUON ESD cluster class
};
