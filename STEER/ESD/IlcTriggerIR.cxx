...
ClassImp(IlcTriggerIR)

//_____________________________________________________________________________
IlcTriggerIR::IlcTriggerIR():
  TObject(),
  fOrbit(0),
  fNWord(0),
  fInt1(NULL),
...
//_____________________________________________________________________________
IlcTriggerIR::IlcTriggerIR(UInt_t orbit, UInt_t nwords, UInt_t *words, Bool_t incomplete, Bool_t transerr):
  TObject(),
  fOrbit(orbit),
  fNWord(nwords),
  fInt1(NULL),
...
IlcTriggerIR::IlcTriggerIR(const IlcTriggerIR &rec):
  TObject(rec),
  fOrbit(rec.fOrbit),
  fNWord(rec.fNWord),
  fInt1(NULL),
...
//_____________________________________________________________________________
IlcTriggerIR &IlcTriggerIR::operator =(const IlcTriggerIR& rec)
{
  // assignment operator
  //
...
//_____________________________________________________________________________
void IlcTriggerIR::Print( const Option_t* ) const
{
  // Print
