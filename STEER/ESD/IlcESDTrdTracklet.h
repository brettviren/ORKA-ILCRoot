#ifndef ILCESDTRDTRACKLET_H
#define ILCESDTRDTRACKLET_H
...
class IlcESDTrdTracklet : public TObject
{
 public:
  IlcESDTrdTracklet();
  IlcESDTrdTracklet(UInt_t trackletWord, Short_t hcid, Int_t label = -1);
  IlcESDTrdTracklet(const IlcESDTrdTracklet &trkl);
  IlcESDTrdTracklet& operator=(const IlcESDTrdTracklet &trkl);
  ~IlcESDTrdTracklet();
