...
/* $Id: IlcESDv0.cxx 54214 2012-01-29 17:56:54Z shahoian $ */
...
const IlcESDV0Params  IlcESDv0::fgkParams;
...
IlcESDv0::IlcESDv0(const IlcESDv0& v0) :
  IlcVParticle(v0),
  fParamN(v0.fParamN),
  fParamP(v0.fParamP),
...
IlcESDv0::IlcESDv0(const IlcExternalTrackParam &t1, Int_t i1,
  ...
  fDist2(0)
{
  ...
  if ((cN>0) && (cN != cP)) {
     fParamN.~IlcExternalTrackParam();
     new (&fParamN) IlcExternalTrackParam(t2);
     fParamP.~IlcExternalTrackParam();
     new (&fParamP) IlcExternalTrackParam(t1);
...
IlcESDv0& IlcESDv0::operator=(const IlcESDv0 &v0)
{
  //--------------------------------------------------------------------
...
void IlcESDv0::Copy(TObject& obj) const {
  ...
  if(this==&obj)return;
  IlcESDv0 *robj = dynamic_cast<IlcESDv0*>(&obj);
  if(!robj)return; // not an ilcesdv0
  *robj = *this;
}
...
Double_t IlcESDv0::E(Int_t pdg) const {
  //--------------------------------------------------------------------
...
Double_t IlcESDv0::Y(Int_t pdg) const {
  //--------------------------------------------------------------------
...
Double_t IlcESDv0::RapK0Short() const {
  //--------------------------------------------------------------------
...
Double_t IlcESDv0::RapLambda() const {
  //--------------------------------------------------------------------
...
Double_t IlcESDv0::AlphaV0() const {
  //--------------------------------------------------------------------
...
Double_t IlcESDv0::PtArmV0() const {
  //--------------------------------------------------------------------
...
Double_t IlcESDv0::ChangeMassHypothesis(Int_t code) {
  //--------------------------------------------------------------------
  ...
  case kK0Short: 
    break;
  default:
    IlcError("invalide PDG code ! Assuming K0s...");
    fPdgCode=kK0Short;
    break;
  }
...
void IlcESDv0::GetPxPyPz(Double_t &px, Double_t &py, Double_t &pz) const {
  //--------------------------------------------------------------------
...
void IlcESDv0::GetXYZ(Double_t &x, Double_t &y, Double_t &z) const {
  //--------------------------------------------------------------------
...
Float_t IlcESDv0::GetD(Double_t x0, Double_t y0) const {
  //--------------------------------------------------------------------
...
Float_t IlcESDv0::GetD(Double_t x0, Double_t y0, Double_t z0) const {
  //--------------------------------------------------------------------
...
Float_t IlcESDv0::GetV0CosineOfPointingAngle(Double_t refPointX, Double_t refPointY, Double_t refPointZ) const {
...
void IlcESDv0::GetPosCov(Double_t cov[6]) const {

  for (Int_t i=0; i<6; ++i) cov[i] = fPosCov[i];

}

Double_t IlcESDv0::GetSigmaY(){
  //
...
Double_t IlcESDv0::GetEffectiveSigmaD0(){
  //
...
Double_t IlcESDv0::GetEffectiveSigmaAP0(){
  //
...
Double_t  IlcESDv0::GetMinimaxSigmaAP0(){
  //
...
Double_t  IlcESDv0::GetMinimaxSigmaD0(){
  //
...
Double_t IlcESDv0::GetLikelihoodAP(Int_t mode0, Int_t mode1){
  //
...
Double_t IlcESDv0::GetLikelihoodD(Int_t mode0, Int_t mode1){
  //
...
Double_t IlcESDv0::GetLikelihoodC(Int_t mode0, Int_t /*mode1*/) const {
  //
  // get likelihood for Causality
  // !!!  Causality variables defined in IlcITStrackerMI !!! 
...
void IlcESDv0::SetCausality(Float_t pb0, Float_t pb1, Float_t pa0, Float_t pa1)
{
  //
  // set probabilities
  //
...
void  IlcESDv0::SetClusters(const Int_t *clp, const Int_t *clm)
{
  //
...
void IlcESDv0::SetP(const IlcExternalTrackParam & paramp)  {
  //
  // set track +
  //
  fParamP   = paramp;
...
void IlcESDv0::SetM(const IlcExternalTrackParam & paramm){
  //
  //set track -
  //
  fParamN = paramm;
...
void IlcESDv0::SetRp(const Double_t *rp){
  //
  // set pid +
  //
...
void IlcESDv0::SetRm(const Double_t *rm){
  //
  // set pid -
  //
...
Double_t IlcESDv0::GetEffMass(UInt_t p1, UInt_t p2) const{
  //
  ...
  */
  ...
  const IlcExternalTrackParam *paramP = GetParamP();
  const IlcExternalTrackParam *paramN = GetParamN();
...
Double_t IlcESDv0::GetKFInfo(UInt_t p1, UInt_t p2, Int_t type) const{
  //
  // type:
  //   0 - return mass
  //   1 - return err mass
  ...
  IlcKFParticle kfp1(  *(paramP), spdg[p1] *TMath::Sign(1,p1) );
  IlcKFParticle kfp2( *(paramN), spdg[p2] *TMath::Sign(1,p2) );
  IlcKFParticle *v0KF = new IlcKFParticle;
  *(v0KF)+=kfp1;
  *(v0KF)+=kfp2;
...
Double_t IlcESDv0::GetKFInfoScale(UInt_t p1, UInt_t p2, Int_t type, Double_t d1pt, Double_t s1pt) const{
  //
  // type
  //   0 - return mass
  //   1 - return err mass
