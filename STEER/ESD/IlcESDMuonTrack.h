#ifndef ILCESDMUONTRACK_H
#define ILCESDMUONTRACK_H

/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
* See cxx source for full Copyright notice                               */

/* $Id: IlcESDMuonTrack.h 55451 2012-03-30 17:10:39Z hristov $ */
...
class IlcESDMuonTrack : public IlcVParticle {
public:
  IlcESDMuonTrack(); //Constructor
  virtual ~IlcESDMuonTrack(); // Destructor
  IlcESDMuonTrack(const IlcESDMuonTrack& esdm);
  IlcESDMuonTrack& operator=(const IlcESDMuonTrack& esdm);
  ...
  void     MoveClustersToESD(IlcESDEvent &esd);
  ...
  // additional methods to comply with IlcVParticle
  ...
  static void AddEffInfo(UInt_t& pattern, Int_t slatOrInfo, Int_t board = 0, EIlcTriggerChPatternFlag effType = kNoEff);
  /// Chamber was hit
  ...
  IlcESDEvent* GetESDEvent() const {return fESDEvent;}
  void         SetESDEvent(IlcESDEvent* evt) {fESDEvent = evt;}  
...
protected:
  ...
  IlcESDEvent*   fESDEvent; //!Pointer back to event to which the track belongs
  
  ClassDef(IlcESDMuonTrack,15) // MUON ESD track class 
};
