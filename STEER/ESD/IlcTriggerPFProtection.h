#ifndef ILCTRIGGERPFPROTECTION_H
#define ILCTRIGGERPFPROTECTION_H
...
class IlcTriggerPFProtection : public TNamed {

public:
                          IlcTriggerPFProtection();
                          IlcTriggerPFProtection( TString & name);
                          IlcTriggerPFProtection( TString & name,TString & inta, TString & intb, TString & interaction );
			  IlcTriggerPFProtection(TString& name, UInt_t* pfdef);  
               virtual   ~IlcTriggerPFProtection() {}
...
private:
		...
		IlcTriggerPFProtection(const IlcTriggerPFProtection & inp );
		IlcTriggerPFProtection& operator = (const IlcTriggerPFProtection& inp);

   ClassDef( IlcTriggerPFProtection, 2 )  // Define a Trigger Past Future Protection 
};
