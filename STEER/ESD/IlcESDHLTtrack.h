#ifndef ILCESDHLTTRACK_H
#define ILCESDHLTTRACK_H
...
class IlcESDHLTtrack : public TObject {
public:
  IlcESDHLTtrack();
  virtual ~IlcESDHLTtrack() {}
  ...
  Bool_t UpdateTrackParams(const IlcKalmanTrack *t);
...
protected:
  ...
  ClassDef(IlcESDHLTtrack,3) //ESD HLT track class
};
