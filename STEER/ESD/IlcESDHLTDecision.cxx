// $Id: IlcESDHLTDecision.cxx 50615 2011-07-16 23:19:19Z hristov $
//**************************************************************************
...
ClassImp(IlcESDHLTDecision)

IlcESDHLTDecision::IlcESDHLTDecision()
  : TNamed(fgkName, "")
...
const char* IlcESDHLTDecision::fgkName="HLTGlobalTrigger";

IlcESDHLTDecision::IlcESDHLTDecision(bool result, const char* description)
...
IlcESDHLTDecision::IlcESDHLTDecision(const IlcESDHLTDecision& src)
  : TNamed(src)
...
IlcESDHLTDecision& IlcESDHLTDecision::operator=(const IlcESDHLTDecision& src)
{
  /// assignment operator
  TNamed::operator=(src);
...
const char* IlcESDHLTDecision::GetDescription() const
{
  /// get the description of the global trigger decision
  return GetTitle();
}

Bool_t    IlcESDHLTDecision::IsTriggerFired(const char* name) const
{
...
void IlcESDHLTDecision::Print(Option_t* option ) const
{
...
void IlcESDHLTDecision::Copy(TObject &object) const
{
  /// Inherited from TObject. Copy this to the specified object.
  if (object.IsA() != IsA()) return;

  IlcESDHLTDecision& target=dynamic_cast<IlcESDHLTDecision&>(object);
  target=*this;
}

TObject *IlcESDHLTDecision::Clone(const char */*newname*/) const
{
  /// Inherited from TObject. Create a new clone.
  return new IlcESDHLTDecision(*this);
}
