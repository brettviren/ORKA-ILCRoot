...
//______________________________________________________________________________
void IlcTrackPointArray::Sort(Bool_t down)
{
...
//______________________________________________________________________________
IlcTrackPoint::IlcTrackPoint(Float_t x, Float_t y, Float_t z, const Float_t *cov, UShort_t volid, Float_t charge, Float_t drifttime,Float_t chargeratio, Int_t clutyp) :
  TObject(),
  fX(0),
  fY(0),
  fZ(0),
...
//______________________________________________________________________________
IlcTrackPoint::IlcTrackPoint(const Float_t *xyz, const Float_t *cov, UShort_t volid, Float_t charge, Float_t drifttime,Float_t chargeratio, Int_t clutyp) :
  TObject(),
  fX(0),
  fY(0),
  fZ(0),
...
//______________________________________________________________________________
void IlcTrackPoint::SetCov(const Float_t *cov)
{
  // Set XYZ cov matrix
  //
  if (cov)
...
//_____________________________________________________________________________
Bool_t IlcTrackPoint::GetPCA(const IlcTrackPoint &p, IlcTrackPoint &out) const
{
  //
...
//______________________________________________________________________________
Bool_t IlcTrackPoint::GetRotMatrix(TGeoRotation& rot) const
{
...
void IlcTrackPoint::SetAlignCovMatrix(const TMatrixDSym& alignparmtrx){
  // Add the uncertainty on the cluster position due to alignment
  // (using the 6x6 IlcAlignObj Cov. Matrix alignparmtrx) to the already
  // present Cov. Matrix 
