...
#ifndef ILCKFPARTICLEBASE_H
#define ILCKFPARTICLEBASE_H

#include "TObject.h"

class IlcKFParticleBase :public TObject {
 ...
 public:
  ...
  virtual void GetDStoParticle( const IlcKFParticleBase &p, 
 ...
 //* Parameters, covariance matrix, charge, and mass hypothesis should be provided 
  ...
  void operator +=( const IlcKFParticleBase &Daughter );  

  //* Add daughter track to the particle 

  void AddDaughter( const IlcKFParticleBase &Daughter );

  void AddDaughterWithEnergyFit( const IlcKFParticleBase &Daughter );
  void AddDaughterWithEnergyCalc( const IlcKFParticleBase &Daughter );
  void AddDaughterWithEnergyFitMC( const IlcKFParticleBase &Daughter ); //with mass constrained

  //* Set production vertex 

  void SetProductionVertex( const IlcKFParticleBase &Vtx );
  ...
  void Construct( const IlcKFParticleBase *vDaughters[], Int_t NDaughters, 
		  const IlcKFParticleBase *ProdVtx=0,   Double_t Mass=-1, Bool_t IsConstrained=0  );
  ...
  void GetDStoParticleBz( Double_t Bz, const IlcKFParticleBase &p, 
  ...
  Double_t GetDistanceFromVertex( const IlcKFParticleBase &Vtx ) const;
  Double_t GetDistanceFromParticle( const IlcKFParticleBase &p ) const;
  ...
  Double_t GetDeviationFromVertex( const IlcKFParticleBase &Vtx ) const;
  Double_t GetDeviationFromParticle( const IlcKFParticleBase &p ) const;  

  //* Subtract the particle from the vertex  

  void SubtractFromVertex( IlcKFParticleBase &Vtx ) const;

  //* Special method for creating gammas

  void ConstructGammaBz( const IlcKFParticleBase &daughter1,
			 const IlcKFParticleBase &daughter2, double Bz  );

  //* return parameters for the Armenteros-Podolanski plot
  static void GetArmenterosPodolanski(IlcKFParticleBase& positive, IlcKFParticleBase& negative, Double_t QtAlfa[2] );
