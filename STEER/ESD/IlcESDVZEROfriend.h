#ifndef ILCESDVZEROFRIEND_H
#define ILCESDVZEROFRIEND_H
...
class IlcESDVZEROfriend: public TObject {
  public :
    IlcESDVZEROfriend();
    virtual ~IlcESDVZEROfriend();

    IlcESDVZEROfriend(const IlcESDVZEROfriend& vzerofriend);
    IlcESDVZEROfriend& operator = (const IlcESDVZEROfriend& vzerofriend);
...
// Getters of ADC signals, ADC pedestals, time information and corresponding flags :
  ...
  private:
    ...
    ClassDef(IlcESDVZEROfriend, 2) // container class for VZERO DDL raw data
};
