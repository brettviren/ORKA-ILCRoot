...
IlcAODZDC::IlcAODZDC(const IlcAODZDC &zdcAOD) :
  IlcVZDC(zdcAOD),
...
//__________________________________________________________________________
IlcAODZDC& IlcAODZDC::operator=(const IlcAODZDC& zdcAOD)
{
  // Assignment operator
  //
  if(this!=&zdcAOD) {
...
Double_t  IlcAODZDC::GetZNCEnergy() const
{
// Return ZNC energy
    if (fZNCEnergy < 0.) {
	fZNCEnergy = 0.;
...
//______________________________________________________________________________
Double_t  IlcAODZDC::GetZNAEnergy() const
{
// Return ZNA Energy
    if (fZNAEnergy < 0.) {
	fZNAEnergy = 0.;
...
//______________________________________________________________________________
Double_t  IlcAODZDC::GetZPCEnergy() const
{
// Return ZPC Energy
    if (fZPCEnergy < 0.) {
	fZPCEnergy = 0.;
...
//______________________________________________________________________________
Double_t  IlcAODZDC::GetZPAEnergy() const
{
// Return ZPA Energy
    if (fZPAEnergy < 0.) {
	fZPAEnergy = 0.;
...
//______________________________________________________________________________
void  IlcAODZDC::SetZNCTowers(const Double_t value[5], const Double_t valueLR[5])
{
  // Sets ZNC towers
  for(Int_t i=0; i<5; i++){
...
//______________________________________________________________________________
void  IlcAODZDC::SetZNATowers(const Double_t value[5], const Double_t valueLR[5])
{
  // Sets ZNA towers
  for(Int_t i=0; i<5; i++){
...
//______________________________________________________________________________
Bool_t IlcAODZDC::GetZNCentroidInPbPb(Float_t beamEne, Double_t centrZNC[2], Double_t centrZNA[2]) 
{
...
//______________________________________________________________________________
Bool_t IlcAODZDC::GetZNCentroidInpp(Double_t centrZNC[2], Double_t centrZNA[2]) 
{
