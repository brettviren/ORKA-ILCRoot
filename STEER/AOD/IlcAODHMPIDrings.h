#ifndef ILCAODHMPIDRINGS_H
#define ILCAODHMPIDRINGS_H
...
class IlcAODHMPIDrings : public TObject {
 ...
 public:
  ...
  IlcAODHMPIDrings(const IlcAODHMPIDrings& hmpidAOD);//
  IlcAODHMPIDrings &operator=(const IlcAODHMPIDrings& hmpidAOD);//
  virtual ~IlcAODHMPIDrings() {};
 ...
 protected:
  ...
  Double32_t  fHmpidAODpid[IlcPID::kSPECIES];      // [0.,0.,8] "detector response probabilities" (for the PID)
  Double32_t  fHMPIDmom[3];                          // [0.,0.,8] track momentum at the HMPID ring reconstruction
  
  ClassDef(IlcAODHMPIDrings,1)  
