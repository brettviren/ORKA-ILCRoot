#ifndef ILCAODVZERO_H
#define ILCAODVZERO_H
...
class IlcAODVZERO : public IlcVVZERO 
{
public:
  IlcAODVZERO();
  IlcAODVZERO(const IlcAODVZERO& source);
  IlcAODVZERO(const IlcVVZERO& source);
  IlcAODVZERO &operator=(const IlcAODVZERO& source);
  IlcAODVZERO &operator=(const IlcVVZERO& source);
