...
/* $Id: IlcAODJet.h 54128 2012-01-25 07:20:33Z kleinb $ */
...
class IlcAODJet : public IlcVParticle {

 public:
    IlcAODJet();
    IlcAODJet(Double_t px, Double_t py, Double_t pz, Double_t e);
    IlcAODJet(TLorentzVector & p);  
    virtual ~IlcAODJet();
    IlcAODJet(const IlcAODJet& jet); 
    IlcAODJet& operator=(const IlcAODJet& jet);
// IlcVParticle methods
    ...
    virtual Double_t   DeltaR(const IlcVParticle* part) const;
...
//
 ...
 private:
    ...
    ClassDef(IlcAODJet,11);

};

inline Double_t IlcAODJet::Phi() const
{
    // Return phi
