...
/* $Id: IlcAODVertex.cxx 53097 2011-11-23 09:17:58Z morsch $ */
...
//     Inheritance from IlcVVertex: A. Dainese
//-------------------------------------------------------------------------

#include "IlcAODVertex.h"
#include "IlcAODTrack.h"

ClassImp(IlcAODVertex)

//______________________________________________________________________________
IlcAODVertex::IlcAODVertex() : 
  IlcVVertex(),
  fChi2perNDF(-999.),
  fID(-1),
  fBCID(IlcVTrack::kTOFBCNA),
  fType(kUndef),
  fNprong(0),
  fIprong(0),
  fNContributors(0),
...
//______________________________________________________________________________
IlcAODVertex::IlcAODVertex(const Double_t position[3], 
...
//______________________________________________________________________________
IlcAODVertex::IlcAODVertex(const Float_t position[3], 
...
//______________________________________________________________________________
IlcAODVertex::IlcAODVertex(const IlcAODVertex& vtx) :
  IlcVVertex(vtx),
  ...
  fProngs(0)
{
  ...
  if (vtx.fCovMatrix) fCovMatrix=new IlcAODRedCov<3>(*vtx.fCovMatrix);
  MakeProngs();
...
//______________________________________________________________________________
IlcAODVertex* IlcAODVertex::CloneWithoutRefs() const
{
  ...
  IlcAODVertex* v = new IlcAODVertex(fPosition,
                                     cov,
                                     fChi2perNDF,
                                     0x0,
                                     fID,
...
//______________________________________________________________________________
IlcAODVertex& IlcAODVertex::operator=(const IlcAODVertex& vtx) 
{
  // Assignment operator
  if (this != &vtx) {

    // name and type
    IlcVVertex::operator=(vtx);
...
//______________________________________________________________________________
void IlcAODVertex::AddDaughter(TObject *daughter)
{
  // Add reference to daughter track
	...
	if (fIprong < fNprong) {
	    ...
	    IlcWarning("Number of daughters out of range !\n");
	}
    }
  return;
}
...
//______________________________________________________________________________
template <class T> void IlcAODVertex::GetSigmaXYZ(T sigma[3]) const
{
...
//______________________________________________________________________________
Int_t IlcAODVertex::GetNContributors() const 
{
  ...
  if (!vtitle.Contains("VertexerTracks")) {
	...
	IlcAODTrack* aodT = dynamic_cast<IlcAODTrack*>(fDaughters.At(iDaug));
	if (!aodT) continue;
...
//______________________________________________________________________________
Bool_t IlcAODVertex::HasDaughter(TObject *daughter) const 
{
...
//______________________________________________________________________________
Double_t IlcAODVertex::RotatedCovMatrixXX(Double_t phi, Double_t theta) const
{
  // XX term of covariance matrix after rotation by phi around z-axis
  // and, then, by theta around new y-axis

  if (!fCovMatrix) {
    //IlcFatal("Covariance matrix not set");
    return -999.;
  }
...
//______________________________________________________________________________
Double_t IlcAODVertex::RotatedCovMatrixXY(Double_t phi, Double_t theta) const
{
...
//______________________________________________________________________________
Double_t IlcAODVertex::RotatedCovMatrixXZ(Double_t phi, Double_t theta) const
{
...
//______________________________________________________________________________
Double_t IlcAODVertex::RotatedCovMatrixYY(Double_t phi) const
{
...
//______________________________________________________________________________
Double_t IlcAODVertex::RotatedCovMatrixYZ(Double_t phi, Double_t theta) const
{
...
//______________________________________________________________________________
Double_t IlcAODVertex::RotatedCovMatrixZZ(Double_t phi, Double_t theta) const
{
...
//______________________________________________________________________________
Double_t IlcAODVertex::Distance2ToVertex(const IlcAODVertex *vtx) const
{
  // distance in 3D to another IlcAODVertex
...
//______________________________________________________________________________
Double_t IlcAODVertex::DistanceXY2ToVertex(const IlcAODVertex *vtx) const
{
  // distance in XY to another IlcAODVertex
...
//______________________________________________________________________________
Double_t IlcAODVertex::Error2DistanceToVertex(IlcAODVertex *vtx) const
{
  // error on the distance in 3D to another IlcAODVertex
...
//______________________________________________________________________________
Double_t IlcAODVertex::Error2DistanceXYToVertex(IlcAODVertex *vtx) const
{
  // error on the distance in XY to another IlcAODVertex
...
void IlcAODVertex::PhiAndThetaToVertex(IlcAODVertex *vtx, P &phi, T &theta) const
{
...
//______________________________________________________________________________
void IlcAODVertex::PrintIndices() const 
{
...
//______________________________________________________________________________
const char* IlcAODVertex::AsString() const
{
...
//______________________________________________________________________________
const char* IlcAODVertex::GetTypeName(AODVtx_t type)
{
...
//______________________________________________________________________________
void IlcAODVertex::Print(Option_t* /*option*/) const 
{
