#ifndef IlcAODRedCov_H
#define IlcAODRedCov_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcAODRedCov.h 50615 2011-07-16 23:19:19Z hristov $ */
...
template <Int_t N> class IlcAODRedCov {
...
template <Int_t N> template <class T> inline void IlcAODRedCov<N>::GetCovMatrix(T *cmat) const
{
  //
...
//______________________________________________________________________________
template <Int_t N> template <class T> inline void IlcAODRedCov<N>::SetCovMatrix(T *cmat)
{
  //
