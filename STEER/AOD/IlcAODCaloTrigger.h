#ifndef ILCAODCALOTRIGGER_H
#define ILCAODCALOTRIGGER_H
...
class IlcAODCaloTrigger : public TNamed 
{
public:
	         IlcAODCaloTrigger();
					 IlcAODCaloTrigger(const char* name, const char* title);
	         IlcAODCaloTrigger(const IlcAODCaloTrigger& ctrig);
	virtual ~IlcAODCaloTrigger();
	
	IlcAODCaloTrigger& operator=(const IlcAODCaloTrigger& ctrig);
