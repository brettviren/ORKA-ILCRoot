...
ClassImp(IlcAODPWG4Particle)


//______________________________________________________________________________
IlcAODPWG4Particle::IlcAODPWG4Particle() :
IlcVParticle(),
...
//______________________________________________________________________________
IlcAODPWG4Particle::IlcAODPWG4Particle(Double_t px, Double_t py, Double_t pz, Double_t e):
  IlcVParticle(),
  fMomentum(0),fPdg(-1), fTag(0), fBtag(-1), fLabel(-1),fCaloLabel(), fTrackLabel(),
  fDetector(""), fDisp(0), fTof(0),fCharged(0), fTagged(0), fBadDist(0), fFidArea(0), fInputFileIndex(0)
{
...
//______________________________________________________________________________
IlcAODPWG4Particle::IlcAODPWG4Particle(TLorentzVector & p):
  IlcVParticle(),
  fMomentum(0),fPdg(-1), fTag(0), fBtag(-1), fLabel(-1),fCaloLabel(), fTrackLabel(),
  fDetector(""), fDisp(0), fTof(0), fCharged(0), fTagged(0), fBadDist(0), fFidArea(0), fInputFileIndex(0)
{
...
//______________________________________________________________________________
void IlcAODPWG4Particle::Clear(const Option_t* /*opt*/) 
{
  //clear
  delete fMomentum;
}
...
//______________________________________________________________________________
IlcAODPWG4Particle::IlcAODPWG4Particle(const IlcAODPWG4Particle& part) :
  IlcVParticle(part),
...
//______________________________________________________________________________
IlcAODPWG4Particle& IlcAODPWG4Particle::operator=(const IlcAODPWG4Particle& part)
{
  // Assignment operator
  if(this!=&part) {
...
Bool_t IlcAODPWG4Particle::IsPIDOK(const Int_t ipid, const Int_t pdgwanted) const{
...
//______________________________________________________________________________
void IlcAODPWG4Particle::Print(Option_t* /*option*/) const 
{
