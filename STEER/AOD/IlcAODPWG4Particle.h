#ifndef ILCAODPWG4PARTICLE_H
#define ILCAODPWG4PARTICLE_H
...
class IlcAODPWG4Particle : public IlcVParticle {
  
 public:
  IlcAODPWG4Particle();
  IlcAODPWG4Particle(Double_t px, Double_t py, Double_t pz, Double_t e);
  IlcAODPWG4Particle(TLorentzVector & p);
  
  virtual ~IlcAODPWG4Particle();
  virtual void Clear(const Option_t* /*opt*/);

  IlcAODPWG4Particle(const IlcAODPWG4Particle& photon); 
  IlcAODPWG4Particle& operator=(const IlcAODPWG4Particle& photon);
  ...
  Double_t GetPairMass(IlcAODPWG4Particle * p)const{ return (*(p->fMomentum)+*fMomentum).M(); }
  // Dummy
 ...
 private:
  ...
  ClassDef(IlcAODPWG4Particle, 4);
};

inline Double_t IlcAODPWG4Particle::Phi() const
{
  // Return phi
