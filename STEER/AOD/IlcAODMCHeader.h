// -*- mode: C++ -*- 
#ifndef ILCAODMCHEADER_H
#define ILCAODMCHEADER_H
...
class IlcAODMCHeader: public IlcVHeader {
public:
  IlcAODMCHeader();
  virtual ~IlcAODMCHeader();
  IlcAODMCHeader(const IlcAODMCHeader& header);
  IlcAODMCHeader& operator=(const IlcAODMCHeader& header);
  ...
  virtual void AddCocktailHeader(const IlcGenEventHeader* header);
  virtual void AddCocktailHeaders(IlcGenEventHeader* header);
  virtual IlcGenEventHeader* GetCocktailHeader(Int_t i);
