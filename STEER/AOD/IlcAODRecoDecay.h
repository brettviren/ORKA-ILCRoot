#ifndef ILCAODRECODECAY_H
#define ILCAODRECODECAY_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

//***********************************************************
// Class IlcAODRecoDecay
...
class IlcAODRecoDecay : public IlcVTrack {

 public:

  IlcAODRecoDecay();
  IlcAODRecoDecay(IlcAODVertex *vtx2,Int_t nprongs,Short_t charge,
		  Double_t *px,Double_t *py,Double_t *pz,
		  Double_t *d0);
  IlcAODRecoDecay(IlcAODVertex *vtx2,Int_t nprongs,Short_t charge,
		  Double_t *d0);
  virtual ~IlcAODRecoDecay();

  IlcAODRecoDecay(const IlcAODRecoDecay& source);
  IlcAODRecoDecay& operator=(const IlcAODRecoDecay& source); 
  ...
  void     SetSecondaryVtx(IlcAODVertex *vtx2) {fSecondaryVtx=vtx2;}
  IlcAODVertex* GetSecondaryVtx() const { return (((IlcAODVertex*)fSecondaryVtx.GetObject()) ? (IlcAODVertex*)fSecondaryVtx.GetObject() : GetOwnSecondaryVtx()); }
  void     SetOwnSecondaryVtx(IlcAODVertex *vtx2) {fOwnSecondaryVtx=vtx2;}
  IlcAODVertex* GetOwnSecondaryVtx() const {return fOwnSecondaryVtx;}
  ...
  // If no, return -1
  // If yes, return label (>=0) of the IlcAODMCParticle
  ...
  virtual Bool_t   PropagateToDCA(const IlcVVertex* vtx,Double_t b,Double_t maxd,Double_t dz[2],Double_t covar[3]);
  ...
  Double_t DecayLength2(IlcAODVertex *vtx1) const
  {return GetSecondaryVtx()->Distance2ToVertex(vtx1);}
  Double_t DecayLength(IlcAODVertex *vtx1) const
    {return TMath::Sqrt(DecayLength2(vtx1));}
  Double_t DecayLengthError2(IlcAODVertex *vtx1) const
    {return GetSecondaryVtx()->Error2DistanceToVertex(vtx1);}
  Double_t DecayLengthError(IlcAODVertex *vtx1) const
    {return TMath::Sqrt(DecayLengthError2(vtx1));}
  Double_t NormalizedDecayLength2(IlcAODVertex *vtx1) const 
    {return DecayLength2(vtx1)/DecayLengthError2(vtx1);}
  Double_t NormalizedDecayLength(IlcAODVertex *vtx1) const 
  {return TMath::Sqrt(NormalizedDecayLength2(vtx1));}
  Double_t DecayLengthXY(Double_t point[3]) const;
  Double_t DecayLengthXY(IlcAODVertex *vtx1) const
    {return GetSecondaryVtx()->DistanceXYToVertex(vtx1);}
  Double_t DecayLengthXYError(IlcAODVertex *vtx1) const
    {return GetSecondaryVtx()->ErrorDistanceXYToVertex(vtx1);}
  Double_t NormalizedDecayLengthXY(IlcAODVertex *vtx1) const 
    {return DecayLengthXY(vtx1)/DecayLengthXYError(vtx1);}
  Double_t Ct(UInt_t pdg,Double_t point[3]) const;
  Double_t Ct(UInt_t pdg,IlcAODVertex *vtx1) const;
  Double_t CosPointingAngle(Double_t point[3]) const;
  Double_t CosPointingAngle(IlcAODVertex *vtx1) const;
  Double_t CosPointingAngleXY(Double_t point[3]) const;
  Double_t CosPointingAngleXY(IlcAODVertex *vtx1) const;
  ...
  Double_t ImpParXY(IlcAODVertex *vtx1) const;
  ...
  Double_t QlProngFlightLine(Int_t ip,IlcAODVertex *vtx1) const;
  Double_t QtProngFlightLine(Int_t ip,Double_t point[3]) const;
  Double_t QtProngFlightLine(Int_t ip,IlcAODVertex *vtx1) const;
  ...
  //Double_t DistanceToVertex(IlcAODVertex *vtx) // distance to a IlcAODVertex
  //Double_t DistanceToTrack(IlcAODTrack *trk)   // distance to a IlcAODTrack
  ...
  // dummy functions for inheritance from IlcVParticle
  Double_t E() const 
    {printf("Dummy function; use IlcAODRecoDecay::E(UInt_t pdg) instead"); return (Double_t)-999.;}
  Double_t Y() const 
    {printf("Dummy function; use IlcAODRecoDecay::Y(UInt_t pdg) instead"); return (Double_t)-999.;}
  Double_t M() const 
 ...
 protected:
  ...
  IlcAODVertex *fOwnSecondaryVtx;  // temporary solution (to work outside IlcAODEvent)
  ...
  // TEMPORARY, to be removed when we do analysis on IlcAODEvent
  ...
  ClassDef(IlcAODRecoDecay,4)  // base class for AOD reconstructed decays
};


inline Short_t IlcAODRecoDecay::ChargeProng(Int_t ip) const
{
...
inline Double_t IlcAODRecoDecay::RadiusSecVtx() const 
{ 
  return TMath::Sqrt(GetSecVtxX()*GetSecVtxX()+GetSecVtxY()*GetSecVtxY());
}

inline void IlcAODRecoDecay::GetSecondaryVtx(Double_t vtx[3]) const 
{
  GetSecondaryVtx()->GetPosition(vtx);
  return;
}

inline Double_t IlcAODRecoDecay::Px() const 
{
  Double_t px=0.; 
...
inline Double_t IlcAODRecoDecay::Py() const 
{
  Double_t py=0.; 
...
inline Double_t IlcAODRecoDecay::Pz() const 
{
  Double_t pz=0.; 
...
inline Double_t IlcAODRecoDecay::Ct(UInt_t pdg,IlcAODVertex *vtx1) const
{
  Double_t v[3];
  vtx1->GetPosition(v);
  return Ct(pdg,v);
...
inline Double_t IlcAODRecoDecay::CosPointingAngle(IlcAODVertex *vtx1) const
{
  Double_t v[3];
  vtx1->GetPosition(v);
...
inline Double_t IlcAODRecoDecay::CosPointingAngleXY(IlcAODVertex *vtx1) const
{
  Double_t v[3];
  vtx1->GetPosition(v);
...
inline Double_t IlcAODRecoDecay::ImpParXY(IlcAODVertex *vtx1) const
{
  Double_t v[3];
  vtx1->GetPosition(v);
  return ImpParXY(v);
...
inline Double_t IlcAODRecoDecay::Pt2Prong(Int_t ip) const 
{
  return PxProng(ip)*PxProng(ip)+PyProng(ip)*PyProng(ip);
}

inline Double_t IlcAODRecoDecay::P2Prong(Int_t ip) const 
{
  return Pt2Prong(ip)+PzProng(ip)*PzProng(ip);
}

inline Double_t IlcAODRecoDecay::QlProngFlightLine(Int_t ip,IlcAODVertex *vtx1) const
{
  Double_t v[3];
  vtx1->GetPosition(v);
...
inline Double_t IlcAODRecoDecay::QtProngFlightLine(Int_t ip,IlcAODVertex *vtx1) const
{
  Double_t v[3];
  vtx1->GetPosition(v);
...
inline void IlcAODRecoDecay::Setd0Prongs(Int_t nprongs,Double_t *d0) 
{
...
inline void IlcAODRecoDecay::SetPxPyPzProngs(Int_t nprongs,Double_t *px,Double_t *py,Double_t *pz) 
{
  if(nprongs!=GetNProngs()) { 
    printf("Wrong number of momenta, must be nProngs");
    return;
...
inline void IlcAODRecoDecay::SetDCAs(Int_t nDCA,Double_t *dca) 
{
...
inline void IlcAODRecoDecay::SetDCA(Double_t dca) 
{
...
inline void IlcAODRecoDecay::SetPID(Int_t nprongs,Double_t *pid) 
{
  if(nprongs!=GetNProngs()) {
...
inline void IlcAODRecoDecay::GetPIDProng(Int_t ip,Double_t *pid) const
{ 
  for(Int_t j=0;j<5;j++)
    pid[j] = fPID[ip*5+j];
  return;
