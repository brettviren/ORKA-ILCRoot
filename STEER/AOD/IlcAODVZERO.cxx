...
ClassImp(IlcAODVZERO)

//__________________________________________________________________________
IlcAODVZERO::IlcAODVZERO()
  :IlcVVZERO(),
   fBBtriggerV0A(0),
   fBGtriggerV0A(0),
   fBBtriggerV0C(0),
...
//__________________________________________________________________________
IlcAODVZERO::IlcAODVZERO(const IlcAODVZERO &source)
  :IlcVVZERO(source),
...
//__________________________________________________________________________
IlcAODVZERO::IlcAODVZERO(const IlcVVZERO &source)
  :IlcVVZERO(source),
   fBBtriggerV0A(0),
   fBGtriggerV0A(0),
   fBBtriggerV0C(0),
...
//__________________________________________________________________________
IlcAODVZERO& IlcAODVZERO::operator=(const IlcAODVZERO& source)
{
  // Assignment operator
  //
  if(this==&source) return *this;
  IlcVVZERO::operator=(source);
  // Assignment operator
  fBBtriggerV0A=source.fBBtriggerV0A;
  fBGtriggerV0A=source.fBGtriggerV0A;
  fBBtriggerV0C=source.fBBtriggerV0C;
...
//__________________________________________________________________________
IlcAODVZERO& IlcAODVZERO::operator=(const IlcVVZERO& source)
{
  // Assignment operator
...
//__________________________________________________________________________
Short_t IlcAODVZERO::GetNbPMV0A() const
{
...
//__________________________________________________________________________
Short_t IlcAODVZERO::GetNbPMV0C() const
{
  // Returns the number of
  // fired PM in V0C
  Short_t n=0;
...
//__________________________________________________________________________
Float_t IlcAODVZERO::GetMTotV0A() const
{
...
//__________________________________________________________________________
Float_t IlcAODVZERO::GetMTotV0C() const
{
  // returns total multiplicity
  // in V0C
  Float_t mul=0.0;
...
//__________________________________________________________________________
Float_t IlcAODVZERO::GetMRingV0A(Int_t ring) const
{ 
  // returns multiplicity in a
  // given ring of V0A
  if (OutOfRange(ring, "IlcAODVZERO:::GetMRingV0A",4)) return -1;
  Float_t mul =0.0;
...
//__________________________________________________________________________
Float_t IlcAODVZERO::GetMRingV0C(Int_t ring) const
{ 
  // returns multiplicity in a
  // given ring of V0C
  if (OutOfRange(ring, "IlcAODVZERO:::GetMRingV0C",4)) return -1;
  Float_t mul =0.0;
...
//__________________________________________________________________________
Float_t IlcAODVZERO::GetMultiplicity(Int_t i) const

{
  // returns multiplicity in a
  // given cell of V0
  if (OutOfRange(i, "IlcAODVZERO::GetMultiplicity:",64)) return -1;
  return fMultiplicity[i];
}

//__________________________________________________________________________
Float_t IlcAODVZERO::GetMultiplicityV0A(Int_t i) const

{
  // returns multiplicity in a
  // given cell of V0A
  if (OutOfRange(i, "IlcAODVZERO::GetMultiplicityV0A:",32)) return -1;
  return fMultiplicity[32+i];
}

//__________________________________________________________________________
Float_t IlcAODVZERO::GetMultiplicityV0C(Int_t i) const

{
  // returns multiplicity in a
  // given cell of V0C
  if (OutOfRange(i, "IlcAODVZERO::GetMultiplicityV0C:",32)) return -1;
  return fMultiplicity[i];
}

//__________________________________________________________________________
Bool_t IlcAODVZERO::BBTriggerV0A(Int_t i) const
{
  // returns offline beam-beam flags in V0A
  // one bit per cell
  if (OutOfRange(i, "IlcAODVZERO:::BBTriggerV0A",32)) return kFALSE;
  UInt_t test = 1;
  return ( fBBtriggerV0A & (test << i) ? kTRUE : kFALSE );
}

//__________________________________________________________________________
Bool_t IlcAODVZERO::BGTriggerV0A(Int_t i) const
{
  // returns offline beam-gas flags in V0A
  // one bit per cell
  if (OutOfRange(i, "IlcAODVZERO:::BGTriggerV0A",32)) return kFALSE;
  UInt_t test = 1;
  return ( fBGtriggerV0A & (test << i) ? kTRUE : kFALSE );
}

//__________________________________________________________________________
Bool_t IlcAODVZERO::BBTriggerV0C(Int_t i) const
{
  // returns offline beam-beam flags in V0C
  // one bit per cell
  if (OutOfRange(i, "IlcAODVZERO:::BBTriggerV0C",32)) return kFALSE;
  UInt_t test = 1;
  return ( fBBtriggerV0C & (test << i) ? kTRUE : kFALSE );
}

//__________________________________________________________________________
Bool_t IlcAODVZERO::BGTriggerV0C(Int_t i) const
{
  // returns offline beam-gasflags in V0C
  // one bit per cell
  if (OutOfRange(i, "IlcAODVZERO:::BGTriggerV0C",32)) return kFALSE;
  UInt_t test = 1;
  return ( fBGtriggerV0C & (test << i) ? kTRUE : kFALSE );
}

//__________________________________________________________________________
Bool_t IlcAODVZERO::GetBBFlag(Int_t i) const

{
  // returns online beam-beam flag in V0
  // one boolean per cell
  if (OutOfRange(i, "IlcAODVZERO::GetBBFlag:",64)) return kFALSE;
  return fBBFlag[i];
}

//__________________________________________________________________________
Bool_t IlcAODVZERO::GetBGFlag(Int_t i) const

{
  // returns online beam-gas flag in V0
  // one boolean per cell
  if (OutOfRange(i, "IlcAODVZERO::GetBGFlag:",64)) return kFALSE;
  return fBGFlag[i];
}
