...
// i)  IlcESDs that are stored locally.
// ii) IlcESDs that are stored in the CAF.
// iii)IlcESDs that are stored in alien.
...
void CreateTags() {
  ...
  //___________________________________//
  //__Create an IlcTagCreator object___//
  //___________________________________//
  ...
  //___________________________________//
  t->ReadLocalCollection("/home/pchrist/ILC/Alien/Local/Tags");
