...
ClassImp(IlcBaseCalibViewer)

IlcBaseCalibViewer::IlcBaseCalibViewer()
                  :TObject(),
                   fTree(0),
                   fFile(0),
...
IlcBaseCalibViewer::IlcBaseCalibViewer(const IlcBaseCalibViewer &c)
                  :TObject(c),
                   fTree(0),
                   fFile(0),
                   fListOfObjectsToBeDeleted(0),
...
{
  //
  // dummy IlcBaseCalibViewer copy constructor
  // not yet working!!!
  //
  fTree = c.fTree;
...
//_____________________________________________________________________________
IlcBaseCalibViewer::IlcBaseCalibViewer(TTree* tree)
                  :TObject(),
                   fTree(0),
                   fFile(0),
                   fListOfObjectsToBeDeleted(0),
...
//_____________________________________________________________________________
IlcBaseCalibViewer::IlcBaseCalibViewer(const Char_t* fileName, const Char_t* treeName)
                  :TObject(),
                   fTree(0),
                   fFile(0),
                   fListOfObjectsToBeDeleted(0),
...
IlcBaseCalibViewer & IlcBaseCalibViewer::operator =(const IlcBaseCalibViewer & param)
{
   //
...
//_____________________________________________________________________________
void IlcBaseCalibViewer::Delete(Option_t* /*option*/) {
   //
   // Should be called from IlcBaseCalibViewerGUI class only.
...
//_____________________________________________________________________________
void IlcBaseCalibViewer::FormatHistoLabels(TH1 *histo) const {
   // 
...
//_____________________________________________________________________________
TFriendElement* IlcBaseCalibViewer::AddReferenceTree(const Char_t* filename, const Char_t* treename, const Char_t* refname){
  //
...
//_____________________________________________________________________________
TString* IlcBaseCalibViewer::Fit(const Char_t* drawCommand, const Char_t* formula, const Char_t* cuts, 
...
//_____________________________________________________________________________
Double_t IlcBaseCalibViewer::GetLTM(Int_t n, Double_t *array, Double_t *sigma, Double_t fraction){
   //
   ...
   IlcMathBase::EvaluateUni(nPoints, ddata, mean, lsigma, hh);
...
//_____________________________________________________________________________
Int_t IlcBaseCalibViewer::GetBin(Float_t value, Int_t nbins, Double_t binLow, Double_t binUp){
...
//_____________________________________________________________________________
TH1F* IlcBaseCalibViewer::SigmaCut(TH1F *histogram, Float_t mean, Float_t sigma, Float_t sigmaMax, 
   ...
   /* Begin_Latex 
      ...
      Begin_Macro(source)
      {
         ...
         TCanvas* macro_example_canvas = new TCanvas("cIlcBaseCalibViewer", "", 350, 350);
         ...
         TH1F *shist = IlcTPCCalibViewer::SigmaCut(distribution, mean, sigma, sigmaMax);
         shist->SetNameTitle("Cumulative","Cumulative S(t, #mu, #sigma)");
         shist->Draw();  
         TVirtualPad *pad3 = macro_example_canvas->cd(3);
         pad3->SetGridy();
         pad3->SetGridx();
         TH1F *shistPM = IlcTPCCalibViewer::SigmaCut(distribution, mean, sigma, sigmaMax, -1, kTRUE);
         shistPM->Draw();   
   ...
   */ 
   ...
   return IlcBaseCalibViewer::SigmaCut(nbins, array, mean, sigma, nbins, binLow, binUp, sigmaMax, sigmaStep, pm);
}   
   
//_____________________________________________________________________________
TH1F* IlcBaseCalibViewer::SigmaCut(Int_t n, Float_t *array, Float_t mean, Float_t sigma, Int_t nbins, Float_t binLow, Float_t binUp, Float_t sigmaMax, Float_t sigmaStep, Bool_t pm){
   //
...
//_____________________________________________________________________________
TH1F* IlcBaseCalibViewer::SigmaCut(Int_t /*n*/, Double_t */*array*/, Double_t /*mean*/, Double_t /*sigma*/, 
...
//_____________________________________________________________________________
Int_t  IlcBaseCalibViewer::DrawHisto1D(const Char_t* drawCommand, const Char_t* sector, const Char_t* cuts, 
...
//_____________________________________________________________________________
Int_t IlcBaseCalibViewer::SigmaCut(const Char_t* drawCommand, const Char_t* sector, const Char_t* cuts, 
...
//_____________________________________________________________________________
Int_t IlcBaseCalibViewer::Integrate(const Char_t* drawCommand, const Char_t* sector, const Char_t* cuts, 
...
//_____________________________________________________________________________
TH1F* IlcBaseCalibViewer::Integrate(TH1F *histogram, Float_t mean, Float_t sigma, Float_t sigmaMax, Float_t sigmaStep){
   //
   // Creates an integrated histogram Begin_Latex S(t, #mu, #sigma) End_Latex, out of the input distribution distribution Begin_Latex f(x, #mu, #sigma) End_Latex, given in "histogram"   
   // "mean" and "sigma" are Begin_Latex #mu End_Latex and  Begin_Latex #sigma End_Latex of the distribution in "histogram", to be specified by the user
   // sigmaMax: up to which sigma around the mean/median/LTM you want to integrate 
   ...
   /* Begin_Latex 
      ...
      Begin_Macro(source)
      {
         ...
         pad2->SetGridy();
         pad2->SetGridx();
         TH1F *shist = IlcTPCCalibViewer::Integrate(distribution, mean, sigma, sigmaMax);
         shist->SetNameTitle("Cumulative","Cumulative S(t, #mu, #sigma)");
         shist->Draw();  
...
//_____________________________________________________________________________
TH1F* IlcBaseCalibViewer::Integrate(Int_t n, Float_t *array, Int_t nbins, Float_t binLow, Float_t binUp, 
...
//_____________________________________________________________________________
void IlcBaseCalibViewer::DrawLines(TH1F *histogram, TVectorF nsigma, TLegend *legend, Int_t color, Bool_t pm) const {
   //
...
//_____________________________________________________________________________
void IlcBaseCalibViewer::DrawLines(TGraph *graph, TVectorF nsigma, TLegend *legend, Int_t color, Bool_t pm) const {
   //
   // Private function for SigmaCut(...) and Integrate(...)
   // Draws lines into the given histogram, specified by "nsigma", the lines are addeed to the legend
   //
