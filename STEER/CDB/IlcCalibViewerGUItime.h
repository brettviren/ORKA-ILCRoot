#ifndef ILCCILCBVIEWERGUITIME_H
#define ILCCILCBVIEWERGUITIME_H

/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcCalibViewerGUItime.h,v */
...
class IlcBaseCalibViewerGUI;

class IlcCalibViewerGUItime : public TGCompositeFrame {
public:
  IlcCalibViewerGUItime(const TGWindow *p, UInt_t w, UInt_t h, const Char_t* det = "TRD");
  virtual ~IlcCalibViewerGUItime();
  ...
  void SetCalibViewerGUI(IlcBaseCalibViewerGUI *gui) {fCalibViewerGUI=gui;}
 ...
 private:
  ...
  IlcBaseCalibViewerGUI *fCalibViewerGUI;  //calib viewer gui used to display verbose information for one run
  ...
  TString fOutputCacheDir;                //output cache diretory for IlcTPCCalibViewerGUI trees, created on the fly
  ...
  void AdjustYRange();
private:
  IlcCalibViewerGUItime(const IlcCalibViewerGUItime &v);
  IlcCalibViewerGUItime &operator = (const IlcCalibViewerGUItime &v);         // assignment operator
  
  ClassDef(IlcCalibViewerGUItime, 1)
