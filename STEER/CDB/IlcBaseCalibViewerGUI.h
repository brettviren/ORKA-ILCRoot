#ifndef ILCBASECILCBVIEWERGUI_H
#define ILCBASECILCBVIEWERGUI_H

///////////////////////////////////////////////////////////////////////////////
//                                                                           //
//  Base class for the IlcTPCCalibViewerGUI and IlcTRDCalibViewerGUI         //
...
class TGGroupFrame;
class TString;
class IlcBaseCalibViewer;

class IlcBaseCalibViewerGUI : public TGCompositeFrame {

 public:
  IlcBaseCalibViewerGUI(const TGWindow *p, UInt_t w, UInt_t h/*, char* fileName*/);  // constructor
  IlcBaseCalibViewerGUI(const IlcBaseCalibViewerGUI &c);                          // copy constructor
  IlcBaseCalibViewerGUI &operator = (const IlcBaseCalibViewerGUI &param);         // assignment operator

  virtual ~IlcBaseCalibViewerGUI();
  ...
  // initializes the GUI with default settings and opens tree for drawing
  virtual void Initialize(IlcBaseCalibViewer *viewer) = 0;
  ...
  //virtual IlcBaseCalibViewer* GetViewer() = 0;
  IlcBaseCalibViewer* GetViewer() {return fViewer;}       // return the IlcBaseCalibViewer pointer
 ...
 protected:   
  IlcBaseCalibViewer   *fViewer;             // CalibViewer object used for drawing
 ...
 protected:
  ...
  ClassDef(IlcBaseCalibViewerGUI, 0)
};
