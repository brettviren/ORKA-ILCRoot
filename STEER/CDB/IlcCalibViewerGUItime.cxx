...
//                                                                           //
//  Usage:   IlcCalibViewerGUItime::ShowGUI(TChain* chain)                   //
//           IlcCalibViewerGUItime::ShowGUI()                                //
///////////////////////////////////////////////////////////////////////////////
...
ClassImp(IlcCalibViewerGUItime)

//_______________________________________________________________________________________________________________
IlcCalibViewerGUItime::IlcCalibViewerGUItime(const TGWindow *p, UInt_t w, UInt_t h, const Char_t* det) :
...
IlcCalibViewerGUItime::~IlcCalibViewerGUItime(){
  //
  // dtor
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::DrawGUI(const TGWindow */*p*/, UInt_t w, UInt_t h) {
   //
   // draw the GUI
   //
   // ======================================================================
  ...
  fRadioXhist->Connect("Clicked()", "IlcCalibViewerGUItime", this, "HandleButtonsDrawSel()");
  ...
  fRadioXrun->Connect("Clicked()", "IlcCalibViewerGUItime", this, "HandleButtonsDrawSel()");
  ...
  fRadioXtime->Connect("Clicked()", "IlcCalibViewerGUItime", this, "HandleButtonsDrawSel()");
  ...
  fListVariables->Connect("Selected(Int_t)", "IlcCalibViewerGUItime", this, "DoNewSelection()");
...
//-------------------- run type selection ------------------------
  ...
  fComboRunType->Connect("Selected(Int_t)", "IlcCalibViewerGUItime", this, "DoDraw()");
  ...
  fNmbPar->Connect("ValueSet(Long_t)", "IlcCalibViewerGUItime", this, "DoParLimitChange()");
  ...
  fListCalibType->Connect("Selected(Int_t)", "IlcCalibViewerGUItime", this, "DoChangeSelectionList()");
  ...
  fCanvMain->GetCanvas()->Connect("ProcessedEvent(Int_t, Int_t, Int_t, TObject*)", "IlcCalibViewerGUItime", this, "MouseMove(Int_t, Int_t, Int_t, TObject*)");
  ...
  fBtnDumpRuns->Connect("Clicked()", "IlcCalibViewerGUItime", this, "DoDumpRuns()");
  ...
  fBtnSave->Connect("Clicked()", "IlcCalibViewerGUItime", this, "SavePicture()");
  ...
  fContRight->AddFrame(fContLoad, new TGLayoutHints(kLHintsExpandX, 0, 0, 10, 0));
    ...
    fContLoad->AddFrame(fContFilename, new TGLayoutHints(kLHintsExpandX, 0, 0, 2, 0));
      ...
      fTxtFilename->Connect("DoubleClicked()", "IlcCalibViewerGUItime", this, "HandleLoadRunTextEntry()");
    ...
    fBtnLoadFile->Connect("Clicked()", "IlcCalibViewerGUItime", this, "HandleLoadRunButtons()");
  ...
  fComboCustomDraw->Connect("ReturnPressed()", "IlcCalibViewerGUItime", this, "DoCustomDraw()");
  fComboCustomDraw->Connect("Selected(Int_t)", "IlcCalibViewerGUItime", this, "DoCustomDraw()");
...
//   fComboCustomCuts->Resize(0, fLblValueY->GetDefaultHeight());
  ...
  fComboCustomCuts->Connect("ReturnPressed()", "IlcCalibViewerGUItime", this, "DoCustomCutsDraw()");
  fComboCustomCuts->Connect("Selected(Int_t)", "IlcCalibViewerGUItime", this, "DoCustomCutsDraw()");

  if(fDetector.Contains("TPC")) SetWindowName("IlcTPCCalibViewer GUI - Time");
  else if (fDetector.Contains("TRD")) SetWindowName("IlcTRDCalibViewer GUI - Time");
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::SetInitialValues(){
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::UseFile(const char* fileName, const char* treeName) {
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::UseChain(TChain* chain)
{
  //
  // load a chain
  //
  fTree=chain;
  if (!CheckChain()) {
    std::cout << "IlcCalibViewerGUItime::UseChain !checkchain OUT" << std::endl;
    return;
  }
...
//______________________________________________________________________________
Bool_t IlcCalibViewerGUItime::CheckChain()
{
  //
  ...
  if (entries==0){
    IlcError("No entries found in chain");
    return kFALSE;
  }
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::FillRunTypes()
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::FillCalibTypes()
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::CheckDrawGraph()
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::Reload(Int_t /*first*/)
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::AddReferenceTree(const char* treeFileName, const char* refName)
{
  //
...
//______________________________________________________________________________
const char* IlcCalibViewerGUItime::GetDrawString(){
  //
...
//______________________________________________________________________________
const char* IlcCalibViewerGUItime::GetDrawOption() const {
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::GetCutString(TString &cutStr){
  //
  // create cut string
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::UpdateValueArrays(Bool_t withGraph)
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::GetHistogramTitle(TString &title)
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::AdjustYRange()
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::DoDraw() {
  //
  // Draw graphics
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::DoDumpRuns()
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::DoParLimitChange()
{
  //
  // DoParLimitChange()
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::DoNewSelection() {
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::DoCustomDraw()
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::DoCustomCutsDraw()
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::HandleButtonsDrawSel(Int_t id)
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::UpdateParName()
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::UpdateParLimits()
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::MouseMove(Int_t event, Int_t x, Int_t y, TObject */*selected*/)
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::SetGuiTree(Int_t run)
{
  //
  // create the IlcCalibViewerGUI tree for run
  ...
  //if(fDetector.Contains("TPC")) ((IlcTPCCalibViewerGUI_new*)fCalibViewerGUI)->Reload();
  //else ((IlcTRDCalibViewerGUI*)fCalibViewerGUI)->Reload();
  fCalibViewerGUI->Reload();
}

//______________________________________________________________________________
const char* IlcCalibViewerGUItime::SubstituteUnderscores(const char* in)
{
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::SavePicture() {
   // 
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::HandleLoadRunButtons() {
  //
  //  Handle the buttons
  //
...
//______________________________________________________________________________
void IlcCalibViewerGUItime::HandleLoadRunTextEntry() {
  //
...
TObjArray* IlcCalibViewerGUItime::ShowGUI(TChain* chain) {
  //
  ...
  IlcCalibViewerGUItime* calibViewerTime = new IlcCalibViewerGUItime(tabCont1, 1000, 650);
...
//__________________________________________________________________
TObjArray* IlcCalibViewerGUItime::ShowGUI() {
  //
