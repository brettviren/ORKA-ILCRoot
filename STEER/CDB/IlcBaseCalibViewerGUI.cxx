///////////////////////////////////////////////////////////////////////////////
//                                                                           //
//  Base class for the IlcTPCCalibViewer and IlcTRDCalibViewer               //
...
ClassImp(IlcBaseCalibViewerGUI)

//________________________________________________________________________________________
IlcBaseCalibViewerGUI::IlcBaseCalibViewerGUI(const TGWindow *p, UInt_t w, UInt_t h)
...
{
   //
   // IlcBaseCalibViewerGUI constructor; fileName specifies the ROOT tree used for drawing 
   //
}

//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::DrawGUI(const TGWindow */*p*/, UInt_t w, UInt_t h) {
   // 
   // draw the GUI
   // 
   // ======================================================================   
   ...
   //fBtnDraw->Connect("Clicked()", "IlcTPCCalibViewerGUI", this, "DoTest(=\"fBtnDraw clicked\")");
   fBtnDraw->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "DoDraw()");
   ...
   ftabLeft1 = ftabLeft->AddTab("More plot options");
      ...
      fContDrawOpt->AddFrame(fContDrawOptSub1D2D, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
         ...
         fRadio1D->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsGeneral()");
         ...
         fRadio2D->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsGeneral()");
         ...
         fContDrawOpt->AddFrame(fContAddDrawOpt, new TGLayoutHints(kLHintsExpandX | kLHintsExpandY, 0, 0, 0, 0));
            ...
            fChkAddDrawOpt->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "DoNewSelection()");
            ...
            fComboAddDrawOpt->Connect("ReturnPressed()", "IlcBaseCalibViewerGUI", this, "HandleButtonsGeneral(=14)");
            fComboAddDrawOpt->Connect("Selected(Int_t)", "IlcBaseCalibViewerGUI", this, "DoNewSelection()");
      ...
      fRadioPredefined->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsGeneral()");
      ...
      fListVariables->Connect("Selected(Int_t)", "IlcBaseCalibViewerGUI", this, "DoNewSelection()");
      ...
      ftabLeft0->AddFrame(fContPlotOpt, new TGLayoutHints(kLHintsExpandX | kLHintsExpandY, 10, 0, 0, 0));
         ...
         fRadioRaw->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsGeneral()");
         ...
         fRadioNormalized->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsGeneral()");
         ...
         fContPlotOpt->AddFrame(fContNormalized, new TGLayoutHints(kLHintsExpandX | kLHintsExpandY, 15, 0, 0, 0));
            ...
            fComboMethod->Connect("Selected(Int_t)", "IlcBaseCalibViewerGUI", this, "DoNewSelection()");
            ...
            fListNormalization->Connect("Selected(Int_t)", "IlcBaseCalibViewerGUI", this, "DoNewSelection()");
      ...
      fRadioCustom->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsGeneral()");
      ...
      fContDrawOpt1D->AddFrame(fcontDrawOpt1DSubLR, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
         ...
         fcontDrawOpt1DSubLR->AddFrame(fContDrawOpt1DSubNSC, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
            ...
            fRadioNorm->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtons1D()");
            ...
            fRadioSigma->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtons1D()");
            ...
            fTxtSigmas->Connect("ReturnPressed()", "IlcBaseCalibViewerGUI", this, "HandleButtons1D(=111)");
            ...
            fContDrawOpt1DSubNSC->AddFrame(fContCumuLR, new TGLayoutHints(kLHintsExpandX, 0, 0, 5, 0));
               ...
               fContCumuLR->AddFrame(fContCumLeft, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
                  ...
                  fRadioCumulative->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtons1D()");
                  ...
                  fCheckCumulativePM->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtons1D()");
                  ...
                  fRadioIntegrate->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtons1D()");
               ...
               fContCumuLR->AddFrame(fContCumRight, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
                  ...
                  fTxtSigmaMax->Connect("ReturnPressed()", "IlcBaseCalibViewerGUI", this, "HandleButtons1D(=112)");
         ...
         fcontDrawOpt1DSubLR->AddFrame(fContDrawOpt1DSubMML, new TGLayoutHints(kLHintsExpandX, 0, 0, 5, 0));
            ...
            fChkMean->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtons1D()");
            ...
            fChkMedian->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtons1D()");
            ...
            fChkLTM->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtons1D()");
      ...
      ftabLeft1->AddFrame(fContStatOpt, new TGLayoutHints(kLHintsExpandX, 0, 0, 10, 0));
         ...
         fChkStatName->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
         ...
         fChkStatEntries->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
         ...
         fContStatOpt->AddFrame(fContStatMean, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
            ...
            fChkStatMean->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
            ...
            fChkStatMeanPM->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
         ...
         fContStatOpt->AddFrame(fContStatRMS, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
            ...
            fChkStatRMS->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
            ...
            fChkStatRMSPM->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
         ...
         fChkStatUnderflow->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
         ...
         fChkStatOverflow->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
         ...
         fChkStatIntegral->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
         ...
         fContStatOpt->AddFrame(fContStatSkew, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
            ...
            fChkStatSkewness->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
            ...
            fChkStatSkewnessPM->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
         ...
         fContStatOpt->AddFrame(fContStatKurt, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
            ...
            fChkStatKurtosis->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
            ...
            fChkStatKurtosisPM->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsStat()");
      ...
      fBtnUnchekAll->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "UnchekAllStat()");
      ...
      fContTopBottom->AddFrame(fContCustom, new TGLayoutHints(kLHintsExpandX, 10, 0, 0, 0));
         ...
         fComboCustom->Connect("ReturnPressed()", "IlcBaseCalibViewerGUI", this, "HandleButtonsGeneral(=42)");
         fComboCustom->Connect("Selected(Int_t)", "IlcBaseCalibViewerGUI", this, "DoNewSelection()");
      ...
      fContTopBottom->AddFrame(fContAddCuts, new TGLayoutHints(kLHintsExpandX, 10, 0, 0, 0));
         ...
         fComboAddCuts->Connect("Selected(Int_t)", "IlcBaseCalibViewerGUI", this, "DoNewSelection()");
   ...
   fCanvMain->GetCanvas()->Connect("ProcessedEvent(Int_t, Int_t, Int_t, TObject*)", "IlcBaseCalibViewerGUI", this, "MouseMove(Int_t, Int_t, Int_t, TObject*)");
     
   fCanvMain->GetCanvas()->Connect("RangeAxisChanged()", "IlcTPCCalibViewerGUI", this, "GetMinMax()");
   ...
   fTabRight1 = ftabRight->AddTab("Advanced");
      ...
      fTabRight0->AddFrame(fContScaling, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
         ...
         fContScaling->AddFrame(fContSetMax, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
            ...
            fChkSetMax->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw()");
            ...
            fTxtSetMax->Connect("ReturnPressed()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw()");
         ...
         fContScaling->AddFrame(fContSetMin, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
            ...
            fChkSetMin->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw()");
            ...
            fTxtSetMin->Connect("ReturnPressed()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw()");
         ...
         fBtnGetMinMax->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "GetMinMax()");
         ...
         fChkGetMinMaxAuto->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw()");
      ...
      // labeling container *** fContLabeling ***  " Labeling "      
         ...
         fTabRight0->AddFrame(fContLabeling, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
            ...
            fChkLabelTitle->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw()");
            ...
            fTxtLabelTitle->Connect("ReturnPressed()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw(=50)");
            ...
            fChkLabelXaxis->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw()");
            ...
            fTxtLabelXaxis->Connect("ReturnPressed()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw(=51)");
            ...
            fChkLabelYaxis->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw()");
            ...
            fTxtLabelYaxis->Connect("ReturnPressed()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw(=52)");
            ...
            fChkLabelGetAuto->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "HandleButtonsNoRedraw()");
      ...
      fTabRight1->AddFrame(fContSave, new TGLayoutHints(kLHintsExpandX, 0, 0, 0, 0));
         ...
         fBtnSave->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "SavePicture()");
         ...
         fContSave->AddFrame(fContAddSaveOpt, new TGLayoutHints(kLHintsExpandX | kLHintsExpandY, 0, 0, 0, 0));
            ...
            fChkAddSaveOpt->Connect("Clicked()", "IlcBaseCalibViewerGUI", this, "DoNewSelection()");
            ...
            fComboAddSaveOpt->Connect("ReturnPressed()", "IlcBaseCalibViewerGUI", this, "SavePicture()");
            
      // calPad export container	    
      fContExport = new TGGroupFrame(fTabRight1, "Export IlcTPCCalPad", kVerticalFrame | kFitWidth | kFitHeight);
...
//________________________________________________________________________________________
IlcBaseCalibViewerGUI::IlcBaseCalibViewerGUI(const IlcBaseCalibViewerGUI &c)
...
{
  //
  // dummy IlcBaseCalibViewerGUI copy constructor
  //
}

//________________________________________________________________________________________
IlcBaseCalibViewerGUI & IlcBaseCalibViewerGUI::operator =(const IlcBaseCalibViewerGUI & /*param*/) {
   //
...
//________________________________________________________________________________________
IlcBaseCalibViewerGUI::~IlcBaseCalibViewerGUI() {
   // 
   // Destructor
   // 
  /*
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::SetInitialValues() {
   // 
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::HandleButtonsGeneral(Int_t id) {
   //
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::HandleButtons1D(Int_t id) {
   //
   // handles mutual radio button exclusions
   // 1D-Tab buttons
   //
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::HandleButtonsStat(Int_t id) {
   // 
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::HandleButtonsNoRedraw(Int_t id) {
   //
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::ReplacePlaceHolders(TString &str)
{
    //
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::DoNewSelection() {
   //
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::SavePicture() {
   // 
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::GetMinMax() {
   //
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::SetMinMaxLabel() {
   // 
...
//________________________________________________________________________________________
void IlcBaseCalibViewerGUI::UnchekAllStat() {
   // 
