...
5) New function IlcPreprocessor::ProcessDCS(). If you do not need to have DCS data in all cases, you can skip the processing by implemting this function and returning kFALSE under certain conditions. E.g. if there is a certain run type.
...
IlcPreprocessor::GetRunType() function.
...
minor changes in IlcShuttleInterface and IlcPreprocessor
...
Initial import as subdirectory in IlcRoot
...
ClassImp(IlcPreprocessor)

//______________________________________________________________________________________________
IlcPreprocessor::IlcPreprocessor(const char* detector, IlcShuttleInterface* shuttle) :
  TNamed(detector, ""),
  fRun(-1),
  fStartTime(0),
  fEndTime(0),
  ...
  fRunTypes()
{
	SetTitle(Form("IlcPreprocessor for %s subdetector.", detector));

  if (!fShuttle)
  {
    IlcFatal("Initialized without Shuttle instance.");
    return;
  }
...
//______________________________________________________________________________________________
IlcPreprocessor::~IlcPreprocessor()
{
}

//______________________________________________________________________________________________
void IlcPreprocessor::Initialize(Int_t run, UInt_t startTime,	UInt_t endTime)
{
...
//______________________________________________________________________________________________
Bool_t IlcPreprocessor::Store(const char* pathLevel2, const char* pathLevel3, TObject* object,
		IlcCDBMetaData* metaData, Int_t validityStart, Bool_t validityInfinite)
{
  ...
  //
  // The call is delegated to IlcShuttleInterface

  const char* offlineDetName = IlcShuttleInterface::GetOfflineDetName(GetName());
  if(!offlineDetName) return 0;

  return fShuttle->Store(IlcCDBPath(offlineDetName, pathLevel2, pathLevel3), object,
  		metaData, validityStart, validityInfinite);
}

//______________________________________________________________________________________________
Bool_t IlcPreprocessor::StoreReferenceData(const char* pathLevel2, const char* pathLevel3, TObject* object,
		IlcCDBMetaData* metaData)
{
  ...
  return fShuttle->StoreReferenceData(IlcCDBPath(offlineDetName, pathLevel2, pathLevel3), object,
  		metaData);
}
    
//______________________________________________________________________________________________
Bool_t IlcPreprocessor::StoreReferenceFile(const char* localFile, const char* gridFileName)
{
	//
...
//______________________________________________________________________________________________
Bool_t IlcPreprocessor::StoreRunMetadataFile(const char* localFile, const char* gridFileName)
{
	//
...
//______________________________________________________________________________________________
const char* IlcPreprocessor::GetFile(Int_t system, const char* id, const char* source)
{
...
//______________________________________________________________________________________________
TList* IlcPreprocessor::GetFileSources(Int_t system, const char* id)
{
...
//______________________________________________________________________________________________
TList* IlcPreprocessor::GetFileIDs(Int_t system, const char* source)
{
...
//______________________________________________________________________________________________
void IlcPreprocessor::Log(const char* message, UInt_t level)
{
...
//______________________________________________________________________________________________
const char* IlcPreprocessor::GetRunParameter(const char* param)
{
...
//______________________________________________________________________________________________
IlcCDBEntry* IlcPreprocessor::GetFromOCDB(const char* pathLevel2, const char* pathLevel3)
{
  ...
  return dynamic_cast<IlcCDBEntry*>
  	(fShuttle->GetFromOCDB(GetName(), IlcCDBPath(offlineDetName, pathLevel2, pathLevel3)));
}

//______________________________________________________________________________________________
IlcCDBEntry* IlcPreprocessor::GetGeometryFromOCDB()
{
  ...
  return dynamic_cast<IlcCDBEntry*>
  	(fShuttle->GetFromOCDB(GetName(), IlcCDBPath("GRP", "Geometry", "Data")));
}

//______________________________________________________________________________________________
const char* IlcPreprocessor::GetRunType()
{
...
//______________________________________________________________________________________________
Bool_t IlcPreprocessor::GetHLTStatus()
{
...
//______________________________________________________________________________________________
const char* IlcPreprocessor::GetTriggerConfiguration()
{
...
//______________________________________________________________________________________________
const char* IlcPreprocessor::GetCTPTimeParams()
{
...
//______________________________________________________________________________________________
const char* IlcPreprocessor::GetTriggerDetectorMask()
{
...
//______________________________________________________________________________________________
void IlcPreprocessor::AddRunType(const char* runType)
{
...
//______________________________________________________________________________________________
UInt_t IlcPreprocessor::GetStartTimeDCSQuery()
{
...
//______________________________________________________________________________________________
UInt_t IlcPreprocessor::GetEndTimeDCSQuery()
{
...
//______________________________________________________________________________________________
const char* IlcPreprocessor::GetForeignFile(const char* detector, Int_t system, const char* id, const char* source)
{
...
//______________________________________________________________________________________________
TList* IlcPreprocessor::GetForeignFileSources(const char* detector, Int_t system, const char* id)
{
...
//______________________________________________________________________________________________
void IlcPreprocessor::SendToML(const char* value)
{
	//
...
//______________________________________________________________________________________________
TString* IlcPreprocessor::GetLTUConfig(const char* det)
{
