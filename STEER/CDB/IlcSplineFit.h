#ifndef ILCSPLINEFIT_H
#define ILCSPLINEFIT_H
...
class IlcSplineFit : public TObject {
 public:
  IlcSplineFit();
  IlcSplineFit(const IlcSplineFit&);
  ~IlcSplineFit();
  IlcSplineFit& operator=(const IlcSplineFit&);
 ...
 protected:
  ...
  Int_t         fMinPoints; // minimum number of points to create IlcSplineFit
