#ifndef IlcDCSSensor_H
#define IlcDCSSensor_H
...
class IlcDCSSensor : public TNamed {

public:
  IlcDCSSensor();
  IlcDCSSensor(const IlcDCSSensor& source);
  virtual ~IlcDCSSensor(){}
  IlcDCSSensor& operator=(const IlcDCSSensor& source);
  ...
  IlcSplineFit* GetFit()   const {return fFit; }
  ...
  void SetFit     (IlcSplineFit *f) {fFit = f; }
