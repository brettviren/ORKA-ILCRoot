#ifndef ROOT_ILCTRDTKDINTERPOLATOR_H
#define ROOT_ILCTRDTKDINTERPOLATOR_H
...
class IlcTRDTKDInterpolator : public TKDTreeIF
{
...
public:
	...
	kNodeVal=2
      ...
      // Bucket Object class
    class IlcTRDTKDNodeInfo : public TObject
    {
        friend class IlcTRDTKDInterpolator;
    public:

	IlcTRDTKDNodeInfo(Int_t ndim = 0);
	IlcTRDTKDNodeInfo(const IlcTRDTKDInterpolator::IlcTRDTKDNodeInfo &ref);
	IlcTRDTKDInterpolator::IlcTRDTKDNodeInfo& operator=(const IlcTRDTKDInterpolator::IlcTRDTKDNodeInfo &ref);
	virtual ~IlcTRDTKDNodeInfo();
	...
	ClassDef(IlcTRDTKDNodeInfo, 1)  // node info for interpolator
    };

public:

    IlcTRDTKDInterpolator();
    IlcTRDTKDInterpolator(Int_t npoints, Int_t ndim, UInt_t bsize, Float_t **data);
    ~IlcTRDTKDInterpolator();
...
private:
    ...
    IlcTRDTKDInterpolator::IlcTRDTKDNodeInfo*  GetNodeInfo(Int_t inode) const;
    Int_t         GetNTNodes() const;
    void          BuildInterpolation();
    void          BuildBoundaryNodes();
    IlcTRDTKDInterpolator(const IlcTRDTKDInterpolator &ref);
    IlcTRDTKDInterpolator &operator=(const IlcTRDTKDInterpolator &ref);
    ...
    ClassDef(IlcTRDTKDInterpolator, 1)   // data interpolator based on KD tree
};
