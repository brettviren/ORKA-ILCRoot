...
/* $Id: IlcEventTagCuts.cxx 50615 2011-07-16 23:19:19Z hristov $ */

//-----------------------------------------------------------------
//           IlcEventTagCuts class
...
ClassImp(IlcEventTagCuts)


//___________________________________________________________________________
IlcEventTagCuts::IlcEventTagCuts() :
  TObject(),
...
//___________________________________________________________________________
void IlcEventTagCuts::SetEventType(UInt_t ntype) {
  //Sets the event type
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNumberOfFiredChipsLayer1Range(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNumberOfFiredChipsLayer2Range(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNumberOfSPDTrackletsRange(Int_t low, Int_t high) {
  //Sets the range for the number of fired chips of layer 1
  //and the corresponding flag to kTRUE if the cut is used.
...
//___________________________________________________________________________
void IlcEventTagCuts::SetPeriodNumberRange(UInt_t low, UInt_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetOrbitNumberRange(UInt_t low, UInt_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetBunchCrossNumberRange(UShort_t low, UShort_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetPrimaryVertexXRange(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetPrimaryVertexYRange(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetPrimaryVertexZRange(Float_t low, Float_t high) {
...
//___________________________________________________________________________
 void IlcEventTagCuts::SetEtaLeadingParticleRange(Float_t low, Float_t high) {
...
void IlcEventTagCuts::SetPhiLeadingParticleRange(Float_t low, Float_t high) {
  //Sets the eta range of LP 
  //and the corresponding flag to kTRUE if the cut is used.
  fPhiMin = low;
  fPhiMax = high; 
...
//___________________________________________________________________________
void IlcEventTagCuts::SetPrimaryVertexZErrorRange(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetTriggerMask(ULong64_t trmask) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetTriggerCluster(UChar_t trcluster) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetMultiplicityRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNParticipantsRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetImpactParamRange(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetPrimaryVertexFlag(Int_t flag) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetZDCNeutron1Range(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetZDCProton1Range(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetZDCNeutron2Range(Float_t low, Float_t high) {
  //Sets the ZDC's neutron energy range 
  //and the corresponding flag to kTRUE if the cut is used.
...
//___________________________________________________________________________
void IlcEventTagCuts::SetZDCProton2Range(Float_t low, Float_t high) {
  //Sets the ZDC's proton energy range 
  //and the corresponding flag to kTRUE if the cut is used.
...
//___________________________________________________________________________
void IlcEventTagCuts::SetZDCEMRange(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetT0VertexZRange(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetPosMultiplicityRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNegMultiplicityRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNeutrMultiplicityRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNV0sRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNCascadesRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNKinksRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNPMDTracksRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNFMDTracksRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNPHOSClustersRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNEMCALClustersRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNJetCandidatesRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetTopJetEnergyMin(Float_t low) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetTopNeutralEnergyMin(Float_t low) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNHardPhotonsRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNChargedAbove1GeVRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
 void IlcEventTagCuts::SetNChargedAbove3GeVRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNChargedAbove10GeVRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNMuonsAbove1GeVRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNMuonsAbove3GeVRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNMuonsAbove10GeVRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNElectronsAbove1GeVRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNElectronsAbove3GeVRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNElectronsAbove10GeVRange(Int_t low, Int_t high) {  
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNElectronRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNFWMuonRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNFWMatchedMuonRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNMuonRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNPionRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNKaonRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNProtonRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNLambdaRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNPhotonRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNPi0Range(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNNeutronRange(Int_t low, Int_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetNKaon0Range(Int_t low, Int_t high) {  
...
//___________________________________________________________________________
void IlcEventTagCuts::SetTotalPRange(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetMeanPtRange(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetTopPtMin(Float_t low) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetTotalNeutralPRange(Float_t low, Float_t high) {  
...
//___________________________________________________________________________
void IlcEventTagCuts::SetMeanNeutralPtPRange(Float_t low, Float_t high) {  
...
//___________________________________________________________________________
void IlcEventTagCuts::SetTopNeutralPtMin(Float_t low) {  
...
//___________________________________________________________________________
void IlcEventTagCuts::SetEventPlaneAngleRange(Float_t low, Float_t high) {
...
//___________________________________________________________________________
void IlcEventTagCuts::SetHBTRadiiRange(Float_t low, Float_t high) {
...
void IlcEventTagCuts::AddRequiredFiredTriggerClass(TString aclass)
{
  fFiredTriggerClass += " ";
...
void IlcEventTagCuts::ResetTriggerClasses()
{
  fFiredTriggerClassFlag = kFALSE;
  fFiredTriggerClass = "";
}

void IlcEventTagCuts::InitializeTriggerClasses(TString aclass)
{
  fActiveTriggerClasses = aclass;
}

//___________________________________________________________________________
Bool_t IlcEventTagCuts::IsAccepted(IlcEventTag *EvTag) const {
 ...
 if(fEtaFlag)
  ...
  if (fFiredTriggerClassFlag) {
    if (fActiveTriggerClasses.Length() == 0) {
      IlcWarning("Attempt to select Trigger classes but Active trigger classes not set in IlcEventTagCuts. Cannot make the selection on Fired Trigger classes");
    }
    else {
...
Bool_t IlcEventTagCuts::IsAccepted(const IlcEventTag *EvTag) const
{
  //Returns true if the event is accepted otherwise false.
  if(fEventTypeFlag)
    if(EvTag->GetEventType() != fEventType)
