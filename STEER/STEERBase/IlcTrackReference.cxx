...
/* $Id: IlcTrackReference.cxx 50851 2011-07-28 23:13:49Z fca $ */
...
ClassImp(IlcTrackReference)

//_______________________________________________________________________
 IlcTrackReference::IlcTrackReference():
   TObject(),
   fTrack(0),
   fX(0),
   fY(0),
...
IlcTrackReference::IlcTrackReference(const IlcTrackReference &tr) :
  TObject(tr),
  fTrack(tr.fTrack),
  fX(tr.fX),
  fY(tr.fY),
...
//_______________________________________________________________________
IlcTrackReference::IlcTrackReference(Int_t label, Int_t id) :
  TObject(),
  fTrack(label),
  fX(0),
  fY(0),
...
IlcExternalTrackParam * IlcTrackReference::MakeTrack(const IlcTrackReference *ref, Double_t mass)
{
  //
  ...
  IlcExternalTrackParam * track = new  IlcExternalTrackParam(xr,alpha,xx,cc);
  return track;
}

//_______________________________________________________________________
void
IlcTrackReference::Print(Option_t* /*opt*/) const
{
