...
/* $Id: IlcVParticle.cxx 53891 2012-01-13 10:34:05Z hristov $ */
...
ClassImp(IlcVParticle)

IlcVParticle::IlcVParticle(const IlcVParticle& vPart) :
  TObject(vPart) { } // Copy constructor

IlcVParticle& IlcVParticle::operator=(const IlcVParticle& vPart)
{ if (this!=&vPart) { 
...
Bool_t IlcVParticle::Local2GlobalMomentum(Double_t p[3], Double_t alpha) const {
  //----------------------------------------------------------------
...
Bool_t IlcVParticle::Local2GlobalPosition(Double_t r[3], Double_t alpha) const {
  //----------------------------------------------------------------
  // This function performs local->global transformation of the
  // track position.
  // When called, the arguments are:
...
Bool_t IlcVParticle::Global2LocalMomentum(Double_t p[3], Short_t charge, Double_t &alpha) const {
  //----------------------------------------------------------------
...
Bool_t IlcVParticle::Global2LocalPosition(Double_t r[3], Double_t alpha) const {
  return Local2GlobalPosition(r, -alpha);
}


Int_t IlcVParticle::Compare( const TObject* obj) const {
