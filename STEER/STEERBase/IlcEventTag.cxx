...
/* $Id: IlcEventTag.cxx 50615 2011-07-16 23:19:19Z hristov $ */
...
ClassImp(IlcEventTag)

//______________________________________________________________________________
  IlcEventTag::IlcEventTag() : 
    TObject(),
    fPeriodNumber(0),
    fOrbitNumber(0),
    fBunchCrossNumber(0),
...
//    fFileRef(0),
    ...
    fNbPMV0C(0)
{
  // IlcEventTag default constructor
  for(Int_t i=0; i<2; i++)     fZDCEMEnergy[i] = -10.0;
}


//___________________________________________________________________________
IlcEventTag::IlcEventTag(const IlcEventTag & evTag) :
  TObject(evTag),
...
//___________________________________________________________________________
IlcEventTag & IlcEventTag::operator=(const IlcEventTag &evTag) {
...
// void IlcEventTag::SetGUID(TString Pid) { ((IlcFileTag * ) fFileRef.GetObject())->SetGUID(Pid);}
// void IlcEventTag::SetPath(TString Pid) {((IlcFileTag * ) fFileRef.GetObject())->SetPath(Pid);}
// void IlcEventTag::SetMD5(TString Pid) {((IlcFileTag * ) fFileRef.GetObject())->SetMD5(Pid);}
// void IlcEventTag::SetTURL(TString Pid) {((IlcFileTag * ) fFileRef.GetObject())->SetTURL(Pid);}
// void IlcEventTag::SetSize(Long64_t i) {((IlcFileTag * ) fFileRef.GetObject())->SetSize(i);}

TString IlcEventTag::GetFiredTriggerClasses(TString actclass) const 
{
