...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
// IlcCheb3D produces the interpolation of the user 3D->NDimOut arbitrary     //
...
// IlcCheb3D(const char* funName,  // name of the file with user function     //
//          or                                                                //
// IlcCheb3D(void (*ptr)(float*,float*),// pointer on the  user function      //
...
// IlcCheb3D(const char* inpFile);                                            //
// or the default constructor IlcCheb3D() followed by                         //
// IlcCheb3D::LoadData(const char* inpFile);                                  //
//                                                                            //
...
class IlcCheb3D: public TNamed 
{
 public:
  IlcCheb3D();
  IlcCheb3D(const IlcCheb3D& src);
  IlcCheb3D(const char* inpFile);
  IlcCheb3D(FILE* stream);
  //
#ifdef _INC_CREATION_ILCCHEB3D_
  IlcCheb3D(const char* funName, Int_t DimOut, const Float_t  *bmin, const Float_t  *bmax, Int_t *npoints, Float_t  prec=1E-6);
  IlcCheb3D(void (*ptr)(float*,float*), Int_t DimOut, Float_t  *bmin,Float_t  *bmax, Int_t *npoints, Float_t  prec=1E-6);
  IlcCheb3D(void (*ptr)(float*,float*), int DimOut, Float_t  *bmin,Float_t  *bmax, Int_t *npX,Int_t *npY,Int_t *npZ, Float_t prec=1E-6);
  IlcCheb3D(void (*ptr)(float*,float*), int DimOut, Float_t  *bmin,Float_t  *bmax, Float_t prec=1E-6, Bool_t run=kTRUE);
#endif
  //
  ~IlcCheb3D()                                                                 {Clear();}
  //
  IlcCheb3D&   operator=(const IlcCheb3D& rhs);
  ...
  //
  IlcCheb3DCalc*  GetChebCalc(int i)                                     const {return (IlcCheb3DCalc*)fChebCalc.UncheckedAt(i);}
 ...
 protected:
  ...
  //
  ClassDef(IlcCheb3D,2)  // Chebyshev parametrization for 3D->N function
};

//__________________________________________________________________________________________
inline Bool_t  IlcCheb3D::IsInside(const Float_t *par) const 
{
...
//__________________________________________________________________________________________
inline Bool_t  IlcCheb3D::IsInside(const Double_t *par) const 
{
  // check if the point is inside of the fitted box
  for (int i=3;i--;) if (fBMin[i]>par[i] || par[i]>fBMax[i]) return kFALSE;
  return kTRUE;
...
//__________________________________________________________________________________________
inline void IlcCheb3D::Eval(const Float_t  *par, Float_t  *res)
{
...
//__________________________________________________________________________________________
inline void IlcCheb3D::Eval(const Double_t  *par, Double_t  *res)
{
  // evaluate Chebyshev parameterization for 3d->DimOut function
  for (int i=3;i--;) fArgsTmp[i] = MapToInternal(par[i],i);
  for (int i=fDimOut;i--;) res[i] = GetChebCalc(i)->Eval(fArgsTmp);
...
//__________________________________________________________________________________________
inline Double_t IlcCheb3D::Eval(const Double_t  *par, int idim)
{
...
//__________________________________________________________________________________________
inline Float_t IlcCheb3D::Eval(const Float_t  *par, int idim)
{
  // evaluate Chebyshev parameterization for idim-th output dimension of 3d->DimOut function
  for (int i=3;i--;) fArgsTmp[i] = MapToInternal(par[i],i);
  return GetChebCalc(idim)->Eval(fArgsTmp);
...
//__________________________________________________________________________________________
inline void IlcCheb3D::EvalDeriv3D(const Float_t *par, Float_t dbdr[3][3])
{
...
//__________________________________________________________________________________________
inline void IlcCheb3D::EvalDeriv3D2(const Float_t *par, Float_t dbdrdr[3][3][3])
{
  // return gradient matrix
  for (int i=3;i--;) fArgsTmp[i] = MapToInternal(par[i],i);
...
//__________________________________________________________________________________________
inline void IlcCheb3D::EvalDeriv(int dimd, const Float_t  *par, Float_t  *res)
{
...
//__________________________________________________________________________________________
inline void IlcCheb3D::EvalDeriv2(int dimd1,int dimd2, const Float_t  *par, Float_t  *res)
{
...
//__________________________________________________________________________________________
inline Float_t IlcCheb3D::EvalDeriv(int dimd, const Float_t  *par, int idim)
{
...
//__________________________________________________________________________________________
inline Float_t IlcCheb3D::EvalDeriv2(int dimd1,int dimd2, const Float_t  *par, int idim)
{
...
//__________________________________________________________________________________________
inline Float_t IlcCheb3D::MapToInternal(Float_t  x,Int_t d) const
{
  // map x to [-1:1]
...
//__________________________________________________________________________________________
inline Double_t IlcCheb3D::MapToInternal(Double_t  x,Int_t d) const
{
  // map x to [-1:1]
#ifdef _BRING_TO_BOUNDARY_
  T res = (x-fBOffset[d])*fBScale[d];
