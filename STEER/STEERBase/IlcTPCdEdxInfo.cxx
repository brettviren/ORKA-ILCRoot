...
ClassImp(IlcTPCdEdxInfo)

IlcTPCdEdxInfo::IlcTPCdEdxInfo():
  TObject(),
  fTPCsignalRegion(),
  fTPCsignalNRegion(),
...
IlcTPCdEdxInfo::IlcTPCdEdxInfo(const IlcTPCdEdxInfo& source): 	 
    TObject(), 	 
    fTPCsignalRegion(), 	 
    fTPCsignalNRegion(), 	 
    fTPCsignalNRowRegion() 	 
...
IlcTPCdEdxInfo& IlcTPCdEdxInfo::operator=(const IlcTPCdEdxInfo& source)	 
{ 	 
    // 	 
    // assignment operator	 
    //
...
void  IlcTPCdEdxInfo::GetTPCSignalRegionInfo(Double32_t signal[4], Char_t ncl[3], Char_t nrows[3]) const {
  //
...
void  IlcTPCdEdxInfo::SetTPCSignalRegionInfo(Double32_t signal[4], Char_t ncl[3], Char_t nrows[3]){
  //
