#ifndef ILCVCLUSTER_H
#define ILCVCLUSTER_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */
/* $Id: IlcVCluster.h 52103 2011-10-13 11:06:48Z morsch $ */
...
class IlcVCluster : public TObject 
{
 ...
 public:
  ...
  IlcVCluster() { ; }
  virtual ~IlcVCluster() { ; }
  IlcVCluster(const IlcVCluster& clus);
  IlcVCluster & operator=(const IlcVCluster& source);
  ...
  ClassDef(IlcVCluster,0)  //VCluster 
    };
