#ifndef ILCEVENTTAGCUTS_H
#define ILCEVENTTAGCUTS_H
/*  See cxx source for full Copyright notice */


/* $Id: IlcEventTagCuts.h 50615 2011-07-16 23:19:19Z hristov $ */
...
class IlcEventTagCuts : public TObject {
 public:
  IlcEventTagCuts();
  ~IlcEventTagCuts();
  void Reset();
  ...
  Bool_t IsAccepted(IlcEventTag *EvTag) const;
  Bool_t IsAccepted(const IlcEventTag *EvTag) const;
