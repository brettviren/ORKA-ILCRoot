...
/* $Id: IlcExternalTrackParam.cxx 52211 2011-10-18 20:07:02Z shahoian $ */
...
//_____________________________________________________________________________
IlcExternalTrackParam& IlcExternalTrackParam::operator=(const IlcExternalTrackParam &trkPar)
{
  //
  // assignment operator
  //
...
//_____________________________________________________________________________
void IlcExternalTrackParam::CopyFromVTrack(const IlcVTrack *vTrack)
{
  //
  ...
  //
  if (!vTrack) {
    IlcError("Source VTrack is NULL");
    return;
  }
  if (this==vTrack) {
    IlcError("Copy of itself is requested");
    return;
  }
  //
  if (vTrack->InheritsFrom(IlcExternalTrackParam::Class())) {
    IlcDebug(1,"Source itself is IlcExternalTrackParam, using assignment operator");
    *this = *(IlcExternalTrackParam*)vTrack;
    return;
  }
  //
  IlcVTrack::operator=( *vTrack );
  //
...
//_____________________________________________________________________________
IlcExternalTrackParam::IlcExternalTrackParam(const IlcVTrack *vTrack) :
  IlcVTrack(),
  kEndCap(0),
  fX(0.),
  fAlpha(0.),
  fDir(1)
{
  ...
  if (vTrack->InheritsFrom("IlcExternalTrackParam")) {
     IlcError("This is not a copy constructor. Use IlcExternalTrackParam(const IlcExternalTrackParam &) !");
...
//_____________________________________________________________________________
IlcExternalTrackParam::IlcExternalTrackParam(Double_t xyz[3],Double_t pxpypz[3],
...
//_____________________________________________________________________________
void IlcExternalTrackParam::Set(Double_t xyz[3],Double_t pxpypz[3],
				Double_t cv[21],Short_t sign) 
{
  //
...
//_____________________________________________________________________________
void IlcExternalTrackParam::AddCovariance(const Double_t c[15]) {
  //
...
Bool_t IlcExternalTrackParam::CorrectForMeanMaterialdEdx
...
Bool_t IlcExternalTrackParam::CorrectForMeanMaterial
(Double_t xOverX0,  Double_t xTimesRho, Double_t mass, 
 Bool_t anglecorr,
...
Bool_t IlcExternalTrackParam::CorrectForMeanMaterialZA
(Double_t xOverX0, Double_t xTimesRho, Double_t mass,
 Double_t zOverA,
 Double_t density,
 Double_t exEnergy,
...
Double_t IlcExternalTrackParam::BetheBlochAleph(Double_t bg,
         Double_t kp1,
         Double_t kp2,
         Double_t kp3,
         Double_t kp4,
  ...
  // bg - beta*gamma
  // 
  // The default values for the kp* parameters are for ILC TPC.
...
Double_t IlcExternalTrackParam::BetheBlochGeant(Double_t bg,
         Double_t kp0,
         Double_t kp1,
         Double_t kp2,
         Double_t kp3,
...
Double_t IlcExternalTrackParam::BetheBlochSolid(Double_t bg) {
  //------------------------------------------------------------------
...
Double_t IlcExternalTrackParam::BetheBlochGas(Double_t bg) {
  //------------------------------------------------------------------
  // This is an approximation of the Bethe-Bloch formula, 
...
Bool_t IlcExternalTrackParam::Rotate(Double_t alpha) {

  return Rotate(alpha, GetBz());
  ...
  if ((cf*ca+sf*sa)<0) {
    IlcDebug(1,Form("Rotation failed: local cos(phi) would become %.2f",cf*ca+sf*sa));
    return kFALSE;
  }
  //
  ...
  if (TMath::Abs(tmp) >= kAlmost1) {
     if (TMath::Abs(tmp) > 1.+ Double_t(FLT_EPSILON))  
        IlcWarning(Form("Rotation failed ! %.10e",tmp));
     return kFALSE;
  }
...
Bool_t IlcExternalTrackParam::PropagateTo(Double_t xk, Double_t b) {
  //----------------------------------------------------------------
  // Propagate this track to the plane X=xk (cm) in the field "b" (kG)
  //----------------------------------------------------------------

  return PropagateTo(xk, b,false,true);
  Double_t dx=xk-fX;
...
Bool_t 
IlcExternalTrackParam::Propagate(Double_t alpha, Double_t x, Double_t b) {
  //------------------------------------------------------------------
  // Transform this track to the local coord. system rotated
  // by angle "alpha" (rad) with respect to the global coord. system, 
...
Bool_t IlcExternalTrackParam::PropagateBxByBz
...
Double_t IlcExternalTrackParam::
GetPredictedChi2(const IlcExternalTrackParam *t) const {
  //----------------------------------------------------------------
  ...
  if (TMath::Abs(1. - t->GetAlpha()/GetAlpha()) > FLT_EPSILON) {
      IlcError("The reference systems of the tracks differ !");
      return kVeryBig;
  }
  if (TMath::Abs(1. - t->GetX()/GetX()) > FLT_EPSILON) {
      IlcError("The reference of the tracks planes differ !");
      return kVeryBig;
  }
...
Double_t *IlcExternalTrackParam::GetResiduals(
...
Double_t b, Double_t &xthis, Double_t &xp) const {
  ...
  while (max--) {
     ...
     if (TMath::Abs(dt2)/(TMath::Abs(t2)+1.e-3) < 1.e-4) {
	  ...
	  IlcDebug(1," stopped at not a stationary point !");
        Double_t lmb=h11+h22; lmb=lmb-TMath::Sqrt(lmb*lmb-4*det);
        if (lmb < 0.) 
	  IlcDebug(1," stopped at not a minimum !");
        break;
     }
  ...
  if (max<=0) IlcDebug(1," too many iterations !");
...
Bool_t IlcExternalTrackParam::PropagateToDCA(const IlcVVertex *vtx, 
...
Bool_t IlcExternalTrackParam::PropagateToDCABxByBz(const IlcVVertex *vtx, 
...
Bool_t IlcExternalTrackParam::GetPxPyPz(Double_t p[3]) const {
  //---------------------------------------------------------------------
...
Double_t IlcExternalTrackParam::Px() const {
  //---------------------------------------------------------------------
...
Double_t IlcExternalTrackParam::Py() const {
  //---------------------------------------------------------------------
...
Double_t IlcExternalTrackParam::Xv() const {
  //---------------------------------------------------------------------
...
Double_t IlcExternalTrackParam::Yv() const {
  //---------------------------------------------------------------------
...
Double_t IlcExternalTrackParam::Theta() const {
  // return theta angle of momentum

  return 0.5*TMath::Pi() - TMath::ATan(fP[3]);
}

Double_t IlcExternalTrackParam::Phi() const {
  //---------------------------------------------------------------------
...
Double_t IlcExternalTrackParam::M() const {
...
Double_t IlcExternalTrackParam::E() const {
...
Double_t IlcExternalTrackParam::Eta() const { 
  // return pseudorapidity

  return -TMath::Log(TMath::Tan(0.5 * Theta())); 
}

Double_t IlcExternalTrackParam::Y() const {
  // return rapidity
...
Bool_t IlcExternalTrackParam::GetXYZ(Double_t *r) const {
  //---------------------------------------------------------------------
...
Bool_t 
IlcExternalTrackParam::GetXYZAt(Double_t x, Double_t b, Double_t *r) const {
  //---------------------------------------------------------------------
  // This function returns the global track position extrapolated to
  // the radial position "x" (cm) in the magnetic field "b" (kG)
  //---------------------------------------------------------------------

  return GetXYZAt(x, b, r, false);
  Double_t dx=x-fX;
...
// print the parameters and the covariance matrix
  ...
  printf("  parameters: %12g %12g %12g %12g %12g dir=%3g isendcap=%i\n",
         fP[0], fP[1], fP[2], fP[3], fP[4],fDir,IsEndCap());
...
Bool_t IlcExternalTrackParam::GetDistance(IlcExternalTrackParam *param2, Double_t x, Double_t dist[3], Double_t bz){
  //------------------------------------------------------------------------
...
void  IlcExternalTrackParam::DrawTrack(Float_t magf, Float_t minR, Float_t maxR, Float_t stepR){
  //
  // Draw track line
  //
  if (minR>maxR) return ;
...
//
void IlcExternalTrackParam::FillPolymarker(TPolyMarker3D *pol, Float_t magF, Float_t minR, Float_t maxR, Float_t stepR){
  //
...
Int_t IlcExternalTrackParam::GetIndex(Int_t i, Int_t j) const {
  //
...
void IlcExternalTrackParam::g3helx3(Double_t qfield, 
                                    Double_t step,
                                    Double_t vect[7]) {
/******************************************************************
 *                                                                *
...
Bool_t IlcExternalTrackParam::PropagateToBxByBz(Double_t xk, const Double_t b[3]) {
  //----------------------------------------------------------------
  ...
  if (TMath::Abs(dx)<=kAlmost0)  return kTRUE;
  if (TMath::Abs(fP[4])<=kAlmost0) return kFALSE;
  // Do not propagate tracks outside the ILC detector
  if (TMath::Abs(dx)>1e5 ||
      TMath::Abs(GetY())>1e5 ||
      TMath::Abs(GetZ())>1e5) {
    IlcWarning(Form("Anomalous track, target X:%f",xk));
    Print();
    return kFALSE;
  }
...
Bool_t IlcExternalTrackParam::Translate(Double_t *vTrasl,Double_t *covV){
  //
...
void IlcExternalTrackParam::CheckCovariance() {
...
//       IlcWarning("Negative eigenvalues of the covariance matrix!");
//       this->Print();
//       eig.Print();
//     }
}

Bool_t IlcExternalTrackParam::ConstrainToVertex(const IlcVVertex* vtx, Double_t b[3])
{
...
void IlcExternalTrackParam::Set(const IlcExternalTrackParam *t){
  ...
  if(IlcDebugLevelClass()>5){
    IlcDebug(6,"Set IlcExternal Params to values:");
...
//   cout<<"xcrv "<<xcrv<<" "<<ycrv<<" R "<<R<<" phicrv "<<phicrv<<" dphi0 "<<dphi0<<" dphi "<<dphi<<" "<<dphis<<" phi "<<phi<<" xyz "<<xyz[0]<<" "<<xyz[1]<<" "<<xyz[2]<<endl;
...
Bool_t IlcExternalTrackParam::PropagateToDCA(const IlcESDVertex *vtx, Double_t b, Double_t maxd){
  //
  ...
  if (!Propagate(alpha+TMath::ASin(sn),xv,b,false)) return kFALSE;
  return kTRUE;
}
...
//     Print("params");
    ...
    GetXYZ(xyz0,false);   //starting global position
    if (!GetXYZAt(x,b,xyz1,false)) return kFALSE;   // no prolongation
...
//     Print("params");
    if (rotateTo){
      ...
      GetXYZ(xyz0,false);   // global position
