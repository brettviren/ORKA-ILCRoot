...
//  1) _BRING_TO_BOUNDARY_ is defined in the IlcCheb3D:                          //
...
//  2) _BRING_TO_BOUNDARY_ is not defined in the IlcCheb3D:                      //
...
#ifndef ILCMAGWRAPCHEB_H
#define ILCMAGWRAPCHEB_H
...
class IlcMagWrapCheb: public TNamed
{
 public:
  IlcMagWrapCheb();
  IlcMagWrapCheb(const IlcMagWrapCheb& src);
  ~IlcMagWrapCheb() {Clear();}
  //
  void       CopyFrom(const IlcMagWrapCheb& src);
  IlcMagWrapCheb& operator=(const IlcMagWrapCheb& rhs);
  ...
  //
  IlcCheb3D* GetParamSol(Int_t ipar)                      const {return (IlcCheb3D*)fParamsSol->UncheckedAt(ipar);}
  IlcCheb3D* GetParamTPCRatInt(Int_t ipar)                const {return (IlcCheb3D*)fParamsTPCRat->UncheckedAt(ipar);}
  IlcCheb3D* GetParamTPCInt(Int_t ipar)                   const {return (IlcCheb3D*)fParamsTPC->UncheckedAt(ipar);}
  IlcCheb3D* GetParamDip(Int_t ipar)                      const {return (IlcCheb3D*)fParamsDip->UncheckedAt(ipar);}
  //
  ...
  //
#ifdef  _INC_CREATION_ILCCHEB3D_                          // see IlcCheb3D.h for explanation
  void         LoadData(const char* inpfile);
  //
  IlcMagWrapCheb(const char* inputFile);
  ...
  //
  void       AddParamSol(const IlcCheb3D* param);
  void       AddParamTPCInt(const IlcCheb3D* param);
  void       AddParamTPCRatInt(const IlcCheb3D* param);
  void       AddParamDip(const IlcCheb3D* param);
 ...
 protected:
  ...
  //
  ClassDef(IlcMagWrapCheb,7)         // Wrapper class for the set of Chebishev parameterizations of Ilc mag.field
  //
 };


//__________________________________________________________________________________________
inline void IlcMagWrapCheb::FieldCyl(const Double_t *rphiz, Double_t *b) const
{
...
inline void IlcMagWrapCheb::CylToCartCylB(const Double_t *rphiz, const Double_t *brphiz,Double_t *bxyz)
{
...
//__________________________________________________________________________________________________
inline void IlcMagWrapCheb::CylToCartCartB(const Double_t* xyz, const Double_t *brphiz, Double_t *bxyz)
{
...
//__________________________________________________________________________________________________
inline void IlcMagWrapCheb::CartToCylCartB(const Double_t *xyz, const Double_t *bxyz, Double_t *brphiz)
{
...
//__________________________________________________________________________________________________
inline void IlcMagWrapCheb::CartToCylCylB(const Double_t *rphiz, const Double_t *bxyz, Double_t *brphiz)
{
  // convert field in cylindrical coordinates to cartesian system, point is in cyl.system
  Double_t btr = TMath::Sqrt(bxyz[0]*bxyz[0]+bxyz[1]*bxyz[1]);
...
//__________________________________________________________________________________________________
inline void IlcMagWrapCheb::CartToCyl(const Double_t *xyz, Double_t *rphiz)
{
...
//__________________________________________________________________________________________________
inline void IlcMagWrapCheb::CylToCart(const Double_t *rphiz, Double_t *xyz)
{
