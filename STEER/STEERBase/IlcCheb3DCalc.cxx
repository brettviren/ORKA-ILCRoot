...
ClassImp(IlcCheb3DCalc)

//__________________________________________________________________________________________
IlcCheb3DCalc::IlcCheb3DCalc() :
  fNCoefs(0), 
  fNRows(0), 
  fNCols(0), 
  fNElemBound2D(0), 
...
//__________________________________________________________________________________________
IlcCheb3DCalc::IlcCheb3DCalc(const IlcCheb3DCalc& src) :
  TNamed(src), 
  fNCoefs(src.fNCoefs), 
  fNRows(src.fNRows), 
  fNCols(src.fNCols),
...
//__________________________________________________________________________________________
IlcCheb3DCalc::IlcCheb3DCalc(FILE* stream) :
  fNCoefs(0), 
  fNRows(0), 
  fNCols(0), 
  fNElemBound2D(0), 
...
//__________________________________________________________________________________________
IlcCheb3DCalc& IlcCheb3DCalc::operator=(const IlcCheb3DCalc& rhs)
{
  // assignment operator
  if (this != &rhs) {
    Clear();
...
//__________________________________________________________________________________________
void IlcCheb3DCalc::Clear(const Option_t*)
{
...
//__________________________________________________________________________________________
void IlcCheb3DCalc::Print(const Option_t* ) const
{
  // print info
...
//__________________________________________________________________________________________
Float_t  IlcCheb3DCalc::EvalDeriv(int dim, const Float_t  *par) const
{
...
//__________________________________________________________________________________________
Float_t  IlcCheb3DCalc::EvalDeriv2(int dim1,int dim2, const Float_t  *par) const
{
...
void IlcCheb3DCalc::SaveData(const char* outfile,Bool_t append) const
{
...
//_______________________________________________
#ifdef _INC_CREATION_ILCCHEB3D_
void IlcCheb3DCalc::SaveData(FILE* stream) const
{
...
//_______________________________________________
void IlcCheb3DCalc::LoadData(FILE* stream)
{
...
//_______________________________________________
void IlcCheb3DCalc::ReadLine(TString& str,FILE* stream) 
{
  ...
  fprintf(stderr,"IlcCheb3D::ReadLine: Failed to read from stream.\nStop");exit(1); // normally, should not reach here
}

//_______________________________________________
void IlcCheb3DCalc::InitCols(int nc)
{
...
//_______________________________________________
void IlcCheb3DCalc::InitRows(int nr)
{
...
//_______________________________________________
void IlcCheb3DCalc::InitElemBound2D(int ne)
{
...
//_______________________________________________
void IlcCheb3DCalc::InitCoefs(int nc)
{
...
//__________________________________________________________________________________________
Float_t IlcCheb3DCalc::ChebEval1Deriv(Float_t  x, const Float_t * array, int ncf )
{
...
//__________________________________________________________________________________________
Float_t IlcCheb3DCalc::ChebEval1Deriv2(Float_t  x, const Float_t * array, int ncf )
{
...
//__________________________________________________________________________________________
Int_t IlcCheb3DCalc::GetMaxColsAtRow() const
{
  int nmax3d = 0; 
  for (int i=fNElemBound2D;i--;) if (fCoefBound2D0[i]>nmax3d) nmax3d = fCoefBound2D0[i];
  return nmax3d;
