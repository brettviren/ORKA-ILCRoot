...
class IlcVTrack: public IlcVParticle {

public:
  enum {
    kITSin=0x0001,kITSout=0x0002,kITSrefit=0x0004,kITSpid=0x0008,
    kVXDin=0x0001,kVXDout=0x0002,kVXDrefit=0x0004,kVXDpid=0x0008,
  ...
  virtual Double_t  GetVXDsignal()       const {return 0.;}
  ...
  virtual Bool_t   PropagateToDCA(const IlcVVertex *vtx,Double_t b,Double_t maxd,Double_t dz[2],Double_t covar[3]) = 0;
  virtual const    IlcExternalTrackParam * GetOuterParam() const { return NULL; }
  ...
  ClassDef(IlcVTrack,1)  // base class for tracks
};
