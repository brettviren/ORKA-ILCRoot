...
class IlcDAQ: public TObject {
 public:

  IlcDAQ() {};
  IlcDAQ(const IlcDAQ& source);
  IlcDAQ& operator = (const IlcDAQ& source);
  virtual ~IlcDAQ() {};
  ...
  enum {
    kNDetectors = 21+1,    // Number of detectors
 ...
 private:
  ...
  ClassDef(IlcDAQ, 3)   // ILC DAQ Configuration class
};
