#ifndef ILCEVENTTAG_H
#define ILCEVENTTAG_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */


/* $Id: IlcEventTag.h 50615 2011-07-16 23:19:19Z hristov $ */
...
class IlcEventTag : public TObject {
 public:
  IlcEventTag();
  IlcEventTag(const IlcEventTag & t);
  virtual ~IlcEventTag();

  IlcEventTag &operator=(const IlcEventTag &rhs);
...
/*   const char *GetGUID() const {return ((IlcFileTag *) fFileRef.GetObject())->GetGUID();} */
/*   const char *GetPath() const {return ((IlcFileTag *) fFileRef.GetObject())->GetPath();} */
/*   const char *GetMD5() const {return  ((IlcFileTag *) fFileRef.GetObject())->GetMD5();} */
/*   const char *GetTURL() const {return ((IlcFileTag *) fFileRef.GetObject())->GetTURL();} */
/*   Long64_t    GetSize() const {return ((IlcFileTag *) fFileRef.GetObject())->GetSize();} */
...
/*   TString   fturl;                          //the file's url */
  ...
  ClassDef(IlcEventTag,17)  //(ClassName, ClassVersion)
      };
//___________________________________________________________________________
