#ifndef ILCMATHBASE_H
#define ILCMATHBASE_H
...
class IlcMathBase : public TObject
{
 public:
  IlcMathBase();
  virtual ~IlcMathBase();
 ...
 ClassDef(IlcMathBase,0) // Various mathematical tools for physics analysis - which are not included in ROOT TMath
