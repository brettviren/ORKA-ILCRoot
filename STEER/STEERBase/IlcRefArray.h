#ifndef ILCREFARRAY_H
#define ILCREFARRAY_H
...
class IlcRefArray : public TObject {
 public:
  IlcRefArray();
  IlcRefArray(UInt_t nelem, UInt_t depth=0);
  IlcRefArray(const IlcRefArray& src);
  IlcRefArray& operator=(const IlcRefArray& src);
  virtual ~IlcRefArray();
  //
 ...
 protected:
  ...
  ClassDef(IlcRefArray,1)
  //
};

//____________________________________________________________________
inline Bool_t IlcRefArray::IsReferred(UInt_t from, UInt_t to)  const
{
...
//____________________________________________________________________
inline UInt_t IlcRefArray::GetReferences(UInt_t from, UInt_t* refs, UInt_t maxRef) const
{
...
//____________________________________________________________________
inline Int_t IlcRefArray::GetReference(UInt_t from, UInt_t which) const
{
...
//____________________________________________________________________
inline void IlcRefArray::AddReference(UInt_t from, UInt_t to)
{
...
//____________________________________________________________________
inline void IlcRefArray::Compactify()
{
