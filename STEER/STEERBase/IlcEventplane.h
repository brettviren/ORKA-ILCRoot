#ifndef ILCEVENTPLANE_H
#define ILCEVENTPLANE_H
...
class IlcEventplane : public TNamed
{
 public:

  IlcEventplane();  /// constructor
  ~IlcEventplane();  /// destructor
  IlcEventplane(const IlcEventplane& ep); /// copy constructor
  IlcEventplane& operator=(const IlcEventplane& ep);   /// assignment operator
  virtual void CopyEP(IlcEventplane& ep) const;
  ...
  TVector2* GetQVector(); 
  Double_t  GetQContributionX(IlcVTrack* track);
  Double_t  GetQContributionY(IlcVTrack* track);
  Double_t  GetQContributionXsub1(IlcVTrack* track);
  Double_t  GetQContributionYsub1(IlcVTrack* track);
  Double_t  GetQContributionXsub2(IlcVTrack* track);
  Double_t  GetQContributionYsub2(IlcVTrack* track);
  ...
  Double_t  GetEventplane(const char *x, const IlcVEvent *event = NULL, Int_t harmonic = 2) const;
  TVector2* GetQsub1();
  TVector2* GetQsub2();
  Double_t  GetQsubRes();
  Bool_t    IsEventInEventplaneClass(Double_t a, Double_t b, const char *method);
  Double_t  CalculateVZEROEventPlane(const IlcVEvent *event, Int_t firstRing, Int_t lastRing, Int_t harmonic, Double_t &qxTot, Double_t &qyTot) const;
 ...
 private:
  ...
  ClassDef(IlcEventplane, 4)
};
#endif //ILCEVENTPLANE_H
