...
//////////////////////////////////////////////////////////////////////////////
//                                                                          //
// The IlcDAQ class is responsible for handling all the information about   //
...
const char* IlcDAQ::fgkDetectorName[IlcDAQ::kNDetectors] = {
  "ITSSPD",
  "ITSSDD",
  "ITSSSD",
  "TPC",
...
Int_t IlcDAQ::fgkNumberOfDdls[IlcDAQ::kNDetectors] = {
  20,
  24,
  16,
  216,
...
Float_t IlcDAQ::fgkNumberOfLdcs[IlcDAQ::kNDetectors] = {
  4,
  4,
  4,
  36,
...
const char* IlcDAQ::fgkOfflineModuleName[IlcDAQ::kNDetectors] = {
  "ITS",
  "ITS",
  "ITS",
  "TPC",
...
const char* IlcDAQ::fgkOnlineName[IlcDAQ::kNDetectors] = {
  "SPD",
  "SDD",
  "SSD",
  "TPC",
...
IlcDAQ::IlcDAQ(const IlcDAQ& source) :
  TObject(source)
{
  // Copy constructor
  // Nothing to be done
...
IlcDAQ& IlcDAQ::operator = (const IlcDAQ& /* source */)
{
  // Assignment operator
  // Nothing to be done
  return *this;
...
Int_t IlcDAQ::DetectorID(const char *detectorName)
{
  ...
  if (iDet == kNDetectors) {
    IlcErrorClass(Form("Invalid detector name: %s !",detectorName));
    return -1;
  }
  return iDet;
}

const char *IlcDAQ::DetectorName(Int_t detectorID)
{
  // Returns the name of particular
  // detector identified by its index
  if (detectorID < 0 || detectorID >= kNDetectors) {
    IlcErrorClass(Form("Invalid detector index: %d (%d -> %d) !",detectorID,0,kNDetectors-1));
    return "";
  }
  return fgkDetectorName[detectorID];
}

Int_t IlcDAQ::DdlIDOffset(const char *detectorName)
{
...
Int_t IlcDAQ::DdlIDOffset(Int_t detectorID)
{
  // Returns the DDL ID offset
...
const char *IlcDAQ::DetectorNameFromDdlID(Int_t ddlID,Int_t &ddlIndex)
{
...
Int_t IlcDAQ::DetectorIDFromDdlID(Int_t ddlID,Int_t &ddlIndex)
{
  ...
  if (ddlIndex >= fgkNumberOfDdls[detectorID]) {
    IlcErrorClass(Form("Invalid DDL index %d (%d -> %d) for detector %d",
...
Int_t IlcDAQ::DdlID(const char *detectorName, Int_t ddlIndex)
{
...
Int_t IlcDAQ::DdlID(Int_t detectorID, Int_t ddlIndex)
{
  // Returns the DDL ID starting from
...
const char *IlcDAQ::DdlFileName(const char *detectorName, Int_t ddlIndex)
{
...
const char *IlcDAQ::DdlFileName(Int_t detectorID, Int_t ddlIndex)
{
  // Returns the DDL file name
  // (used in the simulation) starting from
  // the detector ID and the DDL
...
Int_t IlcDAQ::NumberOfDdls(const char *detectorName)
{
...
Int_t IlcDAQ::NumberOfDdls(Int_t detectorID)
{
  // Returns the number of DDLs for
  // a given detector
  if (detectorID < 0 || detectorID >= kNDetectors) {
...
Float_t IlcDAQ::NumberOfLdcs(const char *detectorName)
{
  // Returns the number of DDLs for
  // a given detector
  Int_t detectorID = DetectorID(detectorName);
...
Float_t IlcDAQ::NumberOfLdcs(Int_t detectorID)
{
  // Returns the number of DDLs for
  // a given detector
  if (detectorID < 0 || detectorID >= kNDetectors) {
...
void IlcDAQ::PrintConfig()
{
  // Print the DAQ configuration
  // for all the detectors
  printf("===================================================================================================\n"
	 "|                              ILC Data Acquisition Configuration                               |\n"
	 "===================================================================================================\n"
	 "| Detector ID | Detector Name | DDL Offset | # of DDLs | # of LDCs | Online Name | IlcRoot Module |\n"
	 "===================================================================================================\n");
...
const char *IlcDAQ::ListOfTriggeredDetectors(UInt_t detectorPattern)
{
...
UInt_t  IlcDAQ::DetectorPattern(const char *detectorList)
{
...
UInt_t  IlcDAQ::DetectorPatternOffline(const char *detectorList)
{
  // Returns a 32-bit word containing the
  // the detector pattern corresponding to a given
  // list of detectors.
...
const char *IlcDAQ::OfflineModuleName(const char *detectorName)
{
...
const char *IlcDAQ::OfflineModuleName(Int_t detectorID)
{
  // Returns the name of the offline module
  // for a given detector (online naming convention)
  if (detectorID < 0 || detectorID >= kNDetectors) {
...
const char *IlcDAQ::OnlineName(const char *detectorName)
{
...
const char *IlcDAQ::OnlineName(Int_t detectorID)
{
  // Returns the name of the online detector name (3 characters)
  // for a given detector
  if (detectorID < 0 || detectorID >= kNDetectors) {
