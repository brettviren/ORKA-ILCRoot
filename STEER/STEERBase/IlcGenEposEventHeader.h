#ifndef ILCGENEPOSEVENTHEADER_H_
#define ILCGENEPOSEVENTHEADER_H_
...
class IlcGenEposEventHeader : public IlcGenEventHeader, public IlcCollisionGeometry
{
public:
	IlcGenEposEventHeader(const char* name);
	IlcGenEposEventHeader();
	virtual ~IlcGenEposEventHeader() {}
...
private:
	...
	ClassDef(IlcGenEposEventHeader,2)
};


#endif /* ILCGENEPOSEVENTHEADER_H_ */
