...
#include "IlcEMCALPIDResponse.h"       //class header

#include "IlcLog.h"   

ClassImp(IlcEMCALPIDResponse)

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
IlcEMCALPIDResponse::IlcEMCALPIDResponse():
  TObject(),
  fNorm(NULL),
  fkPIDParams(NULL)
{
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
IlcEMCALPIDResponse::IlcEMCALPIDResponse(const IlcEMCALPIDResponse &other):
  TObject(other),
  fNorm(other.fNorm),
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
IlcEMCALPIDResponse & IlcEMCALPIDResponse::operator=( const IlcEMCALPIDResponse& other)
{
  //
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Double_t IlcEMCALPIDResponse::GetExpectedNorm( Float_t pt, IlcPID::EParticleType n,  Int_t charge) const  {
  //
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Double_t  IlcEMCALPIDResponse::GetNumberOfSigmas( Float_t pt,  Float_t eop, IlcPID::EParticleType n,  Int_t charge) const {
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Double_t IlcEMCALPIDResponse::ComputeEMCALProbability(Float_t pt, Float_t eop, Int_t charge, Double_t *pEMCAL) const {
  //
  //
  ...
  for (Int_t species = 0; species < IlcPID::kSPECIES; species++) {
    pEMCAL[species] = 999.;
  }
  ...
  for (Int_t species = 0; species < IlcPID::kSPECIES; species++) {
    ...
    IlcPID::EParticleType type = IlcPID::EParticleType(species);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
const TVectorD* IlcEMCALPIDResponse::GetParams(Int_t nParticle, Float_t fPt, Int_t charge) const {
  //
  ...
  if(nParticle > IlcPID::kSPECIES || nParticle <0) return NULL;
  if(nParticle == IlcPID::kProton && charge == -1) nParticle = IlcPID::kSPECIES; // special case for antiprotons
  ...
  IlcDebug(2, Form("NO params for particle %d and momentum %f \n", nParticle, fPt));
