#ifndef ILCCOUNTERCOLLECTION_H
#define ILCCOUNTERCOLLECTION_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcCounterCollection.h 54089 2012-01-23 19:15:13Z hristov $ */ 
...
class IlcCounterCollection : public TNamed {
public:
  
  IlcCounterCollection(const char* name = "counters");
  virtual ~IlcCounterCollection();
  ...
  // Add the given IlcCounterCollections to this
  void Add(const IlcCounterCollection* counter);
  
  // Merge this with a list of IlcCounterCollections
...
private:
  ...
  /// Not implemented
  IlcCounterCollection(const IlcCounterCollection& rhs);
  /// Not implemented
  IlcCounterCollection& operator = (const IlcCounterCollection& rhs);
  ...
  Int_t* CheckConsistency(const IlcCounterCollection* c);
...
private:
  ...
  ClassDef(IlcCounterCollection, 3); // collection of mergeable counters
};
