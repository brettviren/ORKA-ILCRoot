#ifndef ILCTRACKREFERENCE_H
#define ILCTRACKREFERENCE_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcTrackReference.h 53956 2012-01-17 13:19:32Z morsch $ */
...
class IlcTrackReference : public TObject {
public:
  ...
  IlcTrackReference();
  IlcTrackReference(Int_t label, Int_t id = -999);
  IlcTrackReference(const IlcTrackReference &tr);
  virtual ~IlcTrackReference() {}

 static IlcExternalTrackParam * MakeTrack(const IlcTrackReference *ref, Double_t mass);
  ...
  Int_t Compare(const TObject *obj) const {
    Int_t ll = ((IlcTrackReference*)obj)->GetTrack();
...
protected:
  ...
  ClassDef(IlcTrackReference,6)  //Base class for all Ilc track references
};
#endif
