...
ClassImp(IlcRefArray)

//____________________________________________________________________
IlcRefArray::IlcRefArray() : fNElems(0),fRefSize(0),fElems(0),fRefInd(0),fRefBuff(0)
{
  // default constructor
}
 
//____________________________________________________________________
IlcRefArray::IlcRefArray(UInt_t nelem,UInt_t depth) : 
...
//____________________________________________________________________
IlcRefArray::IlcRefArray(const IlcRefArray& src) :
  TObject(src),
  fNElems(src.fNElems),
...
//____________________________________________________________________
IlcRefArray& IlcRefArray::operator=(const IlcRefArray& src)
{
...
//____________________________________________________________________
void IlcRefArray::Expand(UInt_t size)
{
  // expand the size
  if (size<fNElems) {
...
//____________________________________________________________________
void IlcRefArray::ExpandReferences(Int_t addSize)
{
  // add extra slots
...
//____________________________________________________________________
void IlcRefArray::Print(Option_t*) const
{
  // reset references
...
//____________________________________________________________________
void IlcRefArray::AddReferences(UInt_t from, UInt_t *refs, UInt_t nref)
{
