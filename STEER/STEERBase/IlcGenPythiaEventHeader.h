#ifndef ILCGENPYTHIAEVENTHEADER_H
#define ILCGENPYTHIAEVENTHEADER_H

/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcGenPythiaEventHeader.h 50615 2011-07-16 23:19:19Z hristov $ */

#include "IlcGenEventHeader.h"


class IlcGenPythiaEventHeader : public IlcGenEventHeader
{
 public:
    IlcGenPythiaEventHeader();
    IlcGenPythiaEventHeader(const char* name);
    virtual ~IlcGenPythiaEventHeader() {}
    // Getters
...
protected:
    ...
    ClassDef(IlcGenPythiaEventHeader,6)  // Event header for Pythia event
};
