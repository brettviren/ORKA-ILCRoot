#ifndef IlcVParticle_H
#define IlcVParticle_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcVParticle.h 53891 2012-01-13 10:34:05Z hristov $ */
...
class IlcVParticle: public TObject {

public:
  IlcVParticle() { }
  virtual ~IlcVParticle() { }
  IlcVParticle(const IlcVParticle& vPart); 
  IlcVParticle& operator=(const IlcVParticle& vPart);
  ...
  ClassDef(IlcVParticle, 3)  // base class for particles
};
