#ifndef ILCGENHYDJET_H
#define ILCGENHYDJET_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcGenHydjet.h 27585 2008-07-25 12:12:04Z cvetan $ */
...
class IlcGenHydjet : public IlcGenMC
{

 public:
    IlcGenHydjet(Int_t npart=0);
    virtual ~IlcGenHydjet();
...
//
    IlcGenHydjet &  operator=(const IlcGenHydjet & rhs);
 protected:
 ...
 private:
    IlcGenHydjet(const IlcGenHydjet &Hijing);
    void Copy(TObject &rhs) const;
    // check if stable
    Bool_t Stable(TParticle*  particle) const;

    ClassDef(IlcGenHydjet, 1) // IlcGenerator interface to Hydjet
};
#endif
