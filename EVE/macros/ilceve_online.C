...
void ilceve_online_init()
{
  ...
  IlcEveMultiView *multiView = new IlcEveMultiView(kTRUE);
  ...
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC PVTX",         "primary_vertex.C", "primary_vertex_spd",         "",                kTRUE));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC PVTX Ellipse", "primary_vertex.C", "primary_vertex_ellipse_spd", "",                kTRUE));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC PVTX Box",     "primary_vertex.C", "primary_vertex_box_spd",     "kFALSE, 3, 3, 3", kFALSE));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC PVTX",         "primary_vertex.C", "primary_vertex_tpc",         "",                kFALSE));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC PVTX Ellipse", "primary_vertex.C", "primary_vertex_ellipse_tpc", "",                kFALSE));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC PVTX Box",     "primary_vertex.C", "primary_vertex_box_tpc",     "kFALSE, 3, 3, 3", kFALSE));

  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRunLoader, "REC Clus ITS",   "its_clusters.C++",   "its_clusters"));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRunLoader, "REC Clus TPC",   "tpc_clusters.C++",   "tpc_clusters"));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRunLoader, "REC Clus TRD",   "trd_clusters.C++",   "trd_clusters"));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRunLoader, "REC Clus TOF",   "tof_clusters.C++",   "tof_clusters"));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRunLoader, "REC Clus HMPID", "hmpid_clusters.C++", "hmpid_clusters"));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRunLoader, "REC Clus MUON",  "muon_clusters.C++",  "muon_clusters"));

  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRunLoader, "DIG EMCAL",   "emcal_digits.C++",   "emcal_digits"));

  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRawReader, "RAW ITS",     "its_raw.C",     "its_raw"));
  //  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRawReader, "RAW TPC",     "tpc_raw.C",     "tpc_raw"));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRawReader, "RAW TOF",     "tof_raw.C",     "tof_raw"));
  ...
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRawReader, "RAW MUON",    "muon_raw.C++",  "muon_raw"));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kRawReader, "RAW FMD",     "fmd_raw.C",     "fmd_raw"));

  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC Track",      "esd_tracks.C++",        "esd_tracks",             "", kFALSE));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC Track",      "esd_tracks.C++",        "esd_tracks_MI",          "", kFALSE));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC Track",      "esd_tracks.C++",        "esd_tracks_by_category", "", kTRUE));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC Track MUON", "esd_muon_tracks.C++", "esd_muon_tracks",        "kTRUE,kFALSE", kTRUE));
  exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC FMD",        "fmd_esd.C",           "fmd_esd",                "", kTRUE));

  // ???
  // exec->AddMacro(new IlcEveMacro(IlcEveMacro::kESD, "REC TRD", "trd_detectors.C++", "trd_detectors",         "", kFALSE));
  ...
  {
    IlcEveEventManager::GetMaster()->SetAutoLoad(kTRUE);
  }
...
void ilceve_online_on_new_event()
{
  IlcSysInfo::AddStamp("on_new_event_start");

  IlcTriggerAnalysis atr;
  ...
  IlcEveMultiView *multiView = IlcEveMultiView::Instance();
...
*/
  ...
  IlcTriggerAnalysis::V0Decision decisionV0a = 
    atr.V0Trigger(esd, IlcTriggerAnalysis::kASide, kFALSE);
  IlcTriggerAnalysis::V0Decision decisionV0c = 
    atr.V0Trigger(esd, IlcTriggerAnalysis::kCSide, kFALSE);

  Double_t a = 0;
  Double_t c = 0;

  if( decisionV0a == IlcTriggerAnalysis::kV0Invalid ) a = 0.5;
  if( decisionV0a == IlcTriggerAnalysis::kV0Empty ) a = 1.5;
  if( decisionV0a == IlcTriggerAnalysis::kV0BB ) a = 2.5;
  if( decisionV0a == IlcTriggerAnalysis::kV0BG ) a = 3.5;

  if( decisionV0c == IlcTriggerAnalysis::kV0Invalid ) c = 0.5;
  if( decisionV0c == IlcTriggerAnalysis::kV0Empty ) c = 1.5;
  if( decisionV0c == IlcTriggerAnalysis::kV0BB ) c = 2.5;
  if( decisionV0c == IlcTriggerAnalysis::kV0BG ) c = 3.5;

  V0StateHistogram->Fill(a,c);
  IlcSysInfo::AddStamp("on_new_event_after_trig");
  ...
  IlcSysInfo::AddStamp("on_new_event_after_rozphi");
  ...
  IlcSysInfo::AddStamp("on_new_event_after_muon");

  gEve->FullRedraw3D();

  // Register image to amore.
  // const TString pichost("aldaqacrs3");
  const TString pichost(gEnv->GetValue("IlcEve.imageDumpHost", "aldaqacrs3"));
  TTimeStamp now;
  ...
  IlcSysInfo::AddStamp("on_new_event_pic");
  if (pichost == gSystem->HostName() && delta >= 30)
  {
    ...
    status = gSystem->Exec(TString::Format("SendImageToAmore %s %s %d",
		          id.Data(), pic.Data(),
		          IlcEveEventManager::AssertRawReader()->GetRunNumber()));
  ...
  IlcSysInfo::AddStamp("on_new_event_end");
