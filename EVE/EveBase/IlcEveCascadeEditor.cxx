// @(#)root/eve:$Id: IlcEveCascadeEditor.cxx 47102 2011-02-04 11:24:48Z fca $
...
// GUI editor for IlcEveCascade.
//

ClassImp(IlcEveCascadeEditor)

//______________________________________________________________________________
IlcEveCascadeEditor::IlcEveCascadeEditor(const TGWindow *p, Int_t width, Int_t height,
  ...
  // Initialize widget pointers to 0
{
  ...
  fXButtonDetailedView->Connect("Clicked()", "IlcEveCascadeEditor", this, "DisplayDetailed()");
  ...
  fXButtonMassHyp->Connect("Clicked()", "IlcEveCascadeEditor", this, "DisplayMassHyp()");
...
//______________________________________________________________________________
void IlcEveCascadeEditor::SetModel(TObject* obj)
{
  // Set model object.

  fM = static_cast<IlcEveCascade*>(obj);
...
//______________________________________________________________________________
// void IlcEveCascadeEditor::DoXYZZ()
// {
//    // Slot for XYZZ.
//
...
void IlcEveCascadeEditor::DisplayDetailed()
{
  ...
  IlcEveTrack *bacTrack = fM->GetBacTrack();
  IlcEveTrack *negTrack = fM->GetNegTrack();
  IlcEveTrack *posTrack = fM->GetPosTrack();
...
void IlcEveCascadeEditor::DisplayMassHyp()
{	
