// $Id: IlcEveKink.h 37541 2009-12-03 12:31:24Z mtadel $
...
class IlcEveKink : public TEvePointSet
{
  friend class IlcEveKinkList;
  friend class IlcEveKinkEditor;

public:
  IlcEveKink();
  IlcEveKink(TEveRecTrack* tMoth, TEveRecTrack* tDaug, TEveRecKink* kink, TEveTrackPropagator* rsMoth, TEveTrackPropagator* rsDaugh);
  virtual ~IlcEveKink();
...
private:
  IlcEveKink(const IlcEveKink&);            // Not implemented
  IlcEveKink& operator=(const IlcEveKink&); // Not implemented

  ClassDef(IlcEveKink, 0); // Visual representation of a IlcEveKink.
};
...
// IlcEveKinkList
//
// Container for IlcEveKink objects
// Provides managmenet methods for setting cuts and common visualization
// parameters.
//------------------------------------------------------------------------------

class IlcEveKinkList : public TEveElementList
{
  friend class IlcEveKinkListEditor;

public:
  IlcEveKinkList();
  IlcEveKinkList(TEveTrackPropagator* rsMoth, TEveTrackPropagator* rsDaugh);
  IlcEveKinkList(const Text_t* name, TEveTrackPropagator* rsMoth=0, TEveTrackPropagator* rsDaugh=0);
  virtual ~IlcEveKinkList() {}
...
private:
  ...
  IlcEveKinkList(const IlcEveKinkList&);            // Not implemented
  IlcEveKinkList& operator=(const IlcEveKinkList&); // Not implemented

  ClassDef(IlcEveKinkList, 0); // A list of IlcEveKink objecs.
};
