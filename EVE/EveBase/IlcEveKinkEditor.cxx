// $Id: IlcEveKinkEditor.cxx 47102 2011-02-04 11:24:48Z fca $
...
// GUI editor for IlcEveKink.
//

ClassImp(IlcEveKinkEditor)

//______________________________________________________________________________
IlcEveKinkEditor::IlcEveKinkEditor(const TGWindow *p, Int_t width, Int_t height,
  ...
  // Initialize widget pointers to 0
{
  ...
  fXButton->Connect("Clicked()", "IlcEveKinkEditor", this, "DisplayDetailed()");
}

/******************************************************************************/

//______________________________________________________________________________
void IlcEveKinkEditor::SetModel(TObject* obj)
{
  // Set model object.

  fM = static_cast<IlcEveKink*>(obj);
...
void IlcEveKinkEditor::DisplayDetailed()
{
