// $Id: IlcEveCosmicRayFitter.cxx 47102 2011-02-04 11:24:48Z fca $
...
// IlcEveCosmicRayFitter
//
//  Same schema used in IlcEveTrackFitter class.
//
//  IlcEveCosmicRayFitter is a TEvePointSet interface to allow
...
ClassImp(IlcEveCosmicRayFitter)

IlcEveCosmicRayFitter::IlcEveCosmicRayFitter(const Text_t* name, Int_t n_points) :
...
IlcEveCosmicRayFitter::~IlcEveCosmicRayFitter()
{
  // Destructor.
...
/**************************************************************************/
void IlcEveCosmicRayFitter::Start()
{
  ...
  if(fConnected == kFALSE)
  {
    TQObject::Connect("TEvePointSet", "PointSelected(Int_t)",
		      "IlcEveCosmicRayFitter", this, "AddFitPoint(Int_t)");
    fConnected = kTRUE;
  }
}

/**************************************************************************/
void IlcEveCosmicRayFitter::Stop()
{
...
void IlcEveCosmicRayFitter::Reset(Int_t /*n*/, Int_t /*ids*/)
{
  // Reset selection.
...
void IlcEveCosmicRayFitter::FitTrack()
{
  ...
  IlcDebug(2, Form(" Selected %3d points:\n", fLastPoint+1));
...
/**************************************************************************/
void IlcEveCosmicRayFitter::DestroyElements()
{
...
/**************************************************************************/
void IlcEveCosmicRayFitter::SumDistance3D(Int_t &, Double_t *, Double_t & sum, Double_t * par, Int_t )
{
  //
...
/**************************************************************************/
Double_t IlcEveCosmicRayFitter::Distance3D(Double_t x, Double_t y, Double_t z, Double_t *p)
{
  //
...
/**************************************************************************/
void IlcEveCosmicRayFitter::DrawDebugGraph()
{
  //
