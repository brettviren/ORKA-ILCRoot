// $Id: IlcEveLego.cxx 47011 2011-02-02 13:39:25Z fca $
...
// from all events.
//
// 4) Possibility to use IlcPhysicsSelection during the all events histograms creation.
...
//______________________________________________________________________________
IlcEveLego::IlcEveLego(const char* name) :
  ...
  fHisto2dAllEventsSlot(0)
{
  ...
  fEsd = IlcEveEventManager::AssertESD();
  ...
  // Colors from get_pdg_color() in /ilc-macros/kine_tracks.C
...
//______________________________________________________________________________
TEveCaloDataHist* IlcEveLego::LoadData()
{
   ...
   for (int n = 0; n < fEsd->GetNumberOfTracks(); ++n) {
     ...
     IlcESDtrack *track = fEsd->GetTrack(n);
...
//______________________________________________________________________________
TEveCaloDataHist* IlcEveLego::LoadAllData()
{
   ...
   printf("Number of events loaded: %i, with IlcPhysicsSelection: %i\n",fAcceptedEvents,fCollisionCandidatesOnly);
...
//______________________________________________________________________________
TEveCaloDataHist* IlcEveLego::FilterData()
{
   // Tracks selection
   if ( fTracksId == 2 )
   {
      ...
      const IlcESDVertex *pv  = fEsd->GetPrimaryVertex();

      for (Int_t n = 0; n < pv->GetNIndices(); n++ )
      {
         IlcESDtrack *at = fEsd->GetTrack(pv->GetIndices()[n]);
...
//______________________________________________________________________________
TEveCaloDataHist* IlcEveLego::FilterAllData()
{
   // Tracks selection
   if ( fTracksIdAE == 2 )
   {
...
//______________________________________________________________________________
TEveCaloLego* IlcEveLego::CreateHistoLego()
{
...
//______________________________________________________________________________
TEveCaloLego* IlcEveLego::CreateHistoLego(TEveWindowSlot *slot)
{
   // Viewer initialization, tab creation
...
//______________________________________________________________________________
TEveCalo3D* IlcEveLego::Create3DView()
{
   // Initialization
   if (fHisto2ds2 == 0) {
...
//______________________________________________________________________________
TEveCalo3D* IlcEveLego::Create3DView(TEveWindowSlot *slot)
{
...
//______________________________________________________________________________
void IlcEveLego::CreateProjections(TEveWindowSlot* slot1, TEveWindowSlot* slot2)
{
   // Create projections
...
//______________________________________________________________________________
TEveCaloDataHist* IlcEveLego::LoadAllEvents()
{
...
//______________________________________________________________________________
void IlcEveLego::ApplyParticleTypeSelectionAE()
{
...
//______________________________________________________________________________
Int_t IlcEveLego::GetParticleType(IlcESDtrack *track)
{
...
//______________________________________________________________________________
void IlcEveLego::SetParticleType(Int_t id, Bool_t status)
{
...
//______________________________________________________________________________
void IlcEveLego::SetParticleTypeAE(Int_t id, Bool_t status)
{
  // Activate/deactivate particles types
...
//______________________________________________________________________________
void IlcEveLego::SetMaxPt(Double_t val)
{
   // Add new maximum
   fMaxPt = val;   
   Update();
...
//______________________________________________________________________________
void IlcEveLego::SetMaxPtAE(Double_t val)
{
   // Add new maximum
   fMaxPtAE = val;
   FilterAllData();
...
//______________________________________________________________________________
void IlcEveLego::SetThreshold(Double_t val)
{  
...
//______________________________________________________________________________
void IlcEveLego::SetThresholdAE(Double_t val)
{
   // Setting up the new threshold for all histograms
...
//______________________________________________________________________________
void IlcEveLego::SwitchDataType(Bool_t status)
{
...
//______________________________________________________________________________
void IlcEveLego::SetCollisionCandidatesOnly()
{
  // Activate/deactivate MC / real data type
