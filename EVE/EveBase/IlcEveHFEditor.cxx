// @(#)root/eve:$Id: IlcEveHFEditor.cxx 47102 2011-02-04 11:24:48Z fca $
...
// GUI editor for IlcEveHF.
//

ClassImp(IlcEveHFEditor)

//______________________________________________________________________________
IlcEveHFEditor::IlcEveHFEditor(const TGWindow *p, Int_t width, Int_t height,
  ...
  // Initialize widget pointers to 0
{
  ...
  fXButton->Connect("Clicked()", "IlcEveHFEditor", this, "DisplayDetailed()");
}

/******************************************************************************/

//______________________________________________________________________________
void IlcEveHFEditor::SetModel(TObject* obj)
{
  // Set model object.

  fM = static_cast<IlcEveHF*>(obj);
...
void IlcEveHFEditor::DisplayDetailed()
{
