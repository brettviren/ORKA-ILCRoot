...
ClassImp(IlcEveEventSelectorWindow)
//______________________________________________________________________________
IlcEveEventSelectorWindow::IlcEveEventSelectorWindow(const TGWindow *p, UInt_t w, UInt_t h,
                                                     IlcEveEventSelector* sel) :
  TGMainFrame(p, w, h),
  fPSelector(sel),
  fPCanvas(0),
  fPDrawFormula(0),
  ...
  fPEntryMultLow(0)
{
  ...
  buttondraw->Connect("Clicked()","IlcEveEventSelectorWindow",
  ...
  checktextsel->Connect("Toggled(Bool_t)", "IlcEveEventSelector",
  ...
  fPButtonTextDone->Connect("Clicked()", "IlcEveEventSelectorWindow",
  ...
  fPCheckTriggerSimple->Connect("Toggled(Bool_t)","IlcEveEventSelector",
  ...
  fPComboBoxTrigger->Connect("Selected(const char*)","IlcEveEventSelectorWindow",
  ...
  fPCheckTriggerString->Connect("Toggled(Bool_t)","IlcEveEventSelector",
  ...
  buttontrigsel->Connect("Clicked()","IlcEveEventSelectorWindow",
  ...
  checkmult->Connect("Toggled(Bool_t)", "IlcEveEventSelector",
  ...
  buttonmultset->Connect("Clicked()","IlcEveEventSelectorWindow",
  ...
  checkwraparound->Connect("Toggled(Bool_t)","IlcEveEventSelector",
...
//______________________________________________________________________________
IlcEveEventSelectorWindow::~IlcEveEventSelectorWindow()
{
  //dtor
}

//______________________________________________________________________________
void IlcEveEventSelectorWindow::SetupTriggerSelect()
{ 
  ...
  if (fPComboBoxTrigger->GetNumberOfEntries() > 0)
    return;
  IlcEveEventManager* fM = fPSelector->GetEventManager();
  IlcESDEvent* esd = fM->GetESD();
...
//______________________________________________________________________________
void IlcEveEventSelectorWindow::DoSetSelectionString()
{
...
//______________________________________________________________________________
void IlcEveEventSelectorWindow::DoDrawHistogram()
{
...
//______________________________________________________________________________
void IlcEveEventSelectorWindow::DoSetTriggerSelectionString()
{
...
//______________________________________________________________________________
void IlcEveEventSelectorWindow::DoHandleTriggerFromComboBox(const char* str)
{
...
//______________________________________________________________________________
void IlcEveEventSelectorWindow::DoSetMultiplicityRange()
{
