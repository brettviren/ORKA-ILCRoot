// $Id: IlcEveHF.cxx 47014 2011-02-02 14:10:36Z fca $
 ...
 * ee http://ilcinfo.cern.ch/Offline/IlcRoot/License.html for          *
...
//______________________________________________________________________________
IlcEveHF::IlcEveHF(TEveRecTrack* tNeg, TEveRecTrack* tPos, Double_t primVtx[3], IlcAODRecoDecay* aodObj, TEveTrackPropagator* rs) :
...
void IlcEveHF::SetProngDCA() const
{
...
//______________________________________________________________________________
void IlcEveHF::Setd0Prong() const
{
  for(Int_t ip=0; ip<fnProng; ip++)
...
//______________________________________________________________________________
void IlcEveHF::SetMaxProbPdgPid()
{
...
void IlcEveHF::CalculateInvMass(Int_t decay)
{
...
//______________________________________________________________________________
Bool_t IlcEveHF::SelectInvMass(Int_t decay, Float_t decayCuts)
{
...
ClassImp(IlcEveHFList)

//______________________________________________________________________________
IlcEveHFList::IlcEveHFList() :
  TEveElementList(),
  fTitle(),
  fRnrStyle(0),
  fRnrDaughters(kTRUE),
  ...
  fDecay(0)
{
  ...
  fChildClass = IlcEveHF::Class(); // override member from base TEveElementList
}

//______________________________________________________________________________
IlcEveHFList::IlcEveHFList(TEveTrackPropagator* rs) :
  TEveElementList(),
  fTitle(),
  fRnrStyle(rs),
  fRnrDaughters(kTRUE),
...
//______________________________________________________________________________
IlcEveHFList::IlcEveHFList(const Text_t* name, TEveTrackPropagator* rs) :
  TEveElementList(),
  fTitle(),
  fRnrStyle(rs),
  fRnrDaughters(kTRUE),
...
//______________________________________________________________________________
void IlcEveHFList::FilterByPt(Float_t minPt, Float_t maxPt)
{
...
//______________________________________________________________________________
void IlcEveHFList::FilterByRadius(Float_t minR, Float_t maxR)
{
...
//______________________________________________________________________________
void IlcEveHFList::FilterByCosPointingAngle(Float_t minCosPointingAngle, Float_t maxCosPointingAngle)
{
...
//______________________________________________________________________________
void IlcEveHFList::FilterByd0(Float_t mind0, Float_t maxd0)
{
 ...
 //______________________________________________________________________________
void IlcEveHFList::FilterByDCA(Float_t minDaughterDCA, Float_t maxDaughterDCA)
{
...
/******************************************************************************/
//______________________________________________________________________________
/*void IlcEveHFList::FilterByCheckedPidMinProb(Int_t rFlag,Int_t rDaughter, Int_t rPid, Float_t rProb)
{
...
void IlcEveHFList::FilterByInvariantMass(Int_t decay, Float_t deltaInvariantMass)
{
