// @(#)root/eve:$Id: IlcEveV0Editor.cxx 47044 2011-02-03 10:46:29Z fca $
...
// GUI editor for IlcEveV0.
//

ClassImp(IlcEveV0Editor)

//______________________________________________________________________________
IlcEveV0Editor::IlcEveV0Editor(const TGWindow *p, Int_t width, Int_t height,
  ...
  // Initialize widget pointers to 0
{
  ...
  fXButton->Connect("Clicked()", "IlcEveV0Editor", this, "DisplayDetailed()");
}

/******************************************************************************/

//______________________________________________________________________________
void IlcEveV0Editor::SetModel(TObject* obj)
{
  // Set model object.

  fM = static_cast<IlcEveV0*>(obj);
...
void IlcEveV0Editor::DisplayDetailed()
{
