...
void ButtonWindow::DrawResiduals()
{
      ...
      TEveUtil::LoadMacro("$ILC_ROOT/ANALYSIS/macros/ConfigCalibTrain.C+");
       ...
       * 
      IlcESDfriendTrack::MakeDebugStreamer(kTRUE);

      TTreeSRedirector *pcstreamRes = IlcESDfriendTrack::GetDebugStreamer();
      */
      
      TFile fRes("IlcESDfriends.root");
