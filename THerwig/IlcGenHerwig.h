#ifndef ILCGENHERWIG_H
#define ILCGENHERWIG_H
/* 2012-2013 Infrastructure for Large Collider Experiment.       *
 * All rights reserved.                                                   *
 * See cxx source for full Copyright notice                               */

/* $Id: IlcGenHerwig.h 48089 2011-03-05 20:08:23Z morsch $ */
...
class THerwig6;
class IlcGenHerwigEventHeader;
class TArrayI;
class TParticle;
class TClonesArray;


class IlcGenHerwig : public IlcGenMC

{
 ...
 public:
    IlcGenHerwig();
    IlcGenHerwig(Int_t npart);
    virtual ~IlcGenHerwig();
 ...
 protected:
    ...
    IlcGenHerwigEventHeader* fHeader;  //! Event header
 private:
    IlcGenHerwig(const IlcGenHerwig &Herwig);
    IlcGenHerwig &  operator=(const IlcGenHerwig & rhs);
    ...
    ClassDef(IlcGenHerwig,2) // IlcGenerator interface to Herwig
};
#endif
