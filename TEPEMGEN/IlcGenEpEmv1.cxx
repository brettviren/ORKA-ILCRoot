 ...
 * See $ILC_ROOT/EpEmGen/diffcross.f for full Copyright notice          *
 *                                                                        *
 *                                                                        *
 * Copyright(c) 2002 Kai Hencken, Yuri Kharlov, Serguei Sadovsky          *
 * See $ILC_ROOT/EpEmGen/epemgen.f for full Copyright notice            *
 *                                                                        *
 **************************************************************************/

/* $Id: IlcGenEpEmv1.cxx 51126 2011-08-17 13:37:49Z cvetan $ */
...
// [2] K.Hencken, Yu.Kharlov, S.Sadovsky, Internal ILC Note 2002-27.
//%
// Usage:
// Initialization:
//    IlcGenEpEmv1 *gener = new IlcGenEpEmv1();
...
// 1) $ILC_ROOT/EpEmGen/diffcross.f:
...
// 3) Class TEpEmGen:
//    Interface from the fortran event generator to ILCROOT
// 4) Class IlcGenEpEmv1:
//    The event generator to call within ILCROOT
//%
// Author of this module: Yuri.Kharlov@cern.ch
// 9 October 2002

#include "IlcGenEpEmv1.h"
#include <TParticle.h>
#include <TParticlePDG.h>
#include <TDatabasePDG.h>
#include <TEpEmGen.h>

ClassImp(IlcGenEpEmv1)

//------------------------------------------------------------

IlcGenEpEmv1::IlcGenEpEmv1():
  fMass(0),
  fEpEmGen(0),
  fDebug(0),
  fEvent(0),
  fHeader(IlcGenEventHeader())
{
  // Default constructor
  // Avoid zero pt
...
void IlcGenEpEmv1::Generate()
{
  ...
  if (fDebug == 1)
    printf("IlcGenEpEmv1::Generate(): y=(%f,%f), x=(%f,%f), phi=%f\n",
