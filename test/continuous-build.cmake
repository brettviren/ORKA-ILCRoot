...
#Set Project Name
set(CTEST_PROJECT_NAME "IlcRoot")
set(ILC_ROOT $ENV{ILC_ROOT})
set(ILC_INSTALL $ENV{ILC_INSTALL})

if(NOT ILC_INSTALL)
message(FATAL_ERROR "Please set environment variable ILC_INSTALL to the IlcRoot installation directory")
endif(NOT ILC_INSTALL)
if(NOT ILC_ROOT)
message(FATAL_ERROR "Please set environment variable ILC_ROOT to the IlcRoot source directory")
endif(NOT ILC_ROOT)
...
#IlcRoot Repository and build settings
set(ILC_REPO "https://ilcsoft.cern.ch/IlcRoot/trunk")
...
set(CTEST_DROP_SITE "ilcrootbuildcmake.cern.ch")
set(CTEST_DROP_LOCATION "/submit.php?project=IlcRoot")
...
set(TESTCYCLE 2)
#Get Revision
execute_process(COMMAND svn info ${ILC_ROOT} OUTPUT_VARIABLE _svn_out )
string(REGEX REPLACE "^.*Revision: ([^\n]*).*$" "\\1" ILCROOT_SVN_REVISION ${_svn_out})
set(OLDREV ${ILCROOT_SVN_REVISION})       
set(NEWREV ${ILCROOT_SVN_REVISION})       
message("Starting build of revision ${OLDREV}")
#Setup Directories
set(CTEST_BINARY_DIRECTORY  "${ILC_INSTALL}")
set(CTEST_SOURCE_DIRECTORY  "${ILC_ROOT}")
set(CTEST_DASHBOARD_ROOT    "$ENV{HOME}/Dashboards")
#  set(CTEST_CHECKOUT_COMMAND "${CTEST_SVN_COMMAND} co ${ILC_REPO} $ENV{ILC_ROOT}")
