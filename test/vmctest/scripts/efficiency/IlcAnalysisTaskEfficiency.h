#ifndef IlcAnalysisTaskEfficiency_cxx
#define IlcAnalysisTaskEfficiency_cxx
...
class IlcAnalysisTaskEfficiency : public IlcAnalysisTaskSE {
 public:
  IlcAnalysisTaskEfficiency(const char *name = "IlcAnalysisTaskEfficiency");
  virtual ~IlcAnalysisTaskEfficiency() {}
  
  virtual void   UserCreateOutputObjects();
  virtual void   UserExec(Option_t *option);
  virtual void   Terminate(Option_t *);
  virtual Bool_t SelectJouri(IlcESDtrack* track);
 ...
 private:
  ...
  Int_t GetIndexAC(IlcESDtrack *track);
 ...
 //Tracked Deltaphi histos
  ...
  IlcAnalysisTaskEfficiency(const IlcAnalysisTaskEfficiency&); // not implemented
  IlcAnalysisTaskEfficiency& operator=(const IlcAnalysisTaskEfficiency&); // not implemented
  
  ClassDef(IlcAnalysisTaskEfficiency, 1); // example of analysis
};
