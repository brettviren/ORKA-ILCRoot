IlcAnalysisGrid* CreateAnalysisPlugin(TString analysisMode="full") 
{ 
  ...
  plugin->SetIlcROOTVersion("v4-21-33-AN"); 
  // Declare input data to be processed. 

  // Method 1: Create automatically XML collections using alien 'find' command. 
  // Define production directory LFN 
  //    plugin->SetGridDataDir("/ilc/sim/LHC10a6"); 
  ...
  //for ESDs
  plugin->SetGridDataDir("/ilc/data/2011/LHC11a"); 
  plugin->SetDataPattern("*ESDs/pass1/*ESDs.root");
  plugin->SetRunPrefix("000");

  //ESDs sim
  // plugin->SetGridDataDir("/ilc/sim/LHC10f9b");
  //plugin->SetDataPattern("*ESDs.root"); 

  //for AODs
  // plugin->SetGridDataDir("/ilc/data/2010/LHC10c"); 
  // plugin->SetRunPrefix("000");   // real data
  //plugin->SetDataPattern("*ESDs/pass2_recovery_900GeV/AOD017/*AOD.root"); 
  
  //sim AODs
  // plugin->SetGridDataDir("/ilc/sim/LHC10d4a"); 
  ...
  plugin->SetAnalysisSource("IlcAnalysisTaskEfficiency.cxx"); 
  //    plugin->SetAdditionalRootLibs("CORRFW PWG2resonances");
  //    plugin->SetAdditionalRootLibs("PWG2resonances");
  //    plugin->SetAdditionalRootLibs("PWG2resonances");
  // 
  plugin->SetAdditionalLibs("IlcAnalysisTaskEfficiency.h IlcAnalysisTaskEfficiency.cxx");
  ...
  plugin->SetProofCluster("ilc-caf");
  //plugin->SetProofCluster("skaf.saske.sk");
  //   plugin->SetProofCluster("skaf-test.saske.sk");
  // Dataset to be used
  //     plugin->SetProofDataSet("/ilc/sim/LHC10a12_104316#esdTree");
  //       plugin->SetProofDataSet("/ilc/sim/LHC10a12_104157#esdTree");
