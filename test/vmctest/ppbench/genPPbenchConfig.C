/// $Id: genPPbenchConfig.C 39165 2010-02-25 16:12:24Z ivana $
//
...
IlcGenHijing* HijingStandard();
IlcGenGeVSim* GeVSimStandard(Float_t, Float_t);

// Generator 
IlcGenerator* genPPbenchConfig()
{
...
//
	...
	IlcGenHijing *gener = HijingStandard();
...
//
    ...
    case kMuonCocktailPer4:
      ...
      case kHIJINGplus:
      {
        ...
        //
        // Central Hijing 
        IlcGenHijing *genHi = HijingStandard();
