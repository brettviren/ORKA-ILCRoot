...

{
  ...
  gSystem->Exec("ilcroot -b -q sim.C > sim.log 2>&1");
  cout<<">>>>> SIMULATION QA <<<<<"<<endl;
  gSystem->Exec("ilcroot -b -q simqa.C > simqa.log 2>&1");
  cout<<">>>>> RECONSTRUCTION <<<<<"<<endl;
  gSystem->Exec("rm gilc.root");
  gSystem->Exec("Ilcroot -b -q rec.C > rec.log 2>&1");
  cout<<">>>>> RECONSTRUCTION QA <<<<<"<<endl;
  gSystem->Exec("ilcroot -b -q recqa.C > recqa.log 2>&1");
  cout<<">>>>> TAG <<<<<"<<endl;
